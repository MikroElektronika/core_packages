...
const unsigned long __FLASH_SIZE = 0x00010800;
const unsigned long __XRAM_RAM_SIZE = 0x000003FF;
const unsigned long __XRAM_RAM_START = 0x1400;
...
sfr unsigned int          IPC11            absolute 0x00AA;
...
sfr unsigned int          PMD3             absolute 0x0774;
    ...
    // IFS2 bits
    const register unsigned short int FLTBIF = 12;
    sbit  FLTBIF_bit at IFS2.B12;
    ...
    // IEC2 bits
    const register unsigned short int FLTBIE = 12;
    sbit  FLTBIE_bit at IEC2.B12;
