// Definition file for P33FJ09GS302
...
const unsigned long __FLASH_SIZE = 0x000023E8;
...
const unsigned IVT_ADDR_JTAGINTERRUPT        = 0x00B4;
...
const unsigned AIVT_ADDR_ALTJTAGINTERRUPT     = 0x01B4;
...
sfr unsigned int volatile ISRCCON          absolute 0x0500;
...
sfr unsigned int volatile PMD8             absolute 0x077E;
    ...
    const register unsigned short int JTAGIF = 0;
    sbit  JTAGIF_bit at IFS5.B0;
    ...
    const register unsigned short int JTAGIE = 0;
    sbit  JTAGIE_bit at IEC5.B0;
    ...
    // IPC20 bits
    const register unsigned short int JTAGIP_2 = 2;
    sbit  JTAGIP_2_bit at IPC20.B2;
    const register unsigned short int JTAGIP_1 = 1;
    sbit  JTAGIP_1_bit at IPC20.B1;
    const register unsigned short int JTAGIP_0 = 0;
    sbit  JTAGIP_0_bit at IPC20.B0;
    ...
    const register unsigned short int OUTSEL_2 = 10;
    sbit  OUTSEL_2_bit at ISRCCON.B10;
    const register unsigned short int OUTSEL_1 = 9;
    sbit  OUTSEL_1_bit at ISRCCON.B9;
    const register unsigned short int OUTSEL_0 = 8;
    sbit  OUTSEL_0_bit at ISRCCON.B8;
    const register unsigned short int ISRCCAL_5 = 5;
    sbit  ISRCCAL_5_bit at ISRCCON.B5;
    const register unsigned short int ISRCCAL_4 = 4;
    sbit  ISRCCAL_4_bit at ISRCCON.B4;
    const register unsigned short int ISRCCAL_3 = 3;
    sbit  ISRCCAL_3_bit at ISRCCON.B3;
    const register unsigned short int ISRCCAL_2 = 2;
    sbit  ISRCCAL_2_bit at ISRCCON.B2;
    const register unsigned short int ISRCCAL_1 = 1;
    sbit  ISRCCAL_1_bit at ISRCCON.B1;
    const register unsigned short int ISRCCAL_0 = 0;
    sbit  ISRCCAL_0_bit at ISRCCON.B0;
    ...
    const register unsigned short int HYSSEL_1 = 12;
    sbit  HYSSEL_1_bit at CMPCON1.B12;
    sbit  HYSSEL_1_CMPCON1_bit at CMPCON1.B12;
    const register unsigned short int HYSSEL_0 = 11;
    sbit  HYSSEL_0_bit at CMPCON1.B11;
    sbit  HYSSEL_0_CMPCON1_bit at CMPCON1.B11;
    const register unsigned short int FLTREN = 10;
    sbit  FLTREN_bit at CMPCON1.B10;
    sbit  FLTREN_CMPCON1_bit at CMPCON1.B10;
    const register unsigned short int FCLKSEL = 9;
    sbit  FCLKSEL_bit at CMPCON1.B9;
    sbit  FCLKSEL_CMPCON1_bit at CMPCON1.B9;
    ...
    sbit  HYSPOL_bit at CMPCON1.B4;
    sbit  HYSPOL_CMPCON1_bit at CMPCON1.B4;
    const register unsigned short int CMPSTAT = 3;
    sbit  CMPSTAT_bit at CMPCON1.B3;
    sbit  CMPSTAT_CMPCON1_bit at CMPCON1.B3;
    const register unsigned short int HGAIN = 2;
    sbit  HGAIN_bit at CMPCON1.B2;
    sbit  HGAIN_CMPCON1_bit at CMPCON1.B2;
    ...
    sbit  HYSSEL_1_CMPCON2_bit at CMPCON2.B12;
    sbit  HYSSEL_0_CMPCON2_bit at CMPCON2.B11;
    sbit  FLTREN_CMPCON2_bit at CMPCON2.B10;
    sbit  FCLKSEL_CMPCON2_bit at CMPCON2.B9;
    ...
    sbit  HYSPOL_CMPCON2_bit at CMPCON2.B4;
    sbit  CMPSTAT_CMPCON2_bit at CMPCON2.B3;
    sbit  HGAIN_CMPCON2_bit at CMPCON2.B2;
...
// backward compatibility for DTR4BITS
    typedef struct tagDTR4BITS {
      unsigned DTR4:14;
} typeDTR4BITS;
sfr volatile typeDTR4BITS DTR4bits absolute 0x48A;

// backward compatibility for ALTDTR4BITS
    typedef struct tagALTDTR4BITS {
      unsigned ALTDTR4:14;
} typeALTDTR4BITS;
sfr volatile typeALTDTR4BITS ALTDTR4bits absolute 0x48C;
...
sfr volatile typePWMCAP4BITS PWMCAP4bits absolute 0x498;
...
// backward compatibility for ISRCCONBITS
