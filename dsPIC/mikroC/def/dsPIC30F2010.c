...
sfr unsigned int          PMD2             absolute 0x0772;
    ...
    // ADCHS bits
    const register unsigned short int CHXNB_1 = 15;
    sbit  CHXNB_1_bit at ADCHS.B15;
    const register unsigned short int CHXNB_0 = 14;
    sbit  CHXNB_0_bit at ADCHS.B14;
    const register unsigned short int CHXSB = 13;
    sbit  CHXSB_bit at ADCHS.B13;
    ...
    const register unsigned short int CHXNA_1 = 7;
    sbit  CHXNA_1_bit at ADCHS.B7;
    const register unsigned short int CHXNA_0 = 6;
    sbit  CHXNA_0_bit at ADCHS.B6;
    const register unsigned short int CHXSA = 5;
    sbit  CHXSA_bit at ADCHS.B5;
    ...
    // OSCCON bits
    const register unsigned short int TUN3 = 15;
    sbit  TUN3_bit at OSCCON.B15;
    const register unsigned short int TUN2 = 14;
    sbit  TUN2_bit at OSCCON.B14;
    ...
    const register unsigned short int TUN1 = 11;
    sbit  TUN1_bit at OSCCON.B11;
    const register unsigned short int TUN0 = 10;
    sbit  TUN0_bit at OSCCON.B10;
...
sfr volatile typeADCBUF0BITS ADCBUF0bits absolute 0x280;

// backward compatibility for ADCBUF1BITS
    typedef struct tagADCBUF1BITS {
      unsigned ADCBUF1:10;
} typeADCBUF1BITS;
sfr volatile typeADCBUF1BITS ADCBUF1bits absolute 0x282;

// backward compatibility for ADCBUF2BITS
    typedef struct tagADCBUF2BITS {
      unsigned ADCBUF2:10;
} typeADCBUF2BITS;
sfr volatile typeADCBUF2BITS ADCBUF2bits absolute 0x284;

// backward compatibility for ADCBUF3BITS
    typedef struct tagADCBUF3BITS {
      unsigned ADCBUF3:10;
} typeADCBUF3BITS;
sfr volatile typeADCBUF3BITS ADCBUF3bits absolute 0x286;

// backward compatibility for ADCBUF4BITS
    typedef struct tagADCBUF4BITS {
      unsigned ADCBUF4:10;
} typeADCBUF4BITS;
sfr volatile typeADCBUF4BITS ADCBUF4bits absolute 0x288;

// backward compatibility for ADCBUF5BITS
    typedef struct tagADCBUF5BITS {
      unsigned ADCBUF5:10;
} typeADCBUF5BITS;
sfr volatile typeADCBUF5BITS ADCBUF5bits absolute 0x28A;

// backward compatibility for ADCBUF6BITS
    typedef struct tagADCBUF6BITS {
      unsigned ADCBUF6:10;
} typeADCBUF6BITS;
sfr volatile typeADCBUF6BITS ADCBUF6bits absolute 0x28C;

// backward compatibility for ADCBUF7BITS
    typedef struct tagADCBUF7BITS {
      unsigned ADCBUF7:10;
} typeADCBUF7BITS;
sfr volatile typeADCBUF7BITS ADCBUF7bits absolute 0x28E;

// backward compatibility for ADCBUF8BITS
    typedef struct tagADCBUF8BITS {
      unsigned ADCBUF8:10;
} typeADCBUF8BITS;
sfr volatile typeADCBUF8BITS ADCBUF8bits absolute 0x290;

// backward compatibility for ADCBUF9BITS
    typedef struct tagADCBUF9BITS {
      unsigned ADCBUF9:10;
} typeADCBUF9BITS;
sfr volatile typeADCBUF9BITS ADCBUF9bits absolute 0x292;

// backward compatibility for ADCBUFABITS
    typedef struct tagADCBUFABITS {
      unsigned ADCBUFA:10;
} typeADCBUFABITS;
sfr volatile typeADCBUFABITS ADCBUFAbits absolute 0x294;

// backward compatibility for ADCBUFBBITS
    typedef struct tagADCBUFBBITS {
      unsigned ADCBUFB:10;
} typeADCBUFBBITS;
sfr volatile typeADCBUFBBITS ADCBUFBbits absolute 0x296;

// backward compatibility for ADCBUFCBITS
    typedef struct tagADCBUFCBITS {
      unsigned ADCBUFC:10;
} typeADCBUFCBITS;
sfr volatile typeADCBUFCBITS ADCBUFCbits absolute 0x298;

// backward compatibility for ADCBUFDBITS
    typedef struct tagADCBUFDBITS {
      unsigned ADCBUFD:10;
} typeADCBUFDBITS;
sfr volatile typeADCBUFDBITS ADCBUFDbits absolute 0x29A;

// backward compatibility for ADCBUFEBITS
    typedef struct tagADCBUFEBITS {
      unsigned ADCBUFE:10;
} typeADCBUFEBITS;
sfr volatile typeADCBUFEBITS ADCBUFEbits absolute 0x29C;

// backward compatibility for ADCBUFFBITS
    typedef struct tagADCBUFFBITS {
      unsigned ADCBUFF:10;
} typeADCBUFFBITS;
sfr volatile typeADCBUFFBITS ADCBUFFbits absolute 0x29E;
