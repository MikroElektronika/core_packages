...
sfr unsigned int            RPINR26          absolute 0x6D4;
    ...
    sbit  C1RXR0_bit at RPINR26.B0;
    const register unsigned short int C1RXR1 = 1;
    sbit  C1RXR1_bit at RPINR26.B1;
    const register unsigned short int C1RXR2 = 2;
    sbit  C1RXR2_bit at RPINR26.B2;
    const register unsigned short int C1RXR3 = 3;
    sbit  C1RXR3_bit at RPINR26.B3;
    const register unsigned short int C1RXR4 = 4;
    sbit  C1RXR4_bit at RPINR26.B4;
    const register unsigned short int C1RXR5 = 5;
    sbit  C1RXR5_bit at RPINR26.B5;
    const register unsigned short int C1RXR6 = 6;
    sbit  C1RXR6_bit at RPINR26.B6;
