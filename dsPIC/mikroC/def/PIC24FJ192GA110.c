// Definition file for P24FJ192GA110
...
const unsigned long __FLASH_SIZE = 0x000311F4;
...
sfr unsigned int volatile CNPD6            absolute 0x005E;
...
sfr unsigned int volatile CNEN6            absolute 0x006A;
...
sfr unsigned int volatile CNPU6            absolute 0x0076;
...
sfr unsigned int          ALTRP            absolute 0x06E2;
...
sfr unsigned int volatile PMD6             absolute 0x077A;
    ...
    // ALTRP bits
    const register unsigned short int SCK1CM = 0;
    sbit  SCK1CM_bit at ALTRP.B0;
...
sfr volatile typeCNPD6BITS CNPD6bits absolute 0x05E;
...
sfr volatile typeCNEN6BITS CNEN6bits absolute 0x06A;
...
sfr volatile typeCNPU6BITS CNPU6bits absolute 0x076;
...
// backward compatibility for ALTRPBITS
    typedef struct tagALTRPBITS {
      unsigned SCK1CM:1;
} typeALTRPBITS;
sfr volatile typeALTRPBITS ALTRPbits absolute 0x6E2;
