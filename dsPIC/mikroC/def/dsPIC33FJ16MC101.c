// Definition file for P33FJ16MC101
...
const unsigned IVT_ADDR_FLTB1INTERRUPT       = 0x0094;
...
const unsigned AIVT_ADDR_ALTFLTB1INTERRUPT    = 0x0194;
...
sfr unsigned int volatile ADCHS            absolute 0x0328;
...
sfr unsigned int volatile ADCSSL           absolute 0x0330;
...
sfr unsigned int volatile PMD4             absolute 0x0776;
    ...
    const register unsigned short int FLTB1IF = 0;
    sbit  FLTB1IF_bit at IFS4.B0;
    ...
    const register unsigned short int FLTB1IE = 0;
    sbit  FLTB1IE_bit at IEC4.B0;
    ...
    const register unsigned short int FLTB1IP_2 = 2;
    sbit  FLTB1IP_2_bit at IPC16.B2;
    const register unsigned short int FLTB1IP_1 = 1;
    sbit  FLTB1IP_1_bit at IPC16.B1;
    const register unsigned short int FLTB1IP_0 = 0;
    sbit  FLTB1IP_0_bit at IPC16.B0;
