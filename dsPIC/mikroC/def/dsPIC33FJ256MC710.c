// Definition file for P33FJ256MC710
...
const unsigned long __FLASH_SIZE = 0x00040200;
const unsigned long __XRAM_RAM_SIZE = 0x00003FFF;
const unsigned long __XRAM_RAM_START = 0x800;
const unsigned long __YRAM_RAM_SIZE = 0x00002FFF;
const unsigned long __YRAM_RAM_START = 0x4800;
const unsigned long __DMA_RAM_SIZE = 0x000007FF;
const unsigned long __DMA_RAM_START = 0x7800;
...
const register unsigned int DMA_START_ADDRESS = 0x7800;
