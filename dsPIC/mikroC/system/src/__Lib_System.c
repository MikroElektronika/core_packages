...
void __FillZerosFar(void far *dest, unsigned long sizeinbytes){
   ...
   if ((unsigned int)(dest+(sizeinbytes-1)) & 0x8000)
     {
       // da se popune dsrpag i dswpag i da se prebaci bajt ako je bio neparan broj bajtova
        if((unsigned int)dest & 1) // ako je neparan
          {
            *(char far*)dest = 0;
            dest++;
          }
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
// FUNKCIJE KOJE SU PREPISANE IZ PASCALA ZBOG KOMPATIBILNOSTI
