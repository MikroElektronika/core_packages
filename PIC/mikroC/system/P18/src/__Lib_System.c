...
void ____DoIFC(){
  asm MOVF INTCON,0;
  asm MOVWF R2;                              // spasavanje GIE(INTCON-a) mora da ide preko  R2 da bi contex saving sprecio interrupt , ne sme da se pamti ceo INTCON jer moze korisnik da ga menja
