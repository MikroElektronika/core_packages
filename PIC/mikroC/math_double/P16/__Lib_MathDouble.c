 ...
 * @details This function sets the result and appropriate flags if an overflow occurs during the operation.
 */
void SETFOV32()
{
    asm {
 ...
 * @details This function sets the result and appropriate flags if a divide-by-zero error occurs.
 */
void SETFDZ32()
{
    asm {
 ...
 * @details This function sets the math_double_main_global_SIGN based on the result.
 */
void FIXSIGN32()
{
    asm {
 ...
 * @details This function sets the result to zero.
 */
void RES032()
{
    asm {
 ...
 * @details This function sets the result and appropriate flags if an underflow occurs during the operation.
 */
void SETFUN32()
{
    asm {
 ...
 * @details This function normalizes a 32-bit floating point number.
 ...
 * @param[in,out] XLo_2  The least significant part of the unnormalized floating point number.
 * @param[in] SIGN       The sign of the unnormalized floating point number (stored in SIGN,7).
...
/**
 * @brief Normalization routine.
 * @details This function normalizes a 40-bit floating point number to a 32-bit normalized floating point number.
 * @param[in,out] XExp   The exponent part of the unnormalized floating point number.
 * @param[in,out] XHi_2  The most significant part of the unnormalized floating point number.
 * @param[in,out] XHi_1  The second most significant part of the unnormalized floating point number.
 ...
 * @param[in,out] XExp   The exponent part of the first floating point number.
 ...
 * @result The sum of the two 32-bit floating point numbers.
 *         AARG  <--  AARG + BARG
 */
void Add_32x32_FP()
{
 ...
 * @param[in] YHi_1      The second most significant part of the second floating point number.
 * @param[in] YLo_2      The third most significant part of the second floating point number.
 * @result The difference of the two 32-bit floating point numbers.
 *         AARG  <--  AARG - BARG
 */
void Sub_32x32_FP()
{
 ...
 * @param[in] YHi_1      The second most significant part of the second floating point number.
 * @param[in] YLo_2      The third most significant part of the second floating point number.
 * @result The product of the two 32-bit floating point numbers.
 *         AARG  <--  AARG * BARG
 */
void Mul_32x32_FP()
{
 ...
 * @param[in,out] XExp   The exponent part of the floating point dividend.
 * @param[in,out] XHi_2  The most significant part of the floating point dividend.
 * @param[in,out] XHi_1  The second most significant part of the floating point dividend.
 * @param[in,out] XLo_2  The third most significant part of the floating point dividend.
 * @param[in] YExp       The exponent part of the floating point divisor.
 * @param[in] YHi_2      The most significant part of the floating point divisor.
 * @param[in] YHi_1      The second most significant part of the floating point divisor.
 * @param[in] YLo_2      The third most significant part of the floating point divisor.
 * @result The quotient of the two 32-bit floating point numbers.
 *         AARG  <--  AARG / BARG
 * @note The lower 5 bits of the Sign register are used as a counter for loops,
 *       while the highest bit is used to indicate the sign of the result.
 */
void Div_32x32_FP()
{
    __math_tempbD = __math_tempbD;
 ...
 * @param[out] XHi_2  The most significant part of the resulting unsigned integer (Longword).
 * @param[out] XHi_1  The second most significant part of the resulting unsigned integer (Longword).
 * @param[out] XLo_2  The third most significant part of the resulting unsigned integer (Longword).
 * @param[out] XLo_1  The least significant part of the resulting unsigned integer (Longword).
 ...
 * @param[in]  XHi_1  The second most significant part of the floating point number.
 * @param[in]  XLo_2  The third most significant part of the floating point number.
 * @param[out] XHi_2  The most significant part of the resulting 2's complement integer (Longint).
 * @param[out] XHi_1  The second most significant part of the resulting 2's complement integer (Longint).
 * @param[out] XLo_2  The third most significant part of the resulting 2's complement integer (Longint).
 * @param[out] XLo_1  The least significant part of the resulting 2's complement integer (Longint).
 ...
 * @param[in]  XHi_1  The second most significant part of the floating point number.
 * @param[in]  XLo_2  The third most significant part of the floating point number.
 * @param[out] XHi_2  The most significant part of the resulting unsigned absolute value integer (Word).
 * @param[out] XHi_1  The second most significant part of the resulting unsigned absolute value integer (Word).
 ...
 * @param[in]  XHi_1  The second most significant part of the floating point number.
 * @param[in]  XLo_2  The third most significant part of the floating point number.
 * @param[out] XHi_2  The resulting unsigned absolute value integer (Byte).
 ...
 * @param[in]  XLo_1  The 8-bit unsigned integer right justified.
 ...
 * @param[in]  XLo_2  The most significant part of the 16-bit 2's complement integer right justified.
 * @param[in]  XLo_1  The least significant part of the 16-bit 2's complement integer right justified.
 * @param[out] XExp   The exponent part of the resulting floating point number.
 * @param[out] XHi_2  The most significant part of the resulting floating point number.
 * @param[out] XHi_1  The second most significant part of the resulting floating point number.
 * @param[out] XLo_2  The third most significant part of the resulting floating point number.
 ...
 * @param[in]  XLo_2  The most significant part of the 16-bit unsigned integer right justified.
 * @param[in]  XLo_1  The least significant part of the 16-bit unsigned integer right justified.
 * @param[out] XExp   The exponent part of the resulting floating point number.
 * @param[out] XHi_2  The most significant part of the resulting floating point number.
 * @param[out] XHi_1  The second most significant part of the resulting floating point number.
 * @param[out] XLo_2  The third most significant part of the resulting floating point number.
 ...
 * @param[in]  XHi_2  The most significant part of the 32-bit 2's complement integer right justified.
 * @param[in]  XHi_1  The second most significant part of the 32-bit 2's complement integer right justified.
 * @param[in]  XLo_2  The third most significant part of the 32-bit 2's complement integer right justified.
 * @param[in]  XLo_1  The least significant part of the 32-bit 2's complement integer right justified.
 * @param[out] XExp   The exponent part of the resulting floating point number.
 * @param[out] XHi_2  The most significant part of the resulting floating point number.
 * @param[out] XHi_1  The second most significant part of the resulting floating point number.
 * @param[out] XLo_2  The third most significant part of the resulting floating point number.
 ...
 * @param[in]  XHi_2  The most significant part of the 32-bit unsigned integer right justified.
 * @param[in]  XHi_1  The second most significant part of the 32-bit unsigned integer right justified.
 * @param[in]  XLo_2  The third most significant part of the 32-bit unsigned integer right justified.
 * @param[in]  XLo_1  The least significant part of the 32-bit unsigned integer right justified.
 * @param[out] XExp   The exponent part of the resulting floating point number.
 * @param[out] XHi_2  The most significant part of the resulting floating point number.
 * @param[out] XHi_1  The second most significant part of the resulting floating point number.
 * @param[out] XLo_2  The third most significant part of the resulting floating point number.
 ...
 * @param[in]  YHi_1  The second most significant part of the second floating point number.
 * @param[in]  YLo_2  The third most significant part of the second floating point number.
 * @param[out] XExp   The exponent part of the resulting floating point number (ignored).
 * @param[out] XHi_2  The most significant part of the resulting floating point number (ignored).
 * @param[out] XHi_1  The second most significant part of the resulting floating point number (ignored).
 * @param[out] XLo_2  The third most significant part of the resulting floating point number (ignored).
 * @result 0 if true (X = Y), 1 if false (X ≠ Y).
 *         WREG
 */
void Equals_Double()
{
