 ...
 * @details This function divides two signed 32-bit integers.
 * @param[in]  X    The lower part of the dividend.
 * @param[in]  XHi  The higher part of the dividend.
 * @param[in]  Y    The lower part of the divisor.
 * @param[in]  YHi  The higher part of the divisor.
 * @param[out] X    The lower part of the quotient.
 * @param[out] XHi  The higher part of the quotient.
 * @param[out] Reminder    The lower part of the remainder.
 * @param[out] ReminderHi  The higher part of the remainder.
 * @note The highest bit of the SSIGN register is used as a one-bit counter for loops.
 */
void Div_32x32_S()
{
 ...
 * @details This function divides two unsigned 32-bit integers.
 * @param[in]  X           The lower part of the dividend.
 * @param[in]  XHi         The higher part of the dividend.
 * @param[in]  Y           The lower part of the divisor.
 * @param[in]  YHi         The higher part of the divisor.
 * @param[out] Quotient    The lower part of the quotient.
 * @param[out] QuotientHi  The higher part of the quotient.
 * @param[out] Reminder    The lower part of the remainder.
 * @param[out] ReminderHi  The higher part of the remainder.
 */
void Div_32x32_U()
 ...
 * @param[in]  X        The lower part of the unsigned fixed point multiplicand.
 * @param[in]  XHi      The higher part of the unsigned fixed point multiplicand.
 * @param[in]  Y        The lower part of the unsigned fixed point multiplier.
 * @param[in]  YHi      The higher part of the unsigned fixed point multiplier.
 * @param[out] X        The lower part of the 64-bit unsigned fixed point product.
 * @param[out] XHi      The higher part of the 64-bit unsigned fixed point product.
 * @param[out] XHr      The third part of the 64-bit unsigned fixed point product.
 * @param[out] XHs      The fourth part of the 64-bit unsigned fixed point product.
 * @result X  <--  X * Y
 */
void Mul_32x32_U()
{
 ...
 * @param[in]  X        The lower part of the signed fixed point multiplicand.
 * @param[in]  XHi      The higher part of the signed fixed point multiplicand.
 * @param[in]  Y        The lower part of the signed fixed point multiplier.
 * @param[in]  YHi      The higher part of the signed fixed point multiplier.
 * @param[out] X        The lower part of the 64-bit signed fixed point product.
 * @param[out] XHi      The higher part of the 64-bit signed fixed point product.
