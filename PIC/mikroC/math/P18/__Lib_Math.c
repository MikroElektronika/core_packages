/*
 * Project name:
     math.c (fixed-point math library for PIC18)
 * Copyright:
     (c) MikroElektronika, 2005.
 * Description:
     Set of standard math routines for 8-, 16-, 24- (to some extent) and 32-bit
     fixed point signed & unsigned numbers.
     Operations: addition, subtraction, multiplication and division (result and
      remainder)
     Relations: >, <, ==, >=, <=, !=
 * Test configuration:
     MCU:             PIC18xxxxx
     ...
     SW:              mikroC v2.00
 * NOTES:
     WARNING !!! Altering this file may cause improper compiling.
*/

//Declarations------------------------------------------------------------------
/* unsigned int
 main_global_X, main_global_XHi, main_global_XHr, main_global_XHs;
 unsigned int
 main_global_Y, main_global_YHi;
 unsigned short
 main_global_loopcount, main_global_sign;
 unsigned int
 main_global_lowerWord, main_global_upperWord;
 unsigned int
 main_global_remainder, main_global_remainderHi, main_global_temp;
 unsigned short
 main_global_TEMPB, main_global_TEMPB0, main_global_TEMPB1, main_global_TEMPB2,
 main_global_TEMPB3, main_global_SSIGN;*/
//floating point library exception flags
/* unsigned short
 main_global_FPFLAGS;

 unsigned short yByte, yByte_1;*/
//--------------------------------------------------------------end-declarations
...
//-------------- Division, 2x 16-bit signed, lower byte
 void Div_16x16_S_L() {
//  main_global_X = main_global_X;
//  main_global_Y = main_global_Y;
//  main_global_remainder = main_global_remainder;
...
//-------------- Division, 2x 16-bit, signed (signed int)
 void Div_16x16_S() {
//  main_global_X = main_global_X;
//  main_global_Y = main_global_Y;
//  main_global_remainder = main_global_remainder;
...
//-------------- Division, 2x 8-bit signed (signed short)
...
//-------------- Division 32x32 helper routines
...
//-------------- 32-bit signed number division (signed long)
 void Div_32x32_S() {
//  main_global_X = main_global_X;
//  main_global_Y = main_global_Y;
//  main_global_XHi = main_global_XHi;
