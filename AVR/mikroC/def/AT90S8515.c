...
const unsigned int IVT_ADDR_TIMER1_COMPB     = 0x0005;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x0006;
const unsigned int IVT_ADDR_TIMER0_OVF       = 0x0007;
const unsigned int IVT_ADDR_SPI_STC          = 0x0008;
const unsigned int IVT_ADDR_UART_RX          = 0x0009;
const unsigned int IVT_ADDR_UART_UDRE        = 0x000A;
const unsigned int IVT_ADDR_UART__TX         = 0x000B;
