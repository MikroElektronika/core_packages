...
const unsigned long __FLASH_SIZE = 0x00062000;
...
sfr data unsigned char volatile ADCA_CH0_SCAN             absolute 0x0226;
    ...
    sbit  COUNT0_bit at ADCA_CH0_SCAN.B0;
    const register unsigned short int COUNT1 = 1;
    sbit  COUNT1_bit at ADCA_CH0_SCAN.B1;
    const register unsigned short int COUNT2 = 2;
    sbit  COUNT2_bit at ADCA_CH0_SCAN.B2;
    const register unsigned short int COUNT3 = 3;
    sbit  COUNT3_bit at ADCA_CH0_SCAN.B3;
