...
sfr data unsigned short volatile PIFR absolute 0xBC;
    sbit  PEOP_bit at PIFR.B0;
    const register unsigned short int PEOP = 0;
    sbit  PEV0_bit at PIFR.B1;
    const register unsigned short int PEV0 = 1;
    sbit  PEV1_bit at PIFR.B2;
    const register unsigned short int PEV1 = 2;
    sbit  PEV2_bit at PIFR.B3;
    const register unsigned short int PEV2 = 3;

sfr data unsigned short volatile PIM absolute 0xBB;
    sbit  PEOPE_bit at PIM.B0;
    const register unsigned short int PEOPE = 0;
    sbit  PEVE0_bit at PIM.B1;
    const register unsigned short int PEVE0 = 1;
    sbit  PEVE1_bit at PIM.B2;
    const register unsigned short int PEVE1 = 2;
    sbit  PEVE2_bit at PIM.B3;
    const register unsigned short int PEVE2 = 3;

sfr data unsigned short volatile PMIC2 absolute 0xBA;
    sbit  PRFM20_bit at PMIC2.B0;
    const register unsigned short int PRFM20 = 0;
    sbit  PRFM21_bit at PMIC2.B1;
    const register unsigned short int PRFM21 = 1;
    sbit  PRFM22_bit at PMIC2.B2;
    const register unsigned short int PRFM22 = 2;
    sbit  PAOC2_bit at PMIC2.B3;
    const register unsigned short int PAOC2 = 3;
    sbit  PFLTE2_bit at PMIC2.B4;
    const register unsigned short int PFLTE2 = 4;
    sbit  PELEV2_bit at PMIC2.B5;
    const register unsigned short int PELEV2 = 5;
    sbit  PISEL2_bit at PMIC2.B6;
    const register unsigned short int PISEL2 = 6;
    sbit  POVEN2_bit at PMIC2.B7;
    const register unsigned short int POVEN2 = 7;

sfr data unsigned short volatile PMIC1 absolute 0xB9;
    sbit  PRFM10_bit at PMIC1.B0;
    const register unsigned short int PRFM10 = 0;
    sbit  PRFM11_bit at PMIC1.B1;
    const register unsigned short int PRFM11 = 1;
    sbit  PRFM12_bit at PMIC1.B2;
    const register unsigned short int PRFM12 = 2;
    sbit  PAOC1_bit at PMIC1.B3;
    const register unsigned short int PAOC1 = 3;
    sbit  PFLTE1_bit at PMIC1.B4;
    const register unsigned short int PFLTE1 = 4;
    sbit  PELEV1_bit at PMIC1.B5;
    const register unsigned short int PELEV1 = 5;
    sbit  PISEL1_bit at PMIC1.B6;
    const register unsigned short int PISEL1 = 6;
    sbit  POVEN1_bit at PMIC1.B7;
    const register unsigned short int POVEN1 = 7;

sfr data unsigned short volatile PMIC0 absolute 0xB8;
    sbit  PRFM00_bit at PMIC0.B0;
    const register unsigned short int PRFM00 = 0;
    sbit  PRFM01_bit at PMIC0.B1;
    const register unsigned short int PRFM01 = 1;
    sbit  PRFM02_bit at PMIC0.B2;
    const register unsigned short int PRFM02 = 2;
    sbit  PAOC0_bit at PMIC0.B3;
    const register unsigned short int PAOC0 = 3;
    sbit  PFLTE0_bit at PMIC0.B4;
    const register unsigned short int PFLTE0 = 4;
    sbit  PELEV0_bit at PMIC0.B5;
    const register unsigned short int PELEV0 = 5;
    sbit  PISEL0_bit at PMIC0.B6;
    const register unsigned short int PISEL0 = 6;
    sbit  POVEN0_bit at PMIC0.B7;
    const register unsigned short int POVEN0 = 7;

sfr data unsigned short volatile PCTL absolute 0xB7;
    sbit  PRUN_bit at PCTL.B0;
    const register unsigned short int PRUN = 0;
    sbit  PCCYC_bit at PCTL.B1;
    const register unsigned short int PCCYC = 1;
    sbit  PCLKSEL_bit at PCTL.B5;
    const register unsigned short int PCLKSEL = 5;
    sbit  PPRE0_bit at PCTL.B6;
    const register unsigned short int PPRE0 = 6;
    sbit  PPRE1_bit at PCTL.B7;
    const register unsigned short int PPRE1 = 7;

sfr data unsigned short volatile POC absolute 0xB6;
    sbit  POEN0A_bit at POC.B0;
    const register unsigned short int POEN0A = 0;
    sbit  POEN0B_bit at POC.B1;
    const register unsigned short int POEN0B = 1;
    sbit  POEN1A_bit at POC.B2;
    const register unsigned short int POEN1A = 2;
    sbit  POEN1B_bit at POC.B3;
    const register unsigned short int POEN1B = 3;
    sbit  POEN2A_bit at POC.B4;
    const register unsigned short int POEN2A = 4;
    sbit  POEN2B_bit at POC.B5;
    const register unsigned short int POEN2B = 5;

sfr data unsigned short volatile PCNF absolute 0xB5;
    sbit  POPA_bit at PCNF.B2;
    const register unsigned short int POPA = 2;
    sbit  POPB_bit at PCNF.B3;
    const register unsigned short int POPB = 3;
    sbit  PMODE_bit at PCNF.B4;
    const register unsigned short int PMODE = 4;
    sbit  PULOCK_bit at PCNF.B5;
    const register unsigned short int PULOCK = 5;

sfr data unsigned short volatile PSYNC absolute 0xB4;
    sbit  PSYNC00_bit at PSYNC.B0;
    const register unsigned short int PSYNC00 = 0;
    sbit  PSYNC01_bit at PSYNC.B1;
    const register unsigned short int PSYNC01 = 1;
    sbit  PSYNC10_bit at PSYNC.B2;
    const register unsigned short int PSYNC10 = 2;
    sbit  PSYNC11_bit at PSYNC.B3;
    const register unsigned short int PSYNC11 = 3;
    sbit  PSYNC20_bit at PSYNC.B4;
    const register unsigned short int PSYNC20 = 4;
    sbit  PSYNC21_bit at PSYNC.B5;
    const register unsigned short int PSYNC21 = 5;

sfr data unsigned short volatile POCR_RBH absolute 0xB3;
    sbit  POCR_RB_8_bit at POCR_RBH.B0;
    const register unsigned short int POCR_RB_8 = 0;
    sbit  POCR_RB_9_bit at POCR_RBH.B1;
    const register unsigned short int POCR_RB_9 = 1;
    sbit  POCR_RB_10_bit at POCR_RBH.B2;
    const register unsigned short int POCR_RB_10 = 2;
    sbit  POCR_RB_11_bit at POCR_RBH.B3;
    const register unsigned short int POCR_RB_11 = 3;

sfr data unsigned short volatile POCR_RBL absolute 0xB2;
    sbit  POCR_RB_0_bit at POCR_RBL.B0;
    const register unsigned short int POCR_RB_0 = 0;
    sbit  POCR_RB_1_bit at POCR_RBL.B1;
    const register unsigned short int POCR_RB_1 = 1;
    sbit  POCR_RB_2_bit at POCR_RBL.B2;
    const register unsigned short int POCR_RB_2 = 2;
    sbit  POCR_RB_3_bit at POCR_RBL.B3;
    const register unsigned short int POCR_RB_3 = 3;
    sbit  POCR_RB_4_bit at POCR_RBL.B4;
    const register unsigned short int POCR_RB_4 = 4;
    sbit  POCR_RB_5_bit at POCR_RBL.B5;
    const register unsigned short int POCR_RB_5 = 5;
    sbit  POCR_RB_6_bit at POCR_RBL.B6;
    const register unsigned short int POCR_RB_6 = 6;
    sbit  POCR_RB_7_bit at POCR_RBL.B7;
    const register unsigned short int POCR_RB_7 = 7;

sfr data unsigned short volatile POCR2SBH absolute 0xB1;
    sbit  POCR2SB_8_bit at POCR2SBH.B0;
    const register unsigned short int POCR2SB_8 = 0;
    sbit  POCR2SB_9_bit at POCR2SBH.B1;
    const register unsigned short int POCR2SB_9 = 1;
    sbit  POCR2SB_10_bit at POCR2SBH.B2;
    const register unsigned short int POCR2SB_10 = 2;
    sbit  POCR2SB_11_bit at POCR2SBH.B3;
    const register unsigned short int POCR2SB_11 = 3;

sfr data unsigned short volatile POCR2SBL absolute 0xB0;
    sbit  POCR2SB_0_bit at POCR2SBL.B0;
    const register unsigned short int POCR2SB_0 = 0;
    sbit  POCR2SB_1_bit at POCR2SBL.B1;
    const register unsigned short int POCR2SB_1 = 1;
    sbit  POCR2SB_2_bit at POCR2SBL.B2;
    const register unsigned short int POCR2SB_2 = 2;
    sbit  POCR2SB_3_bit at POCR2SBL.B3;
    const register unsigned short int POCR2SB_3 = 3;
    sbit  POCR2SB_4_bit at POCR2SBL.B4;
    const register unsigned short int POCR2SB_4 = 4;
    sbit  POCR2SB_5_bit at POCR2SBL.B5;
    const register unsigned short int POCR2SB_5 = 5;
    sbit  POCR2SB_6_bit at POCR2SBL.B6;
    const register unsigned short int POCR2SB_6 = 6;
    sbit  POCR2SB_7_bit at POCR2SBL.B7;
    const register unsigned short int POCR2SB_7 = 7;

sfr data unsigned short volatile POCR2RAH absolute 0xAF;
    sbit  POCR2RA_8_bit at POCR2RAH.B0;
    const register unsigned short int POCR2RA_8 = 0;
    sbit  POCR2RA_9_bit at POCR2RAH.B1;
    const register unsigned short int POCR2RA_9 = 1;
    sbit  POCR2RA_10_bit at POCR2RAH.B2;
    const register unsigned short int POCR2RA_10 = 2;
    sbit  POCR2RA_11_bit at POCR2RAH.B3;
    const register unsigned short int POCR2RA_11 = 3;

sfr data unsigned short volatile POCR2RAL absolute 0xAE;
    sbit  POCR2RA_0_bit at POCR2RAL.B0;
    const register unsigned short int POCR2RA_0 = 0;
    sbit  POCR2RA_1_bit at POCR2RAL.B1;
    const register unsigned short int POCR2RA_1 = 1;
    sbit  POCR2RA_2_bit at POCR2RAL.B2;
    const register unsigned short int POCR2RA_2 = 2;
    sbit  POCR2RA_3_bit at POCR2RAL.B3;
    const register unsigned short int POCR2RA_3 = 3;
    sbit  POCR2RA_4_bit at POCR2RAL.B4;
    const register unsigned short int POCR2RA_4 = 4;
    sbit  POCR2RA_5_bit at POCR2RAL.B5;
    const register unsigned short int POCR2RA_5 = 5;
    sbit  POCR2RA_6_bit at POCR2RAL.B6;
    const register unsigned short int POCR2RA_6 = 6;
    sbit  POCR2RA_7_bit at POCR2RAL.B7;
    const register unsigned short int POCR2RA_7 = 7;

sfr data unsigned short volatile POCR2SAH absolute 0xAD;
    sbit  POCR2SA_8_bit at POCR2SAH.B0;
    const register unsigned short int POCR2SA_8 = 0;
    sbit  POCR2SA_9_bit at POCR2SAH.B1;
    const register unsigned short int POCR2SA_9 = 1;
    sbit  POCR2SA_10_bit at POCR2SAH.B2;
    const register unsigned short int POCR2SA_10 = 2;
    sbit  POCR2SA_11_bit at POCR2SAH.B3;
    const register unsigned short int POCR2SA_11 = 3;

sfr data unsigned short volatile POCR2SAL absolute 0xAC;
    sbit  POCR2SA_0_bit at POCR2SAL.B0;
    const register unsigned short int POCR2SA_0 = 0;
    sbit  POCR2SA_1_bit at POCR2SAL.B1;
    const register unsigned short int POCR2SA_1 = 1;
    sbit  POCR2SA_2_bit at POCR2SAL.B2;
    const register unsigned short int POCR2SA_2 = 2;
    sbit  POCR2SA_3_bit at POCR2SAL.B3;
    const register unsigned short int POCR2SA_3 = 3;
    sbit  POCR2SA_4_bit at POCR2SAL.B4;
    const register unsigned short int POCR2SA_4 = 4;
    sbit  POCR2SA_5_bit at POCR2SAL.B5;
    const register unsigned short int POCR2SA_5 = 5;
    sbit  POCR2SA_6_bit at POCR2SAL.B6;
    const register unsigned short int POCR2SA_6 = 6;
    sbit  POCR2SA_7_bit at POCR2SAL.B7;
    const register unsigned short int POCR2SA_7 = 7;

sfr data unsigned short volatile POCR1SBH absolute 0xAB;
    sbit  POCR1SB_8_bit at POCR1SBH.B0;
    const register unsigned short int POCR1SB_8 = 0;
    sbit  POCR1SB_9_bit at POCR1SBH.B1;
    const register unsigned short int POCR1SB_9 = 1;
    sbit  POCR1SB_10_bit at POCR1SBH.B2;
    const register unsigned short int POCR1SB_10 = 2;
    sbit  POCR1SB_11_bit at POCR1SBH.B3;
    const register unsigned short int POCR1SB_11 = 3;

sfr data unsigned short volatile POCR1SBL absolute 0xAA;
    sbit  POCR1SB_0_bit at POCR1SBL.B0;
    const register unsigned short int POCR1SB_0 = 0;
    sbit  POCR1SB_1_bit at POCR1SBL.B1;
    const register unsigned short int POCR1SB_1 = 1;
    sbit  POCR1SB_2_bit at POCR1SBL.B2;
    const register unsigned short int POCR1SB_2 = 2;
    sbit  POCR1SB_3_bit at POCR1SBL.B3;
    const register unsigned short int POCR1SB_3 = 3;
    sbit  POCR1SB_4_bit at POCR1SBL.B4;
    const register unsigned short int POCR1SB_4 = 4;
    sbit  POCR1SB_5_bit at POCR1SBL.B5;
    const register unsigned short int POCR1SB_5 = 5;
    sbit  POCR1SB_6_bit at POCR1SBL.B6;
    const register unsigned short int POCR1SB_6 = 6;
    sbit  POCR1SB_7_bit at POCR1SBL.B7;
    const register unsigned short int POCR1SB_7 = 7;

sfr data unsigned short volatile POCR1RAH absolute 0xA9;
    sbit  POCR1RA_8_bit at POCR1RAH.B0;
    const register unsigned short int POCR1RA_8 = 0;
    sbit  POCR1RA_9_bit at POCR1RAH.B1;
    const register unsigned short int POCR1RA_9 = 1;
    sbit  POCR1RA_10_bit at POCR1RAH.B2;
    const register unsigned short int POCR1RA_10 = 2;
    sbit  POCR1RA_11_bit at POCR1RAH.B3;
    const register unsigned short int POCR1RA_11 = 3;

sfr data unsigned short volatile POCR1RAL absolute 0xA8;
    sbit  POCR1RA_0_bit at POCR1RAL.B0;
    const register unsigned short int POCR1RA_0 = 0;
    sbit  POCR1RA_1_bit at POCR1RAL.B1;
    const register unsigned short int POCR1RA_1 = 1;
    sbit  POCR1RA_2_bit at POCR1RAL.B2;
    const register unsigned short int POCR1RA_2 = 2;
    sbit  POCR1RA_3_bit at POCR1RAL.B3;
    const register unsigned short int POCR1RA_3 = 3;
    sbit  POCR1RA_4_bit at POCR1RAL.B4;
    const register unsigned short int POCR1RA_4 = 4;
    sbit  POCR1RA_5_bit at POCR1RAL.B5;
    const register unsigned short int POCR1RA_5 = 5;
    sbit  POCR1RA_6_bit at POCR1RAL.B6;
    const register unsigned short int POCR1RA_6 = 6;
    sbit  POCR1RA_7_bit at POCR1RAL.B7;
    const register unsigned short int POCR1RA_7 = 7;

sfr data unsigned short volatile POCR1SAH absolute 0xA7;
    sbit  POCR1SA_8_bit at POCR1SAH.B0;
    const register unsigned short int POCR1SA_8 = 0;
    sbit  POCR1SA_9_bit at POCR1SAH.B1;
    const register unsigned short int POCR1SA_9 = 1;
    sbit  POCR1SA_10_bit at POCR1SAH.B2;
    const register unsigned short int POCR1SA_10 = 2;
    sbit  POCR1SA_11_bit at POCR1SAH.B3;
    const register unsigned short int POCR1SA_11 = 3;

sfr data unsigned short volatile POCR1SAL absolute 0xA6;
    sbit  POCR1SA_0_bit at POCR1SAL.B0;
    const register unsigned short int POCR1SA_0 = 0;
    sbit  POCR1SA_1_bit at POCR1SAL.B1;
    const register unsigned short int POCR1SA_1 = 1;
    sbit  POCR1SA_2_bit at POCR1SAL.B2;
    const register unsigned short int POCR1SA_2 = 2;
    sbit  POCR1SA_3_bit at POCR1SAL.B3;
    const register unsigned short int POCR1SA_3 = 3;
    sbit  POCR1SA_4_bit at POCR1SAL.B4;
    const register unsigned short int POCR1SA_4 = 4;
    sbit  POCR1SA_5_bit at POCR1SAL.B5;
    const register unsigned short int POCR1SA_5 = 5;
    sbit  POCR1SA_6_bit at POCR1SAL.B6;
    const register unsigned short int POCR1SA_6 = 6;
    sbit  POCR1SA_7_bit at POCR1SAL.B7;
    const register unsigned short int POCR1SA_7 = 7;

sfr data unsigned short volatile POCR0SBH absolute 0xA5;
    sbit  POCR0SB_8_bit at POCR0SBH.B0;
    const register unsigned short int POCR0SB_8 = 0;
    sbit  POCR0SB_9_bit at POCR0SBH.B1;
    const register unsigned short int POCR0SB_9 = 1;
    sbit  POCR0SB_10_bit at POCR0SBH.B2;
    const register unsigned short int POCR0SB_10 = 2;
    sbit  POCR0SB_11_bit at POCR0SBH.B3;
    const register unsigned short int POCR0SB_11 = 3;

sfr data unsigned short volatile POCR0SBL absolute 0xA4;
    sbit  POCR0SB_0_bit at POCR0SBL.B0;
    const register unsigned short int POCR0SB_0 = 0;
    sbit  POCR0SB_1_bit at POCR0SBL.B1;
    const register unsigned short int POCR0SB_1 = 1;
    sbit  POCR0SB_2_bit at POCR0SBL.B2;
    const register unsigned short int POCR0SB_2 = 2;
    sbit  POCR0SB_3_bit at POCR0SBL.B3;
    const register unsigned short int POCR0SB_3 = 3;
    sbit  POCR0SB_4_bit at POCR0SBL.B4;
    const register unsigned short int POCR0SB_4 = 4;
    sbit  POCR0SB_5_bit at POCR0SBL.B5;
    const register unsigned short int POCR0SB_5 = 5;
    sbit  POCR0SB_6_bit at POCR0SBL.B6;
    const register unsigned short int POCR0SB_6 = 6;
    sbit  POCR0SB_7_bit at POCR0SBL.B7;
    const register unsigned short int POCR0SB_7 = 7;

sfr data unsigned short volatile POCR0RAH absolute 0xA3;
    sbit  POCR0RA_8_bit at POCR0RAH.B0;
    const register unsigned short int POCR0RA_8 = 0;
    sbit  POCR0RA_9_bit at POCR0RAH.B1;
    const register unsigned short int POCR0RA_9 = 1;
    sbit  POCR0RA_10_bit at POCR0RAH.B2;
    const register unsigned short int POCR0RA_10 = 2;
    sbit  POCR0RA_11_bit at POCR0RAH.B3;
    const register unsigned short int POCR0RA_11 = 3;

sfr data unsigned short volatile POCR0RAL absolute 0xA2;
    sbit  POCR0RA_0_bit at POCR0RAL.B0;
    const register unsigned short int POCR0RA_0 = 0;
    sbit  POCR0RA_1_bit at POCR0RAL.B1;
    const register unsigned short int POCR0RA_1 = 1;
    sbit  POCR0RA_2_bit at POCR0RAL.B2;
    const register unsigned short int POCR0RA_2 = 2;
    sbit  POCR0RA_3_bit at POCR0RAL.B3;
    const register unsigned short int POCR0RA_3 = 3;
    sbit  POCR0RA_4_bit at POCR0RAL.B4;
    const register unsigned short int POCR0RA_4 = 4;
    sbit  POCR0RA_5_bit at POCR0RAL.B5;
    const register unsigned short int POCR0RA_5 = 5;
    sbit  POCR0RA_6_bit at POCR0RAL.B6;
    const register unsigned short int POCR0RA_6 = 6;
    sbit  POCR0RA_7_bit at POCR0RAL.B7;
    const register unsigned short int POCR0RA_7 = 7;

sfr data unsigned short volatile POCR0SAH absolute 0xA1;
    sbit  POCR0SA_8_bit at POCR0SAH.B0;
    const register unsigned short int POCR0SA_8 = 0;
    sbit  POCR0SA_9_bit at POCR0SAH.B1;
    const register unsigned short int POCR0SA_9 = 1;
    sbit  POCR0SA_10_bit at POCR0SAH.B2;
    const register unsigned short int POCR0SA_10 = 2;
    sbit  POCR0SA_11_bit at POCR0SAH.B3;
    const register unsigned short int POCR0SA_11 = 3;

sfr data unsigned short volatile POCR0SAL absolute 0xA0;
    sbit  POCR0SA_0_bit at POCR0SAL.B0;
    const register unsigned short int POCR0SA_0 = 0;
    sbit  POCR0SA_1_bit at POCR0SAL.B1;
    const register unsigned short int POCR0SA_1 = 1;
    sbit  POCR0SA_2_bit at POCR0SAL.B2;
    const register unsigned short int POCR0SA_2 = 2;
    sbit  POCR0SA_3_bit at POCR0SAL.B3;
    const register unsigned short int POCR0SA_3 = 3;
    sbit  POCR0SA_4_bit at POCR0SAL.B4;
    const register unsigned short int POCR0SA_4 = 4;
    sbit  POCR0SA_5_bit at POCR0SAL.B5;
    const register unsigned short int POCR0SA_5 = 5;
    sbit  POCR0SA_6_bit at POCR0SAL.B6;
    const register unsigned short int POCR0SA_6 = 6;
    sbit  POCR0SA_7_bit at POCR0SAL.B7;
    const register unsigned short int POCR0SA_7 = 7;
