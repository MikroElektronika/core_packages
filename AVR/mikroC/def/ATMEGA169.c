...
sfr io unsigned short EIMSK absolute 0x3D;
    ...
    sbit  PCIE0_bit at EIMSK.B6;
    const register unsigned short int PCIE0 = 6;
    sbit  PCIE1_bit at EIMSK.B7;
    const register unsigned short int PCIE1 = 7;

sfr io unsigned short volatile EIFR absolute 0x3C;
    sbit  INTF0_bit at EIFR.B0;
    const register unsigned short int INTF0 = 0;
    sbit  PCIF0_bit at EIFR.B6;
    const register unsigned short int PCIF0 = 6;
    sbit  PCIF1_bit at EIFR.B7;
    const register unsigned short int PCIF1 = 7;
