...
const unsigned int IVT_ADDR_TIMER1_IC        = 0x000E;
const unsigned int IVT_ADDR_TIMER1_COMPA     = 0x0010;
const unsigned int IVT_ADDR_TIMER1_COMPB     = 0x0012;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x0014;
const unsigned int IVT_ADDR_TIMER0_IC        = 0x0016;
const unsigned int IVT_ADDR_TIMER0_COMPA     = 0x0018;
const unsigned int IVT_ADDR_TIMER0_COMPB     = 0x001A;
const unsigned int IVT_ADDR_TIMER0_OVF       = 0x001C;
const unsigned int IVT_ADDR_SPI_STC          = 0x001E;
const unsigned int IVT_ADDR_VADC             = 0x0020;
const unsigned int IVT_ADDR_CCADC_CONV       = 0x0022;
const unsigned int IVT_ADDR_CCADC_REG_CUR    = 0x0024;
const unsigned int IVT_ADDR_CCADC_ACC        = 0x0026;
...
sfr data unsigned short volatile CADRC absolute 0xE6;
    sbit  CADRC0_bit at CADRC.B0;
    const register unsigned short int CADRC0 = 0;
    sbit  CADRC1_bit at CADRC.B1;
    const register unsigned short int CADRC1 = 1;
    sbit  CADRC2_bit at CADRC.B2;
    const register unsigned short int CADRC2 = 2;
    sbit  CADRC3_bit at CADRC.B3;
    const register unsigned short int CADRC3 = 3;
    sbit  CADRC4_bit at CADRC.B4;
    const register unsigned short int CADRC4 = 4;
    sbit  CADRC5_bit at CADRC.B5;
    const register unsigned short int CADRC5 = 5;
    sbit  CADRC6_bit at CADRC.B6;
    const register unsigned short int CADRC6 = 6;
    sbit  CADRC7_bit at CADRC.B7;
    const register unsigned short int CADRC7 = 7;
...
sfr io unsigned short volatile EEARL absolute 0x41;
sfr io unsigned short volatile EEAR absolute 0x41;
