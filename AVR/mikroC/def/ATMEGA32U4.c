...
const unsigned long __FLASH_SIZE = 0x00007000;
...
const unsigned int IVT_ADDR_Reserved1        = 0x000A;
const unsigned int IVT_ADDR_Reserved2        = 0x000C;
const unsigned int IVT_ADDR_INT6             = 0x000E;
const unsigned int IVT_ADDR_Reserved3        = 0x0010;
...
const unsigned int IVT_ADDR_Reserved4        = 0x001A;
const unsigned int IVT_ADDR_Reserved5        = 0x001C;
const unsigned int IVT_ADDR_Reserved6        = 0x001E;
...
const unsigned int IVT_ADDR_TIMER4_COMPA     = 0x004C;
const unsigned int IVT_ADDR_TIMER4_COMPB     = 0x004E;
const unsigned int IVT_ADDR_TIMER4_COMPD     = 0x0050;
const unsigned int IVT_ADDR_TIMER4_OVF       = 0x0052;
const unsigned int IVT_ADDR_TIMER4_FPF       = 0x0054;
...
sfr io unsigned short volatile PLLCSR absolute 0x49;
    ...
    sbit  PINDIV_bit at PLLCSR.B4;
    const register unsigned short int PINDIV = 4;

sfr io unsigned short volatile PLLFRQ absolute 0x52;
    sbit  PDIV0_bit at PLLFRQ.B0;
    const register unsigned short int PDIV0 = 0;
    sbit  PDIV1_bit at PLLFRQ.B1;
    const register unsigned short int PDIV1 = 1;
    sbit  PDIV2_bit at PLLFRQ.B2;
    const register unsigned short int PDIV2 = 2;
    sbit  PDIV3_bit at PLLFRQ.B3;
    const register unsigned short int PDIV3 = 3;
    sbit  PLLTM0_bit at PLLFRQ.B4;
    const register unsigned short int PLLTM0 = 4;
    sbit  PLLTM1_bit at PLLFRQ.B5;
    const register unsigned short int PLLTM1 = 5;
    sbit  PLLUSB_bit at PLLFRQ.B6;
    const register unsigned short int PLLUSB = 6;
    sbit  PINMUX_bit at PLLFRQ.B7;
    const register unsigned short int PINMUX = 7;
...
sfr data unsigned short volatile UDCON absolute 0xE0;
    ...
    sbit  RSTCPU_bit at UDCON.B3;
    const register unsigned short int RSTCPU = 3;
...
sfr data unsigned short ADCSRB absolute 0x7B;
    ...
    sbit  ADTS3_bit at ADCSRB.B4;
    const register unsigned short int ADTS3 = 4;
    sbit  MUX5_bit at ADCSRB.B5;
...
sfr data unsigned short TIMSK4 absolute 0x72;
    sbit  TOIE4_bit at TIMSK4.B2;
    const register unsigned short int TOIE4 = 2;
    sbit  OCIE4B_bit at TIMSK4.B5;
    const register unsigned short int OCIE4B = 5;
    sbit  OCIE4A_bit at TIMSK4.B6;
    const register unsigned short int OCIE4A = 6;
    sbit  OCIE4D_bit at TIMSK4.B7;
    const register unsigned short int OCIE4D = 7;
...
sfr data unsigned short volatile RCCTRL absolute 0x67;
    sbit  RCFREQ_bit at RCCTRL.B0;
    const register unsigned short int RCFREQ = 0;
...
sfr io unsigned short volatile TIFR4 absolute 0x39;
    sbit  TOV4_bit at TIFR4.B2;
    const register unsigned short int TOV4 = 2;
    sbit  OCF4B_bit at TIFR4.B5;
    const register unsigned short int OCF4B = 5;
    sbit  OCF4A_bit at TIFR4.B6;
    const register unsigned short int OCF4A = 6;
    sbit  OCF4D_bit at TIFR4.B7;
    const register unsigned short int OCF4D = 7;
...
sfr data unsigned short volatile DT4 absolute 0xD4;
    sbit  DT4L0_bit at DT4.B0;
    const register unsigned short int DT4L0 = 0;
    sbit  DT4L1_bit at DT4.B1;
    const register unsigned short int DT4L1 = 1;
    sbit  DT4L2_bit at DT4.B2;
    const register unsigned short int DT4L2 = 2;
    sbit  DT4L3_bit at DT4.B3;
    const register unsigned short int DT4L3 = 3;
    sbit  DT4L4_bit at DT4.B4;
    const register unsigned short int DT4L4 = 4;
    sbit  DT4L5_bit at DT4.B5;
    const register unsigned short int DT4L5 = 5;
    sbit  DT4L6_bit at DT4.B6;
    const register unsigned short int DT4L6 = 6;
    sbit  DT4L7_bit at DT4.B7;
    const register unsigned short int DT4L7 = 7;

sfr data unsigned short volatile OCR4D absolute 0xD2;
    sbit  OCR4D0_bit at OCR4D.B0;
    const register unsigned short int OCR4D0 = 0;
    sbit  OCR4D1_bit at OCR4D.B1;
    const register unsigned short int OCR4D1 = 1;
    sbit  OCR4D2_bit at OCR4D.B2;
    const register unsigned short int OCR4D2 = 2;
    sbit  OCR4D3_bit at OCR4D.B3;
    const register unsigned short int OCR4D3 = 3;
    sbit  OCR4D4_bit at OCR4D.B4;
    const register unsigned short int OCR4D4 = 4;
    sbit  OCR4D5_bit at OCR4D.B5;
    const register unsigned short int OCR4D5 = 5;
    sbit  OCR4D6_bit at OCR4D.B6;
    const register unsigned short int OCR4D6 = 6;
    sbit  OCR4D7_bit at OCR4D.B7;
    const register unsigned short int OCR4D7 = 7;

sfr data unsigned short volatile OCR4C absolute 0xD1;
    sbit  OCR4C0_bit at OCR4C.B0;
    const register unsigned short int OCR4C0 = 0;
    sbit  OCR4C1_bit at OCR4C.B1;
    const register unsigned short int OCR4C1 = 1;
    sbit  OCR4C2_bit at OCR4C.B2;
    const register unsigned short int OCR4C2 = 2;
    sbit  OCR4C3_bit at OCR4C.B3;
    const register unsigned short int OCR4C3 = 3;
    sbit  OCR4C4_bit at OCR4C.B4;
    const register unsigned short int OCR4C4 = 4;
    sbit  OCR4C5_bit at OCR4C.B5;
    const register unsigned short int OCR4C5 = 5;
    sbit  OCR4C6_bit at OCR4C.B6;
    const register unsigned short int OCR4C6 = 6;
    sbit  OCR4C7_bit at OCR4C.B7;
    const register unsigned short int OCR4C7 = 7;

sfr data unsigned short volatile OCR4B absolute 0xD0;
    sbit  OCR4B0_bit at OCR4B.B0;
    const register unsigned short int OCR4B0 = 0;
    sbit  OCR4B1_bit at OCR4B.B1;
    const register unsigned short int OCR4B1 = 1;
    sbit  OCR4B2_bit at OCR4B.B2;
    const register unsigned short int OCR4B2 = 2;
    sbit  OCR4B3_bit at OCR4B.B3;
    const register unsigned short int OCR4B3 = 3;
    sbit  OCR4B4_bit at OCR4B.B4;
    const register unsigned short int OCR4B4 = 4;
    sbit  OCR4B5_bit at OCR4B.B5;
    const register unsigned short int OCR4B5 = 5;
    sbit  OCR4B6_bit at OCR4B.B6;
    const register unsigned short int OCR4B6 = 6;
    sbit  OCR4B7_bit at OCR4B.B7;
    const register unsigned short int OCR4B7 = 7;

sfr data unsigned short volatile OCR4A absolute 0xCF;
    sbit  OCR4A0_bit at OCR4A.B0;
    const register unsigned short int OCR4A0 = 0;
    sbit  OCR4A1_bit at OCR4A.B1;
    const register unsigned short int OCR4A1 = 1;
    sbit  OCR4A2_bit at OCR4A.B2;
    const register unsigned short int OCR4A2 = 2;
    sbit  OCR4A3_bit at OCR4A.B3;
    const register unsigned short int OCR4A3 = 3;
    sbit  OCR4A4_bit at OCR4A.B4;
    const register unsigned short int OCR4A4 = 4;
    sbit  OCR4A5_bit at OCR4A.B5;
    const register unsigned short int OCR4A5 = 5;
    sbit  OCR4A6_bit at OCR4A.B6;
    const register unsigned short int OCR4A6 = 6;
    sbit  OCR4A7_bit at OCR4A.B7;
    const register unsigned short int OCR4A7 = 7;

sfr data unsigned short volatile TCCR4E absolute 0xC4;
    sbit  OC4OE0_bit at TCCR4E.B0;
    const register unsigned short int OC4OE0 = 0;
    sbit  OC4OE1_bit at TCCR4E.B1;
    const register unsigned short int OC4OE1 = 1;
    sbit  OC4OE2_bit at TCCR4E.B2;
    const register unsigned short int OC4OE2 = 2;
    sbit  OC4OE3_bit at TCCR4E.B3;
    const register unsigned short int OC4OE3 = 3;
    sbit  OC4OE4_bit at TCCR4E.B4;
    const register unsigned short int OC4OE4 = 4;
    sbit  OC4OE5_bit at TCCR4E.B5;
    const register unsigned short int OC4OE5 = 5;
    sbit  ENHC4_bit at TCCR4E.B6;
    const register unsigned short int ENHC4 = 6;
    sbit  TLOCK4_bit at TCCR4E.B7;
    const register unsigned short int TLOCK4 = 7;

sfr data unsigned short volatile TCCR4D absolute 0xC3;
    sbit  WGM40_bit at TCCR4D.B0;
    const register unsigned short int WGM40 = 0;
    sbit  WGM41_bit at TCCR4D.B1;
    const register unsigned short int WGM41 = 1;
    sbit  FPF4_bit at TCCR4D.B2;
    const register unsigned short int FPF4 = 2;
    sbit  FPAC4_bit at TCCR4D.B3;
    const register unsigned short int FPAC4 = 3;
    sbit  FPES4_bit at TCCR4D.B4;
    const register unsigned short int FPES4 = 4;
    sbit  FPNC4_bit at TCCR4D.B5;
    const register unsigned short int FPNC4 = 5;
    sbit  FPEN4_bit at TCCR4D.B6;
    const register unsigned short int FPEN4 = 6;
    sbit  FPIE4_bit at TCCR4D.B7;
    const register unsigned short int FPIE4 = 7;

sfr data unsigned short volatile TCCR4C absolute 0xC2;
    sbit  PWM4D_bit at TCCR4C.B0;
    const register unsigned short int PWM4D = 0;
    sbit  FOC4D_bit at TCCR4C.B1;
    const register unsigned short int FOC4D = 1;
    sbit  COM4D0_bit at TCCR4C.B2;
    const register unsigned short int COM4D0 = 2;
    sbit  COM4D1_bit at TCCR4C.B3;
    const register unsigned short int COM4D1 = 3;
    sbit  COM4B0S_bit at TCCR4C.B4;
    const register unsigned short int COM4B0S = 4;
    sbit  COM4B1S_bit at TCCR4C.B5;
    const register unsigned short int COM4B1S = 5;
    sbit  COM4A0S_bit at TCCR4C.B6;
    const register unsigned short int COM4A0S = 6;
    sbit  COM4A1S_bit at TCCR4C.B7;
    const register unsigned short int COM4A1S = 7;

sfr data unsigned short volatile TCCR4B absolute 0xC1;
    ...
    sbit  CS43_bit at TCCR4B.B3;
    const register unsigned short int CS43 = 3;
    sbit  DTPS40_bit at TCCR4B.B4;
    const register unsigned short int DTPS40 = 4;
    sbit  DTPS41_bit at TCCR4B.B5;
    const register unsigned short int DTPS41 = 5;
    sbit  PSR4_bit at TCCR4B.B6;
    const register unsigned short int PSR4 = 6;
    sbit  PWM4X_bit at TCCR4B.B7;
    const register unsigned short int PWM4X = 7;

sfr data unsigned short volatile TCCR4A absolute 0xC0;
    sbit  PWM4B_bit at TCCR4A.B0;
    const register unsigned short int PWM4B = 0;
    sbit  PWM4A_bit at TCCR4A.B1;
    const register unsigned short int PWM4A = 1;
    sbit  FOC4B_bit at TCCR4A.B2;
    const register unsigned short int FOC4B = 2;
    sbit  FOC4A_bit at TCCR4A.B3;
    const register unsigned short int FOC4A = 3;
...
sfr data unsigned short volatile TC4H absolute 0xBF;
    sbit  TC48_bit at TC4H.B0;
    const register unsigned short int TC48 = 0;
    sbit  TC49_bit at TC4H.B1;
    const register unsigned short int TC49 = 1;
    sbit  TC410_bit at TC4H.B2;
    const register unsigned short int TC410 = 2;

sfr data unsigned short volatile TCNT4 absolute 0xBE;
    sbit  TC40_bit at TCNT4.B0;
    const register unsigned short int TC40 = 0;
    sbit  TC41_bit at TCNT4.B1;
    const register unsigned short int TC41 = 1;
    sbit  TC42_bit at TCNT4.B2;
    const register unsigned short int TC42 = 2;
    sbit  TC43_bit at TCNT4.B3;
    const register unsigned short int TC43 = 3;
    sbit  TC44_bit at TCNT4.B4;
    const register unsigned short int TC44 = 4;
    sbit  TC45_bit at TCNT4.B5;
    const register unsigned short int TC45 = 5;
    sbit  TC46_bit at TCNT4.B6;
    const register unsigned short int TC46 = 6;
    sbit  TC47_bit at TCNT4.B7;
    const register unsigned short int TC47 = 7;

sfr data unsigned short volatile CLKSEL1 absolute 0xC6;
...
sfr data unsigned short volatile CLKSEL0 absolute 0xC5;
...
sfr data unsigned short volatile CLKSTA absolute 0xC7;
