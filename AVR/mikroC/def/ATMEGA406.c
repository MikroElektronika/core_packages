...
const unsigned long __FLASH_SIZE = 0x0000A000;
...
const unsigned int IVT_ADDR_INT0             = 0x0004;
const unsigned int IVT_ADDR_INT1             = 0x0006;
const unsigned int IVT_ADDR_INT2             = 0x0008;
const unsigned int IVT_ADDR_INT3             = 0x000A;
const unsigned int IVT_ADDR_PCINT0           = 0x000C;
const unsigned int IVT_ADDR_PCINT1           = 0x000E;
const unsigned int IVT_ADDR_WDT              = 0x0010;
const unsigned int IVT_ADDR_WAKE_UP          = 0x0012;
const unsigned int IVT_ADDR_TIM1_COMP        = 0x0014;
const unsigned int IVT_ADDR_TIM1_OVF         = 0x0016;
const unsigned int IVT_ADDR_TIM0_COMPA       = 0x0018;
const unsigned int IVT_ADDR_TIM0_COMPB       = 0x001A;
const unsigned int IVT_ADDR_TIM0_OVF         = 0x001C;
const unsigned int IVT_ADDR_TWI_BUS_CD       = 0x001E;
const unsigned int IVT_ADDR_TWI              = 0x0020;
const unsigned int IVT_ADDR_VADC             = 0x0022;
const unsigned int IVT_ADDR_CCADC_CONV       = 0x0024;
const unsigned int IVT_ADDR_CCADC_REG_CUR    = 0x0026;
const unsigned int IVT_ADDR_CCADC_ACC        = 0x0028;
const unsigned int IVT_ADDR_EE_READY         = 0x002A;
const unsigned int IVT_ADDR_SPM_READY        = 0x002C;


sfr data unsigned short volatile BPPLR absolute 0xF8;
...
sfr data unsigned short volatile BPCR absolute 0xF7;
    sbit  CCD_bit at BPCR.B0;
    const register unsigned short int CCD = 0;
    sbit  DCD_bit at BPCR.B1;
    const register unsigned short int DCD = 1;
    sbit  SCD_bit at BPCR.B2;
    const register unsigned short int SCD = 2;
    sbit  DUVD_bit at BPCR.B3;
    const register unsigned short int DUVD = 3;

sfr data unsigned short volatile CBPTR absolute 0xF6;
    sbit  OCPT0_bit at CBPTR.B0;
    const register unsigned short int OCPT0 = 0;
    sbit  OCPT1_bit at CBPTR.B1;
    const register unsigned short int OCPT1 = 1;
    sbit  OCPT2_bit at CBPTR.B2;
    const register unsigned short int OCPT2 = 2;
    sbit  OCPT3_bit at CBPTR.B3;
    const register unsigned short int OCPT3 = 3;
    sbit  SCPT0_bit at CBPTR.B4;
    const register unsigned short int SCPT0 = 4;
    sbit  SCPT1_bit at CBPTR.B5;
    const register unsigned short int SCPT1 = 5;
    sbit  SCPT2_bit at CBPTR.B6;
    const register unsigned short int SCPT2 = 6;
    sbit  SCPT3_bit at CBPTR.B7;
    const register unsigned short int SCPT3 = 7;

sfr data unsigned short volatile BPOCD absolute 0xF5;
    sbit  CCDL0_bit at BPOCD.B0;
    const register unsigned short int CCDL0 = 0;
    sbit  CCDL1_bit at BPOCD.B1;
    const register unsigned short int CCDL1 = 1;
    sbit  CCDL2_bit at BPOCD.B2;
    const register unsigned short int CCDL2 = 2;
    sbit  CCDL3_bit at BPOCD.B3;
    const register unsigned short int CCDL3 = 3;
    sbit  DCDL0_bit at BPOCD.B4;
    const register unsigned short int DCDL0 = 4;
    sbit  DCDL1_bit at BPOCD.B5;
    const register unsigned short int DCDL1 = 5;
    sbit  DCDL2_bit at BPOCD.B6;
    const register unsigned short int DCDL2 = 6;
    sbit  DCDL3_bit at BPOCD.B7;
    const register unsigned short int DCDL3 = 7;

sfr data unsigned short volatile BPSCD absolute 0xF4;
...
sfr data unsigned short volatile BPDUV absolute 0xF3;
    sbit  DUDL0_bit at BPDUV.B0;
    const register unsigned short int DUDL0 = 0;
    sbit  DUDL1_bit at BPDUV.B1;
    const register unsigned short int DUDL1 = 1;
    sbit  DUDL2_bit at BPDUV.B2;
    const register unsigned short int DUDL2 = 2;
    sbit  DUDL3_bit at BPDUV.B3;
    const register unsigned short int DUDL3 = 3;
    sbit  DUVT0_bit at BPDUV.B4;
    const register unsigned short int DUVT0 = 4;
    sbit  DUVT1_bit at BPDUV.B5;
    const register unsigned short int DUVT1 = 5;

sfr data unsigned short volatile BPIR absolute 0xF2;
    sbit  SCIE_bit at BPIR.B0;
    const register unsigned short int SCIE = 0;
    sbit  DOCIE_bit at BPIR.B1;
    const register unsigned short int DOCIE = 1;
    sbit  COCIE_bit at BPIR.B2;
    const register unsigned short int COCIE = 2;
    sbit  DUVIE_bit at BPIR.B3;
    const register unsigned short int DUVIE = 3;
    sbit  SCIF_bit at BPIR.B4;
    const register unsigned short int SCIF = 4;
    sbit  DOCIF_bit at BPIR.B5;
    const register unsigned short int DOCIF = 5;
    sbit  COCIF_bit at BPIR.B6;
    const register unsigned short int COCIF = 6;
    sbit  DUVIF_bit at BPIR.B7;
    const register unsigned short int DUVIF = 7;
...
sfr data unsigned short volatile FCSR absolute 0xF0;
    sbit  PFD_bit at FCSR.B0;
    const register unsigned short int PFD = 0;
    sbit  CFE_bit at FCSR.B1;
    const register unsigned short int CFE = 1;
    sbit  DFE_bit at FCSR.B2;
    const register unsigned short int DFE = 2;
    sbit  CPS_bit at FCSR.B3;
    const register unsigned short int CPS = 3;
    sbit  PWMOPC_bit at FCSR.B4;
    const register unsigned short int PWMOPC = 4;
    sbit  PWMOC_bit at FCSR.B5;
    const register unsigned short int PWMOC = 5;

sfr data unsigned short volatile CADICH absolute 0xE9;
...
sfr data unsigned short volatile CADICL absolute 0xE8;
...
sfr data unsigned short volatile CADRDC absolute 0xE7;
...
sfr data unsigned short volatile CADRCC absolute 0xE6;
...
sfr data unsigned short volatile CADCSRB absolute 0xE5;
...
sfr data unsigned short volatile CADCSRA absolute 0xE4;
...
sfr data unsigned short volatile BGCCR absolute 0xD0;
    ...
    sbit  BGD_bit at BGCCR.B7;
    const register unsigned short int BGD = 7;

sfr data unsigned short volatile CCSR absolute 0xC0;
    sbit  ACS_bit at CCSR.B0;
    const register unsigned short int ACS = 0;
    sbit  XOE_bit at CCSR.B1;
    const register unsigned short int XOE = 1;
...
sfr data unsigned short DIDR0 absolute 0x7E;
    sbit  VADC0D_bit at DIDR0.B0;
    const register unsigned short int VADC0D = 0;
    sbit  VADC1D_bit at DIDR0.B1;
    const register unsigned short int VADC1D = 1;
    sbit  VADC2D_bit at DIDR0.B2;
    const register unsigned short int VADC2D = 2;
    sbit  VADC3D_bit at DIDR0.B3;
    const register unsigned short int VADC3D = 3;
...
sfr data unsigned short PRR0 absolute 0x64;
    ...
    sbit  PRTWI_bit at PRR0.B3;
    const register unsigned short int PRTWI = 3;

sfr data unsigned short volatile WUTCSR absolute 0x62;
    sbit  WUTP0_bit at WUTCSR.B0;
    const register unsigned short int WUTP0 = 0;
    sbit  WUTP1_bit at WUTCSR.B1;
    const register unsigned short int WUTP1 = 1;
    sbit  WUTP2_bit at WUTCSR.B2;
    const register unsigned short int WUTP2 = 2;
    sbit  WUTE_bit at WUTCSR.B3;
    const register unsigned short int WUTE = 3;
    sbit  WUTR_bit at WUTCSR.B4;
    const register unsigned short int WUTR = 4;
    sbit  WUTCF_bit at WUTCSR.B5;
    const register unsigned short int WUTCF = 5;
    sbit  WUTIE_bit at WUTCSR.B6;
    const register unsigned short int WUTIE = 6;
    sbit  WUTIF_bit at WUTCSR.B7;
    const register unsigned short int WUTIF = 7;
