...
const unsigned short IVT_ADDR_WDT = 0x0006;
const unsigned short IVT_ADDR_TIMER2_COMPA = 0x0007;
const unsigned short IVT_ADDR_TIMER2_COMPB = 0x0008;
const unsigned short IVT_ADDR_TIMER2_OVF = 0x0009;
const unsigned short IVT_ADDR_TIMER1_CAPT = 0x000A;
const unsigned short IVT_ADDR_TIMER1_COMPA = 0x000B;
const unsigned short IVT_ADDR_TIMER1_COMPB = 0x000C;
const unsigned short IVT_ADDR_TIMER1_OVF = 0x000D;
const unsigned short IVT_ADDR_TIMER0_COMPA = 0x000E;
const unsigned short IVT_ADDR_TIMER0_COMPB = 0x000F;
const unsigned short IVT_ADDR_TIMER0_OVF = 0x0010;
const unsigned short IVT_ADDR_SPI_STC = 0x0011;
const unsigned short IVT_ADDR_USART_RX = 0x0012;
const unsigned short IVT_ADDR_USART_UDRE = 0x0013;
const unsigned short IVT_ADDR_USART_TX = 0x0014;
const unsigned short IVT_ADDR_ADC = 0x0015;
const unsigned short IVT_ADDR_EE_READY = 0x0016;
const unsigned short IVT_ADDR_ANALOG_COMP = 0x0017;
const unsigned short IVT_ADDR_TWI = 0x0018;
const unsigned short IVT_ADDR_SPM_Ready = 0x0019;
const unsigned short IVT_ADDR_USART_START = 0x001A;
