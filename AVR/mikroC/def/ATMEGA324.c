...
sfr data unsigned short OCR1BH absolute 0x8B;
    sbit  OCR1AH0_bit at OCR1BH.B0;
    const register unsigned short int OCR1AH0 = 0;
    sbit  OCR1AH1_bit at OCR1BH.B1;
    const register unsigned short int OCR1AH1 = 1;
    sbit  OCR1AH2_bit at OCR1BH.B2;
    const register unsigned short int OCR1AH2 = 2;
    sbit  OCR1AH3_bit at OCR1BH.B3;
    const register unsigned short int OCR1AH3 = 3;
    sbit  OCR1AH4_bit at OCR1BH.B4;
    const register unsigned short int OCR1AH4 = 4;
    sbit  OCR1AH5_bit at OCR1BH.B5;
    const register unsigned short int OCR1AH5 = 5;
    sbit  OCR1AH6_bit at OCR1BH.B6;
    const register unsigned short int OCR1AH6 = 6;
    sbit  OCR1AH7_bit at OCR1BH.B7;
    const register unsigned short int OCR1AH7 = 7;

sfr data unsigned short OCR1BL absolute 0x8A;
    sbit  OCR1AL0_bit at OCR1BL.B0;
    const register unsigned short int OCR1AL0 = 0;
    sbit  OCR1AL1_bit at OCR1BL.B1;
    const register unsigned short int OCR1AL1 = 1;
    sbit  OCR1AL2_bit at OCR1BL.B2;
    const register unsigned short int OCR1AL2 = 2;
    sbit  OCR1AL3_bit at OCR1BL.B3;
    const register unsigned short int OCR1AL3 = 3;
    sbit  OCR1AL4_bit at OCR1BL.B4;
    const register unsigned short int OCR1AL4 = 4;
    sbit  OCR1AL5_bit at OCR1BL.B5;
    const register unsigned short int OCR1AL5 = 5;
    sbit  OCR1AL6_bit at OCR1BL.B6;
    const register unsigned short int OCR1AL6 = 6;
    sbit  OCR1AL7_bit at OCR1BL.B7;
    const register unsigned short int OCR1AL7 = 7;

sfr data unsigned short OCR1AH absolute 0x89;
    sbit  OCR1AH0_OCR1AH_bit at OCR1AH.B0;
    sbit  OCR1AH1_OCR1AH_bit at OCR1AH.B1;
    sbit  OCR1AH2_OCR1AH_bit at OCR1AH.B2;
    sbit  OCR1AH3_OCR1AH_bit at OCR1AH.B3;
    sbit  OCR1AH4_OCR1AH_bit at OCR1AH.B4;
    sbit  OCR1AH5_OCR1AH_bit at OCR1AH.B5;
    sbit  OCR1AH6_OCR1AH_bit at OCR1AH.B6;
    sbit  OCR1AH7_OCR1AH_bit at OCR1AH.B7;

sfr data unsigned short OCR1AL absolute 0x88;
    sbit  OCR1AL0_OCR1AL_bit at OCR1AL.B0;
    sbit  OCR1AL1_OCR1AL_bit at OCR1AL.B1;
    sbit  OCR1AL2_OCR1AL_bit at OCR1AL.B2;
    sbit  OCR1AL3_OCR1AL_bit at OCR1AL.B3;
    sbit  OCR1AL4_OCR1AL_bit at OCR1AL.B4;
    sbit  OCR1AL5_OCR1AL_bit at OCR1AL.B5;
    sbit  OCR1AL6_OCR1AL_bit at OCR1AL.B6;
    sbit  OCR1AL7_OCR1AL_bit at OCR1AL.B7;
...
sfr data unsigned short volatile CLKPR absolute 0x61;
    ...
    sbit  CPKPCE_bit at CLKPR.B7;
    const register unsigned short int CPKPCE = 7;
...
sfr io unsigned short volatile SPDR0 absolute 0x4E;
    sbit  SPDRB0_bit at SPDR0.B0;
    const register unsigned short int SPDRB0 = 0;
    sbit  SPDRB1_bit at SPDR0.B1;
    const register unsigned short int SPDRB1 = 1;
    sbit  SPDRB2_bit at SPDR0.B2;
    const register unsigned short int SPDRB2 = 2;
    sbit  SPDRB3_bit at SPDR0.B3;
    const register unsigned short int SPDRB3 = 3;
    sbit  SPDRB4_bit at SPDR0.B4;
    const register unsigned short int SPDRB4 = 4;
    sbit  SPDRB5_bit at SPDR0.B5;
    const register unsigned short int SPDRB5 = 5;
    sbit  SPDRB6_bit at SPDR0.B6;
    const register unsigned short int SPDRB6 = 6;
    sbit  SPDRB7_bit at SPDR0.B7;
    const register unsigned short int SPDRB7 = 7;

sfr io unsigned short volatile SPSR absolute 0x4D;
sfr io unsigned short volatile SPSR0 absolute 0x4D;
    sbit  SPI2X_bit at SPSR0.B0;
    const register unsigned short int SPI2X = 0;
    sbit  SPI2X0_bit at SPSR0.B0;
    const register unsigned short int SPI2X0 = 0;
    sbit  WCOL0_bit at SPSR0.B6;
    const register unsigned short int WCOL0 = 6;
    sbit  SPIF_bit at SPSR0.B7;
    const register unsigned short int SPIF = 7;
    sbit  SPIF0_bit at SPSR0.B7;
    const register unsigned short int SPIF0 = 7;

sfr io unsigned short volatile SPCR absolute 0x4C;
sfr io unsigned short volatile SPCR0 absolute 0x4C;
    sbit  SPR00_bit at SPCR0.B0;
    const register unsigned short int SPR00 = 0;
    sbit  SPR10_bit at SPCR0.B1;
    const register unsigned short int SPR10 = 1;
    sbit  CPHA0_bit at SPCR0.B2;
    const register unsigned short int CPHA0 = 2;
    sbit  CPOL0_bit at SPCR0.B3;
    const register unsigned short int CPOL0 = 3;
    sbit  MSTR0_bit at SPCR0.B4;
    const register unsigned short int MSTR0 = 4;
    sbit  DORD0_bit at SPCR0.B5;
    const register unsigned short int DORD0 = 5;
    sbit  SPE0_bit at SPCR0.B6;
    const register unsigned short int SPE0 = 6;
    sbit  SPIE0_bit at SPCR0.B7;
    const register unsigned short int SPIE0 = 7;
...
sfr io unsigned short OCR0A absolute 0x47;
    sbit  OCROA_0_bit at OCR0A.B0;
    const register unsigned short int OCROA_0 = 0;
    sbit  OCROA_1_bit at OCR0A.B1;
    const register unsigned short int OCROA_1 = 1;
    sbit  OCROA_2_bit at OCR0A.B2;
    const register unsigned short int OCROA_2 = 2;
    sbit  OCROA_3_bit at OCR0A.B3;
    const register unsigned short int OCROA_3 = 3;
    sbit  OCROA_4_bit at OCR0A.B4;
    const register unsigned short int OCROA_4 = 4;
    sbit  OCROA_5_bit at OCR0A.B5;
    const register unsigned short int OCROA_5 = 5;
    sbit  OCROA_6_bit at OCR0A.B6;
    const register unsigned short int OCROA_6 = 6;
    sbit  OCROA_7_bit at OCR0A.B7;
    const register unsigned short int OCROA_7 = 7;
