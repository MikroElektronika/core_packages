...
const unsigned int IVT_ADDR_TIMER1_CAPT      = 0x0003;
const unsigned int IVT_ADDR_TIMER1_COMPA     = 0x0004;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x0005;
const unsigned int IVT_ADDR_TIMER0_OVF       = 0x0006;
const unsigned int IVT_ADDR_USART__RX        = 0x0007;
const unsigned int IVT_ADDR_USART__UDRE      = 0x0008;
const unsigned int IVT_ADDR_USART__TX        = 0x0009;
const unsigned int IVT_ADDR_ANA_COMP         = 0x000A;
const unsigned int IVT_ADDR_PCINT_B          = 0x000B;
const unsigned int IVT_ADDR_TIMER1_COMPB     = 0x000C;
const unsigned int IVT_ADDR_TIMER0_COMPA     = 0x000D;
const unsigned int IVT_ADDR_TIMER0_COMPB     = 0x000E;
const unsigned int IVT_ADDR_USI_START        = 0x000F;
const unsigned int IVT_ADDR_USI_OVERFLOW     = 0x0010;
const unsigned int IVT_ADDR_EEPROM_Ready     = 0x0011;
const unsigned int IVT_ADDR_WDT_OVERFLOW     = 0x0012;
const unsigned int IVT_ADDR_PCINT_A          = 0x0013;
const unsigned int IVT_ADDR_PCINT_D          = 0x0014;
...
sfr io unsigned short volatile MCUCR absolute 0x55;
    ...
    sbit  PUD_bit at MCUCR.B7;
    const register unsigned short int PUD = 7;
...
sfr io unsigned short volatile PCMSK absolute 0x40;
    ...
    sbit  PCINT6_bit at PCMSK.B6;
    const register unsigned short int PCINT6 = 6;
    sbit  PCINT7_bit at PCMSK.B7;
...
sfr io unsigned short volatile UCSRA absolute 0x02B;
...
sfr io unsigned short volatile UCSR0B absolute 0x02A;
sfr io unsigned short volatile UCSRB absolute 0x02A;
...
sfr io unsigned short volatile BODCR absolute 0x27;
    sbit  BPDSE_bit at BODCR.B0;
    const register unsigned short int BPDSE = 0;
    sbit  BPDS_bit at BODCR.B1;
    const register unsigned short int BPDS = 1;

sfr io unsigned short volatile PRR absolute 0x26;
    sbit  PRUSART_bit at PRR.B0;
    const register unsigned short int PRUSART = 0;
...
sfr io unsigned short PCMSK2 absolute 0x25;
    sbit  PCINT11_bit at PCMSK2.B0;
    const register unsigned short int PCINT11 = 0;
    sbit  PCINT12_bit at PCMSK2.B1;
    const register unsigned short int PCINT12 = 1;
    sbit  PCINT13_bit at PCMSK2.B2;
    const register unsigned short int PCINT13 = 2;
    sbit  PCINT14_bit at PCMSK2.B3;
    const register unsigned short int PCINT14 = 3;
    sbit  PCINT15_bit at PCMSK2.B4;
    const register unsigned short int PCINT15 = 4;
    sbit  PCINT16_bit at PCMSK2.B5;
    const register unsigned short int PCINT16 = 5;
    sbit  PCINT17_bit at PCMSK2.B6;
    const register unsigned short int PCINT17 = 6;

sfr io unsigned short PCMSK1 absolute 0x24;
...
sfr io unsigned short volatile UCSR0C absolute 0x23;
sfr io unsigned short volatile UCSRC absolute 0x23;
...
sfr io unsigned short UBRRH absolute 0x22;
...
sfr io unsigned short volatile DIDR absolute 0x21;
    sbit  AIN0D_bit at DIDR.B0;
    const register unsigned short int AIN0D = 0;
    sbit  AIN1D_bit at DIDR.B1;
