...
const unsigned int IVT_ADDR_TIMER2_COMP      = 0x0003;
const unsigned int IVT_ADDR_TIMER2_OVF       = 0x0004;
const unsigned int IVT_ADDR_TIMER1_CAPT      = 0x0005;
const unsigned int IVT_ADDR_TIMER1_COMPA     = 0x0006;
const unsigned int IVT_ADDR_TIMER1_COMPB     = 0x0007;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x0008;
const unsigned int IVT_ADDR_TIMER0_OVF       = 0x0009;
const unsigned int IVT_ADDR_SPI__STC         = 0x000A;
const unsigned int IVT_ADDR_USART__RXC       = 0x000B;
const unsigned int IVT_ADDR_USART__UDRE      = 0x000C;
const unsigned int IVT_ADDR_USART__TXC       = 0x000D;
const unsigned int IVT_ADDR_ADC              = 0x000E;
const unsigned int IVT_ADDR_EE_RDY           = 0x000F;
const unsigned int IVT_ADDR_ANA_COMP         = 0x0010;
const unsigned int IVT_ADDR_TWI              = 0x0011;
const unsigned int IVT_ADDR_SPM_RDY          = 0x0012;
...
sfr io unsigned short volatile SFIOR absolute 0x50;
    ...
    sbit  ADHSM_bit at SFIOR.B4;
    const register unsigned short int ADHSM = 4;
