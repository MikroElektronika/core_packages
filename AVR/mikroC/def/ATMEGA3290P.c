...
sfr data unsigned short volatile LCDCCR absolute 0xE7;
    ...
    sbit  LCDMDT_bit at LCDCCR.B4;
    const register unsigned short int LCDMDT = 4;
...
sfr data unsigned short volatile LCDCRA absolute 0xE4;
    ...
    sbit  LCDCCD_bit at LCDCRA.B1;
    const register unsigned short int LCDCCD = 1;
    sbit  LCDBD_bit at LCDCRA.B2;
    const register unsigned short int LCDBD = 2;
