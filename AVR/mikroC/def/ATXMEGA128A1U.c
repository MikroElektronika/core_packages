...
const unsigned short IVT_ADDR_TCE2_LUNF = 0x005E; // Low Byte Underflow Interrupt
const unsigned short IVT_ADDR_TCE2_HUNF = 0x0060; // High Byte Underflow Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPA = 0x0062; // Low Byte Compare A Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPB = 0x0064; // Low Byte Compare B Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPC = 0x0066; // Low Byte Compare C Interrupt
const unsigned short IVT_ADDR_TCE2_LCMPD = 0x0068; // Low Byte Compare D Interrupt
...
const unsigned short IVT_ADDR_TWID_TWIS = 0x0096; // TWI Slave Interrupt
const unsigned short IVT_ADDR_TWID_TWIM = 0x0098; // TWI Master Interrupt
...
const unsigned short IVT_ADDR_PORTQ_INT0 = 0x00BC; // External Interrupt 0
const unsigned short IVT_ADDR_PORTQ_INT1 = 0x00BE; // External Interrupt 1

// PORTH interrupt vectors
const unsigned short IVT_ADDR_PORTH_INT0 = 0x00C0; // External Interrupt 0
const unsigned short IVT_ADDR_PORTH_INT1 = 0x00C2; // External Interrupt 1

// PORTJ interrupt vectors
const unsigned short IVT_ADDR_PORTJ_INT0 = 0x00C4; // External Interrupt 0
const unsigned short IVT_ADDR_PORTJ_INT1 = 0x00C6; // External Interrupt 1

// PORTK interrupt vectors
const unsigned short IVT_ADDR_PORTK_INT0 = 0x00C8; // External Interrupt 0
const unsigned short IVT_ADDR_PORTK_INT1 = 0x00CA; // External Interrupt 1
...
const unsigned short IVT_ADDR_TWIF_TWIS = 0x00D4; // TWI Slave Interrupt
const unsigned short IVT_ADDR_TWIF_TWIM = 0x00D6; // TWI Master Interrupt
...
const unsigned short IVT_ADDR_TCF2_LUNF = 0x00D8; // Low Byte Underflow Interrupt
const unsigned short IVT_ADDR_TCF2_HUNF = 0x00DA; // High Byte Underflow Interrupt
const unsigned short IVT_ADDR_TCF2_LCMPA = 0x00DC; // Low Byte Compare A Interrupt
const unsigned short IVT_ADDR_TCF2_LCMPB = 0x00DE; // Low Byte Compare B Interrupt
const unsigned short IVT_ADDR_TCF2_LCMPC = 0x00E0; // Low Byte Compare C Interrupt
const unsigned short IVT_ADDR_TCF2_LCMPD = 0x00E2; // Low Byte Compare D Interrupt

// TCF1 interrupt vectors
const unsigned short IVT_ADDR_TCF1_OVF = 0x00E4; // Overflow Interrupt
const unsigned short IVT_ADDR_TCF1_ERR = 0x00E6; // Error Interrupt
const unsigned short IVT_ADDR_TCF1_CCA = 0x00E8; // Compare or Capture A Interrupt
const unsigned short IVT_ADDR_TCF1_CCB = 0x00EA; // Compare or Capture B Interrupt

// SPIF interrupt vectors
const unsigned short IVT_ADDR_SPIF_INT = 0x00EC; // SPI Interrupt
...
const unsigned short IVT_ADDR_USARTF1_RXC = 0x00F4; // Reception Complete Interrupt
const unsigned short IVT_ADDR_USARTF1_DRE = 0x00F6; // Data Register Empty Interrupt
const unsigned short IVT_ADDR_USARTF1_TXC = 0x00F8; // Transmission Complete Interrupt
...
sfr data unsigned char volatile ADCB_CTRLB                absolute 0x0241;
    sbit  IMPMODE_ADCB_CTRLB_bit at ADCB_CTRLB.B7;
    sbit  CURRLIMIT0_ADCB_CTRLB_bit at ADCB_CTRLB.B5;
    sbit  CURRLIMIT1_ADCB_CTRLB_bit at ADCB_CTRLB.B6;
...
sfr data unsigned char volatile ADCB_REFCTRL              absolute 0x0242;
    ...
    sbit  REFSEL2_ADCB_REFCTRL_bit at ADCB_REFCTRL.B6;
...
sfr data unsigned char volatile ADCB_CH1RESL              absolute 0x0252;
sfr data unsigned char volatile ADCB_CH1RESH              absolute 0x0253;
sfr data unsigned int  volatile ADCB_CH2RES               absolute 0x0254;
sfr data unsigned char volatile ADCB_CH2RESL              absolute 0x0254;
sfr data unsigned char volatile ADCB_CH2RESH              absolute 0x0255;
sfr data unsigned int  volatile ADCB_CH3RES               absolute 0x0256;
sfr data unsigned char volatile ADCB_CH3RESL              absolute 0x0256;
sfr data unsigned char volatile ADCB_CH3RESH              absolute 0x0257;
...
sfr data unsigned char volatile ADCB_CH0_CTRL             absolute 0x0260;
    ...
    sbit  GAIN0_ADCB_CH0_CTRL_bit at ADCB_CH0_CTRL.B2;
    sbit  GAIN1_ADCB_CH0_CTRL_bit at ADCB_CH0_CTRL.B3;
    sbit  GAIN2_ADCB_CH0_CTRL_bit at ADCB_CH0_CTRL.B4;
    sbit  INPUTMODE0_ADCB_CH0_CTRL_bit at ADCB_CH0_CTRL.B0;
    sbit  INPUTMODE1_ADCB_CH0_CTRL_bit at ADCB_CH0_CTRL.B1;

sfr data unsigned char volatile ADCB_CH0_MUXCTRL          absolute 0x0261;
    sbit  MUXPOS0_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B3;
    sbit  MUXPOS1_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B4;
    sbit  MUXPOS2_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B5;
    sbit  MUXPOS3_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B6;
    sbit  MUXINT0_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B3;
    sbit  MUXINT1_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B4;
    sbit  MUXINT2_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B5;
    sbit  MUXINT3_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B6;
    sbit  MUXNEG0_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B0;
    sbit  MUXNEG1_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B1;
    sbit  MUXNEG2_ADCB_CH0_MUXCTRL_bit at ADCB_CH0_MUXCTRL.B2;

sfr data unsigned char volatile ADCB_CH0_INTCTRL          absolute 0x0262;
    sbit  INTMODE0_ADCB_CH0_INTCTRL_bit at ADCB_CH0_INTCTRL.B2;
    sbit  INTMODE1_ADCB_CH0_INTCTRL_bit at ADCB_CH0_INTCTRL.B3;
...
sfr data unsigned char volatile ADCB_CH0_INTFLAGS         absolute 0x0263;
    sbit  CHIF_ADCB_CH0_INTFLAGS_bit at ADCB_CH0_INTFLAGS.B0;
...
sfr data unsigned char volatile ADCB_CH0_SCAN             absolute 0x0266;
    sbit  OFFSET0_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B4;
    sbit  OFFSET1_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B5;
    sbit  OFFSET2_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B6;
    sbit  OFFSET3_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B7;
    sbit  SCANNUM0_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B0;
    sbit  SCANNUM1_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B1;
    sbit  SCANNUM2_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B2;
    sbit  SCANNUM3_ADCB_CH0_SCAN_bit at ADCB_CH0_SCAN.B3;

sfr data unsigned char volatile ADCB_CH1_CTRL             absolute 0x0268;
    sbit  START_ADCB_CH1_CTRL_bit at ADCB_CH1_CTRL.B7;
    sbit  GAIN0_ADCB_CH1_CTRL_bit at ADCB_CH1_CTRL.B2;
    sbit  GAIN1_ADCB_CH1_CTRL_bit at ADCB_CH1_CTRL.B3;
    sbit  GAIN2_ADCB_CH1_CTRL_bit at ADCB_CH1_CTRL.B4;
    sbit  INPUTMODE0_ADCB_CH1_CTRL_bit at ADCB_CH1_CTRL.B0;
    sbit  INPUTMODE1_ADCB_CH1_CTRL_bit at ADCB_CH1_CTRL.B1;

sfr data unsigned char volatile ADCB_CH1_MUXCTRL          absolute 0x0269;
    sbit  MUXPOS0_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B3;
    sbit  MUXPOS1_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B4;
    sbit  MUXPOS2_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B5;
    sbit  MUXPOS3_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B6;
    sbit  MUXINT0_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B3;
    sbit  MUXINT1_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B4;
    sbit  MUXINT2_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B5;
    sbit  MUXINT3_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B6;
    sbit  MUXNEG0_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B0;
    sbit  MUXNEG1_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B1;
    sbit  MUXNEG2_ADCB_CH1_MUXCTRL_bit at ADCB_CH1_MUXCTRL.B2;

sfr data unsigned char volatile ADCB_CH1_INTCTRL          absolute 0x026A;
    sbit  INTMODE0_ADCB_CH1_INTCTRL_bit at ADCB_CH1_INTCTRL.B2;
    sbit  INTMODE1_ADCB_CH1_INTCTRL_bit at ADCB_CH1_INTCTRL.B3;
    sbit  INTLVL0_ADCB_CH1_INTCTRL_bit at ADCB_CH1_INTCTRL.B0;
    sbit  INTLVL1_ADCB_CH1_INTCTRL_bit at ADCB_CH1_INTCTRL.B1;

sfr data unsigned char volatile ADCB_CH1_INTFLAGS         absolute 0x026B;
    sbit  CHIF_ADCB_CH1_INTFLAGS_bit at ADCB_CH1_INTFLAGS.B0;

sfr data unsigned int  volatile ADCB_CH1_RES              absolute 0x026C;
sfr data unsigned char volatile ADCB_CH1_RESL             absolute 0x026C;
sfr data unsigned char volatile ADCB_CH1_RESH             absolute 0x026D;
sfr data unsigned char volatile ADCB_CH1_SCAN             absolute 0x026E;
    sbit  OFFSET0_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B4;
    sbit  OFFSET1_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B5;
    sbit  OFFSET2_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B6;
    sbit  OFFSET3_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B7;
    sbit  SCANNUM0_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B0;
    sbit  SCANNUM1_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B1;
    sbit  SCANNUM2_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B2;
    sbit  SCANNUM3_ADCB_CH1_SCAN_bit at ADCB_CH1_SCAN.B3;

sfr data unsigned char volatile ADCB_CH2_CTRL             absolute 0x0270;
    sbit  START_ADCB_CH2_CTRL_bit at ADCB_CH2_CTRL.B7;
    sbit  GAIN0_ADCB_CH2_CTRL_bit at ADCB_CH2_CTRL.B2;
    sbit  GAIN1_ADCB_CH2_CTRL_bit at ADCB_CH2_CTRL.B3;
    sbit  GAIN2_ADCB_CH2_CTRL_bit at ADCB_CH2_CTRL.B4;
    sbit  INPUTMODE0_ADCB_CH2_CTRL_bit at ADCB_CH2_CTRL.B0;
    sbit  INPUTMODE1_ADCB_CH2_CTRL_bit at ADCB_CH2_CTRL.B1;

sfr data unsigned char volatile ADCB_CH2_MUXCTRL          absolute 0x0271;
    sbit  MUXPOS0_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B3;
    sbit  MUXPOS1_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B4;
    sbit  MUXPOS2_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B5;
    sbit  MUXPOS3_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B6;
    sbit  MUXINT0_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B3;
    sbit  MUXINT1_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B4;
    sbit  MUXINT2_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B5;
    sbit  MUXINT3_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B6;
    sbit  MUXNEG0_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B0;
    sbit  MUXNEG1_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B1;
    sbit  MUXNEG2_ADCB_CH2_MUXCTRL_bit at ADCB_CH2_MUXCTRL.B2;

sfr data unsigned char volatile ADCB_CH2_INTCTRL          absolute 0x0272;
    sbit  INTMODE0_ADCB_CH2_INTCTRL_bit at ADCB_CH2_INTCTRL.B2;
    sbit  INTMODE1_ADCB_CH2_INTCTRL_bit at ADCB_CH2_INTCTRL.B3;
    sbit  INTLVL0_ADCB_CH2_INTCTRL_bit at ADCB_CH2_INTCTRL.B0;
    sbit  INTLVL1_ADCB_CH2_INTCTRL_bit at ADCB_CH2_INTCTRL.B1;

sfr data unsigned char volatile ADCB_CH2_INTFLAGS         absolute 0x0273;
    sbit  CHIF_ADCB_CH2_INTFLAGS_bit at ADCB_CH2_INTFLAGS.B0;

sfr data unsigned int  volatile ADCB_CH2_RES              absolute 0x0274;
sfr data unsigned char volatile ADCB_CH2_RESL             absolute 0x0274;
sfr data unsigned char volatile ADCB_CH2_RESH             absolute 0x0275;
sfr data unsigned char volatile ADCB_CH2_SCAN             absolute 0x0276;
    sbit  OFFSET0_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B4;
    sbit  OFFSET1_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B5;
    sbit  OFFSET2_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B6;
    sbit  OFFSET3_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B7;
    sbit  SCANNUM0_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B0;
    sbit  SCANNUM1_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B1;
    sbit  SCANNUM2_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B2;
    sbit  SCANNUM3_ADCB_CH2_SCAN_bit at ADCB_CH2_SCAN.B3;

sfr data unsigned char volatile ADCB_CH3_CTRL             absolute 0x0278;
    sbit  START_ADCB_CH3_CTRL_bit at ADCB_CH3_CTRL.B7;
    sbit  GAIN0_ADCB_CH3_CTRL_bit at ADCB_CH3_CTRL.B2;
    sbit  GAIN1_ADCB_CH3_CTRL_bit at ADCB_CH3_CTRL.B3;
    sbit  GAIN2_ADCB_CH3_CTRL_bit at ADCB_CH3_CTRL.B4;
    sbit  INPUTMODE0_ADCB_CH3_CTRL_bit at ADCB_CH3_CTRL.B0;
    sbit  INPUTMODE1_ADCB_CH3_CTRL_bit at ADCB_CH3_CTRL.B1;

sfr data unsigned char volatile ADCB_CH3_MUXCTRL          absolute 0x0279;
    sbit  MUXPOS0_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B3;
    sbit  MUXPOS1_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B4;
    sbit  MUXPOS2_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B5;
    sbit  MUXPOS3_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B6;
    sbit  MUXINT0_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B3;
    sbit  MUXINT1_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B4;
    sbit  MUXINT2_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B5;
    sbit  MUXINT3_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B6;
    sbit  MUXNEG0_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B0;
    sbit  MUXNEG1_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B1;
    sbit  MUXNEG2_ADCB_CH3_MUXCTRL_bit at ADCB_CH3_MUXCTRL.B2;

sfr data unsigned char volatile ADCB_CH3_INTCTRL          absolute 0x027A;
    sbit  INTMODE0_ADCB_CH3_INTCTRL_bit at ADCB_CH3_INTCTRL.B2;
    sbit  INTMODE1_ADCB_CH3_INTCTRL_bit at ADCB_CH3_INTCTRL.B3;
    sbit  INTLVL0_ADCB_CH3_INTCTRL_bit at ADCB_CH3_INTCTRL.B0;
    sbit  INTLVL1_ADCB_CH3_INTCTRL_bit at ADCB_CH3_INTCTRL.B1;

sfr data unsigned char volatile ADCB_CH3_INTFLAGS         absolute 0x027B;
    sbit  CHIF_ADCB_CH3_INTFLAGS_bit at ADCB_CH3_INTFLAGS.B0;

sfr data unsigned int  volatile ADCB_CH3_RES              absolute 0x027C;
sfr data unsigned char volatile ADCB_CH3_RESL             absolute 0x027C;
sfr data unsigned char volatile ADCB_CH3_RESH             absolute 0x027D;
sfr data unsigned char volatile ADCB_CH3_SCAN             absolute 0x027E;
    sbit  OFFSET0_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B4;
    sbit  OFFSET1_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B5;
    sbit  OFFSET2_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B6;
    sbit  OFFSET3_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B7;
    sbit  SCANNUM0_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B0;
    sbit  SCANNUM1_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B1;
    sbit  SCANNUM2_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B2;
    sbit  SCANNUM3_ADCB_CH3_SCAN_bit at ADCB_CH3_SCAN.B3;
...
sfr data unsigned char volatile DACB_CTRLA                absolute 0x0320;
    sbit  IDOEN_DACB_CTRLA_bit at DACB_CTRLA.B4;
    sbit  CH1EN_DACB_CTRLA_bit at DACB_CTRLA.B3;
    sbit  CH0EN_DACB_CTRLA_bit at DACB_CTRLA.B2;
    sbit  LPMODE_DACB_CTRLA_bit at DACB_CTRLA.B1;
    sbit  ENABLE_DACB_CTRLA_bit at DACB_CTRLA.B0;

sfr data unsigned char volatile DACB_CTRLB                absolute 0x0321;
    sbit  CHSEL0_DACB_CTRLB_bit at DACB_CTRLB.B5;
    sbit  CHSEL1_DACB_CTRLB_bit at DACB_CTRLB.B6;
    sbit  CH1TRIG_DACB_CTRLB_bit at DACB_CTRLB.B1;
    sbit  CH0TRIG_DACB_CTRLB_bit at DACB_CTRLB.B0;
...
sfr data unsigned char volatile DACB_CTRLC                absolute 0x0322;
    ...
    sbit  LEFTADJ_DACB_CTRLC_bit at DACB_CTRLC.B0;

sfr data unsigned char volatile DACB_EVCTRL               absolute 0x0323;
    sbit  EVSPLIT_DACB_EVCTRL_bit at DACB_EVCTRL.B3;
...
sfr data unsigned char volatile DACB_STATUS               absolute 0x0325;
    sbit  CH1DRE_DACB_STATUS_bit at DACB_STATUS.B1;
    sbit  CH0DRE_DACB_STATUS_bit at DACB_STATUS.B0;

sfr data unsigned char volatile DACB_CH0GAINCAL           absolute 0x0328;
    sbit  CH0GAINCAL0_DACB_CH0GAINCAL_bit at DACB_CH0GAINCAL.B0;
    sbit  CH0GAINCAL1_DACB_CH0GAINCAL_bit at DACB_CH0GAINCAL.B1;
    sbit  CH0GAINCAL2_DACB_CH0GAINCAL_bit at DACB_CH0GAINCAL.B2;
    sbit  CH0GAINCAL3_DACB_CH0GAINCAL_bit at DACB_CH0GAINCAL.B3;
    sbit  CH0GAINCAL4_DACB_CH0GAINCAL_bit at DACB_CH0GAINCAL.B4;
    sbit  CH0GAINCAL5_DACB_CH0GAINCAL_bit at DACB_CH0GAINCAL.B5;
    sbit  CH0GAINCAL6_DACB_CH0GAINCAL_bit at DACB_CH0GAINCAL.B6;

sfr data unsigned char volatile DACB_CH0OFFSETCAL         absolute 0x0329;
    sbit  CH0OFFSETCAL0_DACB_CH0OFFSETCAL_bit at DACB_CH0OFFSETCAL.B0;
    sbit  CH0OFFSETCAL1_DACB_CH0OFFSETCAL_bit at DACB_CH0OFFSETCAL.B1;
    sbit  CH0OFFSETCAL2_DACB_CH0OFFSETCAL_bit at DACB_CH0OFFSETCAL.B2;
    sbit  CH0OFFSETCAL3_DACB_CH0OFFSETCAL_bit at DACB_CH0OFFSETCAL.B3;
    sbit  CH0OFFSETCAL4_DACB_CH0OFFSETCAL_bit at DACB_CH0OFFSETCAL.B4;
    sbit  CH0OFFSETCAL5_DACB_CH0OFFSETCAL_bit at DACB_CH0OFFSETCAL.B5;
    sbit  CH0OFFSETCAL6_DACB_CH0OFFSETCAL_bit at DACB_CH0OFFSETCAL.B6;

sfr data unsigned char volatile DACB_CH1GAINCAL           absolute 0x032A;
    sbit  CH1GAINCAL0_DACB_CH1GAINCAL_bit at DACB_CH1GAINCAL.B0;
    sbit  CH1GAINCAL1_DACB_CH1GAINCAL_bit at DACB_CH1GAINCAL.B1;
    sbit  CH1GAINCAL2_DACB_CH1GAINCAL_bit at DACB_CH1GAINCAL.B2;
    sbit  CH1GAINCAL3_DACB_CH1GAINCAL_bit at DACB_CH1GAINCAL.B3;
    sbit  CH1GAINCAL4_DACB_CH1GAINCAL_bit at DACB_CH1GAINCAL.B4;
    sbit  CH1GAINCAL5_DACB_CH1GAINCAL_bit at DACB_CH1GAINCAL.B5;
    sbit  CH1GAINCAL6_DACB_CH1GAINCAL_bit at DACB_CH1GAINCAL.B6;

sfr data unsigned char volatile DACB_CH1OFFSETCAL         absolute 0x032B;
    sbit  CH1OFFSETCAL0_DACB_CH1OFFSETCAL_bit at DACB_CH1OFFSETCAL.B0;
    sbit  CH1OFFSETCAL1_DACB_CH1OFFSETCAL_bit at DACB_CH1OFFSETCAL.B1;
    sbit  CH1OFFSETCAL2_DACB_CH1OFFSETCAL_bit at DACB_CH1OFFSETCAL.B2;
    sbit  CH1OFFSETCAL3_DACB_CH1OFFSETCAL_bit at DACB_CH1OFFSETCAL.B3;
    sbit  CH1OFFSETCAL4_DACB_CH1OFFSETCAL_bit at DACB_CH1OFFSETCAL.B4;
    sbit  CH1OFFSETCAL5_DACB_CH1OFFSETCAL_bit at DACB_CH1OFFSETCAL.B5;
    sbit  CH1OFFSETCAL6_DACB_CH1OFFSETCAL_bit at DACB_CH1OFFSETCAL.B6;
...
sfr data unsigned char volatile ACB_AC0CTRL               absolute 0x0390;
    ...
    sbit  HSMODE_ACB_AC0CTRL_bit at ACB_AC0CTRL.B3;
    sbit  HYSMODE0_ACB_AC0CTRL_bit at ACB_AC0CTRL.B1;
    sbit  HYSMODE1_ACB_AC0CTRL_bit at ACB_AC0CTRL.B2;
...
sfr data unsigned char volatile ACB_AC1CTRL               absolute 0x0391;
    ...
    sbit  HSMODE_ACB_AC1CTRL_bit at ACB_AC1CTRL.B3;
...
sfr data unsigned char volatile ACB_CTRLA                 absolute 0x0394;
    sbit  AC1OUT_ACB_CTRLA_bit at ACB_CTRLA.B1;
    sbit  AC0OUT_ACB_CTRLA_bit at ACB_CTRLA.B0;

sfr data unsigned char volatile ACB_CTRLB                 absolute 0x0395;
    sbit  SCALEFAC0_ACB_CTRLB_bit at ACB_CTRLB.B0;
    sbit  SCALEFAC1_ACB_CTRLB_bit at ACB_CTRLB.B1;
    sbit  SCALEFAC2_ACB_CTRLB_bit at ACB_CTRLB.B2;
    sbit  SCALEFAC3_ACB_CTRLB_bit at ACB_CTRLB.B3;
    sbit  SCALEFAC4_ACB_CTRLB_bit at ACB_CTRLB.B4;
    sbit  SCALEFAC5_ACB_CTRLB_bit at ACB_CTRLB.B5;
...
sfr data unsigned char volatile EBI_CTRL                  absolute 0x0440;
    const register unsigned short int SDDATAW0 = 6;
    sbit  SDDATAW0_bit at EBI_CTRL.B6;
    const register unsigned short int SDDATAW1 = 7;
    sbit  SDDATAW1_bit at EBI_CTRL.B7;
    const register unsigned short int LPCMODE0 = 4;
    sbit  LPCMODE0_bit at EBI_CTRL.B4;
    const register unsigned short int LPCMODE1 = 5;
    sbit  LPCMODE1_bit at EBI_CTRL.B5;
    const register unsigned short int SRMODE0 = 2;
    sbit  SRMODE0_bit at EBI_CTRL.B2;
    const register unsigned short int SRMODE1 = 3;
    sbit  SRMODE1_bit at EBI_CTRL.B3;
    const register unsigned short int IFMODE0 = 0;
    sbit  IFMODE0_bit at EBI_CTRL.B0;
    const register unsigned short int IFMODE1 = 1;
    sbit  IFMODE1_bit at EBI_CTRL.B1;

sfr data unsigned char volatile EBI_SDRAMCTRLA            absolute 0x0441;
    const register unsigned short int SDCAS = 3;
    sbit  SDCAS_bit at EBI_SDRAMCTRLA.B3;
    const register unsigned short int SDROW = 2;
    sbit  SDROW_bit at EBI_SDRAMCTRLA.B2;
    const register unsigned short int SDCOL0 = 0;
    sbit  SDCOL0_bit at EBI_SDRAMCTRLA.B0;
    const register unsigned short int SDCOL1 = 1;
    sbit  SDCOL1_bit at EBI_SDRAMCTRLA.B1;

sfr data unsigned int  volatile EBI_REFRESH               absolute 0x0444;
sfr data unsigned char volatile EBI_REFRESHL              absolute 0x0444;
sfr data unsigned char volatile EBI_REFRESHH              absolute 0x0445;
sfr data unsigned int  volatile EBI_INITDLY               absolute 0x0446;
sfr data unsigned char volatile EBI_INITDLYL              absolute 0x0446;
sfr data unsigned char volatile EBI_INITDLYH              absolute 0x0447;
sfr data unsigned char volatile EBI_SDRAMCTRLB            absolute 0x0448;
    const register unsigned short int MRDLY0 = 6;
    sbit  MRDLY0_bit at EBI_SDRAMCTRLB.B6;
    const register unsigned short int MRDLY1 = 7;
    sbit  MRDLY1_bit at EBI_SDRAMCTRLB.B7;
    const register unsigned short int ROWCYCDLY0 = 3;
    sbit  ROWCYCDLY0_bit at EBI_SDRAMCTRLB.B3;
    const register unsigned short int ROWCYCDLY1 = 4;
    sbit  ROWCYCDLY1_bit at EBI_SDRAMCTRLB.B4;
    const register unsigned short int ROWCYCDLY2 = 5;
    sbit  ROWCYCDLY2_bit at EBI_SDRAMCTRLB.B5;
    const register unsigned short int RPDLY0 = 0;
    sbit  RPDLY0_bit at EBI_SDRAMCTRLB.B0;
    const register unsigned short int RPDLY1 = 1;
    sbit  RPDLY1_bit at EBI_SDRAMCTRLB.B1;
    const register unsigned short int RPDLY2 = 2;
    sbit  RPDLY2_bit at EBI_SDRAMCTRLB.B2;

sfr data unsigned char volatile EBI_SDRAMCTRLC            absolute 0x0449;
    const register unsigned short int WRDLY0 = 6;
    sbit  WRDLY0_bit at EBI_SDRAMCTRLC.B6;
    const register unsigned short int WRDLY1 = 7;
    sbit  WRDLY1_bit at EBI_SDRAMCTRLC.B7;
    const register unsigned short int ESRDLY0 = 3;
    sbit  ESRDLY0_bit at EBI_SDRAMCTRLC.B3;
    const register unsigned short int ESRDLY1 = 4;
    sbit  ESRDLY1_bit at EBI_SDRAMCTRLC.B4;
    const register unsigned short int ESRDLY2 = 5;
    sbit  ESRDLY2_bit at EBI_SDRAMCTRLC.B5;
    const register unsigned short int ROWCOLDLY0 = 0;
    sbit  ROWCOLDLY0_bit at EBI_SDRAMCTRLC.B0;
    const register unsigned short int ROWCOLDLY1 = 1;
    sbit  ROWCOLDLY1_bit at EBI_SDRAMCTRLC.B1;
    const register unsigned short int ROWCOLDLY2 = 2;
    sbit  ROWCOLDLY2_bit at EBI_SDRAMCTRLC.B2;

sfr data unsigned char volatile EBI_CS0_CTRLA             absolute 0x0450;
    const register unsigned short int ASPACE0 = 2;
    sbit  ASPACE0_bit at EBI_CS0_CTRLA.B2;
    const register unsigned short int ASPACE1 = 3;
    sbit  ASPACE1_bit at EBI_CS0_CTRLA.B3;
    const register unsigned short int ASPACE2 = 4;
    sbit  ASPACE2_bit at EBI_CS0_CTRLA.B4;
    const register unsigned short int ASPACE3 = 5;
    sbit  ASPACE3_bit at EBI_CS0_CTRLA.B5;
    const register unsigned short int ASPACE4 = 6;
    sbit  ASPACE4_bit at EBI_CS0_CTRLA.B6;
    const register unsigned short int MODE0 = 0;
    sbit  MODE0_bit at EBI_CS0_CTRLA.B0;
    const register unsigned short int MODE1 = 1;
    sbit  MODE1_bit at EBI_CS0_CTRLA.B1;

sfr data unsigned char volatile EBI_CS0_CTRLB             absolute 0x0451;
    const register unsigned short int SRWS0 = 0;
    sbit  SRWS0_bit at EBI_CS0_CTRLB.B0;
    const register unsigned short int SRWS1 = 1;
    sbit  SRWS1_bit at EBI_CS0_CTRLB.B1;
    const register unsigned short int SRWS2 = 2;
    sbit  SRWS2_bit at EBI_CS0_CTRLB.B2;
    const register unsigned short int SDINITDONE = 7;
    sbit  SDINITDONE_bit at EBI_CS0_CTRLB.B7;
    const register unsigned short int SDSREN = 2;
    sbit  SDSREN_bit at EBI_CS0_CTRLB.B2;
    const register unsigned short int SDMODE0 = 0;
    sbit  SDMODE0_bit at EBI_CS0_CTRLB.B0;
    const register unsigned short int SDMODE1 = 1;
    sbit  SDMODE1_bit at EBI_CS0_CTRLB.B1;

sfr data unsigned int  volatile EBI_CS0_BASEADDR          absolute 0x0452;
sfr data unsigned char volatile EBI_CS0_BASEADDRL         absolute 0x0452;
sfr data unsigned char volatile EBI_CS0_BASEADDRH         absolute 0x0453;
sfr data unsigned char volatile EBI_CS1_CTRLA             absolute 0x0454;
    sbit  ASPACE0_EBI_CS1_CTRLA_bit at EBI_CS1_CTRLA.B2;
    sbit  ASPACE1_EBI_CS1_CTRLA_bit at EBI_CS1_CTRLA.B3;
    sbit  ASPACE2_EBI_CS1_CTRLA_bit at EBI_CS1_CTRLA.B4;
    sbit  ASPACE3_EBI_CS1_CTRLA_bit at EBI_CS1_CTRLA.B5;
    sbit  ASPACE4_EBI_CS1_CTRLA_bit at EBI_CS1_CTRLA.B6;
    sbit  MODE0_EBI_CS1_CTRLA_bit at EBI_CS1_CTRLA.B0;
    sbit  MODE1_EBI_CS1_CTRLA_bit at EBI_CS1_CTRLA.B1;

sfr data unsigned char volatile EBI_CS1_CTRLB             absolute 0x0455;
    sbit  SRWS0_EBI_CS1_CTRLB_bit at EBI_CS1_CTRLB.B0;
    sbit  SRWS1_EBI_CS1_CTRLB_bit at EBI_CS1_CTRLB.B1;
    sbit  SRWS2_EBI_CS1_CTRLB_bit at EBI_CS1_CTRLB.B2;
    sbit  SDINITDONE_EBI_CS1_CTRLB_bit at EBI_CS1_CTRLB.B7;
    sbit  SDSREN_EBI_CS1_CTRLB_bit at EBI_CS1_CTRLB.B2;
    sbit  SDMODE0_EBI_CS1_CTRLB_bit at EBI_CS1_CTRLB.B0;
    sbit  SDMODE1_EBI_CS1_CTRLB_bit at EBI_CS1_CTRLB.B1;

sfr data unsigned int  volatile EBI_CS1_BASEADDR          absolute 0x0456;
sfr data unsigned char volatile EBI_CS1_BASEADDRL         absolute 0x0456;
sfr data unsigned char volatile EBI_CS1_BASEADDRH         absolute 0x0457;
sfr data unsigned char volatile EBI_CS2_CTRLA             absolute 0x0458;
    sbit  ASPACE0_EBI_CS2_CTRLA_bit at EBI_CS2_CTRLA.B2;
    sbit  ASPACE1_EBI_CS2_CTRLA_bit at EBI_CS2_CTRLA.B3;
    sbit  ASPACE2_EBI_CS2_CTRLA_bit at EBI_CS2_CTRLA.B4;
    sbit  ASPACE3_EBI_CS2_CTRLA_bit at EBI_CS2_CTRLA.B5;
    sbit  ASPACE4_EBI_CS2_CTRLA_bit at EBI_CS2_CTRLA.B6;
    sbit  MODE0_EBI_CS2_CTRLA_bit at EBI_CS2_CTRLA.B0;
    sbit  MODE1_EBI_CS2_CTRLA_bit at EBI_CS2_CTRLA.B1;

sfr data unsigned char volatile EBI_CS2_CTRLB             absolute 0x0459;
    sbit  SRWS0_EBI_CS2_CTRLB_bit at EBI_CS2_CTRLB.B0;
    sbit  SRWS1_EBI_CS2_CTRLB_bit at EBI_CS2_CTRLB.B1;
    sbit  SRWS2_EBI_CS2_CTRLB_bit at EBI_CS2_CTRLB.B2;
    sbit  SDINITDONE_EBI_CS2_CTRLB_bit at EBI_CS2_CTRLB.B7;
    sbit  SDSREN_EBI_CS2_CTRLB_bit at EBI_CS2_CTRLB.B2;
    sbit  SDMODE0_EBI_CS2_CTRLB_bit at EBI_CS2_CTRLB.B0;
    sbit  SDMODE1_EBI_CS2_CTRLB_bit at EBI_CS2_CTRLB.B1;

sfr data unsigned int  volatile EBI_CS2_BASEADDR          absolute 0x045A;
sfr data unsigned char volatile EBI_CS2_BASEADDRL         absolute 0x045A;
sfr data unsigned char volatile EBI_CS2_BASEADDRH         absolute 0x045B;
sfr data unsigned char volatile EBI_CS3_CTRLA             absolute 0x045C;
    sbit  ASPACE0_EBI_CS3_CTRLA_bit at EBI_CS3_CTRLA.B2;
    sbit  ASPACE1_EBI_CS3_CTRLA_bit at EBI_CS3_CTRLA.B3;
    sbit  ASPACE2_EBI_CS3_CTRLA_bit at EBI_CS3_CTRLA.B4;
    sbit  ASPACE3_EBI_CS3_CTRLA_bit at EBI_CS3_CTRLA.B5;
    sbit  ASPACE4_EBI_CS3_CTRLA_bit at EBI_CS3_CTRLA.B6;
    sbit  MODE0_EBI_CS3_CTRLA_bit at EBI_CS3_CTRLA.B0;
    sbit  MODE1_EBI_CS3_CTRLA_bit at EBI_CS3_CTRLA.B1;

sfr data unsigned char volatile EBI_CS3_CTRLB             absolute 0x045D;
    sbit  SRWS0_EBI_CS3_CTRLB_bit at EBI_CS3_CTRLB.B0;
    sbit  SRWS1_EBI_CS3_CTRLB_bit at EBI_CS3_CTRLB.B1;
    sbit  SRWS2_EBI_CS3_CTRLB_bit at EBI_CS3_CTRLB.B2;
    sbit  SDINITDONE_EBI_CS3_CTRLB_bit at EBI_CS3_CTRLB.B7;
    sbit  SDSREN_EBI_CS3_CTRLB_bit at EBI_CS3_CTRLB.B2;
    sbit  SDMODE0_EBI_CS3_CTRLB_bit at EBI_CS3_CTRLB.B0;
    sbit  SDMODE1_EBI_CS3_CTRLB_bit at EBI_CS3_CTRLB.B1;

sfr data unsigned int  volatile EBI_CS3_BASEADDR          absolute 0x045E;
sfr data unsigned char volatile EBI_CS3_BASEADDRL         absolute 0x045E;
sfr data unsigned char volatile EBI_CS3_BASEADDRH         absolute 0x045F;
...
sfr data unsigned char volatile TWID_CTRL                 absolute 0x0490;
    sbit  SDAHOLD0_TWID_CTRL_bit at TWID_CTRL.B1;
    sbit  SDAHOLD1_TWID_CTRL_bit at TWID_CTRL.B2;
    sbit  EDIEN_TWID_CTRL_bit at TWID_CTRL.B0;

sfr data unsigned char volatile TWID_MASTER_CTRLA         absolute 0x0491;
    sbit  INTLVL0_TWID_MASTER_CTRLA_bit at TWID_MASTER_CTRLA.B6;
    sbit  INTLVL1_TWID_MASTER_CTRLA_bit at TWID_MASTER_CTRLA.B7;
    sbit  RIEN_TWID_MASTER_CTRLA_bit at TWID_MASTER_CTRLA.B5;
    sbit  WIEN_TWID_MASTER_CTRLA_bit at TWID_MASTER_CTRLA.B4;
    sbit  ENABLE_TWID_MASTER_CTRLA_bit at TWID_MASTER_CTRLA.B3;

sfr data unsigned char volatile TWID_MASTER_CTRLB         absolute 0x0492;
    sbit  TIMEOUT0_TWID_MASTER_CTRLB_bit at TWID_MASTER_CTRLB.B2;
    sbit  TIMEOUT1_TWID_MASTER_CTRLB_bit at TWID_MASTER_CTRLB.B3;
    sbit  QCEN_TWID_MASTER_CTRLB_bit at TWID_MASTER_CTRLB.B1;
    sbit  SMEN_TWID_MASTER_CTRLB_bit at TWID_MASTER_CTRLB.B0;

sfr data unsigned char volatile TWID_MASTER_CTRLC         absolute 0x0493;
    sbit  ACKACT_TWID_MASTER_CTRLC_bit at TWID_MASTER_CTRLC.B2;
    sbit  CMD0_TWID_MASTER_CTRLC_bit at TWID_MASTER_CTRLC.B0;
    sbit  CMD1_TWID_MASTER_CTRLC_bit at TWID_MASTER_CTRLC.B1;

sfr data unsigned char volatile TWID_MASTER_STATUS        absolute 0x0494;
    sbit  RIF_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B7;
    sbit  WIF_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B6;
    sbit  CLKHOLD_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B5;
    sbit  RXACK_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B4;
    sbit  ARBLOST_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B3;
    sbit  BUSERR_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B2;
    sbit  BUSSTATE0_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B0;
    sbit  BUSSTATE1_TWID_MASTER_STATUS_bit at TWID_MASTER_STATUS.B1;

sfr data unsigned char volatile TWID_MASTER_BAUD          absolute 0x0495;
sfr data unsigned char volatile TWID_MASTER_ADDR          absolute 0x0496;
sfr data unsigned char volatile TWID_MASTER_DATA          absolute 0x0497;
sfr data unsigned char volatile TWID_SLAVE_CTRLA          absolute 0x0498;
    sbit  INTLVL0_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B6;
    sbit  INTLVL1_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B7;
    sbit  DIEN_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B5;
    sbit  APIEN_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B4;
    sbit  ENABLE_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B3;
    sbit  PIEN_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B2;
    sbit  PMEN_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B1;
    sbit  SMEN_TWID_SLAVE_CTRLA_bit at TWID_SLAVE_CTRLA.B0;

sfr data unsigned char volatile TWID_SLAVE_CTRLB          absolute 0x0499;
    sbit  ACKACT_TWID_SLAVE_CTRLB_bit at TWID_SLAVE_CTRLB.B2;
    sbit  CMD0_TWID_SLAVE_CTRLB_bit at TWID_SLAVE_CTRLB.B0;
    sbit  CMD1_TWID_SLAVE_CTRLB_bit at TWID_SLAVE_CTRLB.B1;

sfr data unsigned char volatile TWID_SLAVE_STATUS         absolute 0x049A;
    sbit  DIF_TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B7;
    sbit  APIF_TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B6;
    sbit  CLKHOLD_TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B5;
    sbit  RXACK_TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B4;
    sbit  COLL_TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B3;
    sbit  BUSERR_TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B2;
    sbit  DIR__TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B1;
    sbit  AP_TWID_SLAVE_STATUS_bit at TWID_SLAVE_STATUS.B0;

sfr data unsigned char volatile TWID_SLAVE_ADDR           absolute 0x049B;
sfr data unsigned char volatile TWID_SLAVE_DATA           absolute 0x049C;
sfr data unsigned char volatile TWID_SLAVE_ADDRMASK       absolute 0x049D;
    sbit  ADDRMASK0_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B1;
    sbit  ADDRMASK1_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B2;
    sbit  ADDRMASK2_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B3;
    sbit  ADDRMASK3_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B4;
    sbit  ADDRMASK4_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B5;
    sbit  ADDRMASK5_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B6;
    sbit  ADDRMASK6_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B7;
    sbit  ADDREN_TWID_SLAVE_ADDRMASK_bit at TWID_SLAVE_ADDRMASK.B0;
...
sfr data unsigned char volatile TWIF_CTRL                 absolute 0x04B0;
    sbit  SDAHOLD0_TWIF_CTRL_bit at TWIF_CTRL.B1;
    sbit  SDAHOLD1_TWIF_CTRL_bit at TWIF_CTRL.B2;
    sbit  EDIEN_TWIF_CTRL_bit at TWIF_CTRL.B0;

sfr data unsigned char volatile TWIF_MASTER_CTRLA         absolute 0x04B1;
    sbit  INTLVL0_TWIF_MASTER_CTRLA_bit at TWIF_MASTER_CTRLA.B6;
    sbit  INTLVL1_TWIF_MASTER_CTRLA_bit at TWIF_MASTER_CTRLA.B7;
    sbit  RIEN_TWIF_MASTER_CTRLA_bit at TWIF_MASTER_CTRLA.B5;
    sbit  WIEN_TWIF_MASTER_CTRLA_bit at TWIF_MASTER_CTRLA.B4;
    sbit  ENABLE_TWIF_MASTER_CTRLA_bit at TWIF_MASTER_CTRLA.B3;

sfr data unsigned char volatile TWIF_MASTER_CTRLB         absolute 0x04B2;
    sbit  TIMEOUT0_TWIF_MASTER_CTRLB_bit at TWIF_MASTER_CTRLB.B2;
    sbit  TIMEOUT1_TWIF_MASTER_CTRLB_bit at TWIF_MASTER_CTRLB.B3;
    sbit  QCEN_TWIF_MASTER_CTRLB_bit at TWIF_MASTER_CTRLB.B1;
    sbit  SMEN_TWIF_MASTER_CTRLB_bit at TWIF_MASTER_CTRLB.B0;

sfr data unsigned char volatile TWIF_MASTER_CTRLC         absolute 0x04B3;
    sbit  ACKACT_TWIF_MASTER_CTRLC_bit at TWIF_MASTER_CTRLC.B2;
    sbit  CMD0_TWIF_MASTER_CTRLC_bit at TWIF_MASTER_CTRLC.B0;
    sbit  CMD1_TWIF_MASTER_CTRLC_bit at TWIF_MASTER_CTRLC.B1;

sfr data unsigned char volatile TWIF_MASTER_STATUS        absolute 0x04B4;
    sbit  RIF_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B7;
    sbit  WIF_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B6;
    sbit  CLKHOLD_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B5;
    sbit  RXACK_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B4;
    sbit  ARBLOST_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B3;
    sbit  BUSERR_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B2;
    sbit  BUSSTATE0_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B0;
    sbit  BUSSTATE1_TWIF_MASTER_STATUS_bit at TWIF_MASTER_STATUS.B1;

sfr data unsigned char volatile TWIF_MASTER_BAUD          absolute 0x04B5;
sfr data unsigned char volatile TWIF_MASTER_ADDR          absolute 0x04B6;
sfr data unsigned char volatile TWIF_MASTER_DATA          absolute 0x04B7;
sfr data unsigned char volatile TWIF_SLAVE_CTRLA          absolute 0x04B8;
    sbit  INTLVL0_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B6;
    sbit  INTLVL1_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B7;
    sbit  DIEN_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B5;
    sbit  APIEN_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B4;
    sbit  ENABLE_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B3;
    sbit  PIEN_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B2;
    sbit  PMEN_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B1;
    sbit  SMEN_TWIF_SLAVE_CTRLA_bit at TWIF_SLAVE_CTRLA.B0;

sfr data unsigned char volatile TWIF_SLAVE_CTRLB          absolute 0x04B9;
    sbit  ACKACT_TWIF_SLAVE_CTRLB_bit at TWIF_SLAVE_CTRLB.B2;
    sbit  CMD0_TWIF_SLAVE_CTRLB_bit at TWIF_SLAVE_CTRLB.B0;
    sbit  CMD1_TWIF_SLAVE_CTRLB_bit at TWIF_SLAVE_CTRLB.B1;

sfr data unsigned char volatile TWIF_SLAVE_STATUS         absolute 0x04BA;
    sbit  DIF_TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B7;
    sbit  APIF_TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B6;
    sbit  CLKHOLD_TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B5;
    sbit  RXACK_TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B4;
    sbit  COLL_TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B3;
    sbit  BUSERR_TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B2;
    sbit  DIR__TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B1;
    sbit  AP_TWIF_SLAVE_STATUS_bit at TWIF_SLAVE_STATUS.B0;

sfr data unsigned char volatile TWIF_SLAVE_ADDR           absolute 0x04BB;
sfr data unsigned char volatile TWIF_SLAVE_DATA           absolute 0x04BC;
sfr data unsigned char volatile TWIF_SLAVE_ADDRMASK       absolute 0x04BD;
    sbit  ADDRMASK0_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B1;
    sbit  ADDRMASK1_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B2;
    sbit  ADDRMASK2_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B3;
    sbit  ADDRMASK3_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B4;
    sbit  ADDRMASK4_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B5;
    sbit  ADDRMASK5_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B6;
    sbit  ADDRMASK6_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B7;
    sbit  ADDREN_TWIF_SLAVE_ADDRMASK_bit at TWIF_SLAVE_ADDRMASK.B0;
...
sfr data unsigned char volatile PORTF_REMAP               absolute 0x06AE;
    sbit  SPI_PORTF_REMAP_bit at PORTF_REMAP.B5;
    sbit  USART0_PORTF_REMAP_bit at PORTF_REMAP.B4;
    sbit  TC0D_PORTF_REMAP_bit at PORTF_REMAP.B3;
    sbit  TC0C_PORTF_REMAP_bit at PORTF_REMAP.B2;
    sbit  TC0B_PORTF_REMAP_bit at PORTF_REMAP.B1;
    sbit  TC0A_PORTF_REMAP_bit at PORTF_REMAP.B0;
...
sfr data unsigned char volatile PORTH_DIR                 absolute 0x06E0;
sfr data unsigned char volatile PORTH_DIRSET              absolute 0x06E1;
sfr data unsigned char volatile PORTH_DIRCLR              absolute 0x06E2;
sfr data unsigned char volatile PORTH_DIRTGL              absolute 0x06E3;
sfr data unsigned char volatile PORTH_OUT                 absolute 0x06E4;
sfr data unsigned char volatile PORTH_OUTSET              absolute 0x06E5;
sfr data unsigned char volatile PORTH_OUTCLR              absolute 0x06E6;
sfr data unsigned char volatile PORTH_OUTTGL              absolute 0x06E7;
sfr data unsigned char volatile PORTH_IN                  absolute 0x06E8;
sfr data unsigned char volatile PORTH_INTCTRL             absolute 0x06E9;
    sbit  INT1LVL0_PORTH_INTCTRL_bit at PORTH_INTCTRL.B2;
    sbit  INT1LVL1_PORTH_INTCTRL_bit at PORTH_INTCTRL.B3;
    sbit  INT0LVL0_PORTH_INTCTRL_bit at PORTH_INTCTRL.B0;
    sbit  INT0LVL1_PORTH_INTCTRL_bit at PORTH_INTCTRL.B1;

sfr data unsigned char volatile PORTH_INT0MASK            absolute 0x06EA;
sfr data unsigned char volatile PORTH_INT1MASK            absolute 0x06EB;
sfr data unsigned char volatile PORTH_INTFLAGS            absolute 0x06EC;
    sbit  INT1IF_PORTH_INTFLAGS_bit at PORTH_INTFLAGS.B1;
    sbit  INT0IF_PORTH_INTFLAGS_bit at PORTH_INTFLAGS.B0;

sfr data unsigned char volatile PORTH_REMAP               absolute 0x06EE;
    sbit  SPI_PORTH_REMAP_bit at PORTH_REMAP.B5;
    sbit  USART0_PORTH_REMAP_bit at PORTH_REMAP.B4;
    sbit  TC0D_PORTH_REMAP_bit at PORTH_REMAP.B3;
    sbit  TC0C_PORTH_REMAP_bit at PORTH_REMAP.B2;
    sbit  TC0B_PORTH_REMAP_bit at PORTH_REMAP.B1;
    sbit  TC0A_PORTH_REMAP_bit at PORTH_REMAP.B0;

sfr data unsigned char volatile PORTH_PIN0CTRL            absolute 0x06F0;
    sbit  SRLEN_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B7;
    sbit  INVEN_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B6;
    sbit  OPC0_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B3;
    sbit  OPC1_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B4;
    sbit  OPC2_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B5;
    sbit  ISC0_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B0;
    sbit  ISC1_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B1;
    sbit  ISC2_PORTH_PIN0CTRL_bit at PORTH_PIN0CTRL.B2;

sfr data unsigned char volatile PORTH_PIN1CTRL            absolute 0x06F1;
    sbit  SRLEN_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B7;
    sbit  INVEN_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B6;
    sbit  OPC0_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B3;
    sbit  OPC1_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B4;
    sbit  OPC2_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B5;
    sbit  ISC0_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B0;
    sbit  ISC1_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B1;
    sbit  ISC2_PORTH_PIN1CTRL_bit at PORTH_PIN1CTRL.B2;

sfr data unsigned char volatile PORTH_PIN2CTRL            absolute 0x06F2;
    sbit  SRLEN_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B7;
    sbit  INVEN_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B6;
    sbit  OPC0_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B3;
    sbit  OPC1_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B4;
    sbit  OPC2_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B5;
    sbit  ISC0_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B0;
    sbit  ISC1_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B1;
    sbit  ISC2_PORTH_PIN2CTRL_bit at PORTH_PIN2CTRL.B2;

sfr data unsigned char volatile PORTH_PIN3CTRL            absolute 0x06F3;
    sbit  SRLEN_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B7;
    sbit  INVEN_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B6;
    sbit  OPC0_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B3;
    sbit  OPC1_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B4;
    sbit  OPC2_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B5;
    sbit  ISC0_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B0;
    sbit  ISC1_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B1;
    sbit  ISC2_PORTH_PIN3CTRL_bit at PORTH_PIN3CTRL.B2;

sfr data unsigned char volatile PORTH_PIN4CTRL            absolute 0x06F4;
    sbit  SRLEN_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B7;
    sbit  INVEN_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B6;
    sbit  OPC0_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B3;
    sbit  OPC1_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B4;
    sbit  OPC2_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B5;
    sbit  ISC0_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B0;
    sbit  ISC1_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B1;
    sbit  ISC2_PORTH_PIN4CTRL_bit at PORTH_PIN4CTRL.B2;

sfr data unsigned char volatile PORTH_PIN5CTRL            absolute 0x06F5;
    sbit  SRLEN_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B7;
    sbit  INVEN_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B6;
    sbit  OPC0_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B3;
    sbit  OPC1_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B4;
    sbit  OPC2_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B5;
    sbit  ISC0_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B0;
    sbit  ISC1_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B1;
    sbit  ISC2_PORTH_PIN5CTRL_bit at PORTH_PIN5CTRL.B2;

sfr data unsigned char volatile PORTH_PIN6CTRL            absolute 0x06F6;
    sbit  SRLEN_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B7;
    sbit  INVEN_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B6;
    sbit  OPC0_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B3;
    sbit  OPC1_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B4;
    sbit  OPC2_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B5;
    sbit  ISC0_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B0;
    sbit  ISC1_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B1;
    sbit  ISC2_PORTH_PIN6CTRL_bit at PORTH_PIN6CTRL.B2;

sfr data unsigned char volatile PORTH_PIN7CTRL            absolute 0x06F7;
    sbit  SRLEN_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B7;
    sbit  INVEN_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B6;
    sbit  OPC0_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B3;
    sbit  OPC1_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B4;
    sbit  OPC2_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B5;
    sbit  ISC0_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B0;
    sbit  ISC1_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B1;
    sbit  ISC2_PORTH_PIN7CTRL_bit at PORTH_PIN7CTRL.B2;

sfr data unsigned char volatile PORTJ_DIR                 absolute 0x0700;
sfr data unsigned char volatile PORTJ_DIRSET              absolute 0x0701;
sfr data unsigned char volatile PORTJ_DIRCLR              absolute 0x0702;
sfr data unsigned char volatile PORTJ_DIRTGL              absolute 0x0703;
sfr data unsigned char volatile PORTJ_OUT                 absolute 0x0704;
sfr data unsigned char volatile PORTJ_OUTSET              absolute 0x0705;
sfr data unsigned char volatile PORTJ_OUTCLR              absolute 0x0706;
sfr data unsigned char volatile PORTJ_OUTTGL              absolute 0x0707;
sfr data unsigned char volatile PORTJ_IN                  absolute 0x0708;
sfr data unsigned char volatile PORTJ_INTCTRL             absolute 0x0709;
    sbit  INT1LVL0_PORTJ_INTCTRL_bit at PORTJ_INTCTRL.B2;
    sbit  INT1LVL1_PORTJ_INTCTRL_bit at PORTJ_INTCTRL.B3;
    sbit  INT0LVL0_PORTJ_INTCTRL_bit at PORTJ_INTCTRL.B0;
    sbit  INT0LVL1_PORTJ_INTCTRL_bit at PORTJ_INTCTRL.B1;

sfr data unsigned char volatile PORTJ_INT0MASK            absolute 0x070A;
sfr data unsigned char volatile PORTJ_INT1MASK            absolute 0x070B;
sfr data unsigned char volatile PORTJ_INTFLAGS            absolute 0x070C;
    sbit  INT1IF_PORTJ_INTFLAGS_bit at PORTJ_INTFLAGS.B1;
    sbit  INT0IF_PORTJ_INTFLAGS_bit at PORTJ_INTFLAGS.B0;

sfr data unsigned char volatile PORTJ_REMAP               absolute 0x070E;
    sbit  SPI_PORTJ_REMAP_bit at PORTJ_REMAP.B5;
    sbit  USART0_PORTJ_REMAP_bit at PORTJ_REMAP.B4;
    sbit  TC0D_PORTJ_REMAP_bit at PORTJ_REMAP.B3;
    sbit  TC0C_PORTJ_REMAP_bit at PORTJ_REMAP.B2;
    sbit  TC0B_PORTJ_REMAP_bit at PORTJ_REMAP.B1;
    sbit  TC0A_PORTJ_REMAP_bit at PORTJ_REMAP.B0;

sfr data unsigned char volatile PORTJ_PIN0CTRL            absolute 0x0710;
    sbit  SRLEN_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B7;
    sbit  INVEN_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B6;
    sbit  OPC0_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B3;
    sbit  OPC1_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B4;
    sbit  OPC2_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B5;
    sbit  ISC0_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B0;
    sbit  ISC1_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B1;
    sbit  ISC2_PORTJ_PIN0CTRL_bit at PORTJ_PIN0CTRL.B2;

sfr data unsigned char volatile PORTJ_PIN1CTRL            absolute 0x0711;
    sbit  SRLEN_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B7;
    sbit  INVEN_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B6;
    sbit  OPC0_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B3;
    sbit  OPC1_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B4;
    sbit  OPC2_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B5;
    sbit  ISC0_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B0;
    sbit  ISC1_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B1;
    sbit  ISC2_PORTJ_PIN1CTRL_bit at PORTJ_PIN1CTRL.B2;

sfr data unsigned char volatile PORTJ_PIN2CTRL            absolute 0x0712;
    sbit  SRLEN_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B7;
    sbit  INVEN_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B6;
    sbit  OPC0_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B3;
    sbit  OPC1_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B4;
    sbit  OPC2_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B5;
    sbit  ISC0_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B0;
    sbit  ISC1_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B1;
    sbit  ISC2_PORTJ_PIN2CTRL_bit at PORTJ_PIN2CTRL.B2;

sfr data unsigned char volatile PORTJ_PIN3CTRL            absolute 0x0713;
    sbit  SRLEN_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B7;
    sbit  INVEN_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B6;
    sbit  OPC0_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B3;
    sbit  OPC1_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B4;
    sbit  OPC2_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B5;
    sbit  ISC0_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B0;
    sbit  ISC1_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B1;
    sbit  ISC2_PORTJ_PIN3CTRL_bit at PORTJ_PIN3CTRL.B2;

sfr data unsigned char volatile PORTJ_PIN4CTRL            absolute 0x0714;
    sbit  SRLEN_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B7;
    sbit  INVEN_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B6;
    sbit  OPC0_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B3;
    sbit  OPC1_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B4;
    sbit  OPC2_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B5;
    sbit  ISC0_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B0;
    sbit  ISC1_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B1;
    sbit  ISC2_PORTJ_PIN4CTRL_bit at PORTJ_PIN4CTRL.B2;

sfr data unsigned char volatile PORTJ_PIN5CTRL            absolute 0x0715;
    sbit  SRLEN_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B7;
    sbit  INVEN_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B6;
    sbit  OPC0_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B3;
    sbit  OPC1_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B4;
    sbit  OPC2_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B5;
    sbit  ISC0_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B0;
    sbit  ISC1_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B1;
    sbit  ISC2_PORTJ_PIN5CTRL_bit at PORTJ_PIN5CTRL.B2;

sfr data unsigned char volatile PORTJ_PIN6CTRL            absolute 0x0716;
    sbit  SRLEN_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B7;
    sbit  INVEN_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B6;
    sbit  OPC0_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B3;
    sbit  OPC1_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B4;
    sbit  OPC2_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B5;
    sbit  ISC0_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B0;
    sbit  ISC1_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B1;
    sbit  ISC2_PORTJ_PIN6CTRL_bit at PORTJ_PIN6CTRL.B2;

sfr data unsigned char volatile PORTJ_PIN7CTRL            absolute 0x0717;
    sbit  SRLEN_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B7;
    sbit  INVEN_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B6;
    sbit  OPC0_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B3;
    sbit  OPC1_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B4;
    sbit  OPC2_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B5;
    sbit  ISC0_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B0;
    sbit  ISC1_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B1;
    sbit  ISC2_PORTJ_PIN7CTRL_bit at PORTJ_PIN7CTRL.B2;

sfr data unsigned char volatile PORTK_DIR                 absolute 0x0720;
sfr data unsigned char volatile PORTK_DIRSET              absolute 0x0721;
sfr data unsigned char volatile PORTK_DIRCLR              absolute 0x0722;
sfr data unsigned char volatile PORTK_DIRTGL              absolute 0x0723;
sfr data unsigned char volatile PORTK_OUT                 absolute 0x0724;
sfr data unsigned char volatile PORTK_OUTSET              absolute 0x0725;
sfr data unsigned char volatile PORTK_OUTCLR              absolute 0x0726;
sfr data unsigned char volatile PORTK_OUTTGL              absolute 0x0727;
sfr data unsigned char volatile PORTK_IN                  absolute 0x0728;
sfr data unsigned char volatile PORTK_INTCTRL             absolute 0x0729;
    sbit  INT1LVL0_PORTK_INTCTRL_bit at PORTK_INTCTRL.B2;
    sbit  INT1LVL1_PORTK_INTCTRL_bit at PORTK_INTCTRL.B3;
    sbit  INT0LVL0_PORTK_INTCTRL_bit at PORTK_INTCTRL.B0;
    sbit  INT0LVL1_PORTK_INTCTRL_bit at PORTK_INTCTRL.B1;

sfr data unsigned char volatile PORTK_INT0MASK            absolute 0x072A;
sfr data unsigned char volatile PORTK_INT1MASK            absolute 0x072B;
sfr data unsigned char volatile PORTK_INTFLAGS            absolute 0x072C;
    sbit  INT1IF_PORTK_INTFLAGS_bit at PORTK_INTFLAGS.B1;
    sbit  INT0IF_PORTK_INTFLAGS_bit at PORTK_INTFLAGS.B0;

sfr data unsigned char volatile PORTK_REMAP               absolute 0x072E;
    sbit  SPI_PORTK_REMAP_bit at PORTK_REMAP.B5;
    sbit  USART0_PORTK_REMAP_bit at PORTK_REMAP.B4;
    sbit  TC0D_PORTK_REMAP_bit at PORTK_REMAP.B3;
    sbit  TC0C_PORTK_REMAP_bit at PORTK_REMAP.B2;
    sbit  TC0B_PORTK_REMAP_bit at PORTK_REMAP.B1;
    sbit  TC0A_PORTK_REMAP_bit at PORTK_REMAP.B0;

sfr data unsigned char volatile PORTK_PIN0CTRL            absolute 0x0730;
    sbit  SRLEN_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B7;
    sbit  INVEN_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B6;
    sbit  OPC0_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B3;
    sbit  OPC1_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B4;
    sbit  OPC2_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B5;
    sbit  ISC0_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B0;
    sbit  ISC1_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B1;
    sbit  ISC2_PORTK_PIN0CTRL_bit at PORTK_PIN0CTRL.B2;

sfr data unsigned char volatile PORTK_PIN1CTRL            absolute 0x0731;
    sbit  SRLEN_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B7;
    sbit  INVEN_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B6;
    sbit  OPC0_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B3;
    sbit  OPC1_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B4;
    sbit  OPC2_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B5;
    sbit  ISC0_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B0;
    sbit  ISC1_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B1;
    sbit  ISC2_PORTK_PIN1CTRL_bit at PORTK_PIN1CTRL.B2;

sfr data unsigned char volatile PORTK_PIN2CTRL            absolute 0x0732;
    sbit  SRLEN_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B7;
    sbit  INVEN_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B6;
    sbit  OPC0_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B3;
    sbit  OPC1_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B4;
    sbit  OPC2_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B5;
    sbit  ISC0_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B0;
    sbit  ISC1_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B1;
    sbit  ISC2_PORTK_PIN2CTRL_bit at PORTK_PIN2CTRL.B2;

sfr data unsigned char volatile PORTK_PIN3CTRL            absolute 0x0733;
    sbit  SRLEN_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B7;
    sbit  INVEN_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B6;
    sbit  OPC0_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B3;
    sbit  OPC1_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B4;
    sbit  OPC2_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B5;
    sbit  ISC0_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B0;
    sbit  ISC1_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B1;
    sbit  ISC2_PORTK_PIN3CTRL_bit at PORTK_PIN3CTRL.B2;

sfr data unsigned char volatile PORTK_PIN4CTRL            absolute 0x0734;
    sbit  SRLEN_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B7;
    sbit  INVEN_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B6;
    sbit  OPC0_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B3;
    sbit  OPC1_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B4;
    sbit  OPC2_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B5;
    sbit  ISC0_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B0;
    sbit  ISC1_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B1;
    sbit  ISC2_PORTK_PIN4CTRL_bit at PORTK_PIN4CTRL.B2;

sfr data unsigned char volatile PORTK_PIN5CTRL            absolute 0x0735;
    sbit  SRLEN_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B7;
    sbit  INVEN_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B6;
    sbit  OPC0_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B3;
    sbit  OPC1_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B4;
    sbit  OPC2_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B5;
    sbit  ISC0_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B0;
    sbit  ISC1_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B1;
    sbit  ISC2_PORTK_PIN5CTRL_bit at PORTK_PIN5CTRL.B2;

sfr data unsigned char volatile PORTK_PIN6CTRL            absolute 0x0736;
    sbit  SRLEN_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B7;
    sbit  INVEN_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B6;
    sbit  OPC0_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B3;
    sbit  OPC1_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B4;
    sbit  OPC2_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B5;
    sbit  ISC0_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B0;
    sbit  ISC1_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B1;
    sbit  ISC2_PORTK_PIN6CTRL_bit at PORTK_PIN6CTRL.B2;

sfr data unsigned char volatile PORTK_PIN7CTRL            absolute 0x0737;
    sbit  SRLEN_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B7;
    sbit  INVEN_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B6;
    sbit  OPC0_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B3;
    sbit  OPC1_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B4;
    sbit  OPC2_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B5;
    sbit  ISC0_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B0;
    sbit  ISC1_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B1;
    sbit  ISC2_PORTK_PIN7CTRL_bit at PORTK_PIN7CTRL.B2;

sfr data unsigned char volatile PORTQ_DIR                 absolute 0x07C0;
sfr data unsigned char volatile PORTQ_DIRSET              absolute 0x07C1;
sfr data unsigned char volatile PORTQ_DIRCLR              absolute 0x07C2;
sfr data unsigned char volatile PORTQ_DIRTGL              absolute 0x07C3;
sfr data unsigned char volatile PORTQ_OUT                 absolute 0x07C4;
sfr data unsigned char volatile PORTQ_OUTSET              absolute 0x07C5;
sfr data unsigned char volatile PORTQ_OUTCLR              absolute 0x07C6;
sfr data unsigned char volatile PORTQ_OUTTGL              absolute 0x07C7;
sfr data unsigned char volatile PORTQ_IN                  absolute 0x07C8;
sfr data unsigned char volatile PORTQ_INTCTRL             absolute 0x07C9;
    sbit  INT1LVL0_PORTQ_INTCTRL_bit at PORTQ_INTCTRL.B2;
    sbit  INT1LVL1_PORTQ_INTCTRL_bit at PORTQ_INTCTRL.B3;
    sbit  INT0LVL0_PORTQ_INTCTRL_bit at PORTQ_INTCTRL.B0;
    sbit  INT0LVL1_PORTQ_INTCTRL_bit at PORTQ_INTCTRL.B1;

sfr data unsigned char volatile PORTQ_INT0MASK            absolute 0x07CA;
sfr data unsigned char volatile PORTQ_INT1MASK            absolute 0x07CB;
sfr data unsigned char volatile PORTQ_INTFLAGS            absolute 0x07CC;
    sbit  INT1IF_PORTQ_INTFLAGS_bit at PORTQ_INTFLAGS.B1;
    sbit  INT0IF_PORTQ_INTFLAGS_bit at PORTQ_INTFLAGS.B0;

sfr data unsigned char volatile PORTQ_REMAP               absolute 0x07CE;
    sbit  SPI_PORTQ_REMAP_bit at PORTQ_REMAP.B5;
    sbit  USART0_PORTQ_REMAP_bit at PORTQ_REMAP.B4;
    sbit  TC0D_PORTQ_REMAP_bit at PORTQ_REMAP.B3;
    sbit  TC0C_PORTQ_REMAP_bit at PORTQ_REMAP.B2;
    sbit  TC0B_PORTQ_REMAP_bit at PORTQ_REMAP.B1;
    sbit  TC0A_PORTQ_REMAP_bit at PORTQ_REMAP.B0;

sfr data unsigned char volatile PORTQ_PIN0CTRL            absolute 0x07D0;
    sbit  SRLEN_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B7;
    sbit  INVEN_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B6;
    sbit  OPC0_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B3;
    sbit  OPC1_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B4;
    sbit  OPC2_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B5;
    sbit  ISC0_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B0;
    sbit  ISC1_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B1;
    sbit  ISC2_PORTQ_PIN0CTRL_bit at PORTQ_PIN0CTRL.B2;

sfr data unsigned char volatile PORTQ_PIN1CTRL            absolute 0x07D1;
    sbit  SRLEN_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B7;
    sbit  INVEN_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B6;
    sbit  OPC0_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B3;
    sbit  OPC1_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B4;
    sbit  OPC2_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B5;
    sbit  ISC0_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B0;
    sbit  ISC1_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B1;
    sbit  ISC2_PORTQ_PIN1CTRL_bit at PORTQ_PIN1CTRL.B2;

sfr data unsigned char volatile PORTQ_PIN2CTRL            absolute 0x07D2;
    sbit  SRLEN_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B7;
    sbit  INVEN_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B6;
    sbit  OPC0_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B3;
    sbit  OPC1_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B4;
    sbit  OPC2_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B5;
    sbit  ISC0_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B0;
    sbit  ISC1_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B1;
    sbit  ISC2_PORTQ_PIN2CTRL_bit at PORTQ_PIN2CTRL.B2;

sfr data unsigned char volatile PORTQ_PIN3CTRL            absolute 0x07D3;
    sbit  SRLEN_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B7;
    sbit  INVEN_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B6;
    sbit  OPC0_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B3;
    sbit  OPC1_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B4;
    sbit  OPC2_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B5;
    sbit  ISC0_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B0;
    sbit  ISC1_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B1;
    sbit  ISC2_PORTQ_PIN3CTRL_bit at PORTQ_PIN3CTRL.B2;

sfr data unsigned char volatile PORTQ_PIN4CTRL            absolute 0x07D4;
    sbit  SRLEN_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B7;
    sbit  INVEN_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B6;
    sbit  OPC0_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B3;
    sbit  OPC1_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B4;
    sbit  OPC2_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B5;
    sbit  ISC0_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B0;
    sbit  ISC1_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B1;
    sbit  ISC2_PORTQ_PIN4CTRL_bit at PORTQ_PIN4CTRL.B2;

sfr data unsigned char volatile PORTQ_PIN5CTRL            absolute 0x07D5;
    sbit  SRLEN_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B7;
    sbit  INVEN_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B6;
    sbit  OPC0_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B3;
    sbit  OPC1_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B4;
    sbit  OPC2_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B5;
    sbit  ISC0_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B0;
    sbit  ISC1_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B1;
    sbit  ISC2_PORTQ_PIN5CTRL_bit at PORTQ_PIN5CTRL.B2;

sfr data unsigned char volatile PORTQ_PIN6CTRL            absolute 0x07D6;
    sbit  SRLEN_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B7;
    sbit  INVEN_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B6;
    sbit  OPC0_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B3;
    sbit  OPC1_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B4;
    sbit  OPC2_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B5;
    sbit  ISC0_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B0;
    sbit  ISC1_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B1;
    sbit  ISC2_PORTQ_PIN6CTRL_bit at PORTQ_PIN6CTRL.B2;

sfr data unsigned char volatile PORTQ_PIN7CTRL            absolute 0x07D7;
    sbit  SRLEN_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B7;
    sbit  INVEN_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B6;
    sbit  OPC0_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B3;
    sbit  OPC1_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B4;
    sbit  OPC2_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B5;
    sbit  ISC0_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B0;
    sbit  ISC1_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B1;
    sbit  ISC2_PORTQ_PIN7CTRL_bit at PORTQ_PIN7CTRL.B2;
...
sfr data unsigned char volatile TCE1_CTRLA                absolute 0x0A40;
    sbit  CLKSEL0_TCE1_CTRLA_bit at TCE1_CTRLA.B0;
    sbit  CLKSEL1_TCE1_CTRLA_bit at TCE1_CTRLA.B1;
    sbit  CLKSEL2_TCE1_CTRLA_bit at TCE1_CTRLA.B2;
    sbit  CLKSEL3_TCE1_CTRLA_bit at TCE1_CTRLA.B3;

sfr data unsigned char volatile TCE1_CTRLB                absolute 0x0A41;
    sbit  CCBEN_TCE1_CTRLB_bit at TCE1_CTRLB.B5;
    sbit  CCAEN_TCE1_CTRLB_bit at TCE1_CTRLB.B4;
    sbit  WGMODE0_TCE1_CTRLB_bit at TCE1_CTRLB.B0;
    sbit  WGMODE1_TCE1_CTRLB_bit at TCE1_CTRLB.B1;
    sbit  WGMODE2_TCE1_CTRLB_bit at TCE1_CTRLB.B2;

sfr data unsigned char volatile TCE1_CTRLC                absolute 0x0A42;
    sbit  CMPB_TCE1_CTRLC_bit at TCE1_CTRLC.B1;
    sbit  CMPA_TCE1_CTRLC_bit at TCE1_CTRLC.B0;

sfr data unsigned char volatile TCE1_CTRLD                absolute 0x0A43;
    sbit  EVACT0_TCE1_CTRLD_bit at TCE1_CTRLD.B5;
    sbit  EVACT1_TCE1_CTRLD_bit at TCE1_CTRLD.B6;
    sbit  EVACT2_TCE1_CTRLD_bit at TCE1_CTRLD.B7;
    sbit  EVDLY_TCE1_CTRLD_bit at TCE1_CTRLD.B4;
    sbit  EVSEL0_TCE1_CTRLD_bit at TCE1_CTRLD.B0;
    sbit  EVSEL1_TCE1_CTRLD_bit at TCE1_CTRLD.B1;
    sbit  EVSEL2_TCE1_CTRLD_bit at TCE1_CTRLD.B2;
    sbit  EVSEL3_TCE1_CTRLD_bit at TCE1_CTRLD.B3;

sfr data unsigned char volatile TCE1_CTRLE                absolute 0x0A44;
    sbit  BYTEM_TCE1_CTRLE_bit at TCE1_CTRLE.B0;

sfr data unsigned char volatile TCE1_INTCTRLA             absolute 0x0A46;
    sbit  ERRINTLVL0_TCE1_INTCTRLA_bit at TCE1_INTCTRLA.B2;
    sbit  ERRINTLVL1_TCE1_INTCTRLA_bit at TCE1_INTCTRLA.B3;
    sbit  OVFINTLVL0_TCE1_INTCTRLA_bit at TCE1_INTCTRLA.B0;
    sbit  OVFINTLVL1_TCE1_INTCTRLA_bit at TCE1_INTCTRLA.B1;

sfr data unsigned char volatile TCE1_INTCTRLB             absolute 0x0A47;
    sbit  CCBINTLVL0_TCE1_INTCTRLB_bit at TCE1_INTCTRLB.B2;
    sbit  CCBINTLVL1_TCE1_INTCTRLB_bit at TCE1_INTCTRLB.B3;
    sbit  CCAINTLVL0_TCE1_INTCTRLB_bit at TCE1_INTCTRLB.B0;
    sbit  CCAINTLVL1_TCE1_INTCTRLB_bit at TCE1_INTCTRLB.B1;

sfr data unsigned char volatile TCE1_CTRLFCLR             absolute 0x0A48;
    sbit  CMD0_TCE1_CTRLFCLR_bit at TCE1_CTRLFCLR.B2;
    sbit  CMD1_TCE1_CTRLFCLR_bit at TCE1_CTRLFCLR.B3;
    sbit  LUPD_TCE1_CTRLFCLR_bit at TCE1_CTRLFCLR.B1;
    sbit  DIR__TCE1_CTRLFCLR_bit at TCE1_CTRLFCLR.B0;

sfr data unsigned char volatile TCE1_CTRLFSET             absolute 0x0A49;
    sbit  CMD0_TCE1_CTRLFSET_bit at TCE1_CTRLFSET.B2;
    sbit  CMD1_TCE1_CTRLFSET_bit at TCE1_CTRLFSET.B3;
    sbit  LUPD_TCE1_CTRLFSET_bit at TCE1_CTRLFSET.B1;
    sbit  DIR__TCE1_CTRLFSET_bit at TCE1_CTRLFSET.B0;

sfr data unsigned char volatile TCE1_CTRLGCLR             absolute 0x0A4A;
    sbit  CCBBV_TCE1_CTRLGCLR_bit at TCE1_CTRLGCLR.B2;
    sbit  CCABV_TCE1_CTRLGCLR_bit at TCE1_CTRLGCLR.B1;
    sbit  PERBV_TCE1_CTRLGCLR_bit at TCE1_CTRLGCLR.B0;

sfr data unsigned char volatile TCE1_CTRLGSET             absolute 0x0A4B;
    sbit  CCBBV_TCE1_CTRLGSET_bit at TCE1_CTRLGSET.B2;
    sbit  CCABV_TCE1_CTRLGSET_bit at TCE1_CTRLGSET.B1;
    sbit  PERBV_TCE1_CTRLGSET_bit at TCE1_CTRLGSET.B0;

sfr data unsigned char volatile TCE1_INTFLAGS             absolute 0x0A4C;
    sbit  CCBIF_TCE1_INTFLAGS_bit at TCE1_INTFLAGS.B5;
    sbit  CCAIF_TCE1_INTFLAGS_bit at TCE1_INTFLAGS.B4;
    sbit  ERRIF_TCE1_INTFLAGS_bit at TCE1_INTFLAGS.B1;
    sbit  OVFIF_TCE1_INTFLAGS_bit at TCE1_INTFLAGS.B0;

sfr data unsigned char volatile TCE1_TEMP                 absolute 0x0A4F;
sfr data unsigned int  volatile TCE1_CNT                  absolute 0x0A60;
sfr data unsigned int  volatile TCE1_PER                  absolute 0x0A66;
sfr data unsigned char volatile TCE1_PERL                 absolute 0x0A66;
sfr data unsigned char volatile TCE1_PERH                 absolute 0x0A67;
sfr data unsigned int  volatile TCE1_CCA                  absolute 0x0A68;
sfr data unsigned char volatile TCE1_CCAL                 absolute 0x0A68;
sfr data unsigned char volatile TCE1_CCAH                 absolute 0x0A69;
sfr data unsigned int  volatile TCE1_CCB                  absolute 0x0A6A;
sfr data unsigned char volatile TCE1_CCBL                 absolute 0x0A6A;
sfr data unsigned char volatile TCE1_CCBH                 absolute 0x0A6B;
sfr data unsigned int  volatile TCE1_PERBUF               absolute 0x0A76;
sfr data unsigned char volatile TCE1_PERBUFL              absolute 0x0A76;
sfr data unsigned char volatile TCE1_PERBUFH              absolute 0x0A77;
sfr data unsigned int  volatile TCE1_CCABUF               absolute 0x0A78;
sfr data unsigned char volatile TCE1_CCABUFL              absolute 0x0A78;
sfr data unsigned char volatile TCE1_CCABUFH              absolute 0x0A79;
sfr data unsigned int  volatile TCE1_CCBBUF               absolute 0x0A7A;
sfr data unsigned char volatile TCE1_CCBBUFL              absolute 0x0A7A;
sfr data unsigned char volatile TCE1_CCBBUFH              absolute 0x0A7B;
...
sfr data unsigned char volatile TCF0_CTRLE                absolute 0x0B04;
    sbit  BYTEM0_TCF0_CTRLE_bit at TCF0_CTRLE.B0;
    sbit  BYTEM1_TCF0_CTRLE_bit at TCF0_CTRLE.B1;
...
sfr data unsigned char volatile TCF1_CTRLA                absolute 0x0B40;
    sbit  CLKSEL0_TCF1_CTRLA_bit at TCF1_CTRLA.B0;
    sbit  CLKSEL1_TCF1_CTRLA_bit at TCF1_CTRLA.B1;
    sbit  CLKSEL2_TCF1_CTRLA_bit at TCF1_CTRLA.B2;
    sbit  CLKSEL3_TCF1_CTRLA_bit at TCF1_CTRLA.B3;

sfr data unsigned char volatile TCF1_CTRLB                absolute 0x0B41;
    sbit  CCBEN_TCF1_CTRLB_bit at TCF1_CTRLB.B5;
    sbit  CCAEN_TCF1_CTRLB_bit at TCF1_CTRLB.B4;
    sbit  WGMODE0_TCF1_CTRLB_bit at TCF1_CTRLB.B0;
    sbit  WGMODE1_TCF1_CTRLB_bit at TCF1_CTRLB.B1;
    sbit  WGMODE2_TCF1_CTRLB_bit at TCF1_CTRLB.B2;

sfr data unsigned char volatile TCF1_CTRLC                absolute 0x0B42;
    sbit  CMPB_TCF1_CTRLC_bit at TCF1_CTRLC.B1;
    sbit  CMPA_TCF1_CTRLC_bit at TCF1_CTRLC.B0;

sfr data unsigned char volatile TCF1_CTRLD                absolute 0x0B43;
    sbit  EVACT0_TCF1_CTRLD_bit at TCF1_CTRLD.B5;
    sbit  EVACT1_TCF1_CTRLD_bit at TCF1_CTRLD.B6;
    sbit  EVACT2_TCF1_CTRLD_bit at TCF1_CTRLD.B7;
    sbit  EVDLY_TCF1_CTRLD_bit at TCF1_CTRLD.B4;
    sbit  EVSEL0_TCF1_CTRLD_bit at TCF1_CTRLD.B0;
    sbit  EVSEL1_TCF1_CTRLD_bit at TCF1_CTRLD.B1;
    sbit  EVSEL2_TCF1_CTRLD_bit at TCF1_CTRLD.B2;
    sbit  EVSEL3_TCF1_CTRLD_bit at TCF1_CTRLD.B3;

sfr data unsigned char volatile TCF1_CTRLE                absolute 0x0B44;
    sbit  BYTEM_TCF1_CTRLE_bit at TCF1_CTRLE.B0;

sfr data unsigned char volatile TCF1_INTCTRLA             absolute 0x0B46;
    sbit  ERRINTLVL0_TCF1_INTCTRLA_bit at TCF1_INTCTRLA.B2;
    sbit  ERRINTLVL1_TCF1_INTCTRLA_bit at TCF1_INTCTRLA.B3;
    sbit  OVFINTLVL0_TCF1_INTCTRLA_bit at TCF1_INTCTRLA.B0;
    sbit  OVFINTLVL1_TCF1_INTCTRLA_bit at TCF1_INTCTRLA.B1;

sfr data unsigned char volatile TCF1_INTCTRLB             absolute 0x0B47;
    sbit  CCBINTLVL0_TCF1_INTCTRLB_bit at TCF1_INTCTRLB.B2;
    sbit  CCBINTLVL1_TCF1_INTCTRLB_bit at TCF1_INTCTRLB.B3;
    sbit  CCAINTLVL0_TCF1_INTCTRLB_bit at TCF1_INTCTRLB.B0;
    sbit  CCAINTLVL1_TCF1_INTCTRLB_bit at TCF1_INTCTRLB.B1;

sfr data unsigned char volatile TCF1_CTRLFCLR             absolute 0x0B48;
    sbit  CMD0_TCF1_CTRLFCLR_bit at TCF1_CTRLFCLR.B2;
    sbit  CMD1_TCF1_CTRLFCLR_bit at TCF1_CTRLFCLR.B3;
    sbit  LUPD_TCF1_CTRLFCLR_bit at TCF1_CTRLFCLR.B1;
    sbit  DIR__TCF1_CTRLFCLR_bit at TCF1_CTRLFCLR.B0;

sfr data unsigned char volatile TCF1_CTRLFSET             absolute 0x0B49;
    sbit  CMD0_TCF1_CTRLFSET_bit at TCF1_CTRLFSET.B2;
    sbit  CMD1_TCF1_CTRLFSET_bit at TCF1_CTRLFSET.B3;
    sbit  LUPD_TCF1_CTRLFSET_bit at TCF1_CTRLFSET.B1;
    sbit  DIR__TCF1_CTRLFSET_bit at TCF1_CTRLFSET.B0;

sfr data unsigned char volatile TCF1_CTRLGCLR             absolute 0x0B4A;
    sbit  CCBBV_TCF1_CTRLGCLR_bit at TCF1_CTRLGCLR.B2;
    sbit  CCABV_TCF1_CTRLGCLR_bit at TCF1_CTRLGCLR.B1;
    sbit  PERBV_TCF1_CTRLGCLR_bit at TCF1_CTRLGCLR.B0;

sfr data unsigned char volatile TCF1_CTRLGSET             absolute 0x0B4B;
    sbit  CCBBV_TCF1_CTRLGSET_bit at TCF1_CTRLGSET.B2;
    sbit  CCABV_TCF1_CTRLGSET_bit at TCF1_CTRLGSET.B1;
    sbit  PERBV_TCF1_CTRLGSET_bit at TCF1_CTRLGSET.B0;

sfr data unsigned char volatile TCF1_INTFLAGS             absolute 0x0B4C;
    sbit  CCBIF_TCF1_INTFLAGS_bit at TCF1_INTFLAGS.B5;
    sbit  CCAIF_TCF1_INTFLAGS_bit at TCF1_INTFLAGS.B4;
    sbit  ERRIF_TCF1_INTFLAGS_bit at TCF1_INTFLAGS.B1;
    sbit  OVFIF_TCF1_INTFLAGS_bit at TCF1_INTFLAGS.B0;

sfr data unsigned char volatile TCF1_TEMP                 absolute 0x0B4F;
sfr data unsigned int  volatile TCF1_CNT                  absolute 0x0B60;
sfr data unsigned int  volatile TCF1_PER                  absolute 0x0B66;
sfr data unsigned char volatile TCF1_PERL                 absolute 0x0B66;
sfr data unsigned char volatile TCF1_PERH                 absolute 0x0B67;
sfr data unsigned int  volatile TCF1_CCA                  absolute 0x0B68;
sfr data unsigned char volatile TCF1_CCAL                 absolute 0x0B68;
sfr data unsigned char volatile TCF1_CCAH                 absolute 0x0B69;
sfr data unsigned int  volatile TCF1_CCB                  absolute 0x0B6A;
sfr data unsigned char volatile TCF1_CCBL                 absolute 0x0B6A;
sfr data unsigned char volatile TCF1_CCBH                 absolute 0x0B6B;
sfr data unsigned int  volatile TCF1_PERBUF               absolute 0x0B76;
sfr data unsigned char volatile TCF1_PERBUFL              absolute 0x0B76;
sfr data unsigned char volatile TCF1_PERBUFH              absolute 0x0B77;
sfr data unsigned int  volatile TCF1_CCABUF               absolute 0x0B78;
sfr data unsigned char volatile TCF1_CCABUFL              absolute 0x0B78;
sfr data unsigned char volatile TCF1_CCABUFH              absolute 0x0B79;
sfr data unsigned int  volatile TCF1_CCBBUF               absolute 0x0B7A;
sfr data unsigned char volatile TCF1_CCBBUFL              absolute 0x0B7A;
sfr data unsigned char volatile TCF1_CCBBUFH              absolute 0x0B7B;
...
sfr data unsigned char volatile TCE2_CTRLA                absolute 0x0A00;
    sbit  CLKSEL0_TCE2_CTRLA_bit at TCE2_CTRLA.B0;
    sbit  CLKSEL1_TCE2_CTRLA_bit at TCE2_CTRLA.B1;
    sbit  CLKSEL2_TCE2_CTRLA_bit at TCE2_CTRLA.B2;
    sbit  CLKSEL3_TCE2_CTRLA_bit at TCE2_CTRLA.B3;

sfr data unsigned char volatile TCE2_CTRLB                absolute 0x0A01;
    sbit  HCMPDEN_TCE2_CTRLB_bit at TCE2_CTRLB.B7;
    sbit  HCMPCEN_TCE2_CTRLB_bit at TCE2_CTRLB.B6;
    sbit  HCMPBEN_TCE2_CTRLB_bit at TCE2_CTRLB.B5;
    sbit  HCMPAEN_TCE2_CTRLB_bit at TCE2_CTRLB.B4;
    sbit  LCMPDEN_TCE2_CTRLB_bit at TCE2_CTRLB.B3;
    sbit  LCMPCEN_TCE2_CTRLB_bit at TCE2_CTRLB.B2;
    sbit  LCMPBEN_TCE2_CTRLB_bit at TCE2_CTRLB.B1;
    sbit  LCMPAEN_TCE2_CTRLB_bit at TCE2_CTRLB.B0;

sfr data unsigned char volatile TCE2_CTRLC                absolute 0x0A02;
    sbit  HCMPD_TCE2_CTRLC_bit at TCE2_CTRLC.B7;
    sbit  HCMPC_TCE2_CTRLC_bit at TCE2_CTRLC.B6;
    sbit  HCMPB_TCE2_CTRLC_bit at TCE2_CTRLC.B5;
    sbit  HCMPA_TCE2_CTRLC_bit at TCE2_CTRLC.B4;
    sbit  LCMPD_TCE2_CTRLC_bit at TCE2_CTRLC.B3;
    sbit  LCMPC_TCE2_CTRLC_bit at TCE2_CTRLC.B2;
    sbit  LCMPB_TCE2_CTRLC_bit at TCE2_CTRLC.B1;
    sbit  LCMPA_TCE2_CTRLC_bit at TCE2_CTRLC.B0;

sfr data unsigned char volatile TCE2_CTRLE                absolute 0x0A04;
    sbit  BYTEM0_TCE2_CTRLE_bit at TCE2_CTRLE.B0;
    sbit  BYTEM1_TCE2_CTRLE_bit at TCE2_CTRLE.B1;

sfr data unsigned char volatile TCE2_INTCTRLA             absolute 0x0A06;
    sbit  HUNFINTLVL0_TCE2_INTCTRLA_bit at TCE2_INTCTRLA.B2;
    sbit  HUNFINTLVL1_TCE2_INTCTRLA_bit at TCE2_INTCTRLA.B3;
    sbit  LUNFINTLVL0_TCE2_INTCTRLA_bit at TCE2_INTCTRLA.B0;
    sbit  LUNFINTLVL1_TCE2_INTCTRLA_bit at TCE2_INTCTRLA.B1;

sfr data unsigned char volatile TCE2_INTCTRLB             absolute 0x0A07;
    sbit  LCMPDINTLVL0_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B6;
    sbit  LCMPDINTLVL1_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B7;
    sbit  LCMPCINTLVL0_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B4;
    sbit  LCMPCINTLVL1_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B5;
    sbit  LCMPBINTLVL0_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B2;
    sbit  LCMPBINTLVL1_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B3;
    sbit  LCMPAINTLVL0_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B0;
    sbit  LCMPAINTLVL1_TCE2_INTCTRLB_bit at TCE2_INTCTRLB.B1;

sfr data unsigned char volatile TCE2_CTRLF                absolute 0x0A09;
    sbit  CMD0_TCE2_CTRLF_bit at TCE2_CTRLF.B2;
    sbit  CMD1_TCE2_CTRLF_bit at TCE2_CTRLF.B3;
    sbit  CMDEN0_TCE2_CTRLF_bit at TCE2_CTRLF.B0;
    sbit  CMDEN1_TCE2_CTRLF_bit at TCE2_CTRLF.B1;

sfr data unsigned char volatile TCE2_INTFLAGS             absolute 0x0A0C;
    sbit  LCMPDIF_TCE2_INTFLAGS_bit at TCE2_INTFLAGS.B7;
    sbit  LCMPCIF_TCE2_INTFLAGS_bit at TCE2_INTFLAGS.B6;
    sbit  LCMPBIF_TCE2_INTFLAGS_bit at TCE2_INTFLAGS.B5;
    sbit  LCMPAIF_TCE2_INTFLAGS_bit at TCE2_INTFLAGS.B4;
    sbit  HUNFIF_TCE2_INTFLAGS_bit at TCE2_INTFLAGS.B1;
    sbit  LUNFIF_TCE2_INTFLAGS_bit at TCE2_INTFLAGS.B0;

sfr data unsigned char volatile TCE2_LCNT                 absolute 0x0A20;
sfr data unsigned char volatile TCE2_HCNT                 absolute 0x0A21;
sfr data unsigned char volatile TCE2_LPER                 absolute 0x0A26;
sfr data unsigned char volatile TCE2_HPER                 absolute 0x0A27;
sfr data unsigned char volatile TCE2_LCMPA                absolute 0x0A28;
sfr data unsigned char volatile TCE2_HCMPA                absolute 0x0A29;
sfr data unsigned char volatile TCE2_LCMPB                absolute 0x0A2A;
sfr data unsigned char volatile TCE2_HCMPB                absolute 0x0A2B;
sfr data unsigned char volatile TCE2_LCMPC                absolute 0x0A2C;
sfr data unsigned char volatile TCE2_HCMPC                absolute 0x0A2D;
sfr data unsigned char volatile TCE2_LCMPD                absolute 0x0A2E;
sfr data unsigned char volatile TCE2_HCMPD                absolute 0x0A2F;
sfr data unsigned char volatile TCF2_CTRLA                absolute 0x0B00;
    sbit  CLKSEL0_TCF2_CTRLA_bit at TCF2_CTRLA.B0;
    sbit  CLKSEL1_TCF2_CTRLA_bit at TCF2_CTRLA.B1;
    sbit  CLKSEL2_TCF2_CTRLA_bit at TCF2_CTRLA.B2;
    sbit  CLKSEL3_TCF2_CTRLA_bit at TCF2_CTRLA.B3;

sfr data unsigned char volatile TCF2_CTRLB                absolute 0x0B01;
    sbit  HCMPDEN_TCF2_CTRLB_bit at TCF2_CTRLB.B7;
    sbit  HCMPCEN_TCF2_CTRLB_bit at TCF2_CTRLB.B6;
    sbit  HCMPBEN_TCF2_CTRLB_bit at TCF2_CTRLB.B5;
    sbit  HCMPAEN_TCF2_CTRLB_bit at TCF2_CTRLB.B4;
    sbit  LCMPDEN_TCF2_CTRLB_bit at TCF2_CTRLB.B3;
    sbit  LCMPCEN_TCF2_CTRLB_bit at TCF2_CTRLB.B2;
    sbit  LCMPBEN_TCF2_CTRLB_bit at TCF2_CTRLB.B1;
    sbit  LCMPAEN_TCF2_CTRLB_bit at TCF2_CTRLB.B0;

sfr data unsigned char volatile TCF2_CTRLC                absolute 0x0B02;
    sbit  HCMPD_TCF2_CTRLC_bit at TCF2_CTRLC.B7;
    sbit  HCMPC_TCF2_CTRLC_bit at TCF2_CTRLC.B6;
    sbit  HCMPB_TCF2_CTRLC_bit at TCF2_CTRLC.B5;
    sbit  HCMPA_TCF2_CTRLC_bit at TCF2_CTRLC.B4;
    sbit  LCMPD_TCF2_CTRLC_bit at TCF2_CTRLC.B3;
    sbit  LCMPC_TCF2_CTRLC_bit at TCF2_CTRLC.B2;
    sbit  LCMPB_TCF2_CTRLC_bit at TCF2_CTRLC.B1;
    sbit  LCMPA_TCF2_CTRLC_bit at TCF2_CTRLC.B0;

sfr data unsigned char volatile TCF2_CTRLE                absolute 0x0B04;
    sbit  BYTEM0_TCF2_CTRLE_bit at TCF2_CTRLE.B0;
    sbit  BYTEM1_TCF2_CTRLE_bit at TCF2_CTRLE.B1;

sfr data unsigned char volatile TCF2_INTCTRLA             absolute 0x0B06;
    sbit  HUNFINTLVL0_TCF2_INTCTRLA_bit at TCF2_INTCTRLA.B2;
    sbit  HUNFINTLVL1_TCF2_INTCTRLA_bit at TCF2_INTCTRLA.B3;
    sbit  LUNFINTLVL0_TCF2_INTCTRLA_bit at TCF2_INTCTRLA.B0;
    sbit  LUNFINTLVL1_TCF2_INTCTRLA_bit at TCF2_INTCTRLA.B1;

sfr data unsigned char volatile TCF2_INTCTRLB             absolute 0x0B07;
    sbit  LCMPDINTLVL0_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B6;
    sbit  LCMPDINTLVL1_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B7;
    sbit  LCMPCINTLVL0_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B4;
    sbit  LCMPCINTLVL1_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B5;
    sbit  LCMPBINTLVL0_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B2;
    sbit  LCMPBINTLVL1_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B3;
    sbit  LCMPAINTLVL0_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B0;
    sbit  LCMPAINTLVL1_TCF2_INTCTRLB_bit at TCF2_INTCTRLB.B1;

sfr data unsigned char volatile TCF2_CTRLF                absolute 0x0B09;
    sbit  CMD0_TCF2_CTRLF_bit at TCF2_CTRLF.B2;
    sbit  CMD1_TCF2_CTRLF_bit at TCF2_CTRLF.B3;
    sbit  CMDEN0_TCF2_CTRLF_bit at TCF2_CTRLF.B0;
    sbit  CMDEN1_TCF2_CTRLF_bit at TCF2_CTRLF.B1;

sfr data unsigned char volatile TCF2_INTFLAGS             absolute 0x0B0C;
    sbit  LCMPDIF_TCF2_INTFLAGS_bit at TCF2_INTFLAGS.B7;
    sbit  LCMPCIF_TCF2_INTFLAGS_bit at TCF2_INTFLAGS.B6;
    sbit  LCMPBIF_TCF2_INTFLAGS_bit at TCF2_INTFLAGS.B5;
    sbit  LCMPAIF_TCF2_INTFLAGS_bit at TCF2_INTFLAGS.B4;
    sbit  HUNFIF_TCF2_INTFLAGS_bit at TCF2_INTFLAGS.B1;
    sbit  LUNFIF_TCF2_INTFLAGS_bit at TCF2_INTFLAGS.B0;

sfr data unsigned char volatile TCF2_LCNT                 absolute 0x0B20;
sfr data unsigned char volatile TCF2_HCNT                 absolute 0x0B21;
sfr data unsigned char volatile TCF2_LPER                 absolute 0x0B26;
sfr data unsigned char volatile TCF2_HPER                 absolute 0x0B27;
sfr data unsigned char volatile TCF2_LCMPA                absolute 0x0B28;
sfr data unsigned char volatile TCF2_HCMPA                absolute 0x0B29;
sfr data unsigned char volatile TCF2_LCMPB                absolute 0x0B2A;
sfr data unsigned char volatile TCF2_HCMPB                absolute 0x0B2B;
sfr data unsigned char volatile TCF2_LCMPC                absolute 0x0B2C;
sfr data unsigned char volatile TCF2_HCMPC                absolute 0x0B2D;
sfr data unsigned char volatile TCF2_LCMPD                absolute 0x0B2E;
sfr data unsigned char volatile TCF2_HCMPD                absolute 0x0B2F;
...
sfr data unsigned char volatile AWEXE_STATUSSET           absolute 0x0A85;
    sbit  FDF_AWEXE_STATUSSET_bit at AWEXE_STATUSSET.B2;
    sbit  DTHSBUFV_AWEXE_STATUSSET_bit at AWEXE_STATUSSET.B1;
    sbit  DTLSBUFV_AWEXE_STATUSSET_bit at AWEXE_STATUSSET.B0;
...
sfr data unsigned char volatile HIRESF_CTRLA              absolute 0x0B90;
...
sfr data unsigned char volatile USARTE1_DATA              absolute 0x0AB0;
sfr data unsigned char volatile USARTE1_STATUS            absolute 0x0AB1;
...
sfr data unsigned char volatile USARTE1_CTRLA             absolute 0x0AB3;
...
sfr data unsigned char volatile USARTE1_CTRLB             absolute 0x0AB4;
...
sfr data unsigned char volatile USARTE1_CTRLC             absolute 0x0AB5;
...
sfr data unsigned char volatile USARTE1_BAUDCTRLA         absolute 0x0AB6;
...
sfr data unsigned char volatile USARTE1_BAUDCTRLB         absolute 0x0AB7;
    ...
    sbit  BSEL0_USARTE1_BAUDCTRLB_bit at USARTE1_BAUDCTRLB.B0;
    sbit  BSEL1_USARTE1_BAUDCTRLB_bit at USARTE1_BAUDCTRLB.B1;
    sbit  BSEL2_USARTE1_BAUDCTRLB_bit at USARTE1_BAUDCTRLB.B2;
    sbit  BSEL3_USARTE1_BAUDCTRLB_bit at USARTE1_BAUDCTRLB.B3;

sfr data unsigned char volatile USARTF0_DATA              absolute 0x0BA0;
sfr data unsigned char volatile USARTF0_STATUS            absolute 0x0BA1;
...
sfr data unsigned char volatile USARTF0_CTRLA             absolute 0x0BA3;
...
sfr data unsigned char volatile USARTF0_CTRLB             absolute 0x0BA4;
...
sfr data unsigned char volatile USARTF0_CTRLC             absolute 0x0BA5;
...
sfr data unsigned char volatile USARTF0_BAUDCTRLA         absolute 0x0BA6;
...
sfr data unsigned char volatile USARTF0_BAUDCTRLB         absolute 0x0BA7;
    ...
    sbit  BSEL0_USARTF0_BAUDCTRLB_bit at USARTF0_BAUDCTRLB.B0;
    sbit  BSEL1_USARTF0_BAUDCTRLB_bit at USARTF0_BAUDCTRLB.B1;
    sbit  BSEL2_USARTF0_BAUDCTRLB_bit at USARTF0_BAUDCTRLB.B2;
    sbit  BSEL3_USARTF0_BAUDCTRLB_bit at USARTF0_BAUDCTRLB.B3;

sfr data unsigned char volatile USARTF1_DATA              absolute 0x0BB0;
sfr data unsigned char volatile USARTF1_STATUS            absolute 0x0BB1;
...
sfr data unsigned char volatile USARTF1_CTRLA             absolute 0x0BB3;
...
sfr data unsigned char volatile USARTF1_CTRLB             absolute 0x0BB4;
...
sfr data unsigned char volatile USARTF1_CTRLC             absolute 0x0BB5;
...
sfr data unsigned char volatile USARTF1_BAUDCTRLA         absolute 0x0BB6;
...
sfr data unsigned char volatile USARTF1_BAUDCTRLB         absolute 0x0BB7;
    ...
    sbit  BSEL0_USARTF1_BAUDCTRLB_bit at USARTF1_BAUDCTRLB.B0;
    sbit  BSEL1_USARTF1_BAUDCTRLB_bit at USARTF1_BAUDCTRLB.B1;
    sbit  BSEL2_USARTF1_BAUDCTRLB_bit at USARTF1_BAUDCTRLB.B2;
    sbit  BSEL3_USARTF1_BAUDCTRLB_bit at USARTF1_BAUDCTRLB.B3;
...
sfr data unsigned char volatile SPIF_CTRL                 absolute 0x0BC0;
...
sfr data unsigned char volatile SPIF_INTCTRL              absolute 0x0BC1;
    sbit  INTLVL0_SPIF_INTCTRL_bit at SPIF_INTCTRL.B0;
    sbit  INTLVL1_SPIF_INTCTRL_bit at SPIF_INTCTRL.B1;

sfr data unsigned char volatile SPIF_STATUS               absolute 0x0BC2;
    sbit  IF__SPIF_STATUS_bit at SPIF_STATUS.B7;
    sbit  WRCOL_SPIF_STATUS_bit at SPIF_STATUS.B6;

sfr data unsigned char volatile SPIF_DATA                 absolute 0x0BC3;
