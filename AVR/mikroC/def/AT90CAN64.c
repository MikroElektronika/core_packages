...
const unsigned int IVT_ADDR_TIMER1_COMPC     = 0x001C;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x001E;
const unsigned int IVT_ADDR_TIMER0_COMP      = 0x0020;
const unsigned int IVT_ADDR_TIMER0_OVF       = 0x0022;
const unsigned int IVT_ADDR_CANIT            = 0x0024;
const unsigned int IVT_ADDR_OVRIT            = 0x0026;
const unsigned int IVT_ADDR_SPI__STC         = 0x0028;
const unsigned int IVT_ADDR_USART0__RX       = 0x002A;
const unsigned int IVT_ADDR_USART0__UDRE     = 0x002C;
const unsigned int IVT_ADDR_USART0__TX       = 0x002E;
const unsigned int IVT_ADDR_ANALOG_COMP      = 0x0030;
const unsigned int IVT_ADDR_ADC              = 0x0032;
const unsigned int IVT_ADDR_EE_READY         = 0x0034;
const unsigned int IVT_ADDR_TIMER3_CAPT      = 0x0036;
const unsigned int IVT_ADDR_TIMER3_COMPA     = 0x0038;
const unsigned int IVT_ADDR_TIMER3_COMPB     = 0x003A;
const unsigned int IVT_ADDR_TIMER3_COMPC     = 0x003C;
const unsigned int IVT_ADDR_TIMER3_OVF       = 0x003E;
const unsigned int IVT_ADDR_USART1__RX       = 0x0040;
const unsigned int IVT_ADDR_USART1__UDRE     = 0x0042;
const unsigned int IVT_ADDR_USART1__TX       = 0x0044;
const unsigned int IVT_ADDR_TWI              = 0x0046;
const unsigned int IVT_ADDR_SPM_READY        = 0x0048;
...
sfr data unsigned short volatile CANSIT1 absolute 0xE1;
    sbit  SIT8_bit at CANSIT1.B0;
    const register unsigned short int SIT8 = 0;
    sbit  SIT9_bit at CANSIT1.B1;
    const register unsigned short int SIT9 = 1;
    sbit  SIT10_bit at CANSIT1.B2;
    const register unsigned short int SIT10 = 2;
    sbit  SIT11_bit at CANSIT1.B3;
    const register unsigned short int SIT11 = 3;
    sbit  SIT12_bit at CANSIT1.B4;
    const register unsigned short int SIT12 = 4;
    sbit  SIT13_bit at CANSIT1.B5;
    const register unsigned short int SIT13 = 5;
    sbit  SIT14_bit at CANSIT1.B6;
    const register unsigned short int SIT14 = 6;
...
sfr data unsigned short volatile CANSIT2 absolute 0xE0;
    ...
    sbit  SIT6_bit at CANSIT2.B6;
    const register unsigned short int SIT6 = 6;
    sbit  SIT7_bit at CANSIT2.B7;
    const register unsigned short int SIT7 = 7;

sfr data unsigned short volatile CANIE1 absolute 0xDF;
    sbit  IEMOB8_bit at CANIE1.B0;
    const register unsigned short int IEMOB8 = 0;
    sbit  IEMOB9_bit at CANIE1.B1;
    const register unsigned short int IEMOB9 = 1;
    sbit  IEMOB10_bit at CANIE1.B2;
    const register unsigned short int IEMOB10 = 2;
    sbit  IEMOB11_bit at CANIE1.B3;
    const register unsigned short int IEMOB11 = 3;
    sbit  IEMOB12_bit at CANIE1.B4;
    const register unsigned short int IEMOB12 = 4;
    sbit  IEMOB13_bit at CANIE1.B5;
    const register unsigned short int IEMOB13 = 5;
    sbit  IEMOB14_bit at CANIE1.B6;
    const register unsigned short int IEMOB14 = 6;
...
sfr data unsigned short volatile CANIE2 absolute 0xDE;
    ...
    sbit  IEMOB6_bit at CANIE2.B6;
    const register unsigned short int IEMOB6 = 6;
    sbit  IEMOB7_bit at CANIE2.B7;
    const register unsigned short int IEMOB7 = 7;

sfr data unsigned short volatile CANEN1 absolute 0xDD;
    sbit  ENMOB8_bit at CANEN1.B0;
    const register unsigned short int ENMOB8 = 0;
    sbit  ENMOB9_bit at CANEN1.B1;
    const register unsigned short int ENMOB9 = 1;
    sbit  ENMOB10_bit at CANEN1.B2;
    const register unsigned short int ENMOB10 = 2;
    sbit  ENMOB11_bit at CANEN1.B3;
    const register unsigned short int ENMOB11 = 3;
    sbit  ENMOB12_bit at CANEN1.B4;
    const register unsigned short int ENMOB12 = 4;
    sbit  ENMOB13_bit at CANEN1.B5;
    const register unsigned short int ENMOB13 = 5;
    sbit  ENMOB14_bit at CANEN1.B6;
    const register unsigned short int ENMOB14 = 6;
...
sfr data unsigned short volatile CANEN2 absolute 0xDC;
    ...
    sbit  ENMOB6_bit at CANEN2.B6;
    const register unsigned short int ENMOB6 = 6;
    sbit  ENMOB7_bit at CANEN2.B7;
    const register unsigned short int ENMOB7 = 7;
...
sfr data unsigned short volatile CANGSTA absolute 0xD9;
    ...
    sbit  OVRG_bit at CANGSTA.B6;
    const register unsigned short int OVRG = 6;
