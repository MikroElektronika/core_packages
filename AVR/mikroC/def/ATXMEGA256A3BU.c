...
const unsigned short IVT_ADDR_RTC32_OVF = 0x0014; // Overflow Interrupt
const unsigned short IVT_ADDR_RTC32_COMP = 0x0016; // Compare Interrupt
...
sfr data unsigned char volatile VBAT_CTRL                 absolute 0x00F0;
    const register unsigned short int HIGHESR = 5;
    sbit  HIGHESR_bit at VBAT_CTRL.B5;
    const register unsigned short int XOSCSEL = 4;
    sbit  XOSCSEL_bit at VBAT_CTRL.B4;
    sbit  XOSCEN_VBAT_CTRL_bit at VBAT_CTRL.B3;
    sbit  XOSCFDEN_VBAT_CTRL_bit at VBAT_CTRL.B2;
    const register unsigned short int ACCEN = 1;
    sbit  ACCEN_bit at VBAT_CTRL.B1;
    sbit  RESET__VBAT_CTRL_bit at VBAT_CTRL.B0;

sfr data unsigned char volatile VBAT_STATUS               absolute 0x00F1;
    const register unsigned short int BBPWR = 7;
    sbit  BBPWR_bit at VBAT_STATUS.B7;
    sbit  XOSCRDY_VBAT_STATUS_bit at VBAT_STATUS.B3;
    const register unsigned short int XOSCFAIL = 2;
    sbit  XOSCFAIL_bit at VBAT_STATUS.B2;
    const register unsigned short int BBBORF = 1;
    sbit  BBBORF_bit at VBAT_STATUS.B1;
    const register unsigned short int BBPORF = 0;
    sbit  BBPORF_bit at VBAT_STATUS.B0;

sfr data unsigned char volatile VBAT_BACKUP0              absolute 0x00F2;
sfr data unsigned char volatile VBAT_BACKUP1              absolute 0x00F3;
...
sfr data unsigned char volatile RTC32_CTRL                absolute 0x0420;
    sbit  ENABLE_RTC32_CTRL_bit at RTC32_CTRL.B0;

sfr data unsigned char volatile RTC32_SYNCCTRL            absolute 0x0421;
    const register unsigned short int SYNCCNT = 4;
    sbit  SYNCCNT_bit at RTC32_SYNCCTRL.B4;
    sbit  SYNCBUSY_RTC32_SYNCCTRL_bit at RTC32_SYNCCTRL.B0;

sfr data unsigned char volatile RTC32_INTCTRL             absolute 0x0422;
    const register unsigned short int COMPINTLVL0 = 2;
    sbit  COMPINTLVL0_bit at RTC32_INTCTRL.B2;
    const register unsigned short int COMPINTLVL1 = 3;
    sbit  COMPINTLVL1_bit at RTC32_INTCTRL.B3;
    const register unsigned short int OVFINTLVL0 = 0;
    sbit  OVFINTLVL0_bit at RTC32_INTCTRL.B0;
    const register unsigned short int OVFINTLVL1 = 1;
    sbit  OVFINTLVL1_bit at RTC32_INTCTRL.B1;

sfr data unsigned char volatile RTC32_INTFLAGS            absolute 0x0423;
    const register unsigned short int COMPIF = 1;
    sbit  COMPIF_bit at RTC32_INTFLAGS.B1;
    const register unsigned short int OVFIF = 0;
    sbit  OVFIF_bit at RTC32_INTFLAGS.B0;

sfr data unsigned long volatile RTC32_CNT                 absolute 0x0424;
sfr data unsigned long volatile RTC32_PER                 absolute 0x0428;
sfr data unsigned long volatile RTC32_COMP                absolute 0x042C;
