...
const unsigned int IVT_ADDR_TIMER2_COMP      = 0x0006;
const unsigned int IVT_ADDR_TIMER2_OVF       = 0x0008;
const unsigned int IVT_ADDR_TIMER1_CAPT      = 0x000A;
const unsigned int IVT_ADDR_TIMER1_COMPA     = 0x000C;
const unsigned int IVT_ADDR_TIMER1_COMPB     = 0x000E;
const unsigned int IVT_ADDR_TIMER1_OVF       = 0x0010;
const unsigned int IVT_ADDR_TIMER0_OVF       = 0x0012;
const unsigned int IVT_ADDR_SPI_STC          = 0x0014;
const unsigned int IVT_ADDR_USART_RXC        = 0x0016;
const unsigned int IVT_ADDR_USART_UDRE       = 0x0018;
const unsigned int IVT_ADDR_USART_TXC        = 0x001A;
const unsigned int IVT_ADDR_ADC              = 0x001C;
const unsigned int IVT_ADDR_EE_RDY           = 0x001E;
const unsigned int IVT_ADDR_ANA_COMP         = 0x0020;
const unsigned int IVT_ADDR_TWI              = 0x0022;
const unsigned int IVT_ADDR_INT2             = 0x0024;
const unsigned int IVT_ADDR_TIMER0_COMP      = 0x0026;
...
sfr io unsigned short volatile MCUCR absolute 0x55;
    ...
    sbit  SE_bit at MCUCR.B6;
    const register unsigned short int SE = 6;
    sbit  SM2_bit at MCUCR.B7;
    const register unsigned short int SM2 = 7;
