...
typedef enum CCM_CMD {
    CCM_DC_INVAL = 0x0,                 /*!< Unlock and invali2026-03-06 D-Cache line specified by CSR CCM_XBEGINADDR */
    CCM_DC_WB = 0x1,                    /*!< Flush the specific D-Cache line specified by CSR CCM_XBEGINADDR */
    CCM_DC_WBINVAL = 0x2,               /*!< Unlock, flush and invali2026-03-06 the specific D-Cache line specified by CSR CCM_XBEGINADDR */
    ...
    CCM_DC_WBINVAL_ALL = 0x6,           /*!< Unlock and flush and invali2026-03-06 all the valid and dirty D-Cache lines */
    CCM_DC_WB_ALL = 0x7,                /*!< Flush all the valid and dirty D-Cache lines */
    CCM_DC_INVAL_ALL = 0x17,            /*!< Unlock and invali2026-03-06 all the D-Cache lines */
    CCM_IC_INVAL = 0x8,                 /*!< Unlock and invali2026-03-06 I-Cache line specified by CSR CCM_XBEGINADDR */
    ...
    CCM_IC_INVAL_ALL = 0xd              /*!< Unlock and invali2026-03-06 all the I-Cache lines */
} CCM_CMD_Type;
...
/**
 * \brief  Invali2026-03-06 one I-Cache line specified by address in M-Mode
 * \details
 * This function unlock and invali2026-03-06 one I-Cache line specified
 * by the address.
 * Command \ref CCM_IC_INVAL is written to CSR \ref CSR_CCM_MCOMMAND.
 * \remarks
 * This function must be executed in M-Mode only.
 * \param [in]    addr    start address to be invali2026-03-06d
 */
...
/**
 * \brief  Invali2026-03-06 several I-Cache lines specified by address in M-Mode
 * \details
 * This function unlock and invali2026-03-06 several I-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_IC_INVAL is written to CSR \ref CSR_CCM_MCOMMAND.
 * \remarks
 * This function must be executed in M-Mode only.
 * \param [in]    addr    start address to be invali2026-03-06d
 * \param [in]    cnt     count of cache lines to be invali2026-03-06d
 */
...
/**
 * \brief  Invali2026-03-06 one I-Cache line specified by address in S-Mode
 * \details
 * This function unlock and invali2026-03-06 one I-Cache line specified
 * by the address.
...
/**
 * \brief  Invali2026-03-06 several I-Cache lines specified by address in S-Mode
 * \details
 * This function unlock and invali2026-03-06 several I-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_IC_INVAL is written to CSR \ref CSR_CCM_SCOMMAND.
...
/**
 * \brief  Invali2026-03-06 one I-Cache line specified by address in U-Mode
 * \details
 * This function unlock and invali2026-03-06 one I-Cache line specified
 * by the address.
...
/**
 * \brief  Invali2026-03-06 several I-Cache lines specified by address in U-Mode
 * \details
 * This function unlock and invali2026-03-06 several I-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_IC_INVAL is written to CSR \ref CSR_CCM_UCOMMAND.
...
/**
 * \brief  Invali2026-03-06 all I-Cache lines in M-Mode
 * \details
 * This function invali2026-03-06 all I-Cache lines.
...
/**
 * \brief  Invali2026-03-06 all I-Cache lines in S-Mode
 * \details
 * This function invali2026-03-06 all I-Cache lines.
...
/**
 * \brief  Invali2026-03-06 all I-Cache lines in U-Mode
 * \details
 * This function invali2026-03-06 all I-Cache lines.
...
/**
 * \brief  Invali2026-03-06 one D-Cache line specified by address in M-Mode
 * \details
 * This function unlock and invali2026-03-06 one D-Cache line specified
 * by the address.
...
/**
 * \brief  Invali2026-03-06 several D-Cache lines specified by address in M-Mode
 * \details
 * This function unlock and invali2026-03-06 several D-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_DC_INVAL is written to CSR \ref CSR_CCM_MCOMMAND.
 * \remarks
 * This function must be executed in M-Mode only.
...
/**
 * \brief  Invali2026-03-06 one D-Cache line specified by address in S-Mode
 * \details
 * This function unlock and invali2026-03-06 one D-Cache line specified
 * by the address.
 * Command \ref CCM_DC_INVAL is written to CSR \ref CSR_CCM_MCOMMAND.
...
/**
 * \brief  Invali2026-03-06 several D-Cache lines specified by address in S-Mode
 * \details
 * This function unlock and invali2026-03-06 several D-Cache lines specified
 * by the address and line count.
...
/**
 * \brief  Invali2026-03-06 one D-Cache line specified by address in U-Mode
 * \details
 * This function unlock and invali2026-03-06 one D-Cache line specified
 * by the address.
...
/**
 * \brief  Invali2026-03-06 several D-Cache lines specified by address in U-Mode
 * \details
 * This function unlock and invali2026-03-06 several D-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_DC_INVAL is written to CSR \ref CSR_CCM_UCOMMAND.
...
/**
 * \brief  Flush and invali2026-03-06 one D-Cache line specified by address in M-Mode
 * \details
 * This function flush and invali2026-03-06 one D-Cache line specified by the address.
 * Command \ref CCM_DC_WBINVAL is written to CSR \ref CSR_CCM_MCOMMAND.
 * \remarks
 * This function must be executed in M-Mode only.
 * \param [in]    addr    start address to be flushed and invali2026-03-06d
 */
...
/**
 * \brief  Flush and invali2026-03-06 several D-Cache lines specified by address in M-Mode
 * \details
 * This function flush and invali2026-03-06 several D-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_DC_WBINVAL is written to CSR \ref CSR_CCM_MCOMMAND.
 * \remarks
 * This function must be executed in M-Mode only.
 * \param [in]    addr    start address to be flushed and invali2026-03-06d
 * \param [in]    cnt     count of cache lines to be flushed and invali2026-03-06d
 */
...
/**
 * \brief  Flush and invali2026-03-06 one D-Cache line specified by address in S-Mode
 * \details
 * This function flush and invali2026-03-06 one D-Cache line specified by the address.
...
/**
 * \brief  Flush and invali2026-03-06 several D-Cache lines specified by address in S-Mode
 * \details
 * This function flush and invali2026-03-06 several D-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_DC_WBINVAL is written to CSR \ref CSR_CCM_SCOMMAND.
...
/**
 * \brief  Flush and invali2026-03-06 one D-Cache line specified by address in U-Mode
 * \details
 * This function flush and invali2026-03-06 one D-Cache line specified by the address.
...
/**
 * \brief  Flush and invali2026-03-06 several D-Cache lines specified by address in U-Mode
 * \details
 * This function flush and invali2026-03-06 several D-Cache lines specified
 * by the address and line count.
 * Command \ref CCM_DC_WBINVAL is written to CSR \ref CSR_CCM_UCOMMAND.
...
/**
 * \brief  Invali2026-03-06 all D-Cache lines in M-Mode
 * \details
 * This function invali2026-03-06 all D-Cache lines.
...
/**
 * \brief  Invali2026-03-06 all D-Cache lines in S-Mode
 * \details
 * This function invali2026-03-06 all D-Cache lines.
...
/**
 * \brief  Invali2026-03-06 all D-Cache lines in U-Mode
 * \details
 * This function invali2026-03-06 all D-Cache lines.
 * In U-Mode, this operation will be automatically
 * translated to flush and invali2026-03-06 operations by hardware.
...
/**
 * \brief  Flush and invali2026-03-06 all D-Cache lines in M-Mode
 * \details
 * This function flush and invali2026-03-06 all D-Cache lines.
...
/**
 * \brief  Flush and invali2026-03-06 all D-Cache lines in S-Mode
 * \details
 * This function flush and invali2026-03-06 all D-Cache lines.
...
/**
 * \brief  Flush and invali2026-03-06 all D-Cache lines in U-Mode
 * \details
 * This function flush and invali2026-03-06 all D-Cache lines.
