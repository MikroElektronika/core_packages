...
void _Div_64x64_U(void) {
  ...
  asm {
    ...
    MOV      R4, R2                        // AKO JE DELILAC NULA, ONDA JE REZULTAT +MAX_LONG_LONG A OSTATAK DELJENIK
    ORRS     R4, R3
...
void _Div_64x64_S(void) {
  asm {
    ...
    MOV      R4, R2                      // AKO JE DELILAC NULA, ONDA JE REZULTAT +MAX_LONG_LOGN ili -MAX_LONG_LONG A OSTATAK DELJENIK
    ORRS     R4, R3
...
void _Div_32x32_U(void) {
  asm {
    ...
    MOVS     R4, R2                        // AKO JE DELILAC NULA, ONDA JE REZULTAT +MAX_LONG A OSTATAK DELJENIK
...
void _Div_32x32_S(void) {
  asm {
    ...
    MOVS     R4, R2                      // AKO JE DELILAC NULA, ONDA JE REZULTAT +MAX_LONG ili -MAX_LONG A OSTATAK DELJENIK
