...
void SystemReset(void)
{
    ...
    //
    SCB->AIRCR = 0x05FA0000 | (1ul << 2); // SYSRESETREQ
    //
...
#define SYSTEM_SMC_PMPROT_VALUE        0xA2UL               // SMC_PMPROT //

// HSRUN config values
//#define DEFAULT_SYSTEM_CLOCK         120000000u          // Default System clock value //
//#define MCG_MODE                     MCG_MODE_PEE // Clock generator mode //
// MCG_C1: CLKS=0,FRDIV=3,IREFS=0,IRCLKEN=1,IREFSTEN=0 //
#define SYSTEM_MCG_C1_VALUE          0x1Aul               // MCG_C1 //
...
#define SYSTEM_MCG_C6_VALUE          0x46ul               // MCG_C6 //
// MCG_C7: OSCSEL=0 //
...
#define SYSTEM_SIM_CLKDIV1_VALUE     0x01140000ul         // SIM_CLKDIV1 //
...
///////////////////////////// data and instruction cache part
...
static void InitialSetUpRCCRCC2(){
    ...
    // Provera da li imamo podrsku za HSRUN mode
    if((ulMCG_MODE & 0x10)) 
    {
        // provera freq. ako je freq > 160MHz idemo u HSRUN, u suprotnom RUN mode
        if (Fosc_kHz > 160000) 
        {
    ...
    if ((mcg_mode == MCG_MODE_FEI) || (mcg_mode == MCG_MODE_FBI) || (mcg_mode == MCG_MODE_BLPI))
    {
        ...
        OSC0_CR = ulOSC0_CR;       // Set OSC_CR (OSCERCLK enable, oscillator capacitor load)
