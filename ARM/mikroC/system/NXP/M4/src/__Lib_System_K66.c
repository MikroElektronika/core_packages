...
#define SYSTEM_MCG_C6_VALUE      0x5Dul
/* MCG_C7: OSCSEL=0 */
#define SYSTEM_MCG_C7_VALUE      0x00ul
/* MCG_C9: PLL_CME=1,PLL_LOCRE=0,EXT_PLL_LOCS=0 */
#define SYSTEM_MCG_C9_VALUE      0x20ul
/* MCG_C11: PLLCS=0 */
#define SYSTEM_MCG_C11_VALUE     0x00ul
...
#define SYSTEM_SIM_CLKDIV1_VALUE 0x02260000ul
/* SIM_CLKDIV2: USBDIV=6,USBFRAC=0 */
#define SYSTEM_SIM_CLKDIV2_VALUE 0x0Cul
/* SIM_CLKDIV3: PLLFLLDIV=0,PLLFLLFRAC=0 */
#define SYSTEM_SIM_CLKDIV3_VALUE 0x00ul
...
#define SYSTEM_SIM_SOPT2_VALUE   0x01010000ul
