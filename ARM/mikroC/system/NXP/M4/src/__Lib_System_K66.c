...
void NVIC_SetIntPriority(uint8_t ivt, uint8_t priority) {
  ...
  if (ivt > 15) {
    ...
    { // U slucaju da je priority vrednost poslata u hi nibble zapisu i za IVT_IP0
        *p &= ~((uint32_t)0xF << shift);                             // brisanje stare vrednosti
      *p |= (uint32_t) priority << (shift - 4);     // upis u hi nibble bajta
    }
  }
...
void SystemReset(void)
{
    ...
    //
    SCB->AIRCR = 0x05FA0000 | (1ul << SYSRESETREQ);
    //
...
#define SYSTEM_SMC_PMPROT_VALUE        0xAAul               // SMC_PMPROT //

// HSRUN config values
#define DEFAULT_SYSTEM_CLOCK         180000000ul          /* Default System clock value */
  #define MCG_MODE                     MCG_MODE_PEE /* Clock generator mode */
  /* MCG_C1: CLKS=0,FRDIV=4,IREFS=0,IRCLKEN=1,IREFSTEN=0 */
  #define SYSTEM_MCG_C1_VALUE          0x22ul               /* MCG_C1 */
  /* MCG_C2: LOCRE0=0,FCFTRIM=0,RANGE=2,HGO=0,EREFS=1,LP=0,IRCS=0 */
  #define SYSTEM_MCG_C2_VALUE          0x24ul               /* MCG_C2 */
  /* MCG_C4: DMX32=0,DRST_DRS=0,FCTRIM=0,SCFTRIM=0 */
  #define SYSTEM_MCG_C4_VALUE          0x00ul               /* MCG_C4 */
  /* MCG_SC: ATME=0,ATMS=0,ATMF=0,FLTPRSRV=0,FCRDIV=0,LOCS0=0 */
  #define SYSTEM_MCG_SC_VALUE          0x00ul               /* MCG_SC */
  /* MCG_C5: PLLCLKEN=0,PLLSTEN=0,PRDIV=1 */
  #define SYSTEM_MCG_C5_VALUE          0x01ul               /* MCG_C5 */
  /* MCG_C6: LOLIE0=0,PLLS=1,CME0=0,VDIV=0x1D */
  #define SYSTEM_MCG_C6_VALUE          0x5Dul               /* MCG_C6 */
  /* MCG_C7: OSCSEL=0 */
  #define SYSTEM_MCG_C7_VALUE          0x00ul               /* MCG_C7 */
  /* MCG_C9: PLL_CME=1,PLL_LOCRE=0,EXT_PLL_LOCS=0 */
  #define SYSTEM_MCG_C9_VALUE          0x20ul               /* MCG_C9 */
  /* MCG_C11: PLLCS=0 */
  #define SYSTEM_MCG_C11_VALUE         0x00ul               /* MCG_C11 */
  /* OSC_CR: ERCLKEN=1,EREFSTEN=0,SC2P=0,SC4P=0,SC8P=0,SC16P=0 */
  #define SYSTEM_OSC_CR_VALUE          0x80ul               /* OSC_CR */
  /* SMC_PMCTRL: RUNM=3,STOPA=0,STOPM=0 */
  #define SYSTEM_SMC_PMCTRL_VALUE      0x60ul               /* SMC_PMCTRL */
  /* SIM_CLKDIV1: OUTDIV1=0,OUTDIV2=2,OUTDIV3=2,OUTDIV4=6 */
  #define SYSTEM_SIM_CLKDIV1_VALUE     0x02260000ul         /* SIM_CLKDIV1 */
  /* SIM_CLKDIV2: USBDIV=6,USBFRAC=0 */
  #define SYSTEM_SIM_CLKDIV2_VALUE     0x0Cul               /* SIM_CLKDIV2 */
  /* SIM_CLKDIV3: PLLFLLDIV=0,PLLFLLFRAC=0 */
  #define SYSTEM_SIM_CLKDIV3_VALUE     0x00ul               /* SIM_CLKDIV3 */
  /* SIM_SOPT1: USBREGEN=0,USBSSTBY=0,USBVSTBY=0,OSC32KSEL=2,RAMSIZE=0 */
  #define SYSTEM_SIM_SOPT1_VALUE       0x00080000ul         /* SIM_SOPT1 */
  ...
  #define SYSTEM_SIM_SOPT2_VALUE       0x01010000ul         /* SIM_SOPT2 */

#define SMC_PMCTRL_RUNM_MASK                     0x60ul
#define SIM_SOPT1_OSC32KSEL_MASK                 0xC0000ul
#define SIM_SOPT2_PLLFLLSEL_MASK                 0x30000ul
#define SIM_SOPT2_USBSRC_MASK                    0x40000ul  // SJ - dodata maska za odabir clock source-a za USB
#define SIM_SCGC5_PORTA_MASK                     0x200ul

#define SIM_SCGC5_LPTMR_MASK                     0x1ul
...
/* C11 Bit Fields */
#define MCG_C11_PLLCS_MASK                       0x10ul
...
/* CLKDIV3 Bit Fields */
#define SIM_CLKDIV3_PLLFLLFRAC_MASK              0x1ul
...
#define SIM_CLKDIV3_PLLFLLDIV_MASK               0xEul
...
/* SIM SCGC3 Bit Fields */
#define SIM_SCGC3_USBHSPHY_MASK                  0x4ul

/* OCS CR Bit Fields */
#define OSC_CR_ERCLKEN_MASK                      0x80ul

/* USBPHYCTL Bit Fields */
#define SIM_USBPHYCTL_USBVREGSEL_MASK            0x100ul
...
#define SIM_USBPHYCTL_USBVREGPD_MASK             0x200ul
...
#define SIM_USBPHYCTL_USB3VOUTTRG_MASK           0x700000ul
...
#define SIM_USBPHYCTL_USBDISILIM_MASK            0x800000ul
...
#define USBPHY_TRIM_OVERRIDE_EN_TRIM_DIV_SEL_OVERRIDE_MASK 0x1ul

/* USB PHY CTRL Bit Fields */
#define USBPHY_CTRL_SFTRST_MASK                  0x80000000ul
#define USBPHY_CTRL_CLKGATE_MASK                 0x40000000ul
#define USBPHY_CTRL_AUTORESUME_EN_MASK           0x40000ul
#define USBPHY_CTRL_ENAUTOCLR_CLKGATE_MASK       0x80000ul
#define USBPHY_CTRL_ENAUTOCLR_PHY_PWD_MASK       0x100000ul

/* USB PHY PLL_SIC Bit Fields */
#define USBPHY_PLL_SIC_PLL_POWER_MASK            0x1000ul
#define USBPHY_PLL_SIC_PLL_DIV_SEL_MASK          0x3ul
...
#define USBPHY_PLL_SIC_PLL_BYPASS_MASK           0x10000ul
#define USBPHY_PLL_SIC_PLL_EN_USB_CLKS_MASK      0x40ul
#define USBPHY_PLL_SIC_PLL_LOCK_MASK             0x80000000ul
#define USBPHY_PLL_SIC_PLL_ENABLE_MASK           0x2000ul

/* USB PHY ANACTRL Bit Fields */
#define USBPHY_ANACTRL_PFD_CLK_SEL_MASK          0xCul
#define USBPHY_ANACTRL_PFD_FRAC_MASK             0x3F0ul
#define USBPHY_ANACTRL_PFD_CLKGATE_MASK          0x2ul
...
static void SetWatchDog(uint32_t wdog_stctrlh) {
  // disable watchdog?
  if ((wdog_stctrlh & WDOG_STCTRLH_WDOGEN_MASK) == 0) {
...
static void InitialSetUpRCCRCC2(){
  volatile uint32_t ulOSC_CR, ulSIM_SOPT1, ulSIM_SOPT2, ulSIM_CLKDIV1, ulMCG_C1, ulMCG_C2, ulMCG_C4, ulMCG_C5, ulMCG_C6,
                ulMCG_SC, ulMCG_C7, ulSIM_CLKDIV2, ulWDOG_STCTRLH, ulMCG_MODE, ulMCG_C11, ulSIM_CLKDIV3;
  volatile uint32_t Fosc_kHz;
  uint32_t mcg_mode;
  uint32_t usbPllRefClock;
  ...
  usbPllRefClock = (ulMCG_MODE & 0x300u) >> 8;

  // Set Watchdog
  SetWatchDog(ulWDOG_STCTRLH);

  // set offset for vector table
//  SCB->VTOR = 0;
  ...
  else if ((ulMCG_C2 & MCG_C2_FCFTRIM_MASK) != 0x00)  // Ispitujemo da li imamo napajanje na Vbat pinu (SWRELARM-385)
  {
  ...
  SetPowerModes(ulMCG_MODE, Fosc_kHz);
  ...
  SIM_SOPT2   = ((SIM_SOPT2) & (uint32_t)(~(SIM_SOPT2_TPMSRC_MASK | SIM_SOPT2_USBSRC_MASK))) |
                                         (ulSIM_SOPT2 & SIM_SOPT2_TPMSRC_MASK) |
                                         (ulSIM_SOPT2 & SIM_SOPT2_USBSRC_MASK);   // SJ - dodat odabir clock source-a za USB
  ...
  if ((mcg_mode == MCG_MODE_BLPE) || (mcg_mode == MCG_MODE_BLPI)){
    ...
    if ((mcg_mode == MCG_MODE_PEE) && ((ulMCG_C11 & MCG_C11_PLLCS_MASK) == 0x00U)) {
  ...
  if ((mcg_mode == MCG_MODE_FEI) || (mcg_mode == MCG_MODE_FEE)){
    ...
    while(MCG_S2 != ulMCG_C11) {     // Wait until output of the correct PLL is selected
    }
  }

  //enable VLPR mode
//  if (((SYSTEM_SMC_PMCTRL_VALUE) & SMC_PMCTRL_RUNM_MASK) == (0x02U << SMC_PMCTRL_RUNM_SHIFT)) {
//    SMC_PMCTRL = (uint8_t)((SYSTEM_SMC_PMCTRL_VALUE) & (SMC_PMCTRL_RUNM_MASK)); // Enable VLPR mode
//    while(SMC_PMSTAT != 0x04U) {        // Wait until the system is in VLPR mode
//    }
//  }
  ...
  SIM_CLKDIV3 = ((SIM_CLKDIV3) & (uint32_t)(~(SIM_CLKDIV3_PLLFLLFRAC_MASK | SIM_CLKDIV3_PLLFLLDIV_MASK))) | ((ulSIM_CLKDIV3) & (SIM_CLKDIV3_PLLFLLFRAC_MASK | SIM_CLKDIV3_PLLFLLDIV_MASK));
}
