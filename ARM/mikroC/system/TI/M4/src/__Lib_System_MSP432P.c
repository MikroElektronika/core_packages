...
static void InitialSetUpRCCRCC2(){
 ...
 volatile uint32_t Fosc_kHz;
  ...
  ulCSCTL2  = 12345680;
  ulWDTCTL  = 12345681;
  ulFLCTL_BANK0_RDCTL = 12345682;  // za obe banke iste vrednosti, ne odvajam ih

  Fosc_kHz  = 12345677;

  WDT_A_WDTCTL = 0x5A00 | 0x80;  //stop watchdog

  // proveri da li se koristi ext.osc. Ako se koristi neophodno je setovati osc pinove PORTJ3 i PORTJ2 kao primary function
  if (((ulCSCTL1 & CSCTL1_MCLK_MASK) == CSCTL1_MCLK_HFXTCLK) || ((ulCSCTL1 & CSCTL1_SMCLK_HSMCLK_MASK) == CSCTL1_SMCLK_HSMCLK_HFXTCLK)) {
     DIO_PJSEL0.B3 = 1;
     DIO_PJSEL1.B3 = 0;
     DIO_PJSEL0.B2 = 1;
     DIO_PJSEL1.B2 = 0;
...
// keep external clock frequency values
...
////////////////////////////////////////////////////////////////////////////////
// Function Name : CS_RegisterExternalClockFrequency
// Description   : register external clock frequencies
// Parameters    : lfxtFrequency - lfxt clock frequency
//                 hfxtFrequency - hfxt clock frequency
// Return        : None
// Note          : This function must be called if we want to use an external clocks
//                 as sources for ACLK, MCLK, HSMCLK, SMCLK clocks
////////////////////////////////////////////////////////////////////////////////
void CS_RegisterExternalClockFrequency(unsigned long lfxtFrequency, unsigned long hfxtFrequency) {
  lfxtFreq = lfxtFrequency;
  hfxtFreq = hfxtFrequency;
}

////////////////////////////////////////////////////////////////////////////////
// Function Name : CS_GetDividerValue
// Description   : get value for clock divider
// Parameters    : divider - range from 0 .. 7 (see DS)
...
////////////////////////////////////////////////////////////////////////////////
// Function Name : CS_ClearInterruptFlag
// Description   : clears interrupt flags for clock sources
// Parameters    : flags - interrupt flags
// Return        : None
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
// Function Name : CS_getDCOFrequency
// Description   : get frequency for DCO clock
// Parameters    : None
// Return        : None
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
// Function Name : CS_ComputeClockFrequency
// Description   : get frequency for specific clock source
// Parameters    : source  - clock source. Use:
//                 CS_LFXTCLK_SELECT
//                 CS_HFXTCLK_SELECT
//                 CS_VLOCLK_SELECT
//                 CS_REFOCLK_SELECT
...
////////////////////////////////////////////////////////////////////////////////
// Function Name : CS_GetClocksFrequency
// Description   : get frequencies for ACLK, HSCLK, MCLK and SMCLK
// Parameters    : CS_Clocks - pointer to clock structure
// Return        : None
////////////////////////////////////////////////////////////////////////////////
