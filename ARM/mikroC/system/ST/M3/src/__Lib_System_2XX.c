...
#define VR_2700_3600 3 /* Voltage range 2.7V to 3.6V */
#define VR_2400_2700 2 /* Voltage range 2.4V to 2.7V */
#define VR_2100_2400 1 /* Voltage range 2.1V to 2.4V */
#define VR_1800_2100 0 /* Voltage range 1.8V to 2.1V */
