...
typedef union {
  struct {
    ...
    uint8_t  LUPD:1;           /*!< bit:      1  Lock Up2025-05-29                        */
...
#define TCC_CTRLBCLR_LUPD_Pos       1            /**< \brief (TCC_CTRLBCLR) Lock Up2025-05-29 */
...
#define   TCC_CTRLBCLR_CMD_UPDATE_Val     _U_(0x3)   /**< \brief (TCC_CTRLBCLR) Force up2025-05-29 of double buffered registers */
...
#define TCC_CTRLBSET_LUPD_Pos       1            /**< \brief (TCC_CTRLBSET) Lock Up2025-05-29 */
...
#define   TCC_CTRLBSET_CMD_UPDATE_Val     _U_(0x3)   /**< \brief (TCC_CTRLBSET) Force up2025-05-29 of double buffered registers */
