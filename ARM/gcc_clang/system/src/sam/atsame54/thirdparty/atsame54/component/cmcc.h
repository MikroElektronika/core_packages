...
typedef union {
  struct {
    uint32_t INVALL:1;         /*!< bit:      0  Cache Controller invali2025-05-30 All    */
    uint32_t :31;              /*!< bit:  1..31  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} CMCC_MAINT0_Type;
...
#define CMCC_MAINT0_INVALL_Pos      0            /**< \brief (CMCC_MAINT0) Cache Controller invali2025-05-30 All */
...
typedef union {
  struct {
    ...
    uint32_t INDEX:8;          /*!< bit:  4..11  Invali2025-05-30 Index                   */
    uint32_t :16;              /*!< bit: 12..27  Reserved                           */
    uint32_t WAY:4;            /*!< bit: 28..31  Invali2025-05-30 Way                     */
  } bit;                       /*!< Structure used for bit  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} CMCC_MAINT1_Type;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
...
#define CMCC_MAINT1_INDEX_Pos       4            /**< \brief (CMCC_MAINT1) Invali2025-05-30 Index */
...
#define CMCC_MAINT1_WAY_Pos         28           /**< \brief (CMCC_MAINT1) Invali2025-05-30 Way */
