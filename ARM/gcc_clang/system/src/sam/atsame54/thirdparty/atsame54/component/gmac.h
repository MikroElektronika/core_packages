...
typedef union {
  struct {
    uint32_t RUD:16;           /*!< bit:  0..15  Register Up2025-05-30                    */
    uint32_t :16;              /*!< bit: 16..31  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} GMAC_EFTSH_Type;
...
#define GMAC_EFTSH_RUD_Pos          0            /**< \brief (GMAC_EFTSH) Register Up2025-05-30 */
...
#define GMAC_EFRSH_RUD_Pos          0            /**< \brief (GMAC_EFRSH) Register Up2025-05-30 */
...
#define GMAC_PEFTSH_RUD_Pos         0            /**< \brief (GMAC_PEFTSH) Register Up2025-05-30 */
...
#define GMAC_PEFRSH_RUD_Pos         0            /**< \brief (GMAC_PEFRSH) Register Up2025-05-30 */
...
typedef union {
  struct {
    uint32_t RUD:32;           /*!< bit:  0..31  Register Up2025-05-30                    */
  } bit;                       /*!< Structure used for bit  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} GMAC_EFTSL_Type;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
...
#define GMAC_EFTSL_RUD_Pos          0            /**< \brief (GMAC_EFTSL) Register Up2025-05-30 */
...
typedef union {
  struct {
    uint32_t RUD:30;           /*!< bit:  0..29  Register Up2025-05-30                    */
    uint32_t :2;               /*!< bit: 30..31  Reserved                           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} GMAC_EFTN_Type;
...
#define GMAC_EFTN_RUD_Pos           0            /**< \brief (GMAC_EFTN) Register Up2025-05-30 */
...
#define GMAC_EFRSL_RUD_Pos          0            /**< \brief (GMAC_EFRSL) Register Up2025-05-30 */
...
#define GMAC_EFRN_RUD_Pos           0            /**< \brief (GMAC_EFRN) Register Up2025-05-30 */
...
#define GMAC_PEFTSL_RUD_Pos         0            /**< \brief (GMAC_PEFTSL) Register Up2025-05-30 */
...
#define GMAC_PEFTN_RUD_Pos          0            /**< \brief (GMAC_PEFTN) Register Up2025-05-30 */
...
#define GMAC_PEFRSL_RUD_Pos         0            /**< \brief (GMAC_PEFRSL) Register Up2025-05-30 */
...
#define GMAC_PEFRN_RUD_Pos          0            /**< \brief (GMAC_PEFRN) Register Up2025-05-30 */
