...
typedef union {
  struct {
    ...
    uint32_t RSU:4;            /*!< bit: 20..23  Region Status Up2025-05-30d Interrupt Disable */
...
#define ICM_IER_RSU_Pos             20           /**< \brief (ICM_IER) Region Status Up2025-05-30d Interrupt Disable */
...
#define ICM_IDR_RSU_Pos             20           /**< \brief (ICM_IDR) Region Status Up2025-05-30d Interrupt Disable */
...
typedef union {
  struct {
    ...
    uint32_t RSU:4;            /*!< bit: 20..23  Region Status Up2025-05-30d Interrupt Mask */
...
#define ICM_IMR_RSU_Pos             20           /**< \brief (ICM_IMR) Region Status Up2025-05-30d Interrupt Mask */
...
typedef union {
  struct {
    ...
    uint32_t RSU:4;            /*!< bit: 20..23  Region Status Up2025-05-30d Detected     */
...
#define ICM_ISR_RSU_Pos             20           /**< \brief (ICM_ISR) Region Status Up2025-05-30d Detected */
...
typedef union {
  struct {
    ...
    uint32_t SUIEN:1;          /*!< bit:      9  Region Status Up2025-05-30d Interrupt Enable */
...
#define ICM_RCFG_SUIEN_Pos          9            /**< \brief (ICM_RCFG) Region Status Up2025-05-30d Interrupt Enable */
