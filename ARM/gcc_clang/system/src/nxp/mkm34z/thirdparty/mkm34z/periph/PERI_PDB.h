...
#define PDB_CH_DLY_COUNT                          4u
#define PDB_CH_COUNT                              1u
...
typedef struct {
  ...
  struct {                                         /* offset: 0x10, array step: 0x18 */
    ...
    __IO uint32_t DLY[PDB_CH_DLY_COUNT];             /**< Channel n Delay 0 register..Channel n Delay 3 register, array offset: 0x18, array step: index*0x18, index2*0x4 */
  } CH[PDB_CH_COUNT];
