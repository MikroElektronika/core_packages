...
#define FUSES_GPNVMBITS_PLANE_SELECTION(value) (FUSES_GPNVMBITS_PLANE_SELECTION_Msk & (_UINT16_(value) << FUSES_GPNVMBITS_PLANE_SELECTION_Pos)) /* Assignment of value for PLANE_SELECTION in the FUSES_GPNVMBITS register */
...
#define FUSES_GPNVMBITS_ERASE_FUNCTION_LOCK(value) (FUSES_GPNVMBITS_ERASE_FUNCTION_LOCK_Msk & (_UINT16_(value) << FUSES_GPNVMBITS_ERASE_FUNCTION_LOCK_Pos)) /* Assignment of value for ERASE_FUNCTION_LOCK in the FUSES_GPNVMBITS register */
