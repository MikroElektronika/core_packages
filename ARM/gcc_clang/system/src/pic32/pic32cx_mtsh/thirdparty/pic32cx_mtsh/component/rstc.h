...
#define RSTC_CR_PERRST(value)                 (RSTC_CR_PERRST_Msk & (_UINT32_(value) << RSTC_CR_PERRST_Pos)) /* Assignment of value for PERRST in the RSTC_CR register */
...
#define RSTC_SR_CORESMS(value)                (RSTC_SR_CORESMS_Msk & (_UINT32_(value) << RSTC_SR_CORESMS_Pos)) /* Assignment of value for CORESMS in the RSTC_SR register */
...
#define RSTC_MR_CPUFEN(value)                 (RSTC_MR_CPUFEN_Msk & (_UINT32_(value) << RSTC_MR_CPUFEN_Pos)) /* Assignment of value for CPUFEN in the RSTC_MR register */
...
#define RSTC_MR_SFTPMCRS(value)               (RSTC_MR_SFTPMCRS_Msk & (_UINT32_(value) << RSTC_MR_SFTPMCRS_Pos)) /* Assignment of value for SFTPMCRS in the RSTC_MR register */
...
#define RSTC_MR_WDTPMC0(value)                (RSTC_MR_WDTPMC0_Msk & (_UINT32_(value) << RSTC_MR_WDTPMC0_Pos)) /* Assignment of value for WDTPMC0 in the RSTC_MR register */
...
#define RSTC_MR_WDTPMC1(value)                (RSTC_MR_WDTPMC1_Msk & (_UINT32_(value) << RSTC_MR_WDTPMC1_Pos)) /* Assignment of value for WDTPMC1 in the RSTC_MR register */
...
#define RSTC_MR_CORSMIEN(value)               (RSTC_MR_CORSMIEN_Msk & (_UINT32_(value) << RSTC_MR_CORSMIEN_Pos)) /* Assignment of value for CORSMIEN in the RSTC_MR register */
...
#define RSTC_MR_CPEREN(value)                 (RSTC_MR_CPEREN_Msk & (_UINT32_(value) << RSTC_MR_CPEREN_Pos)) /* Assignment of value for CPEREN in the RSTC_MR register */
...
#define RSTC_MR_CPROCEN(value)                (RSTC_MR_CPROCEN_Msk & (_UINT32_(value) << RSTC_MR_CPROCEN_Pos)) /* Assignment of value for CPROCEN in the RSTC_MR register */
...
#define RSTC_MR_PWRSW(value)                  (RSTC_MR_PWRSW_Msk & (_UINT32_(value) << RSTC_MR_PWRSW_Pos)) /* Assignment of value for PWRSW in the RSTC_MR register */
...
#define RSTC_MR_BADXTRST(value)               (RSTC_MR_BADXTRST_Msk & (_UINT32_(value) << RSTC_MR_BADXTRST_Pos)) /* Assignment of value for BADXTRST in the RSTC_MR register */
