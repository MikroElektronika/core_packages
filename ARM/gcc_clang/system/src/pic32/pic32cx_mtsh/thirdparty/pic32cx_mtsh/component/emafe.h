...
#define EMAFE_CR_SWRST(value)                 (EMAFE_CR_SWRST_Msk & (_UINT32_(value) << EMAFE_CR_SWRST_Pos)) /* Assignment of value for SWRST in the EMAFE_CR register */
...
#define EMAFE_CR_SWRST_DECIM(value)           (EMAFE_CR_SWRST_DECIM_Msk & (_UINT32_(value) << EMAFE_CR_SWRST_DECIM_Pos)) /* Assignment of value for SWRST_DECIM in the EMAFE_CR register */
...
#define EMAFE_MR_LPF_ON0(value)               (EMAFE_MR_LPF_ON0_Msk & (_UINT32_(value) << EMAFE_MR_LPF_ON0_Pos)) /* Assignment of value for LPF_ON0 in the EMAFE_MR register */
...
#define EMAFE_MR_LPF_ON1(value)               (EMAFE_MR_LPF_ON1_Msk & (_UINT32_(value) << EMAFE_MR_LPF_ON1_Pos)) /* Assignment of value for LPF_ON1 in the EMAFE_MR register */
...
#define EMAFE_MR_LPF_ON2(value)               (EMAFE_MR_LPF_ON2_Msk & (_UINT32_(value) << EMAFE_MR_LPF_ON2_Pos)) /* Assignment of value for LPF_ON2 in the EMAFE_MR register */
...
#define EMAFE_MR_LPF_ON3(value)               (EMAFE_MR_LPF_ON3_Msk & (_UINT32_(value) << EMAFE_MR_LPF_ON3_Pos)) /* Assignment of value for LPF_ON3 in the EMAFE_MR register */
...
#define EMAFE_MR_LPF_ON4(value)               (EMAFE_MR_LPF_ON4_Msk & (_UINT32_(value) << EMAFE_MR_LPF_ON4_Pos)) /* Assignment of value for LPF_ON4 in the EMAFE_MR register */
...
#define EMAFE_MR_DMA_ON(value)                (EMAFE_MR_DMA_ON_Msk & (_UINT32_(value) << EMAFE_MR_DMA_ON_Pos)) /* Assignment of value for DMA_ON in the EMAFE_MR register */
...
#define EMAFE_MR_DMACH0(value)                (EMAFE_MR_DMACH0_Msk & (_UINT32_(value) << EMAFE_MR_DMACH0_Pos)) /* Assignment of value for DMACH0 in the EMAFE_MR register */
...
#define EMAFE_MR_DMACH1(value)                (EMAFE_MR_DMACH1_Msk & (_UINT32_(value) << EMAFE_MR_DMACH1_Pos)) /* Assignment of value for DMACH1 in the EMAFE_MR register */
...
#define EMAFE_MR_DMACH2(value)                (EMAFE_MR_DMACH2_Msk & (_UINT32_(value) << EMAFE_MR_DMACH2_Pos)) /* Assignment of value for DMACH2 in the EMAFE_MR register */
...
#define EMAFE_MR_DMACH3(value)                (EMAFE_MR_DMACH3_Msk & (_UINT32_(value) << EMAFE_MR_DMACH3_Pos)) /* Assignment of value for DMACH3 in the EMAFE_MR register */
...
#define EMAFE_MR_DMACH4(value)                (EMAFE_MR_DMACH4_Msk & (_UINT32_(value) << EMAFE_MR_DMACH4_Pos)) /* Assignment of value for DMACH4 in the EMAFE_MR register */
...
#define EMAFE_MR_VAR_ON(value)                (EMAFE_MR_VAR_ON_Msk & (_UINT32_(value) << EMAFE_MR_VAR_ON_Pos)) /* Assignment of value for VAR_ON in the EMAFE_MR register */
...
#define EMAFE_MR_VAR_CH(value)                (EMAFE_MR_VAR_CH_Msk & (_UINT32_(value) << EMAFE_MR_VAR_CH_Pos)) /* Assignment of value for VAR_CH in the EMAFE_MR register */
...
#define EMAFE_MR_VAR_LIMIT(value)             (EMAFE_MR_VAR_LIMIT_Msk & (_UINT32_(value) << EMAFE_MR_VAR_LIMIT_Pos)) /* Assignment of value for VAR_LIMIT in the EMAFE_MR register */
...
#define EMAFE_CDCR_CHA_IDX(value)             (EMAFE_CDCR_CHA_IDX_Msk & (_UINT32_(value) << EMAFE_CDCR_CHA_IDX_Pos)) /* Assignment of value for CHA_IDX in the EMAFE_CDCR register */
...
#define EMAFE_CDCR_CHB_IDX(value)             (EMAFE_CDCR_CHB_IDX_Msk & (_UINT32_(value) << EMAFE_CDCR_CHB_IDX_Pos)) /* Assignment of value for CHB_IDX in the EMAFE_CDCR register */
...
#define EMAFE_CDCR_DIFFTYPE(value)            (EMAFE_CDCR_DIFFTYPE_Msk & (_UINT32_(value) << EMAFE_CDCR_DIFFTYPE_Pos)) /* Assignment of value for DIFFTYPE in the EMAFE_CDCR register */
...
#define EMAFE_CDCR_DIFFCOUNT(value)           (EMAFE_CDCR_DIFFCOUNT_Msk & (_UINT32_(value) << EMAFE_CDCR_DIFFCOUNT_Pos)) /* Assignment of value for DIFFCOUNT in the EMAFE_CDCR register */
...
#define EMAFE_CDCR_DIFFTHRES(value)           (EMAFE_CDCR_DIFFTHRES_Msk & (_UINT32_(value) << EMAFE_CDCR_DIFFTHRES_Pos)) /* Assignment of value for DIFFTHRES in the EMAFE_CDCR register */
...
#define EMAFE_EMR_FORMAT(value)               (EMAFE_EMR_FORMAT_Msk & (_UINT32_(value) << EMAFE_EMR_FORMAT_Pos)) /* Assignment of value for FORMAT in the EMAFE_EMR register */
...
#define EMAFE_EMR_MCLKDIV_LPF(value)          (EMAFE_EMR_MCLKDIV_LPF_Msk & (_UINT32_(value) << EMAFE_EMR_MCLKDIV_LPF_Pos)) /* Assignment of value for MCLKDIV_LPF in the EMAFE_EMR register */
...
#define EMAFE_EMR_OSR(value)                  (EMAFE_EMR_OSR_Msk & (_UINT32_(value) << EMAFE_EMR_OSR_Pos)) /* Assignment of value for OSR in the EMAFE_EMR register */
...
#define EMAFE_CHA_CFG1_THRESH1(value)         (EMAFE_CHA_CFG1_THRESH1_Msk & (_UINT32_(value) << EMAFE_CHA_CFG1_THRESH1_Pos)) /* Assignment of value for THRESH1 in the EMAFE_CHA_CFG1 register */
...
#define EMAFE_CHA_CFG1_IDX(value)             (EMAFE_CHA_CFG1_IDX_Msk & (_UINT32_(value) << EMAFE_CHA_CFG1_IDX_Pos)) /* Assignment of value for IDX in the EMAFE_CHA_CFG1 register */
...
#define EMAFE_CHA_CFG1_COND(value)            (EMAFE_CHA_CFG1_COND_Msk & (_UINT32_(value) << EMAFE_CHA_CFG1_COND_Pos)) /* Assignment of value for COND in the EMAFE_CHA_CFG1 register */
...
#define EMAFE_CHB_CFG1_THRESH1(value)         (EMAFE_CHB_CFG1_THRESH1_Msk & (_UINT32_(value) << EMAFE_CHB_CFG1_THRESH1_Pos)) /* Assignment of value for THRESH1 in the EMAFE_CHB_CFG1 register */
...
#define EMAFE_CHB_CFG1_IDX(value)             (EMAFE_CHB_CFG1_IDX_Msk & (_UINT32_(value) << EMAFE_CHB_CFG1_IDX_Pos)) /* Assignment of value for IDX in the EMAFE_CHB_CFG1 register */
...
#define EMAFE_CHB_CFG1_COND(value)            (EMAFE_CHB_CFG1_COND_Msk & (_UINT32_(value) << EMAFE_CHB_CFG1_COND_Pos)) /* Assignment of value for COND in the EMAFE_CHB_CFG1 register */
...
#define EMAFE_CHA_CFG2_THRESH2(value)         (EMAFE_CHA_CFG2_THRESH2_Msk & (_UINT32_(value) << EMAFE_CHA_CFG2_THRESH2_Pos)) /* Assignment of value for THRESH2 in the EMAFE_CHA_CFG2 register */
...
#define EMAFE_CHB_CFG2_THRESH2(value)         (EMAFE_CHB_CFG2_THRESH2_Msk & (_UINT32_(value) << EMAFE_CHB_CFG2_THRESH2_Pos)) /* Assignment of value for THRESH2 in the EMAFE_CHB_CFG2 register */
...
#define EMAFE_IER_DRDY(value)                 (EMAFE_IER_DRDY_Msk & (_UINT32_(value) << EMAFE_IER_DRDY_Pos)) /* Assignment of value for DRDY in the EMAFE_IER register */
...
#define EMAFE_IER_RXUDR(value)                (EMAFE_IER_RXUDR_Msk & (_UINT32_(value) << EMAFE_IER_RXUDR_Pos)) /* Assignment of value for RXUDR in the EMAFE_IER register */
...
#define EMAFE_IER_RXFULL(value)               (EMAFE_IER_RXFULL_Msk & (_UINT32_(value) << EMAFE_IER_RXFULL_Pos)) /* Assignment of value for RXFULL in the EMAFE_IER register */
...
#define EMAFE_IER_RXEMPTY(value)              (EMAFE_IER_RXEMPTY_Msk & (_UINT32_(value) << EMAFE_IER_RXEMPTY_Pos)) /* Assignment of value for RXEMPTY in the EMAFE_IER register */
...
#define EMAFE_IER_CHCHG(value)                (EMAFE_IER_CHCHG_Msk & (_UINT32_(value) << EMAFE_IER_CHCHG_Pos)) /* Assignment of value for CHCHG in the EMAFE_IER register */
...
#define EMAFE_IER_CHDIFF(value)               (EMAFE_IER_CHDIFF_Msk & (_UINT32_(value) << EMAFE_IER_CHDIFF_Pos)) /* Assignment of value for CHDIFF in the EMAFE_IER register */
...
#define EMAFE_IER_PARERROR(value)             (EMAFE_IER_PARERROR_Msk & (_UINT32_(value) << EMAFE_IER_PARERROR_Pos)) /* Assignment of value for PARERROR in the EMAFE_IER register */
...
#define EMAFE_IER_ENDRX(value)                (EMAFE_IER_ENDRX_Msk & (_UINT32_(value) << EMAFE_IER_ENDRX_Pos)) /* Assignment of value for ENDRX in the EMAFE_IER register */
...
#define EMAFE_IER_RXBUFF(value)               (EMAFE_IER_RXBUFF_Msk & (_UINT32_(value) << EMAFE_IER_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the EMAFE_IER register */
...
#define EMAFE_IER_CHAEVT(value)               (EMAFE_IER_CHAEVT_Msk & (_UINT32_(value) << EMAFE_IER_CHAEVT_Pos)) /* Assignment of value for CHAEVT in the EMAFE_IER register */
...
#define EMAFE_IER_CHBEVT(value)               (EMAFE_IER_CHBEVT_Msk & (_UINT32_(value) << EMAFE_IER_CHBEVT_Pos)) /* Assignment of value for CHBEVT in the EMAFE_IER register */
...
#define EMAFE_IDR_DRDY(value)                 (EMAFE_IDR_DRDY_Msk & (_UINT32_(value) << EMAFE_IDR_DRDY_Pos)) /* Assignment of value for DRDY in the EMAFE_IDR register */
...
#define EMAFE_IDR_RXUDR(value)                (EMAFE_IDR_RXUDR_Msk & (_UINT32_(value) << EMAFE_IDR_RXUDR_Pos)) /* Assignment of value for RXUDR in the EMAFE_IDR register */
...
#define EMAFE_IDR_RXFULL(value)               (EMAFE_IDR_RXFULL_Msk & (_UINT32_(value) << EMAFE_IDR_RXFULL_Pos)) /* Assignment of value for RXFULL in the EMAFE_IDR register */
...
#define EMAFE_IDR_RXEMPTY(value)              (EMAFE_IDR_RXEMPTY_Msk & (_UINT32_(value) << EMAFE_IDR_RXEMPTY_Pos)) /* Assignment of value for RXEMPTY in the EMAFE_IDR register */
...
#define EMAFE_IDR_CHCHG(value)                (EMAFE_IDR_CHCHG_Msk & (_UINT32_(value) << EMAFE_IDR_CHCHG_Pos)) /* Assignment of value for CHCHG in the EMAFE_IDR register */
...
#define EMAFE_IDR_CHDIFF(value)               (EMAFE_IDR_CHDIFF_Msk & (_UINT32_(value) << EMAFE_IDR_CHDIFF_Pos)) /* Assignment of value for CHDIFF in the EMAFE_IDR register */
...
#define EMAFE_IDR_PARERROR(value)             (EMAFE_IDR_PARERROR_Msk & (_UINT32_(value) << EMAFE_IDR_PARERROR_Pos)) /* Assignment of value for PARERROR in the EMAFE_IDR register */
...
#define EMAFE_IDR_ENDRX(value)                (EMAFE_IDR_ENDRX_Msk & (_UINT32_(value) << EMAFE_IDR_ENDRX_Pos)) /* Assignment of value for ENDRX in the EMAFE_IDR register */
...
#define EMAFE_IDR_RXBUFF(value)               (EMAFE_IDR_RXBUFF_Msk & (_UINT32_(value) << EMAFE_IDR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the EMAFE_IDR register */
...
#define EMAFE_IDR_CHAEVT(value)               (EMAFE_IDR_CHAEVT_Msk & (_UINT32_(value) << EMAFE_IDR_CHAEVT_Pos)) /* Assignment of value for CHAEVT in the EMAFE_IDR register */
...
#define EMAFE_IDR_CHBEVT(value)               (EMAFE_IDR_CHBEVT_Msk & (_UINT32_(value) << EMAFE_IDR_CHBEVT_Pos)) /* Assignment of value for CHBEVT in the EMAFE_IDR register */
...
#define EMAFE_IMR_DRDY(value)                 (EMAFE_IMR_DRDY_Msk & (_UINT32_(value) << EMAFE_IMR_DRDY_Pos)) /* Assignment of value for DRDY in the EMAFE_IMR register */
...
#define EMAFE_IMR_RXUDR(value)                (EMAFE_IMR_RXUDR_Msk & (_UINT32_(value) << EMAFE_IMR_RXUDR_Pos)) /* Assignment of value for RXUDR in the EMAFE_IMR register */
...
#define EMAFE_IMR_RXFULL(value)               (EMAFE_IMR_RXFULL_Msk & (_UINT32_(value) << EMAFE_IMR_RXFULL_Pos)) /* Assignment of value for RXFULL in the EMAFE_IMR register */
...
#define EMAFE_IMR_RXEMPTY(value)              (EMAFE_IMR_RXEMPTY_Msk & (_UINT32_(value) << EMAFE_IMR_RXEMPTY_Pos)) /* Assignment of value for RXEMPTY in the EMAFE_IMR register */
...
#define EMAFE_IMR_CHCHG(value)                (EMAFE_IMR_CHCHG_Msk & (_UINT32_(value) << EMAFE_IMR_CHCHG_Pos)) /* Assignment of value for CHCHG in the EMAFE_IMR register */
...
#define EMAFE_IMR_CHDIFF(value)               (EMAFE_IMR_CHDIFF_Msk & (_UINT32_(value) << EMAFE_IMR_CHDIFF_Pos)) /* Assignment of value for CHDIFF in the EMAFE_IMR register */
...
#define EMAFE_IMR_PARERROR(value)             (EMAFE_IMR_PARERROR_Msk & (_UINT32_(value) << EMAFE_IMR_PARERROR_Pos)) /* Assignment of value for PARERROR in the EMAFE_IMR register */
...
#define EMAFE_IMR_ENDRX(value)                (EMAFE_IMR_ENDRX_Msk & (_UINT32_(value) << EMAFE_IMR_ENDRX_Pos)) /* Assignment of value for ENDRX in the EMAFE_IMR register */
...
#define EMAFE_IMR_RXBUFF(value)               (EMAFE_IMR_RXBUFF_Msk & (_UINT32_(value) << EMAFE_IMR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the EMAFE_IMR register */
...
#define EMAFE_IMR_CHAEVT(value)               (EMAFE_IMR_CHAEVT_Msk & (_UINT32_(value) << EMAFE_IMR_CHAEVT_Pos)) /* Assignment of value for CHAEVT in the EMAFE_IMR register */
...
#define EMAFE_IMR_CHBEVT(value)               (EMAFE_IMR_CHBEVT_Msk & (_UINT32_(value) << EMAFE_IMR_CHBEVT_Pos)) /* Assignment of value for CHBEVT in the EMAFE_IMR register */
...
#define EMAFE_ISR_DRDY(value)                 (EMAFE_ISR_DRDY_Msk & (_UINT32_(value) << EMAFE_ISR_DRDY_Pos)) /* Assignment of value for DRDY in the EMAFE_ISR register */
...
#define EMAFE_ISR_RXUDR(value)                (EMAFE_ISR_RXUDR_Msk & (_UINT32_(value) << EMAFE_ISR_RXUDR_Pos)) /* Assignment of value for RXUDR in the EMAFE_ISR register */
...
#define EMAFE_ISR_RXFULL(value)               (EMAFE_ISR_RXFULL_Msk & (_UINT32_(value) << EMAFE_ISR_RXFULL_Pos)) /* Assignment of value for RXFULL in the EMAFE_ISR register */
...
#define EMAFE_ISR_RXEMPTY(value)              (EMAFE_ISR_RXEMPTY_Msk & (_UINT32_(value) << EMAFE_ISR_RXEMPTY_Pos)) /* Assignment of value for RXEMPTY in the EMAFE_ISR register */
...
#define EMAFE_ISR_CHCHG(value)                (EMAFE_ISR_CHCHG_Msk & (_UINT32_(value) << EMAFE_ISR_CHCHG_Pos)) /* Assignment of value for CHCHG in the EMAFE_ISR register */
...
#define EMAFE_ISR_CHDIFF(value)               (EMAFE_ISR_CHDIFF_Msk & (_UINT32_(value) << EMAFE_ISR_CHDIFF_Pos)) /* Assignment of value for CHDIFF in the EMAFE_ISR register */
...
#define EMAFE_ISR_PARERROR(value)             (EMAFE_ISR_PARERROR_Msk & (_UINT32_(value) << EMAFE_ISR_PARERROR_Pos)) /* Assignment of value for PARERROR in the EMAFE_ISR register */
...
#define EMAFE_ISR_ENDRX(value)                (EMAFE_ISR_ENDRX_Msk & (_UINT32_(value) << EMAFE_ISR_ENDRX_Pos)) /* Assignment of value for ENDRX in the EMAFE_ISR register */
...
#define EMAFE_ISR_RXBUFF(value)               (EMAFE_ISR_RXBUFF_Msk & (_UINT32_(value) << EMAFE_ISR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the EMAFE_ISR register */
...
#define EMAFE_ISR_CHAEVT(value)               (EMAFE_ISR_CHAEVT_Msk & (_UINT32_(value) << EMAFE_ISR_CHAEVT_Pos)) /* Assignment of value for CHAEVT in the EMAFE_ISR register */
...
#define EMAFE_ISR_CHBEVT(value)               (EMAFE_ISR_CHBEVT_Msk & (_UINT32_(value) << EMAFE_ISR_CHBEVT_Pos)) /* Assignment of value for CHBEVT in the EMAFE_ISR register */
...
#define EMAFE_SR_CHAEVT(value)                (EMAFE_SR_CHAEVT_Msk & (_UINT32_(value) << EMAFE_SR_CHAEVT_Pos)) /* Assignment of value for CHAEVT in the EMAFE_SR register */
...
#define EMAFE_SR_CHBEVT(value)                (EMAFE_SR_CHBEVT_Msk & (_UINT32_(value) << EMAFE_SR_CHBEVT_Pos)) /* Assignment of value for CHBEVT in the EMAFE_SR register */
...
#define EMAFE_WPMR_WPCFEN(value)              (EMAFE_WPMR_WPCFEN_Msk & (_UINT32_(value) << EMAFE_WPMR_WPCFEN_Pos)) /* Assignment of value for WPCFEN in the EMAFE_WPMR register */
...
#define EMAFE_WPMR_WPITEN(value)              (EMAFE_WPMR_WPITEN_Msk & (_UINT32_(value) << EMAFE_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the EMAFE_WPMR register */
...
#define EMAFE_WPMR_WPCTRL(value)              (EMAFE_WPMR_WPCTRL_Msk & (_UINT32_(value) << EMAFE_WPMR_WPCTRL_Pos)) /* Assignment of value for WPCTRL in the EMAFE_WPMR register */
...
#define EMAFE_WPMR_WPKEY(value)               (EMAFE_WPMR_WPKEY_Msk & (_UINT32_(value) << EMAFE_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the EMAFE_WPMR register */
...
#define EMAFE_WPSR_WPVS(value)                (EMAFE_WPSR_WPVS_Msk & (_UINT32_(value) << EMAFE_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the EMAFE_WPSR register */
...
#define EMAFE_WPSR_WPVSRC(value)              (EMAFE_WPSR_WPVSRC_Msk & (_UINT32_(value) << EMAFE_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the EMAFE_WPSR register */
...
#define EMAFE_VERSION_VERSION(value)          (EMAFE_VERSION_VERSION_Msk & (_UINT32_(value) << EMAFE_VERSION_VERSION_Pos)) /* Assignment of value for VERSION in the EMAFE_VERSION register */
...
#define EMAFE_VERSION_MFN(value)              (EMAFE_VERSION_MFN_Msk & (_UINT32_(value) << EMAFE_VERSION_MFN_Pos)) /* Assignment of value for MFN in the EMAFE_VERSION register */
...
#define EMAFE_RPR_RXPTR(value)                (EMAFE_RPR_RXPTR_Msk & (_UINT32_(value) << EMAFE_RPR_RXPTR_Pos)) /* Assignment of value for RXPTR in the EMAFE_RPR register */
...
#define EMAFE_RCR_RXCTR(value)                (EMAFE_RCR_RXCTR_Msk & (_UINT32_(value) << EMAFE_RCR_RXCTR_Pos)) /* Assignment of value for RXCTR in the EMAFE_RCR register */
...
#define EMAFE_RNPR_RXNPTR(value)              (EMAFE_RNPR_RXNPTR_Msk & (_UINT32_(value) << EMAFE_RNPR_RXNPTR_Pos)) /* Assignment of value for RXNPTR in the EMAFE_RNPR register */
...
#define EMAFE_RNCR_RXNCTR(value)              (EMAFE_RNCR_RXNCTR_Msk & (_UINT32_(value) << EMAFE_RNCR_RXNCTR_Pos)) /* Assignment of value for RXNCTR in the EMAFE_RNCR register */
...
#define EMAFE_PTCR_RXTEN(value)               (EMAFE_PTCR_RXTEN_Msk & (_UINT32_(value) << EMAFE_PTCR_RXTEN_Pos)) /* Assignment of value for RXTEN in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_RXTDIS(value)              (EMAFE_PTCR_RXTDIS_Msk & (_UINT32_(value) << EMAFE_PTCR_RXTDIS_Pos)) /* Assignment of value for RXTDIS in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_TXTEN(value)               (EMAFE_PTCR_TXTEN_Msk & (_UINT32_(value) << EMAFE_PTCR_TXTEN_Pos)) /* Assignment of value for TXTEN in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_TXTDIS(value)              (EMAFE_PTCR_TXTDIS_Msk & (_UINT32_(value) << EMAFE_PTCR_TXTDIS_Pos)) /* Assignment of value for TXTDIS in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_RXCBEN(value)              (EMAFE_PTCR_RXCBEN_Msk & (_UINT32_(value) << EMAFE_PTCR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_RXCBDIS(value)             (EMAFE_PTCR_RXCBDIS_Msk & (_UINT32_(value) << EMAFE_PTCR_RXCBDIS_Pos)) /* Assignment of value for RXCBDIS in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_TXCBEN(value)              (EMAFE_PTCR_TXCBEN_Msk & (_UINT32_(value) << EMAFE_PTCR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_TXCBDIS(value)             (EMAFE_PTCR_TXCBDIS_Msk & (_UINT32_(value) << EMAFE_PTCR_TXCBDIS_Pos)) /* Assignment of value for TXCBDIS in the EMAFE_PTCR register */
...
#define EMAFE_PTCR_ERRCLR(value)              (EMAFE_PTCR_ERRCLR_Msk & (_UINT32_(value) << EMAFE_PTCR_ERRCLR_Pos)) /* Assignment of value for ERRCLR in the EMAFE_PTCR register */
...
#define EMAFE_PTSR_RXTEN(value)               (EMAFE_PTSR_RXTEN_Msk & (_UINT32_(value) << EMAFE_PTSR_RXTEN_Pos)) /* Assignment of value for RXTEN in the EMAFE_PTSR register */
...
#define EMAFE_PTSR_TXTEN(value)               (EMAFE_PTSR_TXTEN_Msk & (_UINT32_(value) << EMAFE_PTSR_TXTEN_Pos)) /* Assignment of value for TXTEN in the EMAFE_PTSR register */
...
#define EMAFE_PTSR_RXCBEN(value)              (EMAFE_PTSR_RXCBEN_Msk & (_UINT32_(value) << EMAFE_PTSR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the EMAFE_PTSR register */
...
#define EMAFE_PTSR_TXCBEN(value)              (EMAFE_PTSR_TXCBEN_Msk & (_UINT32_(value) << EMAFE_PTSR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the EMAFE_PTSR register */
...
#define EMAFE_PTSR_ERR(value)                 (EMAFE_PTSR_ERR_Msk & (_UINT32_(value) << EMAFE_PTSR_ERR_Pos)) /* Assignment of value for ERR in the EMAFE_PTSR register */
...
#define EMAFE_PWPMR_WPPTREN(value)            (EMAFE_PWPMR_WPPTREN_Msk & (_UINT32_(value) << EMAFE_PWPMR_WPPTREN_Pos)) /* Assignment of value for WPPTREN in the EMAFE_PWPMR register */
...
#define EMAFE_PWPMR_WPCTREN(value)            (EMAFE_PWPMR_WPCTREN_Msk & (_UINT32_(value) << EMAFE_PWPMR_WPCTREN_Pos)) /* Assignment of value for WPCTREN in the EMAFE_PWPMR register */
...
#define EMAFE_PWPMR_WPCREN(value)             (EMAFE_PWPMR_WPCREN_Msk & (_UINT32_(value) << EMAFE_PWPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the EMAFE_PWPMR register */
...
#define EMAFE_PWPMR_WPKEY(value)              (EMAFE_PWPMR_WPKEY_Msk & (_UINT32_(value) << EMAFE_PWPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the EMAFE_PWPMR register */
...
/* EMAFE register offsets definitions */
