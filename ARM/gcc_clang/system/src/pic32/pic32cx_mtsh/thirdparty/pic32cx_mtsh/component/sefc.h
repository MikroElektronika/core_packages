...
#define SEFC_EEFC_FMR_FRDY(value)             (SEFC_EEFC_FMR_FRDY_Msk & (_UINT32_(value) << SEFC_EEFC_FMR_FRDY_Pos)) /* Assignment of value for FRDY in the SEFC_EEFC_FMR register */
...
#define SEFC_EEFC_FMR_FWS(value)              (SEFC_EEFC_FMR_FWS_Msk & (_UINT32_(value) << SEFC_EEFC_FMR_FWS_Pos)) /* Assignment of value for FWS in the SEFC_EEFC_FMR register */
...
#define SEFC_EEFC_FMR_SCOD(value)             (SEFC_EEFC_FMR_SCOD_Msk & (_UINT32_(value) << SEFC_EEFC_FMR_SCOD_Pos)) /* Assignment of value for SCOD in the SEFC_EEFC_FMR register */
...
#define SEFC_EEFC_FMR_CLOE(value)             (SEFC_EEFC_FMR_CLOE_Msk & (_UINT32_(value) << SEFC_EEFC_FMR_CLOE_Pos)) /* Assignment of value for CLOE in the SEFC_EEFC_FMR register */
...
#define SEFC_EEFC_FMR_ALWAYS1(value)          (SEFC_EEFC_FMR_ALWAYS1_Msk & (_UINT32_(value) << SEFC_EEFC_FMR_ALWAYS1_Pos)) /* Assignment of value for ALWAYS1 in the SEFC_EEFC_FMR register */
...
#define SEFC_EEFC_FCR_FCMD(value)             (SEFC_EEFC_FCR_FCMD_Msk & (_UINT32_(value) << SEFC_EEFC_FCR_FCMD_Pos)) /* Assignment of value for FCMD in the SEFC_EEFC_FCR register */
...
#define SEFC_EEFC_FCR_FARG(value)             (SEFC_EEFC_FCR_FARG_Msk & (_UINT32_(value) << SEFC_EEFC_FCR_FARG_Pos)) /* Assignment of value for FARG in the SEFC_EEFC_FCR register */
...
#define SEFC_EEFC_FCR_FKEY(value)             (SEFC_EEFC_FCR_FKEY_Msk & (_UINT32_(value) << SEFC_EEFC_FCR_FKEY_Pos)) /* Assignment of value for FKEY in the SEFC_EEFC_FCR register */
...
#define SEFC_EEFC_FSR_FRDY(value)             (SEFC_EEFC_FSR_FRDY_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_FRDY_Pos)) /* Assignment of value for FRDY in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_FCMDE(value)            (SEFC_EEFC_FSR_FCMDE_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_FCMDE_Pos)) /* Assignment of value for FCMDE in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_FLOCKE(value)           (SEFC_EEFC_FSR_FLOCKE_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_FLOCKE_Pos)) /* Assignment of value for FLOCKE in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_FLERR(value)            (SEFC_EEFC_FSR_FLERR_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_FLERR_Pos)) /* Assignment of value for FLERR in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_WPERR(value)            (SEFC_EEFC_FSR_WPERR_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_WPERR_Pos)) /* Assignment of value for WPERR in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_FLSUSP(value)           (SEFC_EEFC_FSR_FLSUSP_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_FLSUSP_Pos)) /* Assignment of value for FLSUSP in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_SECCELSBD(value)        (SEFC_EEFC_FSR_SECCELSBD_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_SECCELSBD_Pos)) /* Assignment of value for SECCELSBD in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_MECCELSBD(value)        (SEFC_EEFC_FSR_MECCELSBD_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_MECCELSBD_Pos)) /* Assignment of value for MECCELSBD in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_SECCEMSBD(value)        (SEFC_EEFC_FSR_SECCEMSBD_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_SECCEMSBD_Pos)) /* Assignment of value for SECCEMSBD in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_MECCEMSBD(value)        (SEFC_EEFC_FSR_MECCEMSBD_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_MECCEMSBD_Pos)) /* Assignment of value for MECCEMSBD in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_SECCELSBL(value)        (SEFC_EEFC_FSR_SECCELSBL_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_SECCELSBL_Pos)) /* Assignment of value for SECCELSBL in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_MECCELSBL(value)        (SEFC_EEFC_FSR_MECCELSBL_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_MECCELSBL_Pos)) /* Assignment of value for MECCELSBL in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_SECCEMSBL(value)        (SEFC_EEFC_FSR_SECCEMSBL_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_SECCEMSBL_Pos)) /* Assignment of value for SECCEMSBL in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FSR_MECCEMSBL(value)        (SEFC_EEFC_FSR_MECCEMSBL_Msk & (_UINT32_(value) << SEFC_EEFC_FSR_MECCEMSBL_Pos)) /* Assignment of value for MECCEMSBL in the SEFC_EEFC_FSR register */
...
#define SEFC_EEFC_FRR_FVALUE(value)           (SEFC_EEFC_FRR_FVALUE_Msk & (_UINT32_(value) << SEFC_EEFC_FRR_FVALUE_Pos)) /* Assignment of value for FVALUE in the SEFC_EEFC_FRR register */
...
#define SEFC_EEFC_USR_RDENUSB0(value)         (SEFC_EEFC_USR_RDENUSB0_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB0_Pos)) /* Assignment of value for RDENUSB0 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_RDENUSB1(value)         (SEFC_EEFC_USR_RDENUSB1_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB1_Pos)) /* Assignment of value for RDENUSB1 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_RDENUSB2(value)         (SEFC_EEFC_USR_RDENUSB2_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB2_Pos)) /* Assignment of value for RDENUSB2 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_RDENUSB3(value)         (SEFC_EEFC_USR_RDENUSB3_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB3_Pos)) /* Assignment of value for RDENUSB3 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_RDENUSB4(value)         (SEFC_EEFC_USR_RDENUSB4_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB4_Pos)) /* Assignment of value for RDENUSB4 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_RDENUSB5(value)         (SEFC_EEFC_USR_RDENUSB5_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB5_Pos)) /* Assignment of value for RDENUSB5 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_RDENUSB6(value)         (SEFC_EEFC_USR_RDENUSB6_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB6_Pos)) /* Assignment of value for RDENUSB6 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_RDENUSB7(value)         (SEFC_EEFC_USR_RDENUSB7_Msk & (_UINT32_(value) << SEFC_EEFC_USR_RDENUSB7_Pos)) /* Assignment of value for RDENUSB7 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB0(value)         (SEFC_EEFC_USR_WRENUSB0_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB0_Pos)) /* Assignment of value for WRENUSB0 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB1(value)         (SEFC_EEFC_USR_WRENUSB1_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB1_Pos)) /* Assignment of value for WRENUSB1 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB2(value)         (SEFC_EEFC_USR_WRENUSB2_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB2_Pos)) /* Assignment of value for WRENUSB2 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB3(value)         (SEFC_EEFC_USR_WRENUSB3_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB3_Pos)) /* Assignment of value for WRENUSB3 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB4(value)         (SEFC_EEFC_USR_WRENUSB4_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB4_Pos)) /* Assignment of value for WRENUSB4 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB5(value)         (SEFC_EEFC_USR_WRENUSB5_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB5_Pos)) /* Assignment of value for WRENUSB5 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB6(value)         (SEFC_EEFC_USR_WRENUSB6_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB6_Pos)) /* Assignment of value for WRENUSB6 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_WRENUSB7(value)         (SEFC_EEFC_USR_WRENUSB7_Msk & (_UINT32_(value) << SEFC_EEFC_USR_WRENUSB7_Pos)) /* Assignment of value for WRENUSB7 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB0(value)         (SEFC_EEFC_USR_PRIVUSB0_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB0_Pos)) /* Assignment of value for PRIVUSB0 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB1(value)         (SEFC_EEFC_USR_PRIVUSB1_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB1_Pos)) /* Assignment of value for PRIVUSB1 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB2(value)         (SEFC_EEFC_USR_PRIVUSB2_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB2_Pos)) /* Assignment of value for PRIVUSB2 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB3(value)         (SEFC_EEFC_USR_PRIVUSB3_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB3_Pos)) /* Assignment of value for PRIVUSB3 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB4(value)         (SEFC_EEFC_USR_PRIVUSB4_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB4_Pos)) /* Assignment of value for PRIVUSB4 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB5(value)         (SEFC_EEFC_USR_PRIVUSB5_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB5_Pos)) /* Assignment of value for PRIVUSB5 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB6(value)         (SEFC_EEFC_USR_PRIVUSB6_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB6_Pos)) /* Assignment of value for PRIVUSB6 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_PRIVUSB7(value)         (SEFC_EEFC_USR_PRIVUSB7_Msk & (_UINT32_(value) << SEFC_EEFC_USR_PRIVUSB7_Pos)) /* Assignment of value for PRIVUSB7 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB0(value)        (SEFC_EEFC_USR_LOCKUSRB0_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB0_Pos)) /* Assignment of value for LOCKUSRB0 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB1(value)        (SEFC_EEFC_USR_LOCKUSRB1_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB1_Pos)) /* Assignment of value for LOCKUSRB1 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB2(value)        (SEFC_EEFC_USR_LOCKUSRB2_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB2_Pos)) /* Assignment of value for LOCKUSRB2 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB3(value)        (SEFC_EEFC_USR_LOCKUSRB3_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB3_Pos)) /* Assignment of value for LOCKUSRB3 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB4(value)        (SEFC_EEFC_USR_LOCKUSRB4_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB4_Pos)) /* Assignment of value for LOCKUSRB4 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB5(value)        (SEFC_EEFC_USR_LOCKUSRB5_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB5_Pos)) /* Assignment of value for LOCKUSRB5 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB6(value)        (SEFC_EEFC_USR_LOCKUSRB6_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB6_Pos)) /* Assignment of value for LOCKUSRB6 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_USR_LOCKUSRB7(value)        (SEFC_EEFC_USR_LOCKUSRB7_Msk & (_UINT32_(value) << SEFC_EEFC_USR_LOCKUSRB7_Pos)) /* Assignment of value for LOCKUSRB7 in the SEFC_EEFC_USR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB0(value)        (SEFC_EEFC_KBLR_KBTLUSB0_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB0_Pos)) /* Assignment of value for KBTLUSB0 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB1(value)        (SEFC_EEFC_KBLR_KBTLUSB1_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB1_Pos)) /* Assignment of value for KBTLUSB1 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB2(value)        (SEFC_EEFC_KBLR_KBTLUSB2_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB2_Pos)) /* Assignment of value for KBTLUSB2 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB3(value)        (SEFC_EEFC_KBLR_KBTLUSB3_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB3_Pos)) /* Assignment of value for KBTLUSB3 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB4(value)        (SEFC_EEFC_KBLR_KBTLUSB4_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB4_Pos)) /* Assignment of value for KBTLUSB4 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB5(value)        (SEFC_EEFC_KBLR_KBTLUSB5_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB5_Pos)) /* Assignment of value for KBTLUSB5 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB6(value)        (SEFC_EEFC_KBLR_KBTLUSB6_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB6_Pos)) /* Assignment of value for KBTLUSB6 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_KBLR_KBTLUSB7(value)        (SEFC_EEFC_KBLR_KBTLUSB7_Msk & (_UINT32_(value) << SEFC_EEFC_KBLR_KBTLUSB7_Pos)) /* Assignment of value for KBTLUSB7 in the SEFC_EEFC_KBLR register */
...
#define SEFC_EEFC_WPMR_WPEN(value)            (SEFC_EEFC_WPMR_WPEN_Msk & (_UINT32_(value) << SEFC_EEFC_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the SEFC_EEFC_WPMR register */
...
#define SEFC_EEFC_WPMR_GPNVMWP(value)         (SEFC_EEFC_WPMR_GPNVMWP_Msk & (_UINT32_(value) << SEFC_EEFC_WPMR_GPNVMWP_Pos)) /* Assignment of value for GPNVMWP in the SEFC_EEFC_WPMR register */
...
#define SEFC_EEFC_WPMR_LOCKWP(value)          (SEFC_EEFC_WPMR_LOCKWP_Msk & (_UINT32_(value) << SEFC_EEFC_WPMR_LOCKWP_Pos)) /* Assignment of value for LOCKWP in the SEFC_EEFC_WPMR register */
...
#define SEFC_EEFC_WPMR_ERASEWP(value)         (SEFC_EEFC_WPMR_ERASEWP_Msk & (_UINT32_(value) << SEFC_EEFC_WPMR_ERASEWP_Pos)) /* Assignment of value for ERASEWP in the SEFC_EEFC_WPMR register */
...
#define SEFC_EEFC_WPMR_USRWP(value)           (SEFC_EEFC_WPMR_USRWP_Msk & (_UINT32_(value) << SEFC_EEFC_WPMR_USRWP_Pos)) /* Assignment of value for USRWP in the SEFC_EEFC_WPMR register */
...
#define SEFC_EEFC_WPMR_ERASEWL(value)         (SEFC_EEFC_WPMR_ERASEWL_Msk & (_UINT32_(value) << SEFC_EEFC_WPMR_ERASEWL_Pos)) /* Assignment of value for ERASEWL in the SEFC_EEFC_WPMR register */
...
#define SEFC_EEFC_WPMR_WPKEY(value)           (SEFC_EEFC_WPMR_WPKEY_Msk & (_UINT32_(value) << SEFC_EEFC_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the SEFC_EEFC_WPMR register */
...
/* SEFC register offsets definitions */
