...
#define RTC_FSTR_SEC(value)                   (RTC_FSTR_SEC_Msk & (_UINT32_(value) << RTC_FSTR_SEC_Pos)) /* Assignment of value for SEC in the RTC_FSTR register */
...
#define RTC_FSTR_MIN(value)                   (RTC_FSTR_MIN_Msk & (_UINT32_(value) << RTC_FSTR_MIN_Pos)) /* Assignment of value for MIN in the RTC_FSTR register */
...
#define RTC_FSTR_HOUR(value)                  (RTC_FSTR_HOUR_Msk & (_UINT32_(value) << RTC_FSTR_HOUR_Pos)) /* Assignment of value for HOUR in the RTC_FSTR register */
...
#define RTC_FSTR_AMPM(value)                  (RTC_FSTR_AMPM_Msk & (_UINT32_(value) << RTC_FSTR_AMPM_Pos)) /* Assignment of value for AMPM in the RTC_FSTR register */
...
#define RTC_FSTR_TEVCNT(value)                (RTC_FSTR_TEVCNT_Msk & (_UINT32_(value) << RTC_FSTR_TEVCNT_Pos)) /* Assignment of value for TEVCNT in the RTC_FSTR register */
...
#define RTC_FSTR_BACKUP(value)                (RTC_FSTR_BACKUP_Msk & (_UINT32_(value) << RTC_FSTR_BACKUP_Pos)) /* Assignment of value for BACKUP in the RTC_FSTR register */
#define RTC_FSTR_Msk                          _UINT32_(0x8F7F7F7F)                                 /* (RTC_FSTR) Register Mask  */

/* UTC mode */
#define RTC_FSTR_UTC_TEVCNT_Pos               _UINT32_(24)                                         /* (RTC_FSTR) Tamper Events Counter (cleared by reading RTC_LSDRx) Position */
#define RTC_FSTR_UTC_TEVCNT_Msk               (_UINT32_(0xF) << RTC_FSTR_UTC_TEVCNT_Pos)           /* (RTC_FSTR) Tamper Events Counter (cleared by reading RTC_LSDRx) Mask */
#define RTC_FSTR_UTC_TEVCNT(value)            (RTC_FSTR_UTC_TEVCNT_Msk & (_UINT32_(value) << RTC_FSTR_UTC_TEVCNT_Pos))
#define RTC_FSTR_UTC_BACKUP_Pos               _UINT32_(31)                                         /* (RTC_FSTR) System Mode of the Tamper (cleared by reading RTC_LSDRx) Position */
#define RTC_FSTR_UTC_BACKUP_Msk               (_UINT32_(0x1) << RTC_FSTR_UTC_BACKUP_Pos)           /* (RTC_FSTR) System Mode of the Tamper (cleared by reading RTC_LSDRx) Mask */
#define RTC_FSTR_UTC_BACKUP(value)            (RTC_FSTR_UTC_BACKUP_Msk & (_UINT32_(value) << RTC_FSTR_UTC_BACKUP_Pos))
#define RTC_FSTR_UTC_Msk                      _UINT32_(0x8F000000)                                 /* (RTC_FSTR_UTC) Register Mask  */
...
#define RTC_FSDR_CENT(value)                  (RTC_FSDR_CENT_Msk & (_UINT32_(value) << RTC_FSDR_CENT_Pos)) /* Assignment of value for CENT in the RTC_FSDR register */
...
#define RTC_FSDR_YEAR(value)                  (RTC_FSDR_YEAR_Msk & (_UINT32_(value) << RTC_FSDR_YEAR_Pos)) /* Assignment of value for YEAR in the RTC_FSDR register */
...
#define RTC_FSDR_MONTH(value)                 (RTC_FSDR_MONTH_Msk & (_UINT32_(value) << RTC_FSDR_MONTH_Pos)) /* Assignment of value for MONTH in the RTC_FSDR register */
...
#define RTC_FSDR_DAY(value)                   (RTC_FSDR_DAY_Msk & (_UINT32_(value) << RTC_FSDR_DAY_Pos)) /* Assignment of value for DAY in the RTC_FSDR register */
...
#define RTC_FSDR_DATE(value)                  (RTC_FSDR_DATE_Msk & (_UINT32_(value) << RTC_FSDR_DATE_Pos)) /* Assignment of value for DATE in the RTC_FSDR register */
#define RTC_FSDR_Msk                          _UINT32_(0x3FFF7F7F)                                 /* (RTC_FSDR) Register Mask  */

/* UTC mode */
#define RTC_FSDR_UTC_TIME_Pos                 _UINT32_(0)                                          /* (RTC_FSDR) Time of the Tamper (cleared by reading RTC_LSDRx) Position */
#define RTC_FSDR_UTC_TIME_Msk                 (_UINT32_(0xFFFFFFFF) << RTC_FSDR_UTC_TIME_Pos)      /* (RTC_FSDR) Time of the Tamper (cleared by reading RTC_LSDRx) Mask */
#define RTC_FSDR_UTC_TIME(value)              (RTC_FSDR_UTC_TIME_Msk & (_UINT32_(value) << RTC_FSDR_UTC_TIME_Pos))
#define RTC_FSDR_UTC_Msk                      _UINT32_(0xFFFFFFFF)                                 /* (RTC_FSDR_UTC) Register Mask  */
...
#define RTC_LSTR_SEC(value)                   (RTC_LSTR_SEC_Msk & (_UINT32_(value) << RTC_LSTR_SEC_Pos)) /* Assignment of value for SEC in the RTC_LSTR register */
...
#define RTC_LSTR_MIN(value)                   (RTC_LSTR_MIN_Msk & (_UINT32_(value) << RTC_LSTR_MIN_Pos)) /* Assignment of value for MIN in the RTC_LSTR register */
...
#define RTC_LSTR_HOUR(value)                  (RTC_LSTR_HOUR_Msk & (_UINT32_(value) << RTC_LSTR_HOUR_Pos)) /* Assignment of value for HOUR in the RTC_LSTR register */
...
#define RTC_LSTR_AMPM(value)                  (RTC_LSTR_AMPM_Msk & (_UINT32_(value) << RTC_LSTR_AMPM_Pos)) /* Assignment of value for AMPM in the RTC_LSTR register */
...
#define RTC_LSTR_BACKUP(value)                (RTC_LSTR_BACKUP_Msk & (_UINT32_(value) << RTC_LSTR_BACKUP_Pos)) /* Assignment of value for BACKUP in the RTC_LSTR register */
#define RTC_LSTR_Msk                          _UINT32_(0x807F7F7F)                                 /* (RTC_LSTR) Register Mask  */

/* UTC mode */
#define RTC_LSTR_UTC_BACKUP_Pos               _UINT32_(31)                                         /* (RTC_LSTR) System Mode of the Tamper (cleared by reading RTC_LSDRx) Position */
#define RTC_LSTR_UTC_BACKUP_Msk               (_UINT32_(0x1) << RTC_LSTR_UTC_BACKUP_Pos)           /* (RTC_LSTR) System Mode of the Tamper (cleared by reading RTC_LSDRx) Mask */
#define RTC_LSTR_UTC_BACKUP(value)            (RTC_LSTR_UTC_BACKUP_Msk & (_UINT32_(value) << RTC_LSTR_UTC_BACKUP_Pos))
#define RTC_LSTR_UTC_Msk                      _UINT32_(0x80000000)                                 /* (RTC_LSTR_UTC) Register Mask  */
...
#define RTC_LSDR_CENT(value)                  (RTC_LSDR_CENT_Msk & (_UINT32_(value) << RTC_LSDR_CENT_Pos)) /* Assignment of value for CENT in the RTC_LSDR register */
...
#define RTC_LSDR_YEAR(value)                  (RTC_LSDR_YEAR_Msk & (_UINT32_(value) << RTC_LSDR_YEAR_Pos)) /* Assignment of value for YEAR in the RTC_LSDR register */
...
#define RTC_LSDR_MONTH(value)                 (RTC_LSDR_MONTH_Msk & (_UINT32_(value) << RTC_LSDR_MONTH_Pos)) /* Assignment of value for MONTH in the RTC_LSDR register */
...
#define RTC_LSDR_DAY(value)                   (RTC_LSDR_DAY_Msk & (_UINT32_(value) << RTC_LSDR_DAY_Pos)) /* Assignment of value for DAY in the RTC_LSDR register */
...
#define RTC_LSDR_DATE(value)                  (RTC_LSDR_DATE_Msk & (_UINT32_(value) << RTC_LSDR_DATE_Pos)) /* Assignment of value for DATE in the RTC_LSDR register */
#define RTC_LSDR_Msk                          _UINT32_(0x3FFF7F7F)                                 /* (RTC_LSDR) Register Mask  */

/* UTC mode */
#define RTC_LSDR_UTC_TIME_Pos                 _UINT32_(0)                                          /* (RTC_LSDR) Time of the Tamper (cleared on read) Position */
#define RTC_LSDR_UTC_TIME_Msk                 (_UINT32_(0xFFFFFFFF) << RTC_LSDR_UTC_TIME_Pos)      /* (RTC_LSDR) Time of the Tamper (cleared on read) Mask */
#define RTC_LSDR_UTC_TIME(value)              (RTC_LSDR_UTC_TIME_Msk & (_UINT32_(value) << RTC_LSDR_UTC_TIME_Pos))
#define RTC_LSDR_UTC_Msk                      _UINT32_(0xFFFFFFFF)                                 /* (RTC_LSDR_UTC) Register Mask  */


/* -------- RTC_CR : (RTC Offset: 0x00) (R/W 32) Control Register -------- */
#define RTC_CR_UPDTIM_Pos                     _UINT32_(0)                                          /* (RTC_CR) Up2025-09-05 Request Time Register Position */
#define RTC_CR_UPDTIM_Msk                     (_UINT32_(0x1) << RTC_CR_UPDTIM_Pos)                 /* (RTC_CR) Up2025-09-05 Request Time Register Mask */
...
#define   RTC_CR_UPDTIM_STOP_UPDATE_Val       _UINT32_(0x0)                                        /* (RTC_CR) No effect or, if UPDTIM has been previously written to 1, stops the up2025-09-05 procedure.  */
...
#define RTC_CR_UPDTIM_STOP_UPDATE             (RTC_CR_UPDTIM_STOP_UPDATE_Val << RTC_CR_UPDTIM_Pos) /* (RTC_CR) No effect or, if UPDTIM has been previously written to 1, stops the up2025-09-05 procedure. Position */
...
#define RTC_CR_UPDCAL_Pos                     _UINT32_(1)                                          /* (RTC_CR) Up2025-09-05 Request Calendar Register Position */
#define RTC_CR_UPDCAL_Msk                     (_UINT32_(0x1) << RTC_CR_UPDCAL_Pos)                 /* (RTC_CR) Up2025-09-05 Request Calendar Register Mask */
...
#define   RTC_CR_UPDCAL_STOP_UPDATE_Val       _UINT32_(0x0)                                        /* (RTC_CR) No effect or, if UPDCAL has been previously written to 1, stops the up2025-09-05 procedure.  */
#define   RTC_CR_UPDCAL_START_UPDATE_Val      _UINT32_(0x1)                                        /* (RTC_CR) Stops the RTC calendar counting.  */
#define RTC_CR_UPDCAL_STOP_UPDATE             (RTC_CR_UPDCAL_STOP_UPDATE_Val << RTC_CR_UPDCAL_Pos) /* (RTC_CR) No effect or, if UPDCAL has been previously written to 1, stops the up2025-09-05 procedure. Position */
...
#define   RTC_CALALR_DATEEN_DISABLED_Val      _UINT32_(0x0)                                        /* (RTC_CALALR) The 2025-09-05-matching alarm is disabled.  */
#define   RTC_CALALR_DATEEN_ENABLED_Val       _UINT32_(0x1)                                        /* (RTC_CALALR) The 2025-09-05-matching alarm is enabled.  */
#define RTC_CALALR_DATEEN_DISABLED            (RTC_CALALR_DATEEN_DISABLED_Val << RTC_CALALR_DATEEN_Pos) /* (RTC_CALALR) The 2025-09-05-matching alarm is disabled. Position */
#define RTC_CALALR_DATEEN_ENABLED             (RTC_CALALR_DATEEN_ENABLED_Val << RTC_CALALR_DATEEN_Pos) /* (RTC_CALALR) The 2025-09-05-matching alarm is enabled. Position */
...
#define RTC_SR_ACKUPD_Pos                     _UINT32_(0)                                          /* (RTC_SR) Acknowledge for Up2025-09-05 Position */
#define RTC_SR_ACKUPD_Msk                     (_UINT32_(0x1) << RTC_SR_ACKUPD_Pos)                 /* (RTC_SR) Acknowledge for Up2025-09-05 Mask */
...
#define   RTC_SR_ACKUPD_FREERUN_Val           _UINT32_(0x0)                                        /* (RTC_SR) Time and calendar registers cannot be up2025-09-05d.  */
#define   RTC_SR_ACKUPD_UPDATE_Val            _UINT32_(0x1)                                        /* (RTC_SR) Time and calendar registers can be up2025-09-05d.  */
#define RTC_SR_ACKUPD_FREERUN                 (RTC_SR_ACKUPD_FREERUN_Val << RTC_SR_ACKUPD_Pos)     /* (RTC_SR) Time and calendar registers cannot be up2025-09-05d. Position */
#define RTC_SR_ACKUPD_UPDATE                  (RTC_SR_ACKUPD_UPDATE_Val << RTC_SR_ACKUPD_Pos)      /* (RTC_SR) Time and calendar registers can be up2025-09-05d. Position */
...
#define   RTC_SR_TDERR_ERR_TIMEDATE_Val       _UINT32_(0x1)                                        /* (RTC_SR) The internal free running counters have been corrupted (invalid 2025-09-05 or time, non-BCD values) since the last read and/or they are still invalid.  */
...
#define RTC_SR_TDERR_ERR_TIMEDATE             (RTC_SR_TDERR_ERR_TIMEDATE_Val << RTC_SR_TDERR_Pos)  /* (RTC_SR) The internal free running counters have been corrupted (invalid 2025-09-05 or time, non-BCD values) since the last read and/or they are still invalid. Position */
...
#define RTC_IER_ACKEN_Pos                     _UINT32_(0)                                          /* (RTC_IER) Acknowledge Up2025-09-05 Interrupt Enable Position */
#define RTC_IER_ACKEN_Msk                     (_UINT32_(0x1) << RTC_IER_ACKEN_Pos)                 /* (RTC_IER) Acknowledge Up2025-09-05 Interrupt Enable Mask */
...
#define RTC_IDR_ACKDIS_Pos                    _UINT32_(0)                                          /* (RTC_IDR) Acknowledge Up2025-09-05 Interrupt Disable Position */
#define RTC_IDR_ACKDIS_Msk                    (_UINT32_(0x1) << RTC_IDR_ACKDIS_Pos)                /* (RTC_IDR) Acknowledge Up2025-09-05 Interrupt Disable Mask */
...
#define RTC_IMR_ACK_Pos                       _UINT32_(0)                                          /* (RTC_IMR) Acknowledge Up2025-09-05 Interrupt Mask Position */
#define RTC_IMR_ACK_Msk                       (_UINT32_(0x1) << RTC_IMR_ACK_Pos)                   /* (RTC_IMR) Acknowledge Up2025-09-05 Interrupt Mask Mask */
...
#define RTC_TCR_TAMPEN0(value)                (RTC_TCR_TAMPEN0_Msk & (_UINT32_(value) << RTC_TCR_TAMPEN0_Pos)) /* Assignment of value for TAMPEN0 in the RTC_TCR register */
...
#define RTC_TCR_TAMPEN1(value)                (RTC_TCR_TAMPEN1_Msk & (_UINT32_(value) << RTC_TCR_TAMPEN1_Pos)) /* Assignment of value for TAMPEN1 in the RTC_TCR register */
...
#define RTC_TCR_TAMPEN2(value)                (RTC_TCR_TAMPEN2_Msk & (_UINT32_(value) << RTC_TCR_TAMPEN2_Pos)) /* Assignment of value for TAMPEN2 in the RTC_TCR register */
...
#define RTC_TCR_TAMPEN3(value)                (RTC_TCR_TAMPEN3_Msk & (_UINT32_(value) << RTC_TCR_TAMPEN3_Pos)) /* Assignment of value for TAMPEN3 in the RTC_TCR register */
...
#define RTC_TCR_TAMPEN4(value)                (RTC_TCR_TAMPEN4_Msk & (_UINT32_(value) << RTC_TCR_TAMPEN4_Pos)) /* Assignment of value for TAMPEN4 in the RTC_TCR register */
...
#define RTC_TCR_TAMPCLR(value)                (RTC_TCR_TAMPCLR_Msk & (_UINT32_(value) << RTC_TCR_TAMPCLR_Pos)) /* Assignment of value for TAMPCLR in the RTC_TCR register */
...
#define RTC_TCR_FGPBRCLR(value)               (RTC_TCR_FGPBRCLR_Msk & (_UINT32_(value) << RTC_TCR_FGPBRCLR_Pos)) /* Assignment of value for FGPBRCLR in the RTC_TCR register */
...
#define RTC_TISR_TISR0(value)                 (RTC_TISR_TISR0_Msk & (_UINT32_(value) << RTC_TISR_TISR0_Pos)) /* Assignment of value for TISR0 in the RTC_TISR register */
...
#define RTC_TISR_TISR1(value)                 (RTC_TISR_TISR1_Msk & (_UINT32_(value) << RTC_TISR_TISR1_Pos)) /* Assignment of value for TISR1 in the RTC_TISR register */
...
#define RTC_TISR_TISR2(value)                 (RTC_TISR_TISR2_Msk & (_UINT32_(value) << RTC_TISR_TISR2_Pos)) /* Assignment of value for TISR2 in the RTC_TISR register */
...
#define RTC_TISR_TISR3(value)                 (RTC_TISR_TISR3_Msk & (_UINT32_(value) << RTC_TISR_TISR3_Pos)) /* Assignment of value for TISR3 in the RTC_TISR register */
...
#define RTC_TISR_TISR4(value)                 (RTC_TISR_TISR4_Msk & (_UINT32_(value) << RTC_TISR_TISR4_Pos)) /* Assignment of value for TISR4 in the RTC_TISR register */
...
/* RTC_SUB0 register API structure */
typedef struct
{
