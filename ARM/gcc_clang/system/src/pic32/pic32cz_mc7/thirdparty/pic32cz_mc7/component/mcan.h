...
#ifndef _PIC32CZMC70_MCAN_COMPONENT_H_
#define _PIC32CZMC70_MCAN_COMPONENT_H_
...
#define   MCAN_TEST_TX_RESET_Val              _UINT32_(0x0)                                        /* (MCAN_TEST) Reset value, CANTX controlled by the CAN Core, up2025-09-05d at the end of the CAN bit time.  */
...
#define MCAN_TEST_TX_RESET                    (MCAN_TEST_TX_RESET_Val << MCAN_TEST_TX_Pos)         /* (MCAN_TEST) Reset value, CANTX controlled by the CAN Core, up2025-09-05d at the end of the CAN bit time. Position */
...
#endif /* _PIC32CZMC70_MCAN_COMPONENT_H_ */
