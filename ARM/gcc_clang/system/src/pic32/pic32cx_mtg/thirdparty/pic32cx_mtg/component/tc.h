...
#define TC_SR_ENDRX(value)                    (TC_SR_ENDRX_Msk & (_UINT32_(value) << TC_SR_ENDRX_Pos)) /* Assignment of value for ENDRX in the TC_SR register */
...
#define TC_SR_RXBUFF(value)                   (TC_SR_RXBUFF_Msk & (_UINT32_(value) << TC_SR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the TC_SR register */
...
#define TC_IER_ENDRX(value)                   (TC_IER_ENDRX_Msk & (_UINT32_(value) << TC_IER_ENDRX_Pos)) /* Assignment of value for ENDRX in the TC_IER register */
...
#define TC_IER_RXBUFF(value)                  (TC_IER_RXBUFF_Msk & (_UINT32_(value) << TC_IER_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the TC_IER register */
...
#define TC_IDR_ENDRX(value)                   (TC_IDR_ENDRX_Msk & (_UINT32_(value) << TC_IDR_ENDRX_Pos)) /* Assignment of value for ENDRX in the TC_IDR register */
...
#define TC_IDR_RXBUFF(value)                  (TC_IDR_RXBUFF_Msk & (_UINT32_(value) << TC_IDR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the TC_IDR register */
...
#define TC_IMR_ENDRX(value)                   (TC_IMR_ENDRX_Msk & (_UINT32_(value) << TC_IMR_ENDRX_Pos)) /* Assignment of value for ENDRX in the TC_IMR register */
...
#define TC_IMR_RXBUFF(value)                  (TC_IMR_RXBUFF_Msk & (_UINT32_(value) << TC_IMR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the TC_IMR register */
...
#define TC_RPR_RXPTR(value)                   (TC_RPR_RXPTR_Msk & (_UINT32_(value) << TC_RPR_RXPTR_Pos)) /* Assignment of value for RXPTR in the TC_RPR register */
...
#define TC_RCR_RXCTR(value)                   (TC_RCR_RXCTR_Msk & (_UINT32_(value) << TC_RCR_RXCTR_Pos)) /* Assignment of value for RXCTR in the TC_RCR register */
...
#define TC_RNPR_RXNPTR(value)                 (TC_RNPR_RXNPTR_Msk & (_UINT32_(value) << TC_RNPR_RXNPTR_Pos)) /* Assignment of value for RXNPTR in the TC_RNPR register */
...
#define TC_RNCR_RXNCTR(value)                 (TC_RNCR_RXNCTR_Msk & (_UINT32_(value) << TC_RNCR_RXNCTR_Pos)) /* Assignment of value for RXNCTR in the TC_RNCR register */
...
#define TC_PTCR_RXTEN(value)                  (TC_PTCR_RXTEN_Msk & (_UINT32_(value) << TC_PTCR_RXTEN_Pos)) /* Assignment of value for RXTEN in the TC_PTCR register */
...
#define TC_PTCR_RXTDIS(value)                 (TC_PTCR_RXTDIS_Msk & (_UINT32_(value) << TC_PTCR_RXTDIS_Pos)) /* Assignment of value for RXTDIS in the TC_PTCR register */
...
#define TC_PTCR_TXTEN(value)                  (TC_PTCR_TXTEN_Msk & (_UINT32_(value) << TC_PTCR_TXTEN_Pos)) /* Assignment of value for TXTEN in the TC_PTCR register */
...
#define TC_PTCR_TXTDIS(value)                 (TC_PTCR_TXTDIS_Msk & (_UINT32_(value) << TC_PTCR_TXTDIS_Pos)) /* Assignment of value for TXTDIS in the TC_PTCR register */
...
#define TC_PTCR_RXCBEN(value)                 (TC_PTCR_RXCBEN_Msk & (_UINT32_(value) << TC_PTCR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the TC_PTCR register */
...
#define TC_PTCR_RXCBDIS(value)                (TC_PTCR_RXCBDIS_Msk & (_UINT32_(value) << TC_PTCR_RXCBDIS_Pos)) /* Assignment of value for RXCBDIS in the TC_PTCR register */
...
#define TC_PTCR_TXCBEN(value)                 (TC_PTCR_TXCBEN_Msk & (_UINT32_(value) << TC_PTCR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the TC_PTCR register */
...
#define TC_PTCR_TXCBDIS(value)                (TC_PTCR_TXCBDIS_Msk & (_UINT32_(value) << TC_PTCR_TXCBDIS_Pos)) /* Assignment of value for TXCBDIS in the TC_PTCR register */
...
#define TC_PTCR_ERRCLR(value)                 (TC_PTCR_ERRCLR_Msk & (_UINT32_(value) << TC_PTCR_ERRCLR_Pos)) /* Assignment of value for ERRCLR in the TC_PTCR register */
...
#define TC_PTSR_RXTEN(value)                  (TC_PTSR_RXTEN_Msk & (_UINT32_(value) << TC_PTSR_RXTEN_Pos)) /* Assignment of value for RXTEN in the TC_PTSR register */
...
#define TC_PTSR_TXTEN(value)                  (TC_PTSR_TXTEN_Msk & (_UINT32_(value) << TC_PTSR_TXTEN_Pos)) /* Assignment of value for TXTEN in the TC_PTSR register */
...
#define TC_PTSR_RXCBEN(value)                 (TC_PTSR_RXCBEN_Msk & (_UINT32_(value) << TC_PTSR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the TC_PTSR register */
...
#define TC_PTSR_TXCBEN(value)                 (TC_PTSR_TXCBEN_Msk & (_UINT32_(value) << TC_PTSR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the TC_PTSR register */
...
#define TC_PTSR_ERR(value)                    (TC_PTSR_ERR_Msk & (_UINT32_(value) << TC_PTSR_ERR_Pos)) /* Assignment of value for ERR in the TC_PTSR register */
...
#define TC_PWPMR_WPPTREN(value)               (TC_PWPMR_WPPTREN_Msk & (_UINT32_(value) << TC_PWPMR_WPPTREN_Pos)) /* Assignment of value for WPPTREN in the TC_PWPMR register */
...
#define TC_PWPMR_WPCTREN(value)               (TC_PWPMR_WPCTREN_Msk & (_UINT32_(value) << TC_PWPMR_WPCTREN_Pos)) /* Assignment of value for WPCTREN in the TC_PWPMR register */
...
#define TC_PWPMR_WPCREN(value)                (TC_PWPMR_WPCREN_Msk & (_UINT32_(value) << TC_PWPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the TC_PWPMR register */
...
#define TC_PWPMR_WPKEY(value)                 (TC_PWPMR_WPKEY_Msk & (_UINT32_(value) << TC_PWPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the TC_PWPMR register */
