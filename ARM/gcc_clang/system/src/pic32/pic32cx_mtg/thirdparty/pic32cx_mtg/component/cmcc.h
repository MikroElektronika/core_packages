...
#define CMCC_TYPE_AP(value)                   (CMCC_TYPE_AP_Msk & (_UINT32_(value) << CMCC_TYPE_AP_Pos)) /* Assignment of value for AP in the CMCC_TYPE register */
...
#define CMCC_TYPE_RANDP(value)                (CMCC_TYPE_RANDP_Msk & (_UINT32_(value) << CMCC_TYPE_RANDP_Pos)) /* Assignment of value for RANDP in the CMCC_TYPE register */
...
#define CMCC_TYPE_LRUP(value)                 (CMCC_TYPE_LRUP_Msk & (_UINT32_(value) << CMCC_TYPE_LRUP_Pos)) /* Assignment of value for LRUP in the CMCC_TYPE register */
...
#define CMCC_CFG_GCLKDIS(value)               (CMCC_CFG_GCLKDIS_Msk & (_UINT32_(value) << CMCC_CFG_GCLKDIS_Pos)) /* Assignment of value for GCLKDIS in the CMCC_CFG register */
...
#define CMCC_CFG_PRGCSIZE(value)              (CMCC_CFG_PRGCSIZE_Msk & (_UINT32_(value) << CMCC_CFG_PRGCSIZE_Pos)) /* Assignment of value for PRGCSIZE in the CMCC_CFG register */
...
#define CMCC_CFG_LOCK(value)                  (CMCC_CFG_LOCK_Msk & (_UINT32_(value) << CMCC_CFG_LOCK_Pos)) /* Assignment of value for LOCK in the CMCC_CFG register */
...
#define CMCC_CTRL_LOCK(value)                 (CMCC_CTRL_LOCK_Msk & (_UINT32_(value) << CMCC_CTRL_LOCK_Pos)) /* Assignment of value for LOCK in the CMCC_CTRL register */
...
#define CMCC_MAINT1_INDEX_Msk                 (_UINT32_(0x7F) << CMCC_MAINT1_INDEX_Pos)            /* (CMCC_MAINT1) Invali2025-09-05 Index Mask */
...
#define CMCC_MAINT1_WAY_Pos                   _UINT32_(30)                                         /* (CMCC_MAINT1) Invali2025-09-05 Way Position */
#define CMCC_MAINT1_WAY_Msk                   (_UINT32_(0x3) << CMCC_MAINT1_WAY_Pos)               /* (CMCC_MAINT1) Invali2025-09-05 Way Mask */
...
#define CMCC_WPMR_WPCFG(value)                (CMCC_WPMR_WPCFG_Msk & (_UINT32_(value) << CMCC_WPMR_WPCFG_Pos)) /* Assignment of value for WPCFG in the CMCC_WPMR register */
...
#define CMCC_WPMR_WPCR(value)                 (CMCC_WPMR_WPCR_Msk & (_UINT32_(value) << CMCC_WPMR_WPCR_Pos)) /* Assignment of value for WPCR in the CMCC_WPMR register */
...
#define CMCC_WPMR_WPKEY(value)                (CMCC_WPMR_WPKEY_Msk & (_UINT32_(value) << CMCC_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the CMCC_WPMR register */
