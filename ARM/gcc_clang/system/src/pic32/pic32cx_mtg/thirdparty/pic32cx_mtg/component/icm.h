...
#define ICM_CFG_HAPROT(value)                 (ICM_CFG_HAPROT_Msk & (_UINT32_(value) << ICM_CFG_HAPROT_Pos)) /* Assignment of value for HAPROT in the ICM_CFG register */
...
#define ICM_CFG_DAPROT(value)                 (ICM_CFG_DAPROT_Msk & (_UINT32_(value) << ICM_CFG_DAPROT_Pos)) /* Assignment of value for DAPROT in the ICM_CFG register */
...
#define ICM_IER_RSU_Pos                       _UINT32_(20)                                         /* (ICM_IER) Region Status Up2025-09-05d Interrupt Disable Position */
#define ICM_IER_RSU_Msk                       (_UINT32_(0xF) << ICM_IER_RSU_Pos)                   /* (ICM_IER) Region Status Up2025-09-05d Interrupt Disable Mask */
...
#define ICM_IDR_RSU_Pos                       _UINT32_(20)                                         /* (ICM_IDR) Region Status Up2025-09-05d Interrupt Disable Position */
#define ICM_IDR_RSU_Msk                       (_UINT32_(0xF) << ICM_IDR_RSU_Pos)                   /* (ICM_IDR) Region Status Up2025-09-05d Interrupt Disable Mask */
...
#define ICM_IMR_RSU_Pos                       _UINT32_(20)                                         /* (ICM_IMR) Region Status Up2025-09-05d Interrupt Mask Position */
#define ICM_IMR_RSU_Msk                       (_UINT32_(0xF) << ICM_IMR_RSU_Pos)                   /* (ICM_IMR) Region Status Up2025-09-05d Interrupt Mask Mask */
...
#define ICM_ISR_RSU_Pos                       _UINT32_(20)                                         /* (ICM_ISR) Region Status Up2025-09-05d Detected Position */
#define ICM_ISR_RSU_Msk                       (_UINT32_(0xF) << ICM_ISR_RSU_Pos)                   /* (ICM_ISR) Region Status Up2025-09-05d Detected Mask */
