...
#define   PWM_SCM_UPDM_MODE2_Val              _UINT32_(0x2)                                        /* (PWM_SCM) Automatic write of duty-cycle up2025-09-05 registers by the Peripheral DMA Controller and automatic up2025-09-05 of synchronous channels  */
...
#define PWM_SCM_UPDM_MODE2                    (PWM_SCM_UPDM_MODE2_Val << PWM_SCM_UPDM_Pos)         /* (PWM_SCM) Automatic write of duty-cycle up2025-09-05 registers by the Peripheral DMA Controller and automatic up2025-09-05 of synchronous channels Position */
