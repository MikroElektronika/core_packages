...
#define UART_CR_OPT_SLEEP(value)              (UART_CR_OPT_SLEEP_Msk & (_UINT32_(value) << UART_CR_OPT_SLEEP_Pos)) /* Assignment of value for OPT_SLEEP in the UART_CR register */
...
#define UART_MR_OPT_EN(value)                 (UART_MR_OPT_EN_Msk & (_UINT32_(value) << UART_MR_OPT_EN_Pos)) /* Assignment of value for OPT_EN in the UART_MR register */
...
#define UART_MR_OPT_RXINV(value)              (UART_MR_OPT_RXINV_Msk & (_UINT32_(value) << UART_MR_OPT_RXINV_Pos)) /* Assignment of value for OPT_RXINV in the UART_MR register */
...
#define UART_MR_OPT_MDINV(value)              (UART_MR_OPT_MDINV_Msk & (_UINT32_(value) << UART_MR_OPT_MDINV_Pos)) /* Assignment of value for OPT_MDINV in the UART_MR register */
...
#define UART_MR_OPT_DMOD(value)               (UART_MR_OPT_DMOD_Msk & (_UINT32_(value) << UART_MR_OPT_DMOD_Pos)) /* Assignment of value for OPT_DMOD in the UART_MR register */
...
#define UART_MR_ACON(value)                   (UART_MR_ACON_Msk & (_UINT32_(value) << UART_MR_ACON_Pos)) /* Assignment of value for ACON in the UART_MR register */
...
#define UART_MR_EDGESEL(value)                (UART_MR_EDGESEL_Msk & (_UINT32_(value) << UART_MR_EDGESEL_Pos)) /* Assignment of value for EDGESEL in the UART_MR register */
...
#define UART_MR_OPT_WKUP(value)               (UART_MR_OPT_WKUP_Msk & (_UINT32_(value) << UART_MR_OPT_WKUP_Pos)) /* Assignment of value for OPT_WKUP in the UART_MR register */
...
#define UART_MR_OPT_CLKDIV(value)             (UART_MR_OPT_CLKDIV_Msk & (_UINT32_(value) << UART_MR_OPT_CLKDIV_Pos)) /* Assignment of value for OPT_CLKDIV in the UART_MR register */
...
#define UART_MR_OPT_DUTY(value)               (UART_MR_OPT_DUTY_Msk & (_UINT32_(value) << UART_MR_OPT_DUTY_Pos)) /* Assignment of value for OPT_DUTY in the UART_MR register */
...
#define UART_MR_OPT_CMPTH(value)              (UART_MR_OPT_CMPTH_Msk & (_UINT32_(value) << UART_MR_OPT_CMPTH_Pos)) /* Assignment of value for OPT_CMPTH in the UART_MR register */
...
#define UART_IER_ENDRX(value)                 (UART_IER_ENDRX_Msk & (_UINT32_(value) << UART_IER_ENDRX_Pos)) /* Assignment of value for ENDRX in the UART_IER register */
...
#define UART_IER_ENDTX(value)                 (UART_IER_ENDTX_Msk & (_UINT32_(value) << UART_IER_ENDTX_Pos)) /* Assignment of value for ENDTX in the UART_IER register */
...
#define UART_IER_TXBUFE(value)                (UART_IER_TXBUFE_Msk & (_UINT32_(value) << UART_IER_TXBUFE_Pos)) /* Assignment of value for TXBUFE in the UART_IER register */
...
#define UART_IER_RXBUFF(value)                (UART_IER_RXBUFF_Msk & (_UINT32_(value) << UART_IER_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the UART_IER register */
...
#define UART_IER_ACE(value)                   (UART_IER_ACE_Msk & (_UINT32_(value) << UART_IER_ACE_Pos)) /* Assignment of value for ACE in the UART_IER register */
...
#define UART_IDR_ENDRX(value)                 (UART_IDR_ENDRX_Msk & (_UINT32_(value) << UART_IDR_ENDRX_Pos)) /* Assignment of value for ENDRX in the UART_IDR register */
...
#define UART_IDR_ENDTX(value)                 (UART_IDR_ENDTX_Msk & (_UINT32_(value) << UART_IDR_ENDTX_Pos)) /* Assignment of value for ENDTX in the UART_IDR register */
...
#define UART_IDR_TXBUFE(value)                (UART_IDR_TXBUFE_Msk & (_UINT32_(value) << UART_IDR_TXBUFE_Pos)) /* Assignment of value for TXBUFE in the UART_IDR register */
...
#define UART_IDR_RXBUFF(value)                (UART_IDR_RXBUFF_Msk & (_UINT32_(value) << UART_IDR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the UART_IDR register */
...
#define UART_IDR_ACE(value)                   (UART_IDR_ACE_Msk & (_UINT32_(value) << UART_IDR_ACE_Pos)) /* Assignment of value for ACE in the UART_IDR register */
...
#define UART_IMR_ENDRX(value)                 (UART_IMR_ENDRX_Msk & (_UINT32_(value) << UART_IMR_ENDRX_Pos)) /* Assignment of value for ENDRX in the UART_IMR register */
...
#define UART_IMR_ENDTX(value)                 (UART_IMR_ENDTX_Msk & (_UINT32_(value) << UART_IMR_ENDTX_Pos)) /* Assignment of value for ENDTX in the UART_IMR register */
...
#define UART_IMR_TXBUFE(value)                (UART_IMR_TXBUFE_Msk & (_UINT32_(value) << UART_IMR_TXBUFE_Pos)) /* Assignment of value for TXBUFE in the UART_IMR register */
...
#define UART_IMR_RXBUFF(value)                (UART_IMR_RXBUFF_Msk & (_UINT32_(value) << UART_IMR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the UART_IMR register */
...
#define UART_IMR_ACE(value)                   (UART_IMR_ACE_Msk & (_UINT32_(value) << UART_IMR_ACE_Pos)) /* Assignment of value for ACE in the UART_IMR register */
...
#define UART_SR_ENDRX(value)                  (UART_SR_ENDRX_Msk & (_UINT32_(value) << UART_SR_ENDRX_Pos)) /* Assignment of value for ENDRX in the UART_SR register */
...
#define UART_SR_ENDTX(value)                  (UART_SR_ENDTX_Msk & (_UINT32_(value) << UART_SR_ENDTX_Pos)) /* Assignment of value for ENDTX in the UART_SR register */
...
#define UART_SR_TXBUFE(value)                 (UART_SR_TXBUFE_Msk & (_UINT32_(value) << UART_SR_TXBUFE_Pos)) /* Assignment of value for TXBUFE in the UART_SR register */
...
#define UART_SR_RXBUFF(value)                 (UART_SR_RXBUFF_Msk & (_UINT32_(value) << UART_SR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the UART_SR register */
...
#define UART_SR_ACE(value)                    (UART_SR_ACE_Msk & (_UINT32_(value) << UART_SR_ACE_Pos)) /* Assignment of value for ACE in the UART_SR register */
...
#define UART_CSR_ACO(value)                   (UART_CSR_ACO_Msk & (_UINT32_(value) << UART_CSR_ACO_Pos)) /* Assignment of value for ACO in the UART_CSR register */
...
#define UART_RPR_RXPTR(value)                 (UART_RPR_RXPTR_Msk & (_UINT32_(value) << UART_RPR_RXPTR_Pos)) /* Assignment of value for RXPTR in the UART_RPR register */
...
#define UART_RCR_RXCTR(value)                 (UART_RCR_RXCTR_Msk & (_UINT32_(value) << UART_RCR_RXCTR_Pos)) /* Assignment of value for RXCTR in the UART_RCR register */
...
#define UART_TPR_TXPTR(value)                 (UART_TPR_TXPTR_Msk & (_UINT32_(value) << UART_TPR_TXPTR_Pos)) /* Assignment of value for TXPTR in the UART_TPR register */
...
#define UART_TCR_TXCTR(value)                 (UART_TCR_TXCTR_Msk & (_UINT32_(value) << UART_TCR_TXCTR_Pos)) /* Assignment of value for TXCTR in the UART_TCR register */
...
#define UART_RNPR_RXNPTR(value)               (UART_RNPR_RXNPTR_Msk & (_UINT32_(value) << UART_RNPR_RXNPTR_Pos)) /* Assignment of value for RXNPTR in the UART_RNPR register */
...
#define UART_RNCR_RXNCTR(value)               (UART_RNCR_RXNCTR_Msk & (_UINT32_(value) << UART_RNCR_RXNCTR_Pos)) /* Assignment of value for RXNCTR in the UART_RNCR register */
...
#define UART_TNPR_TXNPTR(value)               (UART_TNPR_TXNPTR_Msk & (_UINT32_(value) << UART_TNPR_TXNPTR_Pos)) /* Assignment of value for TXNPTR in the UART_TNPR register */
...
#define UART_TNCR_TXNCTR(value)               (UART_TNCR_TXNCTR_Msk & (_UINT32_(value) << UART_TNCR_TXNCTR_Pos)) /* Assignment of value for TXNCTR in the UART_TNCR register */
...
#define UART_PTCR_RXTEN(value)                (UART_PTCR_RXTEN_Msk & (_UINT32_(value) << UART_PTCR_RXTEN_Pos)) /* Assignment of value for RXTEN in the UART_PTCR register */
...
#define UART_PTCR_RXTDIS(value)               (UART_PTCR_RXTDIS_Msk & (_UINT32_(value) << UART_PTCR_RXTDIS_Pos)) /* Assignment of value for RXTDIS in the UART_PTCR register */
...
#define UART_PTCR_TXTEN(value)                (UART_PTCR_TXTEN_Msk & (_UINT32_(value) << UART_PTCR_TXTEN_Pos)) /* Assignment of value for TXTEN in the UART_PTCR register */
...
#define UART_PTCR_TXTDIS(value)               (UART_PTCR_TXTDIS_Msk & (_UINT32_(value) << UART_PTCR_TXTDIS_Pos)) /* Assignment of value for TXTDIS in the UART_PTCR register */
...
#define UART_PTCR_RXCBEN(value)               (UART_PTCR_RXCBEN_Msk & (_UINT32_(value) << UART_PTCR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the UART_PTCR register */
...
#define UART_PTCR_RXCBDIS(value)              (UART_PTCR_RXCBDIS_Msk & (_UINT32_(value) << UART_PTCR_RXCBDIS_Pos)) /* Assignment of value for RXCBDIS in the UART_PTCR register */
...
#define UART_PTCR_TXCBEN(value)               (UART_PTCR_TXCBEN_Msk & (_UINT32_(value) << UART_PTCR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the UART_PTCR register */
...
#define UART_PTCR_TXCBDIS(value)              (UART_PTCR_TXCBDIS_Msk & (_UINT32_(value) << UART_PTCR_TXCBDIS_Pos)) /* Assignment of value for TXCBDIS in the UART_PTCR register */
...
#define UART_PTCR_ERRCLR(value)               (UART_PTCR_ERRCLR_Msk & (_UINT32_(value) << UART_PTCR_ERRCLR_Pos)) /* Assignment of value for ERRCLR in the UART_PTCR register */
...
#define UART_PTSR_RXTEN(value)                (UART_PTSR_RXTEN_Msk & (_UINT32_(value) << UART_PTSR_RXTEN_Pos)) /* Assignment of value for RXTEN in the UART_PTSR register */
...
#define UART_PTSR_TXTEN(value)                (UART_PTSR_TXTEN_Msk & (_UINT32_(value) << UART_PTSR_TXTEN_Pos)) /* Assignment of value for TXTEN in the UART_PTSR register */
...
#define UART_PTSR_RXCBEN(value)               (UART_PTSR_RXCBEN_Msk & (_UINT32_(value) << UART_PTSR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the UART_PTSR register */
...
#define UART_PTSR_TXCBEN(value)               (UART_PTSR_TXCBEN_Msk & (_UINT32_(value) << UART_PTSR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the UART_PTSR register */
...
#define UART_PTSR_ERR(value)                  (UART_PTSR_ERR_Msk & (_UINT32_(value) << UART_PTSR_ERR_Pos)) /* Assignment of value for ERR in the UART_PTSR register */
...
#define UART_PWPMR_WPPTREN(value)             (UART_PWPMR_WPPTREN_Msk & (_UINT32_(value) << UART_PWPMR_WPPTREN_Pos)) /* Assignment of value for WPPTREN in the UART_PWPMR register */
...
#define UART_PWPMR_WPCTREN(value)             (UART_PWPMR_WPCTREN_Msk & (_UINT32_(value) << UART_PWPMR_WPCTREN_Pos)) /* Assignment of value for WPCTREN in the UART_PWPMR register */
...
#define UART_PWPMR_WPCREN(value)              (UART_PWPMR_WPCREN_Msk & (_UINT32_(value) << UART_PWPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the UART_PWPMR register */
...
#define UART_PWPMR_WPKEY(value)               (UART_PWPMR_WPKEY_Msk & (_UINT32_(value) << UART_PWPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the UART_PWPMR register */
