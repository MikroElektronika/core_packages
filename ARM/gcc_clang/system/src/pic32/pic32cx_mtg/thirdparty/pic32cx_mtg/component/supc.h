...
#define SUPC_CR_SHDW(value)                   (SUPC_CR_SHDW_Msk & (_UINT32_(value) << SUPC_CR_SHDW_Pos)) /* Assignment of value for SHDW in the SUPC_CR register */
...
#define SUPC_CR_SHDWEOF(value)                (SUPC_CR_SHDWEOF_Msk & (_UINT32_(value) << SUPC_CR_SHDWEOF_Pos)) /* Assignment of value for SHDWEOF in the SUPC_CR register */
...
#define SUPC_CR_TDXTALSEL(value)              (SUPC_CR_TDXTALSEL_Msk & (_UINT32_(value) << SUPC_CR_TDXTALSEL_Pos)) /* Assignment of value for TDXTALSEL in the SUPC_CR register */
...
#define SUPC_SMMR_VDD3V3SMTH(value)           (SUPC_SMMR_VDD3V3SMTH_Msk & (_UINT32_(value) << SUPC_SMMR_VDD3V3SMTH_Pos)) /* Assignment of value for VDD3V3SMTH in the SUPC_SMMR register */
...
#define SUPC_SMMR_VDD3V3SMSMPL(value)         (SUPC_SMMR_VDD3V3SMSMPL_Msk & (_UINT32_(value) << SUPC_SMMR_VDD3V3SMSMPL_Pos)) /* Assignment of value for VDD3V3SMSMPL in the SUPC_SMMR register */
...
#define SUPC_SMMR_VDD3V3SMRSTEN(value)        (SUPC_SMMR_VDD3V3SMRSTEN_Msk & (_UINT32_(value) << SUPC_SMMR_VDD3V3SMRSTEN_Pos)) /* Assignment of value for VDD3V3SMRSTEN in the SUPC_SMMR register */
...
#define SUPC_SMMR_VDD3V3SMPWRM(value)         (SUPC_SMMR_VDD3V3SMPWRM_Msk & (_UINT32_(value) << SUPC_SMMR_VDD3V3SMPWRM_Pos)) /* Assignment of value for VDD3V3SMPWRM in the SUPC_SMMR register */
...
#define SUPC_MR_LCDOUT(value)                 (SUPC_MR_LCDOUT_Msk & (_UINT32_(value) << SUPC_MR_LCDOUT_Pos)) /* Assignment of value for LCDOUT in the SUPC_MR register */
...
#define SUPC_MR_LCDMODE(value)                (SUPC_MR_LCDMODE_Msk & (_UINT32_(value) << SUPC_MR_LCDMODE_Pos)) /* Assignment of value for LCDMODE in the SUPC_MR register */
...
#define SUPC_MR_CORSMM(value)                 (SUPC_MR_CORSMM_Msk & (_UINT32_(value) << SUPC_MR_CORSMM_Pos)) /* Assignment of value for CORSMM in the SUPC_MR register */
...
#define   SUPC_MR_CORSMM_VALID_VDD_Val        _UINT32_(0x1)                                        /* (SUPC_MR) VDDCORE supply monitor output value is checked to vali2025-09-05 the VDDCORE domain power-on.  */
...
#define SUPC_MR_CORSMM_VALID_VDD              (SUPC_MR_CORSMM_VALID_VDD_Val << SUPC_MR_CORSMM_Pos) /* (SUPC_MR) VDDCORE supply monitor output value is checked to vali2025-09-05 the VDDCORE domain power-on. Position */
...
#define SUPC_MR_VREGDIS(value)                (SUPC_MR_VREGDIS_Msk & (_UINT32_(value) << SUPC_MR_VREGDIS_Pos)) /* Assignment of value for VREGDIS in the SUPC_MR register */
...
#define SUPC_MR_CORSMRSTEN(value)             (SUPC_MR_CORSMRSTEN_Msk & (_UINT32_(value) << SUPC_MR_CORSMRSTEN_Pos)) /* Assignment of value for CORSMRSTEN in the SUPC_MR register */
...
#define SUPC_MR_CORSMDIS(value)               (SUPC_MR_CORSMDIS_Msk & (_UINT32_(value) << SUPC_MR_CORSMDIS_Pos)) /* Assignment of value for CORSMDIS in the SUPC_MR register */
...
#define SUPC_MR_IO_BACKUP_ISO(value)          (SUPC_MR_IO_BACKUP_ISO_Msk & (_UINT32_(value) << SUPC_MR_IO_BACKUP_ISO_Pos)) /* Assignment of value for IO_BACKUP_ISO in the SUPC_MR register */
...
#define SUPC_WUMR_LPDBCEN2(value)             (SUPC_WUMR_LPDBCEN2_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBCEN2_Pos)) /* Assignment of value for LPDBCEN2 in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBCEN3(value)             (SUPC_WUMR_LPDBCEN3_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBCEN3_Pos)) /* Assignment of value for LPDBCEN3 in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBCEN4(value)             (SUPC_WUMR_LPDBCEN4_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBCEN4_Pos)) /* Assignment of value for LPDBCEN4 in the SUPC_WUMR register */
...
#define SUPC_WUMR_FWUPDBC(value)              (SUPC_WUMR_FWUPDBC_Msk & (_UINT32_(value) << SUPC_WUMR_FWUPDBC_Pos)) /* Assignment of value for FWUPDBC in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBC0(value)               (SUPC_WUMR_LPDBC0_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBC0_Pos)) /* Assignment of value for LPDBC0 in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBC1(value)               (SUPC_WUMR_LPDBC1_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBC1_Pos)) /* Assignment of value for LPDBC1 in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBC2(value)               (SUPC_WUMR_LPDBC2_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBC2_Pos)) /* Assignment of value for LPDBC2 in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBC3(value)               (SUPC_WUMR_LPDBC3_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBC3_Pos)) /* Assignment of value for LPDBC3 in the SUPC_WUMR register */
...
#define SUPC_WUMR_LPDBC4(value)               (SUPC_WUMR_LPDBC4_Msk & (_UINT32_(value) << SUPC_WUMR_LPDBC4_Pos)) /* Assignment of value for LPDBC4 in the SUPC_WUMR register */
...
#define SUPC_WUIR_WKUPEN14(value)             (SUPC_WUIR_WKUPEN14_Msk & (_UINT32_(value) << SUPC_WUIR_WKUPEN14_Pos)) /* Assignment of value for WKUPEN14 in the SUPC_WUIR register */
...
#define SUPC_WUIR_WKUPT14(value)              (SUPC_WUIR_WKUPT14_Msk & (_UINT32_(value) << SUPC_WUIR_WKUPT14_Pos)) /* Assignment of value for WKUPT14 in the SUPC_WUIR register */
...
#define SUPC_SR_TDOSCSEL(value)               (SUPC_SR_TDOSCSEL_Msk & (_UINT32_(value) << SUPC_SR_TDOSCSEL_Pos)) /* Assignment of value for TDOSCSEL in the SUPC_SR register */
...
#define SUPC_SR_VDD3V3SMWS(value)             (SUPC_SR_VDD3V3SMWS_Msk & (_UINT32_(value) << SUPC_SR_VDD3V3SMWS_Pos)) /* Assignment of value for VDD3V3SMWS in the SUPC_SR register */
...
#define SUPC_SR_CORSMRSTS(value)              (SUPC_SR_CORSMRSTS_Msk & (_UINT32_(value) << SUPC_SR_CORSMRSTS_Pos)) /* Assignment of value for CORSMRSTS in the SUPC_SR register */
...
#define SUPC_SR_VDD3V3SMRSTS(value)           (SUPC_SR_VDD3V3SMRSTS_Msk & (_UINT32_(value) << SUPC_SR_VDD3V3SMRSTS_Pos)) /* Assignment of value for VDD3V3SMRSTS in the SUPC_SR register */
...
#define SUPC_SR_VDD3V3SMIS(value)             (SUPC_SR_VDD3V3SMIS_Msk & (_UINT32_(value) << SUPC_SR_VDD3V3SMIS_Pos)) /* Assignment of value for VDD3V3SMIS in the SUPC_SR register */
...
#define SUPC_SR_VDD3V3SMS(value)              (SUPC_SR_VDD3V3SMS_Msk & (_UINT32_(value) << SUPC_SR_VDD3V3SMS_Pos)) /* Assignment of value for VDD3V3SMS in the SUPC_SR register */
...
#define SUPC_SR_LCDS(value)                   (SUPC_SR_LCDS_Msk & (_UINT32_(value) << SUPC_SR_LCDS_Pos)) /* Assignment of value for LCDS in the SUPC_SR register */
...
#define SUPC_SR_FWUPS(value)                  (SUPC_SR_FWUPS_Msk & (_UINT32_(value) << SUPC_SR_FWUPS_Pos)) /* Assignment of value for FWUPS in the SUPC_SR register */
...
#define SUPC_SR_LPDBCS2(value)                (SUPC_SR_LPDBCS2_Msk & (_UINT32_(value) << SUPC_SR_LPDBCS2_Pos)) /* Assignment of value for LPDBCS2 in the SUPC_SR register */
...
#define SUPC_SR_LPDBCS3(value)                (SUPC_SR_LPDBCS3_Msk & (_UINT32_(value) << SUPC_SR_LPDBCS3_Pos)) /* Assignment of value for LPDBCS3 in the SUPC_SR register */
...
#define SUPC_SR_LPDBCS4(value)                (SUPC_SR_LPDBCS4_Msk & (_UINT32_(value) << SUPC_SR_LPDBCS4_Pos)) /* Assignment of value for LPDBCS4 in the SUPC_SR register */
...
#define SUPC_SR_SXFMS(value)                  (SUPC_SR_SXFMS_Msk & (_UINT32_(value) << SUPC_SR_SXFMS_Pos)) /* Assignment of value for SXFMS in the SUPC_SR register */
...
#define SUPC_SR_SXFME(value)                  (SUPC_SR_SXFME_Msk & (_UINT32_(value) << SUPC_SR_SXFME_Pos)) /* Assignment of value for SXFME in the SUPC_SR register */
...
#define SUPC_SR_BADXTS(value)                 (SUPC_SR_BADXTS_Msk & (_UINT32_(value) << SUPC_SR_BADXTS_Pos)) /* Assignment of value for BADXTS in the SUPC_SR register */
...
#define SUPC_SR_FWKUPS(value)                 (SUPC_SR_FWKUPS_Msk & (_UINT32_(value) << SUPC_SR_FWKUPS_Pos)) /* Assignment of value for FWKUPS in the SUPC_SR register */
...
#define SUPC_SR_RTTS(value)                   (SUPC_SR_RTTS_Msk & (_UINT32_(value) << SUPC_SR_RTTS_Pos)) /* Assignment of value for RTTS in the SUPC_SR register */
...
#define SUPC_SR_RTCS(value)                   (SUPC_SR_RTCS_Msk & (_UINT32_(value) << SUPC_SR_RTCS_Pos)) /* Assignment of value for RTCS in the SUPC_SR register */
...
#define SUPC_EMR_FLRSGPBR(value)              (SUPC_EMR_FLRSGPBR_Msk & (_UINT32_(value) << SUPC_EMR_FLRSGPBR_Pos)) /* Assignment of value for FLRSGPBR in the SUPC_EMR register */
...
#define SUPC_EMR_FULLGPBRC(value)             (SUPC_EMR_FULLGPBRC_Msk & (_UINT32_(value) << SUPC_EMR_FULLGPBRC_Pos)) /* Assignment of value for FULLGPBRC in the SUPC_EMR register */
...
#define SUPC_EMR_COREBGEN(value)              (SUPC_EMR_COREBGEN_Msk & (_UINT32_(value) << SUPC_EMR_COREBGEN_Pos)) /* Assignment of value for COREBGEN in the SUPC_EMR register */
...
#define SUPC_BMR_RTTWKEN(value)               (SUPC_BMR_RTTWKEN_Msk & (_UINT32_(value) << SUPC_BMR_RTTWKEN_Pos)) /* Assignment of value for RTTWKEN in the SUPC_BMR register */
...
#define SUPC_BMR_RTCWKEN(value)               (SUPC_BMR_RTCWKEN_Msk & (_UINT32_(value) << SUPC_BMR_RTCWKEN_Pos)) /* Assignment of value for RTCWKEN in the SUPC_BMR register */
...
#define SUPC_BMR_VBATWKEN(value)              (SUPC_BMR_VBATWKEN_Msk & (_UINT32_(value) << SUPC_BMR_VBATWKEN_Pos)) /* Assignment of value for VBATWKEN in the SUPC_BMR register */
...
#define SUPC_BMR_FWUPEN(value)                (SUPC_BMR_FWUPEN_Msk & (_UINT32_(value) << SUPC_BMR_FWUPEN_Pos)) /* Assignment of value for FWUPEN in the SUPC_BMR register */
...
#define SUPC_BMR_CORPORWKEN(value)            (SUPC_BMR_CORPORWKEN_Msk & (_UINT32_(value) << SUPC_BMR_CORPORWKEN_Pos)) /* Assignment of value for CORPORWKEN in the SUPC_BMR register */
...
#define SUPC_BMR_VDD3V3SMWKEN(value)          (SUPC_BMR_VDD3V3SMWKEN_Msk & (_UINT32_(value) << SUPC_BMR_VDD3V3SMWKEN_Pos)) /* Assignment of value for VDD3V3SMWKEN in the SUPC_BMR register */
...
#define SUPC_BMR_VBATREN(value)               (SUPC_BMR_VBATREN_Msk & (_UINT32_(value) << SUPC_BMR_VBATREN_Pos)) /* Assignment of value for VBATREN in the SUPC_BMR register */
...
#define SUPC_BMR_MRTCOUT(value)               (SUPC_BMR_MRTCOUT_Msk & (_UINT32_(value) << SUPC_BMR_MRTCOUT_Pos)) /* Assignment of value for MRTCOUT in the SUPC_BMR register */
...
#define SUPC_BMR_BADXTWKEN(value)             (SUPC_BMR_BADXTWKEN_Msk & (_UINT32_(value) << SUPC_BMR_BADXTWKEN_Pos)) /* Assignment of value for BADXTWKEN in the SUPC_BMR register */
...
#define SUPC_BMR_KEY(value)                   (SUPC_BMR_KEY_Msk & (_UINT32_(value) << SUPC_BMR_KEY_Pos)) /* Assignment of value for KEY in the SUPC_BMR register */
...
#define SUPC_WUSR_WKUPS(value)                (SUPC_WUSR_WKUPS_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPS_Pos)) /* Assignment of value for WKUPS in the SUPC_WUSR register */
...
#define SUPC_WUSR_BADXTWKS(value)             (SUPC_WUSR_BADXTWKS_Msk & (_UINT32_(value) << SUPC_WUSR_BADXTWKS_Pos)) /* Assignment of value for BADXTWKS in the SUPC_WUSR register */
...
#define SUPC_WUSR_FWUPS(value)                (SUPC_WUSR_FWUPS_Msk & (_UINT32_(value) << SUPC_WUSR_FWUPS_Pos)) /* Assignment of value for FWUPS in the SUPC_WUSR register */
...
#define SUPC_WUSR_VDD3V3SMWS(value)           (SUPC_WUSR_VDD3V3SMWS_Msk & (_UINT32_(value) << SUPC_WUSR_VDD3V3SMWS_Pos)) /* Assignment of value for VDD3V3SMWS in the SUPC_WUSR register */
...
#define SUPC_WUSR_RTTS(value)                 (SUPC_WUSR_RTTS_Msk & (_UINT32_(value) << SUPC_WUSR_RTTS_Pos)) /* Assignment of value for RTTS in the SUPC_WUSR register */
...
#define SUPC_WUSR_RTCS(value)                 (SUPC_WUSR_RTCS_Msk & (_UINT32_(value) << SUPC_WUSR_RTCS_Pos)) /* Assignment of value for RTCS in the SUPC_WUSR register */
...
#define SUPC_WUSR_VDD3V3SMRSTS(value)         (SUPC_WUSR_VDD3V3SMRSTS_Msk & (_UINT32_(value) << SUPC_WUSR_VDD3V3SMRSTS_Pos)) /* Assignment of value for VDD3V3SMRSTS in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS0(value)              (SUPC_WUSR_WKUPIS0_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS0_Pos)) /* Assignment of value for WKUPIS0 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS1(value)              (SUPC_WUSR_WKUPIS1_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS1_Pos)) /* Assignment of value for WKUPIS1 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS2(value)              (SUPC_WUSR_WKUPIS2_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS2_Pos)) /* Assignment of value for WKUPIS2 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS3(value)              (SUPC_WUSR_WKUPIS3_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS3_Pos)) /* Assignment of value for WKUPIS3 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS4(value)              (SUPC_WUSR_WKUPIS4_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS4_Pos)) /* Assignment of value for WKUPIS4 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS5(value)              (SUPC_WUSR_WKUPIS5_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS5_Pos)) /* Assignment of value for WKUPIS5 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS6(value)              (SUPC_WUSR_WKUPIS6_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS6_Pos)) /* Assignment of value for WKUPIS6 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS7(value)              (SUPC_WUSR_WKUPIS7_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS7_Pos)) /* Assignment of value for WKUPIS7 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS8(value)              (SUPC_WUSR_WKUPIS8_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS8_Pos)) /* Assignment of value for WKUPIS8 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS9(value)              (SUPC_WUSR_WKUPIS9_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS9_Pos)) /* Assignment of value for WKUPIS9 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS10(value)             (SUPC_WUSR_WKUPIS10_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS10_Pos)) /* Assignment of value for WKUPIS10 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS11(value)             (SUPC_WUSR_WKUPIS11_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS11_Pos)) /* Assignment of value for WKUPIS11 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS12(value)             (SUPC_WUSR_WKUPIS12_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS12_Pos)) /* Assignment of value for WKUPIS12 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS13(value)             (SUPC_WUSR_WKUPIS13_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS13_Pos)) /* Assignment of value for WKUPIS13 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS14(value)             (SUPC_WUSR_WKUPIS14_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS14_Pos)) /* Assignment of value for WKUPIS14 in the SUPC_WUSR register */
...
#define SUPC_WUSR_WKUPIS15(value)             (SUPC_WUSR_WKUPIS15_Msk & (_UINT32_(value) << SUPC_WUSR_WKUPIS15_Pos)) /* Assignment of value for WKUPIS15 in the SUPC_WUSR register */
...
#define SUPC_IER_LPDBC0(value)                (SUPC_IER_LPDBC0_Msk & (_UINT32_(value) << SUPC_IER_LPDBC0_Pos)) /* Assignment of value for LPDBC0 in the SUPC_IER register */
...
#define SUPC_IER_LPDBC1(value)                (SUPC_IER_LPDBC1_Msk & (_UINT32_(value) << SUPC_IER_LPDBC1_Pos)) /* Assignment of value for LPDBC1 in the SUPC_IER register */
...
#define SUPC_IER_LPDBC2(value)                (SUPC_IER_LPDBC2_Msk & (_UINT32_(value) << SUPC_IER_LPDBC2_Pos)) /* Assignment of value for LPDBC2 in the SUPC_IER register */
...
#define SUPC_IER_LPDBC3(value)                (SUPC_IER_LPDBC3_Msk & (_UINT32_(value) << SUPC_IER_LPDBC3_Pos)) /* Assignment of value for LPDBC3 in the SUPC_IER register */
...
#define SUPC_IER_LPDBC4(value)                (SUPC_IER_LPDBC4_Msk & (_UINT32_(value) << SUPC_IER_LPDBC4_Pos)) /* Assignment of value for LPDBC4 in the SUPC_IER register */
...
#define SUPC_IER_VDD3V3SMEV(value)            (SUPC_IER_VDD3V3SMEV_Msk & (_UINT32_(value) << SUPC_IER_VDD3V3SMEV_Pos)) /* Assignment of value for VDD3V3SMEV in the SUPC_IER register */
...
#define SUPC_IER_VBATSMEV(value)              (SUPC_IER_VBATSMEV_Msk & (_UINT32_(value) << SUPC_IER_VBATSMEV_Pos)) /* Assignment of value for VBATSMEV in the SUPC_IER register */
...
#define SUPC_IDR_LPDBC0(value)                (SUPC_IDR_LPDBC0_Msk & (_UINT32_(value) << SUPC_IDR_LPDBC0_Pos)) /* Assignment of value for LPDBC0 in the SUPC_IDR register */
...
#define SUPC_IDR_LPDBC1(value)                (SUPC_IDR_LPDBC1_Msk & (_UINT32_(value) << SUPC_IDR_LPDBC1_Pos)) /* Assignment of value for LPDBC1 in the SUPC_IDR register */
...
#define SUPC_IDR_LPDBC2(value)                (SUPC_IDR_LPDBC2_Msk & (_UINT32_(value) << SUPC_IDR_LPDBC2_Pos)) /* Assignment of value for LPDBC2 in the SUPC_IDR register */
...
#define SUPC_IDR_LPDBC3(value)                (SUPC_IDR_LPDBC3_Msk & (_UINT32_(value) << SUPC_IDR_LPDBC3_Pos)) /* Assignment of value for LPDBC3 in the SUPC_IDR register */
...
#define SUPC_IDR_LPDBC4(value)                (SUPC_IDR_LPDBC4_Msk & (_UINT32_(value) << SUPC_IDR_LPDBC4_Pos)) /* Assignment of value for LPDBC4 in the SUPC_IDR register */
...
#define SUPC_IDR_VDD3V3SMEV(value)            (SUPC_IDR_VDD3V3SMEV_Msk & (_UINT32_(value) << SUPC_IDR_VDD3V3SMEV_Pos)) /* Assignment of value for VDD3V3SMEV in the SUPC_IDR register */
...
#define SUPC_IDR_VBATSMEV(value)              (SUPC_IDR_VBATSMEV_Msk & (_UINT32_(value) << SUPC_IDR_VBATSMEV_Pos)) /* Assignment of value for VBATSMEV in the SUPC_IDR register */
...
#define SUPC_IMR_LPDBC0(value)                (SUPC_IMR_LPDBC0_Msk & (_UINT32_(value) << SUPC_IMR_LPDBC0_Pos)) /* Assignment of value for LPDBC0 in the SUPC_IMR register */
...
#define SUPC_IMR_LPDBC1(value)                (SUPC_IMR_LPDBC1_Msk & (_UINT32_(value) << SUPC_IMR_LPDBC1_Pos)) /* Assignment of value for LPDBC1 in the SUPC_IMR register */
...
#define SUPC_IMR_LPDBC2(value)                (SUPC_IMR_LPDBC2_Msk & (_UINT32_(value) << SUPC_IMR_LPDBC2_Pos)) /* Assignment of value for LPDBC2 in the SUPC_IMR register */
...
#define SUPC_IMR_LPDBC3(value)                (SUPC_IMR_LPDBC3_Msk & (_UINT32_(value) << SUPC_IMR_LPDBC3_Pos)) /* Assignment of value for LPDBC3 in the SUPC_IMR register */
...
#define SUPC_IMR_LPDBC4(value)                (SUPC_IMR_LPDBC4_Msk & (_UINT32_(value) << SUPC_IMR_LPDBC4_Pos)) /* Assignment of value for LPDBC4 in the SUPC_IMR register */
...
#define SUPC_IMR_VDD3V3SMEV(value)            (SUPC_IMR_VDD3V3SMEV_Msk & (_UINT32_(value) << SUPC_IMR_VDD3V3SMEV_Pos)) /* Assignment of value for VDD3V3SMEV in the SUPC_IMR register */
...
#define SUPC_IMR_VBATSMEV(value)              (SUPC_IMR_VBATSMEV_Msk & (_UINT32_(value) << SUPC_IMR_VBATSMEV_Pos)) /* Assignment of value for VBATSMEV in the SUPC_IMR register */
...
#define SUPC_ISR_LPDBC0(value)                (SUPC_ISR_LPDBC0_Msk & (_UINT32_(value) << SUPC_ISR_LPDBC0_Pos)) /* Assignment of value for LPDBC0 in the SUPC_ISR register */
...
#define SUPC_ISR_LPDBC1(value)                (SUPC_ISR_LPDBC1_Msk & (_UINT32_(value) << SUPC_ISR_LPDBC1_Pos)) /* Assignment of value for LPDBC1 in the SUPC_ISR register */
...
#define SUPC_ISR_LPDBC2(value)                (SUPC_ISR_LPDBC2_Msk & (_UINT32_(value) << SUPC_ISR_LPDBC2_Pos)) /* Assignment of value for LPDBC2 in the SUPC_ISR register */
...
#define SUPC_ISR_LPDBC3(value)                (SUPC_ISR_LPDBC3_Msk & (_UINT32_(value) << SUPC_ISR_LPDBC3_Pos)) /* Assignment of value for LPDBC3 in the SUPC_ISR register */
...
#define SUPC_ISR_LPDBC4(value)                (SUPC_ISR_LPDBC4_Msk & (_UINT32_(value) << SUPC_ISR_LPDBC4_Pos)) /* Assignment of value for LPDBC4 in the SUPC_ISR register */
...
#define SUPC_ISR_VDD3V3SMEV(value)            (SUPC_ISR_VDD3V3SMEV_Msk & (_UINT32_(value) << SUPC_ISR_VDD3V3SMEV_Pos)) /* Assignment of value for VDD3V3SMEV in the SUPC_ISR register */
...
#define SUPC_ISR_VBATSMEV(value)              (SUPC_ISR_VBATSMEV_Msk & (_UINT32_(value) << SUPC_ISR_VBATSMEV_Pos)) /* Assignment of value for VBATSMEV in the SUPC_ISR register */
