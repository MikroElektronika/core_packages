...
#define DWDT_WDT1_CR_WDRSTT(value)            (DWDT_WDT1_CR_WDRSTT_Msk & (_UINT32_(value) << DWDT_WDT1_CR_WDRSTT_Pos)) /* Assignment of value for WDRSTT in the DWDT_WDT1_CR register */
...
#define DWDT_WDT1_CR_LOCKMR(value)            (DWDT_WDT1_CR_LOCKMR_Msk & (_UINT32_(value) << DWDT_WDT1_CR_LOCKMR_Pos)) /* Assignment of value for LOCKMR in the DWDT_WDT1_CR register */
...
#define DWDT_WDT1_CR_KEY(value)               (DWDT_WDT1_CR_KEY_Msk & (_UINT32_(value) << DWDT_WDT1_CR_KEY_Pos)) /* Assignment of value for KEY in the DWDT_WDT1_CR register */
...
#define DWDT_WDT1_MR_PERIODRST(value)         (DWDT_WDT1_MR_PERIODRST_Msk & (_UINT32_(value) << DWDT_WDT1_MR_PERIODRST_Pos)) /* Assignment of value for PERIODRST in the DWDT_WDT1_MR register */
...
#define DWDT_WDT1_MR_RPTHRST(value)           (DWDT_WDT1_MR_RPTHRST_Msk & (_UINT32_(value) << DWDT_WDT1_MR_RPTHRST_Pos)) /* Assignment of value for RPTHRST in the DWDT_WDT1_MR register */
...
#define DWDT_WDT1_MR_WDNRSTDIS(value)         (DWDT_WDT1_MR_WDNRSTDIS_Msk & (_UINT32_(value) << DWDT_WDT1_MR_WDNRSTDIS_Pos)) /* Assignment of value for WDNRSTDIS in the DWDT_WDT1_MR register */
...
#define DWDT_WDT1_MR_WDDIS(value)             (DWDT_WDT1_MR_WDDIS_Msk & (_UINT32_(value) << DWDT_WDT1_MR_WDDIS_Pos)) /* Assignment of value for WDDIS in the DWDT_WDT1_MR register */
...
#define DWDT_WDT1_MR_WDIDLEHLT(value)         (DWDT_WDT1_MR_WDIDLEHLT_Msk & (_UINT32_(value) << DWDT_WDT1_MR_WDIDLEHLT_Pos)) /* Assignment of value for WDIDLEHLT in the DWDT_WDT1_MR register */
...
#define DWDT_WDT1_MR_WDDBG0HLT(value)         (DWDT_WDT1_MR_WDDBG0HLT_Msk & (_UINT32_(value) << DWDT_WDT1_MR_WDDBG0HLT_Pos)) /* Assignment of value for WDDBG0HLT in the DWDT_WDT1_MR register */
...
#define DWDT_WDT1_MR_WDDBG1HLT(value)         (DWDT_WDT1_MR_WDDBG1HLT_Msk & (_UINT32_(value) << DWDT_WDT1_MR_WDDBG1HLT_Pos)) /* Assignment of value for WDDBG1HLT in the DWDT_WDT1_MR register */
...
#define DWDT_WDT1_VR_COUNTER(value)           (DWDT_WDT1_VR_COUNTER_Msk & (_UINT32_(value) << DWDT_WDT1_VR_COUNTER_Pos)) /* Assignment of value for COUNTER in the DWDT_WDT1_VR register */
...
#define DWDT_WDT1_WL_PERIOD(value)            (DWDT_WDT1_WL_PERIOD_Msk & (_UINT32_(value) << DWDT_WDT1_WL_PERIOD_Pos)) /* Assignment of value for PERIOD in the DWDT_WDT1_WL register */
...
#define DWDT_WDT1_WL_RPTH(value)              (DWDT_WDT1_WL_RPTH_Msk & (_UINT32_(value) << DWDT_WDT1_WL_RPTH_Pos)) /* Assignment of value for RPTH in the DWDT_WDT1_WL register */
...
#define DWDT_WDT1_IL_LVLTH(value)             (DWDT_WDT1_IL_LVLTH_Msk & (_UINT32_(value) << DWDT_WDT1_IL_LVLTH_Pos)) /* Assignment of value for LVLTH in the DWDT_WDT1_IL register */
...
#define DWDT_WDT1_IL_PRESC(value)             (DWDT_WDT1_IL_PRESC_Msk & (_UINT32_(value) << DWDT_WDT1_IL_PRESC_Pos)) /* Assignment of value for PRESC in the DWDT_WDT1_IL register */
...
#define DWDT_WDT1_IER_PERINT(value)           (DWDT_WDT1_IER_PERINT_Msk & (_UINT32_(value) << DWDT_WDT1_IER_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT1_IER register */
...
#define DWDT_WDT1_IER_RPTHINT(value)          (DWDT_WDT1_IER_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT1_IER_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT1_IER register */
...
#define DWDT_WDT1_IER_LVLINT(value)           (DWDT_WDT1_IER_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT1_IER_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT1_IER register */
...
#define DWDT_WDT1_IER_RLDERR(value)           (DWDT_WDT1_IER_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT1_IER_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT1_IER register */
...
#define DWDT_WDT1_IDR_PERINT(value)           (DWDT_WDT1_IDR_PERINT_Msk & (_UINT32_(value) << DWDT_WDT1_IDR_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT1_IDR register */
...
#define DWDT_WDT1_IDR_RPTHINT(value)          (DWDT_WDT1_IDR_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT1_IDR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT1_IDR register */
...
#define DWDT_WDT1_IDR_LVLINT(value)           (DWDT_WDT1_IDR_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT1_IDR_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT1_IDR register */
...
#define DWDT_WDT1_IDR_RLDERR(value)           (DWDT_WDT1_IDR_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT1_IDR_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT1_IDR register */
...
#define DWDT_WDT1_ISR_PERINT(value)           (DWDT_WDT1_ISR_PERINT_Msk & (_UINT32_(value) << DWDT_WDT1_ISR_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT1_ISR register */
...
#define DWDT_WDT1_ISR_RPTHINT(value)          (DWDT_WDT1_ISR_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT1_ISR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT1_ISR register */
...
#define DWDT_WDT1_ISR_LVLINT(value)           (DWDT_WDT1_ISR_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT1_ISR_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT1_ISR register */
...
#define DWDT_WDT1_ISR_RLDERR(value)           (DWDT_WDT1_ISR_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT1_ISR_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT1_ISR register */
...
#define DWDT_WDT1_IMR_PERINT(value)           (DWDT_WDT1_IMR_PERINT_Msk & (_UINT32_(value) << DWDT_WDT1_IMR_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT1_IMR register */
...
#define DWDT_WDT1_IMR_RPTHINT(value)          (DWDT_WDT1_IMR_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT1_IMR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT1_IMR register */
...
#define DWDT_WDT1_IMR_LVLINT(value)           (DWDT_WDT1_IMR_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT1_IMR_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT1_IMR register */
...
#define DWDT_WDT1_IMR_RLDERR(value)           (DWDT_WDT1_IMR_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT1_IMR_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT1_IMR register */
...
#define DWDT_WDT0_CR_WDRSTT(value)            (DWDT_WDT0_CR_WDRSTT_Msk & (_UINT32_(value) << DWDT_WDT0_CR_WDRSTT_Pos)) /* Assignment of value for WDRSTT in the DWDT_WDT0_CR register */
...
#define DWDT_WDT0_CR_LOCKMR(value)            (DWDT_WDT0_CR_LOCKMR_Msk & (_UINT32_(value) << DWDT_WDT0_CR_LOCKMR_Pos)) /* Assignment of value for LOCKMR in the DWDT_WDT0_CR register */
...
#define DWDT_WDT0_CR_KEY(value)               (DWDT_WDT0_CR_KEY_Msk & (_UINT32_(value) << DWDT_WDT0_CR_KEY_Pos)) /* Assignment of value for KEY in the DWDT_WDT0_CR register */
...
#define DWDT_WDT0_MR_PERIODRST(value)         (DWDT_WDT0_MR_PERIODRST_Msk & (_UINT32_(value) << DWDT_WDT0_MR_PERIODRST_Pos)) /* Assignment of value for PERIODRST in the DWDT_WDT0_MR register */
...
#define DWDT_WDT0_MR_RPTHRST(value)           (DWDT_WDT0_MR_RPTHRST_Msk & (_UINT32_(value) << DWDT_WDT0_MR_RPTHRST_Pos)) /* Assignment of value for RPTHRST in the DWDT_WDT0_MR register */
...
#define DWDT_WDT0_MR_WDNRSTDIS(value)         (DWDT_WDT0_MR_WDNRSTDIS_Msk & (_UINT32_(value) << DWDT_WDT0_MR_WDNRSTDIS_Pos)) /* Assignment of value for WDNRSTDIS in the DWDT_WDT0_MR register */
...
#define DWDT_WDT0_MR_WDDIS(value)             (DWDT_WDT0_MR_WDDIS_Msk & (_UINT32_(value) << DWDT_WDT0_MR_WDDIS_Pos)) /* Assignment of value for WDDIS in the DWDT_WDT0_MR register */
...
#define DWDT_WDT0_MR_WDIDLEHLT(value)         (DWDT_WDT0_MR_WDIDLEHLT_Msk & (_UINT32_(value) << DWDT_WDT0_MR_WDIDLEHLT_Pos)) /* Assignment of value for WDIDLEHLT in the DWDT_WDT0_MR register */
...
#define DWDT_WDT0_MR_WDDBG0HLT(value)         (DWDT_WDT0_MR_WDDBG0HLT_Msk & (_UINT32_(value) << DWDT_WDT0_MR_WDDBG0HLT_Pos)) /* Assignment of value for WDDBG0HLT in the DWDT_WDT0_MR register */
...
#define DWDT_WDT0_MR_WDDBG1HLT(value)         (DWDT_WDT0_MR_WDDBG1HLT_Msk & (_UINT32_(value) << DWDT_WDT0_MR_WDDBG1HLT_Pos)) /* Assignment of value for WDDBG1HLT in the DWDT_WDT0_MR register */
...
#define DWDT_WDT0_VR_COUNTER(value)           (DWDT_WDT0_VR_COUNTER_Msk & (_UINT32_(value) << DWDT_WDT0_VR_COUNTER_Pos)) /* Assignment of value for COUNTER in the DWDT_WDT0_VR register */
...
#define DWDT_WDT0_WL_PERIOD(value)            (DWDT_WDT0_WL_PERIOD_Msk & (_UINT32_(value) << DWDT_WDT0_WL_PERIOD_Pos)) /* Assignment of value for PERIOD in the DWDT_WDT0_WL register */
...
#define DWDT_WDT0_WL_RPTH(value)              (DWDT_WDT0_WL_RPTH_Msk & (_UINT32_(value) << DWDT_WDT0_WL_RPTH_Pos)) /* Assignment of value for RPTH in the DWDT_WDT0_WL register */
...
#define DWDT_WDT0_IL_LVLTH(value)             (DWDT_WDT0_IL_LVLTH_Msk & (_UINT32_(value) << DWDT_WDT0_IL_LVLTH_Pos)) /* Assignment of value for LVLTH in the DWDT_WDT0_IL register */
...
#define DWDT_WDT0_IL_PRESC(value)             (DWDT_WDT0_IL_PRESC_Msk & (_UINT32_(value) << DWDT_WDT0_IL_PRESC_Pos)) /* Assignment of value for PRESC in the DWDT_WDT0_IL register */
...
#define DWDT_WDT0_IER_PERINT(value)           (DWDT_WDT0_IER_PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_IER_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT0_IER register */
...
#define DWDT_WDT0_IER_RPTHINT(value)          (DWDT_WDT0_IER_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_IER_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT0_IER register */
...
#define DWDT_WDT0_IER_LVLINT(value)           (DWDT_WDT0_IER_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT0_IER_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT0_IER register */
...
#define DWDT_WDT0_IER_W1PERINT(value)         (DWDT_WDT0_IER_W1PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_IER_W1PERINT_Pos)) /* Assignment of value for W1PERINT in the DWDT_WDT0_IER register */
...
#define DWDT_WDT0_IER_W1RPTHINT(value)        (DWDT_WDT0_IER_W1RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_IER_W1RPTHINT_Pos)) /* Assignment of value for W1RPTHINT in the DWDT_WDT0_IER register */
...
#define DWDT_WDT0_IER_RLDERR(value)           (DWDT_WDT0_IER_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT0_IER_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT0_IER register */
...
#define DWDT_WDT0_IDR_PERINT(value)           (DWDT_WDT0_IDR_PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_IDR_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT0_IDR register */
...
#define DWDT_WDT0_IDR_RPTHINT(value)          (DWDT_WDT0_IDR_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_IDR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT0_IDR register */
...
#define DWDT_WDT0_IDR_LVLINT(value)           (DWDT_WDT0_IDR_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT0_IDR_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT0_IDR register */
...
#define DWDT_WDT0_IDR_W1PERINT(value)         (DWDT_WDT0_IDR_W1PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_IDR_W1PERINT_Pos)) /* Assignment of value for W1PERINT in the DWDT_WDT0_IDR register */
...
#define DWDT_WDT0_IDR_W1RPTHINT(value)        (DWDT_WDT0_IDR_W1RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_IDR_W1RPTHINT_Pos)) /* Assignment of value for W1RPTHINT in the DWDT_WDT0_IDR register */
...
#define DWDT_WDT0_IDR_RLDERR(value)           (DWDT_WDT0_IDR_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT0_IDR_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT0_IDR register */
...
#define DWDT_WDT0_ISR_PERINT(value)           (DWDT_WDT0_ISR_PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_ISR_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT0_ISR register */
...
#define DWDT_WDT0_ISR_RPTHINT(value)          (DWDT_WDT0_ISR_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_ISR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT0_ISR register */
...
#define DWDT_WDT0_ISR_LVLINT(value)           (DWDT_WDT0_ISR_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT0_ISR_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT0_ISR register */
...
#define DWDT_WDT0_ISR_W1PERINT(value)         (DWDT_WDT0_ISR_W1PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_ISR_W1PERINT_Pos)) /* Assignment of value for W1PERINT in the DWDT_WDT0_ISR register */
...
#define DWDT_WDT0_ISR_W1RPTHINT(value)        (DWDT_WDT0_ISR_W1RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_ISR_W1RPTHINT_Pos)) /* Assignment of value for W1RPTHINT in the DWDT_WDT0_ISR register */
...
#define DWDT_WDT0_ISR_RLDERR(value)           (DWDT_WDT0_ISR_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT0_ISR_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT0_ISR register */
...
#define DWDT_WDT0_IMR_PERINT(value)           (DWDT_WDT0_IMR_PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_IMR_PERINT_Pos)) /* Assignment of value for PERINT in the DWDT_WDT0_IMR register */
...
#define DWDT_WDT0_IMR_RPTHINT(value)          (DWDT_WDT0_IMR_RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_IMR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the DWDT_WDT0_IMR register */
...
#define DWDT_WDT0_IMR_LVLINT(value)           (DWDT_WDT0_IMR_LVLINT_Msk & (_UINT32_(value) << DWDT_WDT0_IMR_LVLINT_Pos)) /* Assignment of value for LVLINT in the DWDT_WDT0_IMR register */
...
#define DWDT_WDT0_IMR_W1PERINT(value)         (DWDT_WDT0_IMR_W1PERINT_Msk & (_UINT32_(value) << DWDT_WDT0_IMR_W1PERINT_Pos)) /* Assignment of value for W1PERINT in the DWDT_WDT0_IMR register */
...
#define DWDT_WDT0_IMR_W1RPTHINT(value)        (DWDT_WDT0_IMR_W1RPTHINT_Msk & (_UINT32_(value) << DWDT_WDT0_IMR_W1RPTHINT_Pos)) /* Assignment of value for W1RPTHINT in the DWDT_WDT0_IMR register */
...
#define DWDT_WDT0_IMR_RLDERR(value)           (DWDT_WDT0_IMR_RLDERR_Msk & (_UINT32_(value) << DWDT_WDT0_IMR_RLDERR_Pos)) /* Assignment of value for RLDERR in the DWDT_WDT0_IMR register */
...
#define DWDT_WDT1_LVLLIM_LVLMIN(value)        (DWDT_WDT1_LVLLIM_LVLMIN_Msk & (_UINT32_(value) << DWDT_WDT1_LVLLIM_LVLMIN_Pos)) /* Assignment of value for LVLMIN in the DWDT_WDT1_LVLLIM register */
...
#define DWDT_WDT1_LVLLIM_LVLMAX(value)        (DWDT_WDT1_LVLLIM_LVLMAX_Msk & (_UINT32_(value) << DWDT_WDT1_LVLLIM_LVLMAX_Pos)) /* Assignment of value for LVLMAX in the DWDT_WDT1_LVLLIM register */
...
#define DWDT_WDT1_RLIM_RPTHMIN(value)         (DWDT_WDT1_RLIM_RPTHMIN_Msk & (_UINT32_(value) << DWDT_WDT1_RLIM_RPTHMIN_Pos)) /* Assignment of value for RPTHMIN in the DWDT_WDT1_RLIM register */
...
#define DWDT_WDT1_RLIM_RPTHMAX(value)         (DWDT_WDT1_RLIM_RPTHMAX_Msk & (_UINT32_(value) << DWDT_WDT1_RLIM_RPTHMAX_Pos)) /* Assignment of value for RPTHMAX in the DWDT_WDT1_RLIM register */
...
#define DWDT_WDT1_PLIM_PERMIN(value)          (DWDT_WDT1_PLIM_PERMIN_Msk & (_UINT32_(value) << DWDT_WDT1_PLIM_PERMIN_Pos)) /* Assignment of value for PERMIN in the DWDT_WDT1_PLIM register */
...
#define DWDT_WDT1_PLIM_PERMAX(value)          (DWDT_WDT1_PLIM_PERMAX_Msk & (_UINT32_(value) << DWDT_WDT1_PLIM_PERMAX_Pos)) /* Assignment of value for PERMAX in the DWDT_WDT1_PLIM register */
