...
#define MEM2MEM_THR_THDATA(value)             (MEM2MEM_THR_THDATA_Msk & (_UINT32_(value) << MEM2MEM_THR_THDATA_Pos)) /* Assignment of value for THDATA in the MEM2MEM_THR register */
...
#define MEM2MEM_MR_TSIZE(value)               (MEM2MEM_MR_TSIZE_Msk & (_UINT32_(value) << MEM2MEM_MR_TSIZE_Pos)) /* Assignment of value for TSIZE in the MEM2MEM_MR register */
...
#define MEM2MEM_IER_RXEND(value)              (MEM2MEM_IER_RXEND_Msk & (_UINT32_(value) << MEM2MEM_IER_RXEND_Pos)) /* Assignment of value for RXEND in the MEM2MEM_IER register */
...
#define MEM2MEM_IER_RXBUFF(value)             (MEM2MEM_IER_RXBUFF_Msk & (_UINT32_(value) << MEM2MEM_IER_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the MEM2MEM_IER register */
...
#define MEM2MEM_IDR_RXEND(value)              (MEM2MEM_IDR_RXEND_Msk & (_UINT32_(value) << MEM2MEM_IDR_RXEND_Pos)) /* Assignment of value for RXEND in the MEM2MEM_IDR register */
...
#define MEM2MEM_IDR_RXBUFF(value)             (MEM2MEM_IDR_RXBUFF_Msk & (_UINT32_(value) << MEM2MEM_IDR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the MEM2MEM_IDR register */
...
#define MEM2MEM_IMR_RXEND(value)              (MEM2MEM_IMR_RXEND_Msk & (_UINT32_(value) << MEM2MEM_IMR_RXEND_Pos)) /* Assignment of value for RXEND in the MEM2MEM_IMR register */
...
#define MEM2MEM_IMR_RXBUFF(value)             (MEM2MEM_IMR_RXBUFF_Msk & (_UINT32_(value) << MEM2MEM_IMR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the MEM2MEM_IMR register */
...
#define MEM2MEM_ISR_RXEND(value)              (MEM2MEM_ISR_RXEND_Msk & (_UINT32_(value) << MEM2MEM_ISR_RXEND_Pos)) /* Assignment of value for RXEND in the MEM2MEM_ISR register */
...
#define MEM2MEM_ISR_RXBUFF(value)             (MEM2MEM_ISR_RXBUFF_Msk & (_UINT32_(value) << MEM2MEM_ISR_RXBUFF_Pos)) /* Assignment of value for RXBUFF in the MEM2MEM_ISR register */
...
#define MEM2MEM_WPMR_WPEN(value)              (MEM2MEM_WPMR_WPEN_Msk & (_UINT32_(value) << MEM2MEM_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the MEM2MEM_WPMR register */
...
#define MEM2MEM_WPMR_WPITEN(value)            (MEM2MEM_WPMR_WPITEN_Msk & (_UINT32_(value) << MEM2MEM_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the MEM2MEM_WPMR register */
...
#define MEM2MEM_WPMR_WPKEY(value)             (MEM2MEM_WPMR_WPKEY_Msk & (_UINT32_(value) << MEM2MEM_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the MEM2MEM_WPMR register */
...
#define MEM2MEM_RPR_RXPTR(value)              (MEM2MEM_RPR_RXPTR_Msk & (_UINT32_(value) << MEM2MEM_RPR_RXPTR_Pos)) /* Assignment of value for RXPTR in the MEM2MEM_RPR register */
...
#define MEM2MEM_RCR_RXCTR(value)              (MEM2MEM_RCR_RXCTR_Msk & (_UINT32_(value) << MEM2MEM_RCR_RXCTR_Pos)) /* Assignment of value for RXCTR in the MEM2MEM_RCR register */
...
#define MEM2MEM_TPR_TXPTR(value)              (MEM2MEM_TPR_TXPTR_Msk & (_UINT32_(value) << MEM2MEM_TPR_TXPTR_Pos)) /* Assignment of value for TXPTR in the MEM2MEM_TPR register */
...
#define MEM2MEM_TCR_TXCTR(value)              (MEM2MEM_TCR_TXCTR_Msk & (_UINT32_(value) << MEM2MEM_TCR_TXCTR_Pos)) /* Assignment of value for TXCTR in the MEM2MEM_TCR register */
...
#define MEM2MEM_RNPR_RXNPTR(value)            (MEM2MEM_RNPR_RXNPTR_Msk & (_UINT32_(value) << MEM2MEM_RNPR_RXNPTR_Pos)) /* Assignment of value for RXNPTR in the MEM2MEM_RNPR register */
...
#define MEM2MEM_RNCR_RXNCTR(value)            (MEM2MEM_RNCR_RXNCTR_Msk & (_UINT32_(value) << MEM2MEM_RNCR_RXNCTR_Pos)) /* Assignment of value for RXNCTR in the MEM2MEM_RNCR register */
...
#define MEM2MEM_TNPR_TXNPTR(value)            (MEM2MEM_TNPR_TXNPTR_Msk & (_UINT32_(value) << MEM2MEM_TNPR_TXNPTR_Pos)) /* Assignment of value for TXNPTR in the MEM2MEM_TNPR register */
...
#define MEM2MEM_TNCR_TXNCTR(value)            (MEM2MEM_TNCR_TXNCTR_Msk & (_UINT32_(value) << MEM2MEM_TNCR_TXNCTR_Pos)) /* Assignment of value for TXNCTR in the MEM2MEM_TNCR register */
...
#define MEM2MEM_PTCR_RXTEN(value)             (MEM2MEM_PTCR_RXTEN_Msk & (_UINT32_(value) << MEM2MEM_PTCR_RXTEN_Pos)) /* Assignment of value for RXTEN in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_RXTDIS(value)            (MEM2MEM_PTCR_RXTDIS_Msk & (_UINT32_(value) << MEM2MEM_PTCR_RXTDIS_Pos)) /* Assignment of value for RXTDIS in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_TXTEN(value)             (MEM2MEM_PTCR_TXTEN_Msk & (_UINT32_(value) << MEM2MEM_PTCR_TXTEN_Pos)) /* Assignment of value for TXTEN in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_TXTDIS(value)            (MEM2MEM_PTCR_TXTDIS_Msk & (_UINT32_(value) << MEM2MEM_PTCR_TXTDIS_Pos)) /* Assignment of value for TXTDIS in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_RXCBEN(value)            (MEM2MEM_PTCR_RXCBEN_Msk & (_UINT32_(value) << MEM2MEM_PTCR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_RXCBDIS(value)           (MEM2MEM_PTCR_RXCBDIS_Msk & (_UINT32_(value) << MEM2MEM_PTCR_RXCBDIS_Pos)) /* Assignment of value for RXCBDIS in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_TXCBEN(value)            (MEM2MEM_PTCR_TXCBEN_Msk & (_UINT32_(value) << MEM2MEM_PTCR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_TXCBDIS(value)           (MEM2MEM_PTCR_TXCBDIS_Msk & (_UINT32_(value) << MEM2MEM_PTCR_TXCBDIS_Pos)) /* Assignment of value for TXCBDIS in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTCR_ERRCLR(value)            (MEM2MEM_PTCR_ERRCLR_Msk & (_UINT32_(value) << MEM2MEM_PTCR_ERRCLR_Pos)) /* Assignment of value for ERRCLR in the MEM2MEM_PTCR register */
...
#define MEM2MEM_PTSR_RXTEN(value)             (MEM2MEM_PTSR_RXTEN_Msk & (_UINT32_(value) << MEM2MEM_PTSR_RXTEN_Pos)) /* Assignment of value for RXTEN in the MEM2MEM_PTSR register */
...
#define MEM2MEM_PTSR_TXTEN(value)             (MEM2MEM_PTSR_TXTEN_Msk & (_UINT32_(value) << MEM2MEM_PTSR_TXTEN_Pos)) /* Assignment of value for TXTEN in the MEM2MEM_PTSR register */
...
#define MEM2MEM_PTSR_RXCBEN(value)            (MEM2MEM_PTSR_RXCBEN_Msk & (_UINT32_(value) << MEM2MEM_PTSR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the MEM2MEM_PTSR register */
...
#define MEM2MEM_PTSR_TXCBEN(value)            (MEM2MEM_PTSR_TXCBEN_Msk & (_UINT32_(value) << MEM2MEM_PTSR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the MEM2MEM_PTSR register */
...
#define MEM2MEM_PTSR_ERR(value)               (MEM2MEM_PTSR_ERR_Msk & (_UINT32_(value) << MEM2MEM_PTSR_ERR_Pos)) /* Assignment of value for ERR in the MEM2MEM_PTSR register */
...
#define MEM2MEM_PWPMR_WPPTREN(value)          (MEM2MEM_PWPMR_WPPTREN_Msk & (_UINT32_(value) << MEM2MEM_PWPMR_WPPTREN_Pos)) /* Assignment of value for WPPTREN in the MEM2MEM_PWPMR register */
...
#define MEM2MEM_PWPMR_WPCTREN(value)          (MEM2MEM_PWPMR_WPCTREN_Msk & (_UINT32_(value) << MEM2MEM_PWPMR_WPCTREN_Pos)) /* Assignment of value for WPCTREN in the MEM2MEM_PWPMR register */
...
#define MEM2MEM_PWPMR_WPCREN(value)           (MEM2MEM_PWPMR_WPCREN_Msk & (_UINT32_(value) << MEM2MEM_PWPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the MEM2MEM_PWPMR register */
...
#define MEM2MEM_PWPMR_WPKEY(value)            (MEM2MEM_PWPMR_WPKEY_Msk & (_UINT32_(value) << MEM2MEM_PWPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the MEM2MEM_PWPMR register */
...
/* MEM2MEM register offsets definitions */
...
/* MEM2MEM register API structure */
typedef struct
{
