...
#define PDC_PERIPH_RPR_RXPTR(value)           (PDC_PERIPH_RPR_RXPTR_Msk & (_UINT32_(value) << PDC_PERIPH_RPR_RXPTR_Pos)) /* Assignment of value for RXPTR in the PDC_PERIPH_RPR register */
...
#define PDC_PERIPH_RCR_RXCTR(value)           (PDC_PERIPH_RCR_RXCTR_Msk & (_UINT32_(value) << PDC_PERIPH_RCR_RXCTR_Pos)) /* Assignment of value for RXCTR in the PDC_PERIPH_RCR register */
...
#define PDC_PERIPH_TPR_TXPTR(value)           (PDC_PERIPH_TPR_TXPTR_Msk & (_UINT32_(value) << PDC_PERIPH_TPR_TXPTR_Pos)) /* Assignment of value for TXPTR in the PDC_PERIPH_TPR register */
...
#define PDC_PERIPH_TCR_TXCTR(value)           (PDC_PERIPH_TCR_TXCTR_Msk & (_UINT32_(value) << PDC_PERIPH_TCR_TXCTR_Pos)) /* Assignment of value for TXCTR in the PDC_PERIPH_TCR register */
...
#define PDC_PERIPH_RNPR_RXNPTR(value)         (PDC_PERIPH_RNPR_RXNPTR_Msk & (_UINT32_(value) << PDC_PERIPH_RNPR_RXNPTR_Pos)) /* Assignment of value for RXNPTR in the PDC_PERIPH_RNPR register */
...
#define PDC_PERIPH_RNCR_RXNCTR(value)         (PDC_PERIPH_RNCR_RXNCTR_Msk & (_UINT32_(value) << PDC_PERIPH_RNCR_RXNCTR_Pos)) /* Assignment of value for RXNCTR in the PDC_PERIPH_RNCR register */
...
#define PDC_PERIPH_TNPR_TXNPTR(value)         (PDC_PERIPH_TNPR_TXNPTR_Msk & (_UINT32_(value) << PDC_PERIPH_TNPR_TXNPTR_Pos)) /* Assignment of value for TXNPTR in the PDC_PERIPH_TNPR register */
...
#define PDC_PERIPH_TNCR_TXNCTR(value)         (PDC_PERIPH_TNCR_TXNCTR_Msk & (_UINT32_(value) << PDC_PERIPH_TNCR_TXNCTR_Pos)) /* Assignment of value for TXNCTR in the PDC_PERIPH_TNCR register */
...
#define PDC_PERIPH_PTCR_RXTEN(value)          (PDC_PERIPH_PTCR_RXTEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_RXTEN_Pos)) /* Assignment of value for RXTEN in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_RXTDIS(value)         (PDC_PERIPH_PTCR_RXTDIS_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_RXTDIS_Pos)) /* Assignment of value for RXTDIS in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_TXTEN(value)          (PDC_PERIPH_PTCR_TXTEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_TXTEN_Pos)) /* Assignment of value for TXTEN in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_TXTDIS(value)         (PDC_PERIPH_PTCR_TXTDIS_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_TXTDIS_Pos)) /* Assignment of value for TXTDIS in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_RXCBEN(value)         (PDC_PERIPH_PTCR_RXCBEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_RXCBDIS(value)        (PDC_PERIPH_PTCR_RXCBDIS_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_RXCBDIS_Pos)) /* Assignment of value for RXCBDIS in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_TXCBEN(value)         (PDC_PERIPH_PTCR_TXCBEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_TXCBDIS(value)        (PDC_PERIPH_PTCR_TXCBDIS_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_TXCBDIS_Pos)) /* Assignment of value for TXCBDIS in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTCR_ERRCLR(value)         (PDC_PERIPH_PTCR_ERRCLR_Msk & (_UINT32_(value) << PDC_PERIPH_PTCR_ERRCLR_Pos)) /* Assignment of value for ERRCLR in the PDC_PERIPH_PTCR register */
...
#define PDC_PERIPH_PTSR_RXTEN(value)          (PDC_PERIPH_PTSR_RXTEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTSR_RXTEN_Pos)) /* Assignment of value for RXTEN in the PDC_PERIPH_PTSR register */
...
#define PDC_PERIPH_PTSR_TXTEN(value)          (PDC_PERIPH_PTSR_TXTEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTSR_TXTEN_Pos)) /* Assignment of value for TXTEN in the PDC_PERIPH_PTSR register */
...
#define PDC_PERIPH_PTSR_RXCBEN(value)         (PDC_PERIPH_PTSR_RXCBEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTSR_RXCBEN_Pos)) /* Assignment of value for RXCBEN in the PDC_PERIPH_PTSR register */
...
#define PDC_PERIPH_PTSR_TXCBEN(value)         (PDC_PERIPH_PTSR_TXCBEN_Msk & (_UINT32_(value) << PDC_PERIPH_PTSR_TXCBEN_Pos)) /* Assignment of value for TXCBEN in the PDC_PERIPH_PTSR register */
...
#define PDC_PERIPH_PTSR_ERR(value)            (PDC_PERIPH_PTSR_ERR_Msk & (_UINT32_(value) << PDC_PERIPH_PTSR_ERR_Pos)) /* Assignment of value for ERR in the PDC_PERIPH_PTSR register */
...
#define PDC_PERIPH_PWPMR_WPPTREN(value)       (PDC_PERIPH_PWPMR_WPPTREN_Msk & (_UINT32_(value) << PDC_PERIPH_PWPMR_WPPTREN_Pos)) /* Assignment of value for WPPTREN in the PDC_PERIPH_PWPMR register */
...
#define PDC_PERIPH_PWPMR_WPCTREN(value)       (PDC_PERIPH_PWPMR_WPCTREN_Msk & (_UINT32_(value) << PDC_PERIPH_PWPMR_WPCTREN_Pos)) /* Assignment of value for WPCTREN in the PDC_PERIPH_PWPMR register */
...
#define PDC_PERIPH_PWPMR_WPCREN(value)        (PDC_PERIPH_PWPMR_WPCREN_Msk & (_UINT32_(value) << PDC_PERIPH_PWPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the PDC_PERIPH_PWPMR register */
...
#define PDC_PERIPH_PWPMR_WPKEY(value)         (PDC_PERIPH_PWPMR_WPKEY_Msk & (_UINT32_(value) << PDC_PERIPH_PWPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the PDC_PERIPH_PWPMR register */
...
/* PDC register offsets definitions */
