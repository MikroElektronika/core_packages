...
#define SLCDC_CR_LCDEN(value)                 (SLCDC_CR_LCDEN_Msk & (_UINT32_(value) << SLCDC_CR_LCDEN_Pos)) /* Assignment of value for LCDEN in the SLCDC_CR register */
...
#define SLCDC_CR_LCDDIS(value)                (SLCDC_CR_LCDDIS_Msk & (_UINT32_(value) << SLCDC_CR_LCDDIS_Pos)) /* Assignment of value for LCDDIS in the SLCDC_CR register */
...
#define SLCDC_CR_SWRST(value)                 (SLCDC_CR_SWRST_Msk & (_UINT32_(value) << SLCDC_CR_SWRST_Pos)) /* Assignment of value for SWRST in the SLCDC_CR register */
...
#define SLCDC_CR_FRZDF(value)                 (SLCDC_CR_FRZDF_Msk & (_UINT32_(value) << SLCDC_CR_FRZDF_Pos)) /* Assignment of value for FRZDF in the SLCDC_CR register */
...
#define SLCDC_CR_FRZMAP(value)                (SLCDC_CR_FRZMAP_Msk & (_UINT32_(value) << SLCDC_CR_FRZMAP_Pos)) /* Assignment of value for FRZMAP in the SLCDC_CR register */
...
#define SLCDC_CR_FRZKEY(value)                (SLCDC_CR_FRZKEY_Msk & (_UINT32_(value) << SLCDC_CR_FRZKEY_Pos)) /* Assignment of value for FRZKEY in the SLCDC_CR register */
...
#define SLCDC_MR_COMSEL(value)                (SLCDC_MR_COMSEL_Msk & (_UINT32_(value) << SLCDC_MR_COMSEL_Pos)) /* Assignment of value for COMSEL in the SLCDC_MR register */
...
#define SLCDC_MR_SEGSEL(value)                (SLCDC_MR_SEGSEL_Msk & (_UINT32_(value) << SLCDC_MR_SEGSEL_Pos)) /* Assignment of value for SEGSEL in the SLCDC_MR register */
...
#define SLCDC_MR_BUFTIME(value)               (SLCDC_MR_BUFTIME_Msk & (_UINT32_(value) << SLCDC_MR_BUFTIME_Pos)) /* Assignment of value for BUFTIME in the SLCDC_MR register */
...
#define SLCDC_MR_BIAS(value)                  (SLCDC_MR_BIAS_Msk & (_UINT32_(value) << SLCDC_MR_BIAS_Pos)) /* Assignment of value for BIAS in the SLCDC_MR register */
...
#define SLCDC_MR_LPMODE(value)                (SLCDC_MR_LPMODE_Msk & (_UINT32_(value) << SLCDC_MR_LPMODE_Pos)) /* Assignment of value for LPMODE in the SLCDC_MR register */
...
#define SLCDC_FRR_PRESC(value)                (SLCDC_FRR_PRESC_Msk & (_UINT32_(value) << SLCDC_FRR_PRESC_Pos)) /* Assignment of value for PRESC in the SLCDC_FRR register */
...
#define SLCDC_FRR_DIV(value)                  (SLCDC_FRR_DIV_Msk & (_UINT32_(value) << SLCDC_FRR_DIV_Pos)) /* Assignment of value for DIV in the SLCDC_FRR register */
...
#define SLCDC_DR_DISPMODE(value)              (SLCDC_DR_DISPMODE_Msk & (_UINT32_(value) << SLCDC_DR_DISPMODE_Pos)) /* Assignment of value for DISPMODE in the SLCDC_DR register */
...
#define SLCDC_DR_LCDBLKFREQ(value)            (SLCDC_DR_LCDBLKFREQ_Msk & (_UINT32_(value) << SLCDC_DR_LCDBLKFREQ_Pos)) /* Assignment of value for LCDBLKFREQ in the SLCDC_DR register */
...
#define SLCDC_SR_ENA(value)                   (SLCDC_SR_ENA_Msk & (_UINT32_(value) << SLCDC_SR_ENA_Pos)) /* Assignment of value for ENA in the SLCDC_SR register */
...
#define SLCDC_SR_DFFRZS(value)                (SLCDC_SR_DFFRZS_Msk & (_UINT32_(value) << SLCDC_SR_DFFRZS_Pos)) /* Assignment of value for DFFRZS in the SLCDC_SR register */
...
#define SLCDC_SR_MAPFRZS(value)               (SLCDC_SR_MAPFRZS_Msk & (_UINT32_(value) << SLCDC_SR_MAPFRZS_Pos)) /* Assignment of value for MAPFRZS in the SLCDC_SR register */
...
#define SLCDC_IER_ENDFRAME(value)             (SLCDC_IER_ENDFRAME_Msk & (_UINT32_(value) << SLCDC_IER_ENDFRAME_Pos)) /* Assignment of value for ENDFRAME in the SLCDC_IER register */
...
#define SLCDC_IER_DIS(value)                  (SLCDC_IER_DIS_Msk & (_UINT32_(value) << SLCDC_IER_DIS_Pos)) /* Assignment of value for DIS in the SLCDC_IER register */
...
#define SLCDC_IDR_ENDFRAME(value)             (SLCDC_IDR_ENDFRAME_Msk & (_UINT32_(value) << SLCDC_IDR_ENDFRAME_Pos)) /* Assignment of value for ENDFRAME in the SLCDC_IDR register */
...
#define SLCDC_IDR_DIS(value)                  (SLCDC_IDR_DIS_Msk & (_UINT32_(value) << SLCDC_IDR_DIS_Pos)) /* Assignment of value for DIS in the SLCDC_IDR register */
...
#define SLCDC_IMR_ENDFRAME(value)             (SLCDC_IMR_ENDFRAME_Msk & (_UINT32_(value) << SLCDC_IMR_ENDFRAME_Pos)) /* Assignment of value for ENDFRAME in the SLCDC_IMR register */
...
#define SLCDC_IMR_DIS(value)                  (SLCDC_IMR_DIS_Msk & (_UINT32_(value) << SLCDC_IMR_DIS_Pos)) /* Assignment of value for DIS in the SLCDC_IMR register */
...
#define SLCDC_ISR_ENDFRAME(value)             (SLCDC_ISR_ENDFRAME_Msk & (_UINT32_(value) << SLCDC_ISR_ENDFRAME_Pos)) /* Assignment of value for ENDFRAME in the SLCDC_ISR register */
...
#define SLCDC_ISR_DIS(value)                  (SLCDC_ISR_DIS_Msk & (_UINT32_(value) << SLCDC_ISR_DIS_Pos)) /* Assignment of value for DIS in the SLCDC_ISR register */
...
#define SLCDC_SMR0_LCD0(value)                (SLCDC_SMR0_LCD0_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD0_Pos)) /* Assignment of value for LCD0 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD1(value)                (SLCDC_SMR0_LCD1_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD1_Pos)) /* Assignment of value for LCD1 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD2(value)                (SLCDC_SMR0_LCD2_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD2_Pos)) /* Assignment of value for LCD2 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD3(value)                (SLCDC_SMR0_LCD3_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD3_Pos)) /* Assignment of value for LCD3 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD4(value)                (SLCDC_SMR0_LCD4_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD4_Pos)) /* Assignment of value for LCD4 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD5(value)                (SLCDC_SMR0_LCD5_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD5_Pos)) /* Assignment of value for LCD5 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD6(value)                (SLCDC_SMR0_LCD6_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD6_Pos)) /* Assignment of value for LCD6 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD7(value)                (SLCDC_SMR0_LCD7_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD7_Pos)) /* Assignment of value for LCD7 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD8(value)                (SLCDC_SMR0_LCD8_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD8_Pos)) /* Assignment of value for LCD8 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD9(value)                (SLCDC_SMR0_LCD9_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD9_Pos)) /* Assignment of value for LCD9 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD10(value)               (SLCDC_SMR0_LCD10_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD10_Pos)) /* Assignment of value for LCD10 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD11(value)               (SLCDC_SMR0_LCD11_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD11_Pos)) /* Assignment of value for LCD11 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD12(value)               (SLCDC_SMR0_LCD12_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD12_Pos)) /* Assignment of value for LCD12 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD13(value)               (SLCDC_SMR0_LCD13_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD13_Pos)) /* Assignment of value for LCD13 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD14(value)               (SLCDC_SMR0_LCD14_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD14_Pos)) /* Assignment of value for LCD14 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD15(value)               (SLCDC_SMR0_LCD15_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD15_Pos)) /* Assignment of value for LCD15 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD16(value)               (SLCDC_SMR0_LCD16_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD16_Pos)) /* Assignment of value for LCD16 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD17(value)               (SLCDC_SMR0_LCD17_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD17_Pos)) /* Assignment of value for LCD17 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD18(value)               (SLCDC_SMR0_LCD18_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD18_Pos)) /* Assignment of value for LCD18 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD19(value)               (SLCDC_SMR0_LCD19_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD19_Pos)) /* Assignment of value for LCD19 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD20(value)               (SLCDC_SMR0_LCD20_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD20_Pos)) /* Assignment of value for LCD20 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD21(value)               (SLCDC_SMR0_LCD21_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD21_Pos)) /* Assignment of value for LCD21 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD22(value)               (SLCDC_SMR0_LCD22_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD22_Pos)) /* Assignment of value for LCD22 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD23(value)               (SLCDC_SMR0_LCD23_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD23_Pos)) /* Assignment of value for LCD23 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD24(value)               (SLCDC_SMR0_LCD24_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD24_Pos)) /* Assignment of value for LCD24 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD25(value)               (SLCDC_SMR0_LCD25_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD25_Pos)) /* Assignment of value for LCD25 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD26(value)               (SLCDC_SMR0_LCD26_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD26_Pos)) /* Assignment of value for LCD26 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD27(value)               (SLCDC_SMR0_LCD27_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD27_Pos)) /* Assignment of value for LCD27 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD28(value)               (SLCDC_SMR0_LCD28_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD28_Pos)) /* Assignment of value for LCD28 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD29(value)               (SLCDC_SMR0_LCD29_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD29_Pos)) /* Assignment of value for LCD29 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD30(value)               (SLCDC_SMR0_LCD30_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD30_Pos)) /* Assignment of value for LCD30 in the SLCDC_SMR0 register */
...
#define SLCDC_SMR0_LCD31(value)               (SLCDC_SMR0_LCD31_Msk & (_UINT32_(value) << SLCDC_SMR0_LCD31_Pos)) /* Assignment of value for LCD31 in the SLCDC_SMR0 register */
...
#define SLCDC_WPMR_WPEN(value)                (SLCDC_WPMR_WPEN_Msk & (_UINT32_(value) << SLCDC_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the SLCDC_WPMR register */
...
#define SLCDC_WPMR_WPITEN(value)              (SLCDC_WPMR_WPITEN_Msk & (_UINT32_(value) << SLCDC_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the SLCDC_WPMR register */
...
#define SLCDC_WPMR_WPCREN(value)              (SLCDC_WPMR_WPCREN_Msk & (_UINT32_(value) << SLCDC_WPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the SLCDC_WPMR register */
...
#define SLCDC_WPMR_WPKEY(value)               (SLCDC_WPMR_WPKEY_Msk & (_UINT32_(value) << SLCDC_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the SLCDC_WPMR register */
...
#define SLCDC_LMEMR0_LPIXEL(value)            (SLCDC_LMEMR0_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR0_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR0 register */
...
#define SLCDC_LMEMR1_LPIXEL(value)            (SLCDC_LMEMR1_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR1_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR1 register */
...
#define SLCDC_LMEMR2_LPIXEL(value)            (SLCDC_LMEMR2_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR2_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR2 register */
...
#define SLCDC_LMEMR3_LPIXEL(value)            (SLCDC_LMEMR3_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR3_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR3 register */
...
#define SLCDC_LMEMR4_LPIXEL(value)            (SLCDC_LMEMR4_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR4_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR4 register */
...
#define SLCDC_LMEMR5_LPIXEL(value)            (SLCDC_LMEMR5_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR5_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR5 register */
...
#define SLCDC_LMEMR6_LPIXEL(value)            (SLCDC_LMEMR6_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR6_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR6 register */
...
#define SLCDC_LMEMR7_LPIXEL(value)            (SLCDC_LMEMR7_LPIXEL_Msk & (_UINT32_(value) << SLCDC_LMEMR7_LPIXEL_Pos)) /* Assignment of value for LPIXEL in the SLCDC_LMEMR7 register */
#define SLCDC_LMEMR7_Msk                      _UINT32_(0xFFFFFFFF)                                 /* (SLCDC_LMEMR7) Register Mask  */


/* SLCDC register offsets definitions */
