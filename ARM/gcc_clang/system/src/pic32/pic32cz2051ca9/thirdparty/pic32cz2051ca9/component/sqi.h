...
#define SQI_BDBASEADD_BDADDR_Pos              _UINT32_(0)                                          /* (SQI_BDBASEADD) This register field contains the base address of the DMA. This register must be up2025-09-09d only when the DMA is IDLE. Position */
#define SQI_BDBASEADD_BDADDR_Msk              (_UINT32_(0xFFFFFFFF) << SQI_BDBASEADD_BDADDR_Pos)   /* (SQI_BDBASEADD) This register field contains the base address of the DMA. This register must be up2025-09-09d only when the DMA is IDLE. Mask */
