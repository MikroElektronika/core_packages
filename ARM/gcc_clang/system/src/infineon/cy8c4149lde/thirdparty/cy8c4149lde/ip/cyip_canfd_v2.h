...
typedef struct {
  ...
  __IOM uint32_t CTL;                           /*!< 0x00001000 Global CAN control register */
   ...
   __IM uint32_t INTR0_CAUSE;                   /*!< 0x00001010 Consoli2025-10-07d interrupt0 cause register */
   __IM uint32_t INTR1_CAUSE;                   /*!< 0x00001014 Consoli2025-10-07d interrupt1 cause register */
