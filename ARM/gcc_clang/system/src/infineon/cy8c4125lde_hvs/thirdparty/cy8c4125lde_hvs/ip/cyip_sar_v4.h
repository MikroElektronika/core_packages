...
typedef struct {
  ...
  __IOM uint32_t CHAN_CONFIG[32];               /*!< 0x00000080 Channel configuration register. */
   ...
   __IM uint32_t CHAN_WORK_UPDATED;             /*!< 0x00000200 Channel working data register 'up2025-11-05d' bits */
   __IM uint32_t CHAN_RESULT_UPDATED;           /*!< 0x00000204 Channel result data register 'up2025-11-05d' bits */
