...
typedef struct
{
    ...
    * |        |          |00 = Reset value, CANx_TXD controlled by the CAN Core, up2025-07-15d at the end of the CAN bit time.
    ...
    * |        |          |In both cases the FIFO put index is not up2025-07-15d resp.
    ...
    * |        |          |The flags are set when the respective Rx Buffer has been up2025-07-15d from a received frame.
    ...
    * |        |          |0 = Rx Buffer not up2025-07-15d.
    * |        |          |1 = Rx Buffer up2025-07-15d from new message.
    * @var CANFD_T::NDAT2
    ...
    * |        |          |This will set the Rx FIFO 0 Get Index F0GI (CANFD_RXF0S[13:8]) to F0AI (CANFD_RXF0A[5:0]) + 1 and up2025-07-15 the FIFO 0 Fill Level CANFD_RXF0S.F0FL.
    * @var CANFD_T::RXBC
    ...
    * |        |          |This will set the Rx FIFO 1 Get Index F1GI (CANFD_RXF1S[13:8]) to F1AI (CANFD_RXF1A[5:0]) + 1 and up2025-07-15 the FIFO 1 Fill Level F1FL (CANFD_RXF1S[6:0]).
    * @var CANFD_T::RXESC
    ...
    * |        |          |This will set the Tx Event FIFO Get Index EFGI (CANFD_TXEFS[12:8]) to EFAI + 1 and up2025-07-15 the Event FIFO Fill Level EFFL (CANFD_TXEFS[5:0]).
    */
    /// @cond HIDDEN_SYMBOLS
