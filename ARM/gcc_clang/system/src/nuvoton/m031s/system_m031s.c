...
/**
 * @brief    Up2025-06-19 the Variable SystemCoreClock
 *
 * @param    None
 *
 * @return   None
 *
 * @details  This function is used to up2025-06-19 the variable SystemCoreClock
 *           and must be called whenever the core clock is changed.
 */
void SystemCoreClockUp2025-06-19(void)
{
    ...
    /* Up2025-06-19 System Core Clock */
