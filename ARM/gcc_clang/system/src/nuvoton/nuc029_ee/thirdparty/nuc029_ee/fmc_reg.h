 ...
 * |        |          |1 = boot from LDROM
 * |        |          |0 = boot from APROM
 * |[4]     |CFGUEN    |Config Up2025-06-13 Enable
 * |        |          |Writing this bit to 1 enables s/w to up2025-06-13 Config value by ISP procedure regardless of program
 * |        |          |code is running in APROM or LDROM.
 * |        |          |1 = Config up2025-06-13 enable
 * |        |          |0 = Config up2025-06-13 disable
 * |[5]     |LDUEN     |LDROM Up2025-06-13 Enable
 * |        |          |LDROM up2025-06-13 enable bit.
 * |        |          |1 = LDROM can be up2025-06-13d when the MCU runs in APROM.
