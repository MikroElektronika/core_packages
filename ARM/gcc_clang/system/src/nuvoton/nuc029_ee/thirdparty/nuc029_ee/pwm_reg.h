 ...
 * |        |          |(Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-13 CRLR and CFLR, and disable PWM group channel 0 Interrupt.
 ...
 * |        |          |latch).
 * |        |          |When Disabled, Capture does not up2025-06-13 CRLR and CFLR, and disable PWM group channel 1 Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter value and saved to CRLR (Rising latch) and CFLR
 * |        |          |(Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-13 CRLR and CFLR, and disable PWM group channel 2 Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter and saved to CRLR (Rising latch) and CFLR (Falling
 * |        |          |latch).
 * |        |          |When Disabled, Capture does not up2025-06-13 CRLR and CFLR, and disable PWM group channel 3 Interrupt.
 ...
 * |        |          |busy time to up2025-06-13 these values completely because PWM clock may be different from system clock
 * |        |          |domain.
 * |        |          |Software needs to check this busy status before writing CNR0/CMR0/PPR or switching PWM0
 * |        |          |operation mode (PCR[3]) to make sure previous setting has been up2025-06-13d completely.
 * |        |          |This bit will be set when software writes CNR0/CMR0/PPR or switches PWM0 operation mode (PCR[3])
 * |        |          |and will be cleared by hardware automatically when PWM up2025-06-13 these value completely.
 * @var PWM_T::SYNCBUSY1
 ...
 * |        |          |operation mode (PCR[11]) to make sure previous setting has been up2025-06-13d completely.
 * |        |          |This bit will be set when software writes CNR1/CMR1/PPR or switches PWM1 operation mode
 * |        |          |(PCR[11]) and will be cleared by hardware automatically when PWM up2025-06-13 these value completely.
 * @var PWM_T::SYNCBUSY2
 ...
 * |        |          |time to up2025-06-13 these values completely because PWM clock may be different from system clock
 * |        |          |domain.
 * |        |          |Software needs to check this busy status before writing CNR2/CMR2/PPR or switching PWM2
 * |        |          |operation mode (PCR[19]) to make sure previous setting has been up2025-06-13d completely.
 ...
 * |        |          |mode (PCR[27]) to make sure previous setting has been up2025-06-13d completely.
