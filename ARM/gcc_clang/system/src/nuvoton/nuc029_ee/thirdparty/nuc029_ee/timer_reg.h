 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-13d continuously with the 24-bit
 ...
 * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-06-13d continuously to monitor 24-bit up
 * |        |          |counter value.
 * @var TIMER_T::TCAP
