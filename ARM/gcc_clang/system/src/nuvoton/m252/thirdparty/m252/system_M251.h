...
/**
 * @brief    Up2025-08-12 the Variable SystemCoreClock
 *
 * @details  This function is used to up2025-08-12 the variable SystemCoreClock
 *           and must be called whenever the core clock is changed.
 */
extern void SystemCoreClockUp2025-08-12(void);
