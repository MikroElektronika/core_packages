...
/**
 * @brief      Enable LDROM Up2025-08-12 Function
 *
 *
 *
 * @details    This function will set LDUEN bit of ISPCTL control register to enable LDROM up2025-08-12 function.
 *             User needs to set LDUEN bit before they can up2025-08-12 LDROM.
 *
 */
#define FMC_ENABLE_LD_UPDATE()    (FMC->ISPCTL |=  FMC_ISPCTL_LDUEN_Msk)  /*!< Enable LDROM Up2025-08-12 Function   */

/**
 * @brief      Disable LDROM Up2025-08-12 Function
 *
 *
 *
 * @details    This function will set ISPEN bit of ISPCTL control register to disable LDROM up2025-08-12 function.
 *
 */
#define FMC_DISABLE_LD_UPDATE()   (FMC->ISPCTL &= ~FMC_ISPCTL_LDUEN_Msk)  /*!< Disable LDROM Up2025-08-12 Function  */

/**
 * @brief      Enable User Configuration Up2025-08-12 Function
 *
 *
 *
 * @details    This function will set CFGUEN bit of ISPCTL control register to enable User Configuration up2025-08-12 function.
 *             User needs to set CFGUEN bit before they can up2025-08-12 User Configuration area.
 *
 */
#define FMC_ENABLE_CFG_UPDATE()   (FMC->ISPCTL |=  FMC_ISPCTL_CFGUEN_Msk) /*!< Enable CONFIG Up2025-08-12 Function  */

/**
 * @brief      Disable User Configuration Up2025-08-12 Function
 *
 *
 *
 * @details    This function will clear CFGUEN bit of ISPCTL control register to disable User Configuration up2025-08-12 function.
 *
 */
#define FMC_DISABLE_CFG_UPDATE()  (FMC->ISPCTL &= ~FMC_ISPCTL_CFGUEN_Msk) /*!< Disable CONFIG Up2025-08-12 Function */


/**
 * @brief      Enable APROM Up2025-08-12 Function
 *
 *
 *
 * @details    This function will set APUEN bit of ISPCTL control register to enable APROM up2025-08-12 function.
 *             User needs to set APUEN bit before they can up2025-08-12 APROM in APROM boot mode.
 *
 */
#define FMC_ENABLE_AP_UPDATE()    (FMC->ISPCTL |=  FMC_ISPCTL_APUEN_Msk)  /*!< Enable APROM Up2025-08-12 Function   */

/**
 * @brief      Disable APROM Up2025-08-12 Function
 *
 *
 *
 * @details    This function will clear APUEN bit of ISPCTL control register to disable APROM up2025-08-12 function.
 *
 */
#define FMC_DISABLE_AP_UPDATE()   (FMC->ISPCTL &= ~FMC_ISPCTL_APUEN_Msk)  /*!< Disable APROM Up2025-08-12 Function  */
...
/**
  ...
  *
  *
  * @details  Disable APROM up2025-08-12 function will forbid APROM programming when boot form APROM.
  *           APROM up2025-08-12 is default to be disable.
  *
  */
#define FMC_DisableAPUp2025-08-12()        (FMC->ISPCTL &= ~FMC_ISPCTL_APUEN_Msk)     /*!< Disable AP up2025-08-12 */
...
/**
  ...
  *
  *
  * @details  Disable User Configuration up2025-08-12 function will forbid User Configuration programming.
  *           User Configuration up2025-08-12 is default to be disable.
  */
#define FMC_DisableConfigUp2025-08-12()     (FMC->ISPCTL &= ~FMC_ISPCTL_CFGUEN_Msk)   /*!< Disable config up2025-08-12 */
...
/**
  ...
  * @details  Disable LDROM up2025-08-12 function will forbid LDROM programming.
  *           LDROM up2025-08-12 is default to be disable.
  */
#define FMC_DisableLDUp2025-08-12()          (FMC->ISPCTL &= ~FMC_ISPCTL_LDUEN_Msk)   /*!< Disable LD up2025-08-12 */
...
/**
  ...
  *
  */
#define FMC_EnableAPUp2025-08-12()           (FMC->ISPCTL |= FMC_ISPCTL_APUEN_Msk)    /*!< Enable AP up2025-08-12 */
...
/**
  ...
  *
  */
#define FMC_EnableConfigUp2025-08-12()        (FMC->ISPCTL |= FMC_ISPCTL_CFGUEN_Msk)   /*!< Enable config up2025-08-12 */
...
/**
  ...
  *
  */
#define FMC_EnableLDUp2025-08-12()             (FMC->ISPCTL |= FMC_ISPCTL_LDUEN_Msk)   /*!< Enable LD up2025-08-12 */
