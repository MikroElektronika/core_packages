...
typedef struct {
     ...
     * |        |          |0 = Shutter Disabled.
     * |        |          |1 = Shutter Enabled.
     * |[20]    |UPDATE    |Up2025-06-11 Register At New Frame
     * |        |          |0 = Up2025-06-11 register at new frame Disabled.
     * |        |          |1 = Up2025-06-11 register at new frame Enabled (Auto clear to 0 when register up2025-06-11d).
