...
typedef struct
{
     ...
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
     * |[3]     |APUEN     |APROM Up2025-06-13 Enable Bit (Write Protect)
     * |        |          |0 = APROM cannot be up2025-06-13d when the chip runs in APROM.
     * |        |          |1 = APROM can be up2025-06-13d when the chip runs in APROM.
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
     * |[4]     |CFGUEN    |CONFIG Up2025-06-13 Enable Bit (Write Protect)
     * |        |          |0 = CONFIG cannot be up2025-06-13d.
     * |        |          |1 = CONFIG can be up2025-06-13d.
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
     * |[5]     |LDUEN     |LDROM Up2025-06-13 Enable Bit (Write Protect)
     * |        |          |LDROM up2025-06-13 enable bit.
     * |        |          |0 = LDROM cannot be up2025-06-13d.
     * |        |          |1 = LDROM can be up2025-06-13d.
     * |        |          |Note: This bit is write protected. Refer to the SYS_REGLCTL register.
