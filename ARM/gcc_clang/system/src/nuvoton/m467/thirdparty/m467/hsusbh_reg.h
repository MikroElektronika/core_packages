...
typedef struct
{
     ...
     * |        |          |This field indicates, relative to the current position of the executing host controller, where software can reliably up2025-06-13 the isochronous schedule.
