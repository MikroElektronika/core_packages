...
/**
  ...
  * @details    This macro get EQEI pulse counter hold value, which is up2025-06-13d with counter value in hold counter value control.
  * \hideinitializer
  */
...
/**
  ...
  * @details    This macro get EQEI pulse counter index latch value, which is up2025-06-13d with counter value when the index is detected.
  * \hideinitializer
  */
...
/**
  ...
  * @return     EQEI pulse counter index latch value
  * @details    This macro set EQEI pulse counter index latch value, which is up2025-06-13d with counter value when the index is detected.
  * \hideinitializer
  */
