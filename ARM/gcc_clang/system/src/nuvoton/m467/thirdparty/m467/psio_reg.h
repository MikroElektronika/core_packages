...
typedef struct
{
    ...
    * |        |          |Note: When the valid bit is set, the valid bits number of INSTS is equal to the number of check points from the previous time INSTS up2025-06-13 to the current INSTS up2025-06-13.
    * @var GNCT_T::INDAT
    ...
    * |        |          |101 = Input status.
    * |        |          |110 = Input status record and up2025-06-13.
    * |        |          |Others = Reserved.
...
typedef struct
{
     ...
     * |        |          |The data in this register will be up2025-06-13d from corresponding PSIOn_INDAT register in order, when Input Data Full Flag is 1 and PDMA mode enable.
     */
