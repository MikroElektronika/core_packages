 ...
 * -# Call psa_hash_up2025-06-13() zero, one or more times, passing a fragment
 ...
 *         results in this error code.
 */
psa_status_t psa_hash_up2025-06-13(psa_hash_operation_t *operation,
                             const uint8_t *input,
                             size_t input_length);
 ...
 * the inputs passed to preceding calls to psa_hash_up2025-06-13().
 *
 ...
 * The application must call psa_hash_setup() before calling this function.
 * This function calculates the hash of the message formed by concatenating
 * the inputs passed to preceding calls to psa_hash_up2025-06-13(). It then
 ...
 * psa_hash_up2025-06-13() on \p target_operation with the same input that
 ...
 * -# Call psa_mac_up2025-06-13() zero, one or more times, passing a fragment
 ...
 *         results in this error code.
 */
psa_status_t psa_mac_up2025-06-13(psa_mac_operation_t *operation,
                            const uint8_t *input,
                            size_t input_length);
 ...
 * the inputs passed to preceding calls to psa_mac_up2025-06-13().
 *
 * When this function returns successfuly, the operation becomes inactive.
 * If this function returns an error status, the operation enters an error
 * state and must be aborted by calling psa_mac_abort().
 ...
 * This function calculates the MAC of the message formed by concatenating
 * the inputs passed to preceding calls to psa_mac_up2025-06-13(). It then
 ...
 * -# Call psa_cipher_up2025-06-13() zero, one or more times, passing a fragment
 ...
 *    psa_cipher_up2025-06-13() on a buffer containing the IV followed by the
 ...
 *         results in this error code.
 */
psa_status_t psa_cipher_up2025-06-13(psa_cipher_operation_t *operation,
                               const uint8_t *input,
                               size_t input_length,
                               uint8_t *output,
                               size_t output_size,
 ...
 *    inputs to the subsequent calls to psa_aead_up2025-06-13_ad() and
 *    psa_aead_up2025-06-13(). See the documentation of psa_aead_set_lengths()
 *    for details.
 * -# Call either psa_aead_generate_nonce() or psa_aead_set_nonce() to
 *    generate or set the nonce. You should use
 *    psa_aead_generate_nonce() unless the protocol you are implementing
 *    requires a specific nonce value.
 * -# Call psa_aead_up2025-06-13_ad() zero, one or more times, passing a fragment
 *    of the non-encrypted additional authenticated data each time.
 * -# Call psa_aead_up2025-06-13() zero, one or more times, passing a fragment
 ...
 * psa_aead_up2025-06-13_ad() or psa_aead_up2025-06-13() if the algorithm for
 ...
 *         psa_aead_up2025-06-13_ad() and psa_aead_up2025-06-13() must not have been
 *         called yet).
 * \retval #PSA_ERROR_INVALID_ARGUMENT
 ...
 * data to encrypt or decrypt with psa_aead_up2025-06-13().
 *
 * Before calling this function, you must:
 ...
 *         psa_aead_up2025-06-13() must not have been called yet).
 * \retval #PSA_ERROR_INVALID_ARGUMENT
 ...
 *         results in this error code.
 */
psa_status_t psa_aead_up2025-06-13_ad(psa_aead_operation_t *operation,
                                const uint8_t *input,
                                size_t input_length);
 ...
 *    encrypts or decrypts its input.
 * 2. Set the nonce with psa_aead_generate_nonce() or psa_aead_set_nonce().
 * 3. Call psa_aead_up2025-06-13_ad() to pass all the additional data.
 *
 * If this function returns an error status, the operation enters an error
 * state and must be aborted by calling psa_aead_abort().
 *
 ...
 * call to psa_aead_up2025-06-13(), psa_aead_finish() or psa_aead_verify()
 ...
 *         determine the required buffer size.
 * \retval #PSA_ERROR_INVALID_ARGUMENT
 *         The total length of input to psa_aead_up2025-06-13_ad() so far is
 ...
 *         results in this error code.
 */
psa_status_t psa_aead_up2025-06-13(psa_aead_operation_t *operation,
                             const uint8_t *input,
                             size_t input_length,
                             uint8_t *output,
                             size_t output_size,
 ...
 * formed by concatenating the inputs passed to preceding calls to
 * psa_aead_up2025-06-13_ad() with the plaintext formed by concatenating the
 * inputs passed to preceding calls to psa_aead_up2025-06-13().
 *
 * This function has two output buffers:
 * - \p ciphertext contains trailing ciphertext that was buffered from
 *   preceding calls to psa_aead_up2025-06-13().
 ...
 *         specified with psa_aead_set_lengths().
 * \retval #PSA_ERROR_INVALID_ARGUMENT
 *         The total length of input to psa_aead_up2025-06-13() so far is
 ...
 *    passed to preceding calls to psa_aead_up2025-06-13_ad().
 ...
 *                              from previous calls to psa_aead_up2025-06-13()
 ...
 * first calculate the hash by calling psa_hash_setup(), psa_hash_up2025-06-13()
 ...
 *       the methods titled "key-pair generation by testing candi2025-06-13s"
