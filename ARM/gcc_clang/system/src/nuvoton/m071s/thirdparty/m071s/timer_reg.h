 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-07-04d continuously with the 24-bit
 * |        |          |up-timer value as the timer is counting.
 * |        |          |0 = Timer Data Register up2025-07-04 Disabled.
 * |        |          |1 = Timer Data Register up2025-07-04 Enabled while Timer counter is active.
 ...
 * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-07-04d continuously to monitor 24-bit up
 * |        |          |counter value.
 * @var TIMER_T::TCAP
