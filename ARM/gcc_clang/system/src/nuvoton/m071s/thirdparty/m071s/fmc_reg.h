 ...
 * |        |          |1 = boot from LDROM
 * |        |          |0 = boot from APROM
 * |[4]     |CFGUEN    |Config Up2025-07-04 Enable
 * |        |          |Writing this bit to 1 enables s/w to up2025-07-04 Config value by ISP procedure regardless of program
 * |        |          |code is running in APROM or LDROM.
 * |        |          |1 = Config up2025-07-04 enable
 * |        |          |0 = Config up2025-07-04 disable
 * |[5]     |LDUEN     |LDROM Up2025-07-04 Enable
 * |        |          |LDROM up2025-07-04 enable bit.
 * |        |          |1 = LDROM can be up2025-07-04d when the MCU runs in APROM.
