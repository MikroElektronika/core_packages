...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    /* Up2025-07-16 System Core Clock */
    SystemCoreClockUp2025-07-16();
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    /* Select HCLK clock source to PLL,
       ...
       and up2025-07-16 system core clock
...
/**
  ...
  *             User can use SystemCoreClockUp2025-07-16() to calculate CyclesPerUs automatically before using this function.
  */
