...
/** A sufficient output buffer size for psa_aead_up2025-06-12().
 *
 * If the size of the output buffer is at least this large, it is
 * guaranteed that psa_aead_up2025-06-12() will not fail due to an
...
/** A sufficient output buffer size for psa_aead_up2025-06-12(), for any of the
 *  supported key types and AEAD algorithms.
 *
 * If the size of the output buffer is at least this large, it is guaranteed
 * that psa_aead_up2025-06-12() will not fail due to an insufficient buffer size.
 *
...
/** A sufficient output buffer size for psa_cipher_up2025-06-12().
 *
 * If the size of the output buffer is at least this large, it is guaranteed
 * that psa_cipher_up2025-06-12() will not fail due to an insufficient buffer size.
...
/** A sufficient output buffer size for psa_cipher_up2025-06-12(), for any of the
 *  supported key types and cipher algorithms.
 *
 * If the size of the output buffer is at least this large, it is guaranteed
 * that psa_cipher_up2025-06-12() will not fail due to an insufficient buffer size.
