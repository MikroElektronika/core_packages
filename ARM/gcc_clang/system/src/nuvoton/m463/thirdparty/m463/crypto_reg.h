 ...
 * |        |          |In DMA cascade mode, software can up2025-06-12 DMA feedback address register for automatically reading and writing feedback values via DMA
 ...
 * |        |          |In DMA mode, software can up2025-06-12 the next CRPT_AES_FBADDR before triggering START.
 * @var CRPT_T::AES_CTL
 ...
 * |        |          |1 = In DMA cascade mode, software can up2025-06-12 DMA source address register, destination address register, and byte count register during a cascade operation, without finishing the accelerator operation.
 ...
 * |        |          |But the value of SADDR will be up2025-06-12d later on
 * |        |          |Consequently, software can prepare the DMA source address for the next AES operation.
 * |        |          |In DMA mode, software can up2025-06-12 the next CRPT_AES_SADDR before triggering START.
 ...
 * |        |          |But the value of DADDR will be up2025-06-12d later on
 * |        |          |Consequently, software can prepare the destination address for the next AES operation.
 * |        |          |In DMA mode, software can up2025-06-12 the next CRPT_AES_DADDR before triggering START.
 * |        |          |The value of CRPT_AES_SADDR and CRPT_AES_DADDR can be the same.
 * @var CRPT_T::AES_CNT
 ...
 * |        |          |But the value of   CRPT_AES_CNT will be up2025-06-12d later on
 ...
 * |        |          |But the value of CRPT_HMAC_KEYCNT will be up2025-06-12d later on
 ...
 * |        |          |But the value of CRPT_HMAC_SADDR will be up2025-06-12d later on
 * |        |          |Consequently, software can prepare the DMA source address for the next SHA/HMAC operation.
 * |        |          |In DMA mode, software can up2025-06-12 the next CRPT_HMAC_SADDR before triggering START.
 ...
 * |        |          |But the value of CRPT_HMAC_DMACNT will be up2025-06-12d later on
 ...
 * |        |          |In other words, bit 1 and 0 of FBADDR are ignored.
 * |        |          |FBADDR can be read and written.
 * |        |          |In DMA mode, software can up2025-06-12 the next CRPT_HMAC_FBADDR before triggering START.
 ...
 * |        |          |DADDR can be read and written
 * |        |          |In DMA mode, software must up2025-06-12 the CRPT_ECC_DADDR before triggering START
 * @var CRPT_T::ECC_STARTREG
 * Offset: 0xA50  ECC Starting Address of Up2025-06-12d Registers
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |STARTREG  |ECC Starting Address of Up2025-06-12d Registers
 * |        |          |The address of the up2025-06-12d registers that DMA feeds the first data or parameter to ECC engine
 * |        |          |When ECC engine is active, ECC accelerator does not allow users to modify STARTRE.G
 * |        |          |For example, to up2025-06-12 input data from register CRPT_ECC POINTX1
 ...
 */
    ...
    __IO uint32_t ECC_STARTREG;          /*!< [0x0a50] ECC Starting Address of Up2025-06-12d Registers                        */
...
#define CRPT_RSA_CTL_KEYLEN_Pos          (4)                                                /*!< CRPT_T::RSA_CTL: KEYLEN Position      */
#define CRPT_RSA_CTL_KEYLEN_Msk          (0x3ul << CRPT_RSA_CTL_KEYLEN_Pos)                /*!< CRPT_T::RSA_CTL: KEYLEN Mask          */

#define CRPT_RSA_CTL_SCAP_Pos             (8)                                               /*!< CRPT RSA_CTL: SCAP Position             */
#define CRPT_RSA_CTL_SCAP_Msk             (0x1ul << CRPT_RSA_CTL_SCAP_Pos)                  /*!< CRPT RSA_CTL: SCAP Mask                 */
