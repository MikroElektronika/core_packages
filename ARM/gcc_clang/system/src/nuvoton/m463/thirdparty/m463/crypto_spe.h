...
#define psa_cipher_up2025-06-12 \
        PSA_FUNCTION_NAME(psa_cipher_up2025-06-12)
...
#define psa_hash_up2025-06-12 \
        PSA_FUNCTION_NAME(psa_hash_up2025-06-12)
...
#define psa_mac_up2025-06-12 \
        PSA_FUNCTION_NAME(psa_mac_up2025-06-12)
