...
typedef struct
{
     ...
     * |        |          |0 = PERIOD will load to PBUF at the end point of each period
     * |        |          |CMP will load to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMP will load to PBUF and CMPBUF immediately when software up2025-06-12 PERIOD/CMP.
     ...
     * |        |          |0 = Capture function Disabled. EPWM_RCAPDATn/EPWM_FCAPDATn register will not be up2025-06-12d.
