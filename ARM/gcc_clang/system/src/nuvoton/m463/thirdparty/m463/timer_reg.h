...
typedef struct
{
     ...
     * |        |          |Note: Up2025-06-12 prescale counter value will reset internal 8-bit prescale counter and 24-bit up counter value.
     ...
     * |        |          |When user up2025-06-12s CMPDAT while timer is running in periodic mode,
     * |        |          |CNT will be reset to default value.
     * |        |          |1 = The behavior selection in periodic mode is Enabled.
     * |        |          |When user up2025-06-12 CMPDAT while timer is running in periodic mode, the limitations as bellows list,
     * |        |          |If up2025-06-12d CMPDAT value > CNT, CMPDAT will be up2025-06-12d and CNT keep running continually.
     * |        |          |If up2025-06-12d CMPDAT value = CNT, timer time-out interrupt will be asserted immediately.
     * |        |          |If up2025-06-12d CMPDAT value < CNT, CNT will be reset to default value.
     ...
     * |        |          |1 = PERIOD/CMP will load to PBUF/CMPBUF immediately when user up2025-06-12 PERIOD/CMP.
