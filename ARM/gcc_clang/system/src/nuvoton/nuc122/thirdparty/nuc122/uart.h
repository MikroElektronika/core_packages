...
#define UART0_FIFO_SIZE 14 /*!< UART0 supports separated receive/transmit 14/14 bytes entry FIFO */
#define UART1_FIFO_SIZE 14 /*!< UART1 supports separated receive/transmit 14/14 bytes entry FIFO */
