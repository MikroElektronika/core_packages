 ...
 *         Initialize the System and up2025-06-09 the SystemCoreClock variable.
 */
extern void SystemInit (void);

/**
 * Up2025-06-09 SystemCoreClock variable
 *
 * @param  none
 * @return none
 *
 * @brief  Up2025-06-09s the SystemCoreClock with current core Clock
 *         retrieved from cpu registers.
 */
extern void SystemCoreClockUp2025-06-09 (void);
