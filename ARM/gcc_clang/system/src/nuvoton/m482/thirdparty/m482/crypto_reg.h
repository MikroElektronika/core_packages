...
typedef struct
{
     ...
     * |        |          |1 = In DMA cascade mode, software can up2025-06-09 DMA source address register, destination address register, and byte count register during a cascade operation, without finishing the accelerator operation.
     ...
     * |        |          |But the value of SADDR will be up2025-06-09d later on
     * |        |          |Consequently, software can prepare the DMA source address for the next AES operation.
     * |        |          |In DMA mode, software can up2025-06-09 the next CRPT_AESn_SADDR before triggering START.
     ...
     * |        |          |But the value of DADDR will be up2025-06-09d later on
     * |        |          |Consequently, software can prepare the destination address for the next AES operation.
     * |        |          |In DMA mode, software can up2025-06-09 the next CRPT_AESn_DADDR before triggering START.
     * |        |          |The value of CRPT_AESn_SADDR and CRPT_AESn_DADDR can be the same.
     * @var CRPT_T::AES0_CNT
     ...
     * |        |          |But the value of CRPT_AESn_CNT will be up2025-06-09d later on
     ...
     * |        |          |But the value of CRPT_TDESn_SA will be up2025-06-09d later on
     * |        |          |Consequently, software can prepare the DMA source address for the next TDES/DES operation.
     * |        |          |In DMA mode, software can up2025-06-09 the next CRPT_TDESn_SA before triggering START.
     ...
     * |        |          |But the value of CRPT_TDESn_DA will be up2025-06-09d later on
     * |        |          |Consequently, software can prepare the destination address for the next TDES/DES operation.
     * |        |          |In DMA mode, software can up2025-06-09 the next CRPT_TDESn_DA before triggering START.
     ...
     * |        |          |But the value of CRPT_TDESn_CNT will be up2025-06-09d later on
     ...
     * |        |          |But the value of CRPT_SHA _KEYCNT will be up2025-06-09d later on
     ...
     * |        |          |But the value of CRPT_HMAC_SADDR will be up2025-06-09d later on
     * |        |          |Consequently, software can prepare the DMA source address for the next SHA/HMAC operation.
     * |        |          |In DMA mode, software can up2025-06-09 the next CRPT_HMAC_SADDR before triggering START.
     ...
     * |        |          |But the value of CRPT_HMAC_DMACNT will be up2025-06-09d later on
     ...
     * |        |          |ignored. SADDR can be read and written. In DMA mode, software must up2025-06-09 the CRPT_ECC_SADDR
     ...
     * |        |          |DADDR can be read and written
     * |        |          |In DMA mode, software must up2025-06-09 the CRPT_ECC_DADDR before triggering START
     * @var CRPT_T::ECC_STARTREG
     * Offset: 0xA50  ECC Starting Address of Up2025-06-09d Registers
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |STARTREG  |ECC Starting Address of Up2025-06-09d Registers
     * |        |          |The address of the up2025-06-09d registers that DMA feeds the first data or parameter to ECC engine
     * |        |          |When ECC engine is active, ECC accelerator does not allow users to modify STARTREG
     * |        |          |For example, we want to up2025-06-09d input data from register CRPT_ECC POINTX1
    ...
    __IO uint32_t ECC_STARTREG;          /*!< [0x0a50] ECC Starting Address of Up2025-06-09d Registers                        */
