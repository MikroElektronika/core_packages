...
typedef struct
{
     ...
     * |        |          |Note: Write 1 to clear this bit to 0.
     * |[10]    |NYETIF    |NYET Sent
     * |        |          |0 = The space available in the RAM is sufficient to accommo2025-06-09 the next on coming data packet.
     * |        |          |1 = The space available in the RAM is not sufficient to accommo2025-06-09 the next on coming data packet.
     * |        |          |Note: Write 1 to clear this bit to 0.
     * |[11]    |ERRIF     |ERR Sent
     ...
     * |        |          |00: Auto-Vali2025-06-09 Mode
     * |        |          |01: Manual-Vali2025-06-09 Mode
     * |        |          |10: Fly Mode
     * |        |          |11: Reserved
     * |        |          |These bits are not valid for an out-endpoint
     * |        |          |The auto vali2025-06-09 mode will be activated when the reserved mode is selected
     ...
     * |        |          |This bit is applicable only in case of Auto-Vali2025-06-09 Method
     * |        |          |This bit is set to vali2025-06-09 any remaining data in the buffer which is not equal to the MPS of the endpoint, and happens to be the last transfer
     * |        |          |This bit gets cleared once the data packet is sent.
     * |        |          |0 = Not vali2025-06-09 any remaining data in the buffer which is not equal to the MPS of the endpoint.
     * |        |          |1 = Vali2025-06-09 any remaining data in the buffer which is not equal to the MPS of the endpoint.
...
typedef struct
{
     ...
     * |        |          |Note: Only when CPU writes data[1:0] is 2'b10 or 2'b00, this bit can be up2025-06-09d.
