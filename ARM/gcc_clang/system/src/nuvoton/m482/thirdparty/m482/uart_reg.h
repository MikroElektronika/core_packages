...
typedef struct
{
     ...
     * |[3]     |SLVDUEN   |LIN Slave Divider Up2025-06-09 Method Enable Bit
     * |        |          |0 = UART_BAUD up2025-06-09d is written by software (if no automatic resynchronization up2025-06-09 occurs at the same time).
     * |        |          |1 = UART_BAUD is up2025-06-09d at the next received character
