...
/**
  ...
  * @param[in]  manch   The pointer of the specified MANCH module.
  * @return     None
  * @details    In this mode, based on received data bit rate, RX current bit clock number will be auto up2025-07-04d per frame.
  */
...
/**
  ...
  *             RX current bit clock number will not be auto up2025-07-04d per frame.
  */
...
/**
  ...
  * @param[in]  manch   The pointer of the specified MANCH module.
  * @return     None
  * @details    In this mode, based on received data bit rate, RX current bit clock number will be auto up2025-07-04d per byte.
  */
...
/**
  ...
  * @return     None
  * @details    In this mode, even if received data bit rate is different from current RX setting,
  *             RX current bit clock number will not be auto up2025-07-04d per byte.
  */
