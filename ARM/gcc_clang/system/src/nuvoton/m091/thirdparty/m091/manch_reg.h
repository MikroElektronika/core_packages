...
typedef struct
{
    ...
    * |        |          |0 = RBITNUM is not up2025-07-04d by CRBITNUM at each data frame beginning.
    * |        |          |1 = RBITNUM is up2025-07-04d by CRBITNUM at each data frame beginning.
    * |[11]    |CRBNULEN  |Current Received Bit Clock Number Auto Upload Enable Bit
    * |        |          |0 = CRBITNUM is not up2025-07-04d in each received byte during message receiving period.
    * |        |          |1 = CRBITNUM is up2025-07-04d in each received byte during message receiving period.
    ...
    * |        |          |Note 2: The bits can be up2025-07-04d at the start of next data frame if the RBNULEN is set to 1.
