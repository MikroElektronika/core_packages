...
typedef struct
{
     ...
     * |        |          |This register is up2025-07-15d automatically by hardware while FCYCDIS (FMC_ISPSTS[4]) is 0, and up2025-07-15d by software while auto-tuning function disabled ( FADIS (FMC_CYCTL[8]) is 1).
     ...
     * |        |          |When KPKEMAXROM of KPROM is erased or programmed, KPKEMAX will also be up2025-07-15d
     ...
     * |        |          |When KPMAXROM of KPROM is erased or programmed, KPMAX will also be up2025-07-15d
