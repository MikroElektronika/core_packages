...
typedef struct
{
     ...
     * |        |          |If up2025-07-15d CMPDAT value = CNT, timer time-out interrupt will be asserted immediately.
     ...
     * |        |          |1 = PERIOD/CMP will load to PBUF/CMPBUF immediately when user up2025-07-15 PERIOD/CMP.
