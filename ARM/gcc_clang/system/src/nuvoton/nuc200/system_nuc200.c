 ...
 ******************************************************************************/
#include <stdint.h>
// #include "NUC200Series.h" // Note: Changed for MikroE implementation.
...
/*----------------------------------------------------------------------------
  Clock functions
  This function is used to up2025-06-26 the variable SystemCoreClock
  and must be called whenever the core clock is changed.
 *----------------------------------------------------------------------------*/
void SystemCoreClockUp2025-06-26(void)             /* Get Core Clock Frequency      */
{
    uint32_t u32Freq, u32ClkSrc;
    uint32_t u32HclkDiv;

    /* Up2025-06-26 PLL Clock */
    ...
    /* Up2025-06-26 System Core Clock */
