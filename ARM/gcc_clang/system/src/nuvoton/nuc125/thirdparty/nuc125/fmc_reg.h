...
typedef struct
{
     ...
     * |[2]     |SPUEN     |SPROM Up2025-06-24 Enable (Write Protection)
     * |        |          |0 = SPROM cannot be up2025-06-24d.
     * |        |          |1 = SPROM can be up2025-06-24d.
     * |[3]     |APUEN     |APROM Up2025-06-24 Enable (Write Protection)
     * |        |          |0 = APROM cannot be up2025-06-24d when the chip runs in APROM.
     * |        |          |1 = APROM can be up2025-06-24d when the chip runs in APROM.
     * |[4]     |CFGUEN    |CONFIG Up2025-06-24 Enable (Write Protection)
     * |        |          |0 = CONFIG cannot be up2025-06-24d.
     * |        |          |1 = CONFIG can be up2025-06-24d.
     * |[5]     |LDUEN     |LDROM Up2025-06-24 Enable (Write Protection)
     * |        |          |LDROM up2025-06-24 enable bit.
     * |        |          |0 = LDROM cannot be up2025-06-24d.
     * |        |          |1 = LDROM can be up2025-06-24d.
