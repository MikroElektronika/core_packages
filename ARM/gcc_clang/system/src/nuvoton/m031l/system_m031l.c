...
/**
 * @brief    Up2025-06-09 the Variable SystemCoreClock
 *
 * @param    None
 *
 * @return   None
 *
 * @details  This function is used to up2025-06-09 the variable SystemCoreClock
 *           and must be called whenever the core clock is changed.
 */
void SystemCoreClockUp2025-06-09(void)
{
