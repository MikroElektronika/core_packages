...
typedef struct
{
     ...
     * |        |          |0 = When device responds NAK after receiving IN token, IN NAK status will not be up2025-07-02d to USBD_EPSTS0 register, so that the USB interrupt event will not be asserted.
     * |        |          |1 = IN NAK status will be up2025-07-02d to USBD_EPSTS0 register and the USB interrupt event will be asserted, when the device responds NAK after receiving IN token.
     * @var USBD_T::INTSTS
