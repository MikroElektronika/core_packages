...
typedef struct
{
     ...
     * |        |          |Note: This bit is write-protected. Refer to the SYS_REGLCTL register.
     * |[2]     |SPUEN     |SPROM Up2025-07-02 Enable Bit (Write Protection)
     * |        |          |0 = SPROM cannot be up2025-07-02d.
     * |        |          |1 = SPROM can be up2025-07-02d.
     * |        |          |Note: This bit is write-protected. Refer to the SYS_REGLCTL register.
     * |[3]     |APUEN     |APROM Up2025-07-02 Enable Bit (Write Protection)
     * |        |          |0 = APROM cannot be up2025-07-02d when the chip runs in APROM.
     * |        |          |1 = APROM can be up2025-07-02d when the chip runs in APROM.
     * |        |          |Note: This bit is write-protected. Refer to the SYS_REGLCTL register.
     * |[4]     |CFGUEN    |CONFIG Up2025-07-02 Enable Bit (Write Protection)
     * |        |          |0 = CONFIG cannot be up2025-07-02d.
     * |        |          |1 = CONFIG can be up2025-07-02d.
     * |        |          |Note: This bit is write-protected. Refer to the SYS_REGLCTL register.
     * |[5]     |LDUEN     |LDROM Up2025-07-02 Enable Bit (Write Protection)
     * |        |          |LDROM up2025-07-02 enable bit.
     * |        |          |0 = LDROM cannot be up2025-07-02d.
     * |        |          |1 = LDROM can be up2025-07-02d.
     * |        |          |Note: This bit is write-protected. Refer to the SYS_REGLCTL register.
