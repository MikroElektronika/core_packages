...
typedef struct
{
     ...
     * |        |          |If user writes WWDT_RLDCNT register when current WWDT counter value is larger than CMPDAT, WWDT reset signal will be generatec immediately.
     ...
     * |        |          |CNTDAT will be up2025-06-27d continuously to monitor 6-bit WWDT down counter value.
     */
