...
typedef struct
{
    ...
    * |        |          |Note 2: Refer to Figure 6.11-24 and Figure 6.11-25 for RS-485 function mode.
     ...
     * |[3]     |SLVDUEN   |LIN Slave Divider Up2025-06-27 Method Enable Bit
     * |        |          |0 = UART_BAUD up2025-06-27d is written by software (if no automatic resynchronization up2025-06-27 occurs at the same time).
     * |        |          |1 = UART_BAUD is up2025-06-27d at the next received character
