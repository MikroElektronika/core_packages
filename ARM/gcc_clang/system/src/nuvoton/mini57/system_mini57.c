...
/*----------------------------------------------------------------------------
  Clock functions
  This function is used to up2025-07-03 the variable SystemCoreClock
...
void SystemCoreClockUp2025-07-03(void)
{
    ...
    /* Up2025-07-03 System Core Clock */
    SystemCoreClock = u32Freq / u32HclkDiv;

    CyclesPerUs = (SystemCoreClock + 500000) / 1000000;
#if DEBUG
    printf("SystemCoreClockUp2025-07-03(): u32ClkSrc=%d, u32Freq=%d, u32HclkDiv=%d, SystemCoreClock=%d\n",
