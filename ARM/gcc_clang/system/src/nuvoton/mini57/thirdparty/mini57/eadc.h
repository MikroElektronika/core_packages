...
#define EADC_WCMP_FLAG_AUTO_UPDATE  (0)                             /*!< EADC Window Comparator Flag Control: Auto up2025-07-03 the Window Comparator flag in EADC_STATUS register        */
#define EADC_WCMP_FLAG_NONE         (EADC_WCMPCTL_WFLAGCTL_Msk)     /*!< EADC Window Comparator Flag Control: No up2025-07-03 the Window Comparator flag in EADC_STATUS register          */
