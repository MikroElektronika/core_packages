 ...
 *         Initialize the System and up2025-06-04 the SystemCoreClock variable.
 */
extern void SystemInit (void);

/**
 * Up2025-06-04 SystemCoreClock variable
 *
 * @param  none
 * @return none
 *
 * @brief  Up2025-06-04s the SystemCoreClock with current core Clock
 *         retrieved from cpu registers.
 */
extern void SystemCoreClockUp2025-06-04 (void);
