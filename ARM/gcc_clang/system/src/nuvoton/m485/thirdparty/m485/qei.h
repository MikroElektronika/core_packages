...
/**
  ...
  * @details    This macro get QEI pulse counter hold value, which is up2025-06-04d with counter value in hold counter value control.
  * \hideinitializer
  */
...
/**
  ...
  * @details    This macro get QEI pulse counter index latch value, which is up2025-06-04d with counter value when the index is detected.
  * \hideinitializer
  */
...
/**
  ...
  * @return     QEI pulse counter index latch value
  * @details    This macro set QEI pulse counter index latch value, which is up2025-06-04d with counter value when the index is detected.
  * \hideinitializer
  */
