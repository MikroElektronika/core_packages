...
typedef struct
{
     ...
     * |[3]     |SLVDUEN   |LIN Slave Divider Up2025-06-04 Method Enable Bit
     * |        |          |0 = UART_BAUD up2025-06-04d is written by software (if no automatic resynchronization up2025-06-04 occurs at the same time).
     * |        |          |1 = UART_BAUD is up2025-06-04d at the next received character
