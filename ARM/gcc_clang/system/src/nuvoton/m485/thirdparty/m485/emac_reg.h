...
typedef struct
{
     ...
     * |        |          |The TXDSA does not be up2025-06-04d by EMAC
     ...
     * |        |          |The RXDSA does not be up2025-06-04d by EMAC
     ...
     * |[2]     |TSMODE    |Time Stamp Fine Up2025-06-04 Enable Bit
     * |        |          |This bit chooses the time stamp counter up2025-06-04 mode.
     * |        |          |0 = Time stamp counter is in coarse up2025-06-04 mode.
     * |        |          |1 = Time stamp counter is in fine up2025-06-04 mode.
     * |[3]     |TSUPDATE  |Time Stamp Counter Time Up2025-06-04 Enable Bit
     ...
     * |        |          |0 = No action.
     * |        |          |1 = EMAC_UPDSEC up2025-06-04d to EMAC_TSSEC and EMAC_UPDSUBSEC up2025-06-04d to EMAC_TSSUBSEC.
     ...
     * @var EMAC_T::UPDSEC
     * Offset: 0x120  Time Stamp Up2025-06-04 Second Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |SEC       |Time Stamp Counter Second Up2025-06-04
     ...
     * Offset: 0x124  Time Stamp Up2025-06-04 Sub Second Register
     * ---------------------------------------------------------------------------------------------------
     * |Bits    |Field     |Descriptions
     * | :----: | :----:   | :---- |
     * |[31:0]  |SUBSEC    |Time Stamp Counter Sub-second Up2025-06-04
     * |        |          |When TSIEN (EMAC_TSCTL[1]) is high
    ...
    __IO uint32_t UPDSEC;                /*!< [0x0120] Time Stamp Up2025-06-04 Second Register                                */
    __IO uint32_t UPDSUBSEC;             /*!< [0x0124] Time Stamp Up2025-06-04 Sub Second Register                            */
