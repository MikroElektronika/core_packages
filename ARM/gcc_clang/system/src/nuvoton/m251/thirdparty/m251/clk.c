...
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    /* Up2025-08-11 System Core Clock */
    SystemCoreClockUp2025-08-11();
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    /* Select HCLK clock source to PLL,
       ...
       and up2025-08-11 system core clock
...
/**
  ...
  *             User can use SystemCoreClockUp2025-08-11() to calculate CyclesPerUs automatically before using this function.
  */
