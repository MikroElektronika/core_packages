...
typedef struct
{
     ...
     * |        |          |1 = PERIOD/CMPDAT will load to PBUF and CMPBUF immediately when software up2025-08-11 PERIOD/CMPDAT.
     ...
     * |        |          |0 = Capture function Disabled. RCAPDAT/FCAPDAT register will not be up2025-08-11d.
