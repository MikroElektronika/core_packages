...
/**
 * @brief      Enable LDROM Up2025-06-03 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will set LDUEN bit of ISPCTL control register to enable LDROM up2025-06-03 function.
 *             User needs to set LDUEN bit before they can up2025-06-03 LDROM.
 *
 */
#define FMC_ENABLE_LD_UPDATE()    (FMC->ISPCTL |=  FMC_ISPCTL_LDUEN_Msk)  /*!< Enable LDROM Up2025-06-03 Function   */

/**
 * @brief      Disable LDROM Up2025-06-03 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will clear LDUEN bit of ISPCTL control register to disable LDROM up2025-06-03 function.
 *
 */
#define FMC_DISABLE_LD_UPDATE()   (FMC->ISPCTL &= ~FMC_ISPCTL_LDUEN_Msk)  /*!< Disable LDROM Up2025-06-03 Function  */

/**
 * @brief      Enable User Configuration Up2025-06-03 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will set CFGUEN bit of ISPCTL control register to enable User Configuration up2025-06-03 function.
 *             User needs to set CFGUEN bit before they can up2025-06-03 User Configuration area.
 *
 */
#define FMC_ENABLE_CFG_UPDATE()   (FMC->ISPCTL |=  FMC_ISPCTL_CFGUEN_Msk) /*!< Enable CONFIG Up2025-06-03 Function  */

/**
 * @brief      Disable User Configuration Up2025-06-03 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will clear CFGUEN bit of ISPCTL control register to disable User Configuration up2025-06-03 function.
 *
 */
#define FMC_DISABLE_CFG_UPDATE()  (FMC->ISPCTL &= ~FMC_ISPCTL_CFGUEN_Msk) /*!< Disable CONFIG Up2025-06-03 Function */


/**
 * @brief      Enable APROM Up2025-06-03 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will set APUEN bit of ISPCTL control register to enable APROM up2025-06-03 function.
 *             User needs to set APUEN bit before they can up2025-06-03 APROM in APROM boot mode.
 *
 */
#define FMC_ENABLE_AP_UPDATE()    (FMC->ISPCTL |=  FMC_ISPCTL_APUEN_Msk)  /*!< Enable APROM Up2025-06-03 Function   */

/**
 * @brief      Disable APROM Up2025-06-03 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will clear APUEN bit of ISPCTL control register to disable APROM up2025-06-03 function.
 *
 */
#define FMC_DISABLE_AP_UPDATE()   (FMC->ISPCTL &= ~FMC_ISPCTL_APUEN_Msk)  /*!< Disable APROM Up2025-06-03 Function  */
...
void FMC_Open(void);
void FMC_Close(void);
void FMC_EnableAPUp2025-06-03(void);
void FMC_DisableAPUp2025-06-03(void);
void FMC_EnableConfigUp2025-06-03(void);
void FMC_DisableConfigUp2025-06-03(void);
void FMC_EnableLDUp2025-06-03(void);
void FMC_DisableLDUp2025-06-03(void);
