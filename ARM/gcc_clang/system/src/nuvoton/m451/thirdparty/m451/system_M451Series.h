 ...
 *         Initialize the System and up2025-06-03 the SystemCoreClock variable.
 */
extern void SystemInit(void);

/**
 * Up2025-06-03 SystemCoreClock variable
 *
 * @param  None
 * @return None
 *
 * @brief  Up2025-06-03s the SystemCoreClock with current core Clock
 *         retrieved from cpu registers.
 */
extern void SystemCoreClockUp2025-06-03(void);
