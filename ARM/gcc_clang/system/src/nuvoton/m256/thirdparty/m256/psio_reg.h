...
typedef struct
{
    ...
    * |        |          |Status input buffer
    * |        |          |(read clear)
    * |        |          |Note: When the valid bit is set, the valid bits number of INSTS is equal to the number of check points from the previous time INSTS up2025-07-16 to the current INSTS up2025-07-16.
    * @var GNCT_T::INDAT
    ...
    * |        |          |101 = input status.
    * |        |          |110 = input status record and up2025-07-16.
    * |        |          |Others = reserved.
...
typedef struct
{
     ...
     * |        |          |The data in this register will be up2025-07-16d from corresponding PSIOn_INDATA register in order, when Input Data Full Flag is 1 and PDMA mode enable.
     */
