...
typedef struct
{
     ...
     * |        |          |1 = In DMA cascade mode, software can up2025-07-16 DMA source address register, destination address register, and byte count register during a cascade operation, without finishing the accelerator operation.
     ...
     * |        |          |But the value of SADDR will be up2025-07-16d later on
     * |        |          |Consequently, software can prepare the DMA source address for the next AES operation.
     * |        |          |In DMA mode, software can up2025-07-16 the next CRPT_AES_SADDR before triggering START.
     ...
     * |        |          |But the value of DADDR will be up2025-07-16d later on
     * |        |          |Consequently, software can prepare the destination address for the next AES operation.
     * |        |          |In DMA mode, software can up2025-07-16 the next CRPT_AES_DADDR before triggering START.
     * |        |          |The value of CRPT_AES_SADDR and CRPT_AES_DADDR can be the same.
     * @var CRPT_T::AES_CNT
     ...
     * |        |          |But the value of CRPT_AESn_CNT will be up2025-07-16d later on
