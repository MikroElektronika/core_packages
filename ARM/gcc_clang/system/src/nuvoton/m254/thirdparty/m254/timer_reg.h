...
typedef struct
{
     ...
     * |        |          |When user up2025-07-16s CMPDAT while timer is running in periodic mode,
     * |        |          |CNT will be reset to default value.
     * |        |          |1 = The behavior selection in periodic mode is Enabled.
     * |        |          |When user up2025-07-16 CMPDAT while timer is running in periodic mode, the limitations as bellows list,
     * |        |          |If up2025-07-16d CMPDAT value > CNT, CMPDAT will be up2025-07-16d and CNT keep running continually.
     * |        |          |If up2025-07-16d CMPDAT value = CNT, timer time-out interrupt will be asserted.
     * |        |          |If up2025-07-16d CMPDAT value < CNT, CNT will be reset to default value.
