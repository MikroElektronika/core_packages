...
/**
 * @brief    Up2025-07-16 the Variable SystemCoreClock
 *
 * @details  This function is used to up2025-07-16 the variable SystemCoreClock
 *           and must be called whenever the core clock is changed.
 */
extern void SystemCoreClockUp2025-07-16(void);
