...
#define USB_EP_RSPCTL_MODE_AUTO         ((uint32_t)0x00000000)      /*!<Auto-Vali2025-06-16 Mode  \hideinitializer */
#define USB_EP_RSPCTL_MODE_MANUAL       ((uint32_t)0x00000002)      /*!<Manual-Vali2025-06-16 Mode  \hideinitializer */
...
void USBD_Up2025-06-16DeviceState(void);
