...
// #include "NUC505Series.h" // Note: Changed for MikroE implementation.
...
void SystemCoreClockUp2025-06-16 (void) @ "SystemCoreClockUp2025-06-16";    // Ensure this function can be initialized by copy.
#endif

/*----------------------------------------------------------------------------
  Clock functions
 *----------------------------------------------------------------------------*/
void SystemCoreClockUp2025-06-16 (void)            /* Get Core Clock Frequency      */
{
    ...
    /* Up2025-06-16 System Core Clock */
