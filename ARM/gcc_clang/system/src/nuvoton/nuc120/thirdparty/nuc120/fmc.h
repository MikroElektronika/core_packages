...
/**
 * @brief      Enable LDROM Up2025-07-02 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will set LDUEN bit of ISPCON control register to enable LDROM up2025-07-02 function.
 *             User needs to set LDUEN bit before they can up2025-07-02 LDROM.
 *
 */
...
/**
 * @brief      Disable LDROM Up2025-07-02 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will set ISPEN bit of ISPCON control register to disable LDROM up2025-07-02 function.
 *
 */
#define FMC_DISABLE_LD_UPDATE()   (FMC->ISPCON &= ~FMC_ISPCON_LDUEN_Msk)  /*!< Disable LDROM Up2025-07-02 Function  */



/**
 * @brief      Enable User Configuration Up2025-07-02 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will set CFGUEN bit of ISPCON control register to enable User Configuration up2025-07-02 function.
 *             User needs to set CFGUEN bit before they can up2025-07-02 User Configuration area.
 *
 */
#define FMC_ENABLE_CFG_UPDATE()   (FMC->ISPCON |=  FMC_ISPCON_CFGUEN_Msk)

/**
 * @brief      Disable User Configuration Up2025-07-02 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will clear CFGUEN bit of ISPCON control register to disable User Configuration up2025-07-02 function.
 *
 */
#define FMC_DISABLE_CFG_UPDATE()  (FMC->ISPCON &= ~FMC_ISPCON_CFGUEN_Msk)           /*!< Disable CONFIG Up2025-07-02 Function */


/**
 * @brief      Enable APROM Up2025-07-02 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will set APUEN bit of ISPCON control register to enable APROM up2025-07-02 function.
 *             User needs to set APUEN bit before they can up2025-07-02 APROM in APROM boot mode.
 *
 */
...
/**
 * @brief      Disable APROM Up2025-07-02 Function
 *
 * @param      None
 *
 * @return     None
 *
 * @details    This function will clear APUEN bit of ISPCON control register to disable APROM up2025-07-02 function.
 *
 */
#define FMC_DISABLE_AP_UPDATE()   (FMC->ISPCON &= ~FMC_ISPCON_APUEN_Msk)            /*!< Disable APROM Up2025-07-02 Function  */
...
extern void FMC_EnableAPUp2025-07-02(void);
extern void FMC_DisableAPUp2025-07-02(void);
extern void FMC_EnableConfigUp2025-07-02(void);
extern void FMC_DisableConfigUp2025-07-02(void);
extern void FMC_EnableLDUp2025-07-02(void);
extern void FMC_DisableLDUp2025-07-02(void);
