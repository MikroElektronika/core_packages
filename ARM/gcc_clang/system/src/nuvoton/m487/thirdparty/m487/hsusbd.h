...
#define HSUSBD_EP_RSPCTL_MODE_AUTO         ((uint32_t)0x00000000ul)      /*!<Auto-Vali2025-06-18 Mode  \hideinitializer */
#define HSUSBD_EP_RSPCTL_MODE_MANUAL       ((uint32_t)0x00000002ul)      /*!<Manual-Vali2025-06-18 Mode  \hideinitializer */
...
void HSUSBD_Up2025-06-18DeviceState(void);
