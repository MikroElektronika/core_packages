 ...
 *         Initialize the System and up2025-06-05 the SystemCoreClock variable.
 */
extern void SystemInit (void);

/**
 * Up2025-06-05 SystemCoreClock variable
 *
 * @param  none
 * @return none
 *
 * @brief  Up2025-06-05s the SystemCoreClock with current core Clock
 *         retrieved from cpu registers.
 */
extern void SystemCoreClockUp2025-06-05 (void);
