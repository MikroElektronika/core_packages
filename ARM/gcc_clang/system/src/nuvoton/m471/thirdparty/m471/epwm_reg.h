...
typedef struct
{
     ...
     * |        |          |0 = PERIOD will load to PBUF at the end point of each period
     * |        |          |CMPDAT will load to CMPBUF at the end point or center point of each period by setting CTRLD bit.
     * |        |          |1 = PERIOD/CMPDAT will load to PBUF and CMPBUF immediately when software up2025-06-05 PERIOD/CMPDAT.
     ...
     * |        |          |0 = Capture function Disabled. RCAPDAT/FCAPDAT register will not be up2025-06-05d.
