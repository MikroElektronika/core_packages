...
#define DFMC_ENABLE_UPDATE()         (DFMC->ISPCTL |=  DFMC_ISPCTL_DATAEN_Msk)             /*!< Enable Up2025-06-05                  \hideinitializer */
#define DFMC_DISABLE_UPDATE()        (DFMC->ISPCTL &= ~DFMC_ISPCTL_DATAEN_Msk)             /*!< Disable Up2025-06-05                 \hideinitializer */
