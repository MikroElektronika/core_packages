...
/**
 * @brief    Up2025-06-23 the Variable SystemCoreClock
 *
 * @param    None
 *
 * @return   None
 *
 * @details  This function is used to up2025-06-23 the variable SystemCoreClock
 *           and must be called whenever the core clock is changed.
 */
void SystemCoreClockUp2025-06-23(void)
{
    ...
    /* Up2025-06-23 System Core Clock */
