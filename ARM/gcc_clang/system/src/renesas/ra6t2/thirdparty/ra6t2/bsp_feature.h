...
#define BSP_FEATURE_ACMPHS_VREF                           (0xFF)            // The IVREF selection that corresponds to the internal voltage reference.
...
#define BSP_FEATURE_ADC_B_PGA_CHANNEL_MASK                (0x01UL)          // Mask of ADC_B peripherals that support PGA.
#define BSP_FEATURE_ADC_B_PGA_SUPPORTED                   (1UL)             // Programmable Gain Amplifier is supported.
#define BSP_FEATURE_ADC_B_TSN_CALIBRATION32_MASK          (0xFFFFUL)        // Mask of valid bits for TSN calibration.
#define BSP_FEATURE_ADC_B_TSN_SLOPE                       (4000UL)          // Typical slope of the temperature sensor in uV/degC.
#define BSP_FEATURE_ADC_B_UNIT_0_CHANNELS                 (0x000001E71FF3F03FULL)   // Mask of channels available to ADC_B Unit 0.
#define BSP_FEATURE_ADC_B_UNIT_1_CHANNELS                 (0x000001E71FFC0FC0ULL)   // Mask of channels available to ADC_B Unit 1.
...
#define BSP_FEATURE_BSP_HAS_IIC_CLOCK                     (1UL)             // Indicates there is a separate IIC clock.
...
#define BSP_FEATURE_BSP_HAS_SCISPI_CLOCK                  (1UL)             // Indicates there is a separate SCI SPI clock.
...
#define BSP_FEATURE_BSP_NUM_PMSAR                         (15UL)            // Number of available Port Security Attribution Registers.
...
#define BSP_FEATURE_BSP_SYS_CLOCK_FREQ_ONE_ROM_WAITS      (120000000UL)     // Maximum frequency allowed before requiring one wait cycle.
...
#define BSP_FEATURE_CGC_HAS_SOPCCR                        (0x01UL)          // SOPCCR register is available.
...
#define BSP_FEATURE_CGC_PLLCCR_VCO_MAX_HZ                 (240000000UL)     // PLL VCO maximum frequency.
...
#define BSP_FEATURE_DAC12_UNIT_COUNT                      (2UL)             // Number of available DAC12 instance.
...
#define BSP_FEATURE_GPT_32BIT_CHANNEL_MASK                (0x03FFUL)        // Mask of 32-bit GPT channel indices.
...
#define BSP_FEATURE_GPT_CLOCK_DIVIDER_VALUE_7_9_VALID     (1UL)             // Whether or not the bit-values of 0b0111 and 0b1001 are valid divider settings (GTCR.TPCS).
#define BSP_FEATURE_GPT_EVENT_COUNT_CHANNEL_MASK          (0x0FUL)          // Mask of channels that support event count input (has GTUPSR register).
#define BSP_FEATURE_GPT_EVENT_COUNT_SUPPORTED             (1UL)             // At least one channel supports event counts.
#define BSP_FEATURE_GPT_GPTE_CHANNEL_MASK                 (0x03F0UL)        // Mask of GPT channels that are the GPTE implementation.
...
#define BSP_FEATURE_GPT_ODC_FRANGE_FREQ_MIN               (115000000UL)     // Minimum frequency for standard PDG operation, must set GTCLYCR.FRANGE bit below this value.
...
#define BSP_FEATURE_GPT_ODC_FREQ_MAX                      (200000000UL)     // Maximum supported frequency of the PWM Delay Generation circuit.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                        (0xF00FFFFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_IIC_B_FAST_MODE_PLUS                  (0x3UL)           // Mask of channels which support "Fast Mode Plus": up to 1 Mbps bit rates.
#define BSP_FEATURE_IIC_B_VALID_CHANNEL_MASK              (0x03UL)          // Mask of available IIC_B or compatible I3C channels.
#define BSP_FEATURE_IIC_BUS_FREE_TIME_MULTIPLIER          (5UL)             // Multiplication factor to calculate SDA bus free time.
...
#define BSP_FEATURE_IOPORT_ELC_PORTS                      (0x7800UL)        // Mask of valid indices for ELC signal mapping of port input data.
...
#define BSP_FEATURE_KINT_HAS_MSTP                         (1UL)             // A module stop bit is provided for the KINT peripheral.
...
#define BSP_FEATURE_LPM_DPSIER_MASK                       (0x0013FFFFULL)   // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_SNZEDCR_MASK                      (0x87UL)          // Mask of valid bits for the SNZEDCRn registers.
#define BSP_FEATURE_LPM_SNZREQCR_MASK                     (0x7002FFFFULL)   // Mask of valid bits for the SNZREQCRn registers.
...
#define BSP_FEATURE_RSIP_SCE5B_SUPPORTED                  (1UL)             // The device supports cryptography using SCE5B.
...
#define BSP_FEATURE_RTC_HAS_HP_MODE                       (0UL)             // Feature not available on this device.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS                      (0x021FUL)        // Mask of channels that can support LIN.
...
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS              (0x021FUL)        // Mask of channels which support CTS external pins.
#define BSP_FEATURE_SCI_UART_DE_IS_INVERTED               (1UL)             // Indicates the PSEL value used to enable `DEn` output signal is opposite compared to other MCUs.
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                (0x021FUL)        // Mask of channels which support the UART FIFO.
...
#define BSP_FEATURE_TFU_IS_AVAILABLE                      (1UL)
#define BSP_FEATURE_TFU_SUPPORTED                         (1UL)             // The TFU peripheral is available @todo [rename] Change to `IS_AVAILABLE` for consistency with other modules.
