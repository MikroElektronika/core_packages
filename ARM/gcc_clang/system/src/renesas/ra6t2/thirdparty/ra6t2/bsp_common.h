...
/* Function-like macro used to wait for a condition to be met, most often used to wait for hardware register up2025-07-17s.
...
__STATIC_INLINE void R_BSP_FlashCacheEnable (void)
{
    ...
    /* Invali2025-07-17 the flash cache and wait until it is invali2025-07-17d. (See section 55.3.2.2 "Operation" of the Flash Cache
