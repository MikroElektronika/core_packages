...
extern "C" {
            ...
            #include "../../../ra/fsp/src/bsp/mcu/ra4t1/bsp_mcu_info.h"
            #include "bsp_clock_cfg.h"
            #define BSP_MCU_GROUP_RA4T1 (1)
...
#define BSP_TZ_CFG_DPFSAR ((RA_NOT_DEFINED > 0) ? 0xFBECA00CU : 0xFFFFFFFFU)
#endif
...
#define BSP_TZ_CFG_CGFSAR (0xFFFBF602U)
#else
...
#define BSP_TZ_CFG_ICUSARE ((RA_NOT_DEFINED > 0) ? 0x8FF2FFFFU : 0xFFFFFFFFU)
#endif
