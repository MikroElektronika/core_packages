...
#define BSP_FEATURE_ADC_HAS_PGA                           (1UL)             // Determine if ADPGACR is present.
...
#define BSP_FEATURE_ICU_WUPEN_MASK                        (0x00000800700D7FFFULL)   // A mask of valid bits for [WUPEN1:WUPEN0].
...
#define BSP_FEATURE_LPM_DPSIER_MASK                       (0x04135FF3ULL)   // Mask of valid bit-fields of the DPSIERn registers.
...
#define BSP_FEATURE_LPM_SNZREQCR_MASK                     (0x70407FFFULL)   // Mask of valid bits for the SNZREQCRn registers.
