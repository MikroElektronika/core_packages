...
#define BSP_PERIPHERAL_ACMPHS_CHANNEL_MASK       (0x3FU)
...
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK          (0x1FFFU)
...
#define BSP_PERIPHERAL_ICU_EXT_IRQ_CHANNEL_MASK  (0x3FFFU)
...
#define BSP_PERIPHERAL_SCI_CHANNEL_MASK          (0x31FU)
