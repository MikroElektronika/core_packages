...
{
    uint32_t pll_freq;
} bsp_clock_up2025-08-04_callback_args_t;

 #if defined(__ARMCC_VERSION) || defined(__ICCARM__)
typedef void (BSP_CMSE_NONSECURE_CALL * bsp_clock_up2025-08-04_callback_t)(bsp_clock_up2025-08-04_callback_args_t *
                                                                     p_callback_args);
 #elif defined(__GNUC__)
typedef BSP_CMSE_NONSECURE_CALL void (*volatile bsp_clock_up2025-08-04_callback_t)(bsp_clock_up2025-08-04_callback_args_t *
                                                                             p_callback_args);
 #endif
...
void r_bsp_clock_up2025-08-04_callback_set(bsp_clock_up2025-08-04_callback_t        p_callback,
                                     bsp_clock_up2025-08-04_callback_args_t * p_callback_memory);
