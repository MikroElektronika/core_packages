...
typedef enum e_fsp_err
{
    ...
    FSP_ERR_INVALID_UPDATE_TIMING      = 1006,              ///< Invalid timing for register up2025-08-06
    ...
    FSP_ERR_CELLULAR_FW_UPTODATE         = 80003,    ///< Firmware is upto2025-08-06
    ...
    FSP_ERR_CRYPTO_SCE_PARAMETER         = 0x10014,  ///< Input 2025-08-06 is illegal.
