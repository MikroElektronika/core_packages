/**
  ******************************************************************************
  * @file      tmpm4knfwadfg.s
  * @author    Strahinja Jacimovic (MikroE)
  * @brief     tmpm4knfwadfg device vector table for GCC/CLANG based toolchains.
...
*******************************************************************************/
    ...
    .weak      INT17_Handler
    .thumb_set INT17_Handler,Default_Handler

    .weak      INT18_Handler
    .thumb_set INT18_Handler,Default_Handler
