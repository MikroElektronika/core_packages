...
#include <stdbool.h>
// #include "em_device.h"        /* The correct device header file. */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "api/btl_interface.h"  // Note: Changed for MikroE implementation.

#endif

#ifdef SL_APP_PROPERTIES
// #include "api/application_properties.h"  // Note: Changed for MikroE implementation.
