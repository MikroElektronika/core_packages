...
__isr_vector:
    ...
    .long   MSCAN_ORed_IRQHandler                           /* MSCAN Tx, Err and Wake-up interrupt*/
...
LPUART2_IRQHandler:
    ...
    .type MSCAN_Rx_IRQHandler, %function
MSCAN_Rx_IRQHandler:
    ldr   r0,=MSCAN_DriverIRQHandler
    bx    r0
    .size MSCAN_Rx_IRQHandler, . - MSCAN_Rx_IRQHandler

    .align 1
    .thumb_func
    .weak MSCAN_ORed_IRQHandler
    .type MSCAN_ORed_IRQHandler, %function
MSCAN_ORed_IRQHandler:
    ldr   r0,=MSCAN_DriverIRQHandler
    bx    r0
    .size MSCAN_ORed_IRQHandler, . - MSCAN_ORed_IRQHandler
