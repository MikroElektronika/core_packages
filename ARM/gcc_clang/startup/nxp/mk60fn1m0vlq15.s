...
g_pfnVectors:
    ...
    .word  UART4_SingleinterruptvectorforUARTstatussources_Handler
    .word  UART4_SingleinterruptvectorforUARTerrorsources_Handler
    .word  UART5_SingleinterruptvectorforUARTstatussources_Handler
    .word  UART5_SingleinterruptvectorforUARTerrorsources_Handler
    .word  ADC0_Handler
    .word  ADC1_Handler
    .word  CMP0_Handler
    .word  CMP1_Handler
    ...
    .word  PDB_Handler
    .word  USBOTG_Handler
    .word  USBChargerDetect_Handler
    .word  EthernetMAC_IEEE1588TimerInterrupt_Handler
    .word  EthernetMAC_Transmitinterrupt_Handler
    .word  EthernetMAC_Receiveinterrupt_Handler
    .word  EthernetMAC_Errorandmiscellaneousinterrupt_Handler
    .word  0                                    /* Reserved */
    .word  SDHC_Handler
    .word  DAC0_Handler
    .word  DAC1_Handler
    ...
    .word  Portcontrolmodule_PindetectPortF_Handler
    .word  0                                    /* Reserved */
    .word  Software_Handler
    .word  NANDflashcontroller_Handler
    .word  USBHS_Handler
    .word  0                                    /* Reserved */
    .word  CMP3_Handler
    .word  0                                    /* Reserved */
...
*******************************************************************************/
    ...
    .weak      UART4_SingleinterruptvectorforUARTstatussources_Handler
    .thumb_set UART4_SingleinterruptvectorforUARTstatussources_Handler,Default_Handler

    .weak      UART4_SingleinterruptvectorforUARTerrorsources_Handler
    .thumb_set UART4_SingleinterruptvectorforUARTerrorsources_Handler,Default_Handler

    .weak      UART5_SingleinterruptvectorforUARTstatussources_Handler
    .thumb_set UART5_SingleinterruptvectorforUARTstatussources_Handler,Default_Handler

    .weak      UART5_SingleinterruptvectorforUARTerrorsources_Handler
    .thumb_set UART5_SingleinterruptvectorforUARTerrorsources_Handler,Default_Handler
    ...
    .weak      USBOTG_Handler
    .thumb_set USBOTG_Handler,Default_Handler

    .weak      USBChargerDetect_Handler
    .thumb_set USBChargerDetect_Handler,Default_Handler

    .weak      EthernetMAC_IEEE1588TimerInterrupt_Handler
    .thumb_set EthernetMAC_IEEE1588TimerInterrupt_Handler,Default_Handler

    .weak      EthernetMAC_Transmitinterrupt_Handler
    .thumb_set EthernetMAC_Transmitinterrupt_Handler,Default_Handler

    .weak      EthernetMAC_Receiveinterrupt_Handler
    .thumb_set EthernetMAC_Receiveinterrupt_Handler,Default_Handler

    .weak      EthernetMAC_Errorandmiscellaneousinterrupt_Handler
    .thumb_set EthernetMAC_Errorandmiscellaneousinterrupt_Handler,Default_Handler
    ...
    .weak      DAC1_Handler
    .thumb_set DAC1_Handler,Default_Handler
    ...
    .weak      Portcontrolmodule_PindetectPortF_Handler
    .thumb_set Portcontrolmodule_PindetectPortF_Handler,Default_Handler

    .weak      Software_Handler
    .thumb_set Software_Handler,Default_Handler

    .weak      NANDflashcontroller_Handler
    .thumb_set NANDflashcontroller_Handler,Default_Handler

    .weak      USBHS_Handler
    .thumb_set USBHS_Handler,Default_Handler

    .weak      CMP3_Handler
    .thumb_set CMP3_Handler,Default_Handler
