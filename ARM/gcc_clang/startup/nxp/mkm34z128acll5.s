...
__isr_vector:
    ...
    .long   EWM_IRQHandler                                  /* External Watchdog Monitor*/
    .long   MCG_IRQHandler                                  /* MCG interrupt*/
    .long   WDOG_IRQHandler                                 /* WDOG ORed interrupt*/
...
SPI1_IRQHandler:
    ...
    .align 1
    .thumb_func
    .weak UART0_UART1_IRQHandler
    .type UART0_UART1_IRQHandler, %function
UART0_UART1_IRQHandler:
    ldr   r0,=UART0_UART1_DriverIRQHandler
    bx    r0
    .size UART0_UART1_IRQHandler, . - UART0_UART1_IRQHandler

    .align 1
    .thumb_func
    .weak UART2_UART3_IRQHandler
    .type UART2_UART3_IRQHandler, %function
UART2_UART3_IRQHandler:
    ldr   r0,=UART2_UART3_DriverIRQHandler
    bx    r0
    .size UART2_UART3_IRQHandler, . - UART2_UART3_IRQHandler
...
/* Exception Handlers */
    ...
    def_irq_handler    UART0_UART1_DriverIRQHandler
    def_irq_handler    UART2_UART3_DriverIRQHandler
