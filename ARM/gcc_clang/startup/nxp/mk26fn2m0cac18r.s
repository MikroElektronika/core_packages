...
g_pfnVectors:
    ...
    .word  USBFSChargerDetect_Handler
    .word  0                                    /* Reserved */
    .word  DAC0_Handler
    .word  MCG_Handler
    ...
    .word  TPM1_Handler
    .word  TPM2_Handler
    .word  USBHSDCDorUSBHSPhy_Handler
    .word  I2C3_Handler
    .word  CMP3_Handler
    .word  USBHSOTG_Handler
...
*******************************************************************************/
    ...
    .weak      USBFSChargerDetect_Handler
    .thumb_set USBFSChargerDetect_Handler,Default_Handler
    ...
    .weak      TSI0_Handler
    .thumb_set TSI0_Handler,Default_Handler
    ...
    .weak      USBHSDCDorUSBHSPhy_Handler
    .thumb_set USBHSDCDorUSBHSPhy_Handler,Default_Handler
    ...
    .weak      USBHSOTG_Handler
    .thumb_set USBHSOTG_Handler,Default_Handler
