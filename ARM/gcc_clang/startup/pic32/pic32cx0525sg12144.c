/*
 * GCC startup file for PIC32CX0525SG12144
 *
...
void GIRQ19_Handler       ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void GIRQ25_Handler       ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void KBC_OBE_Handler      ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void KBC_IBF_Handler      ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void PHOT_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void PS2_0B_WAKE_Handler  ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void PS2_1B_WAKE_Handler  ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void KEYSCAN_Handler      ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void ESPI_VWIRE_Handler   ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void SAF_DONE_Handler     ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SAF_ERR_Handler      ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
const DeviceVectors exception_table = {
        ...
        .pfnGIRQ17_Handler             = (void*) GIRQ17_Handler, /* 9  The PECI Interface allows the EC to retrieve temperature readings from PECI-compliant devices. */
        ...
        .pfnGIRQ19_Handler             = (void*) GIRQ19_Handler, /* 11 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        ...
        .pfnGIRQ24_Handler             = (void*) GIRQ24_Handler, /* 15 The ESPI VW Channel permits the System to emulate a set of wires that interconnect the system Core Logic with the EC */
        .pfnGIRQ25_Handler             = (void*) GIRQ25_Handler, /* 16 The ESPI VW Channel permits the System to emulate a set of wires that interconnect the system Core Logic with the EC */
        ...
        .pfnKBC_OBE_Handler            = (void*) KBC_OBE_Handler, /* 58 The Keyboard Controller is a Host/EC Message Interface with hardware assists to emulate 8042 behavior */
        .pfnKBC_IBF_Handler            = (void*) KBC_IBF_Handler, /* 59 The Keyboard Controller is a Host/EC Message Interface with hardware assists to emulate 8042 behavior */
        ...
        .pfnLED2_Handler               = (void*) LED2_Handler,   /* 85 The LED is implemented using a PWM that can be driven either by the 48 MHz clock or by a 32.768 KHz clock input. */
        .pvReserved86                  = (void*) (0UL),          /* 86 Reserved */
        .pfnPHOT_Handler               = (void*) PHOT_Handler,   /* 87 This block monitors the PROCHOT# signal generated by the host processor. It is designed to detect single assertions and monitor cumulative PROCHOT active time. */
        ...
        .pfnPS2_1_ACT_Handler          = (void*) PS2_1_ACT_Handler, /* 101 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic */
        .pvReserved102                 = (void*) (0UL),          /* 102 Reserved */
        .pfnINTR_PC_Handler            = (void*) INTR_PC_Handler, /* 103 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        .pfnINTR_BM1_Handler           = (void*) INTR_BM1_Handler, /* 104 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        .pfnINTR_BM2_Handler           = (void*) INTR_BM2_Handler, /* 105 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        .pfnINTR_LTR_Handler           = (void*) INTR_LTR_Handler, /* 106 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        .pfnINTR_OOB_UP_Handler        = (void*) INTR_OOB_UP_Handler, /* 107 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        .pfnINTR_OOB_DOWN_Handler      = (void*) INTR_OOB_DOWN_Handler, /* 108 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        .pfnINTR_FLASH_Handler         = (void*) INTR_FLASH_Handler, /* 109 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        .pfnESPI_RESET_Handler         = (void*) ESPI_RESET_Handler, /* 110 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        ...
        .pfnPS2_0B_WAKE_Handler        = (void*) PS2_0B_WAKE_Handler, /* 130 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic */
        .pvReserved131                 = (void*) (0UL),          /* 131 Reserved */
        .pfnPS2_1B_WAKE_Handler        = (void*) PS2_1B_WAKE_Handler, /* 132 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic */
        .pvReserved133                 = (void*) (0UL),          /* 133 Reserved */
        .pvReserved134                 = (void*) (0UL),          /* 134 Reserved */
        .pfnKEYSCAN_Handler            = (void*) KEYSCAN_Handler, /* 135 The Keyboard Scan Interface block provides a register interface to directly scan an external keyboard matrix of size up to 18x8. */
        ...
        .pfnESPI_VWIRE_Handler         = (void*) ESPI_VWIRE_Handler, /* 156 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design */
        ...
        .pfnTACH3_Handler              = (void*) TACH3_Handler,  /* 159 This block monitors TACH output signals from various types of fans, and determines their speed. */
        ...
        .pfnSAF_DONE_Handler           = (void*) SAF_DONE_Handler, /* 166 SAF BRIDGE COMPONENT */
        .pfnSAF_ERR_Handler            = (void*) SAF_ERR_Handler, /* 167 SAF BRIDGE COMPONENT */
