...
typedef struct
{
  ...
  __IO uint32_t TPWM0;             /*!< PWM period rate (PWM period [s]  maximum speed*1  2^16)   */
  __IO uint32_t OMEGA0;            /*!< Rotation speed (speed [Hz] maximum speed *11  2^15)   */
  __IO uint32_t THETA0;            /*!< Motor phase (motor phase [deg]/360  2^16)   */
  __IO uint32_t IDREF0;            /*!< d-axis reference value (current [A]  maximum current*2  2^15)   */
  __IO uint32_t IQREF0;            /*!< q-axis reference value (current [A]  maximum current *2  2^15)   */
  __IO uint32_t VD0;               /*!< d-axis voltage (voltage [V]  maximum voltage *3  2^31)   */
  __IO uint32_t VQ0;               /*!< q-axis voltage (voltage [V]  maximum voltage *3  2^31)   */
  ...
  __IO uint32_t MDPRD0;            /*!< PWM period (to be set identically with PMDs PWM period)   */
  ...
  __IO uint32_t VDC0;              /*!< DC supply voltage (voltage [V]  maximum voltage *3  2^15)   */
  __IO uint32_t ID0;               /*!< d-axis current (current [A]  maximum current *2  2^31)   */
  __IO uint32_t IQ0;               /*!< q-axis current (current [A]  maximum current *2  2^31)   */
  __IO uint32_t MCTLF1;            /*!< Status flags                                 */
  __IO uint32_t MODE1;             /*!< Task control mode                            */
  __IO uint32_t FMODE1;            /*!< Flow control                                 */
  __IO uint32_t TPWM1;             /*!< PWM period rate (PWM period [s]  maximum speed*1  2^16)   */
  __IO uint32_t OMEGA1;            /*!< Rotation speed (speed [Hz] maximum speed *11  2^15)   */
  __IO uint32_t THETA1;            /*!< Motor phase (motor phase [deg]/360  2^16)   */
  __IO uint32_t IDREF1;            /*!< d-axis reference value (current [A]  maximum current*2  2^15)   */
  __IO uint32_t IQREF1;            /*!< q-axis reference value (current [A]  maximum current *2  2^15)   */
  __IO uint32_t VD1;               /*!< d-axis voltage (voltage [V]  maximum voltage *3  2^31)   */
  __IO uint32_t VQ1;               /*!< q-axis voltage (voltage [V]  maximum voltage *3  2^31)   */
  ...
  __IO uint32_t MDPRD1;            /*!< PWM period (to be set identically with PMDs PWM period)   */
  ...
  __IO uint32_t VDC1;              /*!< DC supply voltage (voltage [V]  maximum voltage *3  2^15)   */
  __IO uint32_t ID1;               /*!< d-axis current (current [A]  maximum current *2  2^31)   */
  __IO uint32_t IQ1;               /*!< q-axis current (current [A]  maximum current *2  2^31)   */
       uint32_t RESERVED3;
