...
/******  TMPM364 Specific Interrupt Numbers ********************************************************/
  ...
  INTAD_IRQn                    = 58,       /*!< ADC conversion completion                         */
...
typedef struct
{
  ...
  __I  uint32_t SRAM_CYCLES0_0;  /*!< SMC SRAM Cycles Register 0 <0>              */
  __I  uint32_t OPMODE0_0;       /*!< SMC Opmode Register 0 <0>                   */
       uint32_t RESERVED3[6];
  __I  uint32_t SRAM_CYCLES0_1;  /*!< SMC SRAM Cycles Register 0 <1>              */
  __I  uint32_t OPMODE0_1;       /*!< SMC Opmode Register 0 <1>                   */
       uint32_t RESERVED4[6];
  __I  uint32_t SRAM_CYCLES0_2;  /*!< SMC SRAM Cycles Register 0 <2>              */
  __I  uint32_t OPMODE0_2;       /*!< SMC Opmode Register 0 <2>                   */
       uint32_t RESERVED5[6];
  __I  uint32_t SRAM_CYCLES0_3;  /*!< SMC SRAM Cycles Register 0 <3>              */
  __I  uint32_t OPMODE0_3;       /*!< SMC Opmode Register 0 <3>                   */
} TSB_SMC_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t END1;           /*!< RMC Receive bit Number Register 1  */
  __IO uint32_t END2;           /*!< RMC Receive bit Number Register 2  */
  __IO uint32_t END3;           /*!< RMC Receive bit Number Register 3  */
  __IO uint32_t FSSEL;          /*!< RMC Frequency Select Register      */
} TSB_RMC_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t CNT;            /*!< KWUP Pull-up Cycle Control Register        */
  __O  uint32_t CLR;            /*!< KWUP Interrupt Request All Clear Register  */
...
typedef struct
{
  ...
  __I  uint32_t FLCS;            /*!< FLASH Control Register  */
} TSB_FC_TypeDef;
...
#define TSB_SBI4_BASE             (PERI_BASE  + 0xE0400UL)
...
#define TSB_SC5_BASE              (PERI_BASE  + 0xE1500UL)
#define TSB_SC6_BASE              (PERI_BASE  + 0xE1600UL)
#define TSB_SC7_BASE              (PERI_BASE  + 0xE1700UL)
#define TSB_SC8_BASE              (PERI_BASE  + 0xE1800UL)
#define TSB_SC9_BASE              (PERI_BASE  + 0xE1900UL)
#define TSB_SC10_BASE             (PERI_BASE  + 0xE1A00UL)
#define TSB_SC11_BASE             (PERI_BASE  + 0xE1B00UL)
#define TSB_CEC_BASE              (PERI_BASE  + 0xE2000UL)
#define TSB_RMC0_BASE             (PERI_BASE  + 0xE3000UL)
#define TSB_RMC1_BASE             (PERI_BASE  + 0xE3100UL)
