...
#ifndef __TMPM4K2B_H__
#define __TMPM4K2B_H__
...
/******  TMPM4K2B Specific Interrupt Numbers *******************************************************************/
  ...
  INTEMG1_IRQn                  = 14,        /*!< A-PMD ch1 EMG interrupt                                     */
  INTOVV0_IRQn                  = 15,        /*!< A-PMD ch0 OVV interrupt                                     */
  INTOVV1_IRQn                  = 16,        /*!< A-PMD ch1 OVV interrupt                                     */
  INTPWM0_IRQn                  = 17,        /*!< A-PMD ch0 PWM interrupt                                     */
  INTPWM1_IRQn                  = 18,        /*!< A-PMD ch1 PWM interrupt                                     */
  INTENC00_IRQn                 = 19,        /*!< A-ENC32 ch0 Encoder input interrupt 0                       */
  INTENC01_IRQn                 = 20,        /*!< A-ENC32 ch0 Encoder input interrupt 1                       */
  ...
  INTENC10_IRQn                 = 89,        /*!< A-ENC32 ch1 Encoder input interrupt 0                       */
  INTENC11_IRQn                 = 90,        /*!< A-ENC32 ch1 Encoder input interrupt 1                       */
  INTADBPDA_IRQn                = 91,        /*!< ADC unit B PMD trigger interrupt A                          */
  INTADBPDB_IRQn                = 92,        /*!< ADC unit B PMD trigger interrupt B                          */
  INTADBCP0_IRQn                = 93,        /*!< ADC unit B Monitor function 0 interrupt                     */
  INTADBCP1_IRQn                = 94,        /*!< ADC unit B Monitor function 1 interrupt                     */
  INTADBTRG_IRQn                = 95,        /*!< ADC unit B General-purpose trigger interrupt                */
  INTADBSGL_IRQn                = 96,        /*!< ADC unit B Single conversion interrupt                      */
  INTADBCNT_IRQn                = 97,        /*!< ADC unit B Continuous conversion interrupt                  */
  INTADCCMP_IRQn                = 98         /*!< ADC Conversion result compare interrupt                     */
} IRQn_Type;
...
// #include "system_TMPM4KxB.h"                 /* TMPM4K2B System                                      */
...
/**
  * @brief AD conversion Result Comparison Circuit
  */
typedef struct
{
  __IO uint32_t PEN;               /*!< Enable Register                              */
  __IO uint32_t ERRSET;            /*!< Permissible Error Setting Register           */
  __IO uint32_t TIMEOUT;           /*!< Time Out Period Setting Register             */
  __IO uint32_t PSEL;              /*!< Compare Channel Selection Register           */
  __IO uint32_t TIME;              /*!< Time Counter Register                        */
       uint32_t RESERVED0[3];
  __IO uint32_t CLR;               /*!< Clear Register                               */
  __IO uint32_t STATUS;            /*!< Status Register                              */
       uint32_t RESERVED1[118];
  __I  uint32_t ERRLOG0;           /*!< Error Log Register 0                         */
  __IO uint32_t ERRRES0;           /*!< Error Result Register 0                      */
  __IO uint32_t ERRTIM0;           /*!< Error Time Register 0                        */
       uint32_t RESERVED2;
  __I  uint32_t ERRLOG1;           /*!< Error Log Register 1                         */
  __IO uint32_t ERRRES1;           /*!< Error Result Register 1                      */
  __IO uint32_t ERRTIM1;           /*!< Error Time Register 1                        */
       uint32_t RESERVED3;
  __I  uint32_t ERRLOG2;           /*!< Error Log Register 2                         */
  __IO uint32_t ERRRES2;           /*!< Error Result Register 2                      */
  __IO uint32_t ERRTIM2;           /*!< Error Time Register 2                        */
       uint32_t RESERVED4;
  __I  uint32_t ERRLOG3;           /*!< Error Log Register 3                         */
  __IO uint32_t ERRRES3;           /*!< Error Result Register 3                      */
  __IO uint32_t ERRTIM3;           /*!< Error Time Register 3                        */
       uint32_t RESERVED5;
  __I  uint32_t ERRLOG4;           /*!< Error Log Register 4                         */
  __IO uint32_t ERRRES4;           /*!< Error Result Register 4                      */
  __IO uint32_t ERRTIM4;           /*!< Error Time Register 4                        */
       uint32_t RESERVED6;
  __I  uint32_t ERRLOG5;           /*!< Error Log Register 5                         */
  __IO uint32_t ERRRES5;           /*!< Error Result Register 5                      */
  __IO uint32_t ERRTIM5;           /*!< Error Time Register 5                        */
       uint32_t RESERVED7;
  __I  uint32_t ERRLOG6;           /*!< Error Log Register 6                         */
  __IO uint32_t ERRRES6;           /*!< Error Result Register 6                      */
  __IO uint32_t ERRTIM6;           /*!< Error Time Register 6                        */
       uint32_t RESERVED8;
  __I  uint32_t ERRLOG7;           /*!< Error Log Register 7                         */
  __IO uint32_t ERRRES7;           /*!< Error Result Register 7                      */
  __IO uint32_t ERRTIM7;           /*!< Error Time Register 7                        */
} TSB_ACMP_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t CR;                /*!< Port J Output Control Register               */
       uint32_t RESERVED0[3];
  __IO uint32_t FR4;               /*!< Port J Function Register 4                   */
...
typedef struct
{
  ...
  __IO uint32_t CTLB;              /*!< AMP control register A                       */
  __IO uint32_t CTLC;              /*!< AMP control register A                       */
} TSB_AMP_TypeDef;
...
#define TSB_ACMP_BASE              (PERI_BASE  + 0x00BE000UL)
...
#define TSB_ADB_BASE               (PERI_BASE  + 0x00B8C00UL)
...
#define TSB_AMP_BASE               (PERI_BASE  + 0x00BC000UL)
...
#define TSB_ACMP                   ((   TSB_ACMP_TypeDef *)  TSB_ACMP_BASE)
...
#endif  /* __TMPM4K2B_H__ */

/** @} */ /* End of group TMPM4K2B */
