...
#ifndef __TMPM384_H__
#define __TMPM384_H__
...
/******  TMPM384 Specific Interrupt Numbers *******************************************************************/
  ...
  INTTB80_IRQn                  = 95,        /*!< 16bit TMRB8 compare match detection 0                       */
  INTTB81_IRQn                  = 96,        /*!< 16bit TMRB8 compare match detection 1                       */
  INTTB90_IRQn                  = 97,        /*!< 16bit TMRB9 compare match detection 0                       */
  INTTB91_IRQn                  = 98,        /*!< 16bit TMRB9 compare match detection 1                       */
  INTTBA0_IRQn                  = 99,        /*!< 16bit TMRBA compare match detection 0                       */
  INTTBA1_IRQn                  = 100,       /*!< 16bit TMRBA compare match detection 1                       */
  INTTBB0_IRQn                  = 101,       /*!< 16bit TMRBB compare match detection 0                       */
  INTTBB1_IRQn                  = 102,       /*!< 16bit TMRBB compare match detection 1                       */
  INTCAP80_IRQn                 = 103,       /*!< 16bit TMRB8 input capture 0                                 */
  INTCAP81_IRQn                 = 104,       /*!< 16bit TMRB8 input capture 1                                 */
  INTCAP90_IRQn                 = 105,       /*!< 16bit TMRB9 input capture 0                                 */
  INTCAP91_IRQn                 = 106,       /*!< 16bit TMRB9 input capture 1                                 */
  INTCAPA0_IRQn                 = 107,       /*!< 16bit TMRBA input capture 0                                 */
  INTCAPA1_IRQn                 = 108,       /*!< 16bit TMRBA input capture 1                                 */
  INTCAPB0_IRQn                 = 109,       /*!< 16bit TMRBB input capture 0                                 */
  INTCAPB1_IRQn                 = 110,       /*!< 16bit TMRBB input capture 1                                 */
  INTMTTB30_IRQn                = 111,       /*!< 16-bit MPT3 IGBT period/ compare match detection 0/Over flow*/
  INTMTTB31_IRQn                = 112,       /*!< 16-bit MPT3 IGBT trigger/ compare match detection 1         */
  INTMTCAP30_IRQn               = 113,       /*!< 16-bit MPT3 input capture 0                                 */
  INTMTCAP31_IRQn               = 114,       /*!< 16-bit MPT3 input capture 1                                 */
  INTMTEMG3_IRQn                = 115        /*!< 16-bit MPT3 IGBT EMG interrupt                              */
} IRQn_Type;
...
// #include "system_TMPM384.h"                 /* TMPM384 System                                      */
...
/**
  * @brief General Purpose Input_Output Port (PQ)
  */
typedef struct
{
  __IO uint32_t DATA;              /*!< PQ Data Register                             */
  __IO uint32_t CR;                /*!< PQ Control Register                          */
       uint32_t RESERVED0[8];
  __IO uint32_t OD;                /*!< PQ Open Drain Control Register               */
  __IO uint32_t PUP;               /*!< PQ Pull-Up Control Register                  */
  __IO uint32_t PDN;               /*!< PQ Pull-Down Control Register                */
       uint32_t RESERVED1;
  __IO uint32_t IE;                /*!< PQ Input Enable Control Register             */
} TSB_PQ_TypeDef;

/**
  * @brief General Purpose Input_Output Port (PR)
  */
typedef struct
{
...
/**
  * @brief General Purpose Input_Output Port (PS)
  */
typedef struct
{
  __IO uint32_t DATA;              /*!< PS Data Register                             */
  __IO uint32_t CR;                /*!< PS Control Register                          */
       uint32_t RESERVED0[8];
  __IO uint32_t OD;                /*!< PS Open Drain Control Register               */
  __IO uint32_t PUP;               /*!< PS Pull-Up Control Register                  */
  __IO uint32_t PDN;               /*!< PS Pull-Down Control Register                */
       uint32_t RESERVED1;
  __IO uint32_t IE;                /*!< PS Input Enable Control Register             */
} TSB_PS_TypeDef;

/**
  * @brief General Purpose Input_Output Port (PT)
  */
typedef struct
{
...
/**
  * @brief General Purpose Input_Output Port (PU)
  */
typedef struct
{
...
/**
  * @brief General Purpose Input_Output Port (PV)
  */
typedef struct
{
  __I  uint32_t DATA;              /*!< PV Data Register                             */
       uint32_t RESERVED0[10];
  __I  uint32_t PUP;               /*!< PV Pull-Up Control Register                  */
  __I  uint32_t PDN;               /*!< PV Pull-Down Control Register                */
       uint32_t RESERVED1;
  __I  uint32_t IE;                /*!< PV Input Enable Control Register             */
} TSB_PV_TypeDef;
...
#define TSB_PQ_BASE                (PERI_BASE  + 0x0000400UL)
#define TSB_PR_BASE                (PERI_BASE  + 0x0000440UL)
#define TSB_PS_BASE                (PERI_BASE  + 0x0000480UL)
#define TSB_PT_BASE                (PERI_BASE  + 0x00004C0UL)
#define TSB_PU_BASE                (PERI_BASE  + 0x0000500UL)
#define TSB_PV_BASE                (PERI_BASE  + 0x0000540UL)
...
#define TSB_TB8_BASE               (PERI_BASE  + 0x0010200UL)
#define TSB_TB9_BASE               (PERI_BASE  + 0x0010240UL)
#define TSB_TBA_BASE               (PERI_BASE  + 0x0010280UL)
#define TSB_TBB_BASE               (PERI_BASE  + 0x00102C0UL)
...
#define TSB_MT3_BASE               (PERI_BASE  + 0x0050980UL)
...
#define TSB_PQ                     ((     TSB_PQ_TypeDef *)    TSB_PQ_BASE)
#define TSB_PR                     ((     TSB_PR_TypeDef *)    TSB_PR_BASE)
#define TSB_PS                     ((     TSB_PS_TypeDef *)    TSB_PS_BASE)
...
/* General Purpose Input_Output Port (PQ) */
#define TSB_PQ_DATA_PQ0                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->DATA,0)))
#define TSB_PQ_DATA_PQ1                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->DATA,1)))
#define TSB_PQ_DATA_PQ2                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->DATA,2)))
#define TSB_PQ_DATA_PQ3                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->DATA,3)))
#define TSB_PQ_CR_PQ0C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->CR,0)))
#define TSB_PQ_CR_PQ1C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->CR,1)))
#define TSB_PQ_CR_PQ2C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->CR,2)))
#define TSB_PQ_CR_PQ3C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->CR,3)))
#define TSB_PQ_OD_PQ0OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->OD,0)))
#define TSB_PQ_OD_PQ1OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->OD,1)))
#define TSB_PQ_OD_PQ2OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->OD,2)))
#define TSB_PQ_OD_PQ3OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->OD,3)))
#define TSB_PQ_PUP_PQ0UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PUP,0)))
#define TSB_PQ_PUP_PQ1UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PUP,1)))
#define TSB_PQ_PUP_PQ2UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PUP,2)))
#define TSB_PQ_PUP_PQ3UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PUP,3)))
#define TSB_PQ_PDN_PQ0DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PDN,0)))
#define TSB_PQ_PDN_PQ1DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PDN,1)))
#define TSB_PQ_PDN_PQ2DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PDN,2)))
#define TSB_PQ_PDN_PQ3DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->PDN,3)))
#define TSB_PQ_IE_PQ0IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->IE,0)))
#define TSB_PQ_IE_PQ1IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->IE,1)))
#define TSB_PQ_IE_PQ2IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->IE,2)))
#define TSB_PQ_IE_PQ3IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PQ->IE,3)))


/* General Purpose Input_Output Port (PR) */
...
#define TSB_PR_OD_PQ0OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,0)))
#define TSB_PR_OD_PQ1OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,1)))
#define TSB_PR_OD_PQ2OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,2)))
#define TSB_PR_OD_PQ3OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,3)))
#define TSB_PR_OD_PQ4OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,4)))
#define TSB_PR_OD_PQ5OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,5)))
#define TSB_PR_OD_PQ6OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,6)))
#define TSB_PR_OD_PQ7OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->OD,7)))
#define TSB_PR_PUP_PQ0UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,0)))
#define TSB_PR_PUP_PQ1UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,1)))
#define TSB_PR_PUP_PQ2UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,2)))
#define TSB_PR_PUP_PQ3UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,3)))
#define TSB_PR_PUP_PQ4UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,4)))
#define TSB_PR_PUP_PQ5UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,5)))
#define TSB_PR_PUP_PQ6UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,6)))
#define TSB_PR_PUP_PQ7UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PUP,7)))
#define TSB_PR_PDN_PQ0DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,0)))
#define TSB_PR_PDN_PQ1DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,1)))
#define TSB_PR_PDN_PQ2DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,2)))
#define TSB_PR_PDN_PQ3DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,3)))
#define TSB_PR_PDN_PQ4DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,4)))
#define TSB_PR_PDN_PQ5DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,5)))
#define TSB_PR_PDN_PQ6DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,6)))
#define TSB_PR_PDN_PQ7DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->PDN,7)))
#define TSB_PR_IE_PQ0IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,0)))
#define TSB_PR_IE_PQ1IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,1)))
#define TSB_PR_IE_PQ2IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,2)))
#define TSB_PR_IE_PQ3IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,3)))
#define TSB_PR_IE_PQ4IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,4)))
#define TSB_PR_IE_PQ5IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,5)))
#define TSB_PR_IE_PQ6IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,6)))
#define TSB_PR_IE_PQ7IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PR->IE,7)))


/* General Purpose Input_Output Port (PS) */
#define TSB_PS_DATA_PS0                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->DATA,0)))
#define TSB_PS_DATA_PS1                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->DATA,1)))
#define TSB_PS_DATA_PS2                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->DATA,2)))
#define TSB_PS_DATA_PS3                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->DATA,3)))
#define TSB_PS_DATA_PS4                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->DATA,4)))
#define TSB_PS_DATA_PS5                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->DATA,5)))
#define TSB_PS_DATA_PS6                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->DATA,6)))
#define TSB_PS_CR_PS0C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->CR,0)))
#define TSB_PS_CR_PS1C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->CR,1)))
#define TSB_PS_CR_PS2C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->CR,2)))
#define TSB_PS_CR_PS3C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->CR,3)))
#define TSB_PS_CR_PS4C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->CR,4)))
#define TSB_PS_CR_PS5C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->CR,5)))
#define TSB_PS_CR_PS6C                            (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->CR,6)))
#define TSB_PS_OD_PS0OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->OD,0)))
#define TSB_PS_OD_PS1OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->OD,1)))
#define TSB_PS_OD_PS2OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->OD,2)))
#define TSB_PS_OD_PS3OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->OD,3)))
#define TSB_PS_OD_PS4OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->OD,4)))
#define TSB_PS_OD_PS5OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->OD,5)))
#define TSB_PS_OD_PS6OD                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->OD,6)))
#define TSB_PS_PUP_PS0UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PUP,0)))
#define TSB_PS_PUP_PS1UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PUP,1)))
#define TSB_PS_PUP_PS2UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PUP,2)))
#define TSB_PS_PUP_PS3UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PUP,3)))
#define TSB_PS_PUP_PS4UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PUP,4)))
#define TSB_PS_PUP_PS5UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PUP,5)))
#define TSB_PS_PUP_PS6UP                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PUP,6)))
#define TSB_PS_PDN_PS0DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PDN,0)))
#define TSB_PS_PDN_PS1DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PDN,1)))
#define TSB_PS_PDN_PS2DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PDN,2)))
#define TSB_PS_PDN_PS3DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PDN,3)))
#define TSB_PS_PDN_PS4DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PDN,4)))
#define TSB_PS_PDN_PS5DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PDN,5)))
#define TSB_PS_PDN_PS6DN                          (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->PDN,6)))
#define TSB_PS_IE_PS0IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->IE,0)))
#define TSB_PS_IE_PS1IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->IE,1)))
#define TSB_PS_IE_PS2IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->IE,2)))
#define TSB_PS_IE_PS3IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->IE,3)))
#define TSB_PS_IE_PS4IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->IE,4)))
#define TSB_PS_IE_PS5IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->IE,5)))
#define TSB_PS_IE_PS6IE                           (*((__IO uint32_t *)BITBAND_PERI(&TSB_PS->IE,6)))


/* General Purpose Input_Output Port (PT) */
...
/* General Purpose Input_Output Port (PU) */
...
/* General Purpose Input_Output Port (PV) */
#define TSB_PV_DATA_PV0                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->DATA,0)))
#define TSB_PV_DATA_PV1                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->DATA,1)))
#define TSB_PV_DATA_PV2                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->DATA,2)))
#define TSB_PV_DATA_PV3                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->DATA,3)))
#define TSB_PV_PUP_PV0UP                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PUP,0)))
#define TSB_PV_PUP_PV1UP                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PUP,1)))
#define TSB_PV_PUP_PV2UP                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PUP,2)))
#define TSB_PV_PUP_PV3UP                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PUP,3)))
#define TSB_PV_PDN_PV0DN                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PDN,0)))
#define TSB_PV_PDN_PV1DN                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PDN,1)))
#define TSB_PV_PDN_PV2DN                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PDN,2)))
#define TSB_PV_PDN_PV3DN                          (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->PDN,3)))
#define TSB_PV_IE_PV0IE                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->IE,0)))
#define TSB_PV_IE_PV1IE                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->IE,1)))
#define TSB_PV_IE_PV2IE                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->IE,2)))
#define TSB_PV_IE_PV3IE                           (*((__I  uint32_t *)BITBAND_PERI(&TSB_PV->IE,3)))
...
#define TSB_TB8_MOD_TBRSWR                        (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB8->MOD,6)))
...
#define TSB_TB9_MOD_TBRSWR                        (*((__IO uint32_t *)BITBAND_PERI(&TSB_TB9->MOD,6)))
...
#define TSB_TBA_MOD_TBRSWR                        (*((__IO uint32_t *)BITBAND_PERI(&TSB_TBA->MOD,6)))
...
#define TSB_TBB_MOD_TBRSWR                        (*((__IO uint32_t *)BITBAND_PERI(&TSB_TBB->MOD,6)))
