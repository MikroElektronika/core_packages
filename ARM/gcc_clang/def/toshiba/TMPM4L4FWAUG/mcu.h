...
#ifndef __TMPM4L4_H__
#define __TMPM4L4_H__
...
/******  TMPM4L4 Specific Interrupt Numbers *******************************************************************/
...
#define TSB_PA_FR4_PA6F4                             (*((__IO uint32_t *)BITBAND_PERI(&TSB_PA->FR4,6)))
...
#define TSB_PA_FR5_PA6F5                             (*((__IO uint32_t *)BITBAND_PERI(&TSB_PA->FR5,6)))
...
#define TSB_PC_FR4_PC4F4                             (*((__IO uint32_t *)BITBAND_PERI(&TSB_PC->FR4,4)))
