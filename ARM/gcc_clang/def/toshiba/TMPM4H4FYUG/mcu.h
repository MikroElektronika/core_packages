...
#ifndef __TMPM4H4_H__
#define __TMPM4H4_H__
...
/******  TMPM4H4 Specific Interrupt Numbers *******************************************************************/
  ...
  INTSC3RX_IRQn                 = 40,        /*!< TSPI ch3 Receive interrupt/UART ch3 Reception interrupt     */
  INTSC3TX_IRQn                 = 41,        /*!< TSPI ch3 Transmit interrupt/UART ch3 Transmission interrupt */
  INTSC3ERR_IRQn                = 42,        /*!< TSPI ch3 Error interrupt/UART ch3 Error interrupt           */
...
// #include "system_TMPM4Hx.h"                 /* TMPM4H4 System                                      */
...
typedef struct
{
  ...
  __IO uint8_t  IMC32;             /*!< Interrupu Mode Control Register(A) 32        */
  __IO uint8_t  IMC33;             /*!< Interrupu Mode Control Register(A) 33        */
...
#define TSB_NBD_BASE               (PERI_BASE  + 0x00BBA00UL)
