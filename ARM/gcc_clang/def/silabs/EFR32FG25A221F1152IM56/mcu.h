...
// #include "core_cm33.h"        /* Core Header File */  // Note: Changed for MikroE implementation.
// #include "system_efr32fg25.h" /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
 ...
 *****************************************************************************/
// #include "efr32fg25_scratchpad.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_hfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_fsrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_dpll.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_lfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_lfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_ulfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_icache.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_ldmaxbar.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_burtc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_syscfg.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_buram.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_dcdc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_mailbox.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_eusart.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_sysrtc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_mpahbram.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_pfmxpprf.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_rffpll.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_etampdet.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_bufc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_aes.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_smu.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_usbahb.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_usb.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_usbpll.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_iadc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_vdac.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_lesense.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_hfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_semailbox.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_devinfo.h"  // Note: Changed for MikroE implementation.

/* Custom headers for LDMAXBAR and PRS mappings */
// #include "efr32fg25_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg25_ldmaxbar_defines.h"  // Note: Changed for MikroE implementation.
...
// #include "sl_component_catalog.h"  // Note: Changed for MikroE implementation.

#endif
#if defined(SL_CATALOG_TRUSTZONE_SECURE_CONFIG_PRESENT)
// #include "sl_trustzone_secure_config.h"  // Note: Changed for MikroE implementation.
