...
// #include "system_efr32bg27.h" /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
 ...
 *****************************************************************************/
// #include "efr32bg27_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_hfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_hfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_fsrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_dpll.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_lfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_lfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_ulfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_icache.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_ldmaxbar.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_burtc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_syscfg.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_buram.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_dcdc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_pdm.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_sepuf.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_etampdet.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_aes.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_smu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_iadc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_eusart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_cryptoacc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_devinfo.h"  // Note: Changed for MikroE implementation.

/* Custom headers for LDMAXBAR and PRS mappings */
// #include "efr32bg27_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg27_ldmaxbar_defines.h"  // Note: Changed for MikroE implementation.
