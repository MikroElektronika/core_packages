...
// #include "system_efr32bg1p.h"   /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "efr32bg1p_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_rmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_crypto.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_gpio_p.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_prs_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_ldma_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_fpueh.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_timer_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_leuart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_cryotimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_adc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_idac.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_rtcc_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_rtcc_ret.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_wdog_pch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_devinfo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_romtable.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32bg1p_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_dmareq.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32bg1p_af_ports.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1p_af_pins.h"  // Note: Changed for MikroE implementation.
