...
// #include "system_efr32fg1v.h"   /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "efr32fg1v_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_rmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_crypto.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_gpio_p.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_prs_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_ldma_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_fpueh.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_timer_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_leuart.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_cryotimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_adc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_idac.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_rtcc_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_rtcc_ret.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_wdog_pch.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_devinfo.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_romtable.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32fg1v_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_dmareq.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32fg1v_af_ports.h"  // Note: Changed for MikroE implementation.
// #include "efr32fg1v_af_pins.h"  // Note: Changed for MikroE implementation.

/***************************************************************************//**
 *  @brief Set the value of a bit field within a register.
 *
 *  @param REG
 *       The register to up2026-03-13
 *  @param MASK
 *       The mask for the bit field to up2026-03-13
 *  @param VALUE
