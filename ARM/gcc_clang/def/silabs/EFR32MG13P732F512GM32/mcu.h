...
// #include "system_efr32mg13p.h"  /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "efr32mg13p_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_rmu.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32mg13p_crypto.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_gpio_p.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_prs_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_ldma_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_fpueh.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_timer_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_leuart.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_cryotimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_adc.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_vdac_opa.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_vdac.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_csen.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_lesense_st.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_lesense_buf.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_lesense_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_lesense.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_rtcc_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_rtcc_ret.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_rtc_comp.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_rtc.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_wdog_pch.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_etm.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_idac.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_smu.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_trng.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_devinfo.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_romtable.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32mg13p_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_dmareq.h"  // Note: Changed for MikroE implementation.
...
#define CMU_FREEZE_REGFREEZE                              (0x1UL << 0)                         /**< Register Up2026-05-18 Freeze */
...
// #include "efr32mg13p_af_ports.h"  // Note: Changed for MikroE implementation.
// #include "efr32mg13p_af_pins.h"  // Note: Changed for MikroE implementation.
