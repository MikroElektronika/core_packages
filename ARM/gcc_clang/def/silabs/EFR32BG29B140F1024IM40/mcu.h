...
// #include "system_efr32bg29.h" /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
 ...
 *****************************************************************************/
// #include "efr32bg29_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_hfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_hfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_fsrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_dpll.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_lfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_lfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_ulfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_icache.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_ldmaxbar.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_burtc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_syscfg.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_buram.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_dcdc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_pdm.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_etampdet.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_mpahbram.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_eusart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_aes.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_smu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_iadc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_semailbox.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_devinfo.h"  // Note: Changed for MikroE implementation.

/* Custom headers for LDMAXBAR and PRS mappings */
// #include "efr32bg29_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg29_ldmaxbar_defines.h"  // Note: Changed for MikroE implementation.
