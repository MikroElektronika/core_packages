...
// #include "system_efr32bg12p.h"  /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "efr32bg12p_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_rmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_crypto.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_gpio_p.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_prs_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_ldma_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_fpueh.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_timer_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_leuart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_cryotimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_adc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_idac.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_vdac_opa.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_vdac.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_csen.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_lesense_st.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_lesense_buf.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_lesense_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_lesense.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_rtcc_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_rtcc_ret.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_wdog_pch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_etm.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_smu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_trng.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_devinfo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_romtable.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32bg12p_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_dmareq.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32bg12p_af_ports.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg12p_af_pins.h"  // Note: Changed for MikroE implementation.
