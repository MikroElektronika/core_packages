...
// #include "core_cm3.h"           /* Cortex-M3 processor and core peripherals */  // Note: Changed for MikroE implementation.
// #include "system_efm32gg.h"       /* System Header */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "efm32gg_dma_ch.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_dma.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_aes.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_usb_hc.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_usb_diep.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_usb_doep.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_usb.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_msc.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_emu.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_rmu.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_lesense_st.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_lesense_buf.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_lesense_ch.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_lesense.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_rtc.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_ebi.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_usart.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_timer_cc.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_timer.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_gpio_p.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_vcmp.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_prs_ch.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_prs.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_leuart.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_adc.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_dac.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_lcd.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_burtc_ret.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_burtc.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_etm.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_devinfo.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_romtable.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_calibrate.h"  // Note: Changed for MikroE implementation.
...
// #include "efm32gg_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_dmareq.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_dmactrl.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_uart.h"  // Note: Changed for MikroE implementation.
...
// #include "efm32gg_af_ports.h"  // Note: Changed for MikroE implementation.
// #include "efm32gg_af_pins.h"  // Note: Changed for MikroE implementation.
 ...
 *
 *  @param REG
 *       The register to up2026-05-04
 *  @param MASK
 *       The mask for the bit field to up2026-05-04
 *  @param VALUE
