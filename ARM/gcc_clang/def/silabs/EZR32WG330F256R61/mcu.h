...
// #include "system_ezr32wg.h" /* System Header */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "ezr32wg_dma_ch.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_dma.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_aes.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_usb_hc.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_usb_diep.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_usb_doep.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_usb.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_msc.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_emu.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_rmu.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_cmu.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_lesense_st.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_lesense_buf.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_lesense_ch.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_lesense.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_fpueh.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_usart.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_timer_cc.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_timer.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_acmp.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_leuart.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_rtc.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_letimer.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_i2c.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_gpio_p.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_gpio.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_vcmp.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_prs_ch.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_prs.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_adc.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_dac.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_burtc_ret.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_burtc.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_wdog.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_etm.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_devinfo.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_romtable.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_calibrate.h"  // Note: Changed for MikroE implementation.
...
// #include "ezr32wg_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_dmareq.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_dmactrl.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_usartrf.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_uart.h"  // Note: Changed for MikroE implementation.
...
// #include "ezr32wg_af_ports.h"  // Note: Changed for MikroE implementation.
// #include "ezr32wg_af_pins.h"  // Note: Changed for MikroE implementation.
 ...
 *
 *  @param REG
 *       The register to up2026-05-26
 *  @param MASK
 *       The mask for the bit field to up2026-05-26
 *  @param VALUE
