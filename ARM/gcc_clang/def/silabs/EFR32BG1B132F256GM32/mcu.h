...
// #include "system_efr32bg1b.h"   /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "efr32bg1b_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_rmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_crypto.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_gpio_p.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_prs_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_ldma_ch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_fpueh.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_timer_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_leuart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_cryotimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_pcnt.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_adc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_acmp.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_idac.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_rtcc_cc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_rtcc_ret.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_wdog_pch.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_devinfo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_romtable.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32bg1b_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_dmareq.h"  // Note: Changed for MikroE implementation.
...
// #include "efr32bg1b_af_ports.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg1b_af_pins.h"  // Note: Changed for MikroE implementation.

/***************************************************************************//**
 *  @brief Set the value of a bit field within a register.
 *
 *  @param REG
 *       The register to up2026-03-27
 *  @param MASK
 *       The mask for the bit field to up2026-03-27
 *  @param VALUE
