...
// #include "system_efr32bg22.h" /* System Header File */  // Note: Changed for MikroE implementation.
#include <stdint.h>
 ...
 *****************************************************************************/
// #include "efr32bg22_emu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_cmu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_hfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_hfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_fsrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_dpll.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_lfxo.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_lfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_ulfrco.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_msc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_icache.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_prs.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_gpio.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_ldma.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_ldmaxbar.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_timer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_usart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_burtc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_i2c.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_syscfg.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_buram.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_gpcrc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_dcdc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_pdm.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_aes.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_smu.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_rtcc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_letimer.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_iadc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_wdog.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_eusart.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_cryptoacc.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_devinfo.h"  // Note: Changed for MikroE implementation.

/* Custom headers for LDMAXBAR and PRS mappings */
// #include "efr32bg22_prs_signals.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_dma_descriptor.h"  // Note: Changed for MikroE implementation.
// #include "efr32bg22_ldmaxbar_defines.h"  // Note: Changed for MikroE implementation.
