 ...
 * @note     Generated by SVDConv V3.3.18 on Tuesday, 24.10.2023 14:14:34
 *           from File 'Files/SVD/BAT32G127.svd',
 *           last modified on Tuesday, 24.10.2023 06:14:32
 */
...
/* =========================================  BAT32G127 Specific Interrupt Numbers  ========================================== */
  ...
  INTP4_IRQn                =   5,              /*!< 5  INTP4 External interrupt request                                       */
  INTP5_IRQn                =   6,              /*!< 6  INTP5 External interrupt request                                       */
  KEY_IRQn                  =   7,              /*!< 7  KEY return interrupt request                                           */
  RTC_IRQn                  =   8,              /*!< 8  Real-Time Clock interrupt request                                      */
  IT_IRQn                   =   9,              /*!< 9  15-bit interval timer interrupt request                                */
  ...
  ST1_IRQn                  =  12,              /*!< 12 UART1 transmission transfer end or buffer empty                        */
  SPI10_IRQn                =  12,              /*!< 12 SPI10 transfer end or buffer empty                                     */
  IIC10_IRQn                =  12,              /*!< 12 IIC10 transfer end                                                     */
  SR1_IRQn                  =  13,              /*!< 13 UART1 rerception transfer                                              */
  SPI11_IRQn                =  13,              /*!< 13 SPI11 transfer end or buffer empty                                     */
  IIC11_IRQn                =  13,              /*!< 13 IIC11 transfer end                                                     */
  ST2_IRQn                  =  14,              /*!< 14 UART2 transmission transfer end or buffer empty                        */
  SPI20_IRQn                =  14,              /*!< 14 SPI20 transfer end or buffer empty                                     */
  IIC20_IRQn                =  14,              /*!< 14 IIC20 transfer end                                                     */
  SR2_IRQn                  =  15,              /*!< 15 UART2 rerception transfer                                              */
  SPI21_IRQn                =  15,              /*!< 15 SPI21 transfer end or buffer empty                                     */
  IIC21_IRQn                =  15,              /*!< 15 IIC21 transfer end                                                     */
  IICA0_IRQn                =  16,              /*!< 16 IICA0 interrupt request                                                */
  SPIHS0_IRQn               =  17,              /*!< 17 SPIHS0 interrupt request                                               */
  TM00_IRQn                 =  18,              /*!< 18 TM81 channel 0 interrupt request                                       */
  TM01_IRQn                 =  19,              /*!< 19 TM81 channel 1 interrupt request                                       */
  TM02_IRQn                 =  20,              /*!< 20 TM81 channel 2 interrupt request                                       */
  TM03_IRQn                 =  21,              /*!< 21 TM81 channel 3 interrupt request                                       */
  TM04_IRQn                 =  22,              /*!< 22 TM81 channel 4 interrupt request                                       */
  TM05_IRQn                 =  23,              /*!< 23 TM81 channel 5 interrupt request                                       */
  TM06_IRQn                 =  24,              /*!< 24 TM81 channel 6 interrupt request                                       */
  TM07_IRQn                 =  25,              /*!< 25 TM81 channel 7 interrupt request                                       */
  TMA0_IRQn                 =  26,              /*!< 26 TimerA underflow                                                       */
  ADC_IRQn                  =  27,              /*!< 27 ADC interrupt request                                                  */
  CMP0_IRQn                 =  28,              /*!< 28 CMP0 interrupt request                                                 */
  CMP1_IRQn                 =  29,              /*!< 29 CMP1 interrupt request                                                 */
  OSDC_IRQn                 =  30,              /*!< 30 Oscillator stop detection                                              */
  FMC_IRQn                  =  31               /*!< 31 Flash programming finish                                               */
} IRQn_Type;
...
//#include "system_BAT32G127.h"                   /*!< BAT32G127 System                                                          */
...
typedef struct {                                /*!< (@ 0x40020400) CGC Structure                                              */
  ...
  __IOM uint8_t   RSTM;                         /*!< (@ 0x0000000C) External reset port mask register                          */
  __IM  uint8_t   RESERVED2[19];
...
typedef struct {                                /*!< (@ 0x40040000) PORT Structure                                             */
  ...
  __IOM uint16_t  PDH;                          /*!< (@ 0x0000003E) Pull-down resistor option register H                       */
  ...
  __IM  uint16_t  PREADA;                       /*!< (@ 0x00000080) Port read register A                                       */
  __IM  uint16_t  PREADB;                       /*!< (@ 0x00000082) Port read register B                                       */
  __IM  uint16_t  PREADC;                       /*!< (@ 0x00000084) Port read register C                                       */
  __IM  uint16_t  PREADD;                       /*!< (@ 0x00000086) Port read register D                                       */
  __IM  uint16_t  RESERVED8[3];
  __IM  uint16_t  PREADH;                       /*!< (@ 0x0000008E) Port read register H                                       */
  __IM  uint16_t  RESERVED9[440];
  __IOM uint8_t   PA00CFG;                      /*!< (@ 0x00000400) Port multiplexing function configuration                   */
  __IOM uint8_t   PA01CFG;                      /*!< (@ 0x00000401) Port multiplexing function configuration                   */
  __IOM uint8_t   PA02CFG;                      /*!< (@ 0x00000402) Port multiplexing function configuration                   */
  __IOM uint8_t   PA03CFG;                      /*!< (@ 0x00000403) Port multiplexing function configuration                   */
  __IOM uint8_t   PA04CFG;                      /*!< (@ 0x00000404) Port multiplexing function configuration                   */
  __IOM uint8_t   PA05CFG;                      /*!< (@ 0x00000405) Port multiplexing function configuration                   */
  __IOM uint8_t   PA06CFG;                      /*!< (@ 0x00000406) Port multiplexing function configuration                   */
  __IOM uint8_t   PA07CFG;                      /*!< (@ 0x00000407) Port multiplexing function configuration                   */
  __IOM uint8_t   PA08CFG;                      /*!< (@ 0x00000408) Port multiplexing function configuration                   */
  __IOM uint8_t   PA09CFG;                      /*!< (@ 0x00000409) Port multiplexing function configuration                   */
  __IOM uint8_t   PA10CFG;                      /*!< (@ 0x0000040A) Port multiplexing function configuration                   */
  __IOM uint8_t   PA11CFG;                      /*!< (@ 0x0000040B) Port multiplexing function configuration                   */
  __IOM uint8_t   PA12CFG;                      /*!< (@ 0x0000040C) Port multiplexing function configuration                   */
  __IOM uint8_t   PA13CFG;                      /*!< (@ 0x0000040D) Port multiplexing function configuration                   */
  __IOM uint8_t   PA14CFG;                      /*!< (@ 0x0000040E) Port multiplexing function configuration                   */
  __IOM uint8_t   PA15CFG;                      /*!< (@ 0x0000040F) Port multiplexing function configuration                   */
  __IOM uint8_t   PB00CFG;                      /*!< (@ 0x00000410) Port multiplexing function configuration                   */
  __IOM uint8_t   PB01CFG;                      /*!< (@ 0x00000411) Port multiplexing function configuration                   */
  __IOM uint8_t   PB02CFG;                      /*!< (@ 0x00000412) Port multiplexing function configuration                   */
  __IOM uint8_t   PB03CFG;                      /*!< (@ 0x00000413) Port multiplexing function configuration                   */
  __IOM uint8_t   PB04CFG;                      /*!< (@ 0x00000414) Port multiplexing function configuration                   */
  __IOM uint8_t   PB05CFG;                      /*!< (@ 0x00000415) Port multiplexing function configuration                   */
  __IOM uint8_t   PB06CFG;                      /*!< (@ 0x00000416) Port multiplexing function configuration                   */
  __IOM uint8_t   PB07CFG;                      /*!< (@ 0x00000417) Port multiplexing function configuration                   */
  __IOM uint8_t   PB08CFG;                      /*!< (@ 0x00000418) Port multiplexing function configuration                   */
  __IOM uint8_t   PB09CFG;                      /*!< (@ 0x00000419) Port multiplexing function configuration                   */
  __IOM uint8_t   PB10CFG;                      /*!< (@ 0x0000041A) Port multiplexing function configuration                   */
  __IOM uint8_t   PB11CFG;                      /*!< (@ 0x0000041B) Port multiplexing function configuration                   */
  __IOM uint8_t   PB12CFG;                      /*!< (@ 0x0000041C) Port multiplexing function configuration                   */
  __IOM uint8_t   PB13CFG;                      /*!< (@ 0x0000041D) Port multiplexing function configuration                   */
  __IOM uint8_t   PB14CFG;                      /*!< (@ 0x0000041E) Port multiplexing function configuration                   */
  __IOM uint8_t   PB15CFG;                      /*!< (@ 0x0000041F) Port multiplexing function configuration                   */
  __IOM uint8_t   PC00CFG;                      /*!< (@ 0x00000420) Port multiplexing function configuration                   */
  __IOM uint8_t   PC01CFG;                      /*!< (@ 0x00000421) Port multiplexing function configuration                   */
  __IOM uint8_t   PC02CFG;                      /*!< (@ 0x00000422) Port multiplexing function configuration                   */
  __IOM uint8_t   PC03CFG;                      /*!< (@ 0x00000423) Port multiplexing function configuration                   */
  __IOM uint8_t   PC04CFG;                      /*!< (@ 0x00000424) Port multiplexing function configuration                   */
  __IOM uint8_t   PC05CFG;                      /*!< (@ 0x00000425) Port multiplexing function configuration                   */
  __IOM uint8_t   PC06CFG;                      /*!< (@ 0x00000426) Port multiplexing function configuration                   */
  __IOM uint8_t   PC07CFG;                      /*!< (@ 0x00000427) Port multiplexing function configuration                   */
  __IOM uint8_t   PC08CFG;                      /*!< (@ 0x00000428) Port multiplexing function configuration                   */
  __IOM uint8_t   PC09CFG;                      /*!< (@ 0x00000429) Port multiplexing function configuration                   */
  __IOM uint8_t   PC10CFG;                      /*!< (@ 0x0000042A) Port multiplexing function configuration                   */
  __IOM uint8_t   PC11CFG;                      /*!< (@ 0x0000042B) Port multiplexing function configuration                   */
  __IOM uint8_t   PC12CFG;                      /*!< (@ 0x0000042C) Port multiplexing function configuration                   */
  __IOM uint8_t   PC13CFG;                      /*!< (@ 0x0000042D) Port multiplexing function configuration                   */
  __IOM uint8_t   PC14CFG;                      /*!< (@ 0x0000042E) Port multiplexing function configuration                   */
  __IOM uint8_t   PC15CFG;                      /*!< (@ 0x0000042F) Port multiplexing function configuration                   */
  __IOM uint8_t   PD00CFG;                      /*!< (@ 0x00000430) Port multiplexing function configuration                   */
  __IOM uint8_t   PD01CFG;                      /*!< (@ 0x00000431) Port multiplexing function configuration                   */
  __IOM uint8_t   PD02CFG;                      /*!< (@ 0x00000432) Port multiplexing function configuration                   */
  __IOM uint8_t   PD03CFG;                      /*!< (@ 0x00000433) Port multiplexing function configuration                   */
  __IOM uint8_t   PD04CFG;                      /*!< (@ 0x00000434) Port multiplexing function configuration                   */
  __IOM uint8_t   PD05CFG;                      /*!< (@ 0x00000435) Port multiplexing function configuration                   */
  __IOM uint8_t   PD06CFG;                      /*!< (@ 0x00000436) Port multiplexing function configuration                   */
  __IOM uint8_t   PD07CFG;                      /*!< (@ 0x00000437) Port multiplexing function configuration                   */
  __IOM uint8_t   PD08CFG;                      /*!< (@ 0x00000438) Port multiplexing function configuration                   */
  __IOM uint8_t   PD09CFG;                      /*!< (@ 0x00000439) Port multiplexing function configuration                   */
  __IOM uint8_t   PD10CFG;                      /*!< (@ 0x0000043A) Port multiplexing function configuration                   */
  __IOM uint8_t   PD11CFG;                      /*!< (@ 0x0000043B) Port multiplexing function configuration                   */
  __IOM uint8_t   PD12CFG;                      /*!< (@ 0x0000043C) Port multiplexing function configuration                   */
  __IOM uint8_t   PD13CFG;                      /*!< (@ 0x0000043D) Port multiplexing function configuration                   */
  __IOM uint8_t   PD14CFG;                      /*!< (@ 0x0000043E) Port multiplexing function configuration                   */
  __IOM uint8_t   PD15CFG;                      /*!< (@ 0x0000043F) Port multiplexing function configuration                   */
  __IM  uint16_t  RESERVED10[32];
  __IOM uint8_t   PH00CFG;                      /*!< (@ 0x00000480) Port multiplexing function configuration                   */
  __IOM uint8_t   PH01CFG;                      /*!< (@ 0x00000481) Port multiplexing function configuration                   */
  __IOM uint8_t   PH02CFG;                      /*!< (@ 0x00000482) Port multiplexing function configuration                   */
  __IOM uint8_t   PH03CFG;                      /*!< (@ 0x00000483) Port multiplexing function configuration                   */
  __IOM uint8_t   PH04CFG;                      /*!< (@ 0x00000484) Port multiplexing function configuration                   */
  __IM  uint8_t   RESERVED11;
  __IM  uint16_t  RESERVED12[45];
  __IOM uint8_t   INTP0PCFG;                    /*!< (@ 0x000004E0) Alternate INTP pin configuration register                  */
  __IOM uint8_t   INTP1PCFG;                    /*!< (@ 0x000004E1) Alternate INTP pin configuration register                  */
  __IOM uint8_t   INTP2PCFG;                    /*!< (@ 0x000004E2) Alternate INTP pin configuration register                  */
  __IOM uint8_t   INTP3PCFG;                    /*!< (@ 0x000004E3) Alternate INTP pin configuration register                  */
  __IOM uint8_t   INTP4PCFG;                    /*!< (@ 0x000004E4) Alternate INTP pin configuration register                  */
  __IOM uint8_t   INTP5PCFG;                    /*!< (@ 0x000004E5) Alternate INTP pin configuration register                  */
  __IOM uint8_t   INTP6PCFG;                    /*!< (@ 0x000004E6) Alternate INTP pin configuration register                  */
  __IOM uint8_t   INTP7PCFG;                    /*!< (@ 0x000004E7) Alternate INTP pin configuration register                  */
} PORT_Type;                                    /*!< Size = 1256 (0x4e8)                                                       */
...
/**
  * @brief General Purpose Timer 8 (TM8)
  */

typedef struct {                                /*!< (@ 0x40043000) TM8 Structure                                              */
  ...
  __IM  uint16_t  TCR04;                        /*!< (@ 0x00000008) Timer count register 04                                    */
  __IM  uint16_t  TCR05;                        /*!< (@ 0x0000000A) Timer count register 05                                    */
  __IM  uint16_t  TCR06;                        /*!< (@ 0x0000000C) Timer count register 06                                    */
  __IM  uint16_t  TCR07;                        /*!< (@ 0x0000000E) Timer count register 07                                    */
  ...
  __IOM uint16_t  TMR04;                        /*!< (@ 0x00000018) Timer mode register mn                                     */
  __IOM uint16_t  TMR05;                        /*!< (@ 0x0000001A) Timer mode register mn                                     */
  __IOM uint16_t  TMR06;                        /*!< (@ 0x0000001C) Timer mode register mn                                     */
  __IOM uint16_t  TMR07;                        /*!< (@ 0x0000001E) Timer mode register mn                                     */
  ...
  __IM  uint16_t  TSR04;                        /*!< (@ 0x00000028) Timer status register mn                                   */
  __IM  uint16_t  TSR05;                        /*!< (@ 0x0000002A) Timer status register mn                                   */
  __IM  uint16_t  TSR06;                        /*!< (@ 0x0000002C) Timer status register mn                                   */
  __IM  uint16_t  TSR07;                        /*!< (@ 0x0000002E) Timer status register mn                                   */
  ...
  __IOM uint16_t  TDR00;                        /*!< (@ 0x00000040) Timer data register 00                                     */
  __IOM uint16_t  TDR01;                        /*!< (@ 0x00000042) Timer data register 01                                     */
  __IOM uint16_t  TDR02;                        /*!< (@ 0x00000044) Timer data register 02                                     */
  __IOM uint16_t  TDR03;                        /*!< (@ 0x00000046) Timer data register 03                                     */
  __IOM uint16_t  TDR04;                        /*!< (@ 0x00000048) Timer data register 04                                     */
  __IOM uint16_t  TDR05;                        /*!< (@ 0x0000004A) Timer data register 05                                     */
  __IOM uint16_t  TDR06;                        /*!< (@ 0x0000004C) Timer data register 06                                     */
  __IOM uint16_t  TDR07;                        /*!< (@ 0x0000004E) Timer data register 07                                     */
} TM8_Type;                                     /*!< Size = 80 (0x50)                                                          */
...
typedef struct {                                /*!< (@ 0x40044000) TMA Structure                                              */
  __IOM uint8_t   TACR0;                        /*!< (@ 0x00000000) Timer A control register 0                                 */
  __IOM uint8_t   TAIOC0;                       /*!< (@ 0x00000001) Timer A I/O control register 0                             */
  __IOM uint8_t   TAMR0;                        /*!< (@ 0x00000002) Timer A mode control register 0                            */
  __IOM uint8_t   TAISR0;                       /*!< (@ 0x00000003) Timer A event pin selection register 0                     */
  __IOM uint16_t  TA0;                          /*!< (@ 0x00000004) Timer A count register 0                                   */
} TMA_Type;                                     /*!< Size = 6 (0x6)                                                            */
...
typedef struct {                                /*!< (@ 0x40042400) RTC Structure                                              */
  __IOM uint16_t  ITMC;                         /*!< (@ 0x00000000) 15-bit interval timer control register                     */
  __IOM uint8_t   SEC;                          /*!< (@ 0x00000002) Second count register                                      */
  __IOM uint8_t   MIN;                          /*!< (@ 0x00000003) Minute count register                                      */
  __IOM uint8_t   HOUR;                         /*!< (@ 0x00000004) Hour count register                                        */
  __IOM uint8_t   WEEK;                         /*!< (@ 0x00000005) Week count register                                        */
  __IOM uint8_t   DAY;                          /*!< (@ 0x00000006) Day count register                                         */
  __IOM uint8_t   MONTH;                        /*!< (@ 0x00000007) Month count register                                       */
  __IOM uint8_t   YEAR;                         /*!< (@ 0x00000008) Year count register                                        */
  __IM  uint8_t   RESERVED;
  __IOM uint8_t   ALARMWM;                      /*!< (@ 0x0000000A) Alarm minute register                                      */
  __IOM uint8_t   ALARMWH;                      /*!< (@ 0x0000000B) Alarm hour register                                        */
  __IOM uint8_t   ALARMWW;                      /*!< (@ 0x0000000C) Alarm week register                                        */
  __IOM uint8_t   RTCC0;                        /*!< (@ 0x0000000D) Real-time clock control register 0                         */
  __IOM uint8_t   RTCC1;                        /*!< (@ 0x0000000E) Real-time clock control register 1                         */
  __IM  uint8_t   RESERVED1;
  __IM  uint16_t  RESERVED2[2];
  __IOM uint16_t  SUBCUD;                       /*!< (@ 0x00000014) Watch error correction register                            */
} RTC_Type;                                     /*!< Size = 22 (0x16)                                                          */
...
typedef struct {                                /*!< (@ 0x40041000) PCBZ Structure                                             */
  __IOM uint8_t   CKS1;                         /*!< (@ 0x00000000) Clock output select registers 1                            */
  __IOM uint8_t   CKS0;                         /*!< (@ 0x00000001) Clock output select registers 0                            */
} PCBZ_Type;                                    /*!< Size = 2 (0x2)                                                            */
...
typedef struct {                                /*!< (@ 0x40020404) WDT Structure                                              */
  ...
  __IM  uint8_t   RESERVED1;
  __IOM uint8_t   WDTCFG0;                      /*!< (@ 0x00000004) WDTCFG0 configuration register                             */
  __IOM uint8_t   WDTCFG1;                      /*!< (@ 0x00000005) WDTCFG1 configuration register                             */
  __IOM uint8_t   WDTCFG2;                      /*!< (@ 0x00000006) WDTCFG2 configuration register                             */
  __IOM uint8_t   WDTCFG3;                      /*!< (@ 0x00000007) WDTCFG3 configuration register                             */
  __IM  uint8_t   RESERVED2[3061];
...
typedef struct {                                /*!< (@ 0x40045400) DAC Structure                                              */
...
typedef struct {                                /*!< (@ 0x40045800) CMP Structure                                              */
  ...
  __IOM uint8_t   C0REFS;                       /*!< (@ 0x00000008) Negative end reference selection register of
                                                                    comparator 0                                               */
  __IOM uint8_t   C1REFS;                       /*!< (@ 0x00000009) Negative end reference selection register of
                                                                    comparator 1                                               */
...
typedef struct {                                /*!< (@ 0x40045C00) OPA Structure                                              */
  __IOM uint8_t   OPACTL;                       /*!< (@ 0x00000000) Operational amplifier control register                     */
  __IM  uint8_t   RESERVED[3];
  __IOM uint8_t   OPADAC;                       /*!< (@ 0x00000004) Operational amplifier digital analog control
                                                                    register                                                   */
} OPA_Type;                                     /*!< Size = 5 (0x5)                                                            */
...
typedef struct {                                /*!< (@ 0x40046000) SCI0 Structure                                             */
  ...
  __IOM uint16_t  SSE0;                         /*!< (@ 0x00000022) Slave selection function enable register 0                 */
  __IOM uint16_t  SSC0;                         /*!< (@ 0x00000024) Serial standby control register 0                          */
...
typedef struct {                                /*!< (@ 0x40046400) SCI1 Structure                                             */
  ...
  __IOM uint16_t  SSE0;                         /*!< (@ 0x00000022) Slave selection function enable register 0                 */
  __IOM uint16_t  SSC1;                         /*!< (@ 0x00000024) Serial standby control register 1                          */
  __IM  uint16_t  RESERVED1[13];
...
typedef struct {                                /*!< (@ 0x40046800) SCI2 Structure                                             */
  ...
  __IOM uint16_t  SSE0;                         /*!< (@ 0x00000022) Slave selection function enable register 0                 */
  __IOM uint16_t  SSC2;                         /*!< (@ 0x00000024) Serial standby control register 2                          */
  __IM  uint16_t  RESERVED1[13];
...
typedef struct {                                /*!< (@ 0x40047800) SPIHS0 Structure                                           */
  ...
  __IM  uint16_t  SDRI;                         /*!< (@ 0x0000000C) Data buffer of reception                                   */
  __IM  uint16_t  RESERVED5;
  __IM  uint32_t  SPIS;                         /*!< (@ 0x00000010) SPI status register                                        */
...
typedef struct {                                /*!< (@ 0x40047000) IICA0 Structure                                            */
  ...
  __IM  uint8_t   RESERVED[3];
  __IOM uint8_t   IICA00;                       /*!< (@ 0x00000008) IICA0 shift register                                       */
  __IM  uint8_t   IICS0;                        /*!< (@ 0x00000009) IICA0 status register                                      */
  __IOM uint8_t   IICF0;                        /*!< (@ 0x0000000A) IICA0 flag register                                        */
} IICA0_Type;                                   /*!< Size = 11 (0xb)                                                           */
...
typedef struct {                                /*!< (@ 0x40048000) IRDA Structure                                             */
...
typedef struct {                                /*!< (@ 0x40049000) LCD Structure                                              */
  __IOM uint8_t   SEG0;                         /*!< (@ 0x00000000) LCD display data register 0                                */
  __IOM uint8_t   SEG1;                         /*!< (@ 0x00000001) LCD display data register 1                                */
  __IOM uint8_t   SEG2;                         /*!< (@ 0x00000002) LCD display data register 2                                */
  __IOM uint8_t   SEG3;                         /*!< (@ 0x00000003) LCD display data register 3                                */
  __IOM uint8_t   SEG4;                         /*!< (@ 0x00000004) LCD display data register 4                                */
  __IOM uint8_t   SEG5;                         /*!< (@ 0x00000005) LCD display data register 5                                */
  __IOM uint8_t   SEG6;                         /*!< (@ 0x00000006) LCD display data register 6                                */
  __IOM uint8_t   SEG7;                         /*!< (@ 0x00000007) LCD display data register 7                                */
  __IOM uint8_t   SEG8;                         /*!< (@ 0x00000008) LCD display data register 8                                */
  __IOM uint8_t   SEG9;                         /*!< (@ 0x00000009) LCD display data register 9                                */
  __IOM uint8_t   SEG10;                        /*!< (@ 0x0000000A) LCD display data register 10                               */
  __IOM uint8_t   SEG11;                        /*!< (@ 0x0000000B) LCD display data register 11                               */
  __IOM uint8_t   SEG12;                        /*!< (@ 0x0000000C) LCD display data register 12                               */
  __IOM uint8_t   SEG13;                        /*!< (@ 0x0000000D) LCD display data register 13                               */
  __IOM uint8_t   SEG14;                        /*!< (@ 0x0000000E) LCD display data register 14                               */
  __IOM uint8_t   SEG15;                        /*!< (@ 0x0000000F) LCD display data register 15                               */
  __IOM uint8_t   SEG16;                        /*!< (@ 0x00000010) LCD display data register 16                               */
  __IOM uint8_t   SEG17;                        /*!< (@ 0x00000011) LCD display data register 17                               */
  __IOM uint8_t   SEG18;                        /*!< (@ 0x00000012) LCD display data register 18                               */
  __IOM uint8_t   SEG19;                        /*!< (@ 0x00000013) LCD display data register 19                               */
  __IOM uint8_t   SEG20;                        /*!< (@ 0x00000014) LCD display data register 20                               */
  __IOM uint8_t   SEG21;                        /*!< (@ 0x00000015) LCD display data register 21                               */
  __IOM uint8_t   SEG22;                        /*!< (@ 0x00000016) LCD display data register 22                               */
  __IOM uint8_t   SEG23;                        /*!< (@ 0x00000017) LCD display data register 23                               */
  __IOM uint8_t   SEG24;                        /*!< (@ 0x00000018) LCD display data register 24                               */
  __IOM uint8_t   SEG25;                        /*!< (@ 0x00000019) LCD display data register 25                               */
  __IOM uint8_t   SEG26;                        /*!< (@ 0x0000001A) LCD display data register 26                               */
  __IOM uint8_t   SEG27;                        /*!< (@ 0x0000001B) LCD display data register 27                               */
  __IOM uint8_t   SEG28;                        /*!< (@ 0x0000001C) LCD display data register 28                               */
  __IOM uint8_t   SEG29;                        /*!< (@ 0x0000001D) LCD display data register 29                               */
  __IOM uint8_t   SEG30;                        /*!< (@ 0x0000001E) LCD display data register 30                               */
  __IOM uint8_t   SEG31;                        /*!< (@ 0x0000001F) LCD display data register 31                               */
  __IOM uint8_t   SEG32;                        /*!< (@ 0x00000020) LCD display data register 32                               */
  __IOM uint8_t   SEG33;                        /*!< (@ 0x00000021) LCD display data register 33                               */
  __IOM uint8_t   SEG34;                        /*!< (@ 0x00000022) LCD display data register 34                               */
  __IOM uint8_t   SEG35;                        /*!< (@ 0x00000023) LCD display data register 35                               */
  __IOM uint8_t   SEG36;                        /*!< (@ 0x00000024) LCD display data register 36                               */
  __IOM uint8_t   SEG37;                        /*!< (@ 0x00000025) LCD display data register 37                               */
  __IOM uint8_t   SEG38;                        /*!< (@ 0x00000026) LCD display data register 38                               */
  __IOM uint8_t   SEG39;                        /*!< (@ 0x00000027) LCD display data register 39                               */
  __IOM uint8_t   SEG40;                        /*!< (@ 0x00000028) LCD display data register 40                               */
  __IOM uint8_t   SEG41;                        /*!< (@ 0x00000029) LCD display data register 41                               */
  __IM  uint8_t   RESERVED[22];
  __IOM uint8_t   LCDM0;                        /*!< (@ 0x00000040) LCD mode register 0                                        */
  __IOM uint8_t   LCDM1;                        /*!< (@ 0x00000041) LCD mode register 0                                        */
  __IOM uint8_t   LCDC0;                        /*!< (@ 0x00000042) LCD clock control register 0                               */
  __IOM uint8_t   VLCD;                         /*!< (@ 0x00000043) LCB Boost level control register                           */
} LCD_Type;                                     /*!< Size = 68 (0x44)                                                          */
...
typedef struct {                                /*!< (@ 0x40005000) DMA Structure                                              */
  ...
  __IOM uint8_t   DMSET0;                       /*!< (@ 0x00000018) DMA Set register 0                                         */
  __IOM uint8_t   DMSET1;                       /*!< (@ 0x00000019) DMA Set register 1                                         */
  __IOM uint8_t   DMSET2;                       /*!< (@ 0x0000001A) DMA Set register 2                                         */
  __IM  uint8_t   RESERVED4;
  __IM  uint32_t  RESERVED5;
  __IOM uint8_t   DMCLR0;                       /*!< (@ 0x00000020) DMA Reset register 0                                       */
  __IOM uint8_t   DMCLR1;                       /*!< (@ 0x00000021) DMA Reset register 1                                       */
  __IOM uint8_t   DMCLR2;                       /*!< (@ 0x00000022) DMA Reset register 2                                       */
  __IM  uint8_t   RESERVED6;
} DMA_Type;                                     /*!< Size = 36 (0x24)                                                          */
...
typedef struct {                                /*!< (@ 0x20000000) DMAVEC Structure                                           */
  __IOM uint8_t   VEC[24];                      /*!< (@ 0x00000000) DMA vector area                                            */
...
typedef struct {                                /*!< (@ 0x40041800) ELC Structure                                              */
...
typedef struct {                                /*!< (@ 0x40041C00) INTM Structure                                             */
...
typedef struct {                                /*!< (@ 0x40042000) KEY Structure                                              */
  __IM  uint8_t   RESERVED;
  __IOM uint8_t   KRM;                          /*!< (@ 0x00000001) Key return mode register                                   */
} KEY_Type;                                     /*!< Size = 2 (0x2)                                                            */
...
typedef struct {                                /*!< (@ 0x40040800) PPORGA Structure                                           */
  __IOM uint8_t   PMS;                          /*!< (@ 0x00000000) Clock output select registers 0                            */
  __IOM uint8_t   GDIDIS;                       /*!< (@ 0x00000001) GDIDIS                                                     */
  __IM  uint16_t  RESERVED;
  __IOM uint16_t  ISCLCD;                       /*!< (@ 0x00000004) LCD Input switching control register                       */
  __IOM uint16_t  SEGEN0;                       /*!< (@ 0x00000006) LCD port function register 0                               */
  __IOM uint16_t  SEGEN1;                       /*!< (@ 0x00000008) LCD port function register 1                               */
  __IOM uint16_t  SEGEN2;                       /*!< (@ 0x0000000A) LCD port function register 2                               */
  __IOM uint16_t  SEGEN3;                       /*!< (@ 0x0000000C) LCD port function register 3                               */
} PPORGA_Type;                                  /*!< Size = 14 (0xe)                                                           */
...
typedef struct {                                /*!< (@ 0x40040C00) MISC Structure                                             */
...
typedef struct {                                /*!< (@ 0x40020100) SAF Structure                                              */
  ...
  __IM  uint16_t  RESERVED4[63994];
  __IOM uint16_t  SFRGD;                        /*!< (@ 0x00020B08) SFR guard control register                                 */
  __IM  uint16_t  RESERVED5[1019];
  __IOM uint8_t   CRCIN;                        /*!< (@ 0x00021300) CRC input register                                         */
  __IM  uint8_t   RESERVED6;
  __IOM uint16_t  CRCD;                         /*!< (@ 0x00021302) CRC data register                                          */
} SAF_Type;                                     /*!< Size = 135940 (0x21304)                                                   */
...
typedef struct {                                /*!< (@ 0x40022400) OCRV Structure                                             */
  __IOM uint8_t   HOCOFC;                       /*!< (@ 0x00000000) High speed internal vibration frequency correction
                                                                    control register                                           */
} OCRV_Type;                                    /*!< Size = 1 (0x1)                                                            */
...
/**
  * @brief Internal reference voltage calibration data (BGR)
  */

typedef struct {                                /*!< (@ 0x00500C64) BGR Structure                                              */
  __IM  uint16_t  VDDCDR;                       /*!< (@ 0x00000000) The A/D conversion value of VBGR at 25 degrees
...
typedef struct {                                /*!< (@ 0x00500E4C) UID Structure                                              */
  ...
  __IM  uint32_t  UID1;                         /*!< (@ 0x00000028) UID word 1                                                 */
  __IM  uint32_t  UID2;                         /*!< (@ 0x0000002C) UID word 2                                                 */
  __IM  uint32_t  UID3;                         /*!< (@ 0x00000030) UID word 3                                                 */
} UID_Type;                                     /*!< Size = 52 (0x34)                                                          */
...
#define TM8_BASE                    0x40043000UL
#define TMA_BASE                    0x40044000UL
#define RTC_BASE                    0x40042400UL
#define PCBZ_BASE                   0x40041000UL
#define WDT_BASE                    0x40020404UL
#define ADC_BASE                    0x40045000UL
#define DAC_BASE                    0x40045400UL
#define CMP_BASE                    0x40045800UL
#define OPA_BASE                    0x40045C00UL
#define SCI0_BASE                   0x40046000UL
#define SCI1_BASE                   0x40046400UL
#define SCI2_BASE                   0x40046800UL
#define SPIHS0_BASE                 0x40047800UL
#define IICA0_BASE                  0x40047000UL
#define IRDA_BASE                   0x40048000UL
#define LCD_BASE                    0x40049000UL
#define DMA_BASE                    0x40005000UL
#define DMAVEC_BASE                 0x20000000UL
#define ELC_BASE                    0x40041800UL
#define INT_BASE                    0x40006000UL
#define INTM_BASE                   0x40041C00UL
#define KEY_BASE                    0x40042000UL
#define PPORGA_BASE                 0x40040800UL
#define MISC_BASE                   0x40040C00UL
...
/* =========================================================  PER0  ========================================================== */
#define CGC_PER0_TM8EN_Pos                (0UL)                     /*!< CGC PER0: TM8EN (Bit 0)                               */
#define CGC_PER0_TM8EN_Msk                (0x1UL)                   /*!< CGC PER0: TM8EN (Bitfield-Mask: 0x01)                 */
#define CGC_PER0_TMAEN_Pos                (1UL)                     /*!< CGC PER0: TMAEN (Bit 1)                               */
#define CGC_PER0_TMAEN_Msk                (0x2UL)                   /*!< CGC PER0: TMAEN (Bitfield-Mask: 0x01)                 */
...
#define CGC_PER0_IRDAEN_Pos               (5UL)                     /*!< CGC PER0: IRDAEN (Bit 5)                              */
#define CGC_PER0_IRDAEN_Msk               (0x20UL)                  /*!< CGC PER0: IRDAEN (Bitfield-Mask: 0x01)                */
#define CGC_PER0_IICAEN_Pos               (6UL)                     /*!< CGC PER0: IICAEN (Bit 6)                              */
#define CGC_PER0_IICAEN_Msk               (0x40UL)                  /*!< CGC PER0: IICAEN (Bitfield-Mask: 0x01)                */
#define CGC_PER0_RTCEN_Pos                (7UL)                     /*!< CGC PER0: RTCEN (Bit 7)                               */
#define CGC_PER0_RTCEN_Msk                (0x80UL)                  /*!< CGC PER0: RTCEN (Bitfield-Mask: 0x01)                 */
/* =========================================================  PER1  ========================================================== */
#define CGC_PER1_SPIHSEN_Pos              (0UL)                     /*!< CGC PER1: SPIHSEN (Bit 0)                             */
#define CGC_PER1_SPIHSEN_Msk              (0x1UL)                   /*!< CGC PER1: SPIHSEN (Bitfield-Mask: 0x01)               */
#define CGC_PER1_DMAEN_Pos                (1UL)                     /*!< CGC PER1: DMAEN (Bit 1)                               */
#define CGC_PER1_DMAEN_Msk                (0x2UL)                   /*!< CGC PER1: DMAEN (Bitfield-Mask: 0x01)                 */
#define CGC_PER1_OSDCEN_Pos               (2UL)                     /*!< CGC PER1: OSDCEN (Bit 2)                              */
#define CGC_PER1_OSDCEN_Msk               (0x4UL)                   /*!< CGC PER1: OSDCEN (Bitfield-Mask: 0x01)                */
#define CGC_PER1_ADCEN_Pos                (4UL)                     /*!< CGC PER1: ADCEN (Bit 4)                               */
#define CGC_PER1_ADCEN_Msk                (0x10UL)                  /*!< CGC PER1: ADCEN (Bitfield-Mask: 0x01)                 */
#define CGC_PER1_DACEN_Pos                (5UL)                     /*!< CGC PER1: DACEN (Bit 5)                               */
#define CGC_PER1_DACEN_Msk                (0x20UL)                  /*!< CGC PER1: DACEN (Bitfield-Mask: 0x01)                 */
#define CGC_PER1_CMPEN_Pos                (6UL)                     /*!< CGC PER1: CMPEN (Bit 6)                               */
#define CGC_PER1_CMPEN_Msk                (0x40UL)                  /*!< CGC PER1: CMPEN (Bitfield-Mask: 0x01)                 */
#define CGC_PER1_OPAEN_Pos                (7UL)                     /*!< CGC PER1: OPAEN (Bit 7)                               */
#define CGC_PER1_OPAEN_Msk                (0x80UL)                  /*!< CGC PER1: OPAEN (Bitfield-Mask: 0x01)                 */
/* =========================================================  OSMC  ========================================================== */
...
/* =========================================================  RSTM  ========================================================== */
#define CGC_RSTM_RSTM0_Pos                (0UL)                     /*!< CGC RSTM: RSTM0 (Bit 0)                               */
#define CGC_RSTM_RSTM0_Msk                (0x1UL)                   /*!< CGC RSTM: RSTM0 (Bitfield-Mask: 0x01)                 */
/* ========================================================  HOCODIV  ======================================================== */
/* ========================================================  HIOTRM  ========================================================= */
...
#define RST_RESF_CLMRF_Pos                (3UL)                     /*!< RST RESF: CLMRF (Bit 3)                               */
#define RST_RESF_CLMRF_Msk                (0x8UL)                   /*!< RST RESF: CLMRF (Bitfield-Mask: 0x01)                 */
...
#define PORT_INTP0PCFG_CFG_Msk            (0xfUL)                   /*!< PORT INTP0PCFG: CFG (Bitfield-Mask: 0x0f)             */
/* =======================================================  INTP1PCFG  ======================================================= */
#define PORT_INTP1PCFG_CFG_Pos            (0UL)                     /*!< PORT INTP1PCFG: CFG (Bit 0)                           */
#define PORT_INTP1PCFG_CFG_Msk            (0xfUL)                   /*!< PORT INTP1PCFG: CFG (Bitfield-Mask: 0x0f)             */
/* =======================================================  INTP2PCFG  ======================================================= */
#define PORT_INTP2PCFG_CFG_Pos            (0UL)                     /*!< PORT INTP2PCFG: CFG (Bit 0)                           */
#define PORT_INTP2PCFG_CFG_Msk            (0xfUL)                   /*!< PORT INTP2PCFG: CFG (Bitfield-Mask: 0x0f)             */
/* =======================================================  INTP3PCFG  ======================================================= */
#define PORT_INTP3PCFG_CFG_Pos            (0UL)                     /*!< PORT INTP3PCFG: CFG (Bit 0)                           */
#define PORT_INTP3PCFG_CFG_Msk            (0xfUL)                   /*!< PORT INTP3PCFG: CFG (Bitfield-Mask: 0x0f)             */
/* =======================================================  INTP4PCFG  ======================================================= */
#define PORT_INTP4PCFG_CFG_Pos            (0UL)                     /*!< PORT INTP4PCFG: CFG (Bit 0)                           */
#define PORT_INTP4PCFG_CFG_Msk            (0xfUL)                   /*!< PORT INTP4PCFG: CFG (Bitfield-Mask: 0x0f)             */
/* =======================================================  INTP5PCFG  ======================================================= */
#define PORT_INTP5PCFG_CFG_Pos            (0UL)                     /*!< PORT INTP5PCFG: CFG (Bit 0)                           */
#define PORT_INTP5PCFG_CFG_Msk            (0xfUL)                   /*!< PORT INTP5PCFG: CFG (Bitfield-Mask: 0x0f)             */
/* =======================================================  INTP6PCFG  ======================================================= */
/* =======================================================  INTP7PCFG  ======================================================= */
...
/* =========================================================  TCR0  ========================================================== */
/* =========================================================  TMR00  ========================================================= */
#define TM8_TMR00_MD_Pos                  (0UL)                     /*!< TM8 TMR00: MD (Bit 0)                                 */
#define TM8_TMR00_MD_Msk                  (0xfUL)                   /*!< TM8 TMR00: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR00_GTS_Pos                 (4UL)                     /*!< TM8 TMR00: GTS (Bit 4)                                */
#define TM8_TMR00_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR00: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR00_CIS_Pos                 (6UL)                     /*!< TM8 TMR00: CIS (Bit 6)                                */
#define TM8_TMR00_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR00: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR00_STS_Pos                 (8UL)                     /*!< TM8 TMR00: STS (Bit 8)                                */
#define TM8_TMR00_STS_Msk                 (0x700UL)                 /*!< TM8 TMR00: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR00_CCS_Pos                 (12UL)                    /*!< TM8 TMR00: CCS (Bit 12)                               */
#define TM8_TMR00_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR00: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR00_CKS_Pos                 (14UL)                    /*!< TM8 TMR00: CKS (Bit 14)                               */
#define TM8_TMR00_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR00: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TMR01  ========================================================= */
#define TM8_TMR01_MD_Pos                  (0UL)                     /*!< TM8 TMR01: MD (Bit 0)                                 */
#define TM8_TMR01_MD_Msk                  (0xfUL)                   /*!< TM8 TMR01: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR01_GTS_Pos                 (4UL)                     /*!< TM8 TMR01: GTS (Bit 4)                                */
#define TM8_TMR01_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR01: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR01_CIS_Pos                 (6UL)                     /*!< TM8 TMR01: CIS (Bit 6)                                */
#define TM8_TMR01_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR01: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR01_STS_Pos                 (8UL)                     /*!< TM8 TMR01: STS (Bit 8)                                */
#define TM8_TMR01_STS_Msk                 (0x700UL)                 /*!< TM8 TMR01: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR01_CCS_Pos                 (12UL)                    /*!< TM8 TMR01: CCS (Bit 12)                               */
#define TM8_TMR01_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR01: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR01_CKS_Pos                 (14UL)                    /*!< TM8 TMR01: CKS (Bit 14)                               */
#define TM8_TMR01_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR01: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TMR02  ========================================================= */
#define TM8_TMR02_MD_Pos                  (0UL)                     /*!< TM8 TMR02: MD (Bit 0)                                 */
#define TM8_TMR02_MD_Msk                  (0xfUL)                   /*!< TM8 TMR02: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR02_GTS_Pos                 (4UL)                     /*!< TM8 TMR02: GTS (Bit 4)                                */
#define TM8_TMR02_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR02: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR02_CIS_Pos                 (6UL)                     /*!< TM8 TMR02: CIS (Bit 6)                                */
#define TM8_TMR02_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR02: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR02_STS_Pos                 (8UL)                     /*!< TM8 TMR02: STS (Bit 8)                                */
#define TM8_TMR02_STS_Msk                 (0x700UL)                 /*!< TM8 TMR02: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR02_MASTER_Pos              (11UL)                    /*!< TM8 TMR02: MASTER (Bit 11)                            */
#define TM8_TMR02_MASTER_Msk              (0x800UL)                 /*!< TM8 TMR02: MASTER (Bitfield-Mask: 0x01)               */
#define TM8_TMR02_CCS_Pos                 (12UL)                    /*!< TM8 TMR02: CCS (Bit 12)                               */
#define TM8_TMR02_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR02: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR02_CKS_Pos                 (14UL)                    /*!< TM8 TMR02: CKS (Bit 14)                               */
#define TM8_TMR02_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR02: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TMR03  ========================================================= */
#define TM8_TMR03_MD_Pos                  (0UL)                     /*!< TM8 TMR03: MD (Bit 0)                                 */
#define TM8_TMR03_MD_Msk                  (0xfUL)                   /*!< TM8 TMR03: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR03_GTS_Pos                 (4UL)                     /*!< TM8 TMR03: GTS (Bit 4)                                */
#define TM8_TMR03_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR03: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR03_CIS_Pos                 (6UL)                     /*!< TM8 TMR03: CIS (Bit 6)                                */
#define TM8_TMR03_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR03: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR03_STS_Pos                 (8UL)                     /*!< TM8 TMR03: STS (Bit 8)                                */
#define TM8_TMR03_STS_Msk                 (0x700UL)                 /*!< TM8 TMR03: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR03_CCS_Pos                 (12UL)                    /*!< TM8 TMR03: CCS (Bit 12)                               */
#define TM8_TMR03_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR03: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR03_CKS_Pos                 (14UL)                    /*!< TM8 TMR03: CKS (Bit 14)                               */
#define TM8_TMR03_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR03: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TMR04  ========================================================= */
#define TM8_TMR04_MD_Pos                  (0UL)                     /*!< TM8 TMR04: MD (Bit 0)                                 */
#define TM8_TMR04_MD_Msk                  (0xfUL)                   /*!< TM8 TMR04: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR04_GTS_Pos                 (4UL)                     /*!< TM8 TMR04: GTS (Bit 4)                                */
#define TM8_TMR04_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR04: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR04_CIS_Pos                 (6UL)                     /*!< TM8 TMR04: CIS (Bit 6)                                */
#define TM8_TMR04_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR04: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR04_STS_Pos                 (8UL)                     /*!< TM8 TMR04: STS (Bit 8)                                */
#define TM8_TMR04_STS_Msk                 (0x700UL)                 /*!< TM8 TMR04: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR04_MASTER_Pos              (11UL)                    /*!< TM8 TMR04: MASTER (Bit 11)                            */
#define TM8_TMR04_MASTER_Msk              (0x800UL)                 /*!< TM8 TMR04: MASTER (Bitfield-Mask: 0x01)               */
#define TM8_TMR04_CCS_Pos                 (12UL)                    /*!< TM8 TMR04: CCS (Bit 12)                               */
#define TM8_TMR04_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR04: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR04_CKS_Pos                 (14UL)                    /*!< TM8 TMR04: CKS (Bit 14)                               */
#define TM8_TMR04_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR04: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TMR05  ========================================================= */
#define TM8_TMR05_MD_Pos                  (0UL)                     /*!< TM8 TMR05: MD (Bit 0)                                 */
#define TM8_TMR05_MD_Msk                  (0xfUL)                   /*!< TM8 TMR05: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR05_GTS_Pos                 (4UL)                     /*!< TM8 TMR05: GTS (Bit 4)                                */
#define TM8_TMR05_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR05: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR05_CIS_Pos                 (6UL)                     /*!< TM8 TMR05: CIS (Bit 6)                                */
#define TM8_TMR05_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR05: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR05_STS_Pos                 (8UL)                     /*!< TM8 TMR05: STS (Bit 8)                                */
#define TM8_TMR05_STS_Msk                 (0x700UL)                 /*!< TM8 TMR05: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR05_CCS_Pos                 (12UL)                    /*!< TM8 TMR05: CCS (Bit 12)                               */
#define TM8_TMR05_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR05: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR05_CKS_Pos                 (14UL)                    /*!< TM8 TMR05: CKS (Bit 14)                               */
#define TM8_TMR05_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR05: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TMR06  ========================================================= */
#define TM8_TMR06_MD_Pos                  (0UL)                     /*!< TM8 TMR06: MD (Bit 0)                                 */
#define TM8_TMR06_MD_Msk                  (0xfUL)                   /*!< TM8 TMR06: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR06_GTS_Pos                 (4UL)                     /*!< TM8 TMR06: GTS (Bit 4)                                */
#define TM8_TMR06_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR06: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR06_CIS_Pos                 (6UL)                     /*!< TM8 TMR06: CIS (Bit 6)                                */
#define TM8_TMR06_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR06: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR06_STS_Pos                 (8UL)                     /*!< TM8 TMR06: STS (Bit 8)                                */
#define TM8_TMR06_STS_Msk                 (0x700UL)                 /*!< TM8 TMR06: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR06_MASTER_Pos              (11UL)                    /*!< TM8 TMR06: MASTER (Bit 11)                            */
#define TM8_TMR06_MASTER_Msk              (0x800UL)                 /*!< TM8 TMR06: MASTER (Bitfield-Mask: 0x01)               */
#define TM8_TMR06_CCS_Pos                 (12UL)                    /*!< TM8 TMR06: CCS (Bit 12)                               */
#define TM8_TMR06_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR06: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR06_CKS_Pos                 (14UL)                    /*!< TM8 TMR06: CKS (Bit 14)                               */
#define TM8_TMR06_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR06: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TMR07  ========================================================= */
#define TM8_TMR07_MD_Pos                  (0UL)                     /*!< TM8 TMR07: MD (Bit 0)                                 */
#define TM8_TMR07_MD_Msk                  (0xfUL)                   /*!< TM8 TMR07: MD (Bitfield-Mask: 0x0f)                   */
#define TM8_TMR07_GTS_Pos                 (4UL)                     /*!< TM8 TMR07: GTS (Bit 4)                                */
#define TM8_TMR07_GTS_Msk                 (0x30UL)                  /*!< TM8 TMR07: GTS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR07_CIS_Pos                 (6UL)                     /*!< TM8 TMR07: CIS (Bit 6)                                */
#define TM8_TMR07_CIS_Msk                 (0xc0UL)                  /*!< TM8 TMR07: CIS (Bitfield-Mask: 0x03)                  */
#define TM8_TMR07_STS_Pos                 (8UL)                     /*!< TM8 TMR07: STS (Bit 8)                                */
#define TM8_TMR07_STS_Msk                 (0x700UL)                 /*!< TM8 TMR07: STS (Bitfield-Mask: 0x07)                  */
#define TM8_TMR07_CCS_Pos                 (12UL)                    /*!< TM8 TMR07: CCS (Bit 12)                               */
#define TM8_TMR07_CCS_Msk                 (0x1000UL)                /*!< TM8 TMR07: CCS (Bitfield-Mask: 0x01)                  */
#define TM8_TMR07_CKS_Pos                 (14UL)                    /*!< TM8 TMR07: CKS (Bit 14)                               */
#define TM8_TMR07_CKS_Msk                 (0xc000UL)                /*!< TM8 TMR07: CKS (Bitfield-Mask: 0x03)                  */
/* =========================================================  TSR00  ========================================================= */
#define TM8_TSR00_OVF_Pos                 (0UL)                     /*!< TM8 TSR00: OVF (Bit 0)                                */
#define TM8_TSR00_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR00: OVF (Bitfield-Mask: 0x01)                  */
/* =========================================================  TSR01  ========================================================= */
#define TM8_TSR01_OVF_Pos                 (0UL)                     /*!< TM8 TSR01: OVF (Bit 0)                                */
#define TM8_TSR01_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR01: OVF (Bitfield-Mask: 0x01)                  */
/* =========================================================  TSR02  ========================================================= */
#define TM8_TSR02_OVF_Pos                 (0UL)                     /*!< TM8 TSR02: OVF (Bit 0)                                */
#define TM8_TSR02_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR02: OVF (Bitfield-Mask: 0x01)                  */
/* =========================================================  TSR03  ========================================================= */
#define TM8_TSR03_OVF_Pos                 (0UL)                     /*!< TM8 TSR03: OVF (Bit 0)                                */
#define TM8_TSR03_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR03: OVF (Bitfield-Mask: 0x01)                  */
/* =========================================================  TSR04  ========================================================= */
#define TM8_TSR04_OVF_Pos                 (0UL)                     /*!< TM8 TSR04: OVF (Bit 0)                                */
#define TM8_TSR04_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR04: OVF (Bitfield-Mask: 0x01)                  */
/* =========================================================  TSR05  ========================================================= */
#define TM8_TSR05_OVF_Pos                 (0UL)                     /*!< TM8 TSR05: OVF (Bit 0)                                */
#define TM8_TSR05_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR05: OVF (Bitfield-Mask: 0x01)                  */
/* =========================================================  TSR06  ========================================================= */
#define TM8_TSR06_OVF_Pos                 (0UL)                     /*!< TM8 TSR06: OVF (Bit 0)                                */
#define TM8_TSR06_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR06: OVF (Bitfield-Mask: 0x01)                  */
/* =========================================================  TSR07  ========================================================= */
#define TM8_TSR07_OVF_Pos                 (0UL)                     /*!< TM8 TSR07: OVF (Bit 0)                                */
#define TM8_TSR07_OVF_Msk                 (0x1UL)                   /*!< TM8 TSR07: OVF (Bitfield-Mask: 0x01)                  */
/* ==========================================================  TE0  ========================================================== */
#define TM8_TE0_TE00_Pos                  (0UL)                     /*!< TM8 TE0: TE00 (Bit 0)                                 */
#define TM8_TE0_TE00_Msk                  (0x1UL)                   /*!< TM8 TE0: TE00 (Bitfield-Mask: 0x01)                   */
#define TM8_TE0_TE01_Pos                  (1UL)                     /*!< TM8 TE0: TE01 (Bit 1)                                 */
#define TM8_TE0_TE01_Msk                  (0x2UL)                   /*!< TM8 TE0: TE01 (Bitfield-Mask: 0x01)                   */
#define TM8_TE0_TE02_Pos                  (2UL)                     /*!< TM8 TE0: TE02 (Bit 2)                                 */
#define TM8_TE0_TE02_Msk                  (0x4UL)                   /*!< TM8 TE0: TE02 (Bitfield-Mask: 0x01)                   */
#define TM8_TE0_TE03_Pos                  (3UL)                     /*!< TM8 TE0: TE03 (Bit 3)                                 */
#define TM8_TE0_TE03_Msk                  (0x8UL)                   /*!< TM8 TE0: TE03 (Bitfield-Mask: 0x01)                   */
#define TM8_TE0_TE04_Pos                  (4UL)                     /*!< TM8 TE0: TE04 (Bit 4)                                 */
#define TM8_TE0_TE04_Msk                  (0x10UL)                  /*!< TM8 TE0: TE04 (Bitfield-Mask: 0x01)                   */
#define TM8_TE0_TE05_Pos                  (5UL)                     /*!< TM8 TE0: TE05 (Bit 5)                                 */
#define TM8_TE0_TE05_Msk                  (0x20UL)                  /*!< TM8 TE0: TE05 (Bitfield-Mask: 0x01)                   */
#define TM8_TE0_TE06_Pos                  (6UL)                     /*!< TM8 TE0: TE06 (Bit 6)                                 */
#define TM8_TE0_TE06_Msk                  (0x40UL)                  /*!< TM8 TE0: TE06 (Bitfield-Mask: 0x01)                   */
#define TM8_TE0_TE07_Pos                  (7UL)                     /*!< TM8 TE0: TE07 (Bit 7)                                 */
#define TM8_TE0_TE07_Msk                  (0x80UL)                  /*!< TM8 TE0: TE07 (Bitfield-Mask: 0x01)                   */
/* ==========================================================  TS0  ========================================================== */
#define TM8_TS0_TS00_Pos                  (0UL)                     /*!< TM8 TS0: TS00 (Bit 0)                                 */
#define TM8_TS0_TS00_Msk                  (0x1UL)                   /*!< TM8 TS0: TS00 (Bitfield-Mask: 0x01)                   */
#define TM8_TS0_TS01_Pos                  (1UL)                     /*!< TM8 TS0: TS01 (Bit 1)                                 */
#define TM8_TS0_TS01_Msk                  (0x2UL)                   /*!< TM8 TS0: TS01 (Bitfield-Mask: 0x01)                   */
#define TM8_TS0_TS02_Pos                  (2UL)                     /*!< TM8 TS0: TS02 (Bit 2)                                 */
#define TM8_TS0_TS02_Msk                  (0x4UL)                   /*!< TM8 TS0: TS02 (Bitfield-Mask: 0x01)                   */
#define TM8_TS0_TS03_Pos                  (3UL)                     /*!< TM8 TS0: TS03 (Bit 3)                                 */
#define TM8_TS0_TS03_Msk                  (0x8UL)                   /*!< TM8 TS0: TS03 (Bitfield-Mask: 0x01)                   */
#define TM8_TS0_TS04_Pos                  (4UL)                     /*!< TM8 TS0: TS04 (Bit 4)                                 */
#define TM8_TS0_TS04_Msk                  (0x10UL)                  /*!< TM8 TS0: TS04 (Bitfield-Mask: 0x01)                   */
#define TM8_TS0_TS05_Pos                  (5UL)                     /*!< TM8 TS0: TS05 (Bit 5)                                 */
#define TM8_TS0_TS05_Msk                  (0x20UL)                  /*!< TM8 TS0: TS05 (Bitfield-Mask: 0x01)                   */
#define TM8_TS0_TS06_Pos                  (6UL)                     /*!< TM8 TS0: TS06 (Bit 6)                                 */
#define TM8_TS0_TS06_Msk                  (0x40UL)                  /*!< TM8 TS0: TS06 (Bitfield-Mask: 0x01)                   */
#define TM8_TS0_TS07_Pos                  (7UL)                     /*!< TM8 TS0: TS07 (Bit 7)                                 */
#define TM8_TS0_TS07_Msk                  (0x80UL)                  /*!< TM8 TS0: TS07 (Bitfield-Mask: 0x01)                   */
/* ==========================================================  TT0  ========================================================== */
#define TM8_TT0_TT00_Pos                  (0UL)                     /*!< TM8 TT0: TT00 (Bit 0)                                 */
#define TM8_TT0_TT00_Msk                  (0x1UL)                   /*!< TM8 TT0: TT00 (Bitfield-Mask: 0x01)                   */
#define TM8_TT0_TT01_Pos                  (1UL)                     /*!< TM8 TT0: TT01 (Bit 1)                                 */
#define TM8_TT0_TT01_Msk                  (0x2UL)                   /*!< TM8 TT0: TT01 (Bitfield-Mask: 0x01)                   */
#define TM8_TT0_TT02_Pos                  (2UL)                     /*!< TM8 TT0: TT02 (Bit 2)                                 */
#define TM8_TT0_TT02_Msk                  (0x4UL)                   /*!< TM8 TT0: TT02 (Bitfield-Mask: 0x01)                   */
#define TM8_TT0_TT03_Pos                  (3UL)                     /*!< TM8 TT0: TT03 (Bit 3)                                 */
#define TM8_TT0_TT03_Msk                  (0x8UL)                   /*!< TM8 TT0: TT03 (Bitfield-Mask: 0x01)                   */
#define TM8_TT0_TT04_Pos                  (4UL)                     /*!< TM8 TT0: TT04 (Bit 4)                                 */
#define TM8_TT0_TT04_Msk                  (0x10UL)                  /*!< TM8 TT0: TT04 (Bitfield-Mask: 0x01)                   */
#define TM8_TT0_TT05_Pos                  (5UL)                     /*!< TM8 TT0: TT05 (Bit 5)                                 */
#define TM8_TT0_TT05_Msk                  (0x20UL)                  /*!< TM8 TT0: TT05 (Bitfield-Mask: 0x01)                   */
#define TM8_TT0_TT06_Pos                  (6UL)                     /*!< TM8 TT0: TT06 (Bit 6)                                 */
#define TM8_TT0_TT06_Msk                  (0x40UL)                  /*!< TM8 TT0: TT06 (Bitfield-Mask: 0x01)                   */
#define TM8_TT0_TT07_Pos                  (7UL)                     /*!< TM8 TT0: TT07 (Bit 7)                                 */
#define TM8_TT0_TT07_Msk                  (0x80UL)                  /*!< TM8 TT0: TT07 (Bitfield-Mask: 0x01)                   */
/* =========================================================  TPS0  ========================================================== */
#define TM8_TPS0_PRS00_Pos                (0UL)                     /*!< TM8 TPS0: PRS00 (Bit 0)                               */
#define TM8_TPS0_PRS00_Msk                (0xfUL)                   /*!< TM8 TPS0: PRS00 (Bitfield-Mask: 0x0f)                 */
#define TM8_TPS0_PRS01_Pos                (4UL)                     /*!< TM8 TPS0: PRS01 (Bit 4)                               */
#define TM8_TPS0_PRS01_Msk                (0xf0UL)                  /*!< TM8 TPS0: PRS01 (Bitfield-Mask: 0x0f)                 */
#define TM8_TPS0_PRS02_Pos                (8UL)                     /*!< TM8 TPS0: PRS02 (Bit 8)                               */
#define TM8_TPS0_PRS02_Msk                (0x300UL)                 /*!< TM8 TPS0: PRS02 (Bitfield-Mask: 0x03)                 */
#define TM8_TPS0_PRS03_Pos                (12UL)                    /*!< TM8 TPS0: PRS03 (Bit 12)                              */
#define TM8_TPS0_PRS03_Msk                (0x3000UL)                /*!< TM8 TPS0: PRS03 (Bitfield-Mask: 0x03)                 */
/* ==========================================================  TO0  ========================================================== */
#define TM8_TO0_TO00_Pos                  (0UL)                     /*!< TM8 TO0: TO00 (Bit 0)                                 */
#define TM8_TO0_TO00_Msk                  (0x1UL)                   /*!< TM8 TO0: TO00 (Bitfield-Mask: 0x01)                   */
#define TM8_TO0_TO01_Pos                  (1UL)                     /*!< TM8 TO0: TO01 (Bit 1)                                 */
#define TM8_TO0_TO01_Msk                  (0x2UL)                   /*!< TM8 TO0: TO01 (Bitfield-Mask: 0x01)                   */
#define TM8_TO0_TO02_Pos                  (2UL)                     /*!< TM8 TO0: TO02 (Bit 2)                                 */
#define TM8_TO0_TO02_Msk                  (0x4UL)                   /*!< TM8 TO0: TO02 (Bitfield-Mask: 0x01)                   */
#define TM8_TO0_TO03_Pos                  (3UL)                     /*!< TM8 TO0: TO03 (Bit 3)                                 */
#define TM8_TO0_TO03_Msk                  (0x8UL)                   /*!< TM8 TO0: TO03 (Bitfield-Mask: 0x01)                   */
#define TM8_TO0_TO04_Pos                  (4UL)                     /*!< TM8 TO0: TO04 (Bit 4)                                 */
#define TM8_TO0_TO04_Msk                  (0x10UL)                  /*!< TM8 TO0: TO04 (Bitfield-Mask: 0x01)                   */
#define TM8_TO0_TO05_Pos                  (5UL)                     /*!< TM8 TO0: TO05 (Bit 5)                                 */
#define TM8_TO0_TO05_Msk                  (0x20UL)                  /*!< TM8 TO0: TO05 (Bitfield-Mask: 0x01)                   */
#define TM8_TO0_TO06_Pos                  (6UL)                     /*!< TM8 TO0: TO06 (Bit 6)                                 */
#define TM8_TO0_TO06_Msk                  (0x40UL)                  /*!< TM8 TO0: TO06 (Bitfield-Mask: 0x01)                   */
#define TM8_TO0_TO07_Pos                  (7UL)                     /*!< TM8 TO0: TO07 (Bit 7)                                 */
#define TM8_TO0_TO07_Msk                  (0x80UL)                  /*!< TM8 TO0: TO07 (Bitfield-Mask: 0x01)                   */
/* =========================================================  TOE0  ========================================================== */
#define TM8_TOE0_TOE00_Pos                (0UL)                     /*!< TM8 TOE0: TOE00 (Bit 0)                               */
#define TM8_TOE0_TOE00_Msk                (0x1UL)                   /*!< TM8 TOE0: TOE00 (Bitfield-Mask: 0x01)                 */
#define TM8_TOE0_TOE01_Pos                (1UL)                     /*!< TM8 TOE0: TOE01 (Bit 1)                               */
#define TM8_TOE0_TOE01_Msk                (0x2UL)                   /*!< TM8 TOE0: TOE01 (Bitfield-Mask: 0x01)                 */
#define TM8_TOE0_TOE02_Pos                (2UL)                     /*!< TM8 TOE0: TOE02 (Bit 2)                               */
#define TM8_TOE0_TOE02_Msk                (0x4UL)                   /*!< TM8 TOE0: TOE02 (Bitfield-Mask: 0x01)                 */
#define TM8_TOE0_TOE03_Pos                (3UL)                     /*!< TM8 TOE0: TOE03 (Bit 3)                               */
#define TM8_TOE0_TOE03_Msk                (0x8UL)                   /*!< TM8 TOE0: TOE03 (Bitfield-Mask: 0x01)                 */
#define TM8_TOE0_TOE04_Pos                (4UL)                     /*!< TM8 TOE0: TOE04 (Bit 4)                               */
#define TM8_TOE0_TOE04_Msk                (0x10UL)                  /*!< TM8 TOE0: TOE04 (Bitfield-Mask: 0x01)                 */
#define TM8_TOE0_TOE05_Pos                (5UL)                     /*!< TM8 TOE0: TOE05 (Bit 5)                               */
#define TM8_TOE0_TOE05_Msk                (0x20UL)                  /*!< TM8 TOE0: TOE05 (Bitfield-Mask: 0x01)                 */
#define TM8_TOE0_TOE06_Pos                (6UL)                     /*!< TM8 TOE0: TOE06 (Bit 6)                               */
#define TM8_TOE0_TOE06_Msk                (0x40UL)                  /*!< TM8 TOE0: TOE06 (Bitfield-Mask: 0x01)                 */
#define TM8_TOE0_TOE07_Pos                (7UL)                     /*!< TM8 TOE0: TOE07 (Bit 7)                               */
#define TM8_TOE0_TOE07_Msk                (0x80UL)                  /*!< TM8 TOE0: TOE07 (Bitfield-Mask: 0x01)                 */
/* =========================================================  TOL0  ========================================================== */
#define TM8_TOL0_TOL01_Pos                (1UL)                     /*!< TM8 TOL0: TOL01 (Bit 1)                               */
#define TM8_TOL0_TOL01_Msk                (0x2UL)                   /*!< TM8 TOL0: TOL01 (Bitfield-Mask: 0x01)                 */
#define TM8_TOL0_TOL02_Pos                (2UL)                     /*!< TM8 TOL0: TOL02 (Bit 2)                               */
#define TM8_TOL0_TOL02_Msk                (0x4UL)                   /*!< TM8 TOL0: TOL02 (Bitfield-Mask: 0x01)                 */
#define TM8_TOL0_TOL03_Pos                (3UL)                     /*!< TM8 TOL0: TOL03 (Bit 3)                               */
#define TM8_TOL0_TOL03_Msk                (0x8UL)                   /*!< TM8 TOL0: TOL03 (Bitfield-Mask: 0x01)                 */
#define TM8_TOL0_TOL04_Pos                (4UL)                     /*!< TM8 TOL0: TOL04 (Bit 4)                               */
#define TM8_TOL0_TOL04_Msk                (0x10UL)                  /*!< TM8 TOL0: TOL04 (Bitfield-Mask: 0x01)                 */
#define TM8_TOL0_TOL05_Pos                (5UL)                     /*!< TM8 TOL0: TOL05 (Bit 5)                               */
#define TM8_TOL0_TOL05_Msk                (0x20UL)                  /*!< TM8 TOL0: TOL05 (Bitfield-Mask: 0x01)                 */
#define TM8_TOL0_TOL06_Pos                (6UL)                     /*!< TM8 TOL0: TOL06 (Bit 6)                               */
#define TM8_TOL0_TOL06_Msk                (0x40UL)                  /*!< TM8 TOL0: TOL06 (Bitfield-Mask: 0x01)                 */
#define TM8_TOL0_TOL07_Pos                (7UL)                     /*!< TM8 TOL0: TOL07 (Bit 7)                               */
#define TM8_TOL0_TOL07_Msk                (0x80UL)                  /*!< TM8 TOL0: TOL07 (Bitfield-Mask: 0x01)                 */
/* =========================================================  TOM0  ========================================================== */
#define TM8_TOM0_TOM01_Pos                (1UL)                     /*!< TM8 TOM0: TOM01 (Bit 1)                               */
#define TM8_TOM0_TOM01_Msk                (0x2UL)                   /*!< TM8 TOM0: TOM01 (Bitfield-Mask: 0x01)                 */
#define TM8_TOM0_TOM02_Pos                (2UL)                     /*!< TM8 TOM0: TOM02 (Bit 2)                               */
#define TM8_TOM0_TOM02_Msk                (0x4UL)                   /*!< TM8 TOM0: TOM02 (Bitfield-Mask: 0x01)                 */
#define TM8_TOM0_TOM03_Pos                (3UL)                     /*!< TM8 TOM0: TOM03 (Bit 3)                               */
#define TM8_TOM0_TOM03_Msk                (0x8UL)                   /*!< TM8 TOM0: TOM03 (Bitfield-Mask: 0x01)                 */
#define TM8_TOM0_TOM04_Pos                (4UL)                     /*!< TM8 TOM0: TOM04 (Bit 4)                               */
#define TM8_TOM0_TOM04_Msk                (0x10UL)                  /*!< TM8 TOM0: TOM04 (Bitfield-Mask: 0x01)                 */
#define TM8_TOM0_TOM05_Pos                (5UL)                     /*!< TM8 TOM0: TOM05 (Bit 5)                               */
#define TM8_TOM0_TOM05_Msk                (0x20UL)                  /*!< TM8 TOM0: TOM05 (Bitfield-Mask: 0x01)                 */
#define TM8_TOM0_TOM06_Pos                (6UL)                     /*!< TM8 TOM0: TOM06 (Bit 6)                               */
#define TM8_TOM0_TOM06_Msk                (0x40UL)                  /*!< TM8 TOM0: TOM06 (Bitfield-Mask: 0x01)                 */
#define TM8_TOM0_TOM07_Pos                (7UL)                     /*!< TM8 TOM0: TOM07 (Bit 7)                               */
#define TM8_TOM0_TOM07_Msk                (0x80UL)                  /*!< TM8 TOM0: TOM07 (Bitfield-Mask: 0x01)                 */
/* =========================================================  TDR00  ========================================================= */
/* =========================================================  TDR01  ========================================================= */
/* =========================================================  TDR02  ========================================================= */
/* =========================================================  TDR03  ========================================================= */
...
#define TMA_TAMR0_TCK0_Pos                (4UL)                     /*!< TMA TAMR0: TCK0 (Bit 4)                               */
#define TMA_TAMR0_TCK0_Msk                (0x70UL)                  /*!< TMA TAMR0: TCK0 (Bitfield-Mask: 0x07)                 */
/* ========================================================  TAISR0  ========================================================= */
...
#define RTC_RTCC0_RCLOE1_Pos              (5UL)                     /*!< RTC RTCC0: RCLOE1 (Bit 5)                             */
#define RTC_RTCC0_RCLOE1_Msk              (0x20UL)                  /*!< RTC RTCC0: RCLOE1 (Bitfield-Mask: 0x01)               */
...
#define ADC_ADM1_SMODE_Pos                (5UL)                     /*!< ADC ADM1: SMODE (Bit 5)                               */
#define ADC_ADM1_SMODE_Msk                (0x60UL)                  /*!< ADC ADM1: SMODE (Bitfield-Mask: 0x03)                 */
...
/* =========================================================  DACS0  ========================================================= */
#define DAC_DACS0_DACS0_Pos               (0UL)                     /*!< DAC DACS0: DACS0 (Bit 0)                              */
#define DAC_DACS0_DACS0_Msk               (0xffUL)                  /*!< DAC DACS0: DACS0 (Bitfield-Mask: 0xff)                */
/* ==========================================================  DAM  ========================================================== */
...
/* ========================================================  OPACTL  ========================================================= */
#define OPA_OPACTL_INPSEL_Pos             (2UL)                     /*!< OPA OPACTL: INPSEL (Bit 2)                            */
#define OPA_OPACTL_INPSEL_Msk             (0x4UL)                   /*!< OPA OPACTL: INPSEL (Bitfield-Mask: 0x01)              */
#define OPA_OPACTL_OPAMODE_Pos            (4UL)                     /*!< OPA OPACTL: OPAMODE (Bit 4)                           */
#define OPA_OPACTL_OPAMODE_Msk            (0x10UL)                  /*!< OPA OPACTL: OPAMODE (Bitfield-Mask: 0x01)             */
#define OPA_OPACTL_RPDMODE_Pos            (5UL)                     /*!< OPA OPACTL: RPDMODE (Bit 5)                           */
#define OPA_OPACTL_RPDMODE_Msk            (0x20UL)                  /*!< OPA OPACTL: RPDMODE (Bitfield-Mask: 0x01)             */
#define OPA_OPACTL_OPAEN_Pos              (7UL)                     /*!< OPA OPACTL: OPAEN (Bit 7)                             */
#define OPA_OPACTL_OPAEN_Msk              (0x80UL)                  /*!< OPA OPACTL: OPAEN (Bitfield-Mask: 0x01)               */
/* ========================================================  OPADAC  ========================================================= */
#define OPA_OPADAC_OPADAO_Pos             (0UL)                     /*!< OPA OPADAC: OPADAO (Bit 0)                            */
#define OPA_OPADAC_OPADAO_Msk             (0x1fUL)                  /*!< OPA OPADAC: OPADAO (Bitfield-Mask: 0x1f)              */
#define OPA_OPADAC_OPADAP_Pos             (7UL)                     /*!< OPA OPADAC: OPADAP (Bit 7)                            */
#define OPA_OPADAC_OPADAP_Msk             (0x80UL)                  /*!< OPA OPADAC: OPADAP (Bitfield-Mask: 0x01)              */
...
/* =========================================================  SSE0  ========================================================== */
#define SCI0_SSE0_SSIEmn_Pos              (0UL)                     /*!< SCI0 SSE0: SSIEmn (Bit 0)                             */
#define SCI0_SSE0_SSIEmn_Msk              (0x3UL)                   /*!< SCI0 SSE0: SSIEmn (Bitfield-Mask: 0x03)               */
/* =========================================================  SSC0  ========================================================== */
#define SCI0_SSC0_SWC0_Pos                (0UL)                     /*!< SCI0 SSC0: SWC0 (Bit 0)                               */
#define SCI0_SSC0_SWC0_Msk                (0x1UL)                   /*!< SCI0 SSC0: SWC0 (Bitfield-Mask: 0x01)                 */
#define SCI0_SSC0_SSEC0_Pos               (1UL)                     /*!< SCI0 SSC0: SSEC0 (Bit 1)                              */
#define SCI0_SSC0_SSEC0_Msk               (0x2UL)                   /*!< SCI0 SSC0: SSEC0 (Bitfield-Mask: 0x01)                */
/* =========================================================  SDR0  ========================================================== */
/* =========================================================  SIO00  ========================================================= */
/* =========================================================  SIO01  ========================================================= */
/* =========================================================  TXD0  ========================================================== */
...
/* =========================================================  SSE0  ========================================================== */
#define SCI1_SSE0_SSIEmn_Pos              (0UL)                     /*!< SCI1 SSE0: SSIEmn (Bit 0)                             */
#define SCI1_SSE0_SSIEmn_Msk              (0x3UL)                   /*!< SCI1 SSE0: SSIEmn (Bitfield-Mask: 0x03)               */
/* =========================================================  SSC1  ========================================================== */
#define SCI1_SSC1_SWC1_Pos                (0UL)                     /*!< SCI1 SSC1: SWC1 (Bit 0)                               */
#define SCI1_SSC1_SWC1_Msk                (0x1UL)                   /*!< SCI1 SSC1: SWC1 (Bitfield-Mask: 0x01)                 */
#define SCI1_SSC1_SSEC1_Pos               (1UL)                     /*!< SCI1 SSC1: SSEC1 (Bit 1)                              */
#define SCI1_SSC1_SSEC1_Msk               (0x2UL)                   /*!< SCI1 SSC1: SSEC1 (Bitfield-Mask: 0x01)                */
/* =========================================================  SDR1  ========================================================== */
/* =========================================================  SIO10  ========================================================= */
/* =========================================================  SIO11  ========================================================= */
/* =========================================================  TXD1  ========================================================== */
...
/* =========================================================  SSE0  ========================================================== */
#define SCI2_SSE0_SSIEmn_Pos              (0UL)                     /*!< SCI2 SSE0: SSIEmn (Bit 0)                             */
#define SCI2_SSE0_SSIEmn_Msk              (0x3UL)                   /*!< SCI2 SSE0: SSIEmn (Bitfield-Mask: 0x03)               */
/* =========================================================  SSC2  ========================================================== */
#define SCI2_SSC2_SWC2_Pos                (0UL)                     /*!< SCI2 SSC2: SWC2 (Bit 0)                               */
#define SCI2_SSC2_SWC2_Msk                (0x1UL)                   /*!< SCI2 SSC2: SWC2 (Bitfield-Mask: 0x01)                 */
#define SCI2_SSC2_SSEC2_Pos               (1UL)                     /*!< SCI2 SSC2: SSEC2 (Bit 1)                              */
#define SCI2_SSC2_SSEC2_Msk               (0x2UL)                   /*!< SCI2 SSC2: SSEC2 (Bitfield-Mask: 0x01)                */
/* =========================================================  SDR2  ========================================================== */
/* =========================================================  SIO20  ========================================================= */
/* =========================================================  SIO21  ========================================================= */
/* =========================================================  TXD2  ========================================================== */
...
/* =========================================================  SPIM  ========================================================== */
#define SPIHS0_SPIM_RECMD_Pos             (1UL)                     /*!< SPIHS0 SPIM: RECMD (Bit 1)                            */
#define SPIHS0_SPIM_RECMD_Msk             (0x2UL)                   /*!< SPIHS0 SPIM: RECMD (Bitfield-Mask: 0x01)              */
#define SPIHS0_SPIM_DLS_Pos               (2UL)                     /*!< SPIHS0 SPIM: DLS (Bit 2)                              */
#define SPIHS0_SPIM_DLS_Msk               (0x4UL)                   /*!< SPIHS0 SPIM: DLS (Bitfield-Mask: 0x01)                */
#define SPIHS0_SPIM_INTMD_Pos             (3UL)                     /*!< SPIHS0 SPIM: INTMD (Bit 3)                            */
#define SPIHS0_SPIM_INTMD_Msk             (0x8UL)                   /*!< SPIHS0 SPIM: INTMD (Bitfield-Mask: 0x01)              */
#define SPIHS0_SPIM_DIR_Pos               (4UL)                     /*!< SPIHS0 SPIM: DIR (Bit 4)                              */
#define SPIHS0_SPIM_DIR_Msk               (0x10UL)                  /*!< SPIHS0 SPIM: DIR (Bitfield-Mask: 0x01)                */
#define SPIHS0_SPIM_NSSE_Pos              (5UL)                     /*!< SPIHS0 SPIM: NSSE (Bit 5)                             */
#define SPIHS0_SPIM_NSSE_Msk              (0x20UL)                  /*!< SPIHS0 SPIM: NSSE (Bitfield-Mask: 0x01)               */
#define SPIHS0_SPIM_TRMD_Pos              (6UL)                     /*!< SPIHS0 SPIM: TRMD (Bit 6)                             */
#define SPIHS0_SPIM_TRMD_Msk              (0x40UL)                  /*!< SPIHS0 SPIM: TRMD (Bitfield-Mask: 0x01)               */
#define SPIHS0_SPIM_SPIE_Pos              (7UL)                     /*!< SPIHS0 SPIM: SPIE (Bit 7)                             */
#define SPIHS0_SPIM_SPIE_Msk              (0x80UL)                  /*!< SPIHS0 SPIM: SPIE (Bitfield-Mask: 0x01)               */
/* =========================================================  SPIC  ========================================================== */
#define SPIHS0_SPIC_CKS_Pos               (0UL)                     /*!< SPIHS0 SPIC: CKS (Bit 0)                              */
#define SPIHS0_SPIC_CKS_Msk               (0x7UL)                   /*!< SPIHS0 SPIC: CKS (Bitfield-Mask: 0x07)                */
#define SPIHS0_SPIC_CPHA_Pos              (3UL)                     /*!< SPIHS0 SPIC: CPHA (Bit 3)                             */
#define SPIHS0_SPIC_CPHA_Msk              (0x8UL)                   /*!< SPIHS0 SPIC: CPHA (Bitfield-Mask: 0x01)               */
#define SPIHS0_SPIC_CPOL_Pos              (4UL)                     /*!< SPIHS0 SPIC: CPOL (Bit 4)                             */
#define SPIHS0_SPIC_CPOL_Msk              (0x10UL)                  /*!< SPIHS0 SPIC: CPOL (Bitfield-Mask: 0x01)               */
/* =========================================================  SDRO  ========================================================== */
/* =========================================================  SDRI  ========================================================== */
/* =========================================================  SPIS  ========================================================== */
#define SPIHS0_SPIS_SPTF_Pos              (0UL)                     /*!< SPIHS0 SPIS: SPTF (Bit 0)                             */
#define SPIHS0_SPIS_SPTF_Msk              (0x1UL)                   /*!< SPIHS0 SPIS: SPTF (Bitfield-Mask: 0x01)               */
#define SPIHS0_SPIS_SDRIF_Pos             (1UL)                     /*!< SPIHS0 SPIS: SDRIF (Bit 1)                            */
#define SPIHS0_SPIS_SDRIF_Msk             (0x2UL)                   /*!< SPIHS0 SPIS: SDRIF (Bitfield-Mask: 0x01)              */
...
/* =========================================================  LCDM0  ========================================================= */
#define LCD_LCDM0_LBAS_Pos                (0UL)                     /*!< LCD LCDM0: LBAS (Bit 0)                               */
#define LCD_LCDM0_LBAS_Msk                (0x3UL)                   /*!< LCD LCDM0: LBAS (Bitfield-Mask: 0x03)                 */
#define LCD_LCDM0_LDTY_Pos                (2UL)                     /*!< LCD LCDM0: LDTY (Bit 2)                               */
#define LCD_LCDM0_LDTY_Msk                (0x1cUL)                  /*!< LCD LCDM0: LDTY (Bitfield-Mask: 0x07)                 */
#define LCD_LCDM0_LWAVE_Pos               (5UL)                     /*!< LCD LCDM0: LWAVE (Bit 5)                              */
#define LCD_LCDM0_LWAVE_Msk               (0x20UL)                  /*!< LCD LCDM0: LWAVE (Bitfield-Mask: 0x01)                */
#define LCD_LCDM0_MDSET_Pos               (6UL)                     /*!< LCD LCDM0: MDSET (Bit 6)                              */
#define LCD_LCDM0_MDSET_Msk               (0xc0UL)                  /*!< LCD LCDM0: MDSET (Bitfield-Mask: 0x03)                */
/* =========================================================  LCDM1  ========================================================= */
#define LCD_LCDM1_LCDVLM_Pos              (0UL)                     /*!< LCD LCDM1: LCDVLM (Bit 0)                             */
#define LCD_LCDM1_LCDVLM_Msk              (0x1UL)                   /*!< LCD LCDM1: LCDVLM (Bitfield-Mask: 0x01)               */
#define LCD_LCDM1_LCDSEL_Pos              (3UL)                     /*!< LCD LCDM1: LCDSEL (Bit 3)                             */
#define LCD_LCDM1_LCDSEL_Msk              (0x8UL)                   /*!< LCD LCDM1: LCDSEL (Bitfield-Mask: 0x01)               */
#define LCD_LCDM1_BLON_Pos                (4UL)                     /*!< LCD LCDM1: BLON (Bit 4)                               */
#define LCD_LCDM1_BLON_Msk                (0x10UL)                  /*!< LCD LCDM1: BLON (Bitfield-Mask: 0x01)                 */
#define LCD_LCDM1_VLCON_Pos               (5UL)                     /*!< LCD LCDM1: VLCON (Bit 5)                              */
#define LCD_LCDM1_VLCON_Msk               (0x20UL)                  /*!< LCD LCDM1: VLCON (Bitfield-Mask: 0x01)                */
#define LCD_LCDM1_SCOC_Pos                (6UL)                     /*!< LCD LCDM1: SCOC (Bit 6)                               */
#define LCD_LCDM1_SCOC_Msk                (0x40UL)                  /*!< LCD LCDM1: SCOC (Bitfield-Mask: 0x01)                 */
#define LCD_LCDM1_LCDON_Pos               (7UL)                     /*!< LCD LCDM1: LCDON (Bit 7)                              */
#define LCD_LCDM1_LCDON_Msk               (0x80UL)                  /*!< LCD LCDM1: LCDON (Bitfield-Mask: 0x01)                */
/* =========================================================  LCDC0  ========================================================= */
/* =========================================================  VLCD  ========================================================== */
/* ==========================================================  SEG  ========================================================== */
...
/* ========================================================  GDIDIS  ========================================================= */
/* ========================================================  ISCLCD  ========================================================= */
#define PPORGA_ISCLCD_ISCCAP_Pos          (0UL)                     /*!< PPORGA ISCLCD: ISCCAP (Bit 0)                         */
#define PPORGA_ISCLCD_ISCCAP_Msk          (0x1UL)                   /*!< PPORGA ISCLCD: ISCCAP (Bitfield-Mask: 0x01)           */
#define PPORGA_ISCLCD_ISCVL_Pos           (1UL)                     /*!< PPORGA ISCLCD: ISCVL (Bit 1)                          */
#define PPORGA_ISCLCD_ISCVL_Msk           (0x2UL)                   /*!< PPORGA ISCLCD: ISCVL (Bitfield-Mask: 0x01)            */
/* ========================================================  SEGEN0  ========================================================= */
/* ========================================================  SEGEN1  ========================================================= */
/* ========================================================  SEGEN2  ========================================================= */
/* ========================================================  SEGEN3  ========================================================= */
...
/* =========================================================  NFEN0  ========================================================= */
#define MISC_NFEN0_TNFEN00_Pos            (0UL)                     /*!< MISC NFEN0: TNFEN00 (Bit 0)                           */
#define MISC_NFEN0_TNFEN00_Msk            (0x1UL)                   /*!< MISC NFEN0: TNFEN00 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN0_TNFEN01_Pos            (1UL)                     /*!< MISC NFEN0: TNFEN01 (Bit 1)                           */
#define MISC_NFEN0_TNFEN01_Msk            (0x2UL)                   /*!< MISC NFEN0: TNFEN01 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN0_TNFEN02_Pos            (2UL)                     /*!< MISC NFEN0: TNFEN02 (Bit 2)                           */
#define MISC_NFEN0_TNFEN02_Msk            (0x4UL)                   /*!< MISC NFEN0: TNFEN02 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN0_TNFEN03_Pos            (3UL)                     /*!< MISC NFEN0: TNFEN03 (Bit 3)                           */
#define MISC_NFEN0_TNFEN03_Msk            (0x8UL)                   /*!< MISC NFEN0: TNFEN03 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN0_TNFEN04_Pos            (4UL)                     /*!< MISC NFEN0: TNFEN04 (Bit 4)                           */
#define MISC_NFEN0_TNFEN04_Msk            (0x10UL)                  /*!< MISC NFEN0: TNFEN04 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN0_TNFEN05_Pos            (5UL)                     /*!< MISC NFEN0: TNFEN05 (Bit 5)                           */
#define MISC_NFEN0_TNFEN05_Msk            (0x20UL)                  /*!< MISC NFEN0: TNFEN05 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN0_TNFEN06_Pos            (6UL)                     /*!< MISC NFEN0: TNFEN06 (Bit 6)                           */
#define MISC_NFEN0_TNFEN06_Msk            (0x40UL)                  /*!< MISC NFEN0: TNFEN06 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN0_TNFEN07_Pos            (7UL)                     /*!< MISC NFEN0: TNFEN07 (Bit 7)                           */
#define MISC_NFEN0_TNFEN07_Msk            (0x80UL)                  /*!< MISC NFEN0: TNFEN07 (Bitfield-Mask: 0x01)             */
/* =========================================================  NFEN1  ========================================================= */
#define MISC_NFEN1_TNFEN10_Pos            (0UL)                     /*!< MISC NFEN1: TNFEN10 (Bit 0)                           */
#define MISC_NFEN1_TNFEN10_Msk            (0x1UL)                   /*!< MISC NFEN1: TNFEN10 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN1_TNFEN11_Pos            (1UL)                     /*!< MISC NFEN1: TNFEN11 (Bit 1)                           */
#define MISC_NFEN1_TNFEN11_Msk            (0x2UL)                   /*!< MISC NFEN1: TNFEN11 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN1_TNFEN12_Pos            (2UL)                     /*!< MISC NFEN1: TNFEN12 (Bit 2)                           */
#define MISC_NFEN1_TNFEN12_Msk            (0x4UL)                   /*!< MISC NFEN1: TNFEN12 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN1_TNFEN13_Pos            (3UL)                     /*!< MISC NFEN1: TNFEN13 (Bit 3)                           */
#define MISC_NFEN1_TNFEN13_Msk            (0x8UL)                   /*!< MISC NFEN1: TNFEN13 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN1_TNFEN14_Pos            (4UL)                     /*!< MISC NFEN1: TNFEN14 (Bit 4)                           */
#define MISC_NFEN1_TNFEN14_Msk            (0x10UL)                  /*!< MISC NFEN1: TNFEN14 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN1_TNFEN15_Pos            (5UL)                     /*!< MISC NFEN1: TNFEN15 (Bit 5)                           */
#define MISC_NFEN1_TNFEN15_Msk            (0x20UL)                  /*!< MISC NFEN1: TNFEN15 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN1_TNFEN16_Pos            (6UL)                     /*!< MISC NFEN1: TNFEN16 (Bit 6)                           */
#define MISC_NFEN1_TNFEN16_Msk            (0x40UL)                  /*!< MISC NFEN1: TNFEN16 (Bitfield-Mask: 0x01)             */
#define MISC_NFEN1_TNFEN17_Pos            (7UL)                     /*!< MISC NFEN1: TNFEN17 (Bit 7)                           */
#define MISC_NFEN1_TNFEN17_Msk            (0x80UL)                  /*!< MISC NFEN1: TNFEN17 (Bitfield-Mask: 0x01)             */
/* ==========================================================  ISC  ========================================================== */
...
/* =========================================================  TIOS0  ========================================================= */
/* =========================================================  RTCCL  ========================================================= */
#define MISC_RTCCL_RTCCKS_Pos             (0UL)                     /*!< MISC RTCCL: RTCCKS (Bit 0)                            */
#define MISC_RTCCL_RTCCKS_Msk             (0x3UL)                   /*!< MISC RTCCL: RTCCKS (Bitfield-Mask: 0x03)              */
#define MISC_RTCCL_RTCCL5_Pos             (5UL)                     /*!< MISC RTCCL: RTCCL5 (Bit 5)                            */
#define MISC_RTCCL_RTCCL5_Msk             (0x20UL)                  /*!< MISC RTCCL: RTCCL5 (Bitfield-Mask: 0x01)              */
#define MISC_RTCCL_RTCCL6_Pos             (6UL)                     /*!< MISC RTCCL: RTCCL6 (Bit 6)                            */
#define MISC_RTCCL_RTCCL6_Msk             (0x40UL)                  /*!< MISC RTCCL: RTCCL6 (Bitfield-Mask: 0x01)              */
#define MISC_RTCCL_RTCCL7_Pos             (7UL)                     /*!< MISC RTCCL: RTCCL7 (Bit 7)                            */
#define MISC_RTCCL_RTCCL7_Msk             (0x80UL)                  /*!< MISC RTCCL: RTCCL7 (Bitfield-Mask: 0x01)              */
...
/* ========================================================  FLPROT  ========================================================= */
/* =======================================================  FLRCVCNT  ======================================================== */
#define FMC_FLRCVCNT_FLPRVCNT_Pos         (0UL)                     /*!< FMC FLRCVCNT: FLPRVCNT (Bit 0)                        */
#define FMC_FLRCVCNT_FLPRVCNT_Msk         (0x1fffUL)                /*!< FMC FLRCVCNT: FLPRVCNT (Bitfield-Mask: 0x1fff)        */
#define FMC_FLRCVCNT_LOAD0_Pos            (15UL)                    /*!< FMC FLRCVCNT: LOAD0 (Bit 15)                          */
#define FMC_FLRCVCNT_LOAD0_Msk            (0x8000UL)                /*!< FMC FLRCVCNT: LOAD0 (Bitfield-Mask: 0x01)             */
#define FMC_FLRCVCNT_FLERVCNT_Pos         (16UL)                    /*!< FMC FLRCVCNT: FLERVCNT (Bit 16)                       */
#define FMC_FLRCVCNT_FLERVCNT_Msk         (0x7fff0000UL)            /*!< FMC FLRCVCNT: FLERVCNT (Bitfield-Mask: 0x7fff)        */
#define FMC_FLRCVCNT_LOAD1_Pos            (31UL)                    /*!< FMC FLRCVCNT: LOAD1 (Bit 31)                          */
#define FMC_FLRCVCNT_LOAD1_Msk            (0x80000000UL)            /*!< FMC FLRCVCNT: LOAD1 (Bitfield-Mask: 0x01)             */
/* ========================================================  FLSECPR  ======================================================== */
#define FMC_FLSECPR_SECPR_Pos             (0UL)                     /*!< FMC FLSECPR: SECPR (Bit 0)                            */
#define FMC_FLSECPR_SECPR_Msk             (0xfUL)                   /*!< FMC FLSECPR: SECPR (Bitfield-Mask: 0x0f)              */
#define FMC_FLSECPR_KEY_Pos               (8UL)                     /*!< FMC FLSECPR: KEY (Bit 8)                              */
#define FMC_FLSECPR_KEY_Msk               (0xffffff00UL)            /*!< FMC FLSECPR: KEY (Bitfield-Mask: 0xffffff)            */
...
/* =========================================================  SFRGD  ========================================================= */
#define SAF_SFRGD_GCSC_Pos                (0UL)                     /*!< SAF SFRGD: GCSC (Bit 0)                               */
#define SAF_SFRGD_GCSC_Msk                (0x1UL)                   /*!< SAF SFRGD: GCSC (Bitfield-Mask: 0x01)                 */
#define SAF_SFRGD_GINT_Pos                (1UL)                     /*!< SAF SFRGD: GINT (Bit 1)                               */
#define SAF_SFRGD_GINT_Msk                (0x2UL)                   /*!< SAF SFRGD: GINT (Bitfield-Mask: 0x01)                 */
#define SAF_SFRGD_GPORT_Pos               (2UL)                     /*!< SAF SFRGD: GPORT (Bit 2)                              */
#define SAF_SFRGD_GPORT_Msk               (0x4UL)                   /*!< SAF SFRGD: GPORT (Bitfield-Mask: 0x01)                */
#define SAF_SFRGD_GCOMP_Pos               (3UL)                     /*!< SAF SFRGD: GCOMP (Bit 3)                              */
#define SAF_SFRGD_GCOMP_Msk               (0x8UL)                   /*!< SAF SFRGD: GCOMP (Bitfield-Mask: 0x01)                */
...
/* ========================================================  SCMCTL  ========================================================= */
#define OSDC_SCMCTL_OSDCCMP_Pos           (0UL)                     /*!< OSDC SCMCTL: OSDCCMP (Bit 0)                          */
#define OSDC_SCMCTL_OSDCCMP_Msk           (0xfffUL)                 /*!< OSDC SCMCTL: OSDCCMP (Bitfield-Mask: 0xfff)           */
#define OSDC_SCMCTL_OSCDE_Pos             (15UL)                    /*!< OSDC SCMCTL: OSCDE (Bit 15)                           */
#define OSDC_SCMCTL_OSCDE_Msk             (0x8000UL)                /*!< OSDC SCMCTL: OSCDE (Bitfield-Mask: 0x01)              */
/* =========================================================  SCMMD  ========================================================= */
#define OSDC_SCMMD_CKSEL_Pos              (0UL)                     /*!< OSDC SCMMD: CKSEL (Bit 0)                             */
#define OSDC_SCMMD_CKSEL_Msk              (0x1UL)                   /*!< OSDC SCMMD: CKSEL (Bitfield-Mask: 0x01)               */
#define OSDC_SCMMD_MDSEL_Pos              (1UL)                     /*!< OSDC SCMMD: MDSEL (Bit 1)                             */
#define OSDC_SCMMD_MDSEL_Msk              (0x2UL)                   /*!< OSDC SCMMD: MDSEL (Bitfield-Mask: 0x01)               */
/* =========================================================  SCMST  ========================================================= */
#define OSDC_SCMST_OSTDF_Pos              (0UL)                     /*!< OSDC SCMST: OSTDF (Bit 0)                             */
#define OSDC_SCMST_OSTDF_Msk              (0x1UL)                   /*!< OSDC SCMST: OSTDF (Bitfield-Mask: 0x01)               */
...
/* ========================================================  HOCOFC  ========================================================= */
#define OCRV_HOCOFC_FCST_Pos              (0UL)                     /*!< OCRV HOCOFC: FCST (Bit 0)                             */
#define OCRV_HOCOFC_FCST_Msk              (0x1UL)                   /*!< OCRV HOCOFC: FCST (Bitfield-Mask: 0x01)               */
#define OCRV_HOCOFC_FCEND_Pos             (4UL)                     /*!< OCRV HOCOFC: FCEND (Bit 4)                            */
#define OCRV_HOCOFC_FCEND_Msk             (0x10UL)                  /*!< OCRV HOCOFC: FCEND (Bitfield-Mask: 0x01)              */
#define OCRV_HOCOFC_FCREF_Pos             (5UL)                     /*!< OCRV HOCOFC: FCREF (Bit 5)                            */
#define OCRV_HOCOFC_FCREF_Msk             (0x20UL)                  /*!< OCRV HOCOFC: FCREF (Bitfield-Mask: 0x01)              */
#define OCRV_HOCOFC_FCMD_Pos              (7UL)                     /*!< OCRV HOCOFC: FCMD (Bit 7)                             */
#define OCRV_HOCOFC_FCMD_Msk              (0x80UL)                  /*!< OCRV HOCOFC: FCMD (Bitfield-Mask: 0x01)               */
