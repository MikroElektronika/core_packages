...
#ifndef __APM32A0XX_H
#define __APM32A0XX_H
...
/** @addtogroup APM32A0xx
  * @brief Peripheral Access Layer
  @{
*/

#if defined (APM32A091xC)
#define    APM32A091
#endif /*!< APM32A091xC */

// Note: Added for MikroE implementation.
#define APM32A091
#if !defined (APM32A091)
#error "Please select first the target APM32A0xx device used in your application (in apm32a0xx.h file)"
#endif
...
/** @defgroup APM32A0xx_StdPeripheral_Library_Version
  @{
*/

/*!< [31:16] APM32A0XX Standard Peripheral Library main version V1.0.0*/
#define __APM32A0_DEVICE_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __APM32A0_DEVICE_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __APM32A0_DEVICE_VERSION_SUB2   (0x03) /*!< [15:8]  sub2 version */
#define __APM32A0_DEVICE_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define __APM32A0_DEVICE_VERSION        ((__APM32A0_DEVICE_VERSION_MAIN << 24)\
                                        |(__APM32A0_DEVICE_VERSION_SUB1 << 16)\
                                        |(__APM32A0_DEVICE_VERSION_SUB2 << 8 )\
                                        |(__APM32A0_DEVICE_VERSION_RC))

/**@} end of group APM32A0xx_StdPeripheral_Library_Version */
...
/* APM32A0xx do not provide MPU  */
#define __MPU_PRESENT             0
/* APM32A0xx uses 2 Bits for the Priority Levels */
...
#if defined (APM32A091)
    /*  APM32A091 specific Interrupt Numbers */
...
//#include "system_apm32a0xx.h" /*!< APM32A0xx System Header */
