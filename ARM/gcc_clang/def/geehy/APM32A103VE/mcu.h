...
#ifndef __APM32A10X_H
#define __APM32A10X_H
...
/*!
 *  APM32A10X_LD: APM32 Low    density devices, the Flash memory density ranges between 16 and 32 Kbytes.
 *  APM32A10X_MD: APM32 Medium density devices, the Flash memory density ranges between 64 and 128 Kbytes.
 *  APM32A10X_HD: APM32 High   density devices, the Flash memory density ranges between 256 and 512 Kbytes.
 */
// Note: Added for MikroE implementation.
#define APM32A10X_LD
#if !defined (APM32A10X_LD)  && !defined (APM32A10X_MD) && !defined (APM32A10X_HD)
#error "Please select a the target APM32A10x device used in your application (in apm32a10x.h file)"
#endif
...
/** @defgroup APM32A10x_StdPeripheral_Library_Version
  @{
*/

/**
 * @brief APM32A10x Standard Peripheral Library version number
 */
#define __APM32A10X_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __APM32A10X_STDPERIPH_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __APM32A10X_STDPERIPH_VERSION_SUB2   (0x07) /*!< [15:8]  sub2 version */
#define __APM32A10X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */
#define __APM32A10X_STDPERIPH_VERSION       ( (__APM32A10X_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__APM32A10X_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__APM32A10X_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__APM32A10X_STDPERIPH_VERSION_RC))
...
/**
 * @brief APM32A10x Interrupt Number Definition, according to the selected device
...
#if defined (APM32A10X_LD)
    /*  APM32A10X Low-density devices specific Interrupt Numbers */
...
#elif defined (APM32A10X_MD)
    /*  APM32A10X Medium-density devices specific Interrupt Numbers */
    ADC1_2_IRQn                 = 18,     /*!< ADC1 and ADC2 global Interrupt                       */
    USBD1_HP_CAN1_TX_IRQn       = 19,     /*!< USB Device 1 High Priority or CAN1 TX Interrupts     */
    USBD1_LP_CAN1_RX0_IRQn      = 20,     /*!< USB Device 1 Low Priority or CAN1 RX0 Interrupts     */
    CAN1_RX1_IRQn               = 21,     /*!< CAN1 RX1 Interrupt                                   */
...
#elif defined (APM32A10X_HD)
    /*  APM32A10X High-density devices specific Interrupt Numbers */
    ADC1_2_IRQn                 = 18,     /*!< ADC1 and ADC2 global Interrupt                       */
    USBD1_HP_CAN1_TX_IRQn       = 19,     /*!< USB Device 1 High Priority or CAN1 TX Interrupts     */
    USBD1_LP_CAN1_RX0_IRQn      = 20,     /*!< USB Device 1 Low Priority or CAN1 RX0 Interrupts     */
    CAN1_RX1_IRQn               = 21,     /*!< CAN1 RX1 Interrupt                                   */
...
#if defined (APM32A10X_MD) || defined (APM32A10X_LD)
#define QSPI                    ((QSPI_T *)QSPI_BASE)
#endif
#if defined (APM32A10X_HD)
