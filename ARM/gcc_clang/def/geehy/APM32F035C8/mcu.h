...
#ifndef __APM32F035_H
#define __APM32F035_H
...
#if defined (APM32F035x8)
#define    APM32F035
#endif /*!< APM32F035x8 */

// Note: Added for MikroE implementation.
#define APM32F035
#if !defined (APM32F035)
#error "Please select first the target APM32F035 device used in your application (in apm32f035.h file)"
#endif
...
/** @defgroup APM32F035_StdPeripheral_Library_Version
  @{
*/

/*!< [31:16] APM32F035 Standard Peripheral Library main version V1.0.0*/
#define __APM32F035_DEVICE_VERSION_MAIN     (0x01) /*!< [31:24] main version */
#define __APM32F035_DEVICE_VERSION_SUB1     (0x00) /*!< [23:16] sub1 version */
#define __APM32F035_DEVICE_VERSION_SUB2     (0x00) /*!< [15:8]  sub2 version */
#define __APM32F035_DEVICE_VERSION_RC       (0x00) /*!< [7:0]  release candidate */
#define __APM32F035_DEVICE_VERSION          ((__APM32F035_DEVICE_VERSION_MAIN << 24)\
                                            |(__APM32F035_DEVICE_VERSION_SUB1 << 16)\
                                            |(__APM32F035_DEVICE_VERSION_SUB2 << 8 )\
                                            |(__APM32F035_DEVICE_VERSION_RC))

/**@} end of group APM32F035_StdPeripheral_Library_Version*/
...
/* APM32F035 do not provide MPU  */
#define __MPU_PRESENT             0
/* APM32F035 uses 2 Bits for the Priority Levels */
...
#if defined (APM32F035)
    /*  APM32F035 specific Interrupt Numbers */
