 ...
 * @note     Generated by SVDConv V3.3.35 on Monday, 14.12.2020 18:23:13
 *           from File 'SN32F770.svd',
 *           last modified on Monday, 14.12.2020 10:23:06
 */
...
/* ==========================================  SN32F770 Specific Interrupt Numbers  ========================================== */
  NDT_IRQn                  =   0,              /*!< 0  NDT                                                                    */
  CT16B0_IRQn               =   1,              /*!< 1  CT16B0                                                                 */
  CT16B1_IRQn               =   2,              /*!< 2  CT16B1                                                                 */
  ADC_IRQn                  =   3,              /*!< 3  ADC                                                                    */
  CMP0_IRQn                 =   8,              /*!< 8  CMP0                                                                   */
...
//#include "system_SN32F770.h"                    /*!< SN32F770 System                                                           */
...
typedef struct {                                /*!< (@ 0x40060000) SN_SYS0 Structure                                          */
  ...
  union {
    ...
    struct {
      __IOM uint32_t IHRCEN     : 3;            /*!< [2..0] IHRC enable                                                        */
            uint32_t            : 29;
    } ANBCTRL_b;
  } ;
...
typedef struct {                                /*!< (@ 0x40026000) SN_ADC Structure                                           */
  ...
  union {
    ...
    struct {
      __IOM uint32_t CHS        : 3;            /*!< [2..0] ADC input channel                                                  */
            uint32_t            : 1;
...
typedef struct {                                /*!< (@ 0x40028000) SN_CMP Structure                                           */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t CM0PREF    : 2;            /*!< [2..1] CMP0 Positive reference voltage (VPREF0) source                    */
      __IOM uint32_t CM0NS      : 2;            /*!< [4..3] CMP0 negative input pin selection bit                              */
      __IOM uint32_t CM0RS      : 4;            /*!< [8..5] CMP0 internal reference voltage (VIREF0) selection bits            */
      __IOM uint32_t CM0OEN     : 1;            /*!< [9..9] CMP0 Output pin control bit                                        */
      __IOM uint32_t CM0G       : 1;            /*!< [10..10] CMP0 interrupt trigger direction control bit                     */
            uint32_t            : 21;
    } CTRL_b;
  } ;
  ...
  union {
    __IOM uint32_t DB;                          /*!< (@ 0x00000018) Offset:0x18 CMP Interrupt Clear Register                   */
...
typedef struct {                                /*!< (@ 0x40000000) SN_CT16B0 Structure                                        */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t CM         : 3;            /*!< [6..4] Counting mode selection                                            */
            uint32_t            : 1;
      __IOM uint32_t IHRCFREQ   : 4;            /*!< [11..8] Internal high-speed clock frequency for CT16B0 PCLK               */
            uint32_t            : 20;
    } TMRCTRL_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t EM2        : 1;            /*!< [2..2] When the TC doesn't match MR2 and EMC2 is not 0, this
            ...
            uint32_t            : 1;
      __IOM uint32_t EMC0       : 2;            /*!< [5..4] CT16Bn_PWM0 functionality when the TC matches MR0                  */
      __IOM uint32_t EMC1       : 2;            /*!< [7..6] CT16Bn_PWM1 functionality when the TC matches MR1                  */
      __IOM uint32_t EMC2       : 2;            /*!< [9..8] CT16Bn_PWM2 functionality when the TC matches MR2                  */
            uint32_t            : 14;
      __OM  uint32_t PWMKEY     : 8;            /*!< [31..24] PWM register key.                                                */
    } EM_b;
  } ;
  ...
  union {
    __IOM uint32_t PWMmNIOCTRL;                 /*!< (@ 0x00000044) Offset:0x44 CT16Bn PWMmN IO Control register               */
  ...
  union {
    __IOM uint32_t PWM0NDB;                     /*!< (@ 0x00000048) Offset:0x48 CT16Bn PWM0N Dead-band Period Register         */
  ...
  union {
    __IOM uint32_t PWM1NDB;                     /*!< (@ 0x0000004C) Offset:0x4C CT16Bn PWM1N Dead-band Period Register         */
  ...
  union {
    __IOM uint32_t PWM2NDB;                     /*!< (@ 0x00000050) Offset:0x50 CT16Bn PWM2N Dead-band Period Register         */
...
typedef struct {                                /*!< (@ 0x40002000) SN_CT16B1 Structure                                        */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t EMC1       : 2;            /*!< [7..6] CT16Bn_PWM1 functionality when the TC matches MR1                  */
      __IOM uint32_t EMC2       : 2;            /*!< [9..8] CT16Bn_PWM2 functionality when the TC matches MR2                  */
      __IOM uint32_t EMC3       : 2;            /*!< [11..10] CT16Bn_PWM3 functionality when the TC matches MR3                */
            uint32_t            : 12;
      __OM  uint32_t PWMKEY     : 8;            /*!< [31..24] PWM register key                                                 */
    } EM_b;
  } ;
...
typedef struct {                                /*!< (@ 0x40062000) SN_FLASH Structure                                         */
  ...
  union {
    ...
    struct {
      __IOM uint32_t DATA       : 32;           /*!< [31..0] Data to be programmed or be read                                  */
    } DATA_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t ADDR       : 32;           /*!< [31..0] Flash Address                                                     */
    } ADDR_b;
  } ;
...
typedef struct {                                /*!< (@ 0x1FFF2224) SN_UC Structure                                            */
...
#define SN_UC_BASE                  0x1FFF2224UL
