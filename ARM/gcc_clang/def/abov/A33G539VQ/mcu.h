...
//#include "system_A33G53x.h"                         /*!< A33G53x System                                                        */
...
typedef struct {                                    /*!< FMC Structure                                                         */
  ...
  __I  uint32_t  RESERVED2;
  __IO uint32_t  IER;                               /*!< Flash Memory Interrupt Enable Register                 */
  __IO uint32_t  ISR;                               /*!< Flash Memory Interrupt Status Register                 */
} FMC_Type;
...
/**
  * @brief PMULEGACY A33G53x Extended Mode Register (PMULEGACY)
  */

typedef struct {                                    /*!< PMULEGACY Structure                                                   */
  __IO uint32_t  LEGACY;                            /*!< PMULEGACY A33G53x Extended Mode Register                              */
} PMULEGACY_Type;
