...
#if !defined(MKM14ZA5_COMMON_H_)
#define MKM14ZA5_COMMON_H_                       /**< Symbol preventing repeated inclusion */
...
#define CPU_MKM14Z64ACHH5 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKM14ZA5_SERIES
