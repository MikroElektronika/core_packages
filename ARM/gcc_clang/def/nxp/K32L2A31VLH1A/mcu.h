...
#if !defined(K32L2A31A_COMMON_H_)
#define K32L2A31A_COMMON_H_                      /**< Symbol preventing repeated inclusion */
...
#define CPU_K32L2A31VLH1A // Note: Added for MikroE implementation.
