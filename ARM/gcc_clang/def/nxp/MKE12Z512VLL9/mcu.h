...
#if !defined(MKE12Z9_COMMON_H_)
#define MKE12Z9_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE12Z512VLL9 // Note: Added for MikroE implementation.
