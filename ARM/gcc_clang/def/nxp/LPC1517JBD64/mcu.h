...
/**
  ...
  */
                                                    /* updated LPC_SYSCON_Type Keil 26.08.2015 */
typedef struct {                                    /*!< SYSCON Structure */
  __IO uint32_t  SYSMEMREMAP;                       /*!< (R/W)  0x000  System memory remap */
  __I  uint32_t  RESERVED0[2];          
  __IO uint32_t  AHBBUFEN0;                         /*!< (R/W)  0x00C  AHB-to-APB bridge 0 write buffering control */
  __IO uint32_t  AHBBUFEN1;                         /*!< (R/W)  0x010  AHB-to-APB bridge 1 write buffering control */
  __IO uint32_t  SYSTCKCAL;                         /*!< (R/W)  0x014  System tick counter calibration */
  __I  uint32_t  RESERVED1;                         /*!< (R/W)  0x018  Reserved */
  __IO uint32_t  NMISRC;                            /*!< (R/W)  0x01C  NMI Source Control */
  __I  uint32_t  RESERVED2[8];          
  __IO uint32_t  SYSRSTSTAT;                        /*!< (R/W)  0x040  System reset status register */
  __IO uint32_t  PRESETCTRL0;                       /*!< (R/W)  0x044  Peripheral reset control 0 */
  __IO uint32_t  PRESETCTRL1;                       /*!< (R/W)  0x048  Peripheral reset control 1 */
  __I  uint32_t  PIOPORCAP0;                        /*!< (R  )  0x04C  POR captured PIO status 0 */
  __I  uint32_t  PIOPORCAP1;                        /*!< (R  )  0x050  POR captured PIO status 1 */
  __I  uint32_t  PIOPORCAP2;                        /*!< (R  )  0x054  POR captured PIO status 2 */
  __I  uint32_t  RESERVED3[10];         
  __IO uint32_t  MAINCLKSELA;                       /*!< (R/W)  0x080  Main clock source select A */
  __IO uint32_t  MAINCLKSELB;                       /*!< (R/W)  0x084  Main clock source select B */
  __IO uint32_t  USBCLKSEL;                         /*!< (R/W)  0x088  USB clock source select */
  __IO uint32_t  ADCASYNCCLKSEL;                    /*!< (R/W)  0x08C  ADC asynchronous clock source select */
  __I  uint32_t  RESERVED4;             
  __IO uint32_t  CLKOUTSELA;                        /*!< (R/W)  0x094  CLKOUT clock source select A */
  __IO uint32_t  CLKOUTSELB;                        /*!< (R/W)  0x098  CLKOUT clock source select B */
  __I  uint32_t  RESERVED5;             
  __IO uint32_t  SYSPLLCLKSEL;                      /*!< (R/W)  0x0A0  System PLL clock source select */
  __IO uint32_t  USBPLLCLKSEL;                      /*!< (R/W)  0x0A4  USB PLL clock source select */
  __IO uint32_t  SCTPLLCLKSEL;                      /*!< (R/W)  0x0A8  SCT PLL clock source select */
  __I  uint32_t  RESERVED6[5];          
  __IO uint32_t  SYSAHBCLKDIV;                      /*!< (R/W)  0x0C0  System clock divider */
  __IO uint32_t  SYSAHBCLKCTRL0;                    /*!< (R/W)  0x0C4  System clock control */
  __IO uint32_t  SYSAHBCLKCTRL1;                    /*!< (R/W)  0x0C8  System clock control */
  __IO uint32_t  SYSTICKCLKDIV;                     /*!< (R/W)  0x0CC  SYSTICK clock divider */
  __IO uint32_t  UARTCLKDIV;                        /*!< (R/W)  0x0D0  USART clock divider. Clock divider for the USART fractional baud rate generator */
  __IO uint32_t  IOCONCLKDIV;                       /*!< (R/W)  0x0D4  Peripheral clock to the IOCON block for programmable glitch filter */
  __IO uint32_t  TRACECLKDIV;                       /*!< (R/W)  0x0D8  ARM trace clock divider */
  __I  uint32_t  RESERVED7[4];          
  __IO uint32_t  USBCLKDIV;                         /*!< (R/W)  0x0EC  USB clock divider */
  __IO uint32_t  ADCASYNCCLKDIV;                    /*!< (R/W)  0x0F0  Asynchronous ADC clock divider */
  __I  uint32_t  RESERVED8;             
  __IO uint32_t  CLKOUTDIV;                         /*!< (R/W)  0x0F8  CLKOUT clock divider */
  __I  uint32_t  RESERVED9[9];          
  __IO uint32_t  FREQMECTRL;                        /*!< (R/W)  0x120  Frequency measure register */
  __IO uint32_t  FLASHCFG;                          /*!< (R/W)  0x124  Flash waitstates configuration register */
  __IO uint32_t  FRGCTRL;                           /*!< (R/W)  0x128  USART fractional baud rate generator control */
  __IO uint32_t  USBCLKCTRL;                        /*!< (R/W)  0x12C  USB clock control */
  __IO uint32_t  USBCLKST;                          /*!< (R/W)  0x130  USB clock status */
  __I  uint32_t  RESERVED10[19];        
  __IO uint32_t  BODCTRL;                           /*!< (R/W)  0x180  Brown-Out Detect */
  __IO uint32_t  IRCCTRL;                           /*!< (R/W)  0x184  IRC trim value */
  __IO uint32_t  SYSOSCCTRL;                        /*!< (R/W)  0x188  System oscillator control */
  __I  uint32_t  RESERVED12;            
  __IO uint32_t  RTCOSCCTRL;                        /*!< (R/W)  0x190  RTC oscillator 32 kHz output control */
  __I  uint32_t  RESERVED13;            
  __IO uint32_t  SYSPLLCTRL;                        /*!< (R/W)  0x198  System PLL control */
  __I  uint32_t  SYSPLLSTAT;                        /*!< (R  )  0x19C  System PLL status */
  __IO uint32_t  USBPLLCTRL;                        /*!< (R/W)  0x1A0  USB PLL control */
  __I  uint32_t  USBPLLSTAT;                        /*!< (R  )  0x1A4  USB PLL status */
  __IO uint32_t  SCTPLLCTRL;                        /*!< (R/W)  0x1A8  SCT PLL control */
  __I  uint32_t  SCTPLLSTAT;                        /*!< (R  )  0x1AC  SCT PLL status */
  __I  uint32_t  RESERVED14[21];        
  __IO uint32_t  PDAWAKECFG;                        /*!< (R/W)  0x204  Power-down states for wake-up from deep-sleep */
  __IO uint32_t  PDRUNCFG;                          /*!< (R/W)  0x208  Power configuration register */ 
  __I  uint32_t  RESERVED15[3];         
  __IO uint32_t  STARTERP0;                         /*!< (R/W)  0x218  Start logic 0 wake-up enable register */
  __IO uint32_t  STARTERP1;                         /*!< (R/W)  0x21C  Start logic 1 wake-up enable register */
  __I  uint32_t  RESERVED16[117];       
  __I  uint32_t  JTAG_IDCODE;                       /*!< (R  )  0x3F4  JTAG ID code register */
  __I  uint32_t  DEVICE_ID0;                        /*!< (R  )  0x3F8  Part ID register */
  __I  uint32_t  DEVICE_ID1;                        /*!< (R  )  0x3FC  Boot ROM and die revision register */
} LPC_SYSCON_Type;

#if 0                                               /* keep old version Keil 26.08.2015 */
typedef struct {                                    /*!< SYSCON Structure                                                      */
