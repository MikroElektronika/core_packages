...
#if !defined(MKE16Z4_COMMON_H_)
#define MKE16Z4_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE16Z32VLF4 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKE16Z4_SERIES
