...
#if !defined(MKE15Z4_COMMON_H_)
#define MKE15Z4_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE15Z32VLD4 // Note: Added for MikroE implementation.
