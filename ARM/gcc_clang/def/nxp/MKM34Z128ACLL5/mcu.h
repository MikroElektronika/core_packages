...
#if !defined(MKM34ZA5_COMMON_H_)
#define MKM34ZA5_COMMON_H_                       /**< Symbol preventing repeated inclusion */
...
#define CPU_MKM34Z128ACLL5 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKM34ZA5_SERIES
