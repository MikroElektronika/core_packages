...
#if !defined(MKE14Z7_COMMON_H_)
#define MKE14Z7_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE14Z256VLH7 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKE14Z7_SERIES
