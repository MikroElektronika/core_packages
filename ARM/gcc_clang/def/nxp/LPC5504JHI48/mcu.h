...
#if !defined(LPC5506_COMMON_H_)
#define LPC5506_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
//#include "system_LPC5506.h"            /* Device specific configuration file */
