...
#if !defined(MKE17Z9_COMMON_H_)
#define MKE17Z9_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE17Z512VLH9 // Note: Added for MikroE implementation.
