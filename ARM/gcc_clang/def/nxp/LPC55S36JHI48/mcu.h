...
#if !defined(LPC55S36_COMMON_H_)
#define LPC55S36_COMMON_H_                       /**< Symbol preventing repeated inclusion */
...
/* ITRC - Peripheral instance base addresses */
  ...
  #define ITRC0_BASE                               (0x5000F000u)
  /** Peripheral ITRC0 base address */
  #define ITRC0_BASE_NS                            (0x4000F000u)
...
/* PKC - Peripheral instance base addresses */
  ...
  #define PKC_BASE                                 (0x5002F000u)
  /** Peripheral PKC base address */
  #define PKC_BASE_NS                              (0x4002F000u)
...
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral PRINCE0 base address */
  #define PRINCE0_BASE                             (0x50035000u)
  /** Peripheral PRINCE0 base address */
  #define PRINCE0_BASE_NS                          (0x40035000u)
  /** Peripheral PRINCE0 base pointer */
  #define PRINCE0                                  ((PRINCE_Type *)PRINCE0_BASE)
  /** Peripheral PRINCE0 base pointer */
  #define PRINCE0_NS                               ((PRINCE_Type *)PRINCE0_BASE_NS)
  /** Array initializer of PRINCE peripheral base addresses */
  #define PRINCE_BASE_ADDRS                        { PRINCE0_BASE }
  /** Array initializer of PRINCE peripheral base pointers */
  #define PRINCE_BASE_PTRS                         { PRINCE0 }
  /** Array initializer of PRINCE peripheral base addresses */
  #define PRINCE_BASE_ADDRS_NS                     { PRINCE0_BASE_NS }
  /** Array initializer of PRINCE peripheral base pointers */
  #define PRINCE_BASE_PTRS_NS                      { PRINCE0_NS }
#else
  /** Peripheral PRINCE0 base address */
  #define PRINCE0_BASE                             (0x40035000u)
  /** Peripheral PRINCE0 base pointer */
  #define PRINCE0                                  ((PRINCE_Type *)PRINCE0_BASE)
  /** Array initializer of PRINCE peripheral base addresses */
  #define PRINCE_BASE_ADDRS                        { PRINCE0_BASE }
...
/* PUF - Peripheral instance base addresses */
  ...
  #define PUF_BASE                                 (0x5003A000u)
  /** Peripheral PUF base address */
  #define PUF_BASE_NS                              (0x4003A000u)
  /** Peripheral PUF base pointer */
  #define PUF                                      ((PUF_Type *)PUF_BASE)
  /** Peripheral PUF base pointer */
  #define PUF_NS                                   ((PUF_Type *)PUF_BASE_NS)
  /** Peripheral PUF base address */
  #define PUF_ALIAS1_BASE                          (0x5003B000u)
  /** Peripheral PUF base address */
  #define PUF_ALIAS1_BASE_NS                       (0x4003B000u)
  /** Peripheral PUF base pointer */
  #define PUF_ALIAS1                               ((PUF_Type *)PUF_ALIAS1_BASE)
  /** Peripheral PUF base pointer */
  #define PUF_ALIAS1_NS                            ((PUF_Type *)PUF_ALIAS1_BASE_NS)
  /** Peripheral PUF base address */
  #define PUF_ALIAS2_BASE                          (0x5003C000u)
  /** Peripheral PUF base address */
  #define PUF_ALIAS2_BASE_NS                       (0x4003C000u)
  /** Peripheral PUF base pointer */
  #define PUF_ALIAS2                               ((PUF_Type *)PUF_ALIAS2_BASE)
  /** Peripheral PUF base pointer */
  #define PUF_ALIAS2_NS                            ((PUF_Type *)PUF_ALIAS2_BASE_NS)
  /** Peripheral PUF base address */
  #define PUF_ALIAS3_BASE                          (0x5003D000u)
  /** Peripheral PUF base address */
  #define PUF_ALIAS3_BASE_NS                       (0x4003D000u)
  /** Peripheral PUF base pointer */
...
#else
  /** Peripheral PUF base address */
  #define PUF_BASE                                 (0x4003A000u)
  /** Peripheral PUF base pointer */
  #define PUF                                      ((PUF_Type *)PUF_BASE)
  /** Peripheral PUF base address */
  #define PUF_ALIAS1_BASE                          (0x4003B000u)
  /** Peripheral PUF base pointer */
  #define PUF_ALIAS1                               ((PUF_Type *)PUF_ALIAS1_BASE)
  /** Peripheral PUF base address */
  #define PUF_ALIAS2_BASE                          (0x4003C000u)
  /** Peripheral PUF base pointer */
  #define PUF_ALIAS2                               ((PUF_Type *)PUF_ALIAS2_BASE)
  /** Peripheral PUF base address */
  #define PUF_ALIAS3_BASE                          (0x4003D000u)
  /** Peripheral PUF base pointer */
  #define PUF_ALIAS3                               ((PUF_Type *)PUF_ALIAS3_BASE)
  /** Array initializer of PUF peripheral base addresses */
  #define PUF_BASE_ADDRS                           { PUF_BASE, PUF_ALIAS1_BASE, PUF_ALIAS2_BASE, PUF_ALIAS3_BASE }
...
/* S50 - Peripheral instance base addresses */
  ...
  #define ELS_BASE                                 (0x50030000u)
  /** Peripheral ELS base address */
  #define ELS_BASE_NS                              (0x40030000u)
  /** Peripheral ELS base pointer */
  #define ELS                                      ((S50_Type *)ELS_BASE)
  /** Peripheral ELS base pointer */
  #define ELS_NS                                   ((S50_Type *)ELS_BASE_NS)
  /** Peripheral ELS base address */
  #define ELS_ALIAS1_BASE                          (0x50031000u)
  /** Peripheral ELS base address */
  #define ELS_ALIAS1_BASE_NS                       (0x40031000u)
  /** Peripheral ELS base pointer */
  #define ELS_ALIAS1                               ((S50_Type *)ELS_ALIAS1_BASE)
  /** Peripheral ELS base pointer */
  #define ELS_ALIAS1_NS                            ((S50_Type *)ELS_ALIAS1_BASE_NS)
  /** Peripheral ELS base address */
  #define ELS_ALIAS2_BASE                          (0x50032000u)
  /** Peripheral ELS base address */
  #define ELS_ALIAS2_BASE_NS                       (0x40032000u)
  /** Peripheral ELS base pointer */
  #define ELS_ALIAS2                               ((S50_Type *)ELS_ALIAS2_BASE)
  /** Peripheral ELS base pointer */
  #define ELS_ALIAS2_NS                            ((S50_Type *)ELS_ALIAS2_BASE_NS)
  /** Peripheral ELS base address */
  #define ELS_ALIAS3_BASE                          (0x50033000u)
  /** Peripheral ELS base address */
  #define ELS_ALIAS3_BASE_NS                       (0x40033000u)
  /** Peripheral ELS base pointer */
...
#else
  /** Peripheral ELS base address */
  #define ELS_BASE                                 (0x40030000u)
  /** Peripheral ELS base pointer */
  #define ELS                                      ((S50_Type *)ELS_BASE)
  /** Peripheral ELS base address */
  #define ELS_ALIAS1_BASE                          (0x40031000u)
  /** Peripheral ELS base pointer */
  #define ELS_ALIAS1                               ((S50_Type *)ELS_ALIAS1_BASE)
  /** Peripheral ELS base address */
  #define ELS_ALIAS2_BASE                          (0x40032000u)
  /** Peripheral ELS base pointer */
  #define ELS_ALIAS2                               ((S50_Type *)ELS_ALIAS2_BASE)
  /** Peripheral ELS base address */
  #define ELS_ALIAS3_BASE                          (0x40033000u)
  /** Peripheral ELS base pointer */
  #define ELS_ALIAS3                               ((S50_Type *)ELS_ALIAS3_BASE)
  /** Array initializer of S50 peripheral base addresses */
  #define S50_BASE_ADDRS                           { ELS_BASE, ELS_ALIAS1_BASE, ELS_ALIAS2_BASE, ELS_ALIAS3_BASE }
...
/* SECTRL - Peripheral instance base addresses */
#if (defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE & 0x2))
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_BASE                             (0x500AC000u)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_BASE_NS                          (0x400AC000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0                                  ((SECTRL_Type *)SECTRL0_BASE)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_NS                               ((SECTRL_Type *)SECTRL0_BASE_NS)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS1_BASE                      (0x500AD000u)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS1_BASE_NS                   (0x400AD000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS1                           ((SECTRL_Type *)SECTRL0_ALIAS1_BASE)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS1_NS                        ((SECTRL_Type *)SECTRL0_ALIAS1_BASE_NS)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS2_BASE                      (0x500AE000u)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS2_BASE_NS                   (0x400AE000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS2                           ((SECTRL_Type *)SECTRL0_ALIAS2_BASE)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS2_NS                        ((SECTRL_Type *)SECTRL0_ALIAS2_BASE_NS)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS3_BASE                      (0x500AF000u)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS3_BASE_NS                   (0x400AF000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS3                           ((SECTRL_Type *)SECTRL0_ALIAS3_BASE)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS3_NS                        ((SECTRL_Type *)SECTRL0_ALIAS3_BASE_NS)
  /** Array initializer of SECTRL peripheral base addresses */
  #define SECTRL_BASE_ADDRS                        { SECTRL0_BASE, SECTRL0_ALIAS1_BASE, SECTRL0_ALIAS2_BASE, SECTRL0_ALIAS3_BASE }
  /** Array initializer of SECTRL peripheral base pointers */
  #define SECTRL_BASE_PTRS                         { SECTRL0, SECTRL0_ALIAS1, SECTRL0_ALIAS2, SECTRL0_ALIAS3 }
  /** Array initializer of SECTRL peripheral base addresses */
  #define SECTRL_BASE_ADDRS_NS                     { SECTRL0_BASE_NS, SECTRL0_ALIAS1_BASE_NS, SECTRL0_ALIAS2_BASE_NS, SECTRL0_ALIAS3_BASE_NS }
  /** Array initializer of SECTRL peripheral base pointers */
  #define SECTRL_BASE_PTRS_NS                      { SECTRL0_NS, SECTRL0_ALIAS1_NS, SECTRL0_ALIAS2_NS, SECTRL0_ALIAS3_NS }
#else
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_BASE                             (0x400AC000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0                                  ((SECTRL_Type *)SECTRL0_BASE)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS1_BASE                      (0x400AD000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS1                           ((SECTRL_Type *)SECTRL0_ALIAS1_BASE)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS2_BASE                      (0x400AE000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS2                           ((SECTRL_Type *)SECTRL0_ALIAS2_BASE)
  /** Peripheral SECTRL0 base address */
  #define SECTRL0_ALIAS3_BASE                      (0x400AF000u)
  /** Peripheral SECTRL0 base pointer */
  #define SECTRL0_ALIAS3                           ((SECTRL_Type *)SECTRL0_ALIAS3_BASE)
  /** Array initializer of SECTRL peripheral base addresses */
  #define SECTRL_BASE_ADDRS                        { SECTRL0_BASE, SECTRL0_ALIAS1_BASE, SECTRL0_ALIAS2_BASE, SECTRL0_ALIAS3_BASE }
...
/* SPI_FILTER - Peripheral instance base addresses */
  ...
  #define SPI_FILTER_BASE                          (0x50024000u)
  /** Peripheral SPI_FILTER base address */
  #define SPI_FILTER_BASE_NS                       (0x40024000u)
...
#else
  /** Peripheral SPI_FILTER base address */
  #define SPI_FILTER_BASE                          (0x40024000u)
  /** Peripheral SPI_FILTER base pointer */
  #define SPI_FILTER                               ((SPI_FILTER_Type *)SPI_FILTER_BASE)
  /** Array initializer of SPI_FILTER peripheral base addresses */
  #define SPI_FILTER_BASE_ADDRS                    { SPI_FILTER_BASE }
