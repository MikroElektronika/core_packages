...
#if !defined(MKM34Z7_COMMON_H_)
#define MKM34Z7_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKM34Z256VLQ7 // Note: Added for MikroE implementation.
