...
#if !defined(MKE12Z7_COMMON_H_)
#define MKE12Z7_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE12Z256VLH7 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKE12Z7_SERIES
