...
#if !defined(MKE17Z7_COMMON_H_)
#define MKE17Z7_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE17Z256VLF7 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKE17Z7_SERIES
