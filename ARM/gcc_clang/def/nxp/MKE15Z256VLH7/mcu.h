...
#if !defined(MKE15Z7_COMMON_H_)
#define MKE15Z7_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE15Z256VLH7 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKE15Z7_SERIES
