...
#if !defined(LPC55S04_COMMON_H_)
#define LPC55S04_COMMON_H_                       /**< Symbol preventing repeated inclusion */
...
//#include "system_LPC55S04.h"           /* Device specific configuration file */
