...
#if !defined(MKE13Z7_COMMON_H_)
#define MKE13Z7_COMMON_H_                        /**< Symbol preventing repeated inclusion */
...
#define CPU_MKE13Z128VLL7 // Note: Added for MikroE implementation.
#include "fsl_device_registers.h" // Note: Added for MikroE implementation.

#define MKE13Z7_SERIES
