...
**     - rev. 4.0 (2016-09-20)
**         Up2025-05-16d based on rev2 RDP.
**
** ###################################################################
*/
 ...
 *  0b1..FTM counter is up2025-05-16d with its initial value when the selected trigger is detected.
 */
#define FTM_SYNC_REINIT(x)                       (((uint32_t)(((uint32_t)(x)) << FTM_SYNC_REINIT_SHIFT)) & FTM_SYNC_REINIT_MASK)
#define FTM_SYNC_SYNCHOM_MASK                    (0x8U)
#define FTM_SYNC_SYNCHOM_SHIFT                   (3U)
/*! SYNCHOM - Output Mask Synchronization
 *  0b0..OUTMASK register is up2025-05-16d with the value of its buffer in all rising edges of the FTM input clock.
 *  0b1..OUTMASK register is up2025-05-16d with the value of its buffer only by the PWM synchronization.
 */
 ...
 *  0b0..CNTIN register is up2025-05-16d with its buffer value at all rising edges of FTM input clock.
 *  0b1..CNTIN register is up2025-05-16d with its buffer value by the PWM synchronization.
 */
#define FTM_SYNCONF_CNTINC(x)                    (((uint32_t)(((uint32_t)(x)) << FTM_SYNCONF_CNTINC_SHIFT)) & FTM_SYNCONF_CNTINC_MASK)
#define FTM_SYNCONF_INVC_MASK                    (0x10U)
#define FTM_SYNCONF_INVC_SHIFT                   (4U)
/*! INVC - INVCTRL Register Synchronization
 *  0b0..INVCTRL register is up2025-05-16d with its buffer value at all rising edges of FTM input clock.
 *  0b1..INVCTRL register is up2025-05-16d with its buffer value by the PWM synchronization.
 */
#define FTM_SYNCONF_INVC(x)                      (((uint32_t)(((uint32_t)(x)) << FTM_SYNCONF_INVC_SHIFT)) & FTM_SYNCONF_INVC_MASK)
#define FTM_SYNCONF_SWOC_MASK                    (0x20U)
#define FTM_SYNCONF_SWOC_SHIFT                   (5U)
/*! SWOC - SWOCTRL Register Synchronization
 *  0b0..SWOCTRL register is up2025-05-16d with its buffer value at all rising edges of FTM input clock.
 *  0b1..SWOCTRL register is up2025-05-16d with its buffer value by the PWM synchronization.
 */
...
/*! LDOK - Load Enable
 *  0b0..Loading up2025-05-16d values is disabled.
 *  0b1..Loading up2025-05-16d values is enabled.
 */
...
/*! INVW0 - Invali2025-05-16 Way 0
 *  0b0..No operation
 *  0b1..When setting the GO bit, invali2025-05-16 all lines in way 0.
 */
...
/*! INVW1 - Invali2025-05-16 Way 1
 *  0b0..No operation
 *  0b1..When setting the GO bit, invali2025-05-16 all lines in way 1
 */
 ...
 *  0b1..Bus error overrun occurred. The FADR and FDR registers and the other FATR bits are not up2025-05-16d to reflect this new bus error.
 */
 ...
 *  0b1..Pin Control Register fields [15:0] are locked and cannot be up2025-05-16d until the next system reset.
 */
 ...
 *  0b0000000000000000..Corresponding Pin Control Register is not up2025-05-16d with the value in GPWD.
 *  0b0000000000000001..Corresponding Pin Control Register is up2025-05-16d with the value in GPWD.
 */
 ...
 *  0b0..PWT pulse width register(s) is not up-to-2025-05-16.
 *  0b1..PWT pulse width register(s) has been up2025-05-16d.
 */
...
/*! FIRCTRUP - Fast IRC Trim Up2025-05-16
 *  0b0..Disable Fast IRC trimming up2025-05-16s
 *  0b1..Enable Fast IRC trimming up2025-05-16s
 */
...
/*! UPDATE - Allow up2025-05-16s
 *  0b0..Up2025-05-16s not allowed. After the initial configuration, the watchdog cannot be later modified without forcing a reset.
 *  0b1..Up2025-05-16s allowed. Software can modify the watchdog configuration registers within 128 bus clocks after performing the unlock write sequence.
 */
