...
#if !defined(LPC55S28_COMMON_H_)
#define LPC55S28_COMMON_H_                       /**< Symbol preventing repeated inclusion */
...
//#include "system_LPC55S28.h"           /* Device specific configuration file */
