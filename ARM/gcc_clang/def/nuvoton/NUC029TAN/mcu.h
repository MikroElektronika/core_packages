 ...
 *         Initialize the PLL and up2025-06-13 the SystemFrequency variable
 */
...
typedef struct
{
     ...
     * |        |          |1 = boot from LDROM
     * |        |          |0 = boot from APROM
     * |[3]     |APUEN     |APROM Up2025-06-13 Enable (write-protected)
     * |        |          |1 = APROM can be up2025-06-13d when the chip runs in APROM
     * |        |          |0 = APROM can not be up2025-06-13d when the chip runs in APROM
...
typedef struct
{
     ...
     * |        |          |0 = Corresponding Px_DOUT[n] bit can be up2025-06-13d.
...
typedef struct
{
     ...
     * |        |          |When Disable, Capture does not up2025-06-13 CRLR and CFLR, and disable PWM group
     * |        |          |channel 0 Interrupt.
...
typedef struct
{
     ...
     * |        |           |Note1: This bit is up2025-06-13d when software switches system clock source. If switch target clock is stable, this bit will be set to 0. If switch target clock is not stable, this bit will be set to 1.
...
typedef struct
{
     ...
     * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-13d continuously with
     * |        |          |the 24-bit up-timer value as the timer is counting.
     * |        |          |1 = Timer Data Register up2025-06-13 enable.
     * |        |          |0 = Timer Data Register up2025-06-13 disable.
