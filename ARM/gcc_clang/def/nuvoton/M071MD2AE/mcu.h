...
typedef struct
{
     ...
     * |[4]     |CFGUEN    |Config Up2025-07-04 Enable (Write Protect)
     ...
     * |[5]     |LDUEN     |LDROM Up2025-07-04 Enable (Write Protect)
     * |        |          |LDROM up2025-07-04 enable bit.
     * |        |          |0 = LDROM cannot be up2025-07-04d
     * |        |          |1 = LDROM can be up2025-07-04d when chip runs in APROM.
...
typedef struct
{
     ...
     * |        |          |0 = Corresponding GPIOx_DOUT[n] bit can be up2025-07-04d.
...
typedef struct
{
     ...
     * |        |          |        controller attempts to transmit data to a master, the transmit data register should be up2025-07-04d
...
typedef struct
{
     ...
     * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-07-04d continuously with the 24-bit up-timer value as the timer is counting.
     ...
     * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-07-04d continuously to monitor 24-bit up counter value.
     */
    __I  uint32_t  TDR;
...
typedef struct
{
     ...
     * |[3]     |LINS_DUM_EN|LIN Slave Divider Up2025-07-04 Method Enable Control
     * |        |          |0 = UA_BAUD up2025-07-04d is written by software (if no automatic resynchronization up2025-07-04 occurs at the same time).
     * |        |          |1 = UA_BAUD is up2025-07-04d at the next received character. User must set the bit before checksum reception.
     * |        |          |Note1: This bit only valid when in LIN slave mode (LINS_EN (UA_LIN_CTL[0]) = 1).
...
typedef struct
{
     ...
     * |        |          |WWDTCVAL will be up2025-07-04d continuously to monitor 6-bit down counter value.
     */
