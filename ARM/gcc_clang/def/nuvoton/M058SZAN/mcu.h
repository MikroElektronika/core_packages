 ...
 *         Initialize the PLL and up2025-06-27 the SystemFrequency variable
 */
 ...
 * |        |          |1 = boot from LDROM
 * |        |          |Note: This bit is write protected.
 * |[3]     |APUEN     |APROM Up2025-06-27 Enable
 * |        |          |0 = APROM cannot be up2025-06-27d when the chip runs in APROM
 * |        |          |1 = APROM can be up2025-06-27d when the chip runs in APROM
 * |        |          |Note: This bit is write protected.
 * |[4]     |CFGUEN    |Config Up2025-06-27 Enable
 * |        |          |Writing this bit to 1 enables s/w to up2025-06-27 Config value by ISP procedure regardless of program
 * |        |          |code is running in APROM or LDROM.
 * |        |          |0 = Config up2025-06-27 disable
 * |        |          |1 = Config up2025-06-27 enable
 * |        |          |Note: This bit is write protected.
 * |[5]     |LDUEN     |LDROM Up2025-06-27 Enable
 * |        |          |LDROM up2025-06-27 enable bit.
 * |        |          |0 = LDROM cannot be up2025-06-27d
 * |        |          |1 = LDROM can be up2025-06-27d.
 * |        |          |Note: This bit is write protected.
 ...
 * |        |          |0 = Corresponding Px_DOUT[n] bit can be up2025-06-27d.
 ...
 * |        |          |Note2: When Disabled, Capture does not up2025-06-27 CRLR and CFLR, and disable PWM group channel 0 Interrupt.
 ...
 * |        |          |Note2: When Disabled, Capture does not up2025-06-27 CRLR and CFLR, and disable PWM group channel 1 Interrupt.
 ...
 * |        |          |Note2: When Disabled, Capture does not up2025-06-27 CRLR and CFLR, and disable PWM group channel 2 Interrupt.
 ...
 * |        |          |Note1: When Enabled, Capture latched the PWM-counter and saved to CRLR (Rising latch) and CFLR (Falling latch).
 * |        |          |Note2: When Disabled, Capture does not up2025-06-27 CRLR and CFLR, and disable PWM group channel 3 Interrupt.
 ...
 * |        |          |up2025-06-27 the transmit data register before setting the GO_BUSY bit to 1.
 * @var SPI_T::CNTRL2
 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-27d continuously with the 24-bit up-timer value as the timer is counting.
 * |        |          |0 = Timer Data Register up2025-06-27 Disabled.
 * |        |          |1 = Timer Data Register up2025-06-27 Enabled while Timer counter is active.
 ...
 * |        |          |When user up2025-06-27s TCMP while timer is running in periodic mode, TDR will be reset to default value.
 * |        |          |1 = The behavior selection in periodic mode is Enabled.
 * |        |          |When user up2025-06-27 TCMP while timer is running in periodic mode, the limitations as bellows list,
 * |        |          |If up2025-06-27d TCMP value > TDR, TCMP will be up2025-06-27d and TDR keep running continually.
 * |        |          |If up2025-06-27d TCMP value = TDR, timer time-out interrupt will be asserted immediately.
 * |        |          |If up2025-06-27d TCMP value < TDR, TDR will be reset to default value.
 ...
 * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-06-27d continuously to monitor 24-bit up counter value.
 * @var TIMER_T::TCAP
 ...
 * |        |          |WWDTCVAL will be up2025-06-27d continuously to monitor 6-bit down counter value.
 */
