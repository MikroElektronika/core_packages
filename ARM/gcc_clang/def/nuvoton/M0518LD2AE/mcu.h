...
typedef struct
{
     ...
     * |[4]     |CFGUEN    |Config Up2025-06-11 Enable (Write Protect)
     ...
     * |[5]     |LDUEN     |LDROM Up2025-06-11 Enable (Write Protect)
     * |        |          |LDROM up2025-06-11 enable bit.
     * |        |          |1 = LDROM can be up2025-06-11d when chip runs in APROM.
...
typedef struct
{
     ...
     * |        |          |0 = Corresponding GPIOx_DOUT[n] bit can be up2025-06-11d.
...
typedef struct
{
     ...
     * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-11d continuously with the 24-bit up-timer value as the timer is counting.
     ...
     * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-06-11d continuously to monitor 24-bit up counter value.
     */
    __I  uint32_t  TDR;
