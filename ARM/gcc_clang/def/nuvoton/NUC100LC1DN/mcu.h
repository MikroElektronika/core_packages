 ...
 * |        |          |This bit is up2025-06-20d when software switches system clock source. 
 ...
 * |        |          |1 = boot from LDROM
 * |        |          |0 = boot from APROM
 * |[4]     |CFGUEN    |Config Up2025-06-20 Enable
 * |        |          |Writing this bit to 1 enables s/w to up2025-06-20 Config value by ISP procedure regardless of
 * |        |          |program
 * |        |          |code is running in APROM or LDROM.
 * |        |          |1 = Config up2025-06-20 enable
 * |        |          |0 = Config up2025-06-20 disable
 * |[5]     |LDUEN     |LDROM Up2025-06-20 Enable
 * |        |          |LDROM up2025-06-20 enable bit.
 * |        |          |1 = LDROM can be up2025-06-20d when the MCU runs in APROM.
 ...
 * |        |          |0 = Corresponding GPIOx_DOUT[n] bit can be up2025-06-20d.
 ...
 * |        |          |CFLR (Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-20 CRLR and CFLR, and disable PWM group channel 0
 * |        |          |Interrupt.
 ...
 * |        |          |(Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-20 CRLR and CFLR, and disable PWM group channel 1
 * |        |          |Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter value and saved to CRLR (Rising latch) and
 * |        |          |CFLR (Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-20 CRLR and CFLR, and disable PWM group channel 2
 * |        |          |Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter and saved to CRLR (Rising latch) and CFLR
 * |        |          |(Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-20 CRLR and CFLR, and disable PWM group channel 3
 * |        |          |Interrupt.
 ...
 * |        |          |busy time to up2025-06-20 these values completely because PWM clock may be different from system
 * |        |          |clock domain.
 * |        |          |Software needs to check this busy status before writing CNR0/CMR0/PPR or switching PWM0
 * |        |          |operation mode (PCR[3]) to make sure previous setting has been up2025-06-20d completely.
 * |        |          |This bit will be set when software writes CNR0/CMR0/PPR or switches PWM0 operation mode
 * |        |          |(PCR[3]) and will be cleared by hardware automatically when PWM up2025-06-20 these value
 * |        |          |completely.
 * @var PWM_T::SYNCBUSY1
 ...
 * |        |          |a busy time to up2025-06-20 these values completely because PWM clock may be different from system
 * |        |          |clock domain.
 * |        |          |Software needs to check this busy status before writing CNR1/CMR1/PPR or switching PWM1
 * |        |          |operation mode (PCR[11]) to make sure previous setting has been up2025-06-20d completely.
 * |        |          |This bit will be set when software writes CNR1/CMR1/PPR or switches PWM1 operation mode
 * |        |          |(PCR[11]) and will be cleared by hardware automatically when PWM up2025-06-20 these value
 * |        |          |completely.
 * @var PWM_T::SYNCBUSY2
 ...
 * |        |          |operation mode (PCR[19]) to make sure previous setting has been up2025-06-20d completely.
 * |        |          |This bit will be set when software writes CNR2/CMR2/PPR or switch PWM2 operation mode
 * |        |          |(PCR[19]) and will be cleared by hardware automatically when PWM up2025-06-20 these value
 * |        |          |completely.
 * @var PWM_T::SYNCBUSY3
 ...
 * |        |          |operation mode (PCR[27]) to make sure previous setting has been up2025-06-20d completely.
 * |        |          |This bit will be set when Software writes CNR3/CMR3/PPR or switch PWM3 operation mode
 * |        |          |(PCR[27]) and will be cleared by hardware automatically when PWM up2025-06-20 these value
 * |        |          |completely.
 */
 ...
 * |        |          |are up2025-06-20d done is necessary.
 * |        |          |0 = SPRCTL, SPR0 ~ SPR19 updating is in progress.
 * |        |          |1 = SPRCTL, SPR0 ~ SPR19 are up2025-06-20d done and ready to be accessed.
 ...
 * |        |          |The field defines that how many times of HIRC trim value is up2025-06-20d by auto trim circuit before the HIRC frequency locked.
 ...
 * |        |          |This bit controls if an interrupt will be triggered while HIRC trim value up2025-06-20 limitation |count reached and HIRC frequency still not locked on target frequency set by TRIM_SEL (IRCTRIMCTL[1:0]).
 * |        |          |If this bit is high and TRIM_FAIL_INT (IRCTRIMINT[1]) is set during auto trim operation.
 * |        |          |An interrupt will be triggered to notify that HIRC trim value up2025-06-20 limitation count was reached.
 ...
 * |        |          |This bit indicates that internal 22.1184 MHz high speed oscillator trim value up2025-06-20 limitation count reached and the internal 22.1184 MHz high speed oscillator clock frequency still doesn't be locked.
 ...
 * |        |          |If this bit is set and TRIM_FAIL_IEN (IRCTRIMIEN[1]) is high, an interrupt will be triggered to notify that HIRC trim value up2025-06-20 limitation count was reached.
 * |        |          |Write 1 to clear this to 0.
 * |        |          |0 = Trim value up2025-06-20 limitation count did not reach.
 * |        |          |1 = Trim value up2025-06-20 limitation count reached and internal 22.1184 MHz high speed
 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-20d continuously with the 24-bit
 * |        |          |up-timer value as the timer is counting.
 * |        |          |0 = Timer Data Register up2025-06-20 Disabled.
 * |        |          |1 = Timer Data Register up2025-06-20 Enabled while Timer counter is active.
 ...
 * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-06-20d continuously to monitor
 ...
 * |[3]     |LINS_DUM_EN|LIN Slave Divider Up2025-06-20 Method Enable Control
 * |        |          |0 = UA_BAUD up2025-06-20d is written by software (if no automatic resynchronization up2025-06-20 occurs at the same time).
 * |        |          |1 = UA_BAUD is up2025-06-20d at the next received character. User must set the bit before checksum reception.
 * |        |          |Note1: This bit only valid when in LIN slave mode (LINS_EN (UA_LIN_CTL[0]) = 1).
 ...
 * |        |          |    up2025-06-20d to USBD_EPSTS register, so that the USB interrupt event will not be asserted.
 * |        |          |1 = IN NAK status will be up2025-06-20d to USBD_EPSTS register and the USB interrupt event
 ...
 * |        |          |WWDTCVAL will be up2025-06-20d continuously to monitor 6-bit down counter value.
 */
