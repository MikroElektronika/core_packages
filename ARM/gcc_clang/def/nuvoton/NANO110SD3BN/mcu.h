...
typedef struct
{
    ...
    */
     ...
     * |        |          |The DAC needs at least 2 us to settle down every time when each data deliver to DAC, which means user cannot up2025-06-18 each DACx_data register faster than 2 us; otherwise data will lost.
...
typedef struct
{
     ...
     * |        |          |0 = boot from APROM.
     * |        |          |1 = boot from LDROM.
     * |[3]     |APUEN     |APROM Up2025-06-18 Enable (Write-Protection Bit)
     * |        |          |APROM up2025-06-18 enable bit.
     * |        |          |0 = APROM can not be up2025-06-18d.
     * |        |          |1 = APROM can be up2025-06-18d when the MCU runs in APROM.
     * |[4]     |CFGUEN    |Enable Config-Bits Up2025-06-18 By ISP (Write-Protection Bit)
     * |        |          |0 = Disabling ISP can up2025-06-18 config-bits.
     * |        |          |1 = Enabling ISP can up2025-06-18 config-bits.
     * |[5]     |LDUEN     |LDROM Up2025-06-18 Enable (Write-Protection Bit)
     * |        |          |LDROM up2025-06-18 enable bit.
     * |        |          |0 = LDROM cannot be up2025-06-18d.
     * |        |          |1 = LDROM can be up2025-06-18d when the chip runs in APROM.
...
typedef struct
{
    ...
    */
     ...
     * |[7:6]   |TRIM_RETRY_CNT|Trim Value Up2025-06-18 Limitation Count
     * |        |          |This field defines that how many times the auto trim circuit will try to up2025-06-18 the HIRC trim value before the frequency of HIRC locked.
     * |        |          |Once the HIRC locked, the internal trim value up2025-06-18 counter will be reset.
     * |        |          |If the trim value up2025-06-18 counter reached this limitation value and frequency of HIRC still doesn't lock, the auto trim operation will be disabled and TRIM_SEL will be cleared to 00.
    ...
    */
     ...
     * |        |          |This bit controls if an interrupt will be triggered while HIRC trim value up2025-06-18 limitation count reached and HIRC frequency still not locked on target frequency set by TRIM_SEL.
     * |        |          |If this bit is high and TRIM_FAIL_INT is set during auto trim operation, an interrupt will be triggered to notify that HIRC trim value up2025-06-18 limitation count was reached.
    ...
    */
     ...
     * |        |          |This bit indicates that HIRC trim value up2025-06-18 limitation count reached and HIRC clock frequency still doesn't lock.
     * |        |          |Once this bit is set, the auto trim operation stopped and TRIM_SEL will be cleared to 00 by hardware automatically.
     * |        |          |If this bit is set and TRIM_FAIL_IEN is high, an interrupt will be triggered to notify that HIRC trim value up2025-06-18 limitation count was reached.
     * |        |          |Write 1 to clear this to zero.
     * |        |          |0 = Trim value up2025-06-18 limitation count doesn't reach.
     * |        |          |1 = Trim value up2025-06-18 limitation count reached and HIRC frequency still doesn't lock.
...
typedef struct
{
    ...
    */
     ...
     * |        |          |0 = The corresponding GPIO_DOUT bit [n] can be up2025-06-18d.
...
typedef struct
{
     ...
     * |        |          |Setting this bit to 1 to enter Master mode, the device sends a START or repeat START condition to bus when the bus is free and it will be cleared to 0 after the START command is active and the STATUS has been up2025-06-18d.
...
typedef struct
{
     ...
     * |        |          |11 = Transfer Source address is wrap around (When the PDMA_CBCR is equal to zero, the PDMA_CSAR and PDMA_CBCR register will be up2025-06-18d by PDMA_SAR and PDMA_BCR automatically.
     ...
     * |        |          |11 = Transfer Destination address is wrapped around (When the PDMA_CBCR is equal to zero, the PDMA_CDAR and PDMA_CBCR register will be up2025-06-18d by PDMA_DAR and PDMA_BCR automatically.
     * |        |          |PDMA will start another transfer without software trigger until PDMA_EN disabled.
     * |        |          |When the PDMA_EN is disabled, the PDMA will complete the active transfer but the remained data which in the PDMA_BUF will not transfer to destination address).
...
typedef struct
{
    ...
    */
     ...
     * |        |          |When Disabled, Capture does not up2025-06-18 PWM_CRL0 and PWM_CFL0, and disable Channel 0 Interrupt.
     ...
     * |        |          |When Disabled, Capture does not up2025-06-18 PWM_CRL1 and PWM_CFL1, and disable Channel 1 Interrupt.
     ...
     * |        |          |When Disabled, Capture does not up2025-06-18 PWM_CRL2 and PWM_CFL2, and disable Channel 2 Interrupt.
     ...
     * |        |          |When Disabled, Capture does not up2025-06-18 PWM_CRL3 and PWM_CFL3, and disable Channel 3 Interrupt.
    ...
    */
     ...
     * |        |          |This flag indicate CRL0 up2025-06-18 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL0 up2025-06-18 faster than software read it when it is set
     ...
     * |        |          |This flag indicate CRL1 up2025-06-18 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL1 up2025-06-18 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CRL2 up2025-06-18 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL2 up2025-06-18 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CRL3up2025-06-18 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL3 up2025-06-18 faster than software reading it when it is set
...
typedef struct
{
    ...
    */
     ...
     * |        |          |After CPU writing registers SPR0 ~ SPR19, polling this bit to check if SP0 ~ SPR19 are up2025-06-18d done is necessary.
     * |        |          |This it is read only and any write to this bit won't take any effect.
     * |        |          |0 = SPR0 ~ SPR19 updating is in progress.
     * |        |          |1 = SPR0 ~ SPR19 are up2025-06-18d done and ready to read.
    */
...
typedef struct
{
    ...
    */
     ...
     * |        |          |Note: When the SPI controller is configured as a slave device and the FIFO mode is disabled, if the SPI controller attempts to transmit data to a master, the software must up2025-06-18 the transmit data register before setting the GO_BUSY bit to 1
    */
    __O  uint32_t TX0;
