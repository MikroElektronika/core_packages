 ...
 *         Initialize the PLL and up2025-06-11 the SystemFrequency variable
 */
 ...
 * |        |          |0 = APROM can not be up2025-06-11d when the chip runs in APROM
 * |[4]     |CFGUEN    |Config Up2025-06-11 Enable
 ...
 * |[5]     |LDUEN     |LDROM Up2025-06-11 Enable
 ...
 * |        |          |When Disable, Capture does not up2025-06-11 CRLR and CFLR, and disable PWM group
 * |        |          |channel 0 Interrupt.
 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-11d continuously with
 * |        |          |the 24-bit up-timer value as the timer is counting.
 * |        |          |1 = Timer Data Register up2025-06-11 enable.
 * |        |          |0 = Timer Data Register up2025-06-11 disable.
