 ...
 * |        |          |1 = boot from LDROM
 * |        |          |0 = boot from APROM
 * |[4]     |CFGUEN    |Config Up2025-07-01 Enable
 ...
 * |[5]     |LDUEN     |LDROM Up2025-07-01 Enable
 * |        |          |LDROM up2025-07-01 enable bit.
 * |        |          |1 = LDROM can be up2025-07-01d when the MCU runs in APROM.
 ...
 * |        |          |(Falling latch).
 * |        |          |When Disabled, Capture does not up2025-07-01 CRLR and CFLR, and disable PWM group channel 0 Interrupt.
 ...
 * |        |          |latch).
 * |        |          |When Disabled, Capture does not up2025-07-01 CRLR and CFLR, and disable PWM group channel 1 Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter value and saved to CRLR (Rising latch) and CFLR
 * |        |          |(Falling latch).
 * |        |          |When Disabled, Capture does not up2025-07-01 CRLR and CFLR, and disable PWM group channel 2 Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter and saved to CRLR (Rising latch) and CFLR (Falling
 * |        |          |latch).
 * |        |          |When Disabled, Capture does not up2025-07-01 CRLR and CFLR, and disable PWM group channel 3 Interrupt.
 ...
 * |        |          |busy time to up2025-07-01 these values completely because PWM clock may be different from system clock
 * |        |          |domain.
 * |        |          |Software needs to check this busy status before writing CNR0/CMR0/PPR or switching PWM0
 * |        |          |operation mode (PCR[3]) to make sure previous setting has been up2025-07-01d completely.
 * |        |          |This bit will be set when software writes CNR0/CMR0/PPR or switches PWM0 operation mode (PCR[3])
 * |        |          |and will be cleared by hardware automatically when PWM up2025-07-01 these value completely.
 * @var PWM_T::SYNCBUSY1
 ...
 * |        |          |operation mode (PCR[11]) to make sure previous setting has been up2025-07-01d completely.
 * |        |          |This bit will be set when software writes CNR1/CMR1/PPR or switches PWM1 operation mode
 * |        |          |(PCR[11]) and will be cleared by hardware automatically when PWM up2025-07-01 these value completely.
 * @var PWM_T::SYNCBUSY2
 ...
 * |        |          |time to up2025-07-01 these values completely because PWM clock may be different from system clock
 * |        |          |domain.
 * |        |          |Software needs to check this busy status before writing CNR2/CMR2/PPR or switching PWM2
 * |        |          |operation mode (PCR[19]) to make sure previous setting has been up2025-07-01d completely.
 ...
 * |        |          |mode (PCR[27]) to make sure previous setting has been up2025-07-01d completely.
 ...
 * |        |          |up2025-07-01d done is necessary.
 * |        |          |0 = SPRCTL, SPR0 ~ SPR19 updating is in progress.
 * |        |          |1 = SPRCTL, SPR0 ~ SPR19 are up2025-07-01d done and ready to be accessed.
 ...
 * |[7:6]   |TRIM_RETRY_CNT|Trim Value Up2025-07-01 Limitation Count
 * |        |          |The field defines that how many times of HIRC trim value is up2025-07-01d by auto trim circuit before
 * |        |          |the HIRC frequency locked.
 * |        |          |Once the HIRC locked, the internal trim value up2025-07-01 counter will be reset.
 * |        |          |If the trim value up2025-07-01 counter reached this limitation value and frequency of HIRC still
 ...
 * |        |          |This bit controls if an interrupt will be triggered while HIRC trim value up2025-07-01 limitation
 ...
 * |        |          |An interrupt will be triggered to notify that HIRC trim value up2025-07-01 limitation count was
 * |        |          |reached.
 ...
 * |        |          |This bit indicates that internal 22.1184 MHz high speed oscillator trim value up2025-07-01 limitation
 ...
 * |        |          |notify that HIRC trim value up2025-07-01 limitation count was reached.
 * |        |          |Write 1 to clear this to 0.
 * |        |          |0 = Trim value up2025-07-01 limitation count did not reach.
 * |        |          |1 = Trim value up2025-07-01 limitation count reached and internal 22.1184 MHz high speed oscillator
 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-07-01d continuously with the 24-bit
 ...
 * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-07-01d continuously to monitor 24-bit up
 * |        |          |counter value.
 * @var TIMER_T::TCAP
 ...
 * |        |          |0 = UA_BAUD up2025-07-01d is written by software (if no automatic resynchronization up2025-07-01 occurs at
 * |        |          |the same time).
 * |        |          |1 = UA_BAUD is up2025-07-01d at the next received character. User must set the bit before checksum
 * |        |          |reception.
 * |        |          |Note1: This bit only valid when in LIN slave mode (LINS_EN (UA_LIN_CTL[0]) = 1).
 ...
 * |        |          |    up2025-07-01d to USBD_EPSTS register, so that the USB interrupt event will not be asserted.
 * |        |          |1 = IN NAK status will be up2025-07-01d to USBD_EPSTS register and the USB interrupt event
