...
typedef struct
{
    ...
    */
     ...
     * |        |          |Note1: This bit is up2025-07-03d when software switches system clock source.
...
typedef struct
{
    ...
    */
     ...
     * |        |          |0 = Corresponding Px_DOUT[n] bit can be up2025-07-03d.
...
typedef struct
{
    ...
    */
     ...
     * |        |          |0 = Corresponding PWM-timer running Stopped.
     * |        |          |1 = Corresponding PWM-timer start run Enabled.
     * |[5]     |HCUPDT    |Half Cycle Up2025-07-03 Enable For center-Aligned Type
     * |        |          |0 = disable half cycle up2025-07-03 PERIOD & CMP.
     * |        |          |1 = enable half cycle up2025-07-03 PERIOD & CMP.
    ...
    */
     ...
     * |        |          |0 = Disabled.
     * |        |          |1 = Enabled.
     * |        |          |When this bit is set, timer1 time-out event will up2025-07-03 PWM_PHCHG with PWM_PHCHG_NXT register.
     ...
     * |        |          |0 = Disabled.
     * |        |          |1 = Enabled.
     * |        |          |When this bit is set, timer0 time-out event will up2025-07-03 PWM_PHCHG with PWM_PHCHG_NXT register.
...
typedef struct
{
    ...
    */
     ...
     * |        |          |This field also defines how many times the auto trim circuit will try to up2025-07-03 the HFIRC trim value before the frequency of HFIRC is locked.
     * |        |          |Once the HFIRC is locked, the internal trim value up2025-07-03 counter will be reset.
     * |        |          |If the trim value up2025-07-03 counter reaches this limitation value and frequency of HFIRC is still not locked, the auto trim operation will be disabled and FREQSEL will be cleared to 0.
    ...
    */
     ...
     * |        |          |This bit controls if an interrupt will be triggered while HFIRC trim value up2025-07-03 limitation count is reached and HFIRC frequency is still not locked on target frequency set by FREQSEL.
     * |        |          |If this bit is high and TFAILIF is set during auto trim operation, an interrupt will be triggered to notify that HFIRC trim value up2025-07-03 limitation count is reached.
    ...
    */
     ...
     * |        |          |This bit indicates that HFIRC trim value up2025-07-03 limitation count reached and HFIRC clock frequency still doesn't lock.
     * |        |          |Once this bit is set, the auto trim operation stopped and FREQSEL will be cleared to 0 by hardware automatically.
     * |        |          |If this bit is set and TFAILIEN is high, an interrupt will be triggered to notify that HFIRC trim value up2025-07-03 limitation count was reached.
     * |        |          |Software can write 1 to clear this bit to zero.
     * |        |          |0 = Trim value up2025-07-03 limitation count is not reached.
     * |        |          |1 = Trim value up2025-07-03 limitation count is reached and HFIRC frequency is still not locked.
