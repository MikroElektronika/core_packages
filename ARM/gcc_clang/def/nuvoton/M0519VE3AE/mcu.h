...
typedef struct
{
     ...
     * |        |          |When disabled, capture does not up2025-06-11 CRLR and CFLR, and disable BPWM group channel 0 interrupt.
     ...
     * |        |          |When disabled, capture does not up2025-06-11 CRLR and CFLR, and disable BPWM channel 1 interrupt.
...
typedef struct
{
     ...
     * |         |          |1 = Hardware will up2025-06-11 the value of PWM period register (PWMP) and PWM duty
...
typedef struct
{
     ...
     * |        |          |0 = boot from APROM
     * |        |          |1 = boot from LDROM
     * |[3]     |APUEN     |APROM Up2025-06-11 Enable(Write-Protected)
     * |        |          |0 = APROM cannot be up2025-06-11d when the chip runs in APROM
     * |        |          |1 = APROM can be up2025-06-11d when the chip runs in APROM
     * |[4]     |CFGUEN    |Config Up2025-06-11 Enable(Write-Protected)
     * |        |          |Writing this bit to 1 enables S/W to up2025-06-11 Config value by ISP procedure regardless of program
     * |        |          |code is running in APROM or LDROM.
     * |        |          |0 = Config up2025-06-11 disable
     * |        |          |1 = Config up2025-06-11 enable
     * |[5]     |LDUEN     |LDROM Up2025-06-11 Enable(Write-Protected)
     * |        |          |LDROM up2025-06-11 enable bit.
     * |        |          |0 = LDROM cannot be up2025-06-11d
     * |        |          |1 = LDROM can be up2025-06-11d when the MCU runs in APROM.
...
typedef struct
{
     ...
     * |        |          |0 = Corresponding Px_DOUT[n] bit can be up2025-06-11d.
...
typedef struct
{
     ...
     * |        |          |        controller attempts to transmit data to a master, the transmit data register should be up2025-06-11d
...
typedef struct
{
     ...
     * |        |          |When this bit is set, timer counter value (TDR) will be up2025-06-11d continuously to monitor internal 24-bit up counter value as the counter is counting.
     * |        |          |0 = Timer Data Register up2025-06-11 Disabled.
     * |        |          |1 = Timer Data Register up2025-06-11 Enabled while timer counter is active.
...
typedef struct
{
    ...
    * |[3]     |LINS_DUM_EN|LIN Slave Divider Up2025-06-11 Method Enable Control
    * |        |          |0 = UA_BAUD up2025-06-11d is written by software (if no automatic resynchronization up2025-06-11 occurs at the same time).
    * |        |          |1 = UA_BAUD is up2025-06-11d at the next received character. User must set the bit before checksum reception.
    * |        |          |Note1: This bit only valid when in LIN slave mode (LINS_EN (UA_LIN_CTL[0]) = 1).
...
typedef struct
{
     ...
     * |        |          |WWDTCVAL will be up2025-06-11d continuously to monitor 6-bit down counter value.
     */
