 ...
 * |        |          |1 = boot from LDROM
 * |        |          |0 = boot from APROM
 * |[4]     |CFGUEN    |Config Up2025-06-12 Enable
 * |        |          |Writing this bit to 1 enables s/w to up2025-06-12 Config value by ISP procedure regardless of program
 * |        |          |code is running in APROM or LDROM.
 * |        |          |1 = Config up2025-06-12 enable
 * |        |          |0 = Config up2025-06-12 disable
 * |[5]     |LDUEN     |LDROM Up2025-06-12 Enable
 * |        |          |LDROM up2025-06-12 enable bit.
 * |        |          |1 = LDROM can be up2025-06-12d when the MCU runs in APROM.
 ...
 * |        |          |0 = Corresponding DOUT (GPIOx_DOUT[n]) bit can be up2025-06-12d.
 ...
 * |        |          |When Disabled, Capture does not up2025-06-12 CRLR and CFLR, and disable PWM group channel 0 Interrupt.
 ...
 * |        |          |When Disabled, Capture does not up2025-06-12 CRLR and CFLR, and disable PWM group channel 1 Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter value and saved to CRLR (Rising latch) and CFLR (Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-12 CRLR and CFLR, and disable PWM group channel 2 Interrupt.
 ...
 * |        |          |When Enabled, Capture latched the PWM-counter and saved to CRLR (Rising latch) and CFLR (Falling latch).
 * |        |          |When Disabled, Capture does not up2025-06-12 CRLR and CFLR, and disable PWM group channel 3 Interrupt.
 ...
 * |        |          |PWM will have a busy time to up2025-06-12 these values completely because
 ...
 * |        |          |switching PWM0 operation mode (PCR[3]) to make sure previous setting has been up2025-06-12d completely.
 * |        |          |This bit will be set when software writes CNR0/CMR0/PPR or switches PWM0 operation mode (PCR[3])
 * |        |          |and will be cleared by hardware automatically when PWM up2025-06-12 these value completely.
 * @var PWM_T::SYNCBUSY1
 ...
 * |        |          |switching PWM1 operation mode (PCR[11]) to make sure previous setting has been up2025-06-12d completely.
 ...
 * |        |          |switching PWM2 operation mode (PCR[19]) to make sure previous setting has been up2025-06-12d completely.
 ...
 * |        |          |switching PWM3 operation mode (PCR[27]) to make sure previous setting has been up2025-06-12d completely.
 ...
 * |        |          |        controller attempts to transmit data to a master, the transmit data register should be up2025-06-12d
 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-12d continuously with the 24-bit up-timer value as the timer is counting.
 * |        |          |0 = Timer Data Register up2025-06-12 Disabled.
 * |        |          |1 = Timer Data Register up2025-06-12 Enabled while Timer counter is active.
 ...
 * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-06-12d continuously to monitor 24-bit up counter value.
 * @var TIMER_T::TCAP
 ...
 * |        |          |    up2025-06-12d to USBD_EPSTS register, so that the USB interrupt event will not be asserted.
 * |        |          |1 = IN NAK status will be up2025-06-12d to USBD_EPSTS register and the USB interrupt event
 ...
 * |        |          |WWDTCVAL will be up2025-06-12d continuously to monitor 6-bit down counter value.
 */
