...
typedef struct
{
     ...
     * |        |          |1 = Boot from LDROM
     * |        |          |0 = Boot from APROM
     * |[4]     |CFGUEN    |Enable Config-bits Up2025-06-13 by ISP
     * |        |          |1 = Enable ISP can up2025-06-13 config-bits
     * |        |          |0 = Disable ISP can up2025-06-13 config-bits.
...
typedef struct
{
     ...
     * |        |          |This field also defines how many times the auto trim circuit will try to up2025-06-13 the
     * |        |          |HIRC trim value before the frequency of HIRC is locked.
     * |        |          |Once the HIRC is locked, the internal trim value up2025-06-13 counter will be reset
     * |        |          |If the trim value up2025-06-13 counter reaches this limitation value and frequency of HIRC
     ...
     * |        |              |This bit controls if an interrupt will be triggered while HIRC trim value up2025-06-13 limitation
     ...
     * |        |              |triggered to notify that HFIRC trim value up2025-06-13 limitation count is reached.
     ...
     * |        |              |This bit indicates that HIRC trim value up2025-06-13 limitation count reached and HIRC
     ...
     * |        |              |that HIRC trim value up2025-06-13 limitation count was reached. Write "1" to clear this to zero.
     * |        |              |0 = Trim value up2025-06-13 limitation count is not reached.
     * |        |              |1 = Trim value up2025-06-13 limitation count is reached and HFIRC frequency is still not locked.
