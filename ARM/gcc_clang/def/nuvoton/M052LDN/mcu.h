 ...
 *         Initialize the PLL and up2025-07-07 the SystemFrequency variable
 */
 ...
 * |        |           |Note1:
 * |        |           |This bit is up2025-07-07d when software switches system clock source.
 ...
 * |        |          |1 = boot from LDROM
 * |        |          |0 = boot from APROM
 * |[3]     |APUEN     |APROM Up2025-07-07 Enable (write-protected)
 * |        |          |1 = APROM can be up2025-07-07d when the chip runs in APROM
 * |        |          |0 = APROM can not be up2025-07-07d when the chip runs in APROM
 * |[4]     |CFGUEN    |Config Up2025-07-07 Enable
 * |        |          |Writing this bit to 1 enables s/w to up2025-07-07 Config value by ISP procedure regardless of program
 * |        |          |code is running in APROM or LDROM.
 * |        |          |1 = Config up2025-07-07 enable
 * |        |          |0 = Config up2025-07-07 disable
 * |[5]     |LDUEN     |LDROM Up2025-07-07 Enable
 * |        |          |LDROM up2025-07-07 enable bit.
 * |        |          |1 = LDROM can be up2025-07-07d when the MCU runs in APROM.
 * |        |          |0 = LDROM cannot be up2025-07-07d
 ...
 * |        |          |0 = Corresponding Px_DOUT[n] bit can be up2025-07-07d.
 ...
 * |        |          |When Disable, Capture does not up2025-07-07 CRLR and CFLR, and disable PWM group
 * |        |          |channel 0 Interrupt.
 ...
 * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-07-07d continuously with
 * |        |          |the 24-bit up-timer value as the timer is counting.
 * |        |          |1 = Timer Data Register up2025-07-07 enable.
 * |        |          |0 = Timer Data Register up2025-07-07 disable.
