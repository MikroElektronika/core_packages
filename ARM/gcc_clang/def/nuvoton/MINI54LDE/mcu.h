...
typedef struct
{
     ...
     * |        |          |Note1: This bit is up2025-07-01d when software switches system clock source.
...
typedef struct
{
     ...
     * |        |          |0 = Boot from APROM.
     * |        |          |1 = Boot from LDROM.
     * |[3]     |APUEN     |APROM Up2025-07-01 Enable Control (Write Protect)
     * |        |          |0 = APROM cannot be up2025-07-01d when chip runs in APROM.
     * |        |          |1 = APROM can be up2025-07-01d when chip runs in APROM.
     * |[4]     |CFGUEN    |CONFIG Up2025-07-01 Enable Control (Write Protect)
     * |        |          |Writing this bit to 1 enables software to up2025-07-01 CONFIG value by ISP register control procedure regardless of program code is running in APROM or LDROM.
     * |        |          |0 = ISP up2025-07-01 User Configuration Disabled.
     * |        |          |1 = ISP up2025-07-01 User Configuration Enabled.
     * |[5]     |LDUEN     |LDROM Up2025-07-01 Enable Control (Write Protect)
...
typedef struct
{
     ...
     * |        |          |This bit controls if an interrupt will be triggered while HIRC trim value up2025-07-01 limitation count is reached and HIRC frequency is still not locked on target frequency set by TRIM_SEL.
     * |        |          |If this bit is high and TRIM_FAIL_INT is set during auto trim operation, an interrupt will be triggered to notify that HIRC trim value up2025-07-01 limitation count is reached.
     ...
     * |        |          |This bit indicates that HIRC trim value up2025-07-01 limitation count reached and HIRC clock frequency still doesn't lock.
     * |        |          |Once this bit is set, the auto trim operation stopped and TRIM_SEL will be cleared to 0 by hardware automatically.
     * |        |          |If this bit is set and TRIM_FAIL_IEN is high, an interrupt will be triggered to notify that HIRC trim value up2025-07-01 limitation count was reached.
     * |        |          |Software can write 1 to clear this bit to 0.
     * |        |          |0 = Trim value up2025-07-01 limitation count is not reached.
     * |        |          |1 = Trim value up2025-07-01 limitation count is reached and HIRC frequency is still not locked.
...
typedef struct
{
     ...
     * |        |          |0 = Corresponding Px_DOUT[n] bit can be up2025-07-01d.
...
typedef struct
{
     ...
     * |        |          |0 = Disabled.
     * |        |          |1 = Enabled.
     * |        |          |When this bit is set, timer1 time-out event will up2025-07-01 PHCHG with PHCHG_NXT register.
     ...
     * |        |          |0 = Disabled.
     * |        |          |1 = Enabled.
     * |        |          |When this bit is set, timer0 time-out event will up2025-07-01 PHCHG with PHCHG_NXT register.
...
typedef struct
{
     ...
     * |        |          |If TDR_EN (TCSRx[16]) is set to 1, TDR register value will be up2025-07-01d continuously to monitor 24-bit up counter value.
     * @var TIMER_T::TCAP
