...
typedef struct
{
     ...
     * |        |          |Writing this bit to 1 enables s/w to up2025-06-26 Config value by ISP procedure regardless of program
...
typedef struct
{
     ...
     * |        |          |When Disabled, Capture does not up2025-06-26 CRLR and CFLR, and disable PWM group channel 0 Interrupt.
     ...
     * |        |          |When Disabled, Capture does not up2025-06-26 CRLR and CFLR, and disable PWM group channel 1 Interrupt.
     ...
     * |        |          |When Enabled, Capture latched the PWM-counter value and saved to CRLR (Rising latch) and CFLR (Falling latch).
     * |        |          |When Disabled, Capture does not up2025-06-26 CRLR and CFLR, and disable PWM group channel 2 Interrupt.
     ...
     * |        |          |When Enabled, Capture latched the PWM-counter and saved to CRLR (Rising latch) and CFLR (Falling latch).
     * |        |          |When Disabled, Capture does not up2025-06-26 CRLR and CFLR, and disable PWM group channel 3 Interrupt.
...
typedef struct
{
     ...
     * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-06-26d continuously with the 24-bit up-timer value as the timer is counting.
     ...
     * |        |          |If TDR_EN (TCSR[16]) is set to 1, TDR register will be up2025-06-26d continuously to monitor 24-bit up counter value.
     */
    __I  uint32_t  TDR;
} TIMER_T;
