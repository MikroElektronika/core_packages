...
typedef struct
{
     ...
     * |        |          |11 = Transfer Source address is wrap around (When the PDMA_CBCR is equal to zero, the PDMA_CSAR and PDMA_CBCR register will be up2025-06-25d by PDMA_SAR and PDMA_BCR automatically.
     ...
     * |        |          |11 = Transfer Destination address is wrapped around (When the PDMA_CBCR is equal to zero, the PDMA_CDAR and PDMA_CBCR register will be up2025-06-25d by PDMA_DAR and PDMA_BCR automatically.
     * |        |          |PDMA will start another transfer without software trigger until PDMA_EN disabled.
     * |        |          |When the PDMA_EN is disabled, the PDMA will complete the active transfer but the remained data which in the PDMA_BUF will not transfer to destination address).
...
typedef struct
{
     ...
     * |        |          |0 = Boot from APROM.
     * |        |          |1 = Boot from LDROM.
     * |[3]     |APUEN     |APROM Up2025-06-25 Enable Control (Write Protect)
     * |        |          |0 = APROM cannot be up2025-06-25d.
     * |        |          |1 = APROM can be up2025-06-25d.
     * |[4]     |CFGUEN    |Enable Config-Bits Up2025-06-25 By ISP (Write Protect)
     * |        |          |0 = ISP up2025-06-25 User Configuration Disabled.
     * |        |          |1 = ISP up2025-06-25 User Configuration Enabled.
     * |[5]     |LDUEN     |LDROM Up2025-06-25 Enable Control (Write Protect)
     * |        |          |0 = LDROM cannot be up2025-06-25d.
     * |        |          |1 = LDROM can be up2025-06-25d.
...
typedef struct
{
    ...
    */
     ...
     * |[7:6]   |TRIM_RETRY_CNT|Trim Value Up2025-06-25 Limitation Count
     * |        |          |This field defines that how many times the auto trim circuit will try to up2025-06-25 the HIRC trim value before the frequency of HIRC locked.
     * |        |          |Once the HIRC locked, the internal trim value up2025-06-25 counter will be reset.
     * |        |          |If the trim value up2025-06-25 counter reached this limitation value and frequency of HIRC still doesn't lock, the auto trim operation will be disabled and TRIM_SEL will be cleared to 00.
    ...
    */
     ...
     * |        |          |This bit controls if an interrupt will be triggered while HIRC trim value up2025-06-25 limitation count reached and HIRC frequency still not locked on target frequency set by TRIM_SEL.
     * |        |          |If this bit is high and TRIM_FAIL_INT is set during auto trim operation, an interrupt will be triggered to notify that HIRC trim value up2025-06-25 limitation count was reached.
    ...
    */
     ...
     * |        |          |This bit indicates that HIRC trim value up2025-06-25 limitation count reached and HIRC clock frequency still doesn't lock.
     * |        |          |Once this bit is set, the auto trim operation stopped and TRIM_SEL will be cleared to 00 by hardware automatically.
     * |        |          |If this bit is set and TRIM_FAIL_IEN is high, an interrupt will be triggered to notify that HIRC trim value up2025-06-25 limitation count was reached.
     * |        |          |Write 1 to clear this to zero.
     * |        |          |0 = Trim value up2025-06-25 limitation count doesn't reach.
     * |        |          |1 = Trim value up2025-06-25 limitation count reached and HIRC frequency still doesn't lock.
...
typedef struct
{
    ...
    */
     ...
     * |        |          |0 = The corresponding GPIO_DOUT bit [n] can be up2025-06-25d.
...
typedef struct
{
     ...
     * |        |          |Setting this bit to 1 to enter Master mode, the device sends a START or repeat START condition to bus when the bus is free and it will be cleared to 0 after the START command is active and the STATUS has been up2025-06-25d.
...
typedef struct
{
    ...
    */
     ...
     * |        |          |When Disabled, Capture does not up2025-06-25 CRL0 (PWM_CRL0[15:0]) and CFL0 (PWM_CFL0[15:0]), and disable Channel 0 Interrupt.
     ...
     * |        |          |When Disabled, Capture does not up2025-06-25 CRL1 (PWM_CRL1[15:0]) and CFL1 (PWM_CFL1[15:0]), and disable Channel 1 Interrupt.
     ...
     * |        |          |When Disabled, Capture does not up2025-06-25 CRL2 (PWM_CRL2[15:0]) and CFL2 (PWM_CFL2[15:0]), and disable Channel 2 Interrupt.
     ...
     * |        |          |When Disabled, Capture does not up2025-06-25 CRL3 (PWM_CRL3[15:0]) and CFL3 (PWM_CFL3[15:0]), and disable Channel 3 Interrupt.
    ...
    */
     ...
     * |        |          |This flag indicate CRL0 up2025-06-25 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL0 up2025-06-25 faster than software read it when it is set
     ...
     * |        |          |This flag indicate CRL1 up2025-06-25 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL1 up2025-06-25 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CRL2 up2025-06-25 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL2 up2025-06-25 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CRL3up2025-06-25 faster than software reading it when it is set
     ...
     * |        |          |This flag indicate CFL3 up2025-06-25 faster than software reading it when it is set
...
typedef struct
{
    ...
    */
     ...
     * |        |          |Note2: When the SPI controller is configured as a slave device and the FIFO mode is disabled, if the SPI controller attempts to transmit data to a master, the software must up2025-06-25 the transmit data register before setting the GO_BUSY bit to 1.
    */
    __O  uint32_t TX0;
...
typedef struct
{
    ...
    */
     ...
     * |        |          |Timer only up2025-06-25s this flag when it up2025-06-25s the Timer Capture Data (TMR_TCAP[23:0]) value.
