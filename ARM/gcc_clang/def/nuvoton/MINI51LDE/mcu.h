...
typedef struct
{
     ...
     * |        |          |This bit controls if an interrupt will be triggered while HIRC trim value up2025-07-03 limitation count is reached and HIRC frequency is still not locked on target frequency set by TRIM_SEL.
     * |        |          |If this bit is high and TRIM_FAIL_INT is set during auto trim operation, an interrupt will be triggered to notify that HIRC trim value up2025-07-03 limitation count is reached.
     ...
     * |        |          |This bit indicates that HIRC trim value up2025-07-03 limitation count reached and HIRC clock frequency still doesn't lock.
     * |        |          |Once this bit is set, the auto trim operation stopped and TRIM_SEL will be cleared to 0 by hardware automatically.
     * |        |          |If this bit is set and TRIM_FAIL_IEN is high, an interrupt will be triggered to notify that HIRC trim value up2025-07-03 limitation count was reached.
     * |        |          |Software can write 1 to clear this bit to 0.
     * |        |          |0 = Trim value up2025-07-03 limitation count is not reached.
     * |        |          |1 = Trim value up2025-07-03 limitation count is reached and HIRC frequency is still not locked.
...
typedef struct
{
     ...
     * |        |          |0 = Disabled.
     * |        |          |1 = Enabled.
     * |        |          |When this bit is set, timer1 time-out event will up2025-07-03 PHCHG with PHCHG_NXT register.
     ...
     * |        |          |0 = Disabled.
     * |        |          |1 = Enabled.
     * |        |          |When this bit is set, timer0 time-out event will up2025-07-03 PHCHG with PHCHG_NXT register.
...
typedef struct
{
     ...
     * |        |          |When TDR_EN is set, TDR (Timer Data Register) will be up2025-07-03d continuously with the 24-bit up-timer value as the timer is counting.
     ...
     * |        |          |If TDR_EN (TCSRx[16]) is set to 1, TDR register value will be up2025-07-03d continuously to monitor 24-bit up counter value.
     * @var TIMER_T::TCAP
