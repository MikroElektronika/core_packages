 ...
 * $Revision: 62 $
 * $Date: 15/05/22 9:06a $
 * @brief    NUC1311 Series Peripheral Access Layer Header File
 *
 * @note
 *
...
/**
  ...
  *
  *
  * This user manual describes the usage of NUC1311 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
//#include "system_NUC1311.h"               /* NUC1311 System                                           */
...
typedef struct
{
     ...
     * |        |          |NuMicro NUC1311 series has a maximum of 17Kx32(68KB) embedded Flash, which supports word program only.
...
/** @addtogroup GPIO General purpose I/O (GPIO)
  Memory Mapped Structure for NUC1311 Series General Purpose I/O
  @{
 */
typedef struct
{
