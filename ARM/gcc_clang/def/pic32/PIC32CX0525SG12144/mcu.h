/*
 * Header file for PIC32CX0525SG12144
 *
...
/* PIC32CX0525SG12144 definitions
...
/******  PIC32CX0525SG12144 specific Interrupt Numbers ***********************************/
  ...
  GIRQ17_IRQn               =   9, /* 9   The PECI Interface allows the EC to retrieve temperature readings from PECI-compliant devices. (PECI) */
  ...
  GIRQ19_IRQn               =  11, /* 11  The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  ...
  GIRQ24_IRQn               =  15, /* 15  The ESPI VW Channel permits the System to emulate a set of wires that interconnect the system Core Logic with the EC (ESPI_MSVW00_06) */
  GIRQ25_IRQn               =  16, /* 16  The ESPI VW Channel permits the System to emulate a set of wires that interconnect the system Core Logic with the EC (ESPI_MSVW07_10) */
  ...
  KBC_OBE_IRQn              =  58, /* 58  The Keyboard Controller is a Host/EC Message Interface with hardware assists to emulate 8042 behavior (KBC) */
  KBC_IBF_IRQn              =  59, /* 59  The Keyboard Controller is a Host/EC Message Interface with hardware assists to emulate 8042 behavior (KBC) */
  ...
  LED2_IRQn                 =  85, /* 85  The LED is implemented using a PWM that can be driven either by the 48 MHz clock or by a 32.768 KHz clock input. (LED2) */
  PHOT_IRQn                 =  87, /* 87  This block monitors the PROCHOT# signal generated by the host processor. It is designed to detect single assertions and monitor cumulative PROCHOT active time. (PHOT) */
  ...
  PS2_1_ACT_IRQn            = 101, /* 101 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic (PS2_1) */
  INTR_PC_IRQn              = 103, /* 103 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  INTR_BM1_IRQn             = 104, /* 104 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  INTR_BM2_IRQn             = 105, /* 105 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  INTR_LTR_IRQn             = 106, /* 106 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  INTR_OOB_UP_IRQn          = 107, /* 107 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  INTR_OOB_DOWN_IRQn        = 108, /* 108 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  INTR_FLASH_IRQn           = 109, /* 109 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  ESPI_RESET_IRQn           = 110, /* 110 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  ...
  PS2_0B_WAKE_IRQn          = 130, /* 130 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic (PS2_0) */
  PS2_1B_WAKE_IRQn          = 132, /* 132 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic (PS2_1) */
  KEYSCAN_IRQn              = 135, /* 135 The Keyboard Scan Interface block provides a register interface to directly scan an external keyboard matrix of size up to 18x8. (KMS) */
  ...
  ESPI_VWIRE_IRQn           = 156, /* 156 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  I2CSMB4_IRQn              = 158, /* 158 The SMBus interface can handle standard SMBus 2.0 protocols as well as I2C interface. (SMB4) */
  TACH3_IRQn                = 159, /* 159 This block monitors TACH output signals from various types of fans, and determines their speed. (TACH3) */
  ...
  SAF_DONE_IRQn             = 166, /* 166 SAF BRIDGE COMPONENT (SAFBC)        */
  SAF_ERR_IRQn              = 167, /* 167 SAF BRIDGE COMPONENT (SAFBC)        */
...
typedef struct _DeviceVectors
{
  ...
  void* pfnGIRQ17_Handler;                       /*   9 The PECI Interface allows the EC to retrieve temperature readings from PECI-compliant devices. (PECI) */
  ...
  void* pfnGIRQ19_Handler;                       /*  11 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  ...
  void* pfnGIRQ24_Handler;                       /*  15 The ESPI VW Channel permits the System to emulate a set of wires that interconnect the system Core Logic with the EC (ESPI_MSVW00_06) */
  void* pfnGIRQ25_Handler;                       /*  16 The ESPI VW Channel permits the System to emulate a set of wires that interconnect the system Core Logic with the EC (ESPI_MSVW07_10) */
  ...
  void* pfnKBC_OBE_Handler;                      /*  58 The Keyboard Controller is a Host/EC Message Interface with hardware assists to emulate 8042 behavior (KBC) */
  void* pfnKBC_IBF_Handler;                      /*  59 The Keyboard Controller is a Host/EC Message Interface with hardware assists to emulate 8042 behavior (KBC) */
  ...
  void* pfnLED2_Handler;                         /*  85 The LED is implemented using a PWM that can be driven either by the 48 MHz clock or by a 32.768 KHz clock input. (LED2) */
  void* pvReserved86;
  void* pfnPHOT_Handler;                         /*  87 This block monitors the PROCHOT# signal generated by the host processor. It is designed to detect single assertions and monitor cumulative PROCHOT active time. (PHOT) */
  void* pvReserved88;
  void* pvReserved89;
  ...
  void* pfnPS2_1_ACT_Handler;                    /* 101 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic (PS2_1) */
  void* pvReserved102;
  void* pfnINTR_PC_Handler;                      /* 103 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pfnINTR_BM1_Handler;                     /* 104 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pfnINTR_BM2_Handler;                     /* 105 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pfnINTR_LTR_Handler;                     /* 106 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pfnINTR_OOB_UP_Handler;                  /* 107 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pfnINTR_OOB_DOWN_Handler;                /* 108 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pfnINTR_FLASH_Handler;                   /* 109 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pfnESPI_RESET_Handler;                   /* 110 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  ...
  void* pfnPS2_0B_WAKE_Handler;                  /* 130 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic (PS2_0) */
  void* pvReserved131;
  void* pfnPS2_1B_WAKE_Handler;                  /* 132 The four PS/2 Ports implementation eliminates the need to bit bang I/O ports to generate PS/2 traffic (PS2_1) */
  void* pvReserved133;
  void* pvReserved134;
  void* pfnKEYSCAN_Handler;                      /* 135 The Keyboard Scan Interface block provides a register interface to directly scan an external keyboard matrix of size up to 18x8. (KMS) */
  ...
  void* pvReserved155;
  void* pfnESPI_VWIRE_Handler;                   /* 156 The ESPI is used by the system host to configure the chip and communicate with the logical devices implemented in the design (ESPI_IO) */
  void* pvReserved157;
  void* pfnI2CSMB4_Handler;                      /* 158 The SMBus interface can handle standard SMBus 2.0 protocols as well as I2C interface. (SMB4) */
  void* pfnTACH3_Handler;                        /* 159 This block monitors TACH output signals from various types of fans, and determines their speed. (TACH3) */
  ...
  void* pvReserved165;
  void* pfnSAF_DONE_Handler;                     /* 166 SAF BRIDGE COMPONENT (SAFBC) */
  void* pfnSAF_ERR_Handler;                      /* 167 SAF BRIDGE COMPONENT (SAFBC) */
...
void KBC_OBE_Handler               ( void );
void KBC_IBF_Handler               ( void );
...
void PS2_0B_WAKE_Handler           ( void );
void PS2_1B_WAKE_Handler           ( void );
...
void SAF_DONE_Handler              ( void );
void SAF_ERR_Handler               ( void );
...
/* ************************************************************************** */
/*   INSTANCE DEFINITIONS FOR PIC32CX0525SG12144 */
/* ************************************************************************** */
...
#include "instance/espi_io.h"
#include "instance/espi_memory.h"
#include "instance/espi_msvw00_06.h"
#include "instance/espi_msvw07_10.h"
#include "instance/espi_scratch.h"
#include "instance/espi_smvw00_10.h"
...
#include "instance/pwm8.h"
#include "instance/qmspi.h"
#include "instance/rtc.h"
#include "instance/rtos.h"
#include "instance/safbc.h"
#include "instance/safcomm.h"
#include "instance/sgpio0.h"
#include "instance/sgpio1.h"
#include "instance/sgpio2.h"
#include "instance/sgpio3.h"
...
#define ESPI_IO_REGS                     ((espi_io_registers_t*)0x400f3400)            /* ESPI_IO Registers Address    */
#define ESPI_MEMORY_REGS                 ((espi_memory_registers_t*)0x400f3800)        /* ESPI_MEMORY Registers Address */
#define ESPI_MSVW00_06_REGS              ((espi_msvw00_06_registers_t*)0x400f9c00)     /* ESPI_MSVW00_06 Registers Address */
#define ESPI_MSVW07_10_REGS              ((espi_msvw07_1_registers_t*)0x400f9c54)      /* ESPI_MSVW07_10 Registers Address */
#define ESPI_SMVW00_10_REGS              ((espi_smvw00_1_registers_t*)0x400f9e00)      /* ESPI_SMVW00_10 Registers Address */
#define GCR_REGS                         ((gcr_registers_t*)0x400fff00)                /* GCR Registers Address        */
#define KBC_REGS                         ((kbc_registers_t*)0x400f0400)                /* KBC Registers Address        */
...
#define TACH3_REGS                       ((tach_registers_t*)0x40006030)               /* TACH3 Registers Address      */
...
#define PWM8_REGS                        ((pwm_registers_t*)0x40005880)                /* PWM8 Registers Address       */
#define PECI_REGS                        ((peci_registers_t*)0x40006400)               /* PECI Registers Address       */
#define ADC_REGS                         ((adc_registers_t*)0x40007c00)                /* ADC Registers Address        */
#define PHOT_REGS                        ((phot_registers_t*)0x40003400)               /* PHOT Registers Address       */
...
#define LED2_REGS                        ((led_registers_t*)0x4000ba00)                /* LED2 Registers Address       */
...
#define PS2_1_REGS                       ((ps2_registers_t*)0x40009040)                /* PS2_1 Registers Address      */
...
#define ESPI_SCRATCH_REGS                ((espi_scratch_registers_t*)0x400fbc00)       /* ESPI_SCRATCH Registers Address */
#define HDMI_CEC_REGS                    ((hdmi_cec_registers_t*)0x40006800)           /* HDMI_CEC Registers Address   */
#define SAFBC_REGS                       ((safbc_registers_t*)0x40008000)              /* SAFBC Registers Address      */
#define SAFCOMM_REGS                     ((safcomm_registers_t*)0x40071000)            /* SAFCOMM Registers Address    */
...
#define SGPIO2_REGS                      ((sgpio_registers_t*)0x4000a200)              /* SGPIO2 Registers Address     */
#define SGPIO3_REGS                      ((sgpio_registers_t*)0x4000a300)              /* SGPIO3 Registers Address     */
...
#define ESPI_IO_BASE_ADDRESS             _UINT32_(0x400f3400)                          /* ESPI_IO Base Address */
#define ESPI_MEMORY_BASE_ADDRESS         _UINT32_(0x400f3800)                          /* ESPI_MEMORY Base Address */
#define ESPI_MSVW00_06_BASE_ADDRESS      _UINT32_(0x400f9c00)                          /* ESPI_MSVW00_06 Base Address */
#define ESPI_MSVW07_10_BASE_ADDRESS      _UINT32_(0x400f9c54)                          /* ESPI_MSVW07_10 Base Address */
#define ESPI_SMVW00_10_BASE_ADDRESS      _UINT32_(0x400f9e00)                          /* ESPI_SMVW00_10 Base Address */
#define GCR_BASE_ADDRESS                 _UINT32_(0x400fff00)                          /* GCR Base Address */
#define KBC_BASE_ADDRESS                 _UINT32_(0x400f0400)                          /* KBC Base Address */
...
#define TACH3_BASE_ADDRESS               _UINT32_(0x40006030)                          /* TACH3 Base Address */
...
#define PWM8_BASE_ADDRESS                _UINT32_(0x40005880)                          /* PWM8 Base Address */
#define PECI_BASE_ADDRESS                _UINT32_(0x40006400)                          /* PECI Base Address */
#define ADC_BASE_ADDRESS                 _UINT32_(0x40007c00)                          /* ADC Base Address */
#define PHOT_BASE_ADDRESS                _UINT32_(0x40003400)                          /* PHOT Base Address */
...
#define LED2_BASE_ADDRESS                _UINT32_(0x4000ba00)                          /* LED2 Base Address */
...
#define PS2_1_BASE_ADDRESS               _UINT32_(0x40009040)                          /* PS2_1 Base Address */
...
#define ESPI_SCRATCH_BASE_ADDRESS        _UINT32_(0x400fbc00)                          /* ESPI_SCRATCH Base Address */
#define HDMI_CEC_BASE_ADDRESS            _UINT32_(0x40006800)                          /* HDMI_CEC Base Address */
#define SAFBC_BASE_ADDRESS               _UINT32_(0x40008000)                          /* SAFBC Base Address */
#define SAFCOMM_BASE_ADDRESS             _UINT32_(0x40071000)                          /* SAFCOMM Base Address */
...
#define SGPIO2_BASE_ADDRESS              _UINT32_(0x4000a200)                          /* SGPIO2 Base Address */
#define SGPIO3_BASE_ADDRESS              _UINT32_(0x4000a300)                          /* SGPIO3 Base Address */
...
/* ************************************************************************** */
/*   PIO DEFINITIONS FOR PIC32CX0525SG12144                                   */
/* ************************************************************************** */
// Note: Changed for MikroE implementation.
//#include "pio/pic32cx0525sg12144.h"
