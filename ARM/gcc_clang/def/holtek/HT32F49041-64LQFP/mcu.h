...
#ifndef __HT32F490x1_H
#define __HT32F490x1_H
...
/**
  ...
  */
...
#if !defined (USE_HT32F49041_64LQFP) && !defined (USE_HT32F49041_48LQFP) && !defined (USE_HT32F49041_48QFN)   && \
    !defined (USE_HT32F49041_32LQFP) && !defined (USE_HT32F49041_32QFN)  && !defined (USE_HT32F49041_20TSSOP) && \
    !defined (USE_HT32F49031_64LQFP) && !defined (USE_HT32F49031_48LQFP) && !defined (USE_HT32F49031_48QFN)   && \
    !defined (USE_HT32F49031_32LQFP) && !defined (USE_HT32F49031_32QFN)  && !defined (USE_HT32F49031_20TSSOP)

    #error "Please select first the target device used in your application (in ht32f490x1.h file)"
#endif
    ...
    #define USE_HT32F490x1
    #define LIBCFG_MAX_SPEED                (96000000)
    #define LIBCFG_FLASH_PAGESIZE           (1024)
    #define LIBCFG_RAM_SIZE                 (1024 * 20)
#endif

/**
  * define with package
  */
#if defined (USE_HT32F49041_64LQFP) || defined (USE_HT32F49031_64LQFP)

    #define USE_HT32F490x1_64
#endif

#if defined (USE_HT32F49041_48LQFP) || defined (USE_HT32F49041_48QFN) || defined (USE_HT32F49031_48LQFP) || \
    defined (USE_HT32F49031_48QFN)

    #define USE_HT32F490x1_48
#endif

#if defined (USE_HT32F49041_32LQFP) || defined (USE_HT32F49041_32QFN) || defined (USE_HT32F49031_32LQFP) || \
    defined (USE_HT32F49031_32QFN)

    #define USE_HT32F490x1_32
#endif

#if defined (USE_HT32F49041_20TSSOP) || defined (USE_HT32F49031_20TSSOP)

    #define USE_HT32F490x1_20
#endif

/**
  * define with memory density
  */
#if defined (USE_HT32F49031_64LQFP) || defined (USE_HT32F49031_48LQFP) || defined (USE_HT32F49031_48QFN)  ||\
    defined (USE_HT32F49031_32LQFP) || defined (USE_HT32F49031_32QFN)  || defined (USE_HT32F49031_20TSSOP)

    #define LIBCFG_FLASH_SIZE               (LIBCFG_FLASH_PAGESIZE * 32)
    #define USE_HT32F49031
#endif
...
/**
  ...
  */
  #ifdef _RTE_
//    #include "RTE_Components.h"// Note: Changed for MikroE implementation.
...
/**
  * @brief ht32f490x1 standard peripheral library version number
  */
#define HT32_FWLIB_VER                  (0x0100102b)
#define HT32_FWLIB_SVN                  (0x78)
...
/**
  * @brief ht32f490x1 interrupt number definition, according to the selected device
...
#include <stdint.h>
//#include <stdint.h>// Note: Changed for MikroE implementation.
...
//#include "ht32f490x1_def.h"// Note: Changed for MikroE implementation.
//#include "ht32f490x1_conf.h"// Note: Changed for MikroE implementation.
