...
#ifndef __HT32F491x3_H
#define __HT32F491x3_H
...
/**
  ...
  */
...
#if !defined (USE_HT32F49153_32QFN) && !defined (USE_HT32F49163_32QFN)  &&  !defined (USE_HT32F49153_36QFN)  && \
    !defined (USE_HT32F49163_36QFN) && !defined (USE_HT32F49153_48QFN)  &&  !defined (USE_HT32F49163_48QFN)  && \
    !defined (USE_HT32F49153_48LQFP)&& !defined (USE_HT32F49163_48LQFP) &&  !defined (USE_HT32F49153_64LQFP) && \
    !defined (USE_HT32F49163_64LQFP)&& !defined (USE_HT32F49153_100LQFP)&&  !defined (USE_HT32F49163_100LQFP)

    #error "Please select first the target device used in your application (in ht32f491x3.h file)"
#endif
    ...
    #define USE_HT32F491x3
    #define LIBCFG_MAX_SPEED                (150000000)
    #define LIBCFG_FLASH_PAGESIZE           (2048)
    #define LIBCFG_RAM_SIZE                 (1024 * 48)
#endif

/**
  * define with package
  */
#if defined (USE_HT32F49153_32QFN)   || defined (USE_HT32F49163_32QFN)

    #define USE_HT32F491x3_32
#endif

#if defined (USE_HT32F49153_36QFN)   || defined (USE_HT32F49163_36QFN)

    #define USE_HT32F491x3_36
#endif

#if defined (USE_HT32F49153_48QFN)   || defined (USE_HT32F49163_48QFN)  || defined (USE_HT32F49153_48LQFP)  || \
    defined (USE_HT32F49163_48LQFP)

    #define USE_HT32F491x3_48
#endif

#if defined (USE_HT32F49153_64LQFP)  || defined (USE_HT32F49163_64LQFP)

    #define USE_HT32F491x3_64
#endif

#if defined (USE_HT32F49153_100LQFP) || defined (USE_HT32F49163_100LQFP)

    #define USE_HT32F491x3_100
#endif

/**
  * define with memory density
  */
#if defined (USE_HT32F49153_32QFN)   || defined (USE_HT32F49153_36QFN)  || defined (USE_HT32F49153_48QFN)   || \
    defined (USE_HT32F49153_48LQFP)  || defined (USE_HT32F49153_64LQFP) || defined (USE_HT32F49153_100LQFP)

    #define LIBCFG_FLASH_SIZE               (LIBCFG_FLASH_PAGESIZE * 128)
    #define USE_HT32F49153
#endif

#if defined (USE_HT32F49163_32QFN)   || defined (USE_HT32F49163_36QFN)  || defined (USE_HT32F49163_48QFN)   || \
    defined (USE_HT32F49163_48LQFP)  || defined (USE_HT32F49163_64LQFP) || defined (USE_HT32F49163_100LQFP)

    #define LIBCFG_FLASH_SIZE               (LIBCFG_FLASH_PAGESIZE * 256)
    #define USE_HT32F49163
#endif
...
/**
  * @brief ht32f491x3 standard peripheral library version number
  */
#define HT32_FWLIB_VER                  (0x0100006a)
#define HT32_FWLIB_SVN                  (0x131)
...
/**
  * @brief ht32f491x3 interrupt number definition, according to the selected device
...
//#include "ht32f491x3_def.h"// Note: Changed for MikroE implementation.
//#include "ht32f491x3_conf.h"// Note: Changed for MikroE implementation.
