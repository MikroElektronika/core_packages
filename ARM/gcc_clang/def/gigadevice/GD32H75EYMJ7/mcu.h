...
#if !defined (GD32H75E)
// #error "Please select the target GD32H75E device used in your application (in gd32h75e.h file)"  // Note: Changed for MikroE implementation.
...
/* GD32H75E firmware library version number V1.2.0 */
#define __GD32H75E_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version     */
#define __GD32H75E_STDPERIPH_VERSION_SUB1   (0x02) /*!< [23:16] sub1 version     */
#define __GD32H75E_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version     */
#define __GD32H75E_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-01-30 */
...
typedef enum IRQn {
    ...
    TIMER7_UP_IRQn              = 44,     /*!< TIMER7 Up2026-01-30 global interrupt                                    */
...
/* includes */
// #include "core_cm7.h"  // Note: Changed for MikroE implementation.
// #include "system_gd32h75e.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32h75e_libopt.h"  // Note: Changed for MikroE implementation.
