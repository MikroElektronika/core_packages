...
//  #error "Please select chip type in project configuration"  // Note: Changed for MikroE implementation.
  /* #define GD32EPRT */
  /* #define GD32E50X_HD */
  /* #define GD32E50X_CL */
  /* #define GD32E508 */
...
#if !defined (GD32E50X)
//  #error "Please select the target GD32E50x device used in your application (in gd32e50x.h file)"  // Note: Changed for MikroE implementation.
...
#define __GD32E50X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-02-13 */ 
...
typedef enum IRQn
{
    ...
    TIMER0_UP_IRQn               = 25,     /*!< TIMER0 up2026-02-13 interrupt */
    ...
    TIMER7_UP_IRQn               = 44,     /*!< TIMER7 up2026-02-13 interrupt */
    ...
    TIMER0_UP_TIMER9_IRQn        = 25,     /*!< TIMER0 up2026-02-13 and TIMER9 interrupt */
    ...
    TIMER7_UP_TIMER12_IRQn       = 44,     /*!< TIMER7 up2026-02-13 and TIMER12 interrupt */
...
// #include "system_gd32e50x.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32e50x_libopt.h"  // Note: Changed for MikroE implementation.
