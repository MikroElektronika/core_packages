...
#if !defined (GD32L23x)
// #error "Please select the target GD32L23x device used in your application (in gd32l23x.h file)"  // Note: Changed for MikroE implementation.
...
#define __GD32L23X_STDPERIPH_VERSION_SUB1   (0x03) /*!< [23:16] sub1 version     */
#define __GD32L23X_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version     */
#define __GD32L23X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-02-03 */
...
#ifdef GD32L235  
    TIMER0_TRG_CMT_UP_BRK_IRQn   = 44,     /*!< TIMER0 trigger and Channel commutation or up2026-02-03 or break interrupt */
...
/* includes */
// #include "core_cm23.h"  // Note: Changed for MikroE implementation.
// #include "system_gd32l23x.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32l23x_libopt.h"  // Note: Changed for MikroE implementation.
