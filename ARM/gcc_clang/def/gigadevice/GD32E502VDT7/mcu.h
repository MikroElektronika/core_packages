...
#if !defined (GD32E502)
// #error "Please select the target GD32E502 device used in your application (in gd32e502.h file)"  // Note: Changed for MikroE implementation.
...
#define __GD32E502_STDPERIPH_VERSION_SUB1   (0x06) /*!< [23:16] sub1 version */
#define __GD32E502_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __GD32E502_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-01-22 */ 
...
typedef enum IRQn
{
    ...
    TIMER0_BRK_UP_TRG_CMT_IRQn  = 26,       /*!< TIMER0 break, up2026-01-22, trigger and commutation interrupt    */
    TIMER0_Channel_IRQn         = 27,       /*!< TIMER0 capture compare interrupt                           */
    TIMER1_IRQn                 = 28,       /*!< TIMER1 interrupt                                           */
    TIMER19_BRK_UP_TRG_CMT_IRQn = 29,       /*!< TIMER19 break, up2026-01-22, trigger and commutation interrupt   */
    ...
    TIMER20_BRK_UP_TRG_CMT_IRQn = 43,       /*!< TIMER20 break, up2026-01-22, trigger and commutation interrupt   */
    TIMER20_Channel_IRQn        = 44,       /*!< TIMER20 capture compare interrupt                          */
    TIMER7_BRK_UP_TRG_CMT_IRQn  = 45,       /*!< TIMER7 break, up2026-01-22, trigger and commutation interrupt    */
...
// #include "system_gd32e502.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32e502_libopt.h"  // Note: Changed for MikroE implementation.
