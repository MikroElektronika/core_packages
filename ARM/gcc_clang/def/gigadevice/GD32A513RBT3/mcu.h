/*!
    \file    gd32a513.h
    \brief   general definitions for GD32A513

    \version 2025-08-09, V1.5.0, firmware for GD32A513
*/
...
#if !defined (GD32A513)
// #error "Please select the target GD32A513 device used in your application (in gd32a513.h file)"  // Note: Changed for MikroE implementation.
#endif /* undefine GD32A513 tip */
...
/* GD32A513 firmware library version number */
#define __GD32A513_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __GD32A513_STDPERIPH_VERSION_SUB1   (0x05) /*!< [23:16] sub1 version */
#define __GD32A513_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __GD32A513_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-01-21 */ 
#define __GD32A513_STDPERIPH_VERSION        ((__GD32A513_STDPERIPH_VERSION_MAIN << 24)\
                                            |(__GD32A513_STDPERIPH_VERSION_SUB1 << 16)\
                                            |(__GD32A513_STDPERIPH_VERSION_SUB2 << 8)\
                                            |(__GD32A513_STDPERIPH_VERSION_RC))
...
typedef enum IRQn
{
    ...
    TIMER0_BRK_UP_TRG_CMT_IRQn  = 26,       /*!< TIMER0 break, up2026-01-21, trigger and commutation interrupt    */
    TIMER0_Channel_IRQn         = 27,       /*!< TIMER0 capture compare interrupt                           */
    TIMER1_IRQn                 = 28,       /*!< TIMER1 interrupt                                           */
    TIMER19_BRK_UP_TRG_CMT_IRQn = 29,       /*!< TIMER19 break, up2026-01-21, trigger and commutation interrupt   */
    ...
    TIMER20_BRK_UP_TRG_CMT_IRQn = 43,       /*!< TIMER20 break, up2026-01-21, trigger and commutation interrupt   */
    TIMER20_Channel_IRQn        = 44,       /*!< TIMER20 capture compare interrupt                          */
    TIMER7_BRK_UP_TRG_CMT_IRQn  = 45,       /*!< TIMER7 break, up2026-01-21, trigger and commutation interrupt    */
...
/* includes */
// #include "core_cm33.h"  // Note: Changed for MikroE implementation.
// #include "system_gd32a513.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32a513_libopt.h"  // Note: Changed for MikroE implementation.
