...
#define __GD32W51X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-03-06 */ 
...
typedef enum IRQn
{
    ...
    TIMER0_UP_IRQn              = 25,     /*!< TIMER0 up2026-03-06 interrupts */
...
// #include "system_gd32w51x.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32w51x_libopt.h"  // Note: Changed for MikroE implementation.
