...
#if !defined (GD32A50X)
// #error "Please select the target GD32A50X device used in your application (in gd32a50x.h file)"  // Note: Changed for MikroE implementation.
...
#define __GD32A50X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-01-21 */ 
...
// #include "system_gd32a50x.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32a50x_libopt.h"  // Note: Changed for MikroE implementation.
