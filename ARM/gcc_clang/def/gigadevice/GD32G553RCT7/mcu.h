/*!
    ...
    \version 2025-08-07, V1.3.0, firmware for GD32G5x3
*/
...
/* define GD32G5X3 */
#if !defined (GD32G5X3)
//  #error "Please select the target GD32G5x3 device used in your application (in gd32g5x3.h file)"  // Note: Changed for MikroE implementation.
...
#define __GD32G5X3_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]   release candi2026-02-10 */ 
...
typedef enum IRQn
{
    ...
    TIMER0_UP_IRQn               = 25,     /*!< TIMER0 up2026-02-10 interrupt                                                                 */
    ...
    TIMER7_UP_IRQn               = 44,     /*!< TIMER7 up2026-02-10 interrupt                                                                 */
    ...
    TIMER19_UP_IRQn              = 78,     /*!< TIMER19 up2026-02-10 interrupt                                                                */
...
// #include "system_gd32g5x3.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32g5x3_libopt.h"  // Note: Changed for MikroE implementation.
