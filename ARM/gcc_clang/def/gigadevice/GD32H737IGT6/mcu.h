...
#if !defined (GD32H7XX)
// #error "Please select the target GD32H7XX device used in your application (in gd32h7xx.h file)"  // Note: Changed for MikroE implementation.
...
#define __GD32H7XX_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candi2026-03-04 */
...
typedef enum IRQn {
    ...
    TIMER0_UP_IRQn              = 25,     /*!< TIMER0 up2026-03-04 interrupt                                           */
    ...
    TIMER7_UP_IRQn              = 44,     /*!< TIMER7 Up2026-03-04 global interrupt                                    */
...
// #include "system_gd32h7xx.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
// #include "gd32h7xx_libopt.h"  // Note: Changed for MikroE implementation.
