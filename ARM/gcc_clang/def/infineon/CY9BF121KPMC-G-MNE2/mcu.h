...
/************************************************************************/
/*                                                                      */
/*  Header File for Device MB9B120J                                     */
/*  Version V0.1                                                        */
/*  Date    2013-01-30                                                  */
/*                                                                      */
/************************************************************************/
 ...
 * QPRC_MODULE
 ******************************************************************************/
/* Quad position and revolution counter registers */
typedef struct
{
  __IO uint16_t QPCR;
       uint8_t RESERVED0[2];
...
typedef struct
{
  ...
  union {
    ...
    stc_gpio_ade_field_t ADE_f;
       ...
       uint8_t RESERVED30[124];
  union {
    __IO uint32_t SPSR;
    stc_gpio_spsr_field_t SPSR_f;
  };
       uint8_t RESERVED31[124];
  union {
...
#define FM3_MFS2_LIN_BASE     (FM3_PERIPH_BASE + 0x38200UL)  /* LIN channel 2 registers                */
...
#define FM3_MFS2_LIN    ((FM3_MFS_LIN_TypeDef *)FM3_MFS2_LIN_BASE)
...
#define bFM3_FLASH_IF_CRTRMM_TTRMM0            *((volatile unsigned int*)(0x42002040UL))
#define bFM3_FLASH_IF_CRTRMM_TTRMM1            *((volatile unsigned int*)(0x42002044UL))
#define bFM3_FLASH_IF_CRTRMM_TTRMM2            *((volatile unsigned int*)(0x42002048UL))
#define bFM3_FLASH_IF_CRTRMM_TTRMM3            *((volatile unsigned int*)(0x4200204CUL))
#define bFM3_FLASH_IF_CRTRMM_TTRMM4            *((volatile unsigned int*)(0x42002050UL))
...
#define bFM3_CRTRIM_MCR_TTRM_TRT0              *((volatile unsigned int*)(0x425C0100UL))
#define bFM3_CRTRIM_MCR_TTRM_TRT1              *((volatile unsigned int*)(0x425C0104UL))
#define bFM3_CRTRIM_MCR_TTRM_TRT2              *((volatile unsigned int*)(0x425C0108UL))
#define bFM3_CRTRIM_MCR_TTRM_TRT3              *((volatile unsigned int*)(0x425C010CUL))
#define bFM3_CRTRIM_MCR_TTRM_TRT4              *((volatile unsigned int*)(0x425C0110UL))
