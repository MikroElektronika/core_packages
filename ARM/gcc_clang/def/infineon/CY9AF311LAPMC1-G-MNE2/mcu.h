...
/************************************************************************/
/*                                                                      */
/*  Header File for Device MB9A310K                                     */
/*  Version V1.6                                                        */
/*  Date    2013-03-08                                                  */
/*                                                                      */
/************************************************************************/
 ...
 * 2012-03-09 1.2 Removeded ITSTx bits of I2C SMR register
 ...
 * 2012-05-29 1.4 Modified FMSINT bit of IRQxxMON register to MFSINT
 *                Removeded FTST bits of FCR register in MFS
 * 2012-08-23 1.5 Modified NR0 bit of NMIRR register to NR
...
#include "cy9af311_core_cm3.h"
// #include "system_mb9af31x.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
 ...
 * DS_MODULE
 ******************************************************************************/
/* Deep standby mode registers bit fields */
...
{
  __IO  uint8_t WRTCI      : 1;
  __IO  uint8_t WLVDI      : 1;
  __IO  uint8_t WUI0       : 1;
  __IO  uint8_t WUI1       : 1;
  __IO  uint8_t WUI2       : 1;
  __IO  uint8_t WUI3       : 1;
...
{
  __IO  uint8_t WRTCE      : 1;
  __IO  uint8_t WLVDE      : 1;
        uint8_t RESERVED1  : 1;
  __IO  uint8_t WUI1E      : 1;
  __IO  uint8_t WUI2E      : 1;
  __IO  uint8_t WUI3E      : 1;
} stc_ds_wier_field_t;
...
#define FM3_WORKFLASH_BASE    (0x200C0000UL)                 /* Work Flash Base   					   */
#define FM3_PERIPH_BASE       (0x40000000UL)                 /* Peripheral  Base                       */
#define FM3_CM3_BASE          (0xE0100000UL)                 /* CM3 Private                            */

#define FM3_WORKFLASH_IF_BASE (FM3_WORKFLASH_BASE + 0x20000UL) /* Work Flash interface registers       */
...
#define FM3_DS_BASE           (FM3_PERIPH_BASE + 0x35800UL)  /* Deep stanby mode registers             */
 ...
 ******************************************************************************/
#define FM3_WORKFLASH_IF ((FM3_WORKFLASH_IF_TypeDef *)FM3_WORKFLASH_IF_BASE)
...
#define FM3_MFS0_UART   ((FM3_MFS47_UART_TypeDef *)FM3_MFS0_UART_BASE)
#define FM3_MFS0_CSIO   ((FM3_MFS47_CSIO_TypeDef *)FM3_MFS0_CSIO_BASE)
#define FM3_MFS0_LIN    ((FM3_MFS47_LIN_TypeDef *)FM3_MFS0_LIN_BASE)
#define FM3_MFS0_I2C    ((FM3_MFS47_I2C_TypeDef *)FM3_MFS0_I2C_BASE)
#define FM3_MFS1_UART   ((FM3_MFS47_UART_TypeDef *)FM3_MFS1_UART_BASE)
#define FM3_MFS1_CSIO   ((FM3_MFS47_CSIO_TypeDef *)FM3_MFS1_CSIO_BASE)
#define FM3_MFS1_LIN    ((FM3_MFS47_LIN_TypeDef *)FM3_MFS1_LIN_BASE)
#define FM3_MFS1_I2C    ((FM3_MFS47_I2C_TypeDef *)FM3_MFS1_I2C_BASE)
...
#define FM3_MFS5_UART   ((FM3_MFS03_UART_TypeDef *)FM3_MFS5_UART_BASE)
#define FM3_MFS5_LIN    ((FM3_MFS03_LIN_TypeDef *)FM3_MFS5_LIN_BASE)
...
/* WorkFlash interface registers */
#define bFM3_WORKFLASH_IF_WFASZR_ASZ           *((volatile unsigned int*)(0x23C00000UL))
#define bFM3_WORKFLASH_IF_WFRWTR_RWT0          *((volatile unsigned int*)(0x23C00080UL))
#define bFM3_WORKFLASH_IF_WFRWTR_RWT1          *((volatile unsigned int*)(0x23C00084UL))
#define bFM3_WORKFLASH_IF_WFRWTR_RWT2          *((volatile unsigned int*)(0x23C00088UL))
#define bFM3_WORKFLASH_IF_WFSTR_RDY            *((volatile unsigned int*)(0x23C00100UL))
#define bFM3_WORKFLASH_IF_WFSTR_HNG            *((volatile unsigned int*)(0x23C00104UL))
...
#define bFM3_FLASH_IF_FSTR_ERR                 *((volatile unsigned int*)(0x42000108UL))
...
#define bFM3_GPIO_PZR0_PF                      *((volatile unsigned int*)(0x4266E03CUL))
...
/* MFS Noise Filter Control registers */
#define bFM3_MFS_NFC_I2CDNF_I2CDNF00           *((volatile unsigned int*)(0x42710000UL))
#define bFM3_MFS_NFC_I2CDNF_I2CDNF01           *((volatile unsigned int*)(0x42710004UL))
#define bFM3_MFS_NFC_I2CDNF_I2CDNF10           *((volatile unsigned int*)(0x42710008UL))
#define bFM3_MFS_NFC_I2CDNF_I2CDNF11           *((volatile unsigned int*)(0x4271000CUL))
#define bFM3_MFS_NFC_I2CDNF_I2CDNF30           *((volatile unsigned int*)(0x42710018UL))
#define bFM3_MFS_NFC_I2CDNF_I2CDNF31           *((volatile unsigned int*)(0x4271001CUL))
#define bFM3_MFS_NFC_I2CDNF_I2CDNF50           *((volatile unsigned int*)(0x42710028UL))
#define bFM3_MFS_NFC_I2CDNF_I2CDNF51           *((volatile unsigned int*)(0x4271002CUL))
...
#define bFM3_RTC_WTCALEN_WTCALEN               *((volatile unsigned int*)(0x427604A0UL))
