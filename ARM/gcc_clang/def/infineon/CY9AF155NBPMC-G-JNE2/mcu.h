...
/************************************************************************/
/*                                                                      */
/*  Header File for Device MB9A150M                                     */
/*  Version V1.1                                                        */
/*  Date    2013-03-15                                                  */
/*                                                                      */
/************************************************************************/
...
typedef enum IRQn
{
    ...
    MFS0_8_RX_IRQn    =  7, /* MultiFunction Serial Reception ch.0 & ch.8    */
    MFS0_8_TX_IRQn    =  8, /* MultiFunction Serial Transmission ch.0 & ch.8 */
    MFS1_9_RX_IRQn    =  9, /* MultiFunction Serial Reception ch.1 & ch.9    */
    MFS1_9_TX_IRQn    = 10, /* MultiFunction Serial Transmission ch.1 & ch.9 */
    MFS2_10_RX_IRQn   = 11, /* MultiFunction Serial Reception ch.2 & ch.10   */
    MFS2_10_TX_IRQn   = 12, /* MultiFunction Serial Transmission ch.2 & ch.10*/
    MFS3_11_RX_IRQn   = 13, /* MultiFunction Serial Reception ch.3 & ch.11   */
    MFS3_11_TX_IRQn   = 14, /* MultiFunction Serial Transmission ch.3 & ch.11*/
    MFS4_12_RX_IRQn   = 15, /* MultiFunction Serial Reception ch.4 & ch.12   */
    MFS4_12_TX_IRQn   = 16, /* MultiFunction Serial Transmission ch.4 & ch.12*/
    MFS5_13_RX_IRQn   = 17, /* MultiFunction Serial Reception ch.5 & ch.13   */
    MFS5_13_TX_IRQn   = 18, /* MultiFunction Serial Transmission ch.5 & ch.13*/
    MFS6_14_RX_IRQn   = 19, /* MultiFunction Serial Reception ch.6 & ch.14   */
    MFS6_14_TX_IRQn   = 20, /* MultiFunction Serial Transmission ch.6 & ch.14*/
    MFS7_15_RX_IRQn   = 21, /* MultiFunction Serial Reception ch.7 & ch.15   */
    MFS7_15_TX_IRQn   = 22, /* MultiFunction Serial Transmission ch.7 & ch.15*/
    PPG_IRQn          = 23, /* PPG                                           */
...
#include "cy9af15_core_cm3.h"
// #include "system_mb9af15x.h"  // Note: Changed for MikroE implementation.
#include <stdint.h>
...
typedef struct
{
  ...
  union {
    ...
    stc_gpio_pcr7_field_t PCR7_f;
       ...
       uint8_t RESERVED17[24];
  union {
    __IO uint32_t PCRE;
    stc_gpio_pcre_field_t PCRE_f;
  };
       uint8_t RESERVED18[196];
  union {
    __IO uint32_t DDR0;
  ...
  union {
    ...
    stc_gpio_ddr8_field_t DDR8_f;
       ...
       uint8_t RESERVED27[20];
  union {
    __IO uint32_t DDRE;
    stc_gpio_ddre_field_t DDRE_f;
  };
       uint8_t RESERVED28[196];
  union {
    __IO uint32_t PDIR0;
  ...
  union {
    ...
    stc_gpio_pdir8_field_t PDIR8_f;
       ...
       uint8_t RESERVED37[20];
  union {
    __IO uint32_t PDIRE;
    stc_gpio_pdire_field_t PDIRE_f;
  };
       uint8_t RESERVED38[196];
  union {
    __IO uint32_t PDOR0;
  ...
  union {
    ...
    stc_gpio_pdor8_field_t PDOR8_f;
       ...
       uint8_t RESERVED47[20];
  union {
    __IO uint32_t PDORE;
    stc_gpio_pdore_field_t PDORE_f;
  };
       uint8_t RESERVED48[196];
  union {
    __IO uint32_t ADE;
    stc_gpio_ade_field_t ADE_f;
  };
       uint8_t RESERVED49[124];
  union {
    __IO uint32_t SPSR;
  ...
  union {
    ...
    stc_gpio_epfr18_field_t EPFR18_f;
       ...
       uint8_t RESERVED67[180];
  union {
    __IO uint32_t PZR0;
    stc_gpio_pzr0_field_t PZR0_f;
  };
       uint8_t RESERVED68[12];
  union {
    __IO uint32_t PZR4;
...
#define FM3_MFS10_UART_BASE   (FM3_PERIPH_BASE + 0x38A00UL)  /* UART asynchronous channel 10 registers */
#define FM3_MFS10_CSIO_BASE   (FM3_PERIPH_BASE + 0x38A00UL)  /* UART synchronous channel 10 registers  */
#define FM3_MFS10_I2C_BASE    (FM3_PERIPH_BASE + 0x38A00UL)  /* I2C channel 10 registers               */
#define FM3_MFS11_UART_BASE   (FM3_PERIPH_BASE + 0x38B00UL)  /* UART asynchronous channel 11 registers */
#define FM3_MFS11_CSIO_BASE   (FM3_PERIPH_BASE + 0x38B00UL)  /* UART synchronous channel 11 registers  */
#define FM3_MFS11_I2C_BASE    (FM3_PERIPH_BASE + 0x38B00UL)  /* I2C channel 11 registers               */
...
#define FM3_MFS2_UART   ((FM3_MFS_UART_TypeDef *)FM3_MFS2_UART_BASE)
#define FM3_MFS2_CSIO   ((FM3_MFS_CSIO_TypeDef *)FM3_MFS2_CSIO_BASE)
#define FM3_MFS2_I2C    ((FM3_MFS_I2C_TypeDef *)FM3_MFS2_I2C_BASE)
...
#define FM3_MFS4_UART   ((FM3_MFS_UART_TypeDef *)FM3_MFS4_UART_BASE)
#define FM3_MFS4_CSIO   ((FM3_MFS_CSIO_TypeDef *)FM3_MFS4_CSIO_BASE)
#define FM3_MFS4_I2C    ((FM3_MFS_I2C_TypeDef *)FM3_MFS4_I2C_BASE)
...
#define FM3_MFS6_UART   ((FM3_MFS_UART_TypeDef *)FM3_MFS6_UART_BASE)
#define FM3_MFS6_CSIO   ((FM3_MFS_CSIO_TypeDef *)FM3_MFS6_CSIO_BASE)
#define FM3_MFS6_I2C    ((FM3_MFS_I2C_TypeDef *)FM3_MFS6_I2C_BASE)
#define FM3_MFS7_UART   ((FM3_MFS_UART_TypeDef *)FM3_MFS7_UART_BASE)
#define FM3_MFS7_CSIO   ((FM3_MFS_CSIO_TypeDef *)FM3_MFS7_CSIO_BASE)
#define FM3_MFS7_I2C    ((FM3_MFS_I2C_TypeDef *)FM3_MFS7_I2C_BASE)
#define FM3_MFS10_UART  ((FM3_MFS_UART_TypeDef *)FM3_MFS10_UART_BASE)
#define FM3_MFS10_CSIO  ((FM3_MFS_CSIO_TypeDef *)FM3_MFS10_CSIO_BASE)
#define FM3_MFS10_I2C   ((FM3_MFS_I2C_TypeDef *)FM3_MFS10_I2C_BASE)
#define FM3_MFS11_UART  ((FM3_MFS_UART_TypeDef *)FM3_MFS11_UART_BASE)
#define FM3_MFS11_CSIO  ((FM3_MFS_CSIO_TypeDef *)FM3_MFS11_CSIO_BASE)
#define FM3_MFS11_I2C   ((FM3_MFS_I2C_TypeDef *)FM3_MFS11_I2C_BASE)
...
#define bFM3_EXTI_ELVR1_LA22                   *((volatile unsigned int*)(0x42600230UL))
#define bFM3_EXTI_ELVR1_LB22                   *((volatile unsigned int*)(0x42600234UL))
#define bFM3_EXTI_ELVR1_LA23                   *((volatile unsigned int*)(0x42600238UL))
#define bFM3_EXTI_ELVR1_LB23                   *((volatile unsigned int*)(0x4260023CUL))
...
#define bFM3_INTREQ_IRQ07MON_MFSINT1           *((volatile unsigned int*)(0x42620604UL))
...
#define bFM3_INTREQ_IRQ08MON_MFSINT2           *((volatile unsigned int*)(0x42620688UL))
#define bFM3_INTREQ_IRQ08MON_MFSINT3           *((volatile unsigned int*)(0x4262068CUL))
#define bFM3_INTREQ_IRQ09MON_MFSINT0           *((volatile unsigned int*)(0x42620700UL))
#define bFM3_INTREQ_IRQ09MON_MFSINT1           *((volatile unsigned int*)(0x42620704UL))
...
#define bFM3_INTREQ_IRQ10MON_MFSINT2           *((volatile unsigned int*)(0x42620788UL))
#define bFM3_INTREQ_IRQ10MON_MFSINT3           *((volatile unsigned int*)(0x4262078CUL))
#define bFM3_INTREQ_IRQ11MON_MFSINT0           *((volatile unsigned int*)(0x42620800UL))
#define bFM3_INTREQ_IRQ11MON_MFSINT1           *((volatile unsigned int*)(0x42620804UL))
...
#define bFM3_INTREQ_IRQ12MON_MFSINT2           *((volatile unsigned int*)(0x42620888UL))
#define bFM3_INTREQ_IRQ12MON_MFSINT3           *((volatile unsigned int*)(0x4262088CUL))
#define bFM3_INTREQ_IRQ13MON_MFSINT0           *((volatile unsigned int*)(0x42620900UL))
#define bFM3_INTREQ_IRQ13MON_MFSINT1           *((volatile unsigned int*)(0x42620904UL))
...
#define bFM3_INTREQ_IRQ14MON_MFSINT2           *((volatile unsigned int*)(0x42620988UL))
#define bFM3_INTREQ_IRQ14MON_MFSINT3           *((volatile unsigned int*)(0x4262098CUL))
#define bFM3_INTREQ_IRQ15MON_MFSINT0           *((volatile unsigned int*)(0x42620A00UL))
#define bFM3_INTREQ_IRQ15MON_MFSINT1           *((volatile unsigned int*)(0x42620A04UL))
...
#define bFM3_INTREQ_IRQ16MON_MFSINT2           *((volatile unsigned int*)(0x42620A88UL))
#define bFM3_INTREQ_IRQ16MON_MFSINT3           *((volatile unsigned int*)(0x42620A8CUL))
#define bFM3_INTREQ_IRQ17MON_MFSINT0           *((volatile unsigned int*)(0x42620B00UL))
#define bFM3_INTREQ_IRQ17MON_MFSINT1           *((volatile unsigned int*)(0x42620B04UL))
...
#define bFM3_INTREQ_IRQ18MON_MFSINT2           *((volatile unsigned int*)(0x42620B88UL))
#define bFM3_INTREQ_IRQ18MON_MFSINT3           *((volatile unsigned int*)(0x42620B8CUL))
#define bFM3_INTREQ_IRQ19MON_MFSINT0           *((volatile unsigned int*)(0x42620C00UL))
#define bFM3_INTREQ_IRQ19MON_MFSINT1           *((volatile unsigned int*)(0x42620C04UL))
...
#define bFM3_INTREQ_IRQ20MON_MFSINT2           *((volatile unsigned int*)(0x42620C88UL))
#define bFM3_INTREQ_IRQ20MON_MFSINT3           *((volatile unsigned int*)(0x42620C8CUL))
#define bFM3_INTREQ_IRQ21MON_MFSINT0           *((volatile unsigned int*)(0x42620D00UL))
#define bFM3_INTREQ_IRQ21MON_MFSINT1           *((volatile unsigned int*)(0x42620D04UL))
...
#define bFM3_INTREQ_IRQ22MON_MFSINT2           *((volatile unsigned int*)(0x42620D88UL))
#define bFM3_INTREQ_IRQ22MON_MFSINT3           *((volatile unsigned int*)(0x42620D8CUL))
...
#define bFM3_GPIO_EPFR16_SIN10S0               *((volatile unsigned int*)(0x4266C840UL))
#define bFM3_GPIO_EPFR16_SIN10S1               *((volatile unsigned int*)(0x4266C844UL))
#define bFM3_GPIO_EPFR16_SOT10B0               *((volatile unsigned int*)(0x4266C848UL))
#define bFM3_GPIO_EPFR16_SOT10B1               *((volatile unsigned int*)(0x4266C84CUL))
#define bFM3_GPIO_EPFR16_SCK10B0               *((volatile unsigned int*)(0x4266C850UL))
#define bFM3_GPIO_EPFR16_SCK10B1               *((volatile unsigned int*)(0x4266C854UL))
#define bFM3_GPIO_EPFR16_SIN11S0               *((volatile unsigned int*)(0x4266C858UL))
#define bFM3_GPIO_EPFR16_SIN11S1               *((volatile unsigned int*)(0x4266C85CUL))
#define bFM3_GPIO_EPFR16_SOT11B0               *((volatile unsigned int*)(0x4266C860UL))
#define bFM3_GPIO_EPFR16_SOT11B1               *((volatile unsigned int*)(0x4266C864UL))
#define bFM3_GPIO_EPFR16_SCK11B0               *((volatile unsigned int*)(0x4266C868UL))
#define bFM3_GPIO_EPFR16_SCK11B1               *((volatile unsigned int*)(0x4266C86CUL))
#define bFM3_GPIO_EPFR18_CECR0B0               *((volatile unsigned int*)(0x4266C900UL))
#define bFM3_GPIO_EPFR18_CECR0B1               *((volatile unsigned int*)(0x4266C904UL))
#define bFM3_GPIO_EPFR18_CECR1B0               *((volatile unsigned int*)(0x4266C908UL))
#define bFM3_GPIO_EPFR18_CECR1B1               *((volatile unsigned int*)(0x4266C90CUL))
...
#define bFM3_DS_WIFSR_WUI4                     *((volatile unsigned int*)(0x426B0118UL))
#define bFM3_DS_WIFSR_WUI5                     *((volatile unsigned int*)(0x426B011CUL))
...
#define bFM3_DS_WIER_WUI4E                     *((volatile unsigned int*)(0x426B0198UL))
#define bFM3_DS_WIER_WUI5E                     *((volatile unsigned int*)(0x426B019CUL))
...
#define bFM3_DS_WILVR_WUI4LV                   *((volatile unsigned int*)(0x426B020CUL))
#define bFM3_DS_WILVR_WUI5LV                   *((volatile unsigned int*)(0x426B0210UL))
...
#define bFM3_MFS2_UART_FCR_FE1                 *((volatile unsigned int*)(0x42704280UL))
#define bFM3_MFS2_UART_FCR_FE2                 *((volatile unsigned int*)(0x42704284UL))
#define bFM3_MFS2_UART_FCR_FCL1                *((volatile unsigned int*)(0x42704288UL))
#define bFM3_MFS2_UART_FCR_FCL2                *((volatile unsigned int*)(0x4270428CUL))
#define bFM3_MFS2_UART_FCR_FSET                *((volatile unsigned int*)(0x42704290UL))
#define bFM3_MFS2_UART_FCR_FLD                 *((volatile unsigned int*)(0x42704294UL))
#define bFM3_MFS2_UART_FCR_FLST                *((volatile unsigned int*)(0x42704298UL))
#define bFM3_MFS2_UART_FCR_FSEL                *((volatile unsigned int*)(0x427042A0UL))
#define bFM3_MFS2_UART_FCR_FTIE                *((volatile unsigned int*)(0x427042A4UL))
#define bFM3_MFS2_UART_FCR_FDRQ                *((volatile unsigned int*)(0x427042A8UL))
#define bFM3_MFS2_UART_FCR_FRIIE               *((volatile unsigned int*)(0x427042ACUL))
#define bFM3_MFS2_UART_FCR_FLSTE               *((volatile unsigned int*)(0x427042B0UL))
#define bFM3_MFS2_UART_FCR0_FE1                *((volatile unsigned int*)(0x42704280UL))
#define bFM3_MFS2_UART_FCR0_FE2                *((volatile unsigned int*)(0x42704284UL))
#define bFM3_MFS2_UART_FCR0_FCL1               *((volatile unsigned int*)(0x42704288UL))
#define bFM3_MFS2_UART_FCR0_FCL2               *((volatile unsigned int*)(0x4270428CUL))
#define bFM3_MFS2_UART_FCR0_FSET               *((volatile unsigned int*)(0x42704290UL))
#define bFM3_MFS2_UART_FCR0_FLD                *((volatile unsigned int*)(0x42704294UL))
#define bFM3_MFS2_UART_FCR0_FLST               *((volatile unsigned int*)(0x42704298UL))
#define bFM3_MFS2_UART_FCR1_FSEL               *((volatile unsigned int*)(0x427042A0UL))
#define bFM3_MFS2_UART_FCR1_FTIE               *((volatile unsigned int*)(0x427042A4UL))
#define bFM3_MFS2_UART_FCR1_FDRQ               *((volatile unsigned int*)(0x427042A8UL))
#define bFM3_MFS2_UART_FCR1_FRIIE              *((volatile unsigned int*)(0x427042ACUL))
#define bFM3_MFS2_UART_FCR1_FLSTE              *((volatile unsigned int*)(0x427042B0UL))
#define bFM3_MFS2_UART_FBYTE_FD0               *((volatile unsigned int*)(0x42704300UL))
#define bFM3_MFS2_UART_FBYTE_FD1               *((volatile unsigned int*)(0x42704304UL))
#define bFM3_MFS2_UART_FBYTE_FD2               *((volatile unsigned int*)(0x42704308UL))
#define bFM3_MFS2_UART_FBYTE_FD3               *((volatile unsigned int*)(0x4270430CUL))
#define bFM3_MFS2_UART_FBYTE_FD4               *((volatile unsigned int*)(0x42704310UL))
#define bFM3_MFS2_UART_FBYTE_FD5               *((volatile unsigned int*)(0x42704314UL))
#define bFM3_MFS2_UART_FBYTE_FD6               *((volatile unsigned int*)(0x42704318UL))
#define bFM3_MFS2_UART_FBYTE_FD7               *((volatile unsigned int*)(0x4270431CUL))
#define bFM3_MFS2_UART_FBYTE_FD8               *((volatile unsigned int*)(0x42704320UL))
#define bFM3_MFS2_UART_FBYTE_FD9               *((volatile unsigned int*)(0x42704324UL))
#define bFM3_MFS2_UART_FBYTE_FD10              *((volatile unsigned int*)(0x42704328UL))
#define bFM3_MFS2_UART_FBYTE_FD11              *((volatile unsigned int*)(0x4270432CUL))
#define bFM3_MFS2_UART_FBYTE_FD12              *((volatile unsigned int*)(0x42704330UL))
#define bFM3_MFS2_UART_FBYTE_FD13              *((volatile unsigned int*)(0x42704334UL))
#define bFM3_MFS2_UART_FBYTE_FD14              *((volatile unsigned int*)(0x42704338UL))
#define bFM3_MFS2_UART_FBYTE_FD15              *((volatile unsigned int*)(0x4270433CUL))
#define bFM3_MFS2_UART_FBYTE1_FD0              *((volatile unsigned int*)(0x42704300UL))
#define bFM3_MFS2_UART_FBYTE1_FD1              *((volatile unsigned int*)(0x42704304UL))
#define bFM3_MFS2_UART_FBYTE1_FD2              *((volatile unsigned int*)(0x42704308UL))
#define bFM3_MFS2_UART_FBYTE1_FD3              *((volatile unsigned int*)(0x4270430CUL))
#define bFM3_MFS2_UART_FBYTE1_FD4              *((volatile unsigned int*)(0x42704310UL))
#define bFM3_MFS2_UART_FBYTE1_FD5              *((volatile unsigned int*)(0x42704314UL))
#define bFM3_MFS2_UART_FBYTE1_FD6              *((volatile unsigned int*)(0x42704318UL))
#define bFM3_MFS2_UART_FBYTE1_FD7              *((volatile unsigned int*)(0x4270431CUL))
#define bFM3_MFS2_UART_FBYTE2_FD8              *((volatile unsigned int*)(0x42704320UL))
#define bFM3_MFS2_UART_FBYTE2_FD9              *((volatile unsigned int*)(0x42704324UL))
#define bFM3_MFS2_UART_FBYTE2_FD10             *((volatile unsigned int*)(0x42704328UL))
#define bFM3_MFS2_UART_FBYTE2_FD11             *((volatile unsigned int*)(0x4270432CUL))
#define bFM3_MFS2_UART_FBYTE2_FD12             *((volatile unsigned int*)(0x42704330UL))
#define bFM3_MFS2_UART_FBYTE2_FD13             *((volatile unsigned int*)(0x42704334UL))
#define bFM3_MFS2_UART_FBYTE2_FD14             *((volatile unsigned int*)(0x42704338UL))
#define bFM3_MFS2_UART_FBYTE2_FD15             *((volatile unsigned int*)(0x4270433CUL))

/* CSIO channel 2 registers */
...
#define bFM3_MFS2_CSIO_FCR_FE1                 *((volatile unsigned int*)(0x42704280UL))
#define bFM3_MFS2_CSIO_FCR_FE2                 *((volatile unsigned int*)(0x42704284UL))
#define bFM3_MFS2_CSIO_FCR_FCL1                *((volatile unsigned int*)(0x42704288UL))
#define bFM3_MFS2_CSIO_FCR_FCL2                *((volatile unsigned int*)(0x4270428CUL))
#define bFM3_MFS2_CSIO_FCR_FSET                *((volatile unsigned int*)(0x42704290UL))
#define bFM3_MFS2_CSIO_FCR_FLD                 *((volatile unsigned int*)(0x42704294UL))
#define bFM3_MFS2_CSIO_FCR_FLST                *((volatile unsigned int*)(0x42704298UL))
#define bFM3_MFS2_CSIO_FCR_FSEL                *((volatile unsigned int*)(0x427042A0UL))
#define bFM3_MFS2_CSIO_FCR_FTIE                *((volatile unsigned int*)(0x427042A4UL))
#define bFM3_MFS2_CSIO_FCR_FDRQ                *((volatile unsigned int*)(0x427042A8UL))
#define bFM3_MFS2_CSIO_FCR_FRIIE               *((volatile unsigned int*)(0x427042ACUL))
#define bFM3_MFS2_CSIO_FCR_FLSTE               *((volatile unsigned int*)(0x427042B0UL))
#define bFM3_MFS2_CSIO_FCR0_FE1                *((volatile unsigned int*)(0x42704280UL))
#define bFM3_MFS2_CSIO_FCR0_FE2                *((volatile unsigned int*)(0x42704284UL))
#define bFM3_MFS2_CSIO_FCR0_FCL1               *((volatile unsigned int*)(0x42704288UL))
#define bFM3_MFS2_CSIO_FCR0_FCL2               *((volatile unsigned int*)(0x4270428CUL))
#define bFM3_MFS2_CSIO_FCR0_FSET               *((volatile unsigned int*)(0x42704290UL))
#define bFM3_MFS2_CSIO_FCR0_FLD                *((volatile unsigned int*)(0x42704294UL))
#define bFM3_MFS2_CSIO_FCR0_FLST               *((volatile unsigned int*)(0x42704298UL))
#define bFM3_MFS2_CSIO_FCR1_FSEL               *((volatile unsigned int*)(0x427042A0UL))
#define bFM3_MFS2_CSIO_FCR1_FTIE               *((volatile unsigned int*)(0x427042A4UL))
#define bFM3_MFS2_CSIO_FCR1_FDRQ               *((volatile unsigned int*)(0x427042A8UL))
#define bFM3_MFS2_CSIO_FCR1_FRIIE              *((volatile unsigned int*)(0x427042ACUL))
#define bFM3_MFS2_CSIO_FCR1_FLSTE              *((volatile unsigned int*)(0x427042B0UL))
#define bFM3_MFS2_CSIO_FBYTE_FD0               *((volatile unsigned int*)(0x42704300UL))
#define bFM3_MFS2_CSIO_FBYTE_FD1               *((volatile unsigned int*)(0x42704304UL))
#define bFM3_MFS2_CSIO_FBYTE_FD2               *((volatile unsigned int*)(0x42704308UL))
#define bFM3_MFS2_CSIO_FBYTE_FD3               *((volatile unsigned int*)(0x4270430CUL))
#define bFM3_MFS2_CSIO_FBYTE_FD4               *((volatile unsigned int*)(0x42704310UL))
#define bFM3_MFS2_CSIO_FBYTE_FD5               *((volatile unsigned int*)(0x42704314UL))
#define bFM3_MFS2_CSIO_FBYTE_FD6               *((volatile unsigned int*)(0x42704318UL))
#define bFM3_MFS2_CSIO_FBYTE_FD7               *((volatile unsigned int*)(0x4270431CUL))
#define bFM3_MFS2_CSIO_FBYTE_FD8               *((volatile unsigned int*)(0x42704320UL))
#define bFM3_MFS2_CSIO_FBYTE_FD9               *((volatile unsigned int*)(0x42704324UL))
#define bFM3_MFS2_CSIO_FBYTE_FD10              *((volatile unsigned int*)(0x42704328UL))
#define bFM3_MFS2_CSIO_FBYTE_FD11              *((volatile unsigned int*)(0x4270432CUL))
#define bFM3_MFS2_CSIO_FBYTE_FD12              *((volatile unsigned int*)(0x42704330UL))
#define bFM3_MFS2_CSIO_FBYTE_FD13              *((volatile unsigned int*)(0x42704334UL))
#define bFM3_MFS2_CSIO_FBYTE_FD14              *((volatile unsigned int*)(0x42704338UL))
#define bFM3_MFS2_CSIO_FBYTE_FD15              *((volatile unsigned int*)(0x4270433CUL))
#define bFM3_MFS2_CSIO_FBYTE1_FD0              *((volatile unsigned int*)(0x42704300UL))
#define bFM3_MFS2_CSIO_FBYTE1_FD1              *((volatile unsigned int*)(0x42704304UL))
#define bFM3_MFS2_CSIO_FBYTE1_FD2              *((volatile unsigned int*)(0x42704308UL))
#define bFM3_MFS2_CSIO_FBYTE1_FD3              *((volatile unsigned int*)(0x4270430CUL))
#define bFM3_MFS2_CSIO_FBYTE1_FD4              *((volatile unsigned int*)(0x42704310UL))
#define bFM3_MFS2_CSIO_FBYTE1_FD5              *((volatile unsigned int*)(0x42704314UL))
#define bFM3_MFS2_CSIO_FBYTE1_FD6              *((volatile unsigned int*)(0x42704318UL))
#define bFM3_MFS2_CSIO_FBYTE1_FD7              *((volatile unsigned int*)(0x4270431CUL))
#define bFM3_MFS2_CSIO_FBYTE2_FD8              *((volatile unsigned int*)(0x42704320UL))
#define bFM3_MFS2_CSIO_FBYTE2_FD9              *((volatile unsigned int*)(0x42704324UL))
#define bFM3_MFS2_CSIO_FBYTE2_FD10             *((volatile unsigned int*)(0x42704328UL))
#define bFM3_MFS2_CSIO_FBYTE2_FD11             *((volatile unsigned int*)(0x4270432CUL))
#define bFM3_MFS2_CSIO_FBYTE2_FD12             *((volatile unsigned int*)(0x42704330UL))
#define bFM3_MFS2_CSIO_FBYTE2_FD13             *((volatile unsigned int*)(0x42704334UL))
#define bFM3_MFS2_CSIO_FBYTE2_FD14             *((volatile unsigned int*)(0x42704338UL))
#define bFM3_MFS2_CSIO_FBYTE2_FD15             *((volatile unsigned int*)(0x4270433CUL))
...
#define bFM3_MFS2_I2C_FCR_FE1                  *((volatile unsigned int*)(0x42704280UL))
#define bFM3_MFS2_I2C_FCR_FE2                  *((volatile unsigned int*)(0x42704284UL))
#define bFM3_MFS2_I2C_FCR_FCL1                 *((volatile unsigned int*)(0x42704288UL))
#define bFM3_MFS2_I2C_FCR_FCL2                 *((volatile unsigned int*)(0x4270428CUL))
#define bFM3_MFS2_I2C_FCR_FSET                 *((volatile unsigned int*)(0x42704290UL))
#define bFM3_MFS2_I2C_FCR_FLD                  *((volatile unsigned int*)(0x42704294UL))
#define bFM3_MFS2_I2C_FCR_FLST                 *((volatile unsigned int*)(0x42704298UL))
#define bFM3_MFS2_I2C_FCR_FSEL                 *((volatile unsigned int*)(0x427042A0UL))
#define bFM3_MFS2_I2C_FCR_FTIE                 *((volatile unsigned int*)(0x427042A4UL))
#define bFM3_MFS2_I2C_FCR_FDRQ                 *((volatile unsigned int*)(0x427042A8UL))
#define bFM3_MFS2_I2C_FCR_FRIIE                *((volatile unsigned int*)(0x427042ACUL))
#define bFM3_MFS2_I2C_FCR_FLSTE                *((volatile unsigned int*)(0x427042B0UL))
#define bFM3_MFS2_I2C_FCR0_FE1                 *((volatile unsigned int*)(0x42704280UL))
#define bFM3_MFS2_I2C_FCR0_FE2                 *((volatile unsigned int*)(0x42704284UL))
#define bFM3_MFS2_I2C_FCR0_FCL1                *((volatile unsigned int*)(0x42704288UL))
#define bFM3_MFS2_I2C_FCR0_FCL2                *((volatile unsigned int*)(0x4270428CUL))
#define bFM3_MFS2_I2C_FCR0_FSET                *((volatile unsigned int*)(0x42704290UL))
#define bFM3_MFS2_I2C_FCR0_FLD                 *((volatile unsigned int*)(0x42704294UL))
#define bFM3_MFS2_I2C_FCR0_FLST                *((volatile unsigned int*)(0x42704298UL))
#define bFM3_MFS2_I2C_FCR1_FSEL                *((volatile unsigned int*)(0x427042A0UL))
#define bFM3_MFS2_I2C_FCR1_FTIE                *((volatile unsigned int*)(0x427042A4UL))
#define bFM3_MFS2_I2C_FCR1_FDRQ                *((volatile unsigned int*)(0x427042A8UL))
#define bFM3_MFS2_I2C_FCR1_FRIIE               *((volatile unsigned int*)(0x427042ACUL))
#define bFM3_MFS2_I2C_FCR1_FLSTE               *((volatile unsigned int*)(0x427042B0UL))
#define bFM3_MFS2_I2C_FBYTE_FD0                *((volatile unsigned int*)(0x42704300UL))
#define bFM3_MFS2_I2C_FBYTE_FD1                *((volatile unsigned int*)(0x42704304UL))
#define bFM3_MFS2_I2C_FBYTE_FD2                *((volatile unsigned int*)(0x42704308UL))
#define bFM3_MFS2_I2C_FBYTE_FD3                *((volatile unsigned int*)(0x4270430CUL))
#define bFM3_MFS2_I2C_FBYTE_FD4                *((volatile unsigned int*)(0x42704310UL))
#define bFM3_MFS2_I2C_FBYTE_FD5                *((volatile unsigned int*)(0x42704314UL))
#define bFM3_MFS2_I2C_FBYTE_FD6                *((volatile unsigned int*)(0x42704318UL))
#define bFM3_MFS2_I2C_FBYTE_FD7                *((volatile unsigned int*)(0x4270431CUL))
#define bFM3_MFS2_I2C_FBYTE_FD8                *((volatile unsigned int*)(0x42704320UL))
#define bFM3_MFS2_I2C_FBYTE_FD9                *((volatile unsigned int*)(0x42704324UL))
#define bFM3_MFS2_I2C_FBYTE_FD10               *((volatile unsigned int*)(0x42704328UL))
#define bFM3_MFS2_I2C_FBYTE_FD11               *((volatile unsigned int*)(0x4270432CUL))
#define bFM3_MFS2_I2C_FBYTE_FD12               *((volatile unsigned int*)(0x42704330UL))
#define bFM3_MFS2_I2C_FBYTE_FD13               *((volatile unsigned int*)(0x42704334UL))
#define bFM3_MFS2_I2C_FBYTE_FD14               *((volatile unsigned int*)(0x42704338UL))
#define bFM3_MFS2_I2C_FBYTE_FD15               *((volatile unsigned int*)(0x4270433CUL))
#define bFM3_MFS2_I2C_FBYTE1_FD0               *((volatile unsigned int*)(0x42704300UL))
#define bFM3_MFS2_I2C_FBYTE1_FD1               *((volatile unsigned int*)(0x42704304UL))
#define bFM3_MFS2_I2C_FBYTE1_FD2               *((volatile unsigned int*)(0x42704308UL))
#define bFM3_MFS2_I2C_FBYTE1_FD3               *((volatile unsigned int*)(0x4270430CUL))
#define bFM3_MFS2_I2C_FBYTE1_FD4               *((volatile unsigned int*)(0x42704310UL))
#define bFM3_MFS2_I2C_FBYTE1_FD5               *((volatile unsigned int*)(0x42704314UL))
#define bFM3_MFS2_I2C_FBYTE1_FD6               *((volatile unsigned int*)(0x42704318UL))
#define bFM3_MFS2_I2C_FBYTE1_FD7               *((volatile unsigned int*)(0x4270431CUL))
#define bFM3_MFS2_I2C_FBYTE2_FD8               *((volatile unsigned int*)(0x42704320UL))
#define bFM3_MFS2_I2C_FBYTE2_FD9               *((volatile unsigned int*)(0x42704324UL))
#define bFM3_MFS2_I2C_FBYTE2_FD10              *((volatile unsigned int*)(0x42704328UL))
#define bFM3_MFS2_I2C_FBYTE2_FD11              *((volatile unsigned int*)(0x4270432CUL))
#define bFM3_MFS2_I2C_FBYTE2_FD12              *((volatile unsigned int*)(0x42704330UL))
#define bFM3_MFS2_I2C_FBYTE2_FD13              *((volatile unsigned int*)(0x42704334UL))
#define bFM3_MFS2_I2C_FBYTE2_FD14              *((volatile unsigned int*)(0x42704338UL))
#define bFM3_MFS2_I2C_FBYTE2_FD15              *((volatile unsigned int*)(0x4270433CUL))
...
/* UART asynchronous channel 10 registers */
#define bFM3_MFS10_UART_SMR_SOE                *((volatile unsigned int*)(0x42714000UL))
#define bFM3_MFS10_UART_SMR_BDS                *((volatile unsigned int*)(0x42714008UL))
#define bFM3_MFS10_UART_SMR_SBL                *((volatile unsigned int*)(0x4271400CUL))
#define bFM3_MFS10_UART_SMR_WUCR               *((volatile unsigned int*)(0x42714010UL))
#define bFM3_MFS10_UART_SCR_TXE                *((volatile unsigned int*)(0x42714020UL))
#define bFM3_MFS10_UART_SCR_RXE                *((volatile unsigned int*)(0x42714024UL))
#define bFM3_MFS10_UART_SCR_TBIE               *((volatile unsigned int*)(0x42714028UL))
#define bFM3_MFS10_UART_SCR_TIE                *((volatile unsigned int*)(0x4271402CUL))
#define bFM3_MFS10_UART_SCR_RIE                *((volatile unsigned int*)(0x42714030UL))
#define bFM3_MFS10_UART_SCR_UPCL               *((volatile unsigned int*)(0x4271403CUL))
#define bFM3_MFS10_UART_ESCR_L0                *((volatile unsigned int*)(0x42714080UL))
#define bFM3_MFS10_UART_ESCR_L1                *((volatile unsigned int*)(0x42714084UL))
#define bFM3_MFS10_UART_ESCR_L2                *((volatile unsigned int*)(0x42714088UL))
#define bFM3_MFS10_UART_ESCR_P                 *((volatile unsigned int*)(0x4271408CUL))
#define bFM3_MFS10_UART_ESCR_PEN               *((volatile unsigned int*)(0x42714090UL))
#define bFM3_MFS10_UART_ESCR_INV               *((volatile unsigned int*)(0x42714094UL))
#define bFM3_MFS10_UART_ESCR_ESBL              *((volatile unsigned int*)(0x42714098UL))
#define bFM3_MFS10_UART_ESCR_FLWEN             *((volatile unsigned int*)(0x4271409CUL))
#define bFM3_MFS10_UART_SSR_TBI                *((volatile unsigned int*)(0x427140A0UL))
#define bFM3_MFS10_UART_SSR_TDRE               *((volatile unsigned int*)(0x427140A4UL))
#define bFM3_MFS10_UART_SSR_RDRF               *((volatile unsigned int*)(0x427140A8UL))
#define bFM3_MFS10_UART_SSR_ORE                *((volatile unsigned int*)(0x427140ACUL))
#define bFM3_MFS10_UART_SSR_FRE                *((volatile unsigned int*)(0x427140B0UL))
#define bFM3_MFS10_UART_SSR_PE                 *((volatile unsigned int*)(0x427140B4UL))
#define bFM3_MFS10_UART_SSR_REC                *((volatile unsigned int*)(0x427140BCUL))
#define bFM3_MFS10_UART_RDR_AD                 *((volatile unsigned int*)(0x42714120UL))
#define bFM3_MFS10_UART_TDR_AD                 *((volatile unsigned int*)(0x42714120UL))
#define bFM3_MFS10_UART_BGR_EXT                *((volatile unsigned int*)(0x427141BCUL))
#define bFM3_MFS10_UART_BGR1_EXT               *((volatile unsigned int*)(0x427141BCUL))
#define bFM3_MFS10_UART_FCR_FE1                *((volatile unsigned int*)(0x42714280UL))
#define bFM3_MFS10_UART_FCR_FE2                *((volatile unsigned int*)(0x42714284UL))
#define bFM3_MFS10_UART_FCR_FCL1               *((volatile unsigned int*)(0x42714288UL))
#define bFM3_MFS10_UART_FCR_FCL2               *((volatile unsigned int*)(0x4271428CUL))
#define bFM3_MFS10_UART_FCR_FSET               *((volatile unsigned int*)(0x42714290UL))
#define bFM3_MFS10_UART_FCR_FLD                *((volatile unsigned int*)(0x42714294UL))
#define bFM3_MFS10_UART_FCR_FLST               *((volatile unsigned int*)(0x42714298UL))
#define bFM3_MFS10_UART_FCR_FSEL               *((volatile unsigned int*)(0x427142A0UL))
#define bFM3_MFS10_UART_FCR_FTIE               *((volatile unsigned int*)(0x427142A4UL))
#define bFM3_MFS10_UART_FCR_FDRQ               *((volatile unsigned int*)(0x427142A8UL))
#define bFM3_MFS10_UART_FCR_FRIIE              *((volatile unsigned int*)(0x427142ACUL))
#define bFM3_MFS10_UART_FCR_FLSTE              *((volatile unsigned int*)(0x427142B0UL))
#define bFM3_MFS10_UART_FCR0_FE1               *((volatile unsigned int*)(0x42714280UL))
#define bFM3_MFS10_UART_FCR0_FE2               *((volatile unsigned int*)(0x42714284UL))
#define bFM3_MFS10_UART_FCR0_FCL1              *((volatile unsigned int*)(0x42714288UL))
#define bFM3_MFS10_UART_FCR0_FCL2              *((volatile unsigned int*)(0x4271428CUL))
#define bFM3_MFS10_UART_FCR0_FSET              *((volatile unsigned int*)(0x42714290UL))
#define bFM3_MFS10_UART_FCR0_FLD               *((volatile unsigned int*)(0x42714294UL))
#define bFM3_MFS10_UART_FCR0_FLST              *((volatile unsigned int*)(0x42714298UL))
#define bFM3_MFS10_UART_FCR1_FSEL              *((volatile unsigned int*)(0x427142A0UL))
#define bFM3_MFS10_UART_FCR1_FTIE              *((volatile unsigned int*)(0x427142A4UL))
#define bFM3_MFS10_UART_FCR1_FDRQ              *((volatile unsigned int*)(0x427142A8UL))
#define bFM3_MFS10_UART_FCR1_FRIIE             *((volatile unsigned int*)(0x427142ACUL))
#define bFM3_MFS10_UART_FCR1_FLSTE             *((volatile unsigned int*)(0x427142B0UL))
#define bFM3_MFS10_UART_FBYTE_FD0              *((volatile unsigned int*)(0x42714300UL))
#define bFM3_MFS10_UART_FBYTE_FD1              *((volatile unsigned int*)(0x42714304UL))
#define bFM3_MFS10_UART_FBYTE_FD2              *((volatile unsigned int*)(0x42714308UL))
#define bFM3_MFS10_UART_FBYTE_FD3              *((volatile unsigned int*)(0x4271430CUL))
#define bFM3_MFS10_UART_FBYTE_FD4              *((volatile unsigned int*)(0x42714310UL))
#define bFM3_MFS10_UART_FBYTE_FD5              *((volatile unsigned int*)(0x42714314UL))
#define bFM3_MFS10_UART_FBYTE_FD6              *((volatile unsigned int*)(0x42714318UL))
#define bFM3_MFS10_UART_FBYTE_FD7              *((volatile unsigned int*)(0x4271431CUL))
#define bFM3_MFS10_UART_FBYTE_FD8              *((volatile unsigned int*)(0x42714320UL))
#define bFM3_MFS10_UART_FBYTE_FD9              *((volatile unsigned int*)(0x42714324UL))
#define bFM3_MFS10_UART_FBYTE_FD10             *((volatile unsigned int*)(0x42714328UL))
#define bFM3_MFS10_UART_FBYTE_FD11             *((volatile unsigned int*)(0x4271432CUL))
#define bFM3_MFS10_UART_FBYTE_FD12             *((volatile unsigned int*)(0x42714330UL))
#define bFM3_MFS10_UART_FBYTE_FD13             *((volatile unsigned int*)(0x42714334UL))
#define bFM3_MFS10_UART_FBYTE_FD14             *((volatile unsigned int*)(0x42714338UL))
#define bFM3_MFS10_UART_FBYTE_FD15             *((volatile unsigned int*)(0x4271433CUL))
#define bFM3_MFS10_UART_FBYTE1_FD0             *((volatile unsigned int*)(0x42714300UL))
#define bFM3_MFS10_UART_FBYTE1_FD1             *((volatile unsigned int*)(0x42714304UL))
#define bFM3_MFS10_UART_FBYTE1_FD2             *((volatile unsigned int*)(0x42714308UL))
#define bFM3_MFS10_UART_FBYTE1_FD3             *((volatile unsigned int*)(0x4271430CUL))
#define bFM3_MFS10_UART_FBYTE1_FD4             *((volatile unsigned int*)(0x42714310UL))
#define bFM3_MFS10_UART_FBYTE1_FD5             *((volatile unsigned int*)(0x42714314UL))
#define bFM3_MFS10_UART_FBYTE1_FD6             *((volatile unsigned int*)(0x42714318UL))
#define bFM3_MFS10_UART_FBYTE1_FD7             *((volatile unsigned int*)(0x4271431CUL))
#define bFM3_MFS10_UART_FBYTE2_FD8             *((volatile unsigned int*)(0x42714320UL))
#define bFM3_MFS10_UART_FBYTE2_FD9             *((volatile unsigned int*)(0x42714324UL))
#define bFM3_MFS10_UART_FBYTE2_FD10            *((volatile unsigned int*)(0x42714328UL))
#define bFM3_MFS10_UART_FBYTE2_FD11            *((volatile unsigned int*)(0x4271432CUL))
#define bFM3_MFS10_UART_FBYTE2_FD12            *((volatile unsigned int*)(0x42714330UL))
#define bFM3_MFS10_UART_FBYTE2_FD13            *((volatile unsigned int*)(0x42714334UL))
#define bFM3_MFS10_UART_FBYTE2_FD14            *((volatile unsigned int*)(0x42714338UL))
#define bFM3_MFS10_UART_FBYTE2_FD15            *((volatile unsigned int*)(0x4271433CUL))

/* CSIO channel 10 registers */
#define bFM3_MFS10_CSIO_SMR_SOE                *((volatile unsigned int*)(0x42714000UL))
#define bFM3_MFS10_CSIO_SMR_SCKE               *((volatile unsigned int*)(0x42714004UL))
#define bFM3_MFS10_CSIO_SMR_BDS                *((volatile unsigned int*)(0x42714008UL))
#define bFM3_MFS10_CSIO_SMR_SCINV              *((volatile unsigned int*)(0x4271400CUL))
#define bFM3_MFS10_CSIO_SMR_WUCR               *((volatile unsigned int*)(0x42714010UL))
#define bFM3_MFS10_CSIO_SCR_TXE                *((volatile unsigned int*)(0x42714020UL))
#define bFM3_MFS10_CSIO_SCR_RXE                *((volatile unsigned int*)(0x42714024UL))
#define bFM3_MFS10_CSIO_SCR_TBIE               *((volatile unsigned int*)(0x42714028UL))
#define bFM3_MFS10_CSIO_SCR_TIE                *((volatile unsigned int*)(0x4271402CUL))
#define bFM3_MFS10_CSIO_SCR_RIE                *((volatile unsigned int*)(0x42714030UL))
#define bFM3_MFS10_CSIO_SCR_SPI                *((volatile unsigned int*)(0x42714034UL))
#define bFM3_MFS10_CSIO_SCR_MS                 *((volatile unsigned int*)(0x42714038UL))
#define bFM3_MFS10_CSIO_SCR_UPCL               *((volatile unsigned int*)(0x4271403CUL))
#define bFM3_MFS10_CSIO_ESCR_L0                *((volatile unsigned int*)(0x42714080UL))
#define bFM3_MFS10_CSIO_ESCR_L1                *((volatile unsigned int*)(0x42714084UL))
#define bFM3_MFS10_CSIO_ESCR_L2                *((volatile unsigned int*)(0x42714088UL))
#define bFM3_MFS10_CSIO_ESCR_WT0               *((volatile unsigned int*)(0x4271408CUL))
#define bFM3_MFS10_CSIO_ESCR_WT1               *((volatile unsigned int*)(0x42714090UL))
#define bFM3_MFS10_CSIO_ESCR_SOP               *((volatile unsigned int*)(0x4271409CUL))
#define bFM3_MFS10_CSIO_SSR_TBI                *((volatile unsigned int*)(0x427140A0UL))
#define bFM3_MFS10_CSIO_SSR_TDRE               *((volatile unsigned int*)(0x427140A4UL))
#define bFM3_MFS10_CSIO_SSR_RDRF               *((volatile unsigned int*)(0x427140A8UL))
#define bFM3_MFS10_CSIO_SSR_ORE                *((volatile unsigned int*)(0x427140ACUL))
#define bFM3_MFS10_CSIO_SSR_REC                *((volatile unsigned int*)(0x427140BCUL))
#define bFM3_MFS10_CSIO_FCR_FE1                *((volatile unsigned int*)(0x42714280UL))
#define bFM3_MFS10_CSIO_FCR_FE2                *((volatile unsigned int*)(0x42714284UL))
#define bFM3_MFS10_CSIO_FCR_FCL1               *((volatile unsigned int*)(0x42714288UL))
#define bFM3_MFS10_CSIO_FCR_FCL2               *((volatile unsigned int*)(0x4271428CUL))
#define bFM3_MFS10_CSIO_FCR_FSET               *((volatile unsigned int*)(0x42714290UL))
#define bFM3_MFS10_CSIO_FCR_FLD                *((volatile unsigned int*)(0x42714294UL))
#define bFM3_MFS10_CSIO_FCR_FLST               *((volatile unsigned int*)(0x42714298UL))
#define bFM3_MFS10_CSIO_FCR_FSEL               *((volatile unsigned int*)(0x427142A0UL))
#define bFM3_MFS10_CSIO_FCR_FTIE               *((volatile unsigned int*)(0x427142A4UL))
#define bFM3_MFS10_CSIO_FCR_FDRQ               *((volatile unsigned int*)(0x427142A8UL))
#define bFM3_MFS10_CSIO_FCR_FRIIE              *((volatile unsigned int*)(0x427142ACUL))
#define bFM3_MFS10_CSIO_FCR_FLSTE              *((volatile unsigned int*)(0x427142B0UL))
#define bFM3_MFS10_CSIO_FCR0_FE1               *((volatile unsigned int*)(0x42714280UL))
#define bFM3_MFS10_CSIO_FCR0_FE2               *((volatile unsigned int*)(0x42714284UL))
#define bFM3_MFS10_CSIO_FCR0_FCL1              *((volatile unsigned int*)(0x42714288UL))
#define bFM3_MFS10_CSIO_FCR0_FCL2              *((volatile unsigned int*)(0x4271428CUL))
#define bFM3_MFS10_CSIO_FCR0_FSET              *((volatile unsigned int*)(0x42714290UL))
#define bFM3_MFS10_CSIO_FCR0_FLD               *((volatile unsigned int*)(0x42714294UL))
#define bFM3_MFS10_CSIO_FCR0_FLST              *((volatile unsigned int*)(0x42714298UL))
#define bFM3_MFS10_CSIO_FCR1_FSEL              *((volatile unsigned int*)(0x427142A0UL))
#define bFM3_MFS10_CSIO_FCR1_FTIE              *((volatile unsigned int*)(0x427142A4UL))
#define bFM3_MFS10_CSIO_FCR1_FDRQ              *((volatile unsigned int*)(0x427142A8UL))
#define bFM3_MFS10_CSIO_FCR1_FRIIE             *((volatile unsigned int*)(0x427142ACUL))
#define bFM3_MFS10_CSIO_FCR1_FLSTE             *((volatile unsigned int*)(0x427142B0UL))
#define bFM3_MFS10_CSIO_FBYTE_FD0              *((volatile unsigned int*)(0x42714300UL))
#define bFM3_MFS10_CSIO_FBYTE_FD1              *((volatile unsigned int*)(0x42714304UL))
#define bFM3_MFS10_CSIO_FBYTE_FD2              *((volatile unsigned int*)(0x42714308UL))
#define bFM3_MFS10_CSIO_FBYTE_FD3              *((volatile unsigned int*)(0x4271430CUL))
#define bFM3_MFS10_CSIO_FBYTE_FD4              *((volatile unsigned int*)(0x42714310UL))
#define bFM3_MFS10_CSIO_FBYTE_FD5              *((volatile unsigned int*)(0x42714314UL))
#define bFM3_MFS10_CSIO_FBYTE_FD6              *((volatile unsigned int*)(0x42714318UL))
#define bFM3_MFS10_CSIO_FBYTE_FD7              *((volatile unsigned int*)(0x4271431CUL))
#define bFM3_MFS10_CSIO_FBYTE_FD8              *((volatile unsigned int*)(0x42714320UL))
#define bFM3_MFS10_CSIO_FBYTE_FD9              *((volatile unsigned int*)(0x42714324UL))
#define bFM3_MFS10_CSIO_FBYTE_FD10             *((volatile unsigned int*)(0x42714328UL))
#define bFM3_MFS10_CSIO_FBYTE_FD11             *((volatile unsigned int*)(0x4271432CUL))
#define bFM3_MFS10_CSIO_FBYTE_FD12             *((volatile unsigned int*)(0x42714330UL))
#define bFM3_MFS10_CSIO_FBYTE_FD13             *((volatile unsigned int*)(0x42714334UL))
#define bFM3_MFS10_CSIO_FBYTE_FD14             *((volatile unsigned int*)(0x42714338UL))
#define bFM3_MFS10_CSIO_FBYTE_FD15             *((volatile unsigned int*)(0x4271433CUL))
#define bFM3_MFS10_CSIO_FBYTE1_FD0             *((volatile unsigned int*)(0x42714300UL))
#define bFM3_MFS10_CSIO_FBYTE1_FD1             *((volatile unsigned int*)(0x42714304UL))
#define bFM3_MFS10_CSIO_FBYTE1_FD2             *((volatile unsigned int*)(0x42714308UL))
#define bFM3_MFS10_CSIO_FBYTE1_FD3             *((volatile unsigned int*)(0x4271430CUL))
#define bFM3_MFS10_CSIO_FBYTE1_FD4             *((volatile unsigned int*)(0x42714310UL))
#define bFM3_MFS10_CSIO_FBYTE1_FD5             *((volatile unsigned int*)(0x42714314UL))
#define bFM3_MFS10_CSIO_FBYTE1_FD6             *((volatile unsigned int*)(0x42714318UL))
#define bFM3_MFS10_CSIO_FBYTE1_FD7             *((volatile unsigned int*)(0x4271431CUL))
#define bFM3_MFS10_CSIO_FBYTE2_FD8             *((volatile unsigned int*)(0x42714320UL))
#define bFM3_MFS10_CSIO_FBYTE2_FD9             *((volatile unsigned int*)(0x42714324UL))
#define bFM3_MFS10_CSIO_FBYTE2_FD10            *((volatile unsigned int*)(0x42714328UL))
#define bFM3_MFS10_CSIO_FBYTE2_FD11            *((volatile unsigned int*)(0x4271432CUL))
#define bFM3_MFS10_CSIO_FBYTE2_FD12            *((volatile unsigned int*)(0x42714330UL))
#define bFM3_MFS10_CSIO_FBYTE2_FD13            *((volatile unsigned int*)(0x42714334UL))
#define bFM3_MFS10_CSIO_FBYTE2_FD14            *((volatile unsigned int*)(0x42714338UL))
#define bFM3_MFS10_CSIO_FBYTE2_FD15            *((volatile unsigned int*)(0x4271433CUL))

/* I2C channel 10 registers */
#define bFM3_MFS10_I2C_SMR_TIE                 *((volatile unsigned int*)(0x42714008UL))
#define bFM3_MFS10_I2C_SMR_RIE                 *((volatile unsigned int*)(0x4271400CUL))
#define bFM3_MFS10_I2C_SMR_WUCR                *((volatile unsigned int*)(0x42714010UL))
#define bFM3_MFS10_I2C_IBCR_INT                *((volatile unsigned int*)(0x42714020UL))
#define bFM3_MFS10_I2C_IBCR_BER                *((volatile unsigned int*)(0x42714024UL))
#define bFM3_MFS10_I2C_IBCR_INTE               *((volatile unsigned int*)(0x42714028UL))
#define bFM3_MFS10_I2C_IBCR_CNDE               *((volatile unsigned int*)(0x4271402CUL))
#define bFM3_MFS10_I2C_IBCR_WSEL               *((volatile unsigned int*)(0x42714030UL))
#define bFM3_MFS10_I2C_IBCR_ACKE               *((volatile unsigned int*)(0x42714034UL))
#define bFM3_MFS10_I2C_IBCR_ACT                *((volatile unsigned int*)(0x42714038UL))
#define bFM3_MFS10_I2C_IBCR_SCC                *((volatile unsigned int*)(0x42714038UL))
#define bFM3_MFS10_I2C_IBCR_MSS                *((volatile unsigned int*)(0x4271403CUL))
#define bFM3_MFS10_I2C_IBSR_BB                 *((volatile unsigned int*)(0x42714080UL))
#define bFM3_MFS10_I2C_IBSR_SPC                *((volatile unsigned int*)(0x42714084UL))
#define bFM3_MFS10_I2C_IBSR_RSC                *((volatile unsigned int*)(0x42714088UL))
#define bFM3_MFS10_I2C_IBSR_AL                 *((volatile unsigned int*)(0x4271408CUL))
#define bFM3_MFS10_I2C_IBSR_TRX                *((volatile unsigned int*)(0x42714090UL))
#define bFM3_MFS10_I2C_IBSR_RSA                *((volatile unsigned int*)(0x42714094UL))
#define bFM3_MFS10_I2C_IBSR_RACK               *((volatile unsigned int*)(0x42714098UL))
#define bFM3_MFS10_I2C_IBSR_FBT                *((volatile unsigned int*)(0x4271409CUL))
#define bFM3_MFS10_I2C_SSR_TBI                 *((volatile unsigned int*)(0x427140A0UL))
#define bFM3_MFS10_I2C_SSR_TDRE                *((volatile unsigned int*)(0x427140A4UL))
#define bFM3_MFS10_I2C_SSR_RDRF                *((volatile unsigned int*)(0x427140A8UL))
#define bFM3_MFS10_I2C_SSR_ORE                 *((volatile unsigned int*)(0x427140ACUL))
#define bFM3_MFS10_I2C_SSR_TBIE                *((volatile unsigned int*)(0x427140B0UL))
#define bFM3_MFS10_I2C_SSR_DMA                 *((volatile unsigned int*)(0x427140B4UL))
#define bFM3_MFS10_I2C_SSR_TSET                *((volatile unsigned int*)(0x427140B8UL))
#define bFM3_MFS10_I2C_SSR_REC                 *((volatile unsigned int*)(0x427140BCUL))
#define bFM3_MFS10_I2C_ISBA_SA0                *((volatile unsigned int*)(0x42714200UL))
#define bFM3_MFS10_I2C_ISBA_SA1                *((volatile unsigned int*)(0x42714204UL))
#define bFM3_MFS10_I2C_ISBA_SA2                *((volatile unsigned int*)(0x42714208UL))
#define bFM3_MFS10_I2C_ISBA_SA3                *((volatile unsigned int*)(0x4271420CUL))
#define bFM3_MFS10_I2C_ISBA_SA4                *((volatile unsigned int*)(0x42714210UL))
#define bFM3_MFS10_I2C_ISBA_SA5                *((volatile unsigned int*)(0x42714214UL))
#define bFM3_MFS10_I2C_ISBA_SA6                *((volatile unsigned int*)(0x42714218UL))
#define bFM3_MFS10_I2C_ISBA_SAEN               *((volatile unsigned int*)(0x4271421CUL))
#define bFM3_MFS10_I2C_ISMK_SM0                *((volatile unsigned int*)(0x42714220UL))
#define bFM3_MFS10_I2C_ISMK_SM1                *((volatile unsigned int*)(0x42714224UL))
#define bFM3_MFS10_I2C_ISMK_SM2                *((volatile unsigned int*)(0x42714228UL))
#define bFM3_MFS10_I2C_ISMK_SM3                *((volatile unsigned int*)(0x4271422CUL))
#define bFM3_MFS10_I2C_ISMK_SM4                *((volatile unsigned int*)(0x42714230UL))
#define bFM3_MFS10_I2C_ISMK_SM5                *((volatile unsigned int*)(0x42714234UL))
#define bFM3_MFS10_I2C_ISMK_SM6                *((volatile unsigned int*)(0x42714238UL))
#define bFM3_MFS10_I2C_ISMK_EN                 *((volatile unsigned int*)(0x4271423CUL))
#define bFM3_MFS10_I2C_FCR_FE1                 *((volatile unsigned int*)(0x42714280UL))
#define bFM3_MFS10_I2C_FCR_FE2                 *((volatile unsigned int*)(0x42714284UL))
#define bFM3_MFS10_I2C_FCR_FCL1                *((volatile unsigned int*)(0x42714288UL))
#define bFM3_MFS10_I2C_FCR_FCL2                *((volatile unsigned int*)(0x4271428CUL))
#define bFM3_MFS10_I2C_FCR_FSET                *((volatile unsigned int*)(0x42714290UL))
#define bFM3_MFS10_I2C_FCR_FLD                 *((volatile unsigned int*)(0x42714294UL))
#define bFM3_MFS10_I2C_FCR_FLST                *((volatile unsigned int*)(0x42714298UL))
#define bFM3_MFS10_I2C_FCR_FSEL                *((volatile unsigned int*)(0x427142A0UL))
#define bFM3_MFS10_I2C_FCR_FTIE                *((volatile unsigned int*)(0x427142A4UL))
#define bFM3_MFS10_I2C_FCR_FDRQ                *((volatile unsigned int*)(0x427142A8UL))
#define bFM3_MFS10_I2C_FCR_FRIIE               *((volatile unsigned int*)(0x427142ACUL))
#define bFM3_MFS10_I2C_FCR_FLSTE               *((volatile unsigned int*)(0x427142B0UL))
#define bFM3_MFS10_I2C_FCR0_FE1                *((volatile unsigned int*)(0x42714280UL))
#define bFM3_MFS10_I2C_FCR0_FE2                *((volatile unsigned int*)(0x42714284UL))
#define bFM3_MFS10_I2C_FCR0_FCL1               *((volatile unsigned int*)(0x42714288UL))
#define bFM3_MFS10_I2C_FCR0_FCL2               *((volatile unsigned int*)(0x4271428CUL))
#define bFM3_MFS10_I2C_FCR0_FSET               *((volatile unsigned int*)(0x42714290UL))
#define bFM3_MFS10_I2C_FCR0_FLD                *((volatile unsigned int*)(0x42714294UL))
#define bFM3_MFS10_I2C_FCR0_FLST               *((volatile unsigned int*)(0x42714298UL))
#define bFM3_MFS10_I2C_FCR1_FSEL               *((volatile unsigned int*)(0x427142A0UL))
#define bFM3_MFS10_I2C_FCR1_FTIE               *((volatile unsigned int*)(0x427142A4UL))
#define bFM3_MFS10_I2C_FCR1_FDRQ               *((volatile unsigned int*)(0x427142A8UL))
#define bFM3_MFS10_I2C_FCR1_FRIIE              *((volatile unsigned int*)(0x427142ACUL))
#define bFM3_MFS10_I2C_FCR1_FLSTE              *((volatile unsigned int*)(0x427142B0UL))
#define bFM3_MFS10_I2C_FBYTE_FD0               *((volatile unsigned int*)(0x42714300UL))
#define bFM3_MFS10_I2C_FBYTE_FD1               *((volatile unsigned int*)(0x42714304UL))
#define bFM3_MFS10_I2C_FBYTE_FD2               *((volatile unsigned int*)(0x42714308UL))
#define bFM3_MFS10_I2C_FBYTE_FD3               *((volatile unsigned int*)(0x4271430CUL))
#define bFM3_MFS10_I2C_FBYTE_FD4               *((volatile unsigned int*)(0x42714310UL))
#define bFM3_MFS10_I2C_FBYTE_FD5               *((volatile unsigned int*)(0x42714314UL))
#define bFM3_MFS10_I2C_FBYTE_FD6               *((volatile unsigned int*)(0x42714318UL))
#define bFM3_MFS10_I2C_FBYTE_FD7               *((volatile unsigned int*)(0x4271431CUL))
#define bFM3_MFS10_I2C_FBYTE_FD8               *((volatile unsigned int*)(0x42714320UL))
#define bFM3_MFS10_I2C_FBYTE_FD9               *((volatile unsigned int*)(0x42714324UL))
#define bFM3_MFS10_I2C_FBYTE_FD10              *((volatile unsigned int*)(0x42714328UL))
#define bFM3_MFS10_I2C_FBYTE_FD11              *((volatile unsigned int*)(0x4271432CUL))
#define bFM3_MFS10_I2C_FBYTE_FD12              *((volatile unsigned int*)(0x42714330UL))
#define bFM3_MFS10_I2C_FBYTE_FD13              *((volatile unsigned int*)(0x42714334UL))
#define bFM3_MFS10_I2C_FBYTE_FD14              *((volatile unsigned int*)(0x42714338UL))
#define bFM3_MFS10_I2C_FBYTE_FD15              *((volatile unsigned int*)(0x4271433CUL))
#define bFM3_MFS10_I2C_FBYTE1_FD0              *((volatile unsigned int*)(0x42714300UL))
#define bFM3_MFS10_I2C_FBYTE1_FD1              *((volatile unsigned int*)(0x42714304UL))
#define bFM3_MFS10_I2C_FBYTE1_FD2              *((volatile unsigned int*)(0x42714308UL))
#define bFM3_MFS10_I2C_FBYTE1_FD3              *((volatile unsigned int*)(0x4271430CUL))
#define bFM3_MFS10_I2C_FBYTE1_FD4              *((volatile unsigned int*)(0x42714310UL))
#define bFM3_MFS10_I2C_FBYTE1_FD5              *((volatile unsigned int*)(0x42714314UL))
#define bFM3_MFS10_I2C_FBYTE1_FD6              *((volatile unsigned int*)(0x42714318UL))
#define bFM3_MFS10_I2C_FBYTE1_FD7              *((volatile unsigned int*)(0x4271431CUL))
#define bFM3_MFS10_I2C_FBYTE2_FD8              *((volatile unsigned int*)(0x42714320UL))
#define bFM3_MFS10_I2C_FBYTE2_FD9              *((volatile unsigned int*)(0x42714324UL))
#define bFM3_MFS10_I2C_FBYTE2_FD10             *((volatile unsigned int*)(0x42714328UL))
#define bFM3_MFS10_I2C_FBYTE2_FD11             *((volatile unsigned int*)(0x4271432CUL))
#define bFM3_MFS10_I2C_FBYTE2_FD12             *((volatile unsigned int*)(0x42714330UL))
#define bFM3_MFS10_I2C_FBYTE2_FD13             *((volatile unsigned int*)(0x42714334UL))
#define bFM3_MFS10_I2C_FBYTE2_FD14             *((volatile unsigned int*)(0x42714338UL))
#define bFM3_MFS10_I2C_FBYTE2_FD15             *((volatile unsigned int*)(0x4271433CUL))
#define bFM3_MFS10_I2C_EIBCR_BEC               *((volatile unsigned int*)(0x427143A0UL))
#define bFM3_MFS10_I2C_EIBCR_SOCE              *((volatile unsigned int*)(0x427143A4UL))
#define bFM3_MFS10_I2C_EIBCR_SCLC              *((volatile unsigned int*)(0x427143A8UL))
#define bFM3_MFS10_I2C_EIBCR_SDAC              *((volatile unsigned int*)(0x427143ACUL))
#define bFM3_MFS10_I2C_EIBCR_SCLS              *((volatile unsigned int*)(0x427143B0UL))
#define bFM3_MFS10_I2C_EIBCR_SDAS              *((volatile unsigned int*)(0x427143B4UL))

/* UART asynchronous channel 11 registers */
#define bFM3_MFS11_UART_SMR_SOE                *((volatile unsigned int*)(0x42716000UL))
#define bFM3_MFS11_UART_SMR_BDS                *((volatile unsigned int*)(0x42716008UL))
#define bFM3_MFS11_UART_SMR_SBL                *((volatile unsigned int*)(0x4271600CUL))
#define bFM3_MFS11_UART_SMR_WUCR               *((volatile unsigned int*)(0x42716010UL))
#define bFM3_MFS11_UART_SCR_TXE                *((volatile unsigned int*)(0x42716020UL))
#define bFM3_MFS11_UART_SCR_RXE                *((volatile unsigned int*)(0x42716024UL))
#define bFM3_MFS11_UART_SCR_TBIE               *((volatile unsigned int*)(0x42716028UL))
#define bFM3_MFS11_UART_SCR_TIE                *((volatile unsigned int*)(0x4271602CUL))
#define bFM3_MFS11_UART_SCR_RIE                *((volatile unsigned int*)(0x42716030UL))
#define bFM3_MFS11_UART_SCR_UPCL               *((volatile unsigned int*)(0x4271603CUL))
#define bFM3_MFS11_UART_ESCR_L0                *((volatile unsigned int*)(0x42716080UL))
#define bFM3_MFS11_UART_ESCR_L1                *((volatile unsigned int*)(0x42716084UL))
#define bFM3_MFS11_UART_ESCR_L2                *((volatile unsigned int*)(0x42716088UL))
#define bFM3_MFS11_UART_ESCR_P                 *((volatile unsigned int*)(0x4271608CUL))
#define bFM3_MFS11_UART_ESCR_PEN               *((volatile unsigned int*)(0x42716090UL))
#define bFM3_MFS11_UART_ESCR_INV               *((volatile unsigned int*)(0x42716094UL))
#define bFM3_MFS11_UART_ESCR_ESBL              *((volatile unsigned int*)(0x42716098UL))
#define bFM3_MFS11_UART_ESCR_FLWEN             *((volatile unsigned int*)(0x4271609CUL))
#define bFM3_MFS11_UART_SSR_TBI                *((volatile unsigned int*)(0x427160A0UL))
#define bFM3_MFS11_UART_SSR_TDRE               *((volatile unsigned int*)(0x427160A4UL))
#define bFM3_MFS11_UART_SSR_RDRF               *((volatile unsigned int*)(0x427160A8UL))
#define bFM3_MFS11_UART_SSR_ORE                *((volatile unsigned int*)(0x427160ACUL))
#define bFM3_MFS11_UART_SSR_FRE                *((volatile unsigned int*)(0x427160B0UL))
#define bFM3_MFS11_UART_SSR_PE                 *((volatile unsigned int*)(0x427160B4UL))
#define bFM3_MFS11_UART_SSR_REC                *((volatile unsigned int*)(0x427160BCUL))
#define bFM3_MFS11_UART_RDR_AD                 *((volatile unsigned int*)(0x42716120UL))
#define bFM3_MFS11_UART_TDR_AD                 *((volatile unsigned int*)(0x42716120UL))
#define bFM3_MFS11_UART_BGR_EXT                *((volatile unsigned int*)(0x427161BCUL))
#define bFM3_MFS11_UART_BGR1_EXT               *((volatile unsigned int*)(0x427161BCUL))
#define bFM3_MFS11_UART_FCR_FE1                *((volatile unsigned int*)(0x42716280UL))
#define bFM3_MFS11_UART_FCR_FE2                *((volatile unsigned int*)(0x42716284UL))
#define bFM3_MFS11_UART_FCR_FCL1               *((volatile unsigned int*)(0x42716288UL))
#define bFM3_MFS11_UART_FCR_FCL2               *((volatile unsigned int*)(0x4271628CUL))
#define bFM3_MFS11_UART_FCR_FSET               *((volatile unsigned int*)(0x42716290UL))
#define bFM3_MFS11_UART_FCR_FLD                *((volatile unsigned int*)(0x42716294UL))
#define bFM3_MFS11_UART_FCR_FLST               *((volatile unsigned int*)(0x42716298UL))
#define bFM3_MFS11_UART_FCR_FSEL               *((volatile unsigned int*)(0x427162A0UL))
#define bFM3_MFS11_UART_FCR_FTIE               *((volatile unsigned int*)(0x427162A4UL))
#define bFM3_MFS11_UART_FCR_FDRQ               *((volatile unsigned int*)(0x427162A8UL))
#define bFM3_MFS11_UART_FCR_FRIIE              *((volatile unsigned int*)(0x427162ACUL))
#define bFM3_MFS11_UART_FCR_FLSTE              *((volatile unsigned int*)(0x427162B0UL))
#define bFM3_MFS11_UART_FCR0_FE1               *((volatile unsigned int*)(0x42716280UL))
#define bFM3_MFS11_UART_FCR0_FE2               *((volatile unsigned int*)(0x42716284UL))
#define bFM3_MFS11_UART_FCR0_FCL1              *((volatile unsigned int*)(0x42716288UL))
#define bFM3_MFS11_UART_FCR0_FCL2              *((volatile unsigned int*)(0x4271628CUL))
#define bFM3_MFS11_UART_FCR0_FSET              *((volatile unsigned int*)(0x42716290UL))
#define bFM3_MFS11_UART_FCR0_FLD               *((volatile unsigned int*)(0x42716294UL))
#define bFM3_MFS11_UART_FCR0_FLST              *((volatile unsigned int*)(0x42716298UL))
#define bFM3_MFS11_UART_FCR1_FSEL              *((volatile unsigned int*)(0x427162A0UL))
#define bFM3_MFS11_UART_FCR1_FTIE              *((volatile unsigned int*)(0x427162A4UL))
#define bFM3_MFS11_UART_FCR1_FDRQ              *((volatile unsigned int*)(0x427162A8UL))
#define bFM3_MFS11_UART_FCR1_FRIIE             *((volatile unsigned int*)(0x427162ACUL))
#define bFM3_MFS11_UART_FCR1_FLSTE             *((volatile unsigned int*)(0x427162B0UL))
#define bFM3_MFS11_UART_FBYTE_FD0              *((volatile unsigned int*)(0x42716300UL))
#define bFM3_MFS11_UART_FBYTE_FD1              *((volatile unsigned int*)(0x42716304UL))
#define bFM3_MFS11_UART_FBYTE_FD2              *((volatile unsigned int*)(0x42716308UL))
#define bFM3_MFS11_UART_FBYTE_FD3              *((volatile unsigned int*)(0x4271630CUL))
#define bFM3_MFS11_UART_FBYTE_FD4              *((volatile unsigned int*)(0x42716310UL))
#define bFM3_MFS11_UART_FBYTE_FD5              *((volatile unsigned int*)(0x42716314UL))
#define bFM3_MFS11_UART_FBYTE_FD6              *((volatile unsigned int*)(0x42716318UL))
#define bFM3_MFS11_UART_FBYTE_FD7              *((volatile unsigned int*)(0x4271631CUL))
#define bFM3_MFS11_UART_FBYTE_FD8              *((volatile unsigned int*)(0x42716320UL))
#define bFM3_MFS11_UART_FBYTE_FD9              *((volatile unsigned int*)(0x42716324UL))
#define bFM3_MFS11_UART_FBYTE_FD10             *((volatile unsigned int*)(0x42716328UL))
#define bFM3_MFS11_UART_FBYTE_FD11             *((volatile unsigned int*)(0x4271632CUL))
#define bFM3_MFS11_UART_FBYTE_FD12             *((volatile unsigned int*)(0x42716330UL))
#define bFM3_MFS11_UART_FBYTE_FD13             *((volatile unsigned int*)(0x42716334UL))
#define bFM3_MFS11_UART_FBYTE_FD14             *((volatile unsigned int*)(0x42716338UL))
#define bFM3_MFS11_UART_FBYTE_FD15             *((volatile unsigned int*)(0x4271633CUL))
#define bFM3_MFS11_UART_FBYTE1_FD0             *((volatile unsigned int*)(0x42716300UL))
#define bFM3_MFS11_UART_FBYTE1_FD1             *((volatile unsigned int*)(0x42716304UL))
#define bFM3_MFS11_UART_FBYTE1_FD2             *((volatile unsigned int*)(0x42716308UL))
#define bFM3_MFS11_UART_FBYTE1_FD3             *((volatile unsigned int*)(0x4271630CUL))
#define bFM3_MFS11_UART_FBYTE1_FD4             *((volatile unsigned int*)(0x42716310UL))
#define bFM3_MFS11_UART_FBYTE1_FD5             *((volatile unsigned int*)(0x42716314UL))
#define bFM3_MFS11_UART_FBYTE1_FD6             *((volatile unsigned int*)(0x42716318UL))
#define bFM3_MFS11_UART_FBYTE1_FD7             *((volatile unsigned int*)(0x4271631CUL))
#define bFM3_MFS11_UART_FBYTE2_FD8             *((volatile unsigned int*)(0x42716320UL))
#define bFM3_MFS11_UART_FBYTE2_FD9             *((volatile unsigned int*)(0x42716324UL))
#define bFM3_MFS11_UART_FBYTE2_FD10            *((volatile unsigned int*)(0x42716328UL))
#define bFM3_MFS11_UART_FBYTE2_FD11            *((volatile unsigned int*)(0x4271632CUL))
#define bFM3_MFS11_UART_FBYTE2_FD12            *((volatile unsigned int*)(0x42716330UL))
#define bFM3_MFS11_UART_FBYTE2_FD13            *((volatile unsigned int*)(0x42716334UL))
#define bFM3_MFS11_UART_FBYTE2_FD14            *((volatile unsigned int*)(0x42716338UL))
#define bFM3_MFS11_UART_FBYTE2_FD15            *((volatile unsigned int*)(0x4271633CUL))

/* CSIO channel 11 registers */
#define bFM3_MFS11_CSIO_SMR_SOE                *((volatile unsigned int*)(0x42716000UL))
#define bFM3_MFS11_CSIO_SMR_SCKE               *((volatile unsigned int*)(0x42716004UL))
#define bFM3_MFS11_CSIO_SMR_BDS                *((volatile unsigned int*)(0x42716008UL))
#define bFM3_MFS11_CSIO_SMR_SCINV              *((volatile unsigned int*)(0x4271600CUL))
#define bFM3_MFS11_CSIO_SMR_WUCR               *((volatile unsigned int*)(0x42716010UL))
#define bFM3_MFS11_CSIO_SCR_TXE                *((volatile unsigned int*)(0x42716020UL))
#define bFM3_MFS11_CSIO_SCR_RXE                *((volatile unsigned int*)(0x42716024UL))
#define bFM3_MFS11_CSIO_SCR_TBIE               *((volatile unsigned int*)(0x42716028UL))
#define bFM3_MFS11_CSIO_SCR_TIE                *((volatile unsigned int*)(0x4271602CUL))
#define bFM3_MFS11_CSIO_SCR_RIE                *((volatile unsigned int*)(0x42716030UL))
#define bFM3_MFS11_CSIO_SCR_SPI                *((volatile unsigned int*)(0x42716034UL))
#define bFM3_MFS11_CSIO_SCR_MS                 *((volatile unsigned int*)(0x42716038UL))
#define bFM3_MFS11_CSIO_SCR_UPCL               *((volatile unsigned int*)(0x4271603CUL))
#define bFM3_MFS11_CSIO_ESCR_L0                *((volatile unsigned int*)(0x42716080UL))
#define bFM3_MFS11_CSIO_ESCR_L1                *((volatile unsigned int*)(0x42716084UL))
#define bFM3_MFS11_CSIO_ESCR_L2                *((volatile unsigned int*)(0x42716088UL))
#define bFM3_MFS11_CSIO_ESCR_WT0               *((volatile unsigned int*)(0x4271608CUL))
#define bFM3_MFS11_CSIO_ESCR_WT1               *((volatile unsigned int*)(0x42716090UL))
#define bFM3_MFS11_CSIO_ESCR_SOP               *((volatile unsigned int*)(0x4271609CUL))
#define bFM3_MFS11_CSIO_SSR_TBI                *((volatile unsigned int*)(0x427160A0UL))
#define bFM3_MFS11_CSIO_SSR_TDRE               *((volatile unsigned int*)(0x427160A4UL))
#define bFM3_MFS11_CSIO_SSR_RDRF               *((volatile unsigned int*)(0x427160A8UL))
#define bFM3_MFS11_CSIO_SSR_ORE                *((volatile unsigned int*)(0x427160ACUL))
#define bFM3_MFS11_CSIO_SSR_REC                *((volatile unsigned int*)(0x427160BCUL))
#define bFM3_MFS11_CSIO_FCR_FE1                *((volatile unsigned int*)(0x42716280UL))
#define bFM3_MFS11_CSIO_FCR_FE2                *((volatile unsigned int*)(0x42716284UL))
#define bFM3_MFS11_CSIO_FCR_FCL1               *((volatile unsigned int*)(0x42716288UL))
#define bFM3_MFS11_CSIO_FCR_FCL2               *((volatile unsigned int*)(0x4271628CUL))
#define bFM3_MFS11_CSIO_FCR_FSET               *((volatile unsigned int*)(0x42716290UL))
#define bFM3_MFS11_CSIO_FCR_FLD                *((volatile unsigned int*)(0x42716294UL))
#define bFM3_MFS11_CSIO_FCR_FLST               *((volatile unsigned int*)(0x42716298UL))
#define bFM3_MFS11_CSIO_FCR_FSEL               *((volatile unsigned int*)(0x427162A0UL))
#define bFM3_MFS11_CSIO_FCR_FTIE               *((volatile unsigned int*)(0x427162A4UL))
#define bFM3_MFS11_CSIO_FCR_FDRQ               *((volatile unsigned int*)(0x427162A8UL))
#define bFM3_MFS11_CSIO_FCR_FRIIE              *((volatile unsigned int*)(0x427162ACUL))
#define bFM3_MFS11_CSIO_FCR_FLSTE              *((volatile unsigned int*)(0x427162B0UL))
#define bFM3_MFS11_CSIO_FCR0_FE1               *((volatile unsigned int*)(0x42716280UL))
#define bFM3_MFS11_CSIO_FCR0_FE2               *((volatile unsigned int*)(0x42716284UL))
#define bFM3_MFS11_CSIO_FCR0_FCL1              *((volatile unsigned int*)(0x42716288UL))
#define bFM3_MFS11_CSIO_FCR0_FCL2              *((volatile unsigned int*)(0x4271628CUL))
#define bFM3_MFS11_CSIO_FCR0_FSET              *((volatile unsigned int*)(0x42716290UL))
#define bFM3_MFS11_CSIO_FCR0_FLD               *((volatile unsigned int*)(0x42716294UL))
#define bFM3_MFS11_CSIO_FCR0_FLST              *((volatile unsigned int*)(0x42716298UL))
#define bFM3_MFS11_CSIO_FCR1_FSEL              *((volatile unsigned int*)(0x427162A0UL))
#define bFM3_MFS11_CSIO_FCR1_FTIE              *((volatile unsigned int*)(0x427162A4UL))
#define bFM3_MFS11_CSIO_FCR1_FDRQ              *((volatile unsigned int*)(0x427162A8UL))
#define bFM3_MFS11_CSIO_FCR1_FRIIE             *((volatile unsigned int*)(0x427162ACUL))
#define bFM3_MFS11_CSIO_FCR1_FLSTE             *((volatile unsigned int*)(0x427162B0UL))
#define bFM3_MFS11_CSIO_FBYTE_FD0              *((volatile unsigned int*)(0x42716300UL))
#define bFM3_MFS11_CSIO_FBYTE_FD1              *((volatile unsigned int*)(0x42716304UL))
#define bFM3_MFS11_CSIO_FBYTE_FD2              *((volatile unsigned int*)(0x42716308UL))
#define bFM3_MFS11_CSIO_FBYTE_FD3              *((volatile unsigned int*)(0x4271630CUL))
#define bFM3_MFS11_CSIO_FBYTE_FD4              *((volatile unsigned int*)(0x42716310UL))
#define bFM3_MFS11_CSIO_FBYTE_FD5              *((volatile unsigned int*)(0x42716314UL))
#define bFM3_MFS11_CSIO_FBYTE_FD6              *((volatile unsigned int*)(0x42716318UL))
#define bFM3_MFS11_CSIO_FBYTE_FD7              *((volatile unsigned int*)(0x4271631CUL))
#define bFM3_MFS11_CSIO_FBYTE_FD8              *((volatile unsigned int*)(0x42716320UL))
#define bFM3_MFS11_CSIO_FBYTE_FD9              *((volatile unsigned int*)(0x42716324UL))
#define bFM3_MFS11_CSIO_FBYTE_FD10             *((volatile unsigned int*)(0x42716328UL))
#define bFM3_MFS11_CSIO_FBYTE_FD11             *((volatile unsigned int*)(0x4271632CUL))
#define bFM3_MFS11_CSIO_FBYTE_FD12             *((volatile unsigned int*)(0x42716330UL))
#define bFM3_MFS11_CSIO_FBYTE_FD13             *((volatile unsigned int*)(0x42716334UL))
#define bFM3_MFS11_CSIO_FBYTE_FD14             *((volatile unsigned int*)(0x42716338UL))
#define bFM3_MFS11_CSIO_FBYTE_FD15             *((volatile unsigned int*)(0x4271633CUL))
#define bFM3_MFS11_CSIO_FBYTE1_FD0             *((volatile unsigned int*)(0x42716300UL))
#define bFM3_MFS11_CSIO_FBYTE1_FD1             *((volatile unsigned int*)(0x42716304UL))
#define bFM3_MFS11_CSIO_FBYTE1_FD2             *((volatile unsigned int*)(0x42716308UL))
#define bFM3_MFS11_CSIO_FBYTE1_FD3             *((volatile unsigned int*)(0x4271630CUL))
#define bFM3_MFS11_CSIO_FBYTE1_FD4             *((volatile unsigned int*)(0x42716310UL))
#define bFM3_MFS11_CSIO_FBYTE1_FD5             *((volatile unsigned int*)(0x42716314UL))
#define bFM3_MFS11_CSIO_FBYTE1_FD6             *((volatile unsigned int*)(0x42716318UL))
#define bFM3_MFS11_CSIO_FBYTE1_FD7             *((volatile unsigned int*)(0x4271631CUL))
#define bFM3_MFS11_CSIO_FBYTE2_FD8             *((volatile unsigned int*)(0x42716320UL))
#define bFM3_MFS11_CSIO_FBYTE2_FD9             *((volatile unsigned int*)(0x42716324UL))
#define bFM3_MFS11_CSIO_FBYTE2_FD10            *((volatile unsigned int*)(0x42716328UL))
#define bFM3_MFS11_CSIO_FBYTE2_FD11            *((volatile unsigned int*)(0x4271632CUL))
#define bFM3_MFS11_CSIO_FBYTE2_FD12            *((volatile unsigned int*)(0x42716330UL))
#define bFM3_MFS11_CSIO_FBYTE2_FD13            *((volatile unsigned int*)(0x42716334UL))
#define bFM3_MFS11_CSIO_FBYTE2_FD14            *((volatile unsigned int*)(0x42716338UL))
#define bFM3_MFS11_CSIO_FBYTE2_FD15            *((volatile unsigned int*)(0x4271633CUL))

/* I2C channel 11 registers */
#define bFM3_MFS11_I2C_SMR_TIE                 *((volatile unsigned int*)(0x42716008UL))
#define bFM3_MFS11_I2C_SMR_RIE                 *((volatile unsigned int*)(0x4271600CUL))
#define bFM3_MFS11_I2C_SMR_WUCR                *((volatile unsigned int*)(0x42716010UL))
#define bFM3_MFS11_I2C_IBCR_INT                *((volatile unsigned int*)(0x42716020UL))
#define bFM3_MFS11_I2C_IBCR_BER                *((volatile unsigned int*)(0x42716024UL))
#define bFM3_MFS11_I2C_IBCR_INTE               *((volatile unsigned int*)(0x42716028UL))
#define bFM3_MFS11_I2C_IBCR_CNDE               *((volatile unsigned int*)(0x4271602CUL))
#define bFM3_MFS11_I2C_IBCR_WSEL               *((volatile unsigned int*)(0x42716030UL))
#define bFM3_MFS11_I2C_IBCR_ACKE               *((volatile unsigned int*)(0x42716034UL))
#define bFM3_MFS11_I2C_IBCR_ACT                *((volatile unsigned int*)(0x42716038UL))
#define bFM3_MFS11_I2C_IBCR_SCC                *((volatile unsigned int*)(0x42716038UL))
#define bFM3_MFS11_I2C_IBCR_MSS                *((volatile unsigned int*)(0x4271603CUL))
#define bFM3_MFS11_I2C_IBSR_BB                 *((volatile unsigned int*)(0x42716080UL))
#define bFM3_MFS11_I2C_IBSR_SPC                *((volatile unsigned int*)(0x42716084UL))
#define bFM3_MFS11_I2C_IBSR_RSC                *((volatile unsigned int*)(0x42716088UL))
#define bFM3_MFS11_I2C_IBSR_AL                 *((volatile unsigned int*)(0x4271608CUL))
#define bFM3_MFS11_I2C_IBSR_TRX                *((volatile unsigned int*)(0x42716090UL))
#define bFM3_MFS11_I2C_IBSR_RSA                *((volatile unsigned int*)(0x42716094UL))
#define bFM3_MFS11_I2C_IBSR_RACK               *((volatile unsigned int*)(0x42716098UL))
#define bFM3_MFS11_I2C_IBSR_FBT                *((volatile unsigned int*)(0x4271609CUL))
#define bFM3_MFS11_I2C_SSR_TBI                 *((volatile unsigned int*)(0x427160A0UL))
#define bFM3_MFS11_I2C_SSR_TDRE                *((volatile unsigned int*)(0x427160A4UL))
#define bFM3_MFS11_I2C_SSR_RDRF                *((volatile unsigned int*)(0x427160A8UL))
#define bFM3_MFS11_I2C_SSR_ORE                 *((volatile unsigned int*)(0x427160ACUL))
#define bFM3_MFS11_I2C_SSR_TBIE                *((volatile unsigned int*)(0x427160B0UL))
#define bFM3_MFS11_I2C_SSR_DMA                 *((volatile unsigned int*)(0x427160B4UL))
#define bFM3_MFS11_I2C_SSR_TSET                *((volatile unsigned int*)(0x427160B8UL))
#define bFM3_MFS11_I2C_SSR_REC                 *((volatile unsigned int*)(0x427160BCUL))
#define bFM3_MFS11_I2C_ISBA_SA0                *((volatile unsigned int*)(0x42716200UL))
#define bFM3_MFS11_I2C_ISBA_SA1                *((volatile unsigned int*)(0x42716204UL))
#define bFM3_MFS11_I2C_ISBA_SA2                *((volatile unsigned int*)(0x42716208UL))
#define bFM3_MFS11_I2C_ISBA_SA3                *((volatile unsigned int*)(0x4271620CUL))
#define bFM3_MFS11_I2C_ISBA_SA4                *((volatile unsigned int*)(0x42716210UL))
#define bFM3_MFS11_I2C_ISBA_SA5                *((volatile unsigned int*)(0x42716214UL))
#define bFM3_MFS11_I2C_ISBA_SA6                *((volatile unsigned int*)(0x42716218UL))
#define bFM3_MFS11_I2C_ISBA_SAEN               *((volatile unsigned int*)(0x4271621CUL))
#define bFM3_MFS11_I2C_ISMK_SM0                *((volatile unsigned int*)(0x42716220UL))
#define bFM3_MFS11_I2C_ISMK_SM1                *((volatile unsigned int*)(0x42716224UL))
#define bFM3_MFS11_I2C_ISMK_SM2                *((volatile unsigned int*)(0x42716228UL))
#define bFM3_MFS11_I2C_ISMK_SM3                *((volatile unsigned int*)(0x4271622CUL))
#define bFM3_MFS11_I2C_ISMK_SM4                *((volatile unsigned int*)(0x42716230UL))
#define bFM3_MFS11_I2C_ISMK_SM5                *((volatile unsigned int*)(0x42716234UL))
#define bFM3_MFS11_I2C_ISMK_SM6                *((volatile unsigned int*)(0x42716238UL))
#define bFM3_MFS11_I2C_ISMK_EN                 *((volatile unsigned int*)(0x4271623CUL))
#define bFM3_MFS11_I2C_FCR_FE1                 *((volatile unsigned int*)(0x42716280UL))
#define bFM3_MFS11_I2C_FCR_FE2                 *((volatile unsigned int*)(0x42716284UL))
#define bFM3_MFS11_I2C_FCR_FCL1                *((volatile unsigned int*)(0x42716288UL))
#define bFM3_MFS11_I2C_FCR_FCL2                *((volatile unsigned int*)(0x4271628CUL))
#define bFM3_MFS11_I2C_FCR_FSET                *((volatile unsigned int*)(0x42716290UL))
#define bFM3_MFS11_I2C_FCR_FLD                 *((volatile unsigned int*)(0x42716294UL))
#define bFM3_MFS11_I2C_FCR_FLST                *((volatile unsigned int*)(0x42716298UL))
#define bFM3_MFS11_I2C_FCR_FSEL                *((volatile unsigned int*)(0x427162A0UL))
#define bFM3_MFS11_I2C_FCR_FTIE                *((volatile unsigned int*)(0x427162A4UL))
#define bFM3_MFS11_I2C_FCR_FDRQ                *((volatile unsigned int*)(0x427162A8UL))
#define bFM3_MFS11_I2C_FCR_FRIIE               *((volatile unsigned int*)(0x427162ACUL))
#define bFM3_MFS11_I2C_FCR_FLSTE               *((volatile unsigned int*)(0x427162B0UL))
#define bFM3_MFS11_I2C_FCR0_FE1                *((volatile unsigned int*)(0x42716280UL))
#define bFM3_MFS11_I2C_FCR0_FE2                *((volatile unsigned int*)(0x42716284UL))
#define bFM3_MFS11_I2C_FCR0_FCL1               *((volatile unsigned int*)(0x42716288UL))
#define bFM3_MFS11_I2C_FCR0_FCL2               *((volatile unsigned int*)(0x4271628CUL))
#define bFM3_MFS11_I2C_FCR0_FSET               *((volatile unsigned int*)(0x42716290UL))
#define bFM3_MFS11_I2C_FCR0_FLD                *((volatile unsigned int*)(0x42716294UL))
#define bFM3_MFS11_I2C_FCR0_FLST               *((volatile unsigned int*)(0x42716298UL))
#define bFM3_MFS11_I2C_FCR1_FSEL               *((volatile unsigned int*)(0x427162A0UL))
#define bFM3_MFS11_I2C_FCR1_FTIE               *((volatile unsigned int*)(0x427162A4UL))
#define bFM3_MFS11_I2C_FCR1_FDRQ               *((volatile unsigned int*)(0x427162A8UL))
#define bFM3_MFS11_I2C_FCR1_FRIIE              *((volatile unsigned int*)(0x427162ACUL))
#define bFM3_MFS11_I2C_FCR1_FLSTE              *((volatile unsigned int*)(0x427162B0UL))
#define bFM3_MFS11_I2C_FBYTE_FD0               *((volatile unsigned int*)(0x42716300UL))
#define bFM3_MFS11_I2C_FBYTE_FD1               *((volatile unsigned int*)(0x42716304UL))
#define bFM3_MFS11_I2C_FBYTE_FD2               *((volatile unsigned int*)(0x42716308UL))
#define bFM3_MFS11_I2C_FBYTE_FD3               *((volatile unsigned int*)(0x4271630CUL))
#define bFM3_MFS11_I2C_FBYTE_FD4               *((volatile unsigned int*)(0x42716310UL))
#define bFM3_MFS11_I2C_FBYTE_FD5               *((volatile unsigned int*)(0x42716314UL))
#define bFM3_MFS11_I2C_FBYTE_FD6               *((volatile unsigned int*)(0x42716318UL))
#define bFM3_MFS11_I2C_FBYTE_FD7               *((volatile unsigned int*)(0x4271631CUL))
#define bFM3_MFS11_I2C_FBYTE_FD8               *((volatile unsigned int*)(0x42716320UL))
#define bFM3_MFS11_I2C_FBYTE_FD9               *((volatile unsigned int*)(0x42716324UL))
#define bFM3_MFS11_I2C_FBYTE_FD10              *((volatile unsigned int*)(0x42716328UL))
#define bFM3_MFS11_I2C_FBYTE_FD11              *((volatile unsigned int*)(0x4271632CUL))
#define bFM3_MFS11_I2C_FBYTE_FD12              *((volatile unsigned int*)(0x42716330UL))
#define bFM3_MFS11_I2C_FBYTE_FD13              *((volatile unsigned int*)(0x42716334UL))
#define bFM3_MFS11_I2C_FBYTE_FD14              *((volatile unsigned int*)(0x42716338UL))
#define bFM3_MFS11_I2C_FBYTE_FD15              *((volatile unsigned int*)(0x4271633CUL))
#define bFM3_MFS11_I2C_FBYTE1_FD0              *((volatile unsigned int*)(0x42716300UL))
#define bFM3_MFS11_I2C_FBYTE1_FD1              *((volatile unsigned int*)(0x42716304UL))
#define bFM3_MFS11_I2C_FBYTE1_FD2              *((volatile unsigned int*)(0x42716308UL))
#define bFM3_MFS11_I2C_FBYTE1_FD3              *((volatile unsigned int*)(0x4271630CUL))
#define bFM3_MFS11_I2C_FBYTE1_FD4              *((volatile unsigned int*)(0x42716310UL))
#define bFM3_MFS11_I2C_FBYTE1_FD5              *((volatile unsigned int*)(0x42716314UL))
#define bFM3_MFS11_I2C_FBYTE1_FD6              *((volatile unsigned int*)(0x42716318UL))
#define bFM3_MFS11_I2C_FBYTE1_FD7              *((volatile unsigned int*)(0x4271631CUL))
#define bFM3_MFS11_I2C_FBYTE2_FD8              *((volatile unsigned int*)(0x42716320UL))
#define bFM3_MFS11_I2C_FBYTE2_FD9              *((volatile unsigned int*)(0x42716324UL))
#define bFM3_MFS11_I2C_FBYTE2_FD10             *((volatile unsigned int*)(0x42716328UL))
#define bFM3_MFS11_I2C_FBYTE2_FD11             *((volatile unsigned int*)(0x4271632CUL))
#define bFM3_MFS11_I2C_FBYTE2_FD12             *((volatile unsigned int*)(0x42716330UL))
#define bFM3_MFS11_I2C_FBYTE2_FD13             *((volatile unsigned int*)(0x42716334UL))
#define bFM3_MFS11_I2C_FBYTE2_FD14             *((volatile unsigned int*)(0x42716338UL))
#define bFM3_MFS11_I2C_FBYTE2_FD15             *((volatile unsigned int*)(0x4271633CUL))
#define bFM3_MFS11_I2C_EIBCR_BEC               *((volatile unsigned int*)(0x427163A0UL))
#define bFM3_MFS11_I2C_EIBCR_SOCE              *((volatile unsigned int*)(0x427163A4UL))
#define bFM3_MFS11_I2C_EIBCR_SCLC              *((volatile unsigned int*)(0x427163A8UL))
#define bFM3_MFS11_I2C_EIBCR_SDAC              *((volatile unsigned int*)(0x427163ACUL))
#define bFM3_MFS11_I2C_EIBCR_SCLS              *((volatile unsigned int*)(0x427163B0UL))
#define bFM3_MFS11_I2C_EIBCR_SDAS              *((volatile unsigned int*)(0x427163B4UL))
