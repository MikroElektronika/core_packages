if(${MCU_NAME} MATCHES "^MK22FN128.+10$")
    set(${linkerScript} linker_scripts/${vendor}/mk22fn128xxx10xx.ld PARENT_SCOPE)
    set(${startupFile} startup/${vendor}/mk22f128xxx10.s PARENT_SCOPE)
