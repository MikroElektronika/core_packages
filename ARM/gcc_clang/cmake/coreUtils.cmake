...
function(set_flags flags)
    ...
    elseif (${CORE_NAME} STREQUAL "M33EF")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m33 -mthumb --specs=nosys.specs -mfloat-abi=soft -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types -Wno-incompatible-pointer-types -Wno-implicit-function-declaration PARENT_SCOPE)
    ...
    elseif (${CORE_NAME} STREQUAL "M85")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m85 -mthumb --specs=nosys.specs -mfloat-abi=soft -mfpu=fpv4-sp-d16 -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types -Wno-incompatible-pointer-types -Wno-implicit-function-declaration PARENT_SCOPE)
    else()
