...
function(get_mcu_vendor vendor)
    ...
    elseif(${MCU_NAME} MATCHES "^(M(C|K)|K(W45|32L)|LPC).+$")
    ...
    elseif(${MCU_NAME} MATCHES "^(C?N?M[10234]|MINI|NANO|NUC).+$")
        set(${vendor} nuvoton PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^(XMC|CY|MB|S6).+$")
        set(${vendor} infineon PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^PIC32C.+$")
        set(${vendor} pic32 PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^GD32.+$")
        set(${vendor} gigadevice PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^(EFM|BGM|EZR|MGM|EFR).+$")
        set(${vendor} silabs PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^(APM|BMP).+$")
        set(${vendor} geehy PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^AT32.+$")
        set(${vendor} arterytek PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^A3[134].+$")
        set(${vendor} abov PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^(BAT|CMS)32.+$")
        set(${vendor} cmsemicon PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^HC32.+$")
        set(${vendor} hdsc PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^(HF5032|HT(32|50)[FL]|[NK]W32F|MXTX[56]).+$")
        set(${vendor} holtek PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^MM32[FLPSW].+$")
        set(${vendor} mindmotion PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^SN32F.+$")
        set(${vendor} sonix PARENT_SCOPE)
    elseif(${MCU_NAME} MATCHES "^[MAX|AD].+$")
        set(${vendor} adi PARENT_SCOPE)
    else()
...
function(set_flags flags)
    ...
    if (${CORE_NAME} STREQUAL "M0")
        if (${MCU_NAME} MATCHES "^STM32F0.+$")
            set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m0 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
        else()
            set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m0plus -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
        endif()
    ...
    elseif (${CORE_NAME} STREQUAL "M23")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m23 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -mfloat-abi=soft -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    elseif (${CORE_NAME} STREQUAL "M3")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m3 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    elseif (${CORE_NAME} STREQUAL "M33EF")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m33 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -mfloat-abi=hard -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    elseif (${CORE_NAME} STREQUAL "M4")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m4 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -mfloat-abi=hard -mfpu=fpv4-sp-d16 -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    elseif (${CORE_NAME} STREQUAL "M4EF")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m4 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -mfloat-abi=hard -mfpu=fpv4-sp-d16 -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    elseif (${CORE_NAME} STREQUAL "M4DSP")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m4 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -mfloat-abi=soft -mfpu=fpv4-sp-d16 -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    elseif (${CORE_NAME} STREQUAL "M7")
        ...
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m7 -mthumb ${POINTER_TYPE_ERROR} -mfloat-abi=hard ${M7_FPU_FLAG} --specs=nosys.specs -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    elseif (${CORE_NAME} STREQUAL "M85")
        set(${flags} -std=gnu99 -Wl,-Map=output.map,-gc-sections,--print-memory-usage -mcpu=cortex-m85 -mthumb ${POINTER_TYPE_ERROR} --specs=nosys.specs -mfloat-abi=hard -mfpu=fpv4-sp-d16 -ffunction-sections -fdata-sections -fno-common -fmessage-length=0 -Wno-int-conversion -Wno-incompatible-function-pointer-types PARENT_SCOPE)
    else()
