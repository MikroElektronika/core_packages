...
void Delay_Cyc(unsigned long cycles_div_by_10)  {  // Cycles_div_by_10 parameter range: min=2, max=4294967295
  unsigned long loc;
...
void Delay_Cyc_Long(unsigned long CycNo) { // CycNo parameter range: min=22, max=4294967295
...
void VDelay_Advanced_ms(unsigned long Time_ms, unsigned Current_Fosc_kHz){ // Time_ms parameter range: min=1, max=4294967295
