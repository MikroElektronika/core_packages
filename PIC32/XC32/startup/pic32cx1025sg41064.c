 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for PIC32CX1025SG41064
 *
...
void Reserved70                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved71                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved72                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved73                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved74                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved75                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved76                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved77                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved78                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved79                ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void Reserved126               ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved127               ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
#else /* Legacy defined(_32CX1025SG41064_H) */
